...
multiline_comment|/*&n; * Print a string of text in a window, automatically wrap around to the&n; * next line if the string is too long to fit on one line. Note that the&n; * string may contain &quot;&bslash;n&quot; to represent a newline character or the real&n; * newline &squot;&bslash;n&squot;, but in that case, auto wrap around will be disabled.&n; */
r_void
...
op_star
id|word
multiline_comment|/*,  *tempptr, *tempptr1*/
suffix:semicolon
id|strcpy
(paren
id|tempstr
...
id|y
suffix:semicolon
multiline_comment|/* Print prompt word by word, wrap around if necessary */
r_while
c_loop
(paren
(paren
...
multiline_comment|/* First iteration */
id|first
op_assign
l_int|0
suffix:semicolon
...
op_increment
suffix:semicolon
multiline_comment|/* wrap to next line */
id|cur_x
op_assign
id|x
suffix:semicolon
