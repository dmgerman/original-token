...
id|stderr
comma
l_string|&quot;Internal error on token_choice_header&bslash;n&quot;
)paren
suffix:semicolon
m_exit
(paren
...
c_func
(paren
l_string|&quot;write_tristate $cfg $autocfg %s $%s $notmod&quot;
comma
id|cfg-&gt;optionname
comma
id|cfg-&gt;optionname
...
c_func
(paren
l_string|&quot;write_tristate $cfg $autocfg %s $%s $notmod&bslash;n&quot;
comma
id|cfg-&gt;optionname
comma
id|cfg-&gt;optionname
...
c_func
(paren
l_string|&quot;write_tristate $cfg $autocfg %s $%s $%s&quot;
comma
id|cfg-&gt;optionname
comma
id|cfg-&gt;optionname
...
c_func
(paren
l_string|&quot;write_string $cfg $autocfg %s $%s $notmod&quot;
comma
id|cfg-&gt;optionname
comma
id|cfg-&gt;optionname
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * Treat tristate like conditional here.&n;&t;&t; */
r_if
c_cond
(paren
id|cfg-&gt;token
...
l_string|&quot;No Name&quot;
suffix:semicolon
multiline_comment|/*&n;    * Thread the menu pointers so I can walk each menu separately.&n;    */
id|tot_menu_num
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/*&n;     * Generate code to set the variables that are &quot;defined&quot;.&n;     */
r_for
c_loop
(paren
id|cfg
