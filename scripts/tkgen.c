...
c_func
(paren
l_string|&quot;global CONFIG_MODULES; if {($CONFIG_MODULES == 1)} then { .menu%d.config.f.x%d.m configure -state normal };&quot;
comma
id|menu_num
comma
id|line_num
...
multiline_comment|/*&n;   * Record this so we can set up the prev/next buttons correctly.&n;   * Menus per column computation has extra button space as follows:&n;   *   4 for the save/quit/load/store buttons,&n;   *   1 for the blank space above save/quit/load/store&n;   *   2 to make the rounding work&n;   */
id|tot_menu_num
op_assign
id|menu_num
suffix:semicolon
...
c_func
(paren
l_string|&quot;set menus_per_column %d&bslash;n&bslash;n&quot;
comma
(paren
id|tot_menu_num
op_plus
