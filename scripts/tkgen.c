...
suffix:semicolon
multiline_comment|/*&n;   * Now we generate the companion procedure for the muen we just&n;   * generated.  This procedure contains all of the code to&n;   * disable/enable widgets based upon the settings of the other&n;   * widgets, and will be called first when the window is mapped,&n;   * and each time one of the buttons in the window are clicked.&n;   */
id|printf
c_func
(paren
...
c_func
(paren
l_string|&quot;&bslash;tbool $w %d %d &bslash;&quot;%s&bslash;&quot; %s %s&bslash;n&quot;
comma
id|cfg-&gt;menu_number
comma
id|cfg-&gt;menu_line
...
c_func
(paren
l_string|&quot;&bslash;ttristate $w %d %d &bslash;&quot;%s&bslash;&quot; %s %s&bslash;n&quot;
comma
id|cfg-&gt;menu_number
comma
id|cfg-&gt;menu_line
...
c_func
(paren
l_string|&quot;&bslash;tdep_tristate $w %d %d &bslash;&quot;%s&bslash;&quot; %s %s&bslash;n&quot;
comma
id|cfg-&gt;menu_number
comma
id|cfg-&gt;menu_line
...
c_func
(paren
l_string|&quot;&bslash;tint $w %d %d &bslash;&quot;%s&bslash;&quot; %s %s&bslash;n&quot;
comma
id|cfg-&gt;menu_number
comma
id|cfg-&gt;menu_line
