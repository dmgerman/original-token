...
id|stderr
comma
l_string|&quot;Bad if clause at line %d(%s):%s&bslash;n&quot;
comma
id|lineno
comma
id|current_file
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;   * Choices appear in pairs of strings.  The parse is fairly trivial.&n;   */
r_while
c_loop
(paren
l_int|1
...
suffix:semicolon
id|kcfg-&gt;choice_label
op_assign
id|choice_kcfg
suffix:semicolon
id|kcfg-&gt;choice_value
op_assign
id|index
op_increment
suffix:semicolon
...
id|kcfg-&gt;label
comma
id|choice_kcfg-&gt;value
)paren
op_eq
l_int|0
)paren
(brace
id|choice_kcfg-&gt;choice_value
op_assign
id|kcfg-&gt;choice_value
suffix:semicolon
)brace
...
id|stderr
comma
l_string|&quot;unknown command=%s(%s %d)&bslash;n&quot;
comma
id|pnt
comma
id|current_file
...
suffix:semicolon
multiline_comment|/*&n;       * Now we need to break apart the individual options into their&n;       * own configuration structures.&n;       */
id|parse_choices
c_func
(paren
id|kcfg
...
id|stderr
comma
l_string|&quot;Can&squot;t handle dep_tristate condition&bslash;n&quot;
)paren
suffix:semicolon
m_exit
(paren
...
suffix:semicolon
multiline_comment|/*&n;   * If our cwd was in the scripts directory, we might have to go up one&n;   * to find the sourced file.&n;   */
r_if
c_cond
(paren
op_logical_neg
...
id|stderr
comma
l_string|&quot;Unable to open file %s&bslash;n&quot;
comma
id|filename
)paren
suffix:semicolon
...
id|stderr
comma
l_string|&quot;The config.in file for this platform does not support&bslash;n&quot;
)paren
suffix:semicolon
id|fprintf
c_func
