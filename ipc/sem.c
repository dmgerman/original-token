...
DECL|macro|sem_lock
mdefine_line|#define sem_lock(id)&t;((struct semid_ds*)ipc_lock(&amp;sem_ids,id))
DECL|macro|sem_unlock
mdefine_line|#define sem_unlock(id)&t;ipc_unlock(&amp;sem_ids,id)
DECL|macro|sem_rmid
mdefine_line|#define sem_rmid(id)&t;((struct semid_ds*)ipc_rmid(&amp;sem_ids,id))
...
multiline_comment|/*&n; * linked list protection:&n; *&t;sem_undo.id_next,&n; *&t;semid_ds.sem_pending{,last},&n; *&t;semid_ds.sem_undo: sem_lock() for read/write&n; *&t;sem_undo.proc_next: only &quot;current&quot; is allowed to read/write that field.&n; *&t;&n; */
