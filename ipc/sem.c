...
l_int|0
suffix:semicolon
multiline_comment|/* anti-deadlock ordering:&n; *&t;sem_lock &lt; semary[].lock&n; * linked list protection:&n; *&t;sem_undo.id_next,&n; *&t;semid_ds.sem_pending{,last},&n; *&t;semid_ds.sem_undo: semary[].lock for read/write&n; *&t;sem_undo.proc_next: only &quot;current&quot; is allowed to read/write that field.&n; *&t;&n; */
...
id|current-&gt;egid
suffix:semicolon
multiline_comment|/* sma-&gt;sem_perm.seq*MSGMNI must be a positive integer.&n;&t; * this limits MSGMNI to 32768&n;&t; */
id|sma-&gt;sem_perm.seq
op_assign
id|sem_seq
op_increment
...
id|q
suffix:semicolon
multiline_comment|/* we own both locks, noone can get in */
id|sma
op_assign
id|semary
(braket
...
DECL|function|semctl_locked_unlock
r_int
id|semctl_locked_unlock
c_func
(paren
r_int
id|semid
...
suffix:semicolon
multiline_comment|/* SETALL doesn&squot;t belong into this&n;&t;&t; * group, but I need the semaphore&n;&t;&t; * for atomically reading nsems&n;&t;&t; * and changing the semaphore values&n;&t;&t; */
id|err
op_assign
op_minus
id|EACCES
...
multiline_comment|/* we still own sem_lock, ie neither ownership&n;&t;&t; * nor permissions of the sem array could&n;&t;&t; * have changed. Just continue.&n;&t;&t; */
id|spin_lock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* we can lock the semary even if it was&n;&t;&t; * deleted.&n;&t;&t; */
id|spin_lock
c_func
(paren
op_amp
...
multiline_comment|/* semsleeping is part of &quot;current&quot;, and it&n;&t; * is never modified by another thread.&n;&t; * No synchronization required.&n;&t; */
r_if
c_cond
(paren
(paren
