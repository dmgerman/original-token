...
multiline_comment|/* MOUNT_REWRITE: kernel vfsmnt of shmfs should be passed to __filp_open() */
...
multiline_comment|/* MOUNT_REWRITE: set -&gt;f_vfsmnt to shmfs one */
