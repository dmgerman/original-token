...
(brace
multiline_comment|/* printk(&quot;shmat() -&gt; EINVAL because the interval [0x%lx,0x%lx) intersects an already mapped interval [0x%lx,0x%lx).&bslash;n&quot;,&n;&t;&t;&t;&t;&t;addr, addr + shp-&gt;shm_segsz, shmd-&gt;vm_start, shmd-&gt;vm_end); */
r_return
op_minus
id|EINVAL
suffix:semicolon
...
c_func
(paren
l_string|&quot;shm_close: shm segment (id=%d) attach list inconsistent&bslash;n&quot;
comma
id|id
)paren
suffix:semicolon
