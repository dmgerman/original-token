...
multiline_comment|/* locks order:&n;&t;shm_lock -&gt; pagecache_lock (end of shm_swap)&n;&t;shp-&gt;sem -&gt; other spinlocks (shm_nopage) */
...
(brace
multiline_comment|/* We check this after kmalloc so&n;&t;&t;&t;&t;   nobody changes num_segs afterwards */
multiline_comment|/*&n;&t;&t; * We never shrink the segment. If we shrink we have to&n;&t;&t; * check for stale handles in newseg&n;&t;&t; */
id|kfree
(paren
id|new_array
)paren
...
multiline_comment|/*&n; * allocate new shmid_kernel and pgtable. protected by shm_segs[id] = NOID.&n; * This has to be called with the shm_lock held&n; */
...
id|printk
(paren
l_string|&quot;shmmni reset to max of %u&bslash;n&quot;
comma
id|IPCMNI
)paren
suffix:semicolon
