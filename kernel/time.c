...
multiline_comment|/*&n; * Modification history kernel/time.c&n; * &n; * 02 Sep 93    Philip Gladstone&n; *      Created file with time related functions from sched.c and adjtimex() &n; * 08 Oct 93    Torsten Duwe&n; *      adjtime interface update and CMOS clock write code&n; */
...
suffix:semicolon
multiline_comment|/* since we&squot;re only adjusting minutes and seconds,&n;   * don&squot;t interfere with hour overflow. This avoids&n;   * messing with unknown time zones but requires your&n;   * RTC not to be off by more than 30 minutes&n;   */
r_if
c_cond
(paren
(paren
