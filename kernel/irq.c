...
l_int|1
suffix:semicolon
multiline_comment|/* the irq isn&squot;t re-enabled */
id|__asm__
id|__volatile__
c_func
(paren
...
c_func
(paren
l_string|&quot;Stack overflow on IRQ%d: shutting down&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
