...
l_int|0
suffix:semicolon
multiline_comment|/* I&squot;ll use an array for speed. and bitmap for speed. */
...
suffix:semicolon
multiline_comment|/* interrupts should be on at the interrupt priority controller level. */
multiline_comment|/* returns with interrupts off at the processor level. */
...
multiline_comment|/* don&squot;t just decrement it in case it is already 0 */
id|intr_count
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* any sort of real time test should go here. */
r_if
c_cond
(paren
id|in_bh
...
id|mask
suffix:semicolon
multiline_comment|/* turn the interrupts back on. */
id|sti
c_func
(paren
)paren
...
suffix:semicolon
multiline_comment|/* and back off. */
id|cli
c_func
(paren
)paren
