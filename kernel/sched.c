...
suffix:semicolon
multiline_comment|/*&n; * signal mapping: this is the default identity mapping used for normal&n; * linux binaries (it&squot;s both the reverse and the normal map, of course)&n; */
