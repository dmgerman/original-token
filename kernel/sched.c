...
id|send_now_idle
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Maybe this process has enough priority to preempt&n;&t;&t; * its preferred CPU. (this is a shortcut):&n;&t;&t; */
id|tsk
op_assign
id|cpu_curr
c_func
...
id|send_now_idle
suffix:colon
multiline_comment|/*&n;&t; * If need_resched == -1 then we can skip sending the IPI&n;&t; * altogether, tsk-&gt;need_resched is actively watched by the&n;&t; * idle thread.&n;&t; */
r_if
c_cond
(paren
(paren
...
id|flags
suffix:semicolon
multiline_comment|/*&n;&t; * fast path falls through. We have to take the runqueue lock&n;&t; * unconditionally to make sure that the test of prev-&gt;state&n;&t; * and setting has_cpu is atomic wrt. interrupts. It&squot;s not&n;&t; * a big problem in the common case because we recently took&n;&t; * the runqueue lock so it&squot;s likely to be in this processor&squot;s&n;&t; * cache.&n;&t; */
id|spin_lock_irqsave
c_func
(paren
op_amp
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * Slow path - we &squot;push&squot; the previous process and&n;&t; * reschedule_idle() will attempt to find a new&n;&t; * processor for it. (but it might preempt the&n;&t; * current process as well.)&n;&t; */
id|running_again
suffix:colon
r_if
c_cond
