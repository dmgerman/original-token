...
multiline_comment|/*&n;&t; * No CPU is idle, but maybe this process has enough priority&n;&t; * to preempt it&squot;s preferred CPU. (this is a shortcut):&n;&t; */
id|tsk
op_assign
id|cpu_curr
c_func
...
id|send_now
suffix:semicolon
multiline_comment|/*&n;&t; * We should get here rarely - or in the high CPU contention&n;&t; * case. No CPU is idle and this process is either lowprio or&n;&t; * the preferred CPU is highprio. Maybe some other CPU can/must&n;&t; * be preempted:&n;&t; */
r_for
c_loop
(paren
id|i
