...
id|flags
suffix:semicolon
multiline_comment|/*&n;&t; * Wakeups to the previous process could result in&n;&t; * the process not being rescheduled properly, because&n;&t; * has_cpu is 1 until now. (so both the currently running&n;&t; * process and the previous process has has_cpu==1)&n;&t; */
id|spin_lock_irqsave
c_func
(paren
op_amp
