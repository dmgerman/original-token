...
DECL|function|allow_interrupts
r_void
id|allow_interrupts
c_func
(paren
...
(brace
macro_line|#if defined(__SMP__) &amp;&amp; defined(__i386__)
multiline_comment|/* UGH UGH UGH. Damn broken IRQ handling test-fix for x86.. */
r_int
id|this_cpu
op_assign
id|smp_processor_id
...
c_func
(paren
l_string|&quot;lock ; btrl    $0, kernel_flag&quot;
)paren
suffix:semicolon
id|sti
c_func
...
suffix:semicolon
multiline_comment|/* interrupts should work here */
id|lock_kernel
c_func
(paren
)paren
...
(brace
multiline_comment|/* can happen if you add a timer with expires == jiffies */
id|insert_timer
c_func
(paren
id|timer
