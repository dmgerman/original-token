...
mdefine_line|#define idle_task(cpu) (task[cpu_number_map[(cpu)]])
...
suffix:colon
multiline_comment|/*&n;&t; * This is subtle.&n;&t; * Note how we can enable interrupts here, even&n;&t; * though interrupts can add processes to the run-&n;&t; * queue. This is because any new processes will&n;&t; * be added to the front of the queue, so &quot;p&quot; above&n;&t; * is a safe starting point.&n;&t; * run-queue deletion and re-ordering is protected by&n;&t; * the scheduler lock&n;&t; */
...
id|out
suffix:semicolon
multiline_comment|/*&n;&t; * this is safe to be done before the check because it&n;&t; * means no deference, just pointer operations.&n;&t; */
id|head
op_assign
id|WAIT_QUEUE_HEAD
c_func
...
(brace
multiline_comment|/*&n;&t;&t;&t; * We can drop the read-lock early if this&n;&t;&t;&t; * is the only/last process.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|next
