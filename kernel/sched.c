...
mdefine_line|#define can_schedule(p)&t;((p)-&gt;processor == NO_PROC_ID)
macro_line|#else
DECL|macro|idle_task
...
c_func
(paren
l_string|&quot;Moving pid 0 last&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
multiline_comment|/*&n; * It is up to the platform where it does the profiling: in the&n; * global timer interrupt, or in a special interrupt handler.&n; *&n; * by default it&squot;s done in the global timer interrupt.&n; */
DECL|function|default_do_profile
r_static
r_void
id|default_do_profile
(paren
r_struct
id|pt_regs
op_star
