...
suffix:semicolon
macro_line|#endif
multiline_comment|/*if (scsi_tapes[dev].buffer-&gt;last_result = INT_MAX)&n;&t;  retval = (-ENOSPC);&n;&t;else */
id|retval
op_assign
(paren
op_minus
...
r_else
multiline_comment|/* Read successfu| */
id|scsi_tapes
(braket
id|dev
)braket
