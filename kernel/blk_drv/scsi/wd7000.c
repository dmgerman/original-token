...
l_int|0x2c
suffix:semicolon
multiline_comment|/* Sets 4MHz for SBIC Revision A */
id|any2scsi
c_func
(paren
id|icb
...
suffix:semicolon
multiline_comment|/* Transfer 1 byte */
id|any2scsi
c_func
(paren
id|icb
...
suffix:semicolon
multiline_comment|/* The speed buffer address */
id|icb
(braket
l_int|8
)braket
...
id|id
suffix:semicolon
multiline_comment|/* The index into the table */
id|icb
(braket
id|ICB_PHASE
)braket
