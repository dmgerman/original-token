multiline_comment|/*&n; *&t;scsi.c Copyright (C) 1992 Drew Eckhardt &n; *&t;generic mid-level SCSI driver by&n; *&t;&t;Drew Eckhardt &n; *&n; *&t;&lt;drew@colorado.edu&gt;&n; */
...
macro_line|#endif
multiline_comment|/*&n;static const char RCSid[] = &quot;$Header: /usr/src/linux/kernel/blk_drv/scsi/RCS/scsi.c,v 1.1 1992/04/24 18:01:50 root Exp root $&quot;;&n;*/
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Build an INQUIRY command block.  */
id|scsi_cmd
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/* Wait for valid result */
r_while
c_loop
(paren
id|the_result
...
id|printk
(paren
l_string|&quot;Already have detected maximum number of SCSI %ss Unable to &bslash;n&quot;
...
suffix:semicolon
multiline_comment|/* Flag bits for the internal_timeout array */
...
c_func
(paren
l_string|&quot;Host %d is no longer busy.&quot;
)paren
suffix:semicolon
macro_line|#endif
)brace
...
multiline_comment|/*&n;&t;&t;Set up sense command in each host structure.&n;&t;*/
r_for
c_loop
(paren
id|i
