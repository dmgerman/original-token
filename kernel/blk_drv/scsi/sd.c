...
suffix:semicolon
multiline_comment|/* For a &gt; 16 Mb system, we may need an intermediate buffer for data */
...
multiline_comment|/* A unit attention comes up if there is a media change on a removable&n;   disk drive */
r_else
r_if
c_cond
(paren
...
id|CURRENT-&gt;buffer
suffix:semicolon
multiline_comment|/* Curses, curses. If this is a DMA transfer, we could be screwed. */
r_if
c_cond
(paren
(paren
...
id|panic
(paren
l_string|&quot;block buffer already in use&quot;
)paren
suffix:semicolon
id|bb
(braket
...
op_increment
suffix:semicolon
multiline_comment|/* Allocate DMA block buffer */
r_if
c_cond
(paren
id|memory_end
