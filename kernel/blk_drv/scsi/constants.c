...
DECL|macro|D
mdefine_line|#define D 0x001  /* DIRECT ACCESS DEVICE (disk) */
DECL|macro|T
mdefine_line|#define T 0x002  /* SEQUENTIAL ACCESS DEVICE (tape) */
DECL|macro|L
mdefine_line|#define L 0x004  /* PRINTER DEVICE */
DECL|macro|P
mdefine_line|#define P 0x008  /* PROCESSOR DEVICE */
DECL|macro|W
mdefine_line|#define W 0x010  /* WRITE ONCE READ MULTIPLE DEVICE */
DECL|macro|R
mdefine_line|#define R 0x020  /* READ ONLY (CD-ROM) DEVICE */
DECL|macro|S
mdefine_line|#define S 0x040  /* SCANNER DEVICE */
DECL|macro|O
mdefine_line|#define O 0x080  /* OPTICAL MEMORY DEVICE */
DECL|macro|M
mdefine_line|#define M 0x100  /* MEDIA CHANGER DEVICE */
DECL|macro|C
mdefine_line|#define C 0x200  /* COMMUNICATION DEVICE */
...
id|R
comma
l_string|&quot;Recovered data with lec&quot;
)brace
comma
(brace
l_int|0x18
...
id|D
comma
l_string|&quot;Illegal function (should use 20 00, 24 00, or 26 00)&quot;
)brace
comma
(brace
l_int|0x24
