...
macro_line|#endif
multiline_comment|/*&n;static const char RCSid[] = &quot;$Header: /usr/src/linux/kernel/blk_drv/scsi/RCS/hosts.c,v 1.1 1992/04/24 18:01:50 root Exp root $&quot;;&n;*/
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t;Initialize our semaphores.  -1 is interpreted to mean &n;&t;&t;&t;&t;&quot;inactive&quot; - where as 0 will indicate a time out condition.&n;&t;&t;&t;*/
id|host_busy
(braket
id|i
)braket
...
id|printk
(paren
l_string|&quot;Host %d is detected as a(n) %s.&bslash;n&bslash;r&quot;
comma
id|count
comma
id|scsi_hosts
...
id|printk
(paren
l_string|&quot;%d host adapters detected. &bslash;n&bslash;r&quot;
comma
id|count
)paren
suffix:semicolon
