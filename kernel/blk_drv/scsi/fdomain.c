...
DECL|macro|VERSION
mdefine_line|#define VERSION          &quot;$Revision: 3.17 $&quot;
...
suffix:semicolon
multiline_comment|/*&n;&n;  READ THIS BEFORE YOU ADD A SIGNATURE!&n;&n;  READING THIS SHORT NOTE CAN SAVE YOU LOTS OF TIME!&n;&n;  READ EVERY WORD, ESPECIALLY THE WORD *NOT*&n;&n;  This driver works *ONLY* for Future Domain cards using the TMC-1800 chip.&n;  This includes models TMC-1660, 1670, and 1680 *ONLY*.&n;&n;  The following BIOS signature signatures are for boards which do *NOT*&n;  work with this driver (but they should work with the Seagate driver):&n;&n;  FUTURE DOMAIN CORP. (C) 1986-1988 V4.0I 03/16/88&n;  FUTURE DOMAIN CORP. (C) 1986-1989 V5.0C2/14/89&n;  FUTURE DOMAIN CORP. (C) 1986-1989 V6.0A7/28/89&n;  FUTURE DOMAIN CORP. (C) 1986-1990 V6.0105/31/90&n;  FUTURE DOMAIN CORP. (C) 1986-1990 V6.0209/18/90&n;  FUTURE DOMAIN CORP. (C) 1986-1990 V7.009/18/90&n;  FUTURE DOMAIN CORP. (C) 1992 V8.00.004/02/92&n;&n;*/
...
comma
multiline_comment|/* READ NOTICE ABOVE *BEFORE* YOU WASTE YOUR TIME ADDING A SIGANTURE&n;    Also, fix the disk geometry code for your signature and send your&n;    changes for faith@cs.unc.edu.  Above all, do *NOT* change any old&n;    signatures! */
)brace
suffix:semicolon
...
c_func
(paren
l_string|&quot;Future Domain: must use interrupt-driven driver&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
r_else
(brace
multiline_comment|/* How the data is stored in the RAM area is very BIOS-dependent.&n;         Therefore, return nothing if we are not *SURE* of the information. */
id|info_array
(braket
l_int|0
)braket
