...
id|vsize
suffix:semicolon
multiline_comment|/*&n;&t; * First check to see if there is enough free_space to continue&n;&t; * the process accounting system. Check_free_space toggles the&n;&t; * acct_active flag so we need to check that after check_free_space.&n;&t; */
id|check_free_space
c_func
(paren
)paren
