...
l_int|NULL
suffix:semicolon
multiline_comment|/* Update links */
r_if
c_cond
(paren
id|p-&gt;p_osptr
...
multiline_comment|/* If the signal will be ignored, don&squot;t even post it */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t; * This loop does two things:&n;&t; * &n;  &t; * A.  Make init inherit all the child processes&n;&t; * B.  Check to see if any process groups have become orphaned&n;&t; *&t;as a result of our exiting, and if they have any stopped&n;&t; *&t;jons, send them a SIGUP and then a SIGCONT.  (POSIX 3.2.2.2)&n;&t; */
r_if
c_cond
(paren
id|p
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * process group orphan check&n;&t;&t;&t; * Case ii: Our child is in a different pgrp &n;&t;&t;&t; * than we are, and it was the only connection&n;&t;&t;&t; * outside, so the child pgrp is now orphaned.&n;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;&t;&t;&t; * This is it; link everything into init&squot;s children &n;&t;&t;&t; * and leave &n;&t;&t;&t; */
id|p-&gt;p_osptr
op_assign
id|task
(braket
