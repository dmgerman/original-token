...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Are we cloning a kernel thread?&n;&t; */
id|mm
op_assign
id|current-&gt;mm
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * No need to worry about the LDT descriptor for the&n;&t;&t; * cloned task, LDTs get magically loaded at&n;&t;&t; * __switch_to time if necessary.&n;&t;&t; */
id|SET_PAGE_DIR
c_func
(paren
id|tsk
...
multiline_comment|/*&n; * Copy a fd_set and compute the maximum fd it contains. &n; */
