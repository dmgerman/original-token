multiline_comment|/*---------------------------------------------------------------------------+&n; |  reg_ld_str.c                                                             |&n; |                                                                           |&n; | All of the functions which transfer data between user memory and REGs.    |&n; |                                                                           |&n; | Copyright (C) 1992    W. Metzenthen, 22 Parker St, Ormond, Vic 3163,      |&n; |                       Australia.  E-mail apm233m@vaxc.cc.monash.edu.au    |&n; |                                                                           |&n; |                                                                           |&n; +---------------------------------------------------------------------------*/
...
op_increment
suffix:semicolon
multiline_comment|/* no need to check here for overflow */
)brace
r_else
(brace
multiline_comment|/* No overflow of sigh will happen, can safely increment */
id|l
(braket
l_int|0
)braket
...
r_else
(brace
multiline_comment|/* No increment required */
id|l
(braket
l_int|0
)braket
...
(brace
multiline_comment|/* See if we can get a valid NaN from the REG */
id|l
(braket
l_int|0
)braket
...
(brace
multiline_comment|/* sigh would overflow */
id|exp
op_increment
suffix:semicolon
id|sigh
