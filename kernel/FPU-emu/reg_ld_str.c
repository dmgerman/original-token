...
DECL|macro|LOST_UP
mdefine_line|#define LOST_UP    (EX_Precision | SW_C1)
DECL|macro|LOST_DOWN
mdefine_line|#define LOST_DOWN  EX_Precision
...
multiline_comment|/* The 80486 doesn&squot;t regard pseudodenormals as denormals here. */
r_if
c_cond
(paren
op_logical_neg
...
op_increment
suffix:semicolon
multiline_comment|/* The default behaviour will now take care of it. */
)brace
r_else
r_if
c_cond
...
(brace
multiline_comment|/* Unsupported NaN data type */
id|EXCEPTION
c_func
(paren
id|EX_Invalid
...
(brace
multiline_comment|/* Correctly format the de-normal */
r_int
id|precision_loss
suffix:semicolon
id|FPU_REG
...
r_else
(brace
multiline_comment|/* ****** ??? This should not be possible */
id|EXCEPTION
c_func
(paren
id|EX_Underflow
...
macro_line|#if 0 /* TW_Denormal is not used yet, and probably won&squot;t be */
r_else
r_if
c_cond
(paren
...
l_int|0x037f
suffix:semicolon
multiline_comment|/* Mask all interrupts while we load. */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* The current data is a special, i.e. NaN, unsupported, infinity,&n;&t;     or denormal */
r_int
r_char
id|t
op_assign
...
id|tag
suffix:semicolon
multiline_comment|/* derived from the new data */
r_if
c_cond
(paren
multiline_comment|/* (t == TW_Valid) || ****/
(paren
id|t
op_eq
id|TW_Zero
...
(brace
multiline_comment|/* Store each register in the order: st(0), st(1), ... */
id|rp
op_assign
op_amp
id|regs
