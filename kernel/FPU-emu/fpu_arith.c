multiline_comment|/*---------------------------------------------------------------------------+&n; |  fpu_arith.c                                                              |&n; |                                                                           |&n; | Code to implement the FPU register/register arithmetis instructions       |&n; |                                                                           |&n; | Copyright (C) 1992    W. Metzenthen, 22 Parker St, Ormond, Vic 3163,      |&n; |                       Australia.  E-mail apm233m@vaxc.cc.monash.edu.au    |&n; |                                                                           |&n; |                                                                           |&n; +---------------------------------------------------------------------------*/
...
multiline_comment|/* This is the sense of the 80486 manual&n;     reg_sub(&amp;st(FPU_rm), FPU_st0_ptr, &amp;st(FPU_rm)); */
id|reg_sub
c_func
(paren
id|FPU_st0_ptr
...
multiline_comment|/* This is the sense of the 80486 manual&n;     reg_sub(FPU_st0_ptr, &amp;st(FPU_rm), &amp;st(FPU_rm)); */
id|reg_sub
c_func
(paren
op_amp
