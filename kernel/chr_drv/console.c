...
DECL|macro|kbdraw
mdefine_line|#define kbdraw&t;&t;(vc_cons[currcons].vc_kbdraw)
DECL|macro|kbde0
mdefine_line|#define kbde0&t;&t;(vc_cons[currcons].vc_kbde0)
DECL|macro|kbdleds
...
r_return
suffix:semicolon
multiline_comment|/* no output in graphics mode */
r_while
c_loop
(paren
id|c
