...
multiline_comment|/*&n;&t;&t; * If the new IRQ is OK, now we unlink the async structure from&n;&t;&t; * the existing interrupt chain.&n;&t;&t; */
r_if
c_cond
(paren
id|info-&gt;next_port
...
id|info
suffix:semicolon
multiline_comment|/* To avoid second change_speed */
)brace
id|sti
c_func
(paren
...
multiline_comment|/*&n;&t; * Link in port to IRQ chain&n;&t; */
id|info-&gt;prev_port
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;Serial driver version 3.8 with&quot;
)paren
suffix:semicolon
macro_line|#ifdef CONFIG_AST_FOURPORT
id|printk
