...
multiline_comment|/*&n; * rs_event&t;&t;- Bitfield of serial lines that events pending&n; * &t;&t;&t;&t;to be processed at the next clock tick.&n; *&n; * We assume here that int&squot;s are 32 bits, so an array of two gives us&n; * 64 lines, which is the maximum we can support.&n; */
...
multiline_comment|/*&n; * ------------------------------------------------------------&n; * rs_throttle()&n; * &n; * This routine is called by the upper-layer tty layer to signal that&n; * incoming characters should be throttled (and that the throttled&n; * should be released).&n; * ------------------------------------------------------------&n; */
