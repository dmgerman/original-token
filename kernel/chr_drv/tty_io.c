...
id|dev
suffix:semicolon
multiline_comment|/*&n; * There be race-conditions here... Lots of them. Careful now.&n; */
id|tty
op_assign
id|o_tty
op_assign
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Stop our allocation of tty if race&n;&t;&t;&t; * condition detected.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|tty
...
op_increment
suffix:semicolon
multiline_comment|/* bump count to preserve tty */
r_if
c_cond
(paren
id|IS_A_PTY
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * Stop our allocation of o_tty if race&n;&t;&t;&t;&t; * condition detected.&n;&t;&t;&t;&t; */
id|free_page
c_func
(paren
(paren
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Free the tty structure, being careful to avoid race conditions&n;&t;&t; */
id|free_tty_struct
op_assign
(paren
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If this is a PTY, free the termios structure, being&n;&t;&t; * careful to avoid race conditions&n;&t;&t; */
r_if
c_cond
(paren
id|IS_A_PTY
...
multiline_comment|/*&n;&t; * Free the tty structure, being careful to avoid race conditions&n;&t; */
id|free_tty_struct
op_assign
(paren
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * If this is a PTY, free the termios structure, being careful&n;&t; * to avoid race conditions&n;&t; */
r_if
c_cond
(paren
id|IS_A_PTY
