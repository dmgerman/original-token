...
multiline_comment|/*&n; * This routine copies out a maximum of buflen characters from the&n; * read_q; it is a convenience for line disciplins so they can grab a&n; * large block of data without calling get_tty_char directly.  It&n; * returns the number of characters actually read.&n; */
...
suffix:semicolon
DECL|variable|vhung_up_tty_fops
r_static
r_struct
id|file_operations
id|vhung_up_tty_fops
op_assign
(brace
id|tty_lseek
comma
...
multiline_comment|/* If not a break, then a parity or frame error */
id|tty-&gt;char_error
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/*&n;&t; *  Why is this not done in init_dev?  Right here, if another &n;&t; * process opens up a tty in packet mode, all the packet &n;&t; * variables get cleared.  Come to think of it, is anything &n;&t; * using the packet mode at all???  - Ted, 1/27/93&n;&t; */
id|tty-&gt;status_changed
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;size of tty structure &gt; 4096!&quot;
)paren
suffix:semicolon
r_if
c_cond
