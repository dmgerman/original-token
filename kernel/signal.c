...
suffix:semicolon
multiline_comment|/* 387 state pointer */
multiline_comment|/* linux extended stack - easier to handle.. */
id|put_fs_long
c_func
(paren
id|regs-&gt;eflags
...
suffix:semicolon
multiline_comment|/* pop %gs ; pop %fs */
id|put_fs_long
c_func
(paren
l_int|0x611f07a1
...
suffix:semicolon
multiline_comment|/* pop %es ; pop %ds ; popad */
id|put_fs_long
c_func
(paren
l_int|0x20c48390
...
suffix:semicolon
multiline_comment|/* nop ; addl $32,%esp */
id|put_fs_long
c_func
(paren
l_int|0x0020c29d
...
suffix:semicolon
multiline_comment|/* popfl ; ret $32 */
id|put_fs_long
c_func
(paren
id|__NR_ssetmask
