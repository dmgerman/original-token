...
multiline_comment|/*&n; * Dequeue a signal and return the element to the caller, which is &n; * expected to free it.&n; *&n; * All callers of must be holding current-&gt;sigmask_lock.&n; */
r_int
...
multiline_comment|/*&n; * kill_something() interprets pid in interesting ways just like kill(2).&n; *&n; * POSIX specifies that kill(-1,sig) is unspecified, but what we have&n; * is probably wrong.  Should make it like BSD or SYSV.&n; */
r_int
