...
multiline_comment|/*&n; * Copy the kernel symbol table to user space.  If the argument is&n; * NULL, just return the size of the table.&n; *&n; * This call is depreciated in favour of query_module+QM_SYMBOLS which&n; * does not arbitrarily limit the length of the symbol.&n; */
id|asmlinkage
r_int
...
id|q
suffix:semicolon
DECL|macro|safe_copystr
mdefine_line|#define safe_copystr(str, len)&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;do {&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;if (left &lt; len)&t;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;&t;goto fini;&t;&t;&t;&t;&bslash;&n;&t;&t;&t;memcpy(p, str, len); p += len, left -= len;&t;&bslash;&n;&t;&t;} while (0)
id|len
op_assign
id|strlen
c_func
