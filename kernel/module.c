...
(brace
multiline_comment|/* Should return -EBIG instead of -EFAULT when the name&n;       is too long, but that we couldn&squot;t detect real faults then.&n;       Maybe strncpy_from_user() should return -EBIG, when&n;       the source string is too long. */
r_return
...
suffix:semicolon
r_int
DECL|function|register_symtab_from
...
(brace
multiline_comment|/*&n;&t;&t; * &quot;from&quot; points to &quot;mod_use_count_&quot; (== start of module)&n;&t;&t; * or is == 0 if called from a non-module&n;&t;&t; */
r_if
c_cond
(paren
(paren
