...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Create the slave init tasks. At this point&n;&t; *&t;fork will create them all ask task 0&n;&t; */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* We are forking multiple process 0&squot;s. This makes it harder&n;&t;&t;   to tell them apart than we would like ;) */
r_if
c_cond
(paren
id|current
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* we count on the clone going ok */
r_if
c_cond
(paren
op_logical_neg
