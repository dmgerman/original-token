multiline_comment|/* $Id: identify.c,v 1.5 2000/01/17 23:32:46 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * identify.c: identify machine by looking up system identifier&n; *&n; * Copyright (C) 1998 Thomas Bogendoerfer&n; * &n; * This code is based on arch/mips/sgi/kernel/system.c, which is&n; * &n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
