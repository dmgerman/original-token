multiline_comment|/* $Id: ip27-memory.c,v 1.9 2000/02/10 09:07:31 kanoj Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Copyright (C) 2000 by Ralf Baechle&n; * Copyright (C) 2000 by Silicon Graphics, Inc.&n; *&n; * On SGI IP27 the ARC memory configuration data is completly bogus but&n; * alternate easier to use mechanisms are available.&n; */
...
multiline_comment|/*&n; * HACK ALERT - Things do not work if this is not here. Maybe this is&n; * acting as a pseudocacheflush operation. The write pattern seems to&n; * be important, writing a 0 does not help.&n; */
DECL|function|setup_test
r_void
id|setup_test
c_func
(paren
...
l_int|1024
suffix:semicolon
multiline_comment|/* 4M L2 caches */
r_while
c_loop
(paren
id|size
...
op_assign
(paren
l_int|0xdeadbeefbabeb000UL
op_or
id|node
)paren
suffix:semicolon
multiline_comment|/* *ptr = 0; */
id|ptr
op_increment
suffix:semicolon
)brace
...
(brace
multiline_comment|/* Ignore holes */
r_if
c_cond
(paren
id|PageSkip
