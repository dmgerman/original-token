multiline_comment|/* $Id: r4xx0.c,v 1.8 2000/02/24 00:12:41 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * r4xx0.c: R4000 processor variant specific MMU/Cache routines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; * Copyright (C) 1997, 1998, 1999 Ralf Baechle (ralf@gnu.org)&n; * Copyright (C) 1999 Silicon Graphics, Inc.&n; */
...
multiline_comment|/* If the addresses passed to these routines are valid, they are either:&n; *&n; * 1) In KSEG0, so we can do a direct flush of the page.&n; * 2) In KSEG2, and since every process can translate those addresses all&n; *    the time in kernel mode we can do a direct flush.&n; * 3) In KSEG1, no flush necessary.&n; */
r_static
r_void
