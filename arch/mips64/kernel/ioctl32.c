multiline_comment|/* $Id: ioctl32.c,v 1.1 2000/04/05 00:43:25 ulfc Exp $&n; * ioctl32.c: Conversion between 32bit and 64bit native ioctls.&n; *&n; * Copyright (C) 2000 Silicon Graphics, Inc.&n; * Written by Ulf Carlsson (ulfc@engr.sgi.com)&n; *&n; * Mostly from the sparc64 ioctl32 implementation.&n; */
