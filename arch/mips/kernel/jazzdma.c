...
multiline_comment|/* find free chunk */
id|pages
op_assign
(paren
id|size
...
multiline_comment|/* mark pages as allocated */
id|laddr
op_assign
(paren
id|first
...
multiline_comment|/*&n;     * update translation table and&n;     * return logical start address&n;     */
id|r4030_write_reg32
c_func
(paren
id|JAZZ_R4030_TRSTBL_INV
...
multiline_comment|/* update translation table */
id|r4030_write_reg32
c_func
(paren
id|JAZZ_R4030_TRSTBL_INV
