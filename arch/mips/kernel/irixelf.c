...
suffix:semicolon
multiline_comment|/* Make sure we will be aligned properly at the end of this. */
id|csp
op_assign
id|sp
suffix:semicolon
...
DECL|macro|INTERP_ALIGN
mdefine_line|#define INTERP_ALIGN  (~((64 * 1024) - 1))
id|NEW_AUX_ENT
(paren
l_int|0
comma
...
c_func
(paren
l_string|&quot;Could not open IRIX interp inode.&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
DECL|function|do_load_irix_library
r_static
r_inline
r_int
id|do_load_irix_library
c_func
(paren
r_int
id|fd
...
op_logical_or
op_logical_neg
id|dentry-&gt;d_inode-&gt;i_op-&gt;default_file_ops-&gt;mmap
)paren
)paren
(brace
r_return
