multiline_comment|/*&n; * Support the inventory interface for IRIX binaries&n; * This is invoked before the mm layer is working, so we do not&n; * use the linked lists for the inventory yet. &n; *&n; * Miguel de Icaza, 1997.&n; *&n; * $Id: irixinv.c,v 1.3 1998/03/27 08:53:40 ralf Exp $&n; */
