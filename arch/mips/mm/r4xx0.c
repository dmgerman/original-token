multiline_comment|/*&n; * r4xx0.c: R4000 processor variant specific MMU/Cache routines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; *&n; * $Id: r4xx0.c,v 1.11 1997/12/02 06:33:53 ralf Exp $&n; *&n; * To do:&n; *&n; *  - this code is a overbloated pig&n; *  - many of the bug workarounds are not efficient at all, but at&n; *    least they are functional ...&n; */
...
multiline_comment|/*&n; * Zero an entire page.  We have three flavours of the routine available.&n; * One for CPU with 16byte, with 32byte cachelines plus a special version&n; * with nops which handles the buggy R4600 v1.x.&n; */
...
r_static
r_void
DECL|function|r4k_flush_cache_pre_dma_out_pc
id|r4k_flush_cache_pre_dma_out_pc
c_func
(paren
r_int
r_int
...
id|cmode
op_eq
id|CONFIG_CM_CACHABLE_WA
op_logical_or
id|cmode
op_eq
id|CONFIG_CM_CACHABLE_NO_WA
)paren
(brace
multiline_comment|/* primary dcache is writethrough, therefore memory&n;&t;&t;   is already consistent with the caches.  */
r_return
suffix:semicolon
)brace
r_if
...
r_static
r_void
DECL|function|r4k_flush_cache_pre_dma_out_sc
id|r4k_flush_cache_pre_dma_out_sc
c_func
(paren
r_int
r_int
...
r_static
r_void
DECL|function|r4k_flush_cache_post_dma_in_pc
id|r4k_flush_cache_post_dma_in_pc
c_func
(paren
r_int
r_int
...
r_static
r_void
DECL|function|r4k_flush_cache_post_dma_in_sc
id|r4k_flush_cache_post_dma_in_sc
c_func
(paren
r_int
r_int
...
multiline_comment|/* XXX Do these for Indy style caches also.  No need for now ... */
id|flush_cache_pre_dma_out
op_assign
id|r4k_flush_cache_pre_dma_out_sc
suffix:semicolon
...
suffix:semicolon
singleline_comment|//set_cp0_config(CONFIG_CM_CMASK, CONFIG_CM_CACHABLE_WA);
singleline_comment|//set_cp0_config(CONFIG_CM_CMASK, CONFIG_CM_CACHABLE_NO_WA);
id|probe_icache
c_func
(paren
id|cfg
...
id|CPU_R5000
suffix:colon
multiline_comment|/* XXX: We don&squot;t handle the true R5000 SCACHE */
r_case
id|CPU_NEVADA
suffix:colon
id|probe_scache_kseg1
...
suffix:semicolon
multiline_comment|/* Try using tags if eeprom gives us bogus data. */
r_if
c_cond
(paren
id|sc_present
...
(brace
multiline_comment|/* Has a true secondary cache. */
id|setup_scache_funcs
c_func
(paren
)paren
...
r_else
(brace
multiline_comment|/* Lacks true secondary cache. */
id|setup_noscache_funcs
c_func
(paren
)paren
...
multiline_comment|/* XXX Handle true second level cache w/ split I/D */
