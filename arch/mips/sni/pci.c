multiline_comment|/* $Id: pci.c,v 1.9 1999/12/04 03:59:00 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * SNI specific PCI support for RM200/RM300.&n; *&n; * Copyright (C) 1997, 1998, 1999 Ralf Baechle&n; */
...
DECL|macro|mkaddr
mdefine_line|#define mkaddr(dev, where)                                                   &bslash;&n;do {                                                                         &bslash;&n;&t;if ((dev)-&gt;bus-&gt;number == 0)                                         &bslash;&n;&t;&t;return -1;                                                   &bslash;&n;&t;*(volatile u32 *)PCIMT_CONFIG_ADDRESS =                              &bslash;&n;&t;&t; ((dev-&gt;bus-&gt;number    &amp; 0xff) &lt;&lt; 0x10) |                    &bslash;&n;&t;         ((dev-&gt;dev_fn &amp; 0xff) &lt;&lt; 0x08) |                            &bslash;&n;&t;         (where  &amp; 0xfc);                                            &bslash;&n;} while(0);
multiline_comment|/* To do:  Bring this uptodate ...  */
DECL|function|pcimt_pcibios_fixup
r_static
r_void
