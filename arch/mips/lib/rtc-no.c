multiline_comment|/* $Id: rtc-no.c,v 1.1 1998/06/30 00:21:55 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Stub RTC routines to keep Linux from crashing on machine which don&squot;t&n; * have a RTC chip.&n; *&n; * Copyright (C) 1998 by Ralf Baechle&n; */
