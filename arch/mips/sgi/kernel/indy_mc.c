multiline_comment|/* $Id: indy_mc.c,v 1.1 1997/06/06 09:36:24 ralf Exp $&n; * indy_mc.c: Routines for manipulating the INDY memory controller.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
