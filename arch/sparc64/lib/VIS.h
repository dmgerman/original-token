multiline_comment|/* $Id: VIS.h,v 1.3 1997/06/27 14:53:18 jj Exp $&n; * VIS.h: High speed copy/clear operations utilizing the UltraSparc&n; *        Visual Instruction Set.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996, 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
mdefine_line|#define ASI_SETSRC_NOBLK&t;wr&t;asi_src, ASI_BLK_XOR, %asi;
DECL|macro|ASI_SETDST_BLK
mdefine_line|#define ASI_SETDST_BLK&t;&t;wr&t;asi_dest, 0, %asi;
DECL|macro|ASI_SETDST_NOBLK
mdefine_line|#define ASI_SETDST_NOBLK&t;wr&t;asi_dest, ASI_BLK_XOR, %asi;
DECL|macro|ASIBLK
