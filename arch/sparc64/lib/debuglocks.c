multiline_comment|/* $Id: debuglocks.c,v 1.2 1998/10/13 09:07:27 davem Exp $&n; * debuglocks.c: Debugging versions of SMP locking primitives.&n; *&n; * Copyright (C) 1998 David S. Miller (davem@dm.cobaltmicro.com)&n; */
