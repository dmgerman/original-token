multiline_comment|/* $Id: misc.c,v 1.14 1998/12/18 10:01:59 davem Exp $&n; * misc.c:  Miscellaneous prom functions that don&squot;t belong&n; *          anywhere else.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996,1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
multiline_comment|/* This is only used internally below. */
...
c_func
(paren
l_string|&quot;PROMLIB: Fatal error, cannot get mmu ihandle.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
