multiline_comment|/* $Id: ranges.c,v 1.7 1997/08/15 06:44:29 davem Exp $&n; * ranges.c: Handle ranges in newer proms for obio/sbus.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
macro_line|#ifdef CONFIG_PCI
DECL|function|prom_apply_ebus_ranges
r_void
...
c_func
(paren
l_string|&quot;WARNING: %s: ot_parent_base high lost&bslash;n&quot;
)paren
suffix:semicolon
id|ebus-&gt;ebus_ranges
(braket
