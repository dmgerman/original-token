multiline_comment|/* $Id: traps.c,v 1.19 1997/06/05 06:22:49 davem Exp $&n; * arch/sparc/kernel/traps.c&n; *&n; * Copyright (C) 1995,1997 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
suffix:semicolon
multiline_comment|/* This is allowed now because the V9 ABI varargs passes floating&n;&t; * point args in floating point registers, so vsprintf() and sprintf()&n;&t; * cause problems.  Luckily we never actually pass floating point values&n;&t; * to those routines in the kernel and the code generated just does&n;&t; * stores of them to the stack.  Therefore, for the moment this fix&n;&t; * is sufficient. -DaveM&n;&t; */
r_if
c_cond
(paren
id|regs-&gt;tstate
...
r_else
(brace
multiline_comment|/* Set inital sane state. */
id|fpload
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;WARNING: FPU exception from kernel mode. at pc=%016lx&bslash;n&quot;
comma
id|regs-&gt;tpc
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;MNA from kernel, spinning&bslash;n&quot;
)paren
suffix:semicolon
id|sti
c_func
