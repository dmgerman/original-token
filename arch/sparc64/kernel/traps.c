multiline_comment|/* $Id: traps.c,v 1.62 1999/08/31 19:25:35 davem Exp $&n; * arch/sparc64/kernel/traps.c&n; *&n; * Copyright (C) 1995,1997 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1997,1999 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
