multiline_comment|/*  $Id: process.c,v 1.98 1999/08/02 08:39:35 davem Exp $&n; *  arch/sparc64/kernel/process.c&n; *&n; *  Copyright (C) 1995, 1996 David S. Miller (davem@caip.rutgers.edu)&n; *  Copyright (C) 1996       Eddie C. Dost   (ecd@skynet.be)&n; *  Copyright (C) 1997, 1998 Jakub Jelinek   (jj@sunsite.mff.cuni.cz)&n; */
...
c_func
(paren
l_string|&quot;&bslash;ncopy_thread: c(%p[mm(%p:%p)]) p(%p[mm(%p:%p)])&bslash;n&quot;
comma
id|current
comma
id|current-&gt;mm
...
c_func
(paren
l_string|&quot;copy_thread: c MM_ctx(%016lx) MM_pgd(%016lx)&bslash;n&quot;
comma
(paren
id|current-&gt;mm
ques
...
c_func
(paren
l_string|&quot;copy_thread: p MM_ctx(%016lx) MM_pgd(%08x)&bslash;n&quot;
comma
(paren
id|p-&gt;mm
ques
...
c_func
(paren
l_string|&quot;copy_thread: c-&gt;flags(%x) p-&gt;flags(%x) &quot;
comma
id|current-&gt;thread.flags
comma
id|p-&gt;thread.flags
