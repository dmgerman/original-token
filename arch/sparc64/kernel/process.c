multiline_comment|/*  $Id: process.c,v 1.54 1998/04/28 08:23:28 davem Exp $&n; *  arch/sparc64/kernel/process.c&n; *&n; *  Copyright (C) 1995, 1996 David S. Miller (davem@caip.rutgers.edu)&n; *  Copyright (C) 1996       Eddie C. Dost   (ecd@skynet.be)&n; *  Copyright (C) 1997, 1998 Jakub Jelinek   (jj@sunsite.mff.cuni.cz)&n; */
...
suffix:semicolon
DECL|function|ultra_check_pgt_cache
r_static
r_inline
r_void
id|ultra_check_pgt_cache
c_func
(paren
r_void
)paren
