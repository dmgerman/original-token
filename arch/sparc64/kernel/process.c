multiline_comment|/*  $Id: process.c,v 1.26 1997/07/01 21:15:07 jj Exp $&n; *  arch/sparc64/kernel/process.c&n; *&n; *  Copyright (C) 1995, 1996 David S. Miller (davem@caip.rutgers.edu)&n; *  Copyright (C) 1996 Eddie C. Dost   (ecd@skynet.be)&n; *  Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
id|tframe_size
suffix:semicolon
macro_line|#if 0&t;/* Now all syscall entries flip off the fpu. */
r_if
c_cond
(paren
id|regs-&gt;tstate
