multiline_comment|/* $Id: pci_iommu.c,v 1.10 2000/02/18 13:48:54 davem Exp $&n; * pci_iommu.c: UltraSparc PCI controller IOM/STC support.&n; *&n; * Copyright (C) 1999 David S. Miller (davem@redhat.com)&n; * Copyright (C) 1999, 2000 Jakub Jelinek (jakub@redhat.com)&n; */
...
id|base_paddr
suffix:semicolon
multiline_comment|/* Flush the IOMMU TLB. */
r_if
c_cond
(paren
id|iommu-&gt;iommu_ctxflush
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Step 6: Flush the IOMMU TLB. */
r_if
c_cond
(paren
id|iommu-&gt;iommu_ctxflush
