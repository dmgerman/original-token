...
DECL|struct|blkelv_ioctl32_arg_s
r_typedef
r_struct
id|blkelv_ioctl32_arg_s
(brace
...
suffix:semicolon
DECL|typedef|blkelv_ioctl32_arg_t
)brace
id|blkelv_ioctl32_arg_t
suffix:semicolon
DECL|function|do_blkelv_ioctl
r_static
r_int
id|do_blkelv_ioctl
c_func
...
c_func
(paren
id|b.max_bomb_segments
comma
op_amp
id|arg-&gt;max_bomb_segments
)paren
suffix:semicolon
r_if
c_cond
