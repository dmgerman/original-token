multiline_comment|/* $Id: ioctl32.c,v 1.35 1998/04/10 02:01:46 davem Exp $&n; * ioctl32.c: Conversion between 32bit and 64bit native ioctls.&n; *&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; *&n; * These routines maintain argument size conversion between 32bit and 64bit&n; * ioctls.&n; */
...
c_func
(paren
l_string|&quot;ppp_ioctl: Unknown cmd fd(%d) cmd(%08x) arg(%08x)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;mt_ioctl: Unknown cmd fd(%d) cmd(%08x) arg(%08x)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;cdrom_ioctl: Unknown cmd fd(%d) cmd(%08x) arg(%08x)&bslash;n&quot;
comma
(paren
r_int
)paren
...
id|VUIDGFORMAT
suffix:colon
multiline_comment|/* Little p (/dev/rtc etc.) */
r_case
id|RTCGET
suffix:colon
r_case
