multiline_comment|/* $Id: time.c,v 1.5 1997/07/23 11:32:06 davem Exp $&n; * time.c: UltraSparc timer and TOD clock support.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * Based largely on code which is:&n; *&n; * Copyright (C) 1996 Thomas K. Dyas (tdyas@eden.rutgers.edu)&n; */
...
c_func
(paren
l_string|&quot;clock_probe: Serious problem can&squot;t find sbus PROM node.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
c_func
(paren
l_string|&quot;clock_probe: Cannot get XXX sbus ranges&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
c_func
(paren
l_string|&quot;clock_probe: Cannot make Mostek&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
multiline_comment|/* XXX fix me badly */
id|prom_adjust_regs
c_func
(paren
id|clk_reg
