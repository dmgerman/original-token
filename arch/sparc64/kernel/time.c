multiline_comment|/* $Id: time.c,v 1.22 1999/08/30 10:01:22 davem Exp $&n; * time.c: UltraSparc timer and TOD clock support.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1998 Eddie C. Dost   (ecd@skynet.be)&n; *&n; * Based largely on code which is:&n; *&n; * Copyright (C) 1996 Thomas K. Dyas (tdyas@eden.rutgers.edu)&n; */
...
l_int|1
comma
id|SBus_chain-&gt;sbus_ranges
comma
id|SBus_chain-&gt;num_sbus_ranges
)paren
suffix:semicolon
)brace
r_if
