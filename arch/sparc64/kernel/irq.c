multiline_comment|/* $Id: irq.c,v 1.47 1998/01/10 18:26:17 ecd Exp $&n; * irq.c: UltraSparc IRQ handling/init/registry.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
...
id|len
comma
l_string|&quot;ISTAT[%d]: PCI[%016lx] OBIO[%016lx]&bslash;n&quot;
comma
id|p-&gt;index
comma
id|p-&gt;psycho_regs-&gt;pci_istate
comma
id|p-&gt;psycho_regs-&gt;obio_istate
)paren
suffix:semicolon
)brace
macro_line|#endif
