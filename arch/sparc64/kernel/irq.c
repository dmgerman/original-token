multiline_comment|/* $Id: irq.c,v 1.66 1998/10/21 15:02:25 ecd Exp $&n; * irq.c: UltraSparc IRQ handling/init/registry.&n; *&n; * Copyright (C) 1997  David S. Miller  (davem@caip.rutgers.edu)&n; * Copyright (C) 1998  Eddie C. Dost    (ecd@skynet.be)&n; * Copyright (C) 1998  Jakub Jelinek    (jj@ultra.linux.cz)&n; */
...
multiline_comment|/* #define SMP_IRQ_VERBOSE */
...
id|level
suffix:semicolon
macro_line|#ifdef SMP_IRQ_VERBOSE
id|printk
c_func
(paren
