multiline_comment|/* $Id: irq.c,v 1.39 1997/08/31 03:11:18 davem Exp $&n; * irq.c: UltraSparc IRQ handling/init/registry.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
...
id|len
comma
l_string|&quot;ISTAT: PCI[%016lx] OBIO[%016lx]&bslash;n&quot;
comma
id|psycho_root-&gt;psycho_regs-&gt;pci_istate
comma
id|psycho_root-&gt;psycho_regs-&gt;obio_istate
)paren
suffix:semicolon
macro_line|#endif
macro_line|#endif
...
mdefine_line|#define psycho_imap_offset(ino)&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;((ino &amp; 0x20) ? (psycho_offset(imap_scsi) + (((ino) &amp; 0x1f) &lt;&lt; 3)) :&t;&bslash;&n;&t;&t;&t;(psycho_offset(imap_a_slot0) + (((ino) &amp; 0x3c) &lt;&lt; 1)))
DECL|macro|psycho_iclr_offset
mdefine_line|#define psycho_iclr_offset(ino)&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;((ino &amp; 0x20) ? (psycho_offset(iclr_scsi) + (((ino) &amp; 0x1f) &lt;&lt; 3)) :&t;&bslash;&n;&t;&t;&t;(psycho_offset(iclr_a_slot0[0]) + (((ino) &amp; 0x1f) &lt;&lt; 3)))
macro_line|#endif
...
l_int|NULL
suffix:semicolon
multiline_comment|/* This is gets the master level10 timer going. */
