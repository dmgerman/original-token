multiline_comment|/* $Id: sbus.c,v 1.7 2000/01/28 13:41:58 jj Exp $&n; * sbus.c: UltraSparc SBUS controller support.&n; *&n; * Copyright (C) 1999 David S. Miller (davem@redhat.com)&n; */
...
suffix:semicolon
multiline_comment|/* Flushing heuristics */
DECL|macro|IOMMU_DIAG_LIM
mdefine_line|#define IOMMU_DIAG_LIM&t;16
DECL|macro|STRBUF_DIAG_LIM
mdefine_line|#define STRBUF_DIAG_LIM&t;32
...
multiline_comment|/* In an effort to keep latency under control, we special&n; * case single page IOMMU flushes.&n; */
