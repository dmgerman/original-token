multiline_comment|/* sparcelf32.c: Support 32-bit Sparc ELF binaries on Ultra.&n; *&n; * This is just binfmt_elf.c with hooks so that the types are those&n; * for a 32-bit ELF binaries.&n; */
multiline_comment|/* This makes it work. */
DECL|macro|ELF_ARCH
...
suffix:semicolon
macro_line|#else
DECL|macro|elf32_core_dump
mdefine_line|#define elf32_core_dump&t;NULL
macro_line|#endif
...
DECL|function|create_elf32_tables
id|__u32
op_star
id|create_elf32_tables
c_func
(paren
r_char
op_star
...
DECL|function|load_elf32_interp
r_static
r_int
r_int
id|load_elf32_interp
c_func
(paren
r_struct
id|elfhdr
...
DECL|function|load_aout32_interp
r_static
r_int
r_int
id|load_aout32_interp
c_func
(paren
r_struct
id|exec
...
r_inline
r_int
DECL|function|do_load_elf32_binary
id|do_load_elf32_binary
c_func
(paren
r_struct
id|linux_binprm
...
r_static
r_int
DECL|function|load_elf32_binary
id|load_elf32_binary
c_func
(paren
r_struct
...
r_inline
r_int
DECL|function|do_load_elf32_library
(def_block
id|do_load_elf32_library
c_func
(paren
r_int
id|fd
...
id|EACCES
suffix:semicolon
multiline_comment|/* seek to the beginning of the file */
r_if
c_cond
(paren
id|file-&gt;f_op-&gt;llseek
...
DECL|function|load_elf32_library
r_static
r_int
id|load_elf32_library
c_func
...
l_int|0
suffix:semicolon
macro_line|#ifndef CONFIG_BINFMT_ELF32
id|MOD_INC_USE_COUNT
suffix:semicolon
macro_line|#endif
