multiline_comment|/* $Id: sys_sparc32.c,v 1.71 1997/12/11 15:15:11 jj Exp $&n; * sys_sparc32.c: Conversion between 32bit and 64bit native syscalls.&n; *&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * These routines maintain argument size conversion between 32bit and 64bit&n; * environment.&n; */
...
r_char
op_star
id|getname_quicklist
suffix:semicolon
r_extern
r_int
id|getname_quickcount
suffix:semicolon
r_extern
r_struct
id|semaphore
id|getname_quicklock
suffix:semicolon
r_extern
r_int
id|kerneld_msqid
suffix:semicolon
multiline_comment|/* Tuning: increase locality by reusing same pages again...&n; * if getname_quicklist becomes too long on low memory machines, either a limit&n; * should be added or after a number of cycles some pages should&n; * be released again ...&n; */
...
c_func
(paren
l_string|&quot;Tell DaveM he fucked up...&quot;
)paren
suffix:semicolon
id|old_fs
op_assign
