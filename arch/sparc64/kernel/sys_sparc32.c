...
suffix:semicolon
multiline_comment|/* XXX: Do we need to translate this from sparc64 to sparc32 traps? */
id|d-&gt;si_trapno
op_assign
id|s-&gt;si_trapno
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* XXX: Do we need to translate this from sparc32 to sparc64 traps? */
id|d-&gt;si_trapno
op_assign
id|s-&gt;si_trapno
suffix:semicolon
