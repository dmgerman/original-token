...
r_else
(brace
multiline_comment|/* Tricky, must clear full unsigned long in the kernel&n;&t;&t;   fdset at the end, this makes sure that actually&n;&t;&t;   happens.  */
id|memset
c_func
(paren
id|fdset
