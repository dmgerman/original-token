...
c_func
(paren
l_string|&quot;%s: Advises us to use %s paging strategy for addr&lt;%08x&gt; len&lt;%08x&gt;&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|strategy
