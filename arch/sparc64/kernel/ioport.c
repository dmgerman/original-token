multiline_comment|/* $Id: ioport.c,v 1.14 1998/05/11 06:23:36 davem Exp $&n; * ioport.c:  Simple io mapping allocator.&n; *&n; * Copyright (C) 1995,1996 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1995 Miguel de Icaza (miguel@nuclecu.unam.mx)&n; */
...
c_func
(paren
l_string|&quot;sparc_alloc_io: Fixed virtual mappings unsupported on Ultra.&quot;
)paren
suffix:semicolon
)brace
r_if
