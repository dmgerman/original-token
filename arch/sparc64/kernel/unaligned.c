multiline_comment|/* $Id: unaligned.c,v 1.1 1997/06/06 10:56:19 jj Exp $&n; * unaligned.c: Unaligned load/store trap handling with special&n; *              cases for the kernel to do them more quickly.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996,1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
DECL|macro|DEBUG_MNA
mdefine_line|#define DEBUG_MNA
DECL|enum|direction
r_enum
id|direction
(brace
