multiline_comment|/* $Id: math.c,v 1.5 1998/06/12 14:54:27 jj Exp $&n; * arch/sparc64/math-emu/math.c&n; *&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; *&n; * Emulation routines originate from soft-fp package, which is part&n; * of glibc and has appropriate copyrights in it.&n; */
