...
mdefine_line|#define _FP_MUL_MEAT_Q(R,X,Y)&t;_FP_MUL_MEAT_2_wide_3mul(Q,R,X,Y,umul_ppmm)
...
mdefine_line|#define FP_INHIBIT_RESULTS ((current-&gt;tss.xfsr[0] &gt;&gt; 23) &amp; _fex)
macro_line|#endif
eof
