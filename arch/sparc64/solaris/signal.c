multiline_comment|/* $Id: signal.c,v 1.2 1997/09/03 12:29:19 jj Exp $&n; * signal.c: Signal emulation for Solaris&n; *&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
