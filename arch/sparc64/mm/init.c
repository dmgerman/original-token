multiline_comment|/*  $Id: init.c,v 1.1 1996/12/26 10:24:23 davem Exp $&n; *  arch/sparc64/mm/init.c&n; *&n; *  Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; */
r_extern
r_void
id|show_net_buffers
c_func
...
id|printk
(paren
l_string|&quot;Freeing unused kernel memory: %dk code, %dk data&bslash;n&quot;
comma
id|savec
op_rshift
l_int|10
