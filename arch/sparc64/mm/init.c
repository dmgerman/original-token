multiline_comment|/*  $Id: init.c,v 1.149 2000/03/15 14:42:58 jj Exp $&n; *  arch/sparc64/mm/init.c&n; *&n; *  Copyright (C) 1996-1999 David S. Miller (davem@caip.rutgers.edu)&n; *  Copyright (C) 1997-1999 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
c_func
(paren
l_string|&quot;init_bootmem(spfn[%lx],bpfn[%lx],epfn[%lx])&bslash;n&quot;
comma
id|start_pfn
comma
id|bootmap_pfn
...
multiline_comment|/* Reserve the kernel text/data/bss, the bootmem bootmap and initrd. */
macro_line|#ifdef DEBUG_BOOTMEM
macro_line|#ifdef CONFIG_BLK_DEV_INITRD
r_if
c_cond
