multiline_comment|/*  $Id: init.c,v 1.148 2000/03/07 07:08:31 anton Exp $&n; *  arch/sparc64/mm/init.c&n; *&n; *  Copyright (C) 1996-1999 David S. Miller (davem@caip.rutgers.edu)&n; *  Copyright (C) 1997-1999 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
id|pte
suffix:semicolon
multiline_comment|/* Set count of second page, so we can free it&n;&t;&t; * seperately later on.&n;&t;&t; */
id|atomic_set
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Clear out both pages now. */
id|memset
c_func
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Determine which page we give to this request. */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;init_bootmem(spfn[%lx],epfn[%lx])&bslash;n&quot;
comma
id|start_pfn
comma
id|end_pfn
...
multiline_comment|/* Reserve the kernel text/data/bss and the bootmem bitmap. */
macro_line|#ifdef DEBUG_BOOTMEM
id|prom_printf
c_func
(paren
...
c_func
(paren
l_string|&quot;init_bootmem: return end_pfn[%lx]&bslash;n&quot;
comma
id|end_pfn
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;taint_real_pages: Rescan sp_banks[].&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_for
...
c_func
(paren
l_string|&quot;taint: Page went away, reserve page %lx.&bslash;n&quot;
comma
id|old_start
)paren
suffix:semicolon
...
singleline_comment|// FIXME to use bootmem scheme...
r_if
c_cond
(paren
