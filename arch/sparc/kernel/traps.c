multiline_comment|/* $Id: traps.c,v 1.49 1996/12/18 06:33:49 tridge Exp $&n; * arch/sparc/kernel/traps.c&n; *&n; * Copyright 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
