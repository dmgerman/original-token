...
DECL|macro|POLL_ROUND_UP
mdefine_line|#define POLL_ROUND_UP(x,y) (((x)+(y)-1)/(y))
DECL|macro|POLLIN
mdefine_line|#define POLLIN 1
DECL|macro|POLLPRI
mdefine_line|#define POLLPRI 2
DECL|macro|POLLOUT
mdefine_line|#define POLLOUT 4
DECL|macro|POLLERR
mdefine_line|#define POLLERR 8
DECL|macro|POLLHUP
mdefine_line|#define POLLHUP 16
DECL|macro|POLLNVAL
mdefine_line|#define POLLNVAL 32
DECL|macro|POLLRDNORM
mdefine_line|#define POLLRDNORM 64
DECL|macro|POLLWRNORM
mdefine_line|#define POLLWRNORM POLLOUT
DECL|macro|POLLRDBAND
mdefine_line|#define POLLRDBAND 128
DECL|macro|POLLWRBAND
mdefine_line|#define POLLWRBAND 256
DECL|macro|LINUX_POLLIN
mdefine_line|#define LINUX_POLLIN (POLLRDNORM | POLLRDBAND | POLLIN)
DECL|macro|LINUX_POLLOUT
mdefine_line|#define LINUX_POLLOUT (POLLWRBAND | POLLWRNORM | POLLOUT)
DECL|macro|LINUX_POLLERR
mdefine_line|#define LINUX_POLLERR (POLLERR)
...
(brace
multiline_comment|/*&n;&t;&t; *&t;Multicast socketopts (ttl, membership)&n;&t;&t; */
r_if
c_cond
(paren
id|tr_opt
