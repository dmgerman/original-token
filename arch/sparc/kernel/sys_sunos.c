...
l_int|0xE8000000UL
suffix:semicolon
multiline_comment|/* To make it work on a sun4c. */
r_for
c_loop
(paren
id|vmm
...
multiline_comment|/* Weird SunOS mm control function.. */
...
c_func
(paren
l_string|&quot;%s: Call to sunos_mctl(addr&lt;%08lx&gt;, len&lt;%08lx&gt;, function&lt;%d&gt;, arg&lt;%p&gt;) &quot;
l_string|&quot;is unsupported&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|addr
...
multiline_comment|/* XXX This won&squot;t be necessary when I sync up to never kernel in 1.3.x series&n; * XXX which has the sys_msync() system call implemented properly.&n; */
DECL|function|sunos_msync
id|asmlinkage
r_int
id|sunos_msync
c_func
...
c_func
(paren
l_string|&quot;%s: Call to sunos_msync(addr&lt;%08lx&gt;, len&lt;%08lx&gt;, flags&lt;%08lx&gt;) &quot;
l_string|&quot;is unsupported&bslash;n&quot;
comma
id|current-&gt;comm
comma
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* Kill the process: the nfs directory is already mounted */
id|regs
op_assign
(paren
r_struct
...
c_func
(paren
l_string|&quot;sys_mount(type&lt;%s&gt;, device&lt;%s&gt;) returns %d&bslash;n&quot;
comma
id|type
comma
id|dev_fname
