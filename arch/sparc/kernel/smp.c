...
l_int|4
suffix:colon
multiline_comment|/* For captures we hold smp_cpu_in_msg[] until all processors&n;&t;&t; * released.  Else we have _big_ problems.&n;&t;&t; */
id|message_cpu
op_assign
id|NO_PROC_ID
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cross call initiated by non master cpu from [%p]&bslash;n&quot;
comma
...
DECL|macro|DEBUG_CAPTURE
macro_line|#undef DEBUG_CAPTURE
DECL|struct|capture_struct
r_static
r_struct
id|capture_struct
(brace
DECL|member|capture_level
r_int
id|capture_level
suffix:semicolon
DECL|member|processors_in
...
c_func
(paren
l_string|&quot;SMP Capture on CPU #%d, but #%d is active.&bslash;n&quot;
comma
id|me
comma
id|klock_info.akp
...
id|timeout
suffix:semicolon
multiline_comment|/* Initialize Capture Info. */
r_for
c_loop
(paren
id|cpu
...
c_func
(paren
l_string|&quot;smp_capture (%d): Wheee, penguin drops off the bus&bslash;n&quot;
comma
id|smp_processor_id
c_func
(paren
...
c_func
(paren
l_string|&quot;smp_capture: map: %ld %ld %ld %ld&bslash;n&quot;
comma
id|cap_info.processors_in
(braket
l_int|0
...
c_func
(paren
l_string|&quot;SMP Release on CPU #%d, but #%d is active.&bslash;n&quot;
comma
id|me
comma
id|klock_info.akp
...
multiline_comment|/* See wait case 4 in smp_message_pass()... */
id|smp_cpu_in_msg
(braket
id|me
)braket
...
c_func
(paren
l_string|&quot;smp_release (%d): Wheee, penguin drops off the bus&bslash;n&quot;
comma
id|smp_processor_id
c_func
(paren
...
c_func
(paren
l_string|&quot;smp_release: map: %ld %ld %ld %ld&bslash;n&quot;
comma
id|cap_info.processors_out
(braket
l_int|0
