...
r_int
DECL|function|_sparc_len2order
id|_sparc_len2order
c_func
(paren
r_int
...
c_func
(paren
l_string|&quot;len2order: from %p: len %lu(0x%lx) yields order &gt;=7.&bslash;n&quot;
comma
