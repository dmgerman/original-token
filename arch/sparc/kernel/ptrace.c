multiline_comment|/* ptrace.c: Sparc process tracing support.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caipfs.rutgers.edu)&n; *&n; * Based upon code written by Ross Biro, Linus Torvalds, Bob Manson,&n; * and David Mosberger.&n; */
...
c_func
(paren
l_string|&quot;%s [%d]: Wants to read user offset %d&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|current-&gt;pid
...
c_func
(paren
l_string|&quot;%s [%d]: Wants to write user offset %d&bslash;n&quot;
comma
id|current-&gt;comm
comma
id|current-&gt;pid
...
c_func
(paren
l_string|&quot;do_ptrace: rq=%d pid=%d addr=%08lx data=%08lx addr2=%08lx&bslash;n&quot;
comma
(paren
r_int
)paren
