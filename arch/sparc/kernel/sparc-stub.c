multiline_comment|/* $Id: sparc-stub.c,v 1.10 1996/02/15 09:12:09 davem Exp $&n; * sparc-stub.c:  KGDB support for the Linux kernel.&n; *&n; * Modifications to run under Linux&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * This file origionally came from the gdb sources, and the&n; * copyright notices have been retained below.&n; */
...
r_return
suffix:semicolon
multiline_comment|/* Again, watch those c-prefixes for solaris/elf kernels */
