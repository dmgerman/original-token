multiline_comment|/* $Id: sparc-stub.c,v 1.7 1995/11/25 00:58:26 davem Exp $&n; * sparc-stub.c:  KGDB support for the Linux kernel.&n; *&n; * Modifications to run under Linux&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * This file origionally came from the gdb sources, and the&n; * copyright notices have been retained below.&n; */
