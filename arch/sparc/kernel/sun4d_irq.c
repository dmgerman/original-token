multiline_comment|/*  $Id: sun4d_irq.c,v 1.3 1997/12/22 16:09:15 jj Exp $&n; *  arch/sparc/kernel/sun4d_irq.c: &n; *&t;&t;&t;SS1000/SC2000 interrupt handling.&n; *&n; *  Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; *  Heavily based on arch/sparc/kernel/irq.c.&n; */
...
id|printk
(paren
l_string|&quot;Attempt to register SBUS IRQ %d without DCOOKIE&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;Unable to disable IRQ %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
(brace
multiline_comment|/* FIXME: Hope no sbus intr handler uses regs */
id|action
op_member_access_from_pointer
id|handler
c_func
