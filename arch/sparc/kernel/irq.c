...
mdefine_line|#define irq_active(cpu) &bslash;&n;&t;(atomic_read(&amp;global_irq_count) != local_irq_count[cpu])
...
DECL|macro|STUCK
mdefine_line|#define STUCK &bslash;&n;if (!--stuck) { &bslash;&n;&t;printk(&quot;wait_on_irq CPU#%d stuck at %08lx, waiting for [%08lx:%x] &quot; &bslash;&n;&t;       &quot;(local=[%d(%x:%x:%x:%x)], global=[%d:%x]) &quot;, &bslash;&n;&t;       cpu, where, previous_irqholder, global_irq_holder, &bslash;&n;&t;       local_count, local_irq_count[0], local_irq_count[1], &bslash;&n;&t;       local_irq_count[2], local_irq_count[3], &bslash;&n;&t;       atomic_read(&amp;global_irq_count), global_irq_lock); &bslash;&n;&t;printk(&quot;g[%d:%x]&bslash;n&quot;, atomic_read(&amp;global_irq_count), global_irq_lock); &bslash;&n;&t;stuck = INIT_STUCK; &bslash;&n;}
...
c_func
(paren
l_string|&quot;mov %%i7, %0&bslash;n&bslash;t&quot;
suffix:colon
l_string|&quot;=r&quot;
(paren
id|where
...
multiline_comment|/* Yes, I know this is broken, but for the time being...&n; *&n; * On Sparc we must differentiate between real local processor&n; * interrupts being disabled and global interrupt locking, this&n; * is so that interrupt handlers which call this stuff don&squot;t get&n; * interrupts turned back on when restore_flags() runs because&n; * our current drivers will be very surprised about this, yes I&n; * know they need to be fixed... -DaveM&n; */
...
macro_line|#undef STUCK
DECL|macro|STUCK
mdefine_line|#define STUCK &bslash;&n;if (!--stuck) { &bslash;&n;&t;printk(&quot;irq_enter stuck (irq=%d, cpu=%d, global=%d)&bslash;n&quot;, &bslash;&n;&t;       irq, cpu, global_irq_holder); &bslash;&n;&t;stuck = INIT_STUCK; &bslash;&n;}
...
c_func
(paren
l_string|&quot;YEEEE Local interrupts enabled, global disabled&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
