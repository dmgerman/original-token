multiline_comment|/* $Id: probe.c,v 1.42 1995/12/26 01:38:08 davem Exp $&n; * probe.c: Preliminary device tree probing routines...&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
