...
multiline_comment|/* XXX Grrr, this stuff should have it&squot;s own file, only generic stuff goes&n; * XXX here.  Possibly clock.c and timer.c?&n; */
...
c_func
(paren
l_string|&quot;Send this information and the type of SUN and CPU/FPU type you have&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;to davem@caip.rutgers.edu so that this can be fixed.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;halting...&bslash;n&bslash;r&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* If I don&squot;t know about this CPU, I don&squot;t want people running on it&n;       * until I do.....&n;       */
id|halt
c_func
(paren
)paren
...
suffix:semicolon
multiline_comment|/* Calculate various constants that make the cache-flushing code&n;&t; * mode speedy.&n;&t; */
id|vac_entries_per_segment
op_assign
id|vac_entries_per_context
op_assign
...
id|x
suffix:semicolon
multiline_comment|/* Here we want to &squot;invalidate&squot; all the software VAC &quot;tags&quot;&n;&t; * just in case there is garbage in there. Then we enable it.&n;&t; */
multiline_comment|/* flush flush flush */
r_for
c_loop
(paren
id|x
...
id|sun4c
suffix:colon
multiline_comment|/* A sun4, sun4c. */
id|num_segmaps
op_assign
id|prom_getintdefault
c_func
...
id|sun4e
suffix:colon
multiline_comment|/* Any Reference MMU derivate should be handled here, hopefuly. */
id|num_segmaps
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;cpu%d MMU contexts: %d&bslash;n&quot;
comma
id|cpuid
comma
id|num_contexts
...
c_func
(paren
l_string|&quot;cpu%d CACHE linesize %d total size %d&bslash;n&quot;
comma
id|cpuid
comma
id|vac_linesize
...
multiline_comment|/* #define DEBUG_PROBE_CLOCK */
...
(brace
multiline_comment|/* Map the Timer chip, this is implemented in hardware inside&n;   * the cache chip on the sun4c.&n;   */
id|sparc_alloc_io
(paren
(paren
r_void
...
suffix:semicolon
multiline_comment|/* Have the level 10 timer tick at 100HZ.  We don&squot;t touch the&n;   * level 14 timer limit since we are letting the prom handle&n;   * them until we have a real console driver so L1-A works.&n;   */
...
suffix:semicolon
multiline_comment|/*&t;  printk(&quot;Timer register dump:&bslash;n&quot;); */
macro_line|#if 0
id|printk
c_func
(paren
l_string|&quot;cpu0: l14limit %08x l14curcount %08x&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;sys: l10limit %08x l10curcount %08x&bslash;n&quot;
comma
id|sun4m_timers-&gt;l10_timer_limit
comma
...
suffix:semicolon
multiline_comment|/* 0x9c4000 */
multiline_comment|/* We should be getting level 10 interrupts now. */
)brace
r_return
suffix:semicolon
)brace
...
multiline_comment|/* Are MBUS&squot;s relevant on sun4c&squot;s? */
id|mem_start
op_assign
id|probe_sbus
c_func
