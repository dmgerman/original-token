multiline_comment|/* init_me.c:  Initialize imperical constants and gather some info from&n; *             the boot prom.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
