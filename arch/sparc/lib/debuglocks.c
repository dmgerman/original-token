multiline_comment|/* $Id: debuglocks.c,v 1.3 1998/09/29 09:46:22 davem Exp $&n; * debuglocks.c: Debugging versions of SMP locking primitives.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1998 Anton Blanchard (anton@progsoc.uts.edu.au)&n; */
