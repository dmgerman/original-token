multiline_comment|/* $Id: console.c,v 1.5 1995/11/25 00:59:54 davem Exp $&n; * console.c: Routines that deal with sending and receiving IO&n; *            to/from the current console device using the PROM.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
...
multiline_comment|/* XXX fix for serial cases at SS-5.                 */
r_switch
c_cond
(paren
op_star
