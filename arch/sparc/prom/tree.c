multiline_comment|/* $Id: tree.c,v 1.15 1997/01/31 00:17:04 tdyas Exp $&n; * tree.c: Basic device tree traversal/scanning for the Linux&n; *         prom library.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
