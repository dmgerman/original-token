multiline_comment|/* $Id: srmmu.c,v 1.122 1996/12/30 06:16:31 davem Exp $&n; * srmmu.c:  SRMMU specific routines for memory management.&n; *&n; * Copyright (C) 1995 David S. Miller  (davem@caip.rutgers.edu)&n; * Copyright (C) 1995 Peter A. Zaitcev (zaitcev@ithil.mcst.ru)&n; * Copyright (C) 1996 Eddie C. Dost    (ecd@skynet.be)&n; */
...
id|flags
suffix:semicolon
multiline_comment|/* Do PGD flush. */
id|save_and_cli
c_func
(paren
id|flags
