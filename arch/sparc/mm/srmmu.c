multiline_comment|/* $Id: srmmu.c,v 1.22 1995/11/25 00:59:33 davem Exp $&n; * srmmu.c:  SRMMU specific routines for memory management.&n; *&n; * Copyright (C) 1995 David S. Miller  (davem@caip.rutgers.edu)&n; * Copyright (C) 1995 Peter A. Zaitcev (zaitcev@lab.ipmce.su)&n; */
...
(brace
multiline_comment|/* More than this is needed. */
op_star
id|ptep
op_assign
id|pteval
...
c_func
(paren
l_string|&quot;sun4m: get_scsi_buffer() not implemented yet.&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;sun4m: release_scsi_buffer() not implemented yet.&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/* Get fault information on an SRMMU. */
r_int
DECL|function|srmmu_get_fault_info
id|srmmu_get_fault_info
c_func
(paren
r_int
r_int
...
(brace
multiline_comment|/* XXX Foo, write this... XXX */
r_return
l_int|0
suffix:semicolon
)brace
...
multiline_comment|/* Map DVMA areas. */
r_for
c_loop
(paren
id|vaddr
...
id|PERCPU_VADDR
suffix:semicolon
multiline_comment|/* Ugh, have to map DVMA that the prom has mapped too or else&n;&t; * you will lose with video cards when we take over the ctx table.&n;&t; * Also, must take into consideration that prom might be using level&n;&t; * two or one PTE&squot;s. TODO&n;&t; *&n;&t; * XXX This still isn&squot;t right, the cg* graphics cards get their&n;&t; * XXX mapped screens all fucked up when I jump onto Linux&squot;s&n;&t; * XXX page tables.  Must investigate...&n;&t; */
r_for
c_loop
(paren
id|vaddr
...
c_func
(paren
l_string|&quot;WHOOPS, update_mmu_cache called on a SRMMU!&bslash;n&quot;
)paren
suffix:semicolon
id|panic
c_func
...
r_void
DECL|function|srmmu_release_hook
id|srmmu_release_hook
c_func
(paren
r_void
op_star
...
r_void
DECL|function|srmmu_task_cacheflush
id|srmmu_task_cacheflush
c_func
(paren
r_void
op_star
