...
macro_line|#endif
DECL|macro|USE_CHUNK_ALLOC
mdefine_line|#define USE_CHUNK_ALLOC 1
...
DECL|function|tsunami_flush_chunk
r_static
r_void
...
DECL|function|viking_mxcc_flush_chunk
r_static
r_void
...
DECL|function|viking_nomxcc_flush_chunk
r_static
r_void
id|viking_nomxcc_flush_chunk
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* Gcc can bite me... */
...
multiline_comment|/* The things we do for performance... */
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Close your eyes... */
id|__asm__
id|__volatile__
c_func
(paren
...
suffix:semicolon
multiline_comment|/* else we die a horrible death */
macro_line|#endif
id|__asm__
id|__volatile__
c_func
...
l_string|&quot;&t;: : &quot;
id|i
l_string|&quot; (SRMMU_CTX_REG), &quot;
id|i
l_string|&quot; (ASI_M_MMUREGS), &quot;
id|i
"&quot;"
(paren
id|SRMMU_FAULT_STATUS
...
DECL|function|hypersparc_flush_chunk
r_static
r_void
...
DECL|function|viking_no_mxcc_update_rootmmu_dir
r_static
r_void
id|viking_no_mxcc_update_rootmmu_dir
c_func
(paren
r_struct
id|task_struct
