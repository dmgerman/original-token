multiline_comment|/* $Id: srmmu.c,v 1.103 1996/10/31 06:28:35 davem Exp $&n; * srmmu.c:  SRMMU specific routines for memory management.&n; *&n; * Copyright (C) 1995 David S. Miller  (davem@caip.rutgers.edu)&n; * Copyright (C) 1995 Peter A. Zaitcev (zaitcev@ithil.mcst.ru)&n; * Copyright (C) 1996 Eddie C. Dost    (ecd@skynet.be)&n; */
...
c_func
(paren
l_string|&quot;can&squot;t determine cache-line-size, halting.&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
