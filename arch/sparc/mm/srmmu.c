multiline_comment|/* $Id: srmmu.c,v 1.156 1997/11/28 14:23:42 jj Exp $&n; * srmmu.c:  SRMMU specific routines for memory management.&n; *&n; * Copyright (C) 1995 David S. Miller  (davem@caip.rutgers.edu)&n; * Copyright (C) 1995 Peter A. Zaitcev (zaitcev@ithil.mcst.ru)&n; * Copyright (C) 1996 Eddie C. Dost    (ecd@skynet.be)&n; * Copyright (C) 1997 Jakub Jelinek    (jj@sunsite.mff.cuni.cz)&n; */
...
id|phys_mem_contig
suffix:semicolon
DECL|variable|page_contig_offset
r_int
...
op_assign
l_int|NULL
multiline_comment|/* hypersparc_flush_page_for_dma */
suffix:semicolon
id|flush_chunk
op_assign
id|hypersparc_flush_chunk
...
op_assign
l_int|NULL
multiline_comment|/* cypress_flush_page_for_dma */
suffix:semicolon
id|sparc_update_rootmmu_dir
op_assign
id|cypress_update_rootmmu_dir
...
op_assign
l_int|NULL
multiline_comment|/* turbosparc_flush_page_for_dma */
suffix:semicolon
id|poke_srmmu
op_assign
id|poke_turbosparc
...
op_assign
l_int|NULL
multiline_comment|/* viking_flush_page_for_dma */
suffix:semicolon
)brace
id|flush_cache_all
op_assign
