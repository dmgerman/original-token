multiline_comment|/* $Id: srmmu.c,v 1.116 1996/12/12 11:57:59 davem Exp $&n; * srmmu.c:  SRMMU specific routines for memory management.&n; *&n; * Copyright (C) 1995 David S. Miller  (davem@caip.rutgers.edu)&n; * Copyright (C) 1995 Peter A. Zaitcev (zaitcev@ithil.mcst.ru)&n; * Copyright (C) 1996 Eddie C. Dost    (ecd@skynet.be)&n; */
...
multiline_comment|/* #define USE_CHUNK_ALLOC 1 */
...
DECL|function|srmmu_set_pte_nocache_nomxccvik
r_static
r_void
id|srmmu_set_pte_nocache_nomxccvik
c_func
(paren
id|pte_t
op_star
...
multiline_comment|/* Tsunami has harvard style split I/D caches which do not snoop each other,&n; * so we have to flush on-stack sig insns.  Only the icache need be flushed&n; * since the Tsunami has a write-through data cache.&n; */
DECL|function|tsunami_flush_sig_insns
r_static
r_void
...
multiline_comment|/* All vikings have an icache which snoops the processor bus and is fully&n; * coherent with the dcache, so no flush is necessary at all.&n; */
DECL|function|viking_flush_sig_insns
r_static
r_void
...
multiline_comment|/* Viking is IO cache coherent, but really only on MXCC. */
...
DECL|function|viking_no_mxcc_getpage
r_static
r_int
r_int
id|viking_no_mxcc_getpage
c_func
(paren
r_void
)paren
...
DECL|function|viking_no_mxcc_pgd_flush
r_static
r_void
id|viking_no_mxcc_pgd_flush
c_func
(paren
id|pgd_t
op_star
...
DECL|function|cypress_flush_page_to_uncache
r_static
r_void
id|cypress_flush_page_to_uncache
c_func
(paren
r_int
r_int
...
DECL|function|cypress_pgd_flush
r_static
r_void
id|cypress_pgd_flush
c_func
(paren
id|pgd_t
op_star
...
DECL|function|cypress_flush_tlb_page_for_cbit
r_static
r_void
id|cypress_flush_tlb_page_for_cbit
c_func
(paren
r_int
r_int
...
multiline_comment|/* Boy was my older implementation inefficient... */
...
multiline_comment|/* HyperSparc has unified I/D L2 cache, however it posseses a small on-chip&n; * ICACHE which must be flushed for the new style signals.&n; */
DECL|function|hypersparc_flush_sig_insns
r_static
r_void
...
DECL|function|hypersparc_getpage
r_static
r_int
r_int
id|hypersparc_getpage
c_func
(paren
r_void
)paren
...
DECL|function|hypersparc_pgd_flush
r_static
r_void
id|hypersparc_pgd_flush
c_func
(paren
id|pgd_t
op_star
