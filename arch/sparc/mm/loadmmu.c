multiline_comment|/* $Id: loadmmu.c,v 1.13 1995/11/25 00:59:24 davem Exp $&n; * loadmmu.c:  This code loads up all the mm function pointers once the&n; *             machine type has been determined.  It also sets the static&n; *             mmu values such as PAGE_NONE, etc.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
...
suffix:semicolon
DECL|variable|mmu_release_hook
r_void
(paren
op_star
id|mmu_release_hook
...
suffix:semicolon
DECL|variable|mmu_task_cacheflush
r_void
(paren
op_star
...
suffix:semicolon
DECL|variable|sparc_virt_to_phys
r_int
r_int
(paren
op_star
id|sparc_virt_to_phys
)paren
(paren
r_int
r_int
...
suffix:semicolon
DECL|variable|sparc_phys_to_virt
r_int
r_int
(paren
op_star
id|sparc_phys_to_virt
)paren
(paren
r_int
r_int
