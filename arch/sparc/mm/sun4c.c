multiline_comment|/* $Id: sun4c.c,v 1.143 1997/04/11 00:42:14 davem Exp $&n; * sun4c.c: Doing in software what should be done in hardware.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996 Eddie C. Dost (ecd@skynet.be)&n; * Copyright (C) 1996 Andrew Tridgell (Andrew.Tridgell@anu.edu.au)&n; */
...
multiline_comment|/* That&squot;s it, we prom_halt() if the cache size is something other than 65536.&n; * So let&squot;s save some cycles and just use that everywhere except for that bootup&n; * sanity check.&n; */
DECL|macro|SUN4C_VAC_SIZE
mdefine_line|#define SUN4C_VAC_SIZE&t;65536
...
DECL|function|sun4c_free_kernel_stack_hw
r_static
r_void
id|sun4c_free_kernel_stack_hw
c_func
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* We are deleting a mapping, so the flushes here are mandatory. */
id|sun4c_flush_page_hw
c_func
(paren
id|stack
...
DECL|function|sun4c_free_kernel_stack_sw
r_static
r_void
id|sun4c_free_kernel_stack_sw
c_func
(paren
r_int
r_int
