multiline_comment|/* $Id: sun4c.c,v 1.175 1999/07/30 09:35:10 davem Exp $&n; * sun4c.c: Doing in software what should be done in hardware.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996 Eddie C. Dost (ecd@skynet.be)&n; * Copyright (C) 1996 Andrew Tridgell (Andrew.Tridgell@anu.edu.au)&n; * Copyright (C) 1997 Anton Blanchard (anton@progsoc.uts.edu.au)&n; * Copyright (C) 1998 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
...
multiline_comment|/* TODO: Make it such that interrupt handlers cannot dick with&n; *       the user segment lists, most of the cli/sti pairs can&n; *       disappear once that is taken care of.&n; */
multiline_comment|/* XXX Ok the real performance win, I figure, will be to use a combined hashing&n; * XXX and bitmap scheme to keep track of what we have mapped where.  The whole&n; * XXX incentive is to make it such that the range flushes can be serviced&n; * XXX always in near constant time. --DaveM&n; */
r_extern
r_int
id|num_segmaps
comma
id|num_contexts
suffix:semicolon
multiline_comment|/* Define this to get extremely anal debugging, undefine for performance. */
multiline_comment|/* #define DEBUG_SUN4C_MM */
...
DECL|macro|FUW_INLINE
mdefine_line|#define FUW_INLINE do {&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;register int ctr asm(&quot;g5&quot;);&t;&t;&t;&t;&t;&bslash;&n;&t;ctr = 0;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;__asm__ __volatile__(&quot;&bslash;n&quot;&t;&t;&t;&t;&t;&bslash;&n;&t;&quot;1:&t;ld&t;[%%g6 + %2], %%g4&t;! flush user windows&bslash;n&quot;&t;&bslash;&n;&t;&quot;&t;orcc&t;%%g0, %%g4, %%g0&bslash;n&quot;&t;&t;&t;&t;&bslash;&n;&t;&quot;&t;add&t;%0, 1, %0&bslash;n&quot;&t;&t;&t;&t;&t;&bslash;&n;&t;&quot;&t;bne&t;1b&bslash;n&quot;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&quot;&t; save&t;%%sp, -64, %%sp&bslash;n&quot;&t;&t;&t;&t;&bslash;&n;&t;&quot;2:&t;subcc&t;%0, 1, %0&bslash;n&quot;&t;&t;&t;&t;&t;&bslash;&n;&t;&quot;&t;bne&t;2b&bslash;n&quot;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;&quot;&t; restore %%g0, %%g0, %%g0&bslash;n&quot;&t;&t;&t;&t;&bslash;&n;&t;: &quot;=&amp;r&quot; (ctr)&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;: &quot;0&quot; (ctr), &quot;i&quot; (UWINMASK_OFFSET)&t;&t;&t;&t;&bslash;&n;&t;: &quot;g4&quot;, &quot;cc&quot;);&t;&t;&t;&t;&t;&t;&t;&bslash;&n;} while(0);
...
multiline_comment|/* Context level flush. */
...
multiline_comment|/* Call this version when you know hardware flushes are available. */
...
multiline_comment|/* Weitek POWER-UP hwbug workaround. */
id|__asm__
id|__volatile__
c_func
(paren
l_string|&quot;nop;nop;nop;&t;! Weitek hwbug&quot;
)paren
suffix:semicolon
)brace
)brace
...
multiline_comment|/* Again, hw-only and sw-only cache page-level flush variants. */
...
c_func
(paren
l_string|&quot;sun4c: Ring num_entries &lt; 0!&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;sun4c_demap_one: Freeing from empty ctx ring.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;sun4c_shrink_kernel_ring: taken &lt; 0.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;sun4c_user_strategy: num_entries!=0 but ring empty.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;sun4c_user_strategy: kernel shrunk but ufree empty.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;sun4c_user_strategy: demapped one but ufree empty.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;deadlock avoidance, taken= %d max= %d&bslash;n&quot;
comma
id|sun4c_user_taken_entries
comma
id|max_user_taken_entries
...
c_func
(paren
l_string|&quot;&bslash;nsun4c_grow_kernel_ring: num_entries!=0, ring empty.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;&bslash;nsun4c_grow_kernel_ring: taken &lt; 0.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;ufree= %d, kfree= %d, kernel= %d&bslash;n&quot;
comma
id|sun4c_ufree_ring.num_entries
comma
id|sun4c_kfree_ring.num_entries
...
multiline_comment|/* 2 page buckets for task struct and kernel stack allocation.&n; *&n; * TASK_STACK_BEGIN&n; * bucket[0]&n; * bucket[1]&n; *   [ ... ]&n; * bucket[NR_TASKS-1]&n; * TASK_STACK_BEGIN + (sizeof(struct task_bucket) * NR_TASKS)&n; *&n; * Each slot looks like:&n; *&n; *  page 1 --  task struct + beginning of kernel stack&n; *  page 2 --  rest of kernel stack&n; */
...
c_func
(paren
l_string|&quot;get_locked_segment: max_user_taken &lt; 0.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;free_locked_segment: max_user_taken &lt; 0.&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
multiline_comment|/* XXX no save_and_cli/restore_flags needed, but put here if darkside still crashes */
...
suffix:semicolon
multiline_comment|/* This window flush is paranoid I think... -DaveM */
id|FUW_INLINE
id|sun4c_set_context
c_func
(paren
...
DECL|function|sun4c_switch_to_context_hw
r_static
r_void
id|sun4c_switch_to_context_hw
c_func
(paren
r_struct
id|task_struct
...
DECL|function|sun4c_init_new_context_hw
r_static
r_void
id|sun4c_init_new_context_hw
c_func
(paren
r_struct
id|mm_struct
...
DECL|function|sun4c_switch_to_context_sw
r_static
r_void
id|sun4c_switch_to_context_sw
c_func
(paren
r_struct
id|task_struct
...
DECL|function|sun4c_init_new_context_sw
r_static
r_void
id|sun4c_init_new_context_sw
c_func
(paren
r_struct
id|mm_struct
...
macro_line|#if 0 /* Not used due to BTFIXUPs */
r_static
r_int
r_int
id|sun4c_pmd_align
...
DECL|function|sun4c_vac_alias_fixup
r_static
r_void
id|sun4c_vac_alias_fixup
c_func
(paren
r_struct
id|vm_area_struct
