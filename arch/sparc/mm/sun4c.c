...
DECL|function|sun4c_unlockpage
r_static
r_void
id|sun4c_unlockpage
c_func
...
c_func
(paren
l_string|&quot;Problem, trying to lock multipage scsi buffer.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;page1&lt;%08lx&gt; page2&lt;%08lx&gt;&bslash;n&quot;
comma
id|page1
comma
id|page2
...
mdefine_line|#define TASK_ENTRY_SIZE    (3 * PAGE_SIZE)
...
DECL|function|sun4c_invalidate_all
r_static
r_void
id|sun4c_invalidate_all
c_func
(paren
r_void
)paren
...
DECL|function|sun4c_invalidate_mm
r_static
r_void
id|sun4c_invalidate_mm
c_func
(paren
r_struct
id|mm_struct
...
DECL|function|sun4c_invalidate_range
r_static
r_void
id|sun4c_invalidate_range
c_func
(paren
r_struct
id|mm_struct
...
DECL|function|sun4c_invalidate_page
r_static
r_void
id|sun4c_invalidate_page
c_func
(paren
r_struct
id|vm_area_struct
...
id|s4cinfo
comma
l_string|&quot;vacsize: %d bytes&bslash;n&quot;
