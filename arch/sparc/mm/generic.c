multiline_comment|/* generic.c: Generic Sparc mm routines that are not dependant upon&n; *            MMU type but are Sparc specific.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; */
