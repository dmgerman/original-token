...
c_func
(paren
l_string|&quot;PCI: Assigning I/O space %04lx-%04lx to device %s&bslash;n&quot;
comma
id|r-&gt;start
comma
id|r-&gt;end
...
DECL|function|pci_fixup_i440bx
r_static
r_void
id|__init
id|pci_fixup_i440bx
...
(brace
macro_line|#if 0&t;&t;&t;&t;&t;&t;&t;    /* Temporarily disabled   FIXME */
multiline_comment|/*&n;&t; * i440BX/ZX -- Occupy the AGP bridge windows.&n;&t; */
id|u16
id|a
comma
id|b
