...
multiline_comment|/* Call all the information procedures */
DECL|function|info
r_void
id|info
c_func
...
multiline_comment|/* In futur version in case we detect a PCI to PCi bridge, we will go &n;for a recursive device search*/
...
multiline_comment|/* (i.e. dev_fn=0xff) It can be a bug in my BIOS, or I havn&squot;t understood all about */
