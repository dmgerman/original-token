...
l_int|NULL
suffix:semicolon
multiline_comment|/* Avoid IRQ assignment below */
)brace
macro_line|#endif
multiline_comment|/*&n;&t;&t; * Fix out-of-range IRQ numbers and missing IRQs.&n;&t;&t; */
r_if
c_cond
(paren
id|dev-&gt;irq
...
c_func
(paren
l_string|&quot;PCI: Assigned IRQ %d to device %s&bslash;n&quot;
comma
id|dev-&gt;irq
comma
id|dev-&gt;slot_name
