...
multiline_comment|/*&n; * IOAPICs can take PCI IRQs directly, lets first check the mptable:&n; *&n; * This can go away once nobody probes the irq this way,&n; * but uses the PCI tables instead.&n; */
r_if
c_cond
(paren
id|where
...
multiline_comment|/*&n;&t; * If we were told to use the PCI BIOS and it&squot;s not present, avoid&n;&t; * touching the hardware.&n;&t; */
id|pci_probe
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;PCI: BIOS forgot to assign address #%d to device %02x:%02x,&quot;
