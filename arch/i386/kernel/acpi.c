...
multiline_comment|/*&n; * Init PIIX4 device and create a fake FACP&n; */
...
suffix:semicolon
DECL|macro|NR_ACPI_DEVICES
mdefine_line|#define NR_ACPI_DEVICES&t;(sizeof(acpi_devices)/sizeof(struct acpi_device))
DECL|function|acpi_find_devices
r_static
r_int
id|__init
id|acpi_find_devices
c_func
(paren
r_void
)paren
...
(brace
singleline_comment|// no ACPI tables and not a recognized ACPI chipset
r_return
op_minus
id|ENODEV
suffix:semicolon
