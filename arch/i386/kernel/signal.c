...
suffix:semicolon
DECL|macro|COPY
mdefine_line|#define COPY(x)&t;&t;__get_user(regs-&gt;x, &amp;sc-&gt;x)
DECL|macro|COPY_SEG
mdefine_line|#define COPY_SEG(seg)&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;{ __get_user(tmp, &amp;sc-&gt;seg);&t;&t;&t;&t;&t;&bslash;&n;&t;  if ((tmp &amp; 0xfffc)&t;&t;/* not a NULL selectors */&t;&bslash;&n;&t;      &amp;&amp; (tmp &amp; 0x4) != 0x4&t;/* not a LDT selector */&t;&bslash;&n;&t;      &amp;&amp; (tmp &amp; 3) != 3)&t;/* not a RPL3 GDT selector */&t;&bslash;&n;&t;&t;  goto badframe;&t;&t;&t;&t;&t;&bslash;&n;&t;  regs-&gt;x##seg = tmp; }
...
multiline_comment|/* This is legacy signal stack switching.  */
r_if
c_cond
(paren
(paren
