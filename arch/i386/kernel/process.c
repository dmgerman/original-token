multiline_comment|/*&n; *  linux/arch/i386/kernel/process.c&n; *&n; *  Copyright (C) 1995  Linus Torvalds&n; *  Pentium III code by Ingo Molnar with changes and support for &n; *  OS exception support by Goutham Rao&n; */
...
id|hard-&gt;st_space
suffix:semicolon
multiline_comment|/*&n;&t; * Transform the two layouts:&n;&t; * (we do not mix 32-bit access with 16-bit access because&n;&t; * thats suboptimal on PPros)&n;&t; */
r_for
c_loop
(paren
id|i
...
DECL|function|i387_user_to_hard
r_int
