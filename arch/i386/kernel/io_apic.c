...
multiline_comment|/*&n;&t; * If there are no explicit mp irq entries: it&squot;s either one of the&n;&t; * default configuration types or we are broken. In both cases it&squot;s&n;&t; * fine to set up most of the low 16 IOAPIC pins to ISA defaults.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
