...
DECL|function|clear_lapic_ints
r_static
r_void
id|clear_lapic_ints
(paren
...
(brace
multiline_comment|/*&n;&t; * Clear the IO-APIC and local APICs before rebooting:&n;&t; */
id|clear_IO_APIC
c_func
(paren
)paren
...
c_func
(paren
l_string|&quot;timer doesnt work through the IO-APIC - cannot activate NMI Watchdog!&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
