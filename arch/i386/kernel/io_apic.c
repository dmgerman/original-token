...
multiline_comment|/*&n;&t; * There are broken mptables which register ISA+high-active+level IRQs,&n;&t; * these are illegal and are converted here to ISA+high-active+edge&n;&t; * IRQ sources. Careful, ISA+low-active+level is another broken entry&n;&t; * type, it represents PCI IRQs &squot;embedded into an ISA bus&squot;, they have&n;&t; * to be accepted. Yes, ugh.&n;&t; */
r_if
c_cond
(paren
(paren
