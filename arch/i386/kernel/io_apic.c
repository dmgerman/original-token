...
multiline_comment|/*&n; * ISA interrupts can be:&n; *  - level triggered, active low (ELCR = 1)&n; *  - edge triggered, active high (ELCR = 0)&n; *  - edge triggered, active low (magic irq 8)&n; */
DECL|function|default_ISA_trigger
r_static
r_int
id|__init
...
DECL|function|default_ISA_polarity
r_static
r_int
id|__init
