...
(brace
multiline_comment|/*&n;&t; * we are careful. While for ISA irqs it&squot;s common to happen&n;&t; * outside of any driver (think autodetection), this is not&n;&t; * at all nice for PCI interrupts. So we are stricter and&n;&t; * print a warning when such spurious interrupts happen.&n;&t; * Spurious interrupts can confuse other drivers if the PCI&n;&t; * IRQ line is shared.&n;&t; *&n;&t; * Such spurious interrupts are either driver bugs, or&n;&t; * sometimes hw (chipset) bugs.&n;&t; */
id|printk
c_func
(paren
l_string|&quot;unexpected IRQ vector %d on CPU#%d!&bslash;n&quot;
comma
id|irq
comma
id|smp_processor_id
...
l_int|0xff
suffix:semicolon
multiline_comment|/* subtle, see irq.h */
r_int
id|cpu
op_assign
id|smp_processor_id
