...
multiline_comment|/*&n; * Edge triggered needs to resend any interrupt&n; * that was delayed.&n; */
...
multiline_comment|/*&n; * Enter and exit the irq handler context..&n; */
DECL|function|enter_ioapic_irq
r_static
r_inline
r_void
id|enter_ioapic_irq
...
suffix:semicolon
multiline_comment|/*&n;&t; * If there is no IRQ handler or it was disabled, exit early.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
