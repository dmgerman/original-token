...
multiline_comment|/*&n;&t; * In the SMP+IOAPIC case it might happen that there are an unspecified&n;&t; * number of pending IRQ events unhandled. We protect against multiple&n;&t; * enable_irq()&squot;s executing them via disable_irq[irq]++&n;&t; */
r_if
c_cond
(paren
op_logical_neg
