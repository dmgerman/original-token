...
suffix:semicolon
multiline_comment|/* fall throught */
r_default
suffix:colon
id|irq_desc
(braket
...
multiline_comment|/*&n; * Silly, horrible hack&n; */
DECL|variable|uglybuffer
r_static
r_char
id|uglybuffer
(braket
...
id|__ALIGN_STR
l_string|&quot;&bslash;n&quot;
l_string|&quot;common_unexpected:&bslash;n&bslash;t&quot;
id|SAVE_ALL
l_string|&quot;pushl $ret_from_intr&bslash;n&bslash;t&quot;
l_string|&quot;jmp strange_interrupt&quot;
)paren
suffix:semicolon
DECL|function|strange_interrupt
r_void
id|strange_interrupt
c_func
(paren
r_int
id|irqnum
...
(brace
multiline_comment|/*&n;&t;&t;&t; * 16 old-style INTA-cycle interrupt gates:&n;&t;&t;&t; */
id|irq_desc
(braket
id|i
)braket
