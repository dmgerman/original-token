...
DECL|function|trigger_pending_irqs
r_static
r_inline
r_void
id|trigger_pending_irqs
c_func
(paren
r_int
r_int
...
l_int|0
suffix:semicolon
multiline_comment|/* If the irq is disabled, just set a flag and return */
r_if
c_cond
(paren
id|disabled_irq
...
macro_line|#endif
multiline_comment|/*&n; * Generic enable/disable code: this just calls&n; * down into the PIC-specific version after having&n; * gotten the irq controller lock.&n; */
