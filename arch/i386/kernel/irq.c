...
multiline_comment|/*&n; * Level and edge triggered IO-APIC interrupts need different handling,&n; * so we use two separate irq descriptors:&n; */
r_static
r_void
...
id|pending
suffix:semicolon
multiline_comment|/* If there is no IRQ handler, exit early, leaving the irq &quot;in progress&quot; */
r_if
c_cond
(paren
op_logical_neg
