...
id|v
suffix:semicolon
multiline_comment|/* &n;&t; * Actually we must have cpuid or we could never have&n;&t; * figured out that this was AMD/Cyrix/Transmeta&n;&t; * from the vendor info :-).&n;&t; */
id|cpuid
c_func
(paren
l_int|0x80000000
...
suffix:semicolon
multiline_comment|/*&n;&t; * Set MTRR capability flag if appropriate&n;&t; */
r_if
c_cond
(paren
...
multiline_comment|/*&n;&t; * Now do the cache operations. &n;&t; */
r_switch
c_cond
(paren
id|c-&gt;x86
...
c_func
(paren
l_string|&quot;CPU: Processor revision %u.%u.%u.%u, %u MHz%s%s&bslash;n&quot;
comma
(paren
id|cpu_rev
op_rshift
...
multiline_comment|/* Unhide possibly hidden flags */
id|rdmsr
c_func
(paren
l_int|0x80860004
...
r_default
suffix:colon
multiline_comment|/* Unknown CPU manufacturer or no special handling needed */
r_break
suffix:semicolon
)brace
id|sep_bug
