...
suffix:semicolon
DECL|variable|standard_resources
r_struct
id|resource
...
suffix:semicolon
multiline_comment|/* For demonstration purposes only.. */
DECL|macro|keyboard_resources
mdefine_line|#define keyboard_resources (standard_resources+3)
DECL|variable|kbd_status_resource
r_struct
id|resource
id|kbd_status_resource
op_assign
(brace
l_string|&quot;status&quot;
comma
...
suffix:semicolon
DECL|macro|STANDARD_RESOURCES
mdefine_line|#define STANDARD_RESOURCES (sizeof(standard_resources)/sizeof(struct resource))
