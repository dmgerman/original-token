...
DECL|variable|ioport_registrar
r_static
r_int
r_int
id|ioport_registrar
...
suffix:semicolon
DECL|macro|IOPORTNAMES_NUM
mdefine_line|#define IOPORTNAMES_NUM 32
DECL|macro|IOPORTNAMES_LEN
mdefine_line|#define IOPORTNAMES_LEN 26
DECL|member|from
r_struct
(brace
r_int
...
multiline_comment|/* Check for set bits in BITMAP starting at BASE, going to EXTENT. */
...
multiline_comment|/*&n; * This is the &squot;old&squot; snarfing worker function&n; */
DECL|function|do_snarf_region
r_void
id|do_snarf_region
c_func
(paren
...
c_func
(paren
l_string|&quot;warning:ioportname-table is full&quot;
)paren
suffix:semicolon
)brace
r_else
...
multiline_comment|/*&n; * The worker for releasing&n; */
DECL|function|do_release_region
r_void
id|do_release_region
c_func
(paren
r_int
r_int
