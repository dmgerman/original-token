...
mdefine_line|#define MTRR_VERSION            &quot;1.18 (19980429)&quot;
DECL|macro|TRUE
...
suffix:semicolon
multiline_comment|/* re-enable interrupts (if enabled previously) */
id|restore_flags
c_func
(paren
id|ctxt-&gt;flags
...
id|printk
(paren
l_string|&quot;mtrr: type missmatch for %lx,%lx old: %s new: %s&bslash;n&quot;
comma
id|base
comma
id|size
