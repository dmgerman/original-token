...
suffix:semicolon
multiline_comment|/*&n; *&t;No point continually digging through complex CPU conditionals..&n; */
DECL|variable|mtrr_flags
r_static
r_int
id|mtrr_flags
suffix:semicolon
DECL|macro|MTRR_PRESENT
mdefine_line|#define MTRR_PRESENT&t;&t;1
DECL|macro|MTRR_WRCOMB
mdefine_line|#define MTRR_WRCOMB&t;&t;2
...
multiline_comment|/*&n;&t; *&t;This needs a little explaining. The size is stored as an&n;&t; *&t;inverted mask of bits of 128K granularity 15 bits long offset&n;&t; *&t;2 bits&n;&t; *&n;&t; *&t;So to get a size we do invert the mask and add 1 to the lowest&n;&t; *&t;mask bit (4 as its 2 bits in). This gives us a size we then shift&n;&t; *&t;to turn into 128K blocks&n;&t; *&n;&t; *&t;eg&t;&t;111 1111 1111 1100      is 512K&n;&t; *&n;&t; *&t;invert&t;&t;000 0000 0000 0011&n;&t; *&t;+1&t;&t;000 0000 0000 0100&n;&t; *&t;*128K&t;...&n;&t; */
id|low
op_assign
(paren
op_complement
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;The writeback rule is quite specific. See the manual. Its&n;&t; *&t;disable local interrupts, write back the cache, set the mtrr&n;&t; */
id|save_flags
c_func
(paren
id|flags
...
multiline_comment|/*  Check upper bits of base and last are equal and lower bits are 0 for&n;&t;&t;base and 1 for last  */
id|last
op_assign
id|base
op_plus
...
macro_line|#endif  /*  __SMP__  */
multiline_comment|/*&n; *&t;The extended memory handling is available on the K6-III and the&n; *&t;K6-II stepping 8 and higher only.&n; */
DECL|function|k6_has_ranges
r_static
r_int
id|k6_has_ranges
c_func
