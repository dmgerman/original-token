...
macro_line|#endif
DECL|macro|spin_lock_reschedule
mdefine_line|#define spin_lock_reschedule(lock) while (!spin_trylock(lock)) schedule ();
...
r_break
suffix:semicolon
multiline_comment|/* Athlon and post-Athlon CPUs */
...
l_int|2
suffix:semicolon
multiline_comment|/* pre-Athlon CPUs */
multiline_comment|/* else fall through */
r_case
id|X86_VENDOR_INTEL
suffix:colon
...
id|X86_VENDOR_CENTAUR
suffix:colon
multiline_comment|/*  and Centaur has 8 MCR&squot;s  */
r_return
l_int|8
suffix:semicolon
multiline_comment|/*break;*/
...
suffix:semicolon
r_else
multiline_comment|/* Set the register to the base (already shifted for us), the&n;&t;   type (off by one) and an inverted bitmask of the size&n;&t;   The size is the only odd bit. We are fed say 512K&n;&t;   We invert this and we get 111 1111 1111 1011 but&n;&t;   if you subtract one and invert you get the desired&n;&t;   111 1111 1111 1100 mask&n;&t;   */
op_star
(paren
id|reg
ques
...
l_int|0xfffff000
suffix:semicolon
multiline_comment|/* base works on 4K pages... */
id|low
op_assign
(paren
(paren
...
suffix:semicolon
multiline_comment|/*  Flush and disable the local CPU&squot;s cache&t;and start the ball rolling on&n;&t;other CPUs  */
id|set_mtrr_prepare
(paren
op_amp
id|ctxt
...
(brace
multiline_comment|/* pre-Athlon CPUs */
multiline_comment|/* Apply the K6 block alignment and size rules&n;&t;     In order&n;&t;&t;o Uncached or gathering only&n;&t;&t;o 128K or bigger block&n;&t;&t;o Power of 2 block&n;&t;&t;o base suitably aligned to the power&n;&t;    */
r_if
c_cond
(paren
id|type
...
id|X86_VENDOR_INTEL
suffix:colon
multiline_comment|/*  Double check for Intel, we may run on Athlon. */
r_if
c_cond
(paren
id|boot_cpu_data.x86_vendor
...
r_else
(brace
multiline_comment|/* Disable SMM mode (bit 1), access to SMM memory (bit 2) and&n;       * access to SMM memory through ARR3 (bit 7).&n;       */
r_if
c_cond
(paren
id|ccr
...
id|X86_VENDOR_AMD
suffix:colon
multiline_comment|/* Just for robustness: pre-Athlon CPUs cannot do SMP. */
r_if
c_cond
(paren
id|boot_cpu_data.x86
