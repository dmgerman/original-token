...
multiline_comment|/*&n;      if (ccr[1] &amp; 0x80) { ccr[1] &amp;= 0x7f; ccrc[1] |= 0x80; }&n;      if (ccr[1] &amp; 0x04) { ccr[1] &amp;= 0xfb; ccrc[1] |= 0x04; }&n;      if (ccr[1] &amp; 0x02) { ccr[1] &amp;= 0xfd; ccrc[1] |= 0x02; }&n;*/
r_if
c_cond
(paren
id|ccr
...
multiline_comment|/* Disable ARR3. */
