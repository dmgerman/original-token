...
multiline_comment|/*&n; * If CONFIG_APM_IGNORE_SUSPEND_BOUNCE is defined then&n; * ignore suspend events for this amount of time after a resume&n; */
