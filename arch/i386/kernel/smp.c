...
suffix:semicolon
multiline_comment|/* immediate flush required */
DECL|variable|cpu_tlbbad
r_int
r_int
id|cpu_tlbbad
(braket
...
suffix:semicolon
multiline_comment|/* flush before returning to user space */
...
comma
op_amp
id|current-&gt;active_mm-&gt;cpu_vm_mask
)paren
suffix:semicolon
id|cpu_tlbbad
(braket
...
DECL|function|do_flush_tlb_all_kernel_local
r_static
r_inline
r_void
id|do_flush_tlb_all_kernel_local
c_func
(paren
r_void
)paren
...
DECL|function|flush_tlb_all_kernel_ipi
r_static
r_void
id|flush_tlb_all_kernel_ipi
c_func
(paren
r_void
op_star
...
DECL|function|flush_tlb_all_kernel
r_void
