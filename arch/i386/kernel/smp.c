...
c_func
(paren
l_string|&quot;Warning: Max I/O APICs exceeded (max %d, found %d).&bslash;n&quot;
comma
id|MAX_IO_APICS
comma
id|ioapics
...
multiline_comment|/* Structure and data for smp_call_function(). This is designed to minimise&n; * static memory requirements. It also looks cleaner.&n; */
DECL|struct|smp_call_function_struct
r_struct
id|smp_call_function_struct
(brace
DECL|member|func
r_void
(paren
...
multiline_comment|/*  [SUMMARY] Run a function on all other CPUs.&n;    &lt;func&gt; The function to run. This must be fast and non-blocking.&n;    &lt;info&gt; An arbitrary pointer to pass to the function.&n;    &lt;retry&gt; If true, keep retrying until ready.&n;    &lt;wait&gt; If true, wait until function has completed on other CPUs.&n;    [RETURNS] 0 on success, else a negative status code. Does not return until&n;    remote CPUs are nearly ready to execute &lt;&lt;func&gt;&gt; or are or have executed.&n;*/
(brace
r_int
r_int
id|timeout
...
op_assign
id|smp_call_function_data-&gt;func
suffix:semicolon
r_void
op_star
id|info
op_assign
id|smp_call_function_data-&gt;info
suffix:semicolon
r_int
id|wait
op_assign
id|smp_call_function_data-&gt;wait
suffix:semicolon
id|ack_APIC_irq
(paren
)paren
suffix:semicolon
multiline_comment|/*  Notify initiating CPU that I&squot;ve grabbed the data and am about to&n;&t;    execute the function  */
id|atomic_dec
(paren
op_amp
id|smp_call_function_data-&gt;unstarted_count
)paren
suffix:semicolon
multiline_comment|/*  At this point the structure may be out of scope unless wait==1  */
(paren
op_star
id|func
)paren
...
(paren
op_amp
id|smp_call_function_data-&gt;unfinished_count
)paren
suffix:semicolon
)brace
