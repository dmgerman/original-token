...
mdefine_line|#define MICROCODE_VERSION &t;&quot;1.0&quot;
...
(brace
multiline_comment|/* write-only /proc/driver/microcode file, one day may become read-write.. */
id|proc_microcode
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;microcode: can&squot;t create /proc/driver/microcode entry&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
l_string|&quot;from revision %d to %d&bslash;n&quot;
comma
id|id
comma
id|rev
