...
macro_line|#
macro_line|#
macro_line|# zero the complete destination - computing the rest
macro_line|# is too much work 
id|movl
op_mod
l_int|6
comma
...
macro_line|# zero the complete destination (computing the rest is too much work)
id|movl
op_mod
l_int|8
comma
