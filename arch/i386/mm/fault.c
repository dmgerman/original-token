...
id|pte
suffix:semicolon
multiline_comment|/*&n;&t; * make it read/writable temporarily, so that the fault&n;&t; * can be handled.&n;&t; */
id|pgd
op_assign
id|swapper_pg_dir
op_plus
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * Beware: Black magic here. The printk is needed here to flush&n;&t; * CPU state on certain buggy processors.&n;&t; */
id|printk
c_func
(paren
l_string|&quot;Ok&quot;
