...
c_func
(paren
l_string|&quot;memory region: %luk @ %08lx000&bslash;n&quot;
comma
id|count
op_lshift
l_int|2
...
r_break
suffix:semicolon
multiline_comment|/* Avoid the kernel mapping between HIGH_MEMORY and &quot;start_mem&quot;.. */
r_if
c_cond
(paren
id|pfn
...
id|PAGE_SHIFT
suffix:semicolon
multiline_comment|/* We have a certain amount of low memory reserved */
r_if
c_cond
(paren
id|start_pfn
