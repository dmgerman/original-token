...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Map the IO-APIC to FEC00000.&n;&t;&t; */
id|apic_area
op_assign
l_int|0xFEC00000
suffix:semicolon
multiline_comment|/*(unsigned long)IO_APIC_BASE;*/
id|pg_table
op_assign
id|pte_offset
c_func
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * No local APIC but we are compiled SMP ... set up a&n;&t;&t; * fake all zeroes page to simulate the local APIC.&n;&t;&t; */
id|pg_table
op_assign
id|pte_offset
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Do the same for the IO-APIC&n;&t;&t; */
id|apic_area
op_assign
l_int|0xFEC00000
suffix:semicolon
