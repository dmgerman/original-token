...
(paren
id|KERN_ERR
l_string|&quot;vmalloced area %08lx bad&bslash;n&quot;
comma
id|address
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * We need to set ASID of the target entry to flush,&n;&t;&t; * because TLB is indexed by (ASID and PAGE).&n;&t;&t; */
id|set_asid
c_func
(paren
id|asid
