...
multiline_comment|/*&n; * After accessing the memory from kernel space (P1-area), we need to &n; * write back the cache line to maintain DMA coherency.&n; *&n; * We search the D-cache to see if we have the entries corresponding to&n; * the page, and if found, write back them.&n; */
