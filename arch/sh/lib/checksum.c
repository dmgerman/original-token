multiline_comment|/*&n; * Taken from:&n; * arch/alpha/lib/checksum.c&n; *&n; * This file contains network checksum routines that are better done&n; * in an architecture-specific manner due to speed..&n; */
