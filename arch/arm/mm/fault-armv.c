...
mdefine_line|#define BUG_PROC_MSG &bslash;&n;  &quot;Buggy processor (%08X), trying to continue.&bslash;n&quot; &bslash;&n;  &quot;Please read http:
...
(brace
multiline_comment|/*&n;&t; *  0 - vector exception&n;&t; */
r_case
l_int|0
suffix:colon
id|force_sig
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t; * 15 - permission fault on page&n;&t; *  5 - page-table entry descriptor fault&n;&t; *  7 - first-level descriptor fault&n;&t; */
r_case
l_int|15
suffix:colon
r_case
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t; * 13 - permission fault on section&n;&t; */
r_case
l_int|13
suffix:colon
id|force_sig
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t;&t; * this should never happen&n;&t;&t; */
id|DIE
c_func
(paren
id|SIGBUS
