multiline_comment|/*&n; * arch/arm/mm/ioremap.c&n; *&n; * Re-map IO memory to kernel address space so that we can access it.&n; *&n; * (C) Copyright 1995 1996 Linus Torvalds&n; *&n; * Hacked for ARM by Phil Blundell &lt;philb@gnu.org&gt;&n; * Hacked to allow all architectures to build, and various cleanups&n; * by Russell King&n; */
