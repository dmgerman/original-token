multiline_comment|/*&n; * arch/arm/mm/mm-armv.c&n; *&n; * Page table sludge for ARM v3 and v4 processor architectures.&n; *&n; * Copyright (C) 1998-1999 Russell King&n; */
...
multiline_comment|/*&n; * Initial boot-time mapping.  This covers just the&n; * zero page, kernel and the flush area.  NB: it&n; * must be sorted by virtual address, and no&n; * virtual address overlaps.&n; *  init_map[2..4] are for architectures with small&n; *  amounts of banked memory.&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Correct the above mappings&n;&t; */
id|init_map
(braket
l_int|0
)braket
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;&t; * Firstly, go through the initial mappings,&n;&t; * but clear out any pgdir entries that are&n;&t; * not in the description.&n;&t; */
r_do
(brace
r_if
c_cond
...
suffix:semicolon
multiline_comment|/*&n;&t; * Now, create the architecture specific mappings&n;&t; */
r_for
c_loop
(paren
id|idx
...
multiline_comment|/*&n; * The mem_map array can get very big.  Mark the end of the&n; * valid mem_map banks with PG_skip, and setup the address&n; * validity bitmap.&n; */
r_int
r_int
id|__init
...
(paren
id|KERN_CRIT
l_string|&quot;*** Error: RAM bank 0 too small&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
