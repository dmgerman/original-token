multiline_comment|/*&n; * ARM semaphore implementation, taken from&n; *&n; * i386 semaphore implementation.&n; *&n; * (C) Copyright 1999 Linus Torvalds&n; *&n; * Modified for ARM by Russell King&n; */
...
multiline_comment|/*&n; * The semaphore operations have a special calling sequence that&n; * allow us to do a simpler in-line version of them. These routines&n; * need to convert that sequence back into the C sequence when&n; * there is contention on the semaphore.&n; *&n; * r0 contains the semaphore pointer on entry. Save the C-clobbered&n; * registers (r0 to r3, ip and lr) except r0 in the cases where it&n; * is used as a return value..&n; */
id|asm
c_func
(paren
"&quot;"
