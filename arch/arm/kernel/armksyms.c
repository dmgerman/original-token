...
suffix:semicolon
DECL|macro|EXPORT_VERS0
mdefine_line|#define EXPORT_VERS0(sym,orig) &bslash;&n; const char __kstrtab_##sym##[] __attribute__((section(&quot;.kstrtab&quot;))) = &bslash;&n;    __MODULE_STRING(##sym##_R00000000); &bslash;&n; const struct module_symbol __ksymtab_##sym __attribute__((section(&quot;__ksymtab&quot;))) = &bslash;&n;    { (unsigned long)&amp;##orig, __kstrtab_##sym };
