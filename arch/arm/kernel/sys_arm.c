...
DECL|macro|PGOFF_SHIFT
mdefine_line|#define PGOFF_SHIFT (PAGE_SHIFT - 12)
DECL|macro|PGOFF_MASK
mdefine_line|#define PGOFF_MASK  (~((1 &lt;&lt; PGOFF_SHIFT) - 1))
multiline_comment|/*&n; * Note: off_4k is always units of 4K.  If we can&squot;t do the requested&n; * offset, we return EINVAL.&n; */
id|asmlinkage
r_int
