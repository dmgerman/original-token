...
multiline_comment|/*&n; * Assign new address to PCI resource.  We hope our resource information&n; * is complete.&n; *&n; * Expects start=0, end=size-1, flags=resource type.&n; */
