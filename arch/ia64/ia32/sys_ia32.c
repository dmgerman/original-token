multiline_comment|/*&n; * sys_ia32.c: Conversion between 32bit and 64bit native syscalls. Based on&n; *             sys_sparc32 &n; *&n; * Copyright (C) 2000&t;&t;VA Linux Co&n; * Copyright (C) 2000&t;&t;Don Dugger &lt;n0ano@valinux.com&gt;&n; * Copyright (C) 1999 &t;&t;Arun Sharma &lt;arun.sharma@intel.com&gt;&n; * Copyright (C) 1997,1998 &t;Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; * Copyright (C) 1997 &t;&t;David S. Miller (davem@caip.rutgers.edu)&n; *&n; * These routines maintain argument size conversion between 32bit and 64bit&n; * environment.&n; */
...
DECL|macro|AA
mdefine_line|#define AA(__x) ((unsigned long)(__x))
r_static
r_int
DECL|function|nargs
id|nargs
...
id|PROT_EXEC
suffix:semicolon
macro_line|#ifdef&t;DDD
macro_line|#else&t;
singleline_comment|// DDD
id|prot
op_or_assign
id|PROT_WRITE
suffix:semicolon
