...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * We flag unaligned references while in kernel as&n;&t; * errors: the kernel must be fixed. The switch code&n;&t; * is in ivt.S at entry 30.&n;&t; *&n;&t; * So here we keep a simple sanity check.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t; * Make sure we log the unaligned access, so that user/sysadmin can notice it&n;&t; * and eventually fix the program.&n;&t; *&n;&t; * We don&squot;t want to do that for every access so we pace it with jiffies.&n;&t; */
r_if
c_cond
(paren
id|unalign_count
