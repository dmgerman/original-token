...
r_else
(brace
multiline_comment|/*&n;&t;&t; * XXX: will eventually move back to perfmonctl()&n;&t;&t; */
r_int
r_int
id|pmd
op_assign
...
id|perf_ovfl_val
suffix:semicolon
multiline_comment|/* we just use ptrace to read */
r_if
c_cond
(paren
id|write_access
...
c_func
(paren
l_string|&quot;ptrace: rejecting access to PMD[%ld] address 0x%lx&bslash;n&quot;
comma
id|pmd
comma
id|addr
...
multiline_comment|/* &n;&t;&t; * We always need to mask upper 32bits of pmd because value is random&n;&t;&t; */
id|pmd_tmp
op_assign
id|child-&gt;thread.pmod
(braket
id|pmd
)braket
op_plus
...
suffix:semicolon
multiline_comment|/*printk(__FUNCTION__&quot; child=%d reading pmd[%ld]=%lx&bslash;n&quot;, child-&gt;pid, pmd, pmd_tmp);*/
id|ptr
op_assign
op_amp
id|pmd_tmp
