...
multiline_comment|/*&n; * The unwind tables are supposed to be sorted, but the GNU toolchain&n; * currently fails to produce a sorted table in the presence of&n; * functions that go into sections other than .text.  For example, the&n; * kernel likes to put initialization code into .text.init, which&n; * messes up the sort order.  Hopefully, this will get fixed sometime&n; * soon.  --davidm 00/05/23&n; */
DECL|macro|UNWIND_TABLE_SORT_BUG
mdefine_line|#define UNWIND_TABLE_SORT_BUG
...
c_func
(paren
l_string|&quot;unwind: 0x%p outside of regstk &quot;
...
id|i
suffix:semicolon
multiline_comment|/*&n;&t; * First, resolve implicit register save locations&n;&t; * (see Section &quot;11.4.2.3 Rules for Using Unwind&n;&t; * Descriptors&quot;, rule 3):&n;&t; */
r_for
c_loop
(paren
id|i
...
(brace
DECL|macro|magic
macro_line|#&t;define magic&t;0x9e3779b97f4a7c16&t;/* (sqrt(5)/2-1)*2^64 */
r_return
(paren
id|ip
op_rshift
...
multiline_comment|/*&n;&t;&t; * We&squot;re initializing a general register: init NaT info, too.  Note that we&n;&t;&t; * rely on the fact that call_unat is the first field in struct switch_stack:&n;&t;&t; */
id|s
(braket
id|val
op_plus
...
id|table_end
suffix:semicolon
macro_line|#ifdef UNWIND_TABLE_SORT_BUG
(brace
r_struct
id|unw_table_entry
op_star
...
id|tmp
suffix:semicolon
multiline_comment|/* stupid bubble sort... */
r_for
c_loop
(paren
id|e1
