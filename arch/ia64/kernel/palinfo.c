...
multiline_comment|/*&n; * The current resvision of the Volume 2 of &n; * IA-64 Architecture Software Developer&squot;s Manual is wrong.&n; * Table 4-10 has invalid information concerning the ma field:&n; * Correct table is:&n; *      bit 0 - 001 - UC&n; *      bit 4 - 100 - UC&n; *      bit 5 - 101 - UCE&n; *      bit 6 - 110 - WC&n; *      bit 7 - 111 - NatPage &n; */
...
initialization_block
suffix:semicolon
multiline_comment|/*&n; * Allocate a buffer suitable for calling PAL code in Virtual mode&n; *&n; * The documentation (PAL2.6) requires thius buffer to have a pinned&n; * translation to avoid any DTLB faults. For this reason we allocate&n; * a page (large enough to hold any possible reply) and use a DTC&n; * to hold the translation during the call. A call the free_palbuffer()&n; * is required to release ALL resources (page + translation).&n; *&n; * The size of the page allocated is based on the PAGE_SIZE defined&n; * at compile time for the kernel, i.e.  &gt;= 4Kb.&n; *&n; * Return: a pointer to the newly allocated page (virtual address)&n; */
r_static
r_void
op_star
...
(paren
id|KERN_ERR
l_string|&quot;%s: can&squot;t get a buffer page&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
...
(brace
multiline_comment|/* XXX: temporary hack */
r_int
r_int
id|flags
suffix:semicolon
multiline_comment|/* PSR.ic must be zero to insert new DTR */
id|ia64_clear_ic
c_func
(paren
id|flags
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * we  only insert of DTR&n;&t;&t; *&n;&t;&t; * XXX: we need to figure out a way to &quot;allocate&quot; TR(s) to avoid&n;&t;&t; * conflicts. Maybe something in an include file like pgtable.h&n;&t;&t; * page.h or processor.h&n;&t;&t; *&n;&t;&t; * ITR0/DTR0: used for kernel code/data&n;&t;&t; * ITR1/DTR1: used by HP simulator&n;&t;&t; * ITR2/DTR2: used to map PAL code&n;&t;&t; */
id|ia64_itr
c_func
(paren
l_int|0x2
...
multiline_comment|/*&n; * Free a palcall buffer allocated with the previous call&n; *&n; * The translation is also purged.&n; */
r_static
r_void
...
id|ret
suffix:semicolon
multiline_comment|/* must be in physical mode */
r_if
c_cond
(paren
(paren
...
id|p
comma
l_string|&quot;PAL_vendor     : 0x%x (min=0x%x)&bslash;n&quot;
"&bslash;"
l_string|&quot;PAL_A revision : 0x%x (min=0x%x)&bslash;n&quot;
"&bslash;"
l_string|&quot;PAL_A model    : 0x%x (min=0x%x)&bslash;n&quot;
"&bslash;"
l_string|&quot;PAL_B mode     : 0x%x (min=0x%x)&bslash;n&quot;
"&bslash;"
l_string|&quot;PAL_B revision : 0x%x (min=0x%x)&bslash;n&quot;
comma
...
multiline_comment|/*&n; * Entry point routine: all calls go trhough this function&n; */
r_static
r_int
...
multiline_comment|/*&n; * List names,function pairs for every entry in /proc/palinfo&n; * Must be terminated with the NULL,NULL entry.&n; */
