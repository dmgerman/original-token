...
suffix:semicolon
"&f;"
multiline_comment|/*&n; * Process bootcommand SMP options, like &quot;nosmp&quot; and &quot;maxcpus=&quot;.&n; */
r_void
id|__init
...
l_int|1
suffix:semicolon
macro_line|#ifdef NOT_YET_PROFILING
id|load_profile_irq
c_func
(paren
id|mid_xlate
...
(paren
id|KERN_INFO
l_string|&quot;SMP: commencing CPU %d current %p&bslash;n&quot;
comma
id|cpuid
comma
id|current
...
id|buffer
comma
l_string|&quot;CPUs probed %d active %d map 0x%lx IPIs %ld&bslash;n&quot;
comma
id|smp_num_probed
comma
id|smp_num_cpus
...
(paren
id|KERN_WARNING
l_string|&quot;spinlock stuck at %p(%d) owner %s at %p(%d) st %ld&bslash;n&quot;
comma
id|inline_pc
comma
id|cpu
