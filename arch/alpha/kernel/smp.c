...
suffix:semicolon
multiline_comment|/* Order data access and bit clearing. */
)brace
r_if
c_cond
(paren
...
mdefine_line|#define spinlock_raise_ipl(LOCK)&t;0
DECL|macro|spinlock_restore_ipl
mdefine_line|#define spinlock_restore_ipl(PREV)&t;((void)0)
