...
DECL|macro|IACK_SC
macro_line|# define IACK_SC&t;TSUNAMI_PCI0_IACK_SC
macro_line|#else
...
DECL|macro|STUCK
mdefine_line|#define STUCK&t;&t;&t;&t;&t;&t;&bslash;&n;  if (!--stuck) {&t;&t;&t;&t;&t;&bslash;&n;    printk(&quot;wait_on_irq CPU#%d stuck at %08lx, &quot;&t;&bslash;&n;&t;   &quot;waiting for %08lx (local=%d, global=%d)&bslash;n&quot;,&t;&bslash;&n;&t;   cpu, where, previous_irqholder, local_count,&t;&bslash;&n;&t;   atomic_read(&amp;global_irq_count));&t;&t;&bslash;&n;    stuck = INIT_STUCK;&t;&t;&t;&t;&t;&bslash;&n;  }
r_static
r_inline
r_void
...
macro_line|#undef STUCK
DECL|macro|STUCK
mdefine_line|#define STUCK&t;&t;&t;&t;&t;&t;&t;&bslash;&n;  if (!--stuck) {&t;&t;&t;&t;&t;&t;&bslash;&n;    printk(&quot;get_irqlock stuck at %08lx, waiting for %08lx&bslash;n&quot;,&t;&bslash;&n;&t;   where, previous_irqholder);&t;&t;&t;&t;&bslash;&n;    stuck = INIT_STUCK;&t;&t;&t;&t;&t;&t;&bslash;&n;  }
r_static
r_inline
r_void
