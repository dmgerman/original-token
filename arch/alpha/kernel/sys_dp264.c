...
suffix:semicolon
DECL|macro|end_tsunami_irq
mdefine_line|#define end_tsunami_irq&t;&t;enable_tsunami_irq
DECL|macro|shutdown_tsunami_irq
mdefine_line|#define shutdown_tsunami_irq&t;disable_tsunami_irq
DECL|macro|mask_and_ack_tsunami_irq
mdefine_line|#define mask_and_ack_tsunami_irq&t;disable_tsunami_irq
DECL|macro|end_clipper_irq
mdefine_line|#define end_clipper_irq&t;&t;enable_clipper_irq
DECL|macro|shutdown_clipper_irq
mdefine_line|#define shutdown_clipper_irq&t;disable_clipper_irq
DECL|macro|mask_and_ack_clipper_irq
mdefine_line|#define mask_and_ack_clipper_irq&t;disable_clipper_irq
r_static
r_int
r_int
DECL|function|startup_tsunami_irq
id|startup_tsunami_irq
c_func
(paren
r_int
r_int
...
r_int
r_int
DECL|function|startup_clipper_irq
id|startup_clipper_irq
c_func
(paren
r_int
r_int
...
DECL|variable|tsunami_irq_type
r_static
r_struct
...
id|startup_tsunami_irq
comma
id|shutdown_tsunami_irq
comma
id|enable_tsunami_irq
comma
id|disable_tsunami_irq
comma
id|mask_and_ack_tsunami_irq
comma
id|end_tsunami_irq
)brace
suffix:semicolon
...
id|startup_clipper_irq
comma
id|shutdown_clipper_irq
comma
id|enable_clipper_irq
comma
id|disable_clipper_irq
comma
id|mask_and_ack_clipper_irq
comma
id|end_clipper_irq
)brace
suffix:semicolon
...
r_inline
r_void
DECL|function|do_flush_irq_mask
id|do_flush_irq_mask
c_func
(paren
r_int
r_int
...
r_inline
r_void
DECL|function|do_flush_smp_irq_mask
...
r_static
r_void
DECL|function|dp264_flush_irq_mask
...
l_int|0xffff
suffix:semicolon
multiline_comment|/* isa irqs always enabled */
id|do_flush_irq_mask
c_func
(paren
id|value
...
r_static
r_void
DECL|function|enable_tsunami_irq
id|enable_tsunami_irq
c_func
(paren
r_int
...
r_static
r_void
DECL|function|disable_tsunami_irq
id|disable_tsunami_irq
c_func
(paren
r_int
...
r_static
r_void
DECL|function|clipper_flush_irq_mask
...
r_static
r_void
DECL|function|enable_clipper_irq
id|enable_clipper_irq
c_func
(paren
r_int
...
r_static
r_void
DECL|function|disable_clipper_irq
id|disable_clipper_irq
c_func
(paren
r_int
