...
id|pinp
suffix:semicolon
multiline_comment|/* Check first for the built-in bridge on hose 1. */
r_if
c_cond
(paren
id|dev2hose
...
r_void
id|__init
DECL|function|webbrick_pci_fixup
id|webbrick_pci_fixup
c_func
(paren
r_void
)paren
...
r_void
id|__init
DECL|function|clipper_pci_fixup
id|clipper_pci_fixup
c_func
(paren
r_void
)paren
