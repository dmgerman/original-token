...
id|i
suffix:semicolon
multiline_comment|/* alloc the bootmem after the kernel */
id|start_pfn
op_assign
id|PFN_UP
c_func
...
c_func
(paren
l_string|&quot;memcluster %d, usage %02lx, start %8lu, end %8lu&bslash;n&quot;
comma
id|i
comma
id|cluster-&gt;usage
...
c_func
(paren
l_string|&quot;max_low_pfn %d&bslash;n&quot;
comma
id|max_low_pfn
)paren
suffix:semicolon
multiline_comment|/* allocate the bootmem array after the kernel and mark&n;&t;   the whole MM as reserved */
id|bootmap_size
op_assign
id|init_bootmem
c_func
