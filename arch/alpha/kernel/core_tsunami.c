...
l_int|0
suffix:colon
multiline_comment|/*&n;&t;&t; * Set up the PCI-&gt;physical memory translation windows.&n;&t;&t; * For now, windows 1,2 and 3 are disabled.  In the future,&n;&t;&t; * we may want to use them to do scatter/gather DMA. &n;&t;&t; *&n;&t;&t; * Window 0 goes at 1 GB and is 1 GB large, mapping to 0.&n;&t;&t; * Window 1 goes at 2 GB and is 1 GB large, mapping to 1GB.&n;&t;&t; */
id|pchip-&gt;wsba
(braket
l_int|0
)braket
...
id|csr
op_assign
id|TSUNAMI_DMA_WIN0_BASE_DEFAULT
op_or
l_int|1UL
suffix:semicolon
id|pchip-&gt;wsm
...
op_assign
(paren
id|TSUNAMI_DMA_WIN0_SIZE_DEFAULT
op_minus
l_int|1
)paren
op_amp
...
id|csr
op_assign
id|TSUNAMI_DMA_WIN0_TRAN_DEFAULT
suffix:semicolon
id|pchip-&gt;wsba
(braket
l_int|1
...
id|csr
op_assign
id|TSUNAMI_DMA_WIN1_BASE_DEFAULT
op_or
l_int|1UL
suffix:semicolon
id|pchip-&gt;wsm
...
op_assign
(paren
id|TSUNAMI_DMA_WIN1_SIZE_DEFAULT
op_minus
l_int|1
)paren
op_amp
...
id|csr
op_assign
id|TSUNAMI_DMA_WIN1_TRAN_DEFAULT
suffix:semicolon
id|pchip-&gt;wsba
(braket
l_int|2
