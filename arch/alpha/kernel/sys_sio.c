multiline_comment|/*&n; *&t;linux/arch/alpha/kernel/sys_sio.c&n; *&n; *&t;Copyright (C) 1995 David A Rusling&n; *&t;Copyright (C) 1996 Jay A Estabrook&n; *&t;Copyright (C) 1998 Richard Henderson&n; *&n; * Code for all boards that route the PCI interrupts through the SIO&n; * PCI/ISA bridge.  This includes Noname (AXPpci33), Multia (UDB),&n; * Kenetics&squot;s Platform 2000, Avanti (AlphaStation), XL, and AlphaBook1.&n; */
...
r_static
r_void
DECL|function|sio_update_irq_hw
id|sio_update_irq_hw
c_func
(paren
r_int
r_int
...
(brace
multiline_comment|/*&n;&t; * Set up the PCI-&gt;physical memory translation windows.  For&n;&t; * the XL we *must* use both windows, in order to maximize the&n;&t; * amount of physical memory that can be used to DMA from the&n;&t; * ISA bus, and still allow PCI bus devices access to all of&n;&t; * host memory.&n;&t; *&n;&t; * See &lt;asm/apecs.h&gt; for window bases and sizes.&n;&t; *&n;&t; * This restriction due to the true XL motherboards&squot; 82379AB SIO&n;&t; * PCI&lt;-&gt;ISA bridge chip which passes only 27 bits of address...&n;&t; */
op_star
(paren
id|vuip
)paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Finally, clear the HAXR2 register, which gets used for PCI&n;&t; * Config Space accesses. That is the way we want to use it,&n;&t; * and we do not want to depend on what ARC or SRM might have&n;&t; * left behind...&n;&t; */
op_star
(paren
id|vuip
)paren
...
id|route_tab
suffix:semicolon
multiline_comment|/* Examine or update the PCI routing table.  */
...
multiline_comment|/* Update all the IRQs.  */
id|common_pci_fixup
c_func
(paren
id|map_irq
...
r_void
id|__init
DECL|function|noname_pci_fixup
id|noname_pci_fixup
c_func
(paren
r_void
...
r_void
id|__init
DECL|function|avanti_pci_fixup
id|avanti_pci_fixup
c_func
(paren
r_void
...
r_void
id|__init
DECL|function|alphabook1_pci_fixup
id|alphabook1_pci_fixup
c_func
(paren
r_void
)paren
