...
suffix:semicolon
multiline_comment|/*&n;&t; * Set up the PCI-&gt;physical memory translation windows.&n;&t; * For now, windows 2 and 3 are disabled.  In the future,&n;&t; * we may want to use them to do scatter/gather DMA. &n;&t; *&n;&t; * Window 0 goes at 1 GB and is 1 GB large.&n;&t; * Window 1 goes at 2 GB and is 1 GB large.&n;&t; */
op_star
(paren
id|vuip
)paren
...
suffix:semicolon
multiline_comment|/*&n;&t; * Zero the HAEs. &n;&t; */
op_star
(paren
(paren
id|vuip
