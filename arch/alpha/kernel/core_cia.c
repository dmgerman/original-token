...
id|temp
suffix:semicolon
multiline_comment|/*&n;&t; * Next, clear the CIA_CFG register, which gets used&n;&t; * for PCI Config Space accesses. That is the way&n;&t; * we want to use it, and we do not want to depend on&n;&t; * what ARC or SRM might have left behind...&n;&t; */
op_star
(paren
id|vuip
)paren
