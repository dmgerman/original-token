...
id|PAGE_MASK
suffix:semicolon
multiline_comment|/* ??? This shouldn&squot;t have been needed, since the entries&n;&t;   we&squot;ve just modified were not in the iommu tlb.  */
id|alpha_mv
dot
id|mv_pci_tbi
c_func
...
(paren
id|KERN_INFO
l_string|&quot;dma_alloc_consistent: &quot;
l_string|&quot;kmalloc failed from %p&bslash;n&quot;
comma
id|__builtin_return_address
c_func
(paren
...
c_func
(paren
l_string|&quot;dma_alloc_consistent: %lx -&gt; [%p,%x] from %p&bslash;n&quot;
comma
id|size
comma
id|cpu_addr
...
c_func
(paren
l_string|&quot;dma_free_consistent: [%x,%lx] from %p&bslash;n&quot;
comma
id|dma_addr
comma
id|size
...
multiline_comment|/* Classify the elements of the scatterlist.  Write dma_address&n;   of each element with:&n;&t;0   : Not mergable.&n;&t;1   : Followers all physically adjacent.&n;&t;[23]: Followers all virtually adjacent.&n;&t;-1  : Not leader.&n;   Write dma_length of each leader with the combined lengths of&n;   the mergable followers.  */
r_static
r_inline
r_void
...
c_func
(paren
l_string|&quot;sg_fill: [%p,%lx] -&gt; sg %x&bslash;n&quot;
comma
id|leader-&gt;address
comma
id|size
...
multiline_comment|/* TODO: Only use the iommu when it helps.  Non-mergable scatterlist&n;   entries might as well use direct mappings.  */
r_int
...
id|fend
suffix:semicolon
multiline_comment|/* If pci_tbi is not available, we must not be able to control&n;&t;   an iommu.  Direct map everything, no merging.  */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Second, iterate over the scatterlist leaders and allocate&n;&t;   dma space as needed.  */
r_for
c_loop
(paren
id|out
...
c_func
(paren
l_string|&quot;pci_unmap_sg: direct [%lx,%lx]&bslash;n&quot;
comma
id|addr
comma
id|size
...
c_func
(paren
l_string|&quot;pci_unmap_sg: sg [%lx,%lx]&bslash;n&quot;
comma
id|addr
comma
id|size
