...
DECL|function|unset_singlestep
r_static
r_void
id|unset_singlestep
c_func
...
multiline_comment|/* Uh, this does ugly stuff. It stores the specified value in the a3&n; * register. entry.S will swap a3 and the returned value from&n; * sys_ptrace() before returning to the user.&n; */
...
multiline_comment|/* This doesn&squot;t do diddly, actually--if the value returned from &n; * sys_ptrace() is != 0, it sets things up properly.&n; */
