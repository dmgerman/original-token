...
suffix:semicolon
multiline_comment|/* XXX: Check here if we would need to switch stacks.. */
r_if
c_cond
(paren
id|verify_area
...
suffix:semicolon
multiline_comment|/* Zero all bits of the ucontext besides the sigcontext.  */
id|__clear_user
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* Copy in the bits we actually use.  */
id|__put_user
c_func
(paren
id|set-&gt;sig
