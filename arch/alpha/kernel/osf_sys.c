...
multiline_comment|/* EV6 implements most of the bits in hardware.  If&n;&t;&t;   UNDZ is not set, UNFD is maintained in software.  */
r_if
c_cond
(paren
id|implver
...
id|IEEE_SW_MASK
suffix:semicolon
multiline_comment|/* Update the real fpcr.  Keep UNFD off if not UNDZ.  */
id|fpcr
op_assign
id|rdfpcr
c_func
...
suffix:semicolon
id|shminfo_oldst.shmmin
op_assign
id|tbuf-&gt;shmmin
suffix:semicolon
id|shminfo_oldst.shmmni
op_assign
id|tbuf-&gt;shmmni
suffix:semicolon
id|shminfo_oldst.shmseg
op_assign
id|tbuf-&gt;shmseg
suffix:semicolon
id|shminfo_oldst.shmall
op_assign
id|tbuf-&gt;shmall
suffix:semicolon
r_if
