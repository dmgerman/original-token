...
id|hose
suffix:semicolon
multiline_comment|/*&n;&t; * Set up the PCI-&gt;physical memory translation windows.&n;&t; * For now, window 1 is disabled.  In the future, we may&n;&t; * want to use it to do scatter/gather DMA. &n;&t; *&n;&t; * Window 0 goes at 1 GB and is 1 GB large.&n;&t; */
op_star
(paren
id|vulp
)paren
