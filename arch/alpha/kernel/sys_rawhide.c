...
suffix:semicolon
multiline_comment|/* Note that `mask&squot; initially contains only the low 64 bits.  */
r_static
r_void
...
(brace
multiline_comment|/* Saddle 0 includes EISA interrupts.  */
id|mask
op_rshift_assign
l_int|16
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* HACK ALERT! Routing is only to CPU #0.  */
r_for
c_loop
(paren
id|hose
