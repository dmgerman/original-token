...
suffix:semicolon
multiline_comment|/*&n;&t; * a0 = 2 (OSF)&n;&t; * a1 = return address, but we give the asm the vaddr of the PCB&n;&t; * a2 = physical addr of PCB&n;&t; * a3 = new virtual page table pointer&n;&t; * a4 = KSP (but we give it 0, asm sets it)&n;&t; */
id|i
op_assign
id|switch_to_osf_pal
c_func
