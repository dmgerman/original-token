...
DECL|macro|ALIGN_DEST_TO8
mdefine_line|#define ALIGN_DEST_TO8(d,s,n) &bslash;&n;&t;while (d &amp; 7) { &bslash;&n;&t;&t;if (n &lt;= 0) return; &bslash;&n;&t;&t;n--; &bslash;&n;&t;&t;*(char *) d = *(char *) s; &bslash;&n;&t;&t;d++; s++; &bslash;&n;&t;}
...
DECL|macro|DO_REST
mdefine_line|#define DO_REST(d,s,n) &bslash;&n;&t;while (n &gt; 0) { &bslash;&n;&t;&t;n--; &bslash;&n;&t;&t;*(char *) d = *(char *) s; &bslash;&n;&t;&t;d++; s++; &bslash;&n;&t;}
...
DECL|macro|DO_REST_ALIGNED
mdefine_line|#define DO_REST_ALIGNED(d,s,n) DO_REST(d,s,n)
...
DECL|function|__memcpy_unaligned
r_static
r_inline
r_void
id|__memcpy_unaligned
c_func
(paren
r_int
r_int
