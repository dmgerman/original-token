multiline_comment|/*&n; * misc.c&n; * &n; * This is a collection of several routines from gzip-1.0.3 &n; * adapted for Linux.&n; *&n; * malloc by Hannu Savolainen 1993 and Matthias Urlichs 1994&n; * puts by Nick Holloway 1993&n; *&n; * Adapted for PowerPC by Gary Thomas&n; * Updated and modified by Cort Dougan (cort@cs.nmt.edu)&n; */
...
c_func
(paren
l_string|&quot;Boot code relocated to: &quot;
)paren
suffix:semicolon
id|puthex
c_func
...
c_func
(paren
l_string|&quot;Residual data relocated to: &quot;
)paren
suffix:semicolon
id|puthex
c_func
...
multiline_comment|/*&n;   * Take care of initrd if we have one&n;   */
multiline_comment|/*&n;   * the _actual_ load addr is 64k (elf hdr size) lower but the&n;   * firmware gives us the starting exec point not the load ptr&n;   * -- Cort&n;   */
id|eh
op_assign
(paren
id|Elf32_Ehdr
...
suffix:semicolon
multiline_comment|/*puts(&quot;Entry point: &quot;); puthex(eh-&gt;e_entry); puts(&quot;&bslash;n&quot;);*/
multiline_comment|/* find string table */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/*puts(&quot;Section: &quot;); puthex(i);&n;&t;  puts(&quot; type: &quot;); puthex(sh-&gt;sh_type);&n;&t;  puts(&quot; offset: &quot;); puthex(sh-&gt;sh_offset);&n;&t;  puts(&quot;&bslash;n&quot;);*/
r_if
c_cond
(paren
id|sh-&gt;sh_type
...
suffix:semicolon
multiline_comment|/*puts(&quot;Found strtab at: &quot;); puthex((unsigned long)strtab);&n;&t;&t;  puts(&quot;&bslash;n&quot;);*/
r_break
suffix:semicolon
)brace
)brace
multiline_comment|/* find the initrd and image sections */
r_if
c_cond
(paren
id|strtab_shdr
...
c_func
(paren
l_string|&quot;Couldn&squot;t find string table for boot image!&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;cmd_line &gt; 16M&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;hold_residual &gt; 16M&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;initrd_start &gt; 16M&bslash;n&quot;
)paren
suffix:semicolon
id|puts
c_func
...
DECL|function|show_residual_data
id|show_residual_data
c_func
(paren
id|RESIDUAL
op_star
