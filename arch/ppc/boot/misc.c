...
suffix:semicolon
multiline_comment|/*puts(&quot;Relocated to start: &quot;);  puthex(start); puts(&quot; &quot;);&n;  puthex(num_words+start);&n;  puts(&quot;&bslash;n&quot;);*/
id|puts
c_func
(paren
l_string|&quot;Cksum: &quot;
...
multiline_comment|/* make the moto firmware print something */
id|puts
c_func
(paren
