multiline_comment|/*&n; * misc.c&n; * &n; * This is a collection of several routines from gzip-1.0.3 &n; * adapted for Linux.&n; *&n; * malloc by Hannu Savolainen 1993 and Matthias Urlichs 1994&n; * puts by Nick Holloway 1993&n; *&n; * Adapted for PowerPC by Gary Thomas&n; */
...
suffix:semicolon
multiline_comment|/*return (TotalMemory);*/
multiline_comment|/* Later this can be a pointer to saved residual data */
r_return
op_amp
id|hold_residual
suffix:semicolon
