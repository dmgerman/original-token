...
multiline_comment|/* Delay for a certain number of seconds */
multiline_comment|/* Note: They loop is used since &squot;udelay&squot; can&squot;t handle really long counts! */
r_int
DECL|function|delayLoop
id|delayLoop
c_func
(paren
r_int
...
multiline_comment|/*&n; * OLD vreset.c&n; *&n; * Initialize the VGA control registers to 80x25 text mode.&n; *&n; * Adapted from a program by:&n; *                                      Steve Sellgren&n; *                                      San Francisco Indigo Company&n; *                                      sfindigo!sellgren@uunet.uu.net&n; */
DECL|variable|CRTC
r_int
r_char
id|CRTC
...
suffix:semicolon
multiline_comment|/* Keyboard should work */
)brace
eof
