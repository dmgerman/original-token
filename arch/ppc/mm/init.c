...
macro_line|#if defined(CONFIG_PREP) || defined(CONFIG_PMAC)
DECL|macro|MMU_SEGMENT_1
mdefine_line|#define MMU_SEGMENT_1&t;&t;0x80000000
DECL|macro|MMU_SEGMENT_2
mdefine_line|#define MMU_SEGMENT_2&t;&t;0xc0000000
macro_line|#endif /* CONFIG_PREP || CONFIG_PMAC */
macro_line|#ifdef CONFIG_CHRP
DECL|macro|MMU_SEGMENT_1
mdefine_line|#define MMU_SEGMENT_1&t;&t;0xf0000000&t;/* LongTrail */
DECL|macro|MMU_SEGMENT_2
mdefine_line|#define MMU_SEGMENT_2&t;&t;0xc0000000
...
multiline_comment|/* NOTE: everything below here is moving to mapin_ram() */
...
id|BAT2.batu.bl
suffix:semicolon
multiline_comment|/*&n;&t;     * let ibm get to the device mem from user mode since&n;&t;     * the X for them needs it right now -- Cort&n;&t;     */
r_if
c_cond
(paren
id|_machine
...
suffix:semicolon
r_else
multiline_comment|/* prep and chrp */
id|end_of_DRAM
op_assign
id|prep_find_end_of_memory
c_func
...
id|size
suffix:semicolon
multiline_comment|/*&n;&t; * BAT mappings on prep cover this already so don&squot;t waste&n;&t; * space with it. -- Cort&n;&t; */
r_if
c_cond
(paren
id|is_prep
...
r_return
suffix:semicolon
multiline_comment|/* else unmap it */
)brace
r_void
