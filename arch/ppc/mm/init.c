...
multiline_comment|/* 8xx doesn&squot;t have BATs */
...
id|ksize
suffix:semicolon
multiline_comment|/* we can&squot;t call the prom any more at this stage, so&n;&t;   all of memory is available (after klimit) */
id|phys_avail
op_assign
id|phys_mem
suffix:semicolon
multiline_comment|/*&n;&t; * phys_avail records memory we can use.&n;&t; * Make sure the kernel text/data/bss is not in it.&n;&t; */
id|kstart
op_assign
id|__pa
c_func
...
(brace
multiline_comment|/*&n;&t;&t; * Remove the initialized ramdisk from the available memory.&n;&t;&t; */
id|remove_mem_piece
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * All pages are DMA-able so this is wrong - the zone code is assuming&n;&t;&t; * both regions have a value so this is necessary for now.&n;&t;&t; * -- Cort&n;&t;&t; */
id|zones_size
(braket
l_int|0
)braket
