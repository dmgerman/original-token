...
id|i
suffix:semicolon
multiline_comment|/*&n;&t;&t; * All pages are DMA-able so this is wrong - the zone code is&n;&t;&t; * assuming both regions have a value so this is necessary for&n;&t;&t; * now.&n;&t;&t; * -- Cort&n;&t;&t; */
macro_line|#if 1
r_for
c_loop
(paren
