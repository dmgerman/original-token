...
c_func
(paren
l_string|&quot;%-8.8s %3d %3d %8d %8d %8d %c%08x %08x&quot;
comma
id|p-&gt;comm
comma
id|p-&gt;pid
...
op_increment
suffix:semicolon
multiline_comment|/*else if((addr &gt;= (unsigned long)&amp;__init_begin &amp;&amp; addr &lt; (unsigned long)&amp;__init_end))&n;                                initpages++;*/
r_else
r_if
c_cond
(paren
...
id|res.TotalMemory
suffix:semicolon
multiline_comment|/* this really has nothing to do with the mmu_init() but is&n;&t;   necessary for early setup -- Cort */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;Ramsize default to be %dM&bslash;n&quot;
comma
id|_TotalMemory
op_rshift
l_int|20
...
multiline_comment|/* this done by INIT_TSS in processor.h on prep -- Cort */
...
(brace
multiline_comment|/*vsid = (vma-&gt;vm_mm-&gt;context &lt;&lt; 4) | (vmaddr &gt;&gt; 28);*/
id|flush_hash_page
c_func
(paren
id|vma-&gt;vm_mm-&gt;context
multiline_comment|/*vsid*/
comma
id|vmaddr
)paren
suffix:semicolon
multiline_comment|/* this is needed on prep at the moment -- don&squot;t know why&n;&t;&t;   -- Cort*/
id|MMU_invalidate_page
c_func
(paren
id|vma-&gt;vm_mm
...
r_else
(brace
multiline_comment|/*printk(&quot;flush_tlb_page() vmaddr &gt; TASK_SIZE %08x&bslash;n&quot;, vmaddr);*/
)brace
)brace
...
(brace
multiline_comment|/*flush_hash_page(VSID_FROM_CONTEXT( start&gt;&gt;28, mm-&gt;context),&n;&t;&t;&t;&t;start );*/
id|flush_hash_page
c_func
(paren
id|mm-&gt;context
...
macro_line|#ifdef CONFIG_PREP
multiline_comment|/*&n; * it&squot;s not a simple matter to get rid of these and switch to the&n; * ones paul is using. it will take some time and thought  -- Cort&n; */
...
c_func
(paren
l_string|&quot;sr %2d t:%1d ks:%d kp:%d n:%d vsid:%x  %x&bslash;n&quot;
comma
id|i
op_rshift
l_int|28
...
c_func
(paren
l_string|&quot;mfspr %0,532; mfspr %1, 533&bslash;n&quot;
suffix:colon
l_string|&quot;=r&quot;
(paren
id|bu
...
c_func
(paren
l_string|&quot;bat2 bepi: %0x vs: %1x vp: %1x wimg: %x%x%x%x pp: %1x&bslash;n&quot;
comma
id|bu.bepi
op_lshift
l_int|17
