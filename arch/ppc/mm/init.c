...
multiline_comment|/* END APUS includes */
...
op_star
id|pte
multiline_comment|/* = (pte_t *) __get_free_page(GFP_KERNEL)*/
suffix:semicolon
r_if
c_cond
(paren
...
multiline_comment|/*free_page((unsigned long)pte);*/
r_if
c_cond
(paren
id|pmd_bad
...
macro_line|#ifdef CONFIG_APUS
DECL|macro|b
mdefine_line|#define b(x) ((unsigned int*)(((unsigned long)(x)) - KERNELBASE + 0xfff00000))
macro_line|#else
