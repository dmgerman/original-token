...
DECL|macro|SHOW_INVALIDATES
mdefine_line|#define SHOW_INVALIDATES
DECL|macro|SHOW_INVALIDATES
macro_line|#undef  SHOW_INVALIDATES
...
mdefine_line|#define NUM_MAPPINGS 128
r_struct
(brace
DECL|member|va
DECL|member|pa
...
macro_line|#if 0 /* I&squot;m not sure this is necessary */
multiline_comment|/* Clear all DRAM not explicitly used by kernel */
id|bzero
c_func
(paren
id|_end
...
c_func
(paren
l_string|&quot;VA: %08X, PA: %08X, Flags: %x, Perms: %d, Vsid: %x&bslash;n&quot;
comma
id|va
comma
id|pg-&gt;page_num
...
multiline_comment|/*&n; * Invalidate a hardware [hash] page table entry&n; * Note: this should never be called [currently] for kernel addresses.&n; */
...
id|_invalidates
suffix:semicolon
macro_line|#ifdef SHOW_INVALIDATES
id|printk
c_func
(paren
l_string|&quot;invalidate()&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|_invalidates
...
c_func
(paren
l_string|&quot;invalidate_mm(%x)&bslash;n&quot;
comma
id|mm
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;invalidate_page(%x[%x], %x)&bslash;n&quot;
comma
id|vma
comma
id|mm
...
r_return
suffix:semicolon
multiline_comment|/* In case VMA lookup fails */
id|_invalidates
op_increment
suffix:semicolon
macro_line|#if 0 /* Unnecessary */
...
multiline_comment|/* Flush TLB entries */
macro_line|#endif
multiline_comment|/* Note: this could be MUCH better */
id|pgd
op_assign
id|pgd_offset
c_func
...
c_func
(paren
l_string|&quot;invalidate_range(%x, %x, %x)&bslash;n&quot;
comma
id|mm
comma
id|va_start
...
c_func
(paren
l_string|&quot;flush_cache_all()&bslash;n&quot;
)paren
suffix:semicolon
id|invalidate
c_func
