multiline_comment|/*&n; * This file is derived from various .h and .c files from the zlib-0.95&n; * distribution by Jean-loup Gailly and Mark Adler, with some additions&n; * by Paul Mackerras to aid in implementing Deflate compression and&n; * decompression for PPP packets.  See zlib.h for conditions of&n; * distribution and use.&n; *&n; * Changes that have been made include:&n; * - changed functions not used outside this file to &quot;local&quot;&n; * - added minCompression parameter to deflateInit2&n; * - added Z_PACKET_FLUSH (see zlib.h for details)&n; * - added inflateIncomp&n; *&n; * $Id: zlib.c,v 1.1 1997/09/19 07:03:44 paulus Exp $&n; */
multiline_comment|/*+++++*/
