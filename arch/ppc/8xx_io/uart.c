...
multiline_comment|/* If the buffer address is in the CPM DPRAM, don&squot;t&n;&t; * convert it.&n;&t; */
r_if
c_cond
(paren
(paren
...
macro_line|#ifdef CONFIG_XMON
r_int
DECL|function|xmon_8xx_read_poll
...
r_int
DECL|function|xmon_8xx_read_char
...
l_int|0x00c0
suffix:semicolon
multiline_comment|/* Enable SMC1 instead of Port B I/O */
...
id|CPM_CR_FLG
suffix:semicolon
multiline_comment|/*&n;&t; * delay for a bit - this is necessary on my board!&n;&t; *  -- Cort&n;&t; */
id|printk
c_func
(paren
l_string|&quot;&quot;
