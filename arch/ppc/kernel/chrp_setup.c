...
id|type
suffix:semicolon
multiline_comment|/* select logical device 0 (KBC/Keyboard) */
id|sio_write
c_func
(paren
l_int|0
...
c_func
(paren
l_string|&quot;sio: Keyboard irq %d, type %d: &quot;
comma
id|irq
comma
id|type
...
c_func
(paren
l_string|&quot;remapping to irq 1, type 3&bslash;n&quot;
)paren
suffix:semicolon
id|sio_write
c_func
...
c_func
(paren
l_string|&quot;sio: Mouse irq %d, type %d: &quot;
comma
id|irq
comma
id|type
...
c_func
(paren
l_string|&quot;remapping to irq 12, type 3&bslash;n&quot;
)paren
suffix:semicolon
id|sio_write
c_func
