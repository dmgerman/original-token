...
suffix:semicolon
multiline_comment|/*&n;&t; * The f50 has a lot of IO space - we need to map some in that&n;&t; * isn&squot;t covered by the BAT mappings in MMU_init() -- Cort&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
macro_line|#if 0&t;&t;
multiline_comment|/*&n;&t;&t; * This ugly hack allows us to force ioremap() to&n;&t;&t; * create a 1-to-1 mapping for us, even though&n;&t;&t; * the address is &lt; ioremap_base.  This is necessary&n;&t;&t; * since we want our PCI IO space to have contiguous&n;&t;&t; * virtual addresses and I think it&squot;s worse to have&n;&t;&t; * calls to map_page() here.&n;&t;&t; * -- Cort&n;&t;&t; */
r_int
r_int
id|hold
op_assign
