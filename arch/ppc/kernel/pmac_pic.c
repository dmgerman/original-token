...
multiline_comment|/* could be here due to a do_fake_interrupt call but we don&squot;t&n;                   mess with the controller from the second cpu -- Cort */
r_goto
id|out
suffix:semicolon
)brace
