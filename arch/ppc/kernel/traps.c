...
(brace
multiline_comment|/*&n;&t; * This should be changed so we don&squot;t take a trap if coming&n;&t; * back when last_task_used_altivec == current.  We should also&n;&t; * allow the kernel to use the altivec regs on UP to store tasks&n;&t; * regs during switch&n;&t; *  -- Cort&n;&t; */
r_if
c_cond
(paren
id|regs-&gt;msr
...
c_func
(paren
l_string|&quot;AltiVec trap with Altivec enabled!&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;Kernel Used Altivec with MSR_VEC off!&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
