multiline_comment|/*&n; * linux/arch/ppc/kernel/sys_ppc.c&n; *&n; * Adapted from the i386 version by Gary Thomas&n; *&n; * This file contains various random system calls that&n; * have a non-standard calling sequence on the Linux/PPC&n; * platform.&n; */
