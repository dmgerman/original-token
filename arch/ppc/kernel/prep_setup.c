...
suffix:semicolon
multiline_comment|/* these need to be here since PReP uses them for OpenPIC support */
multiline_comment|/* Maybe move these to a &squot;openpic_irq.c&squot; file instead? --Troy */
r_extern
r_void
...
multiline_comment|/* We use the NVRAM RTC to time a second to calibrate the decrementer. */
DECL|function|__initfunc
id|__initfunc
c_func
(paren
...
(brace
multiline_comment|/* look for a Raven OpenPIC */
...
suffix:semicolon
multiline_comment|/* printk(&quot;OpenPIC found at %p: &bslash;n&quot;, OpenPIC);*/
)brace
)brace
r_else
(brace
id|printk
(paren
l_string|&quot;prep_init: WARNING: can&squot;t find an OpenPIC on what looks like a PowerPlus board&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
