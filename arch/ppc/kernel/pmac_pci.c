...
multiline_comment|/* We should really use RTAS here, unfortunately, it&squot;s not available with BootX.&n; * (one more reason for writing a beautiful OF booter). I&squot;ll do the RTAS stuff&n; * later, once I have something that works enough with BootX.&n; */
id|__pmac
r_static
r_int
r_int
...
multiline_comment|/* We look for the OF device corresponding to this bus/devfn pair. If we&n;&t;&t; * don&squot;t find it, we default to the external PCI */
id|bridge_node
op_assign
l_int|NULL
suffix:semicolon
