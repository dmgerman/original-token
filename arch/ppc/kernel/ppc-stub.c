multiline_comment|/* $Id: ppc-stub.c,v 1.4 1998/07/28 08:25:01 paulus Exp $&n; * ppc-stub.c:  KGDB support for the Linux kernel.&n; *&n; * adapted from arch/sparc/kernel/sparc-stub.c for the PowerPC&n; * some stuff borrowed from Paul Mackerras&squot; xmon&n; * Copyright (C) 1998 Michael AK Tesch (tesch@cs.wisc.edu)&n; *&n; * Modifications to run under Linux&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * This file originally came from the gdb sources, and the&n; * copyright notices have been retained below.&n; */
...
comma
multiline_comment|/* reserved instruction or sumpin&squot; */
(brace
l_int|0x800
comma
id|SIGFPE
