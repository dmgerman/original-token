multiline_comment|/*&n; * $Id: pci.c,v 1.53 1999/03/12 23:38:02 cort Exp $&n; * Common pmac/prep/chrp pci routines. -- Cort&n; */
...
c_func
(paren
l_string|&quot;Setting PCI access method to mech1&bslash;n&quot;
)paren
suffix:semicolon
