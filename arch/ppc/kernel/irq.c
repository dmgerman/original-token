...
suffix:semicolon
multiline_comment|/* This is the interrupt used on the main controller for the secondary&n;   controller. Happens on PowerBooks G3 Series (a second mac-io)&n;   -- BenH&n; */
DECL|variable|second_irq
r_static
r_int
id|second_irq
op_assign
...
id|len
comma
l_string|&quot;    Gatwick secondary IRQ controller&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#ifdef __SMP__
...
multiline_comment|/* Here, we handle interrupts coming from Gatwick,&n;&t;&t; * normal interrupt code will take care of acking and&n;&t;&t; * masking the irq on Gatwick itself but we ack&amp;mask&n;&t;&t; * the Gatwick main interrupt on Heathrow now. It&squot;s&n;&t;&t; * unmasked later, after interrupt handling. -- BenH &n;&t;&t; */
r_if
c_cond
(paren
id|irq
...
multiline_comment|/* If not found, on exit, irq is 63 (128-1-32-32).&n;&t;&t;&t; * We set it to -1 and revalidate second controller&n;&t;&t;&t; */
r_if
c_cond
(paren
id|irq
...
macro_line|#ifdef SHOW_GATWICK_IRQS
id|printk
c_func
(paren
l_string|&quot;Gatwick irq %d (i:%d, bits:0x%08lx&bslash;n&quot;
comma
id|irq
comma
id|i
...
multiline_comment|/* This was a gatwick sub-interrupt, we re-enable them on Heathrow&n;           now */
r_if
c_cond
(paren
id|_machine
...
macro_line|#ifndef CONFIG_8xx&t;&t;&t;&t;&t;&t;&t;&t;&t;&t;&t;
r_if
c_cond
(paren
id|is_prep
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Cannot allocate second controller IRQ */
r_if
c_cond
(paren
id|irq
...
(paren
id|KERN_INFO
l_string|&quot;irq: fixed SCC on second controller (%d)&bslash;n&quot;
comma
id|int_pool
(braket
l_int|0
