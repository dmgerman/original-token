...
DECL|macro|OPENPIC_DEBUG
mdefine_line|#define OPENPIC_DEBUG
...
DECL|function|chrp_set_irq_mask
r_void
id|chrp_set_irq_mask
c_func
(paren
r_int
id|irq_nr
...
macro_line|#ifdef OPENPIC_DEBUG
id|printk
c_func
(paren
l_string|&quot;OpenPIC interrupt %d&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; *  Here we should process IPI timer&n;&t;&t;&t; *  for now the interrupt is dismissed.&n;&t;&t;&t; */
r_goto
id|out
suffix:semicolon
)brace
...
(brace
multiline_comment|/*irq_mode2 &amp;= ~0x04L;&n;&t;&t;&t;&t;outb( irq_mode1 , 0x4d0 );&n;&t;&t;&t;&t;outb( irq_mode2 , 0x4d1 );*/
)brace
)brace
r_break
suffix:semicolon
...
c_func
(paren
l_string|&quot;Hydra Mac I/O at %p&bslash;n&quot;
comma
id|Hydra
)paren
suffix:semicolon
...
op_logical_neg
id|OpenPIC
multiline_comment|/* &amp;&amp; find_xxx */
)paren
(brace
id|printk
c_func
(paren
l_string|&quot;Unknown openpic implementation&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* other OpenPIC implementations */
multiline_comment|/* ... */
)brace
r_if
c_cond
