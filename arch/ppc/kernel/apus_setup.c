...
id|printk
(paren
l_string|&quot; *Unknown CPU speed ID (&squot;%c&squot;)* &quot;
comma
id|c
)paren
suffix:semicolon
...
l_int|60
suffix:semicolon
multiline_comment|/* Use status of left mouse button to select&n;&t;&t;&t;   RAM speed. */
r_if
c_cond
(paren
op_logical_neg
...
id|printk
(paren
l_string|&quot; [RAM R/W waitstate removed. &quot;
l_string|&quot;(expecting 60ns RAM).] &quot;
)paren
suffix:semicolon
)brace
r_break
...
id|printk
(paren
l_string|&quot;PowerUp Bus Speed: %dMHz&bslash;n&quot;
comma
id|speed
)paren
suffix:semicolon
