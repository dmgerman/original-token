...
suffix:semicolon
DECL|variable|heartbeat_enabled
r_static
r_int
...
id|__apus
DECL|function|apus_request_irq
r_int
id|apus_request_irq
c_func
(paren
...
id|__apus
DECL|function|apus_process_int
r_void
id|apus_process_int
c_func
(paren
...
macro_line|#if defined(CONFIG_WHIPPET_SERIAL)||defined(CONFIG_MULTIFACE_III_TTY)||defined(CONFIG_GVPIOEXT)||defined(CONFIG_AMIGA_BUILTIN_SERIAL)
r_int
id|m68k_rs_init
c_func
(paren
...
id|__apus
DECL|function|apus_restore_flags
r_static
r_void
id|apus_restore_flags
c_func
(paren
r_int
r_int
