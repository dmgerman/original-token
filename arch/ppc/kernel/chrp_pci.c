...
id|dev
suffix:semicolon
multiline_comment|/* get the other 2 busses on the F50 */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;&t;&t; * We assume these values but should someday get them&n;&t;&t;&t; * from the device tree or python itself instead -- Cort&n;&t;&t;&t; */
id|pci_dram_offset
op_assign
l_int|0x80000000
suffix:semicolon
