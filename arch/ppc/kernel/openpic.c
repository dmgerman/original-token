...
id|t
op_amp
id|OPENPIC_VENDOR_ID_DEVICE_ID_MASK
)paren
op_rshift
...
id|t
op_amp
id|OPENPIC_VENDOR_ID_STEPPING_MASK
)paren
op_rshift
id|OPENPIC_VENDOR_ID_STEPPING_SHIFT
suffix:semicolon
r_switch
c_cond
(paren
...
(brace
r_case
id|OPENPIC_DEVICE_ID_APPLE_HYDRA
suffix:colon
id|device
op_assign
l_string|&quot;Hydra&quot;
