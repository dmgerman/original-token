...
mdefine_line|#define CALC_BASE(y)&t;(bi-&gt;dispDeviceBase + bi-&gt;dispDeviceRect[0] * &bslash;&n;&t;&t;&t;(bi-&gt;dispDeviceDepth &gt;&gt; 3) + bi-&gt;dispDeviceRowBytes * (y))
id|__init
r_static
r_void
