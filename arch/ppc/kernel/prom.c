...
c_func
(paren
l_string|&quot;Initing fake screen&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|len
...
c_func
(paren
l_string|&quot;Warning: assuming display depth = 8&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_else
...
c_func
(paren
l_string|&quot;Failed to get width&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;Failed to get height&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
c_func
(paren
l_string|&quot;Failed to get pitch&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
id|model
suffix:semicolon
multiline_comment|/* Here, we decide if we&squot;ll use the interrupt-tree (new Core99 code) or not.&n;&t; * This code was only tested with Core99 machines so far, but should be easily&n;&t; * adapted to older newworld machines (iMac, B&amp;W G3, Lombard).&n;&t; */
id|model
op_assign
id|get_property
c_func
