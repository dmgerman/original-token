multiline_comment|/*&n; * misc.c&n; *&n; * $Id: misc.c,v 1.1 1999/02/17 05:00:06 cort Exp $&n; * &n; * Adapted for PowerPC by Gary Thomas&n; *&n; * Rewritten by Cort Dougan (cort@cs.nmt.edu)&n; * One day to be replaced by a single bootloader for chrp/prep/pmac. -- Cort&n; */
...
multiline_comment|/* Determine if we have a Motorola board */
id|needs_reloc
op_assign
l_int|0
suffix:semicolon
