...
multiline_comment|/* get_remote_kernel():&n; * Perform all necessary steps to get the kernel image&n; * from the boot server. If successfull (retval == 0), subsequent calls to&n; * kread() can access the data.&n; */
...
multiline_comment|/* kread(), klseek(), kclose():&n; * Functions for accessing the received kernel image like with read(),&n; * lseek(), close().&n; */
DECL|function|kread
r_int
id|kread
c_func
