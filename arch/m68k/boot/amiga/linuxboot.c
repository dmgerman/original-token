...
suffix:semicolon
multiline_comment|/* determine CPU type */
id|bi.cputype
op_assign
id|get_cpu
c_func
...
c_func
(paren
l_string|&quot;Warning: Bootinfo version of bootstrap and kernel differ!&bslash;n&quot;
)paren
suffix:semicolon
id|Printf
c_func
...
multiline_comment|/*&n;     *&t;This assembler code is copied to chip ram, and then executed.&n;     *&t;It copies the kernel to it&squot;s final resting place.&n;     *&n;     *&t;It is called with:&n;     *&n;     *&t;    a3 = memptr&n;     *&t;    a4 = start_mem&n;     *&t;    d0 = mem_size&n;     *&t;    d1 = rd_size&n;     *&t;    d2 = kernel_size&n;     *&t;    d3 = sizeof(struct bootinfo)&n;     */
id|asm
c_func
(paren
...
suffix:colon
op_or
multiline_comment|/* copy early bootinfo to end of bss */
id|movel
id|a3
comma
id|a0
