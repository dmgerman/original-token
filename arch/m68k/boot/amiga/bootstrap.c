...
l_string|&quot;Basic options:&bslash;n&quot;
...
l_string|&quot;Advanced options:&bslash;n&quot;
...
l_string|&quot;    -t, --model id       Set the Amiga model to `id&squot;&bslash;n&quot;
l_string|&quot;    -p, --processor cfm  Set the processor type to `cfm&bslash;n&bslash;n&quot;
comma
id|ProgramName
)paren
suffix:semicolon
...
multiline_comment|/*&n;     *&t;If we have a memory file, read the memory information from it&n;     */
r_if
c_cond
(paren
id|memfile_name
