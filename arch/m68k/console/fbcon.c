...
DECL|macro|CONFIG_FBCON_RETINAZ3
macro_line|#undef CONFIG_FBCON_RETINAZ3
...
macro_line|#endif
macro_line|#endif
multiline_comment|/* RetinaZ3 Graphics Board */
macro_line|#ifdef CONFIG_FB_RETINAZ3
macro_line|#ifndef CONFIG_FBCON_RETINAZ3
DECL|macro|CONFIG_FBCON_RETINAZ3
mdefine_line|#define CONFIG_FBCON_RETINAZ3
macro_line|#endif
...
macro_line|#endif
macro_line|#if defined(CONFIG_FBCON_CYBER) || defined(CONFIG_FBCON_RETINAZ3) || &bslash;&n;    defined(CONFIG_FBCON_8PACKED) || defined(CONFIG_FBCON_16PACKED) || &bslash;&n;    defined(CONFIG_FBCON_24PACKED) || defined(CONFIG_FBCON_32PACKED)
...
r_else
(brace
multiline_comment|/*&n;&t;     * Fixed bmove() should end Arno&squot;s frustration with copying?&n;&t;     * Confucius says:&n;&t;     *    Man who copies in wrong direction, end up with trashed data&n;&t;     */
id|fbcon_bmove
c_func
(paren
id|conp
...
(brace
multiline_comment|/* This should really obey the individual character&squot;s&n;&t;&t; * background and foreground colors instead of simply&n;&t;&t; * inverting.&n;&t;&t; */
id|dest
(braket
l_int|0
)braket
...
(brace
multiline_comment|/* This should really obey the individual character&squot;s&n;&t;&t; * background and foreground colors instead of simply&n;&t;&t; * inverting. For 8 plane mode, only the lower 4 bits of the&n;&t;&t; * color are inverted, because only that color registers have&n;&t;&t; * been set up.&n;&t;&t; */
id|dest
(braket
l_int|0
)braket
