...
multiline_comment|/* ++andreas: more optimizations:&n;   subl #65536,d0 replaced by clrw d0; subql #1,d0 for dbcc&n;   addal is faster than addaw&n;   movep is rather expensive compared to ordinary move&squot;s&n;   some functions rewritten in C for clearity, no speed loss */
...
suffix:semicolon
multiline_comment|/* Fixed bmove() should end Arno&squot;s frustration with copying?&n;          * Confusius says:&n;          *    Man who copies in wrong direction, end up with trashed data&n;          */
id|fbcon_clear
c_func
(paren
id|conp
...
multiline_comment|/*&n; *    I splitted the console character loop in two parts&n; *    (cfr. fbcon_putcs_ilbm())&n; */
