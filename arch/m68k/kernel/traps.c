...
multiline_comment|/* just return if we can&squot;t perform the writeback */
r_return
suffix:semicolon
id|set_fs
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n; *  We may have to do a couple of writebacks here.&n; *&n; *  MR: we can speed up the thing a little bit and let do_040writeback()&n; *  not produce another page fault as wb2 corresponds to the address that&n; *  caused the fault. on write faults no second fault is generated, but&n; *  on read faults for security reasons (although per definitionem impossible)&n; */
r_if
c_cond
(paren
id|fp-&gt;un.fmt7.wb2s
...
(brace
multiline_comment|/* We only need to check the ATC as the entry has&n;&t;&t;       already been set up above.  */
id|asm
r_volatile
(paren
l_string|&quot;ptestr #1,%1@,#0&bslash;n&bslash;t&quot;
...
id|printk
(paren
l_string|&quot;prefetch iaddr=%#lx ssw=%#x mmusr=%#x&bslash;n&quot;
comma
id|iaddr
comma
id|ssw
...
id|printk
(paren
l_string|&quot;weird insn access at %#lx from pc %#lx (ssw is %#x)&bslash;n&quot;
comma
id|addr
comma
id|fp-&gt;ptregs.pc
...
c_func
(paren
l_string|&quot;Unknown SIGSEGV - 3&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|die_if_kernel
...
id|PF_DTRACE
suffix:semicolon
multiline_comment|/* clear the trace bit */
(paren
op_star
(paren
r_int
...
suffix:semicolon
multiline_comment|/* Set the exception pending bit in the 68882 idle frame */
r_if
c_cond
(paren
op_star
