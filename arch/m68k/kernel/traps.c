...
multiline_comment|/* Keep the keyboard interrupt working with PROM for debugging. --m */
id|e_vector
op_star
id|old_vbr
suffix:semicolon
...
r_volatile
(paren
l_string|&quot;movec %%vbr,%1&bslash;n&bslash;t&quot;
...
suffix:semicolon
multiline_comment|/* Copy int6 vector. */
macro_line|#else
...
macro_line|#ifdef CONFIG_SUN3
multiline_comment|/* Moved from setup_arch() */
id|base_trap_init
c_func
(paren
)paren
...
suffix:semicolon
macro_line|#ifdef CONFIG_FTRACE
(brace
r_int
r_int
id|flags
