...
suffix:semicolon
multiline_comment|/* ctx_live denotes if we&squot;re clearing a context with an active&n;&t;mm, in which case we can use the pgd for clues and also should&n;&t;mark that mm as lacking a context.  if the context has been&n;&t;mmdrop&squot;d, then flush outright. */
r_if
c_cond
(paren
op_logical_neg
