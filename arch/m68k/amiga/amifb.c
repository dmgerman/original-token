...
mdefine_line|#define CONFIG_AMIFB_OCS   /* define at least one fb driver, this will change later */
macro_line|#endif
macro_line|#if !defined(CONFIG_AMIFB_OCS)
DECL|macro|IS_OCS
macro_line|#  define IS_OCS (0)
macro_line|#elif defined(CONFIG_AMIFB_ECS) || defined(CONFIG_AMIFB_AGA)
DECL|macro|IS_OCS
macro_line|#  define IS_OCS (chipset == TAG_OCS)
macro_line|#else
DECL|macro|CONFIG_AMIFB_OCS_ONLY
macro_line|#  define CONFIG_AMIFB_OCS_ONLY
DECL|macro|IS_OCS
macro_line|#  define IS_OCS (1)
macro_line|#endif
macro_line|#if !defined(CONFIG_AMIFB_ECS)
DECL|macro|IS_ECS
macro_line|#  define IS_ECS (0)
macro_line|#elif defined(CONFIG_AMIFB_OCS) || defined(CONFIG_AMIFB_AGA)
DECL|macro|IS_ECS
macro_line|#  define IS_ECS (chipset == TAG_ECS)
macro_line|#else
DECL|macro|CONFIG_AMIFB_ECS_ONLY
macro_line|#  define CONFIG_AMIFB_ECS_ONLY
DECL|macro|IS_ECS
...
macro_line|#elif defined(CONFIG_AMIFB_OCS) || defined(CONFIG_AMIFB_ECS)
DECL|macro|IS_AGA
macro_line|#  define IS_AGA (chipset == TAG_AGA)
macro_line|#else
DECL|macro|CONFIG_AMIFB_AGA_ONLY
macro_line|#  define CONFIG_AMIFB_AGA_ONLY
DECL|macro|IS_AGA
...
multiline_comment|/*&n;&t; * Monitor Specifications&n;&t; *&n;&t; * These are typical for a `generic&squot; Amiga monitor (e.g. A1960)&n;&t; */
DECL|variable|vfmin
DECL|variable|vfmax
DECL|variable|hfmin
DECL|variable|hfmax
...
multiline_comment|/*&n;&t; * The minimum period for audio depends on htotal (for OCS/ECS/AGA)&n;&t; * (Imported from arch/m68k/amiga/amisound.c)&n;&t; */
r_extern
r_volatile
id|u_short
...
l_string|&quot;Amiga &quot;
suffix:semicolon
multiline_comment|/*&n;&t; * Predefined Video Mode Names&n;&t; *&n;&t; * The a2024-?? modes don&squot;t work yet because there&squot;s no A2024 driver.&n;&t; */
...
l_string|&quot;default&quot;
comma
multiline_comment|/*&n;&t; * AmigaOS Video Modes&n;&t; */
l_string|&quot;ntsc&quot;
comma
...
multiline_comment|/*&n;&t; * VGA Video Modes&n;&t; */
l_string|&quot;vga&quot;
comma
...
multiline_comment|/*&n;&t; * User Defined Video Modes: to be set after boot up using e.g. fbset&n;&t; */
l_string|&quot;user0&quot;
comma
l_string|&quot;user1&quot;
comma
...
mdefine_line|#define DEFMODE_PAL        &quot;pal&quot;&t;/* for PAL OCS/ECS */
DECL|macro|DEFMODE_NTSC
mdefine_line|#define DEFMODE_NTSC       &quot;ntsc&quot;&t;/* for NTSC OCS/ECS */
DECL|macro|DEFMODE_AMBER_PAL
mdefine_line|#define DEFMODE_AMBER_PAL  &quot;pal-lace&quot;&t;/* for flicker fixed PAL (A3000) */
DECL|macro|DEFMODE_AMBER_NTSC
mdefine_line|#define DEFMODE_AMBER_NTSC &quot;ntsc-lace&quot;&t;/* for flicker fixed NTSC (A3000) */
DECL|macro|DEFMODE_AGA
mdefine_line|#define DEFMODE_AGA        &quot;vga70&quot;&t;/* for AGA */
...
suffix:semicolon
multiline_comment|/*&n;&t; * Default Colormaps&n;&t; */
DECL|variable|red2
r_static
id|u_short
id|red2
...
suffix:semicolon
multiline_comment|/*&n;&t; * External references&n;&t; */
r_extern
r_int
r_int
id|ami_intena_vals
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_FB_RETINAZ3&t;&t;&t;/* RetinaZ3 */
r_extern
r_int
id|retz3_probe
c_func
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_GSP_RESOLVER&t;&t;&t;/* DMI Resolver */
r_extern
r_int
id|resolver_probe
c_func
...
macro_line|#endif
multiline_comment|/*&n;&t; * Use the Builtin Chipset&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Set the Default Video Mode */
id|get_video_mode
c_func
(paren
id|amiga_vblank
...
c_func
(paren
l_string|&quot;Couldn&squot;t add vblank interrupt&bslash;n&quot;
)paren
suffix:semicolon
id|ami_intena_vals
(braket
...
multiline_comment|/*&n;&t; * Update the `var&squot; structure (called by amicon.c)&n;&t; */
...
multiline_comment|/*&n;&t; * Set the colormap&n;&t; */
DECL|function|amifbcon_setcmap
r_static
r_int
id|amifbcon_setcmap
c_func
...
mdefine_line|#define CNVT_FROMHW(val,width)&t;(((width) ? ((((val)&lt;&lt;16)-(val)) / &bslash;&n;                                            ((1&lt;&lt;(width))-1)) : 0))
...
c_func
(paren
l_string|&quot;%s: Warning: IF_VERTB was enabled&bslash;n&quot;
comma
id|__FUNCTION__
)paren
suffix:semicolon
