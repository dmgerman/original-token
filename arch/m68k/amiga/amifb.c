...
l_int|0
suffix:semicolon
multiline_comment|/* I *think* that you should only change display lists on long frame.&n;&t; * At least it goes awfully perculiar on my A500 without the following&n;&t; * test. Not really in a position to test this hypothesis, so sorry&n;&t; * for the slow scrolling, all you flicker-fixed souls&n;&t; */
r_if
c_cond
(paren
op_logical_neg
