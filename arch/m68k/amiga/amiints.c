multiline_comment|/*&n; * amiints.c -- Amiga Linux interrupt handling code&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file COPYING in the main directory of this archive&n; * for more details.&n; *&n; */
...
DECL|function|amiga_remove_isr
r_int
id|amiga_remove_isr
(paren
r_int
...
id|printk
(paren
l_string|&quot;amiga_remove_isr: Unknown interrupt source %ld&bslash;n&quot;
comma
id|source
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* if a CIAA interrupt, disable the appropriate CIA ICR bit */
r_if
c_cond
(paren
id|source
...
suffix:semicolon
multiline_comment|/* if a CIAB interrupt, disable the appropriate CIA ICR bit */
r_if
c_cond
(paren
id|source
...
multiline_comment|/*&n; * Enable/disable a particular machine specific interrupt source.&n; * Note that this may affect other interrupts in case of a shared interrupt.&n; */
...
c_func
(paren
l_string|&quot;amiga_enable_irq: Unknown interrupt source %d&bslash;n&quot;
comma
id|source
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;amiga_disable_irq: Unknown interrupt source %d&bslash;n&quot;
comma
id|source
)paren
suffix:semicolon
