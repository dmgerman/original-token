multiline_comment|/*&n; * Linux/arch/m68k/amiga/retz3fb.h -- Defines and macros for the&n; *                                    RetinaZ3 frame buffer device&n; *&n; *    Copyright (C) 1997 Jes Sorensen&n; *&n; * History:&n; *   - 22 Jan 97: Initial work&n; *&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file COPYING in the main directory of this archive&n; * for more details.&n; */
