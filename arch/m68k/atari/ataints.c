...
id|t
id|addql
macro_line|#1,&quot;SYMBOL_NAME_STR(intr_count)&quot;&bslash;n&quot;
id|SAVE_ALL
"&quot;"
...
id|bset
macro_line|#28,%%d0&t;&t;/* set MACHSPEC bit */
id|movel
op_mod
op_mod
id|d0
