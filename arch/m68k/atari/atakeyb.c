...
suffix:semicolon
DECL|variable|atashift_ctrl_map
r_static
id|u_short
...
suffix:semicolon
DECL|variable|atashift_alt_map
r_static
id|u_short
id|atashift_alt_map
(braket
...
id|key_repeat_rate
suffix:semicolon
id|atakeyb_rep_timer.prev
op_assign
id|atakeyb_rep_timer.next
op_assign
l_int|NULL
suffix:semicolon
id|add_timer
