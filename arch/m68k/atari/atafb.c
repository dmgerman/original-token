...
l_int|0
suffix:semicolon
multiline_comment|/* use VESA suspend mode instead of blanking only? */
macro_line|#endif
DECL|struct|atari_fb_par
r_static
r_struct
id|atari_fb_par
(brace
...
suffix:semicolon
multiline_comment|/* import first 16 colors from fbcon.c */
r_extern
r_int
r_int
id|packed16_cmap
...
suffix:semicolon
multiline_comment|/* ++roman: This structure abstracts from the underlying hardware (ST(e),&n; * TT, or Falcon.&n; *&n; * int (*detect)( void )&n; *   This function should detect the current video mode settings and&n; *   store them in atari_fb_predefined[0] for later reference by the&n; *   user. Return the index+1 of an equivalent predefined mode or 0&n; *   if there is no such.&n; * &n; * int (*encode_fix)( struct fb_fix_screeninfo *fix,&n; *                    struct atari_fb_par *par )&n; *   This function should fill in the &squot;fix&squot; structure based on the&n; *   values in the &squot;par&squot; structure.&n; *   &n; * int (*decode_var)( struct fb_var_screeninfo *var,&n; *                    struct atari_fb_par *par )&n; *   Get the video params out of &squot;var&squot;. If a value doesn&squot;t fit, round&n; *   it up, if it&squot;s too big, return EINVAL.&n; *   Round up in the following order: bits_per_pixel, xres, yres, &n; *   xres_virtual, yres_virtual, xoffset, yoffset, grayscale, bitfields, &n; *   horizontal timing, vertical timing.&n; *&n; * int (*encode_var)( struct fb_var_screeninfo *var,&n; *                    struct atari_fb_par *par );&n; *   Fill the &squot;var&squot; structure based on the values in &squot;par&squot; and maybe&n; *   other values read out of the hardware.&n; *   &n; * void (*get_par)( struct atari_fb_par *par )&n; *   Fill the hardware&squot;s &squot;par&squot; structure.&n; *   &n; * void (*set_par)( struct atari_fb_par *par )&n; *   Set the hardware according to &squot;par&squot;.&n; *   &n; * int (*setcolreg)( unsigned regno, unsigned red,&n; *                   unsigned green, unsigned blue,&n; *                   unsigned transp )&n; *   Set a single color register. The values supplied are already&n; *   rounded down to the hardware&squot;s capabilities (according to the&n; *   entries in the var structure). Return != 0 for invalid regno.&n; *&n; * int (*getcolreg)( unsigned regno, unsigned *red,&n; *                   unsigned *green, unsigned *blue,&n; *                   unsigned *transp )&n; *   Read a single color register and split it into&n; *   colors/transparent. Return != 0 for invalid regno.&n; *&n; * void (*set_screen_base)( unsigned long s_base )&n; *   Set the base address of the displayed frame buffer. Only called&n; *   if yres_virtual &gt; yres or xres_virtual &gt; xres.&n; *&n; * int (*blank)( int blank_mode )&n; *   Blank the screen if blank_mode != 0, else unblank. If NULL then blanking&n; *   is done by setting the CLUT to black. Return != 0 if un-/blanking&n; *   failed due to e.g. video mode which doesn&squot;t support it.&n; */
...
comma
multiline_comment|/* Minor 14..23 free for more standard video modes */
(brace
l_int|0
comma
)brace
...
comma
multiline_comment|/* Minor 24..31 reserved for user defined video modes */
(brace
multiline_comment|/* user0, initialized to Rx;y;d from commandline, if supplied */
l_int|0
comma
l_int|0
comma
...
suffix:semicolon
multiline_comment|/* is this ok or should this be DIRECTCOLOR? */
)brace
r_if
c_cond
(paren
...
multiline_comment|/* no smooth scrolling possible with longword aligned video mem */
id|fix-&gt;xpanstep
op_assign
l_int|32
suffix:semicolon
...
l_int|15
suffix:semicolon
multiline_comment|/* &lt;=0 : yres_virtual determined by screensize */
r_if
c_cond
(paren
id|yres_virtual
...
r_else
(brace
macro_line|#if 0 /* TODO enable this (untested yet) */
multiline_comment|/* Round down pixelclock */
r_int
id|i
suffix:semicolon
r_int
...
id|hw-&gt;vss
suffix:semicolon
multiline_comment|/*f030_sreg[2] = 0;*/
id|videl.f_shift
op_assign
l_int|0
suffix:semicolon
...
(brace
multiline_comment|/* ++guenther: we can switch off graphics by changing VDB and VDE,&n; * so VIDEL doesn&squot;t hog the bus while saving.&n; * (this affects usleep()).&n; */
r_if
c_cond
(paren
id|mon_type
...
(brace
multiline_comment|/* All visuals are STATIC, because we don&squot;t know how to change&n;&t;&t;&t; * colors :-(&n;&t;&t;&t; */
r_case
op_minus
l_int|1
suffix:colon
...
suffix:semicolon
macro_line|#endif
DECL|function|atari_fb_get_par
r_static
r_void
id|atari_fb_get_par
c_func
...
DECL|function|atari_fb_set_par
r_static
r_void
id|atari_fb_set_par
c_func
...
multiline_comment|/* there seems to be a bug in gcc 2.5.8 which inhibits using an other solution */
multiline_comment|/* I always get a sigsegv */
DECL|variable|red16
r_static
r_int
id|red16
...
mdefine_line|#define CNVT_FROMHW(val,width) ((width)?((((val) &lt;&lt; 16) - (val)) / ((1&lt;&lt;(width))-1)):0)
r_static
r_int
...
r_static
r_int
DECL|function|atari_fb_get_fix
id|atari_fb_get_fix
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|atari_fb_get_var
id|atari_fb_get_var
c_func
(paren
r_struct
...
r_static
r_void
DECL|function|atari_fb_set_disp
id|atari_fb_set_disp
c_func
(paren
r_int
id|con
...
r_static
r_int
DECL|function|atari_fb_set_var
id|atari_fb_set_var
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|atari_fb_get_cmap
id|atari_fb_get_cmap
c_func
(paren
r_struct
id|fb_cmap
...
r_static
r_int
DECL|function|atari_fb_set_cmap
id|atari_fb_set_cmap
c_func
(paren
r_struct
id|fb_cmap
...
r_static
r_int
DECL|function|atari_fb_pan_display
id|atari_fb_pan_display
c_func
(paren
r_struct
id|fb_var_screeninfo
...
DECL|function|atari_video_setup
r_void
...
id|p
suffix:semicolon
multiline_comment|/* Format is: &lt;xres&gt;;&lt;yres&gt;;&lt;depth&gt;;&lt;plane organ.&gt;;&n;&t; *            &lt;screen mem addr&gt;&n;&t; *&t;      [;&lt;screen mem length&gt;[;&lt;vgaiobase&gt;[;&lt;colorreg-type&gt;]]]&n;&t; */
r_if
c_cond
(paren
op_logical_neg
