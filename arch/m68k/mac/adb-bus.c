...
DECL|macro|ADBDEBUG
mdefine_line|#define ADBDEBUG&t;(ADBDEBUG_READ | ADBDEBUG_START | ADBDEBUG_WRITE | ADBDEBUG_SRQ | ADBDEBUG_REQUEST)
macro_line|#else
DECL|macro|ADBDEBUG
...
c_func
(paren
l_string|&quot;No sync occured&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|ct
...
c_func
(paren
l_string|&quot;No sync 2 occured&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|via_read
...
c_func
(paren
l_string|&quot;No sync 3 occured&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|ct
...
c_func
(paren
l_string|&quot;No sync 4 occured&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|via_read
...
macro_line|#ifdef USE_ORIG
multiline_comment|/*&n;&t;&t;&t; * This will fail - TREQ is active low -&gt; 0 is IRQ !!&n;&t;&t;&t; */
r_if
c_cond
(paren
id|status
...
multiline_comment|/*&n; * Restart of CUDA support: please modify this interrupt handler while &n; * working at the Quadra etc. ADB driver. We can try to merge them later, or&n; * remove the CUDA stuff from the MacII handler&n; */
...
c_func
(paren
l_string|&quot;cuda: send collision!&bslash;n&quot;
)paren
suffix:semicolon
id|via_write
c_func
...
c_func
(paren
l_string|&quot;cuda: state=sent_first_byte status=%x want=%x&bslash;n&quot;
comma
id|status
comma
id|TIP
...
c_func
(paren
l_string|&quot;CUDA: Got an SRQ&bslash;n&quot;
)paren
suffix:semicolon
id|adb_state
op_assign
...
c_func
(paren
l_string|&quot;CUDA: reply buffer overrun!&bslash;n&quot;
)paren
suffix:semicolon
