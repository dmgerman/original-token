...
suffix:semicolon
multiline_comment|/*&n; * This array holds the pointers to the various VIA or other interrupt &n; * controllers&n; */
...
suffix:semicolon
macro_line|#ifdef VIABASE_WEIRDNESS
multiline_comment|/*&n; * VIA2 / RBV default base address &n; */
...
macro_line|#if 0&t;/* doesn&squot;t seem to work yet */
id|sys_request_irq
c_func
(paren
l_int|4
...
multiline_comment|/*&n; *&t;We have no machine specific interrupts on a macintoy&n; *      Yet, we need to register/unregister interrupts ... :-)&n; *      Currently unimplemented: Test for valid irq number, chained irqs,&n; *      Nubus interrupts.&n; */
...
id|devname
suffix:semicolon
multiline_comment|/* and turn it on ... */
r_if
c_cond
(paren
id|srcidx
...
(brace
multiline_comment|/*&n;&t;&t; * Set vPCR for SCSI interrupts. (what about RBV here?)&n;&t;&t; */
id|via_write
c_func
(paren
id|via
