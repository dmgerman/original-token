...
DECL|macro|MAC_TIME_OFFSET
mdefine_line|#define MAC_TIME_OFFSET 2082844800
...
suffix:semicolon
multiline_comment|/* poweroff functions */
r_extern
r_void
id|via_poweroff
c_func
...
suffix:semicolon
multiline_comment|/* pram functions */
r_extern
id|__u32
id|via_read_time
c_func
...
suffix:semicolon
multiline_comment|/* AFAIK only the IIci takes a cache card.  The IIfx has onboard&n;       cache ... someone needs to figure out how to tell if it&squot;s on or&n;       not. */
r_if
c_cond
(paren
...
op_assign
(brace
multiline_comment|/*&n;&t; *&t;The default machine, in case we get an unsupported one&n;&t; *&t;We&squot;ll pretend to be a Macintosh II, that&squot;s pretty safe.&n;&t; */
(brace
id|MAC_MODEL_II
comma
l_string|&quot;Unknown&quot;
...
comma
multiline_comment|/* These have onboard SONIC */
(brace
id|MAC_MODEL_PB520
comma
...
multiline_comment|/* All of these might have onboard SONIC in the Dock but I&squot;m not quite sure */
(brace
id|MAC_MODEL_PB210
comma
...
suffix:semicolon
multiline_comment|/* sure, why not */
id|printk
(paren
l_string|&quot;030 Restart failed.  Please restart manually.&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
r_else
(brace
multiline_comment|/* We never make it here... The above shoule handle all cases. */
id|printk
(paren
l_string|&quot;Restart failed.  Please restart manually.&bslash;n&quot;
)paren
