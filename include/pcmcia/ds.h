...
DECL|macro|DS_MODULE_NAME
mdefine_line|#define DS_MODULE_NAME &quot;bus_managers/pcmcia_ds/v1&quot;
DECL|struct|ds_module_info
r_typedef
r_struct
id|ds_module_info
(brace
...
id|binfo
suffix:semicolon
DECL|member|_register_pccard_driver
r_int
(paren
op_star
id|_register_pccard_driver
)paren
(paren
id|dev_info_t
op_star
...
suffix:semicolon
DECL|member|_unregister_pccard_driver
r_int
(paren
op_star
id|_unregister_pccard_driver
)paren
(paren
id|dev_info_t
op_star
...
id|socket_table
suffix:semicolon
DECL|member|list_sem
id|sem_id
op_star
id|list_sem
suffix:semicolon
DECL|typedef|ds_module_info
)brace
id|ds_module_info
suffix:semicolon
