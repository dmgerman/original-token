...
multiline_comment|/* Attributes for Request/GetConfiguration */
DECL|macro|CONF_ENABLE_IRQ
mdefine_line|#define CONF_ENABLE_IRQ&t;&t;0x01
DECL|macro|EXCLUSIVE_USE
mdefine_line|#define EXCLUSIVE_USE&t;&t;0x02
DECL|macro|VALID_CLIENT
mdefine_line|#define VALID_CLIENT&t;&t;0x04
multiline_comment|/* For MapMemPage */
...
DECL|macro|SS_MODULE_NAME
mdefine_line|#define SS_MODULE_NAME(s)&t;(&quot;busses/pcmcia/&quot; s &quot;/v1&quot;)
DECL|macro|MTD_MODULE_NAME
mdefine_line|#define MTD_MODULE_NAME(s)&t;(&quot;busses/pcmcia/&quot; s &quot;/v1&quot;)
DECL|macro|CS_CLIENT_MODULE_NAME
mdefine_line|#define CS_CLIENT_MODULE_NAME&t;&quot;bus_managers/pcmcia_cs/client/v1&quot;
DECL|struct|cs_client_module_info
r_typedef
r_struct
id|cs_client_module_info
(brace
DECL|member|binfo
id|bus_manager_info
id|binfo
suffix:semicolon
DECL|member|_CardServices
r_int
(paren
op_star
id|_CardServices
...
suffix:semicolon
DECL|typedef|cs_client_module_info
)brace
id|cs_client_module_info
suffix:semicolon
DECL|macro|CS_SOCKET_MODULE_NAME
mdefine_line|#define CS_SOCKET_MODULE_NAME &quot;bus_managers/pcmcia_cs/socket/v1&quot;
DECL|struct|cs_socket_module_info
r_typedef
r_struct
id|cs_socket_module_info
(brace
DECL|member|binfo
id|bus_manager_info
id|binfo
suffix:semicolon
DECL|member|_register_ss_entry
r_int
(paren
op_star
id|_register_ss_entry
)paren
(paren
r_int
comma
...
suffix:semicolon
DECL|member|_unregister_ss_entry
r_void
(paren
op_star
id|_unregister_ss_entry
)paren
(paren
id|ss_entry_t
)paren
...
suffix:semicolon
DECL|typedef|cs_socket_module_info
)brace
id|cs_socket_module_info
suffix:semicolon
macro_line|#endif
