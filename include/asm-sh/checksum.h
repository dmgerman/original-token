...
multiline_comment|/*&n;extern unsigned short int csum_ipv6_magic(struct in6_addr *saddr,&n;                                          struct in6_addr *daddr,&n;                                          __u16 len,&n;                                          unsigned short proto,&n;                                          unsigned int sum);&n;*/
