macro_line|#ifndef __ASM_SH_POSIX_TYPES_H
DECL|macro|__ASM_SH_POSIX_TYPES_H
mdefine_line|#define __ASM_SH_POSIX_TYPES_H
...
macro_line|#endif /* __ASM_SH_POSIX_TYPES_H */
eof
