macro_line|#ifndef __ASM_SH_SEMAPHORE_HELPER_H
DECL|macro|__ASM_SH_SEMAPHORE_HELPER_H
mdefine_line|#define __ASM_SH_SEMAPHORE_HELPER_H
...
macro_line|#endif /* __ASM_SH_SEMAPHORE_HELPER_H */
eof
