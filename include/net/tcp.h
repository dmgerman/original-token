...
mdefine_line|#define TCP_SK_RHASH_FN(__sock)&t;TCP_RHASH_FN((__sock)-&gt;dummy_th.dest)
...
(paren
(paren
id|sk-&gt;tp_pinfo.af_tcp.bind_next
op_assign
id|tb-&gt;owners
)paren
op_ne
...
(brace
id|tb-&gt;owners-&gt;tp_pinfo.af_tcp.bind_pprev
op_assign
op_amp
id|sk-&gt;tp_pinfo.af_tcp.bind_next
suffix:semicolon
...
id|sk
suffix:semicolon
id|sk-&gt;tp_pinfo.af_tcp.bind_pprev
op_assign
op_amp
id|tb-&gt;owners
suffix:semicolon
...
multiline_comment|/* #define SYNQ_DEBUG 1 */
...
(brace
id|sk-&gt;tp_pinfo.af_tcp.bind_next-&gt;tp_pinfo.af_tcp.bind_pprev
op_assign
id|sk-&gt;tp_pinfo.af_tcp.bind_pprev
suffix:semicolon
)brace
