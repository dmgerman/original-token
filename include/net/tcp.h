...
DECL|macro|WINDOW_ADVERTISE_DIVISOR
mdefine_line|#define WINDOW_ADVERTISE_DIVISOR 2
...
mdefine_line|#define TCP_SLT_TWKILL&t;&t;1
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Reset CWND after idle period longer rto. Actually, it would&n;&t; * be better to save last send time, but VJ in SIGCOMM&squot;88 proposes&n;&t; * to use keepalive timestamp. Well, it is not good, certainly,&n;&t; * because SMTP is still broken, but it is better than nothing yet.&n;&t; */
r_if
c_cond
(paren
id|tp-&gt;packets_out
...
(brace
multiline_comment|/* We held off on this in tcp_send_skb() */
id|tp-&gt;pending
op_assign
id|TIME_PROBE0
suffix:semicolon
...
multiline_comment|/* This function does not return reliable answer. You is only as advice.&n; */
