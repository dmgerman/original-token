...
id|family
suffix:semicolon
multiline_comment|/* sk-&gt;zapped */
DECL|member|source
id|__u16
id|source
suffix:semicolon
multiline_comment|/* sk-&gt;dummy_th.source */
DECL|member|dest
id|__u16
id|dest
suffix:semicolon
multiline_comment|/* sk-&gt;dummy_th.dest */
...
mdefine_line|#define TCPOLEN_TSTAMP_ALIGNED&t;12
DECL|macro|TCPOLEN_WSCALE_ALIGNED
mdefine_line|#define TCPOLEN_WSCALE_ALIGNED&t;4
...
multiline_comment|/* &n; *&t;This routines builds a generic TCP header. &n; *&t;They also build the RFC1323 Timestamp, but don&squot;t fill the&n; *&t;actual timestamp in (you need to call tcp_update_options for this).&n; *&t;XXX: pass tp instead of sk here.&n; */
