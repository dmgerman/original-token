...
multiline_comment|/*&n;&t; * It would be a good idea if it didn&squot;t break header prediction.&n;&t; * and BSD made the header predition standard...&n;&t; * It expects the same value in the header i.e. th-&gt;window to be&n;&t; * constant [in fact it&squot;s a good idea but they could document it&n;&t; * couldn&squot;t they ?] [PR].&n;&t; */
multiline_comment|/*&n;&t; *  If the actual window is blocking the sender then try&n;&t; *  to raise it.&n;&t; */
r_if
c_cond
(paren
id|window
