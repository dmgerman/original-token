...
mdefine_line|#define TCP_HTABLE_SIZE&t;&t;1024
...
multiline_comment|/* Find the next port that hashes h that is larger than lport.&n; * If you change the hash, change this function to match, or you will&n; * break TCP port selection. This function must also NOT wrap around&n; * when the next number exceeds the largest possible port (2^16-1).&n; */
DECL|function|tcp_bhashnext
r_static
id|__inline__
r_int
id|tcp_bhashnext
...
id|s
suffix:semicolon
multiline_comment|/* don&squot;t change this to a smaller type! */
id|s
op_assign
(paren
id|lport
...
multiline_comment|/*&n; *      TCP option flags for parsed options.&n; */
DECL|macro|TCPOPTF_SACK_PERM
mdefine_line|#define TCPOPTF_SACK_PERM       1
DECL|macro|TCPOPTF_TIMESTAMP
mdefine_line|#define TCPOPTF_TIMESTAMP       2
...
suffix:semicolon
multiline_comment|/*&n; * FIXME: this method of choosing when to send a window update&n; * does not seem correct to me. -- erics&n; */
...
DECL|function|tcp_build_options
r_static
id|__inline__
r_void
...
(brace
multiline_comment|/* FIXME: We will still need to do SACK here. */
r_if
c_cond
(paren
id|tp-&gt;tstamp_ok
...
suffix:semicolon
multiline_comment|/* rest filled in by tcp_update_options */
)brace
)brace
DECL|function|tcp_update_options
r_static
id|__inline__
r_void
...
multiline_comment|/* &n; *&t;This routines builds a generic TCP header. &n; *&t;They also build the RFC1323 Timestamp, but don&squot;t fill the&n; *&t;actual timestamp in (you need to call tcp_update_options for this).&n; *&t;It can&squot;t (unfortunately) do SACK as well.&n; *&t;XXX: pass tp instead of sk here.&n; */
DECL|function|tcp_build_header_data
r_static
r_inline
r_void
...
multiline_comment|/*&n; * Construct a tcp options header for a SYN or SYN_ACK packet.&n; * If this is every changed make sure to change the definition of&n; * MAX_SYN_SIZE to match the new maximum number of options that you&n; * can generate.&n; * FIXME: This is completely disgusting.&n; * This is probably a good candidate for a bit of assembly magic.&n; * It would be especially magical to compute the checksum for this&n; * stuff on the fly here.&n; */
...
DECL|macro|SYNQ_DEBUG
mdefine_line|#define SYNQ_DEBUG 1
...
(paren
id|KERN_DEBUG
l_string|&quot;synq_unlink: bad prev ptr: %p&bslash;n&quot;
comma
id|prev
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;synq_unlink: bad last ptr %p,%p&bslash;n&quot;
comma
id|req
comma
id|tp-&gt;syn_wait_last
...
c_func
(paren
l_string|&quot;synq_queue: last ptr doesn&squot;t point to last req.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|req-&gt;dl_next
...
(paren
id|KERN_DEBUG
l_string|&quot;tail drop on empty queue? - bug&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
