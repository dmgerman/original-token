...
DECL|macro|DEFAULT_T1
mdefine_line|#define DEFAULT_T1&t;(10  * PR_SLOWHZ)&t;/*  Outstanding frames - 10 seconds */
DECL|macro|DEFAULT_T2
mdefine_line|#define DEFAULT_T2&t;(3   * PR_SLOWHZ)&t;/*  Response delay     - 3 seconds */
DECL|macro|DEFAULT_T3
mdefine_line|#define DEFAULT_T3&t;(300 * PR_SLOWHZ)&t;/*  Idle supervision   - 300 seconds */
DECL|macro|DEFAULT_N2
mdefine_line|#define DEFAULT_N2&t;10&t;&t;&t;/*  Number of retries */
