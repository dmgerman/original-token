...
DECL|macro|IP_MASQ_MOD_NOP
mdefine_line|#define IP_MASQ_MOD_NOP &t;0
DECL|macro|IP_MASQ_MOD_ACCEPT
mdefine_line|#define IP_MASQ_MOD_ACCEPT&t;1
DECL|macro|IP_MASQ_MOD_REJECT
mdefine_line|#define IP_MASQ_MOD_REJECT&t;-1
...
suffix:semicolon
multiline_comment|/*&n; *&t;init functions protos&n; */
r_extern
r_int
id|ip_portfw_init
c_func
