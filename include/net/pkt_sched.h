...
id|qdisc_runqueue_lock
suffix:semicolon
multiline_comment|/* Is it on run list? Reliable only under qdisc_runqueue_lock. */
DECL|function|qdisc_on_runqueue
r_extern
id|__inline__
r_int
...
multiline_comment|/* Is run list not empty? Reliable only under qdisc_runqueue_lock. */
DECL|function|qdisc_pending
r_extern
id|__inline__
r_int
id|qdisc_pending
...
multiline_comment|/* Add qdisc to tail of run list. Called with BH, disabled on this CPU */
...
multiline_comment|/* If the device is not throttled, restart it and add to run list.&n; * BH must be disabled on this CPU. Usually, it is called by timers.&n; */
