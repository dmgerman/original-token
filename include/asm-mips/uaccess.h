multiline_comment|/*&n; * include/asm-mips/uaccess.h&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Copyright (C) 1996 by Ralf Baechle&n; */
...
mdefine_line|#define __get_user_nocheck(x,ptr,size) ({ &bslash;&n;long __gu_err; &bslash;&n;long __gu_val; &bslash;&n;long __gu_addr; &bslash;&n;__asm__(&quot;&quot;:&quot;=r&quot; (__gu_val)); &bslash;&n;__gu_addr = (long) (ptr); &bslash;&n;__gu_err = 0; &bslash;&n;switch (size) { &bslash;&n;case 1: __get_user_nocheck_asm(&quot;lb&quot;); break; &bslash;&n;case 2: __get_user_nocheck_asm(&quot;lh&quot;); break; &bslash;&n;case 4: __get_user_nocheck_asm(&quot;lw&quot;); break; &bslash;&n;case 8: __get_user_nocheck_asm(&quot;ld&quot;); break; &bslash;&n;default: __get_user_unknown(); break; &bslash;&n;} x = (__typeof__(*(ptr))) __gu_val; __gu_err; })
DECL|macro|__get_user_nocheck_asm
mdefine_line|#define __get_user_nocheck_asm(insn) &bslash;&n;({ &bslash;&n;__asm__ __volatile__( &bslash;&n;&t;&quot;1:&bslash;t&quot; insn &quot;&bslash;t%1,%3&bslash;n&quot; &bslash;&n;&t;&quot;2:&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t.fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot; &bslash;&n;&t;&quot;3:&bslash;t.set&bslash;tnoat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;la&bslash;t$1,2b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;li&bslash;t%0,%4&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;jr&bslash;t$1&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.set&bslash;tat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t__ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&bslash;t&quot; &bslash;&n;&t;STR(PTR)&quot;&bslash;t1b,3b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&quot; &bslash;&n;&t;:&quot;=r&quot; (__gu_err), &quot;=r&quot; (__gu_val) &bslash;&n;&t;:&quot;0&quot; (__gu_err), &quot;o&quot; (__m(__gu_addr)), &quot;i&quot; (-EFAULT) &bslash;&n;&t;:&quot;$1&quot;); })
DECL|macro|__get_user_check
mdefine_line|#define __get_user_check(x,ptr,size,mask) ({ &bslash;&n;long __gu_err; &bslash;&n;long __gu_val; &bslash;&n;long __gu_addr; &bslash;&n;__asm__(&quot;&quot;:&quot;=r&quot; (__gu_val)); &bslash;&n;__gu_addr = (long) (ptr); &bslash;&n;__gu_err = -EFAULT; &bslash;&n;if (__access_ok(__gu_addr,size,mask)) { &bslash;&n;switch (size) { &bslash;&n;case 1: __get_user_check_asm(&quot;lb&quot;); break; &bslash;&n;case 2: __get_user_check_asm(&quot;lh&quot;); break; &bslash;&n;case 4: __get_user_check_asm(&quot;lw&quot;); break; &bslash;&n;case 8: __get_user_check_asm(&quot;ld&quot;); break; &bslash;&n;default: __get_user_unknown(); break; &bslash;&n;} } x = (__typeof__(*(ptr))) __gu_val; __gu_err; })
DECL|macro|__get_user_check_asm
mdefine_line|#define __get_user_check_asm(insn) &bslash;&n;({ &bslash;&n;__asm__ __volatile__( &bslash;&n;&t;&quot;1:&bslash;t&quot; insn &quot;&bslash;t%1,%2&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;move&bslash;t%0,$0&bslash;n&quot; &bslash;&n;&t;&quot;2:&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t.fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot; &bslash;&n;&t;&quot;3:&bslash;t.set&bslash;tnoat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;la&bslash;t$1,2b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;jr&bslash;t$1&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.set&bslash;tat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t__ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&bslash;t&quot; &bslash;&n;&t;STR(PTR)&quot;&bslash;t1b,3b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&quot; &bslash;&n;&t;:&quot;=r&quot; (__gu_err), &quot;=r&quot; (__gu_val) &bslash;&n;&t;:&quot;o&quot; (__m(__gu_addr)) &bslash;&n;&t;:&quot;$1&quot;); })
r_extern
r_void
...
mdefine_line|#define __put_user_nocheck(x,ptr,size) ({ &bslash;&n;long __pu_err; &bslash;&n;__typeof__(*(ptr)) __pu_val; &bslash;&n;long __pu_addr; &bslash;&n;__pu_val = (x); &bslash;&n;__pu_addr = (long) (ptr); &bslash;&n;__pu_err = 0; &bslash;&n;switch (size) { &bslash;&n;case 1: __put_user_nocheck_asm(&quot;sb&quot;); break; &bslash;&n;case 2: __put_user_nocheck_asm(&quot;sh&quot;); break; &bslash;&n;case 4: __put_user_nocheck_asm(&quot;sw&quot;); break; &bslash;&n;case 8: __put_user_nocheck_asm(&quot;sd&quot;); break; &bslash;&n;default: __put_user_unknown(); break; &bslash;&n;} __pu_err; })
DECL|macro|__put_user_nocheck_asm
mdefine_line|#define __put_user_nocheck_asm(insn) &bslash;&n;({ &bslash;&n;__asm__ __volatile__( &bslash;&n;&t;&quot;1:&bslash;t&quot; insn &quot;&bslash;t%1,%2&bslash;n&quot; &bslash;&n;&t;&quot;2:&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t.fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot; &bslash;&n;&t;&quot;3:&bslash;t.set&bslash;tnoat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;la&bslash;t$1,2b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;li&bslash;t%0,%3&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;jr&bslash;t$1&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.set&bslash;tat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t__ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&bslash;t&quot; &bslash;&n;&t;STR(PTR)&quot;&bslash;t1b,3b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&quot; &bslash;&n;&t;:&quot;=r&quot; (__pu_err) &bslash;&n;&t;:&quot;r&quot; (__pu_val), &quot;o&quot; (__m(__pu_addr)), &quot;i&quot; (-EFAULT) &bslash;&n;&t;:&quot;$1&quot;); })
DECL|macro|__put_user_check
mdefine_line|#define __put_user_check(x,ptr,size,mask) ({ &bslash;&n;long __pu_err; &bslash;&n;__typeof__(*(ptr)) __pu_val; &bslash;&n;long __pu_addr; &bslash;&n;__pu_val = (x); &bslash;&n;__pu_addr = (long) (ptr); &bslash;&n;__pu_err = -EFAULT; &bslash;&n;if (__access_ok(__pu_addr,size,mask)) { &bslash;&n;switch (size) { &bslash;&n;case 1: __put_user_check_asm(&quot;sb&quot;); break; &bslash;&n;case 2: __put_user_check_asm(&quot;sh&quot;); break; &bslash;&n;case 4: __put_user_check_asm(&quot;sw&quot;); break; &bslash;&n;case 8: __put_user_check_asm(&quot;sd&quot;); break; &bslash;&n;default: __put_user_unknown(); break; &bslash;&n;} } __pu_err; })
DECL|macro|__put_user_check_asm
mdefine_line|#define __put_user_check_asm(insn) &bslash;&n;({ &bslash;&n;__asm__ __volatile__( &bslash;&n;&t;&quot;1:&bslash;t&quot; insn &quot;&bslash;t%1,%2&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;move&bslash;t%0,$0&bslash;n&quot; &bslash;&n;&t;&quot;2:&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t.fixup,&bslash;&quot;ax&bslash;&quot;&bslash;n&quot; &bslash;&n;&t;&quot;3:&bslash;t.set&bslash;tnoat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;la&bslash;t$1,2b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;jr&bslash;t$1&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.set&bslash;tat&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.section&bslash;t__ex_table,&bslash;&quot;a&bslash;&quot;&bslash;n&bslash;t&quot; &bslash;&n;&t;STR(PTR)&quot;&bslash;t1b,3b&bslash;n&bslash;t&quot; &bslash;&n;&t;&quot;.previous&quot; &bslash;&n;&t;:&quot;=r&quot; (__pu_err) &bslash;&n;&t;:&quot;r&quot; (__pu_val), &quot;o&quot; (__m(__pu_addr)) &bslash;&n;&t;:&quot;$1&quot;); })
r_extern
r_void
