multiline_comment|/* $Id: cpu.h,v 1.1 1996/06/23 09:38:33 dm Exp $&n; * cpu.h: Values of the PRId register used to match up&n; *        various MIPS cpu types.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
