multiline_comment|/* $Id: sgi.h,v 1.1 1999/10/21 00:23:05 ralf Exp $&n; * sgi.h: Definitions specific to SGI machines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@sgi.com)&n; */
