...
multiline_comment|/*&n; * Stack layout for all exceptions:&n; *&n; * ptrace needs to have all regs on the stack. If the order here is changed,&n; * it needs to be updated in include/asm-mips/ptrace.h&n; *&n; * The first PTRSIZE*5 bytes are argument save space for C subroutines.&n; */
DECL|macro|FR_REG1
mdefine_line|#define FR_REG1&t;&t;(PTRSIZE*5)
DECL|macro|FR_REG2
