multiline_comment|/* $Id: sgi.h,v 1.1 1997/06/06 09:39:54 ralf Exp $&n; * sgi.h: Definitions specific to SGI machines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@sgi.com)&n; */
