multiline_comment|/*&n; * linux/include/asm-mips/timex.h&n; *&n; * mips architecture timex specifications&n; */
macro_line|#ifndef _ASMmips_TIMEX_H
DECL|macro|_ASMmips_TIMEX_H
mdefine_line|#define _ASMmips_TIMEX_H
