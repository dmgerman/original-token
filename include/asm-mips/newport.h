multiline_comment|/* $Id: newport.h,v 1.1 1998/08/19 21:58:12 ralf Exp $&n; *&n; * newport.h: Defines and register layout for NEWPORT graphics&n; *            hardware.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
...
mdefine_line|#define NPORT_CFG_GDMSK   0x00000f80
DECL|macro|NPORT_CFG_GD0
mdefine_line|#define NPORT_CFG_GD0     0x00000080
DECL|macro|NPORT_CFG_GD1
mdefine_line|#define NPORT_CFG_GD1     0x00000100
DECL|macro|NPORT_CFG_GD2
mdefine_line|#define NPORT_CFG_GD2     0x00000200
DECL|macro|NPORT_CFG_GD3
mdefine_line|#define NPORT_CFG_GD3     0x00000400
DECL|macro|NPORT_CFG_GD4
mdefine_line|#define NPORT_CFG_GD4     0x00000800
DECL|macro|NPORT_CFG_GFAINT
mdefine_line|#define NPORT_CFG_GFAINT  0x00001000
DECL|macro|NPORT_CFG_TOMSK
mdefine_line|#define NPORT_CFG_TOMSK   0x0000e000
DECL|macro|NPORT_CFG_VRMSK
mdefine_line|#define NPORT_CFG_VRMSK   0x00070000
DECL|macro|NPORT_CFG_FBTYP
mdefine_line|#define NPORT_CFG_FBTYP   0x00080000
...
suffix:semicolon
r_return
id|regs-&gt;set.dcbdata0.hwords.s1
suffix:semicolon
)brace
