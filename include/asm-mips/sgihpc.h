multiline_comment|/* $Id: sgihpc.h,v 1.1 1997/06/06 09:40:02 ralf Exp $&n; * sgihpc.h: Various HPC I/O controller defines.  The HPC is basically&n; *           the approximate functional equivalent of the Sun SYSIO&n; *           on SGI INDY machines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
