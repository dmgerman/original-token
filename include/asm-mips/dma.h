...
multiline_comment|/*&n; * The maximum address that we can perform a DMA transfer to on this platform&n; * This describes only the PC style part of the DMA logic like on Deskstations&n; * or Acer PICA but not the much more versatile DMA logic used for the&n; * local devices on Acer PICA or Magnums.&n; */
