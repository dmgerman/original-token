multiline_comment|/*&n; * include/asm-mips/asm.h&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Copyright (C) 1995, 1996, 1997 by Ralf Baechle&n; *&n; * Some useful macros for MIPS assembler code&n; *&n; * Some of the routines below contain useless nops that will be optimized&n; * away by gas in -O mode. These nops are however required to fill delay&n; * slots in noreorder mode.&n; */
...
macro_line|#endif
multiline_comment|/*&n; * Macros to handle different pointer/register sizes for 32/64-bit code&n; *&n; * 64 bit address space isn&squot;t used yet, so we may use the R3000 32 bit&n; * defines for now.&n; */
DECL|macro|PTR
...
DECL|macro|EXPORT
mdefine_line|#define&t;EXPORT(symbol)                                  &bslash;&n;&t;&t;.globl&t;symbol;                         &bslash;&n;symbol:
...
DECL|macro|PTR_SUBU
mdefine_line|#define PTR_SUBU subu
DECL|macro|PTR_ADDU
mdefine_line|#define PTR_ADDU addu
macro_line|#endif
macro_line|#if (_MIPS_ISA == _MIPS_ISA_MIPS3) || (_MIPS_ISA == _MIPS_ISA_MIPS4) || &bslash;&n;    (_MIPS_ISA == _MIPS_ISA_MIPS5)
DECL|macro|REG_S
