multiline_comment|/* $Id: sgimc.h,v 1.1 1997/06/06 09:40:04 ralf Exp $&n; * sgimc.h: Definitions for memory controller hardware found on&n; *          SGI IP20, IP22, IP26, and IP28 machines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
...
suffix:semicolon
macro_line|#endif /* !(_MIPS_SGIMC_H) */
eof
