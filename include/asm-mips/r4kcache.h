multiline_comment|/*&n; * r4kcache.h: Inline assembly cache operations.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; *&n; * $Id: r4kcache.h,v 1.5 1998/05/01 01:36:03 ralf Exp $&n; *&n; * FIXME: Handle split L2 caches.&n; */
