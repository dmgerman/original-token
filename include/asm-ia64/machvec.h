multiline_comment|/*&n; * Machine vector for IA-64.&n; * &n; * Copyright (C) 1999 Silicon Graphics, Inc.&n; * Copyright (C) Srinivasa Thirumalachar &lt;sprasad@engr.sgi.com&gt;&n; * Copyright (C) Vijay Chander &lt;vijay@engr.sgi.com&gt;&n; * Copyright (C) 1999 Hewlett-Packard Co.&n; * Copyright (C) David Mosberger-Tang &lt;davidm@hpl.hp.com&gt;&n; */
...
macro_line|#  include &lt;asm/machvec_sgi_sn1_SIM.h&gt;
