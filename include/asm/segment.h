...
DECL|macro|and_fs_long
mdefine_line|#define and_fs_long(x,addr) and_user_long((x),(int *)(addr))
DECL|function|or_user_long
r_static
r_inline
r_void
id|or_user_long
...
DECL|macro|or_fs_long
mdefine_line|#define or_fs_long(x,addr) or_user_long((x),(int *)(addr))
