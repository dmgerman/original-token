...
mdefine_line|#define KADB_DEBUGGER_BEGVM     0x0fee0000    /* There is no kadb yet but...*/
DECL|macro|LINUX_OPPROM_BEGVM
mdefine_line|#define LINUX_OPPROM_BEGVM      0x0fef0000
DECL|macro|LINUX_OPPROM_ENDVM
mdefine_line|#define LINUX_OPPROM_ENDVM      0x0ff10000    /* I think this is right - tm */
macro_line|#else
DECL|macro|KADB_DEBUGGER_BEGVM
...
id|linux_romvec
(brace
DECL|member|pv_initsp
r_char
op_star
id|pv_initsp
suffix:semicolon
DECL|member|pv_startmon
r_int
(paren
op_star
id|pv_startmon
...
id|pv_echo
suffix:semicolon
DECL|member|pv_insource
r_int
r_char
op_star
id|pv_insource
suffix:semicolon
DECL|member|pv_outsink
r_int
r_char
op_star
id|pv_outsink
suffix:semicolon
DECL|member|pv_getkey
r_int
(paren
op_star
id|pv_getkey
...
suffix:semicolon
DECL|member|pv_translation
r_int
r_int
op_star
id|pv_translation
suffix:semicolon
DECL|member|pv_keybid
r_int
r_char
op_star
id|pv_keybid
suffix:semicolon
DECL|member|pv_screen_x
r_int
op_star
id|pv_screen_x
suffix:semicolon
DECL|member|pv_screen_y
r_int
op_star
id|pv_screen_y
suffix:semicolon
DECL|member|pv_keybuf
r_struct
id|keybuf
op_star
id|pv_keybuf
suffix:semicolon
DECL|member|pv_monid
r_char
op_star
id|pv_monid
suffix:semicolon
...
id|pv_lineptr
suffix:semicolon
DECL|member|pv_linesize
r_int
op_star
id|pv_linesize
suffix:semicolon
DECL|member|pv_getline
r_int
(paren
op_star
id|pv_getline
...
suffix:semicolon
DECL|member|pv_fbthere
r_int
op_star
id|pv_fbthere
suffix:semicolon
DECL|member|pv_getnum
r_int
(paren
op_star
id|pv_getnum
...
suffix:semicolon
DECL|member|pv_nmiclock
r_int
op_star
id|pv_nmiclock
suffix:semicolon
DECL|member|pv_fbtype
r_int
op_star
id|pv_fbtype
suffix:semicolon
...
id|pv_romvers
suffix:semicolon
DECL|member|pv_globram
r_struct
id|globram
op_star
id|pv_globram
suffix:semicolon
DECL|member|pv_kbdzscc
r_char
op_star
id|pv_kbdzscc
suffix:semicolon
DECL|member|pv_keyrinit
r_int
op_star
id|pv_keyrinit
suffix:semicolon
DECL|member|pv_keyrtick
r_int
r_char
op_star
id|pv_keyrtick
suffix:semicolon
DECL|member|pv_memoryavail
r_int
op_star
id|pv_memoryavail
suffix:semicolon
DECL|member|pv_resetaddr
r_int
op_star
id|pv_resetaddr
suffix:semicolon
DECL|member|pv_resetmap
r_int
op_star
id|pv_resetmap
suffix:semicolon
