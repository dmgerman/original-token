...
multiline_comment|/* We don&squot;t use pgd cache yet, so this is a dummy routine */
...
multiline_comment|/* We don&squot;t use pmd cache yet, so this is a dummy routine */
...
suffix:semicolon
DECL|macro|pte_free
mdefine_line|#define pte_free&t;&t;free_pte_fast
DECL|macro|pte_free_kernel
mdefine_line|#define pte_free_kernel&t;&t;free_pte_fast
...
(brace
multiline_comment|/* Nothing to do on m68k */
)brace
