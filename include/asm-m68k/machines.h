multiline_comment|/* $Id: machines.h,v 1.4 1995/11/25 02:31:58 davem Exp $&n; * machines.h:  Defines for taking apart the machine type value in the&n; *              idprom and determining the kind of machine we are on.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Sun3/3x models added by David Monro (davidm@psrg.cs.usyd.edu.au)&n; */
...
singleline_comment|// reduced along with table in arch/m68k/sun3/idprom.c
singleline_comment|// sun3 port doesn&squot;t need to know about sparc machines.
singleline_comment|//#define NUM_SUN_MACHINES   23
DECL|macro|NUM_SUN_MACHINES
mdefine_line|#define NUM_SUN_MACHINES  8
r_extern
r_struct
id|Sun_Machine_Models
id|Sun_Machines
...
DECL|macro|SM_SUN3
mdefine_line|#define SM_SUN3       0x10
DECL|macro|SM_SUN4
mdefine_line|#define SM_SUN4       0x20
DECL|macro|SM_SUN3X
mdefine_line|#define SM_SUN3X      0x40
DECL|macro|SM_SUN4C
...
multiline_comment|/* Sun3 machines */
DECL|macro|SM_3_160
mdefine_line|#define SM_3_160      0x01    /* Sun 3/160 series */
DECL|macro|SM_3_50
mdefine_line|#define SM_3_50       0x02    /* Sun 3/50 series */
DECL|macro|SM_3_260
mdefine_line|#define SM_3_260      0x03    /* Sun 3/260 series */
DECL|macro|SM_3_110
mdefine_line|#define SM_3_110      0x04    /* Sun 3/110 series */
DECL|macro|SM_3_60
mdefine_line|#define SM_3_60       0x07    /* Sun 3/60 series */
DECL|macro|SM_3_E
mdefine_line|#define SM_3_E        0x08    /* Sun 3/E series */
multiline_comment|/* Sun3x machines */
DECL|macro|SM_3_460
mdefine_line|#define SM_3_460      0x01    /* Sun 3/460 (460,470,480) series */
DECL|macro|SM_3_80
mdefine_line|#define SM_3_80       0x02    /* Sun 3/80 series */
