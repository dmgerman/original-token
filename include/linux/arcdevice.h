...
DECL|macro|BUGMSG
mdefine_line|#define BUGMSG(x,msg,args...) &bslash;&n;&t;BUGMSG2(x,&quot;%s%6s: &quot; msg, &bslash;&n;            x==D_NORMAL&t;? KERN_WARNING : &bslash;&n;      x&lt;=D_INIT_REASONS&t;? KERN_INFO    : KERN_DEBUG , &bslash;&n;&t;dev-&gt;name , ## args)
DECL|macro|SETMASK
