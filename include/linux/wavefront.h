...
multiline_comment|/* See wavefront.c for details */
DECL|macro|WAVEFRONT_MAX_DEVICES
mdefine_line|#define WAVEFRONT_MAX_DEVICES 1 /* How many WaveFront cards we can handle */
