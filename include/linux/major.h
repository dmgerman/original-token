...
multiline_comment|/*&n; * assignments&n; *&n; * devices are as follows (same as minix, so we can use the minix fs):&n; *&n; *      character              block                  comments&n; *      --------------------   --------------------   --------------------&n; *  0 - unnamed                unnamed                minor 0 = true nodev&n; *  1 - /dev/mem               ramdisk&n; *  2 -                        floppy&n; *  3 -                        ide0 or hd&n; *  4 - /dev/tty*&n; *  5 - /dev/tty; /dev/cua*&n; *  6 - lp&n; *  7 - /dev/vcs*&n; *  8 -                        scsi disk&n; *  9 - scsi tape&n; * 10 - mice&n; * 11 -                        scsi cdrom&n; * 12 - qic02 tape&n; * 13 -                        xt disk&n; * 14 - sound card&n; * 15 -                        cdu31a cdrom&n; * 16 - sockets                goldstar cdrom&n; * 17 - af_unix                optics cdrom&n; * 18 - af_inet                sanyo cdrom&n; * 19 - cyclades /dev/ttyC*&n; * 20 - cyclades /dev/cub*     mitsumi (mcdx) cdrom&n; * 21 - scsi generic&n; * 22 - Z8530 driver           ide1&n; * 23 -                        mitsumi cdrom&n; * 24 -&t;                       sony535 cdrom&n; * 25 -                        matsushita cdrom       minors 0..3&n; * 26 -                        matsushita cdrom 2     minors 0..3&n; * 27 - qic117 tape            matsushita cdrom 3     minors 0..3&n; * 28 -                        matsushita cdrom 4     minors 0..3&n; * 29 -                        aztech/orchid/okano/wearnes cdrom&n; * 32 -                        philips/lms cm206 cdrom&n; * 33 -                        ide2&n; * 34 -                        ide3&n; */
...
mdefine_line|#define Z8530_MAJOR 22
