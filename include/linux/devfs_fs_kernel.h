...
mdefine_line|#define DEVFS_FL_NONE         0x000  /* This helps making code more readable */
...
mdefine_line|#define DEVFS_FL_AUTO_DEVNUM  0x008  /* Automatically generate device number */
DECL|macro|DEVFS_FL_AOPEN_NOTIFY
mdefine_line|#define DEVFS_FL_AOPEN_NOTIFY 0x010  /* Asynchronously notify devfsd on open */
