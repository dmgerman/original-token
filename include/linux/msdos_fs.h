...
mdefine_line|#define MSDOS_ROOT_INO  1
...
mdefine_line|#define ATTR_UNUSED  (ATTR_VOLUME | ATTR_ARCH | ATTR_SYS)
...
DECL|macro|SET_DIRTY
mdefine_line|#define SET_DIRTY(i) (i)-&gt;i_dirt = (i)-&gt;i_data[D_DIRT] = 1
DECL|macro|MSDOS_SB
mdefine_line|#define MSDOS_SB(s) ((struct msdos_sb_info *) s)
...
id|name_check
suffix:semicolon
multiline_comment|/* r = releaxed, n = normal, s = strict */
...
mdefine_line|#define MSDOS_MKMODE(a,m) (m &amp; (a &amp; ATTR_RO ? 0444 : (a &amp; ATTR_HIDDEN ? 0 : &bslash;&n;    0777)))
multiline_comment|/* Convert the UNIX mode to MS-DOS attribute bits. */
DECL|macro|MSDOS_MKATTR
mdefine_line|#define MSDOS_MKATTR(m) (!(m &amp; 0600) ? ATTR_HIDDEN : ((m &amp; 0600) == 0400 ? &bslash;&n;    ATTR_RO : ATTR_NONE))
