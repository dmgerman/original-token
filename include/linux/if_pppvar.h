multiline_comment|/*&t;$Id: if_pppvar.h,v 1.2 1995/06/12 11:36:51 paulus Exp $&t;*/
...
DECL|macro|RBUFSIZE
mdefine_line|#define RBUFSIZE  2048           /* MUST be a power of 2 and be &lt;= 4095 */
...
id|xbuf
suffix:semicolon
multiline_comment|/* Buffer currently being sent  */
DECL|member|s1buf
r_struct
id|ppp_buffer
op_star
...
id|rbuf
suffix:semicolon
multiline_comment|/* Receive information&t;&t;*/
DECL|member|ubuf
r_struct
id|ppp_buffer
op_star
