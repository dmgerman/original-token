...
suffix:semicolon
DECL|typedef|pci_simple_probe_callback
r_typedef
r_int
(paren
op_star
...
suffix:semicolon
DECL|struct|pci_simple_probe_entry
r_struct
id|pci_simple_probe_entry
(brace
DECL|member|vendor
...
id|vendor
suffix:semicolon
multiline_comment|/* vendor id, PCI_ANY_ID, or 0 for last entry */
DECL|member|device
r_int
r_int
id|device
suffix:semicolon
multiline_comment|/* device id, PCI_ANY_ID, or 0 for last entry */
DECL|member|subsys_vendor
r_int
r_int
id|subsys_vendor
suffix:semicolon
multiline_comment|/* subsystem vendor id, 0 for don&squot;t care */
DECL|member|subsys_device
r_int
r_int
id|subsys_device
suffix:semicolon
multiline_comment|/* subsystem device id, 0 for don&squot;t care */
DECL|member|dev_data
r_void
op_star
id|dev_data
suffix:semicolon
multiline_comment|/* driver-private, entry-specific data */
)brace
suffix:semicolon
r_int
id|pci_simple_probe
