...
multiline_comment|/*&n; * Attention! This file contains user-serviceable parts!&n; * I recommend to make use of it...&n; *&n; * The definitions for the first controller can get overridden by&n; * the kernel command line (&quot;lilo boot option&quot;).&n; * Examples:&n; *                                 sbpcd=0x230,SoundBlaster&n; *                             or&n; *                                 sbpcd=0x300,LaserMate&n; *                             or&n; *                                 sbpcd=0x330,SPEA&n; *&n; * If sbpcd gets used as a module, you can load it with&n; *     insmod /usr/src/linux/modules/sbpcd.o sbpcd=0x230,1&n; * or&n; *     insmod /usr/src/linux/modules/sbpcd.o sbpcd=0x300,0&n; * or&n; *     insmod /usr/src/linux/modules/sbpcd.o sbpcd=0x330,2&n; * respective to override the configured address and type.&n; */
multiline_comment|/*&n; * define your CDROM port base address as CDROM_PORT&n; * and specify the type of your interface card as SBPRO.&n; *&n; * Read linux/drivers/block/README.sbpcd if you are in doubt about the&n; * type of your interface card (you should do that anyway).&n; *&n; * address:&n; * ========&n; * SBPRO type addresses typically are 0x0230 (=0x220+0x10), 0x0250, ...&n; * LASERMATE type (CI-101P, WDH-7001C) addresses typically are 0x0300, ...&n; * SPEA addresses are from the LASERMATE type and range.&n; * There are some soundcards on the market with 0x0630, 0x0650, ...; their&n; * type is not obvious (both types are possible).&n; *&n; * example: if your SBPRO audio address is 0x220, specify 0x230 and SBPRO 1.&n; *          if your soundcard has its CDROM port above 0x300, specify&n; *          that address and try SBPRO 0 first.&n; *&n; * interface type:&n; * ===============&n; * set SBPRO to 1 for &quot;true&quot; SoundBlaster card&n; * set SBPRO to 0 for &quot;compatible&quot; soundcards and&n; *                for &quot;poor&quot; (no sound) interface cards.&n; * set SBPRO to 2 for the SPEA Media FX card&n; *&n; * Almost all &quot;compatible&quot; sound boards need to set SBPRO to 0.&n; * If SBPRO is set wrong, the drives will get found - but any&n; * data access will give errors (audio access will work).&n; * The &quot;OmniCD&quot; no-sound interface card from CreativeLabs needs SBPRO 1.&n; *&n; * mail to emoenke@gwdg.de if you have a &quot;compatible&quot; sound card which&n; * in fact needs to set SBPRO to 1 (not any known at time).&n; *&n; * sound base:&n; * ===========&n; * The SOUND_BASE definition tells if we should try to turn the CD sound&n; * channels on. It will only be of use regarding soundcards with a SbPro&n; * compatible mixer.&n; *&n; * Example: #define SOUND_BASE 0x220 enables the sound card&squot;s CD channels&n; *          #define SOUND_BASE 0     leaves the soundcard untouched&n; */
...
DECL|macro|DBG_CD2
mdefine_line|#define DBG_CD2&t;28&t;/* MKE CD200 debugging trace */
DECL|macro|DBG_TEA
mdefine_line|#define DBG_TEA&t;29&t;/* TEAC CD-55A debugging trace */
DECL|macro|DBG_TE2
mdefine_line|#define DBG_TE2&t;30&t;/* TEAC CD-55A 2nd debugging level */
DECL|macro|DBG_000
...
mdefine_line|#define p_lcs_door_closed&t;0x01
...
DECL|macro|drv_fam0
mdefine_line|#define drv_fam0&t;0x08&t;&t;/* CR-52x family */
DECL|macro|drv_199
...
DECL|macro|drv_famL
mdefine_line|#define drv_famL&t;0x10&t;&t;/* Longshine family */
DECL|macro|drv_260
...
DECL|macro|drv_fam1
mdefine_line|#define drv_fam1&t;0x20&t;&t;/* CR-56x family */
DECL|macro|drv_099
mdefine_line|#define drv_099&t;&t;(drv_fam1+0x01)&t;/* &lt;100 */
DECL|macro|drv_100
mdefine_line|#define drv_100&t;&t;(drv_fam1+0x02)&t;/* &gt;=100, only 5.00 known here */
DECL|macro|drv_famT
mdefine_line|#define drv_famT&t;0x40&t;&t;/* TEAC CD-55A */
DECL|macro|drv_fam2
mdefine_line|#define drv_fam2&t;0x80&t;&t;/* CD200 family */
...
mdefine_line|#define MAX_TRACKS&t;120&t;/* why more than 99? */
multiline_comment|/*==========================================================================*/
