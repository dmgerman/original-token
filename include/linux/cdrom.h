...
multiline_comment|/*&n; * the raw frame layout:&n; *&n; * - audio (red):                  | audio_sample_bytes |&n; *                                 |        2352        |&n; *&n; * - data (yellow, mode1):         | sync - head - data - EDC - zero - ECC |&n; *                                 |  12  -   4  - 2048 -  4  -   8  - 276 |&n; *&n; * - data (yellow, mode2):         | sync - head - data |&n; *                                 |  12  -   4  - 2336 |&n; *&n; * - XA data (green, mode2 form1): | sync - head - sub - data - EDC - ECC |&n; *                                 |  12  -   4  -  8  - 2048 -  4  - 276 |&n; *&n; * - XA data (green, mode2 form2): | sync - head - sub - data - EDC |&n; *                                 |  12  -   4  -  8  - 2324 -  4  |&n; *&n; * Sector types (format) - Forces the CD-ROM to read the specified sector type,&n; *                         attempt to read any other format ends with an error&n; *&n; * format       sector type             user data size (bytes)&n; * -----------------------------------------------------------------------------&n; *   1     CD DA (Red Book)             2352    (CD_FRAMESIZE_RAW)&n; *   2     Mode1 Form1 (Yellow Book)    2048    (CD_FRAMESIZE)&n; *   3     Mode1 Form2 (Yellow Book)    2336    (CD_FRAMESIZE_RAW0)&n; *   4     Mode2 Form1 (Green Book)     2048    (CD_FRAMESIZE)&n; *   5     Mode2 Form2 (Green Book)     2328    (2324+4 spare bytes)&n; *&n; *&n; * Data Selection Field (pc.c[9]) - This value controls the actual number&n; *                                  of bytes transferred from the CD-ROM&n; *&n; * bit      7       6        5        4        3       2        1        0&n; * ----------------------------------------------------------------------------&n; *     |  Sync  |   Sub  | Header |  User  | EDC &amp; | Error |  Block  | reserved&n; *     |        | Header |        |  Data  |  ECC  | Flags |  Error  |&n; *     &bslash;-------------------------------------------/&bslash;---------------/&n; *                           |                              |&n; *                           V                              V&n; *                   stored on CD (2532)    generated during error correction&n; *&n; * The maximal number of bytes returned by CD-ROM is 2646 (CD_FRAMESIZE_RAWER),&n; * when pc.c[9] = 0xfa.&n; *&n; */
