...
mdefine_line|#define __MAX_POLL_TABLE_ENTRIES ((PAGE_SIZE - sizeof (poll_table)) / sizeof (struct poll_table_entry))
...
suffix:semicolon
multiline_comment|/*&n; * XXX - still used by alpha osf and sparc32 compatiblity.&n; */
r_typedef
r_struct
(brace
DECL|member|in
