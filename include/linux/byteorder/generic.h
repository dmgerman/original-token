...
multiline_comment|/*&n; * linux/byteorder_generic.h&n; * Generic Byte-reordering support&n; *&n; * Francois-Rene Rideau &lt;rideau@ens.fr&gt; 19970707&n; *    gathered all the good ideas from all asm-foo/byteorder.h into one file,&n; *    cleaned them up.&n; *    I hope it is compliant with non-GCC compilers.&n; *    I decided to put __BYTEORDER_HAS_U64__ in byteorder.h,&n; *    because I wasn&squot;t sure it would be ok to put it in types.h&n; *    Upgraded it to 2.1.43&n; * Francois-Rene Rideau &lt;rideau@ens.fr&gt; 19971012&n; *    Upgraded it to 2.1.57&n; *    to please Linus T., replaced huge #ifdef&squot;s between little/big endian&n; *    by nestedly #include&squot;d files.&n; * Francois-Rene Rideau &lt;rideau@ens.fr&gt; 19971205&n; *    Made it to 2.1.71; now a facelift:&n; *    Put files under include/linux/byteorder/&n; *    Split swab from generic support.&n; *&n; * TODO:&n; *   = Regular kernel maintainers could also replace all these manual&n; *    byteswap macros that remain, disseminated among drivers,&n; *    after some grep or the sources...&n; *   = Linus might want to rename all these macros and files to fit his taste,&n; *    to fit his personal naming scheme.&n; *   = it seems that a few drivers would also appreciate&n; *    nybble swapping support...&n; *   = every architecture could add their byteswap macro in asm/byteorder.h&n; *    see how some architectures already do (i386, alpha, ppc, etc)&n; */
