...
multiline_comment|/*&n; * linux/byteorder/swabb.h&n; * SWAp Bytes Bizarrely&n; *&t;swaHHXX[ps]?(foo)&n; *&n; * Support for obNUXIous vax-endian and other bizarre architectures...&n; *&n; */
multiline_comment|/*&n; * Meaning of the names I chose (vaxlinux people feel free to correct them):&n; * swahw32&t;swap 16-bit half-words in a 32-bit word&n; * swahb32&t;swap 8-bit halves of each 16-bit half-word in a 32-bit word&n; *&n; * No 64-bit support yet. I don&squot;t know VAX conventions for long longs.&n; * I guarantee it will be a mess when it&squot;s there, though :-&gt;&n; * It will be even worse if there are conflicting 64-bit conventions for vaxen&n; *&n; * Note that if communicating with vax machines becomes useful in some kernel&n; * FS driver, we&squot;d have to move that mess into byteorder/swab.h, and&n; * create cpu_to_ve32 and suches. Ouch.&n; */
