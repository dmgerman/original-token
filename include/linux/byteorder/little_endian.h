...
mdefine_line|#define __constant_cpu_to_be64(x) ___constant_swab64((x))
DECL|macro|__constant_be64_to_cpu
mdefine_line|#define __constant_be64_to_cpu(x) ___constant_swab64((x))
DECL|macro|__constant_cpu_to_be32
mdefine_line|#define __constant_cpu_to_be32(x) ___constant_swab32((x))
DECL|macro|__constant_be32_to_cpu
mdefine_line|#define __constant_be32_to_cpu(x) ___constant_swab32((x))
...
mdefine_line|#define __cpu_to_le64(x) ((__u64)(x))
DECL|macro|__le64_to_cpu
mdefine_line|#define __le64_to_cpu(x) ((__u64)(x))
DECL|macro|__cpu_to_le32
mdefine_line|#define __cpu_to_le32(x) ((__u32)(x))
DECL|macro|__le32_to_cpu
mdefine_line|#define __le32_to_cpu(x) ((__u32)(x))
...
mdefine_line|#define __cpu_to_be64(x) __swab64((x))
DECL|macro|__be64_to_cpu
mdefine_line|#define __be64_to_cpu(x) __swab64((x))
DECL|macro|__cpu_to_be32
mdefine_line|#define __cpu_to_be32(x) __swab32((x))
DECL|macro|__be32_to_cpu
mdefine_line|#define __be32_to_cpu(x) __swab32((x))
...
mdefine_line|#define __cpu_to_le64p(x) (*(__u64*)(x))
DECL|macro|__le64_to_cpup
mdefine_line|#define __le64_to_cpup(x) (*(__u64*)(x))
DECL|macro|__cpu_to_le32p
mdefine_line|#define __cpu_to_le32p(x) (*(__u32*)(x))
DECL|macro|__le32_to_cpup
mdefine_line|#define __le32_to_cpup(x) (*(__u32*)(x))
...
mdefine_line|#define __cpu_to_be64p(x) __swab64p((x))
DECL|macro|__be64_to_cpup
mdefine_line|#define __be64_to_cpup(x) __swab64p((x))
DECL|macro|__cpu_to_be32p
mdefine_line|#define __cpu_to_be32p(x) __swab32p((x))
DECL|macro|__be32_to_cpup
mdefine_line|#define __be32_to_cpup(x) __swab32p((x))
