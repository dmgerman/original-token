...
multiline_comment|/*&n; * Could have been named NUXI-endian&n; * This file *should* work, but has not been tested.&n; * It&squot;s the beginning of what vaxlinux implementers will have to do.&n; * I just hope we won&squot;t have to write standardized cpu_to_ve32() and suches!&n; * little endian is 1234; bigendian is 4321; vaxendian is 3412&n; *&n; * But what does a __u64 look like: is it 34127856 or 78563412 ???&n; * I don&squot;t dare imagine! Hence, no 64-bit byteorder support yet.&n; *&n; */
