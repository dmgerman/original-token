...
multiline_comment|/* PLEASE, avoid to allocate new softirqs, if you need not _really_ high&n;   frequency threaded job scheduling. For almost all the purposes&n;   tasklets are more than enough. F.e. KEYBOARD_BH, CONSOLE_BH, all serial&n;   device BHs et al. are converted to tasklets, not to softirqs.&n; */
r_enum
(brace
...
DECL|function|disable_bh_nosync
r_extern
id|__inline__
r_void
id|disable_bh_nosync
c_func
(paren
r_int
id|nr
