...
mdefine_line|#define inode_get_count(i) atomic_read(&amp;((i)-&gt;i_count))
DECL|macro|inode_inc_count
mdefine_line|#define inode_inc_count(i) atomic_inc(&amp;((i)-&gt;i_count))
DECL|macro|inode_dec_count
mdefine_line|#define inode_dec_count(i) atomic_dec(&amp;((i)-&gt;i_count))
