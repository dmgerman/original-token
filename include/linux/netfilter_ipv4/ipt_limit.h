macro_line|#ifndef _IPT_RATE_H
DECL|macro|_IPT_RATE_H
mdefine_line|#define _IPT_RATE_H
multiline_comment|/* timings are in milliseconds. */
DECL|macro|IPT_LIMIT_SCALE
mdefine_line|#define IPT_LIMIT_SCALE 10000
multiline_comment|/* 1/10,000 sec period =&gt; max of 10,000/sec.  Min rate is then 429490&n;   seconds, or one every 59 hours. */
DECL|struct|ipt_rateinfo
r_struct
id|ipt_rateinfo
(brace
DECL|member|avg
