...
multiline_comment|/*&n; * Change this to set the I/O port address.&n; */
...
mdefine_line|#define SCMD_DATA_READ      0xA0
...
multiline_comment|/*&n; * borrowed from hd.c&n; */
