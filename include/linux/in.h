...
DECL|macro|ntohl
macro_line|#  define ntohl(x)&t;__ntohl((x))
DECL|macro|ntohs
macro_line|#  define ntohs(x)&t;__ntohs((x))
DECL|macro|htonl
macro_line|#  define htonl(x)&t;__htonl((x))
DECL|macro|htons
macro_line|#  define htons(x)&t;__htons((x))
macro_line|#endif
