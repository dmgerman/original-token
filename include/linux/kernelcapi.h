multiline_comment|/*&n; * $Id: kernelcapi.h,v 1.7 2000/06/12 09:20:20 kai Exp $&n; * &n; * Kernel CAPI 2.0 Interface for Linux&n; * &n; * (c) Copyright 1997 by Carsten Paeth (calle@calle.in-berlin.de)&n; * &n; */
