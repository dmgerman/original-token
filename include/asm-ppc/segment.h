macro_line|#ifndef _ASM_PPC_SEGMENT_H
DECL|macro|_ASM_PPC_SEGMENT_H
mdefine_line|#define _ASM_PPC_SEGMENT_H
...
multiline_comment|/*&n; * For segmented architectures, these are used to specify which segment&n; * to use for the above functions.&n; *&n; * The powerpc is not segmented, so these are just dummies.&n; */
