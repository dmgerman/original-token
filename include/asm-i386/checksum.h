...
suffix:semicolon
multiline_comment|/*&n; * I hope GCC will optimize &squot;dummy&squot; away ...&n; */
r_int
r_int
id|csum_partial_copy_nocheck_generic
c_func
(paren
r_int
op_star
...
multiline_comment|/*&n; * These are the &squot;old&squot; way of doing checksums, a warning message will be&n; * printed if they are used and an exeption occurs.&n; *&n; * these functions should go away after some time.&n; */
