...
mdefine_line|#define __copy_from_user(to,from,n)&t;&t;&t;&bslash;&n;&t;(__builtin_constant_p(n) ?&t;&t;&t;&bslash;&n;&t; __constant_copy_from_user_nockeck((to),(from),(n)) :&t;&bslash;&n;&t; __generic_copy_from_user_nocheck((to),(from),(n)))
