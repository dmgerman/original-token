...
macro_line|#else
multiline_comment|/*&n; * These are the old (and incorrect) ones needed for code that doesn&squot;t&n; * know about three-level yet..&n; */
DECL|function|pgd_none
r_extern
r_inline
r_int
