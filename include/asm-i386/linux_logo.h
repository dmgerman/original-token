multiline_comment|/* $Id: linux_logo.h,v 1.3 1998/06/07 21:49:54 geert Exp $&n; * include/asm-i386/linux_logo.h: This is a linux logo&n; *                                to be displayed on boot.&n; *&n; * Copyright (C) 1996 Larry Ewing (lewing@isc.tamu.edu)&n; * Copyright (C) 1996 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; *&n; * You can put anything here, but:&n; * LINUX_LOGO_COLORS has to be less than 224&n; * image size has to be 80x80&n; * values have to start from 0x20&n; * (i.e. RGB(linux_logo_red[0],&n; *&t;     linux_logo_green[0],&n; *&t;     linux_logo_blue[0]) is color 0x20)&n; * BW image has to be 80x80 as well, with MS bit&n; * on the left&n; * Serial_console ascii image can be any size,&n; * but should contain %s to display the version&n; */
macro_line|#include &lt;linux/init.h&gt;
macro_line|#include &lt;linux/version.h&gt;
DECL|macro|linux_logo_banner
mdefine_line|#define linux_logo_banner &quot;Linux/ia32 version &quot; UTS_RELEASE
...
l_string|&quot;   ddd |  ia32  $9$F&bslash;n&quot;
l_string|&quot; &squot;!!!!!$       !!#!`&bslash;n&quot;
l_string|&quot;  !!!!!*     .!!!!!`&bslash;n&quot;
l_string|&quot;&squot;!!!!!!!W..e$$!!!!!!`&bslash;n&quot;
l_string|&quot; &bslash;&quot;~^^~         ^~~^&bslash;n&quot;
l_string|&quot;&bslash;n&quot;
suffix:semicolon
multiline_comment|/* The following created by Andrew Apted, May 1998 */
DECL|variable|__initdata
r_int
r_char
op_star
...
op_assign
l_string|&quot;&bslash;n&quot;
l_string|&quot;LINUX/IA32..........................&bslash;n&quot;
l_string|&quot;::::::::::::::        ::::::::::::::&bslash;n&quot;
l_string|&quot;::::::::::::             :::::::::::&bslash;n&quot;
l_string|&quot;::::::::::::  ##   ##    :::::::::::&bslash;n&quot;
l_string|&quot;:::::::::::: # xxxx ##   :::::::::::&bslash;n&quot;
l_string|&quot;:::::::::::: xxxxxxxxx    ::::::::::&bslash;n&quot;
l_string|&quot;:::::::::::: ##xxx####     :::::::::&bslash;n&quot;
l_string|&quot;::::::::::: ###########     ::::::::&bslash;n&quot;
l_string|&quot;:::::::::  #############      ::::::&bslash;n&quot;
l_string|&quot;::::::::  ###############      :::::&bslash;n&quot;
l_string|&quot;::::::   #################      ::::&bslash;n&quot;
l_string|&quot;::::::  ##################      ::::&bslash;n&quot;
l_string|&quot;:::::xxx##################      ::::&bslash;n&quot;
l_string|&quot;:::xxxxxx  #############xxx   xxx:::&bslash;n&quot;
l_string|&quot;xxxxxxxxxxx   ##########xxxxxxxxxx::&bslash;n&quot;
l_string|&quot;xxxxxxxxxxxx ########## xxxxxxxxxxxx&bslash;n&quot;
l_string|&quot;xxxxxxxxxxxxx#######    xxxxxxxxxxx:&bslash;n&quot;
l_string|&quot;:::::xxxxxxxx:::::::::::xxxxxx::::::&bslash;n&bslash;n&quot;
suffix:semicolon
macro_line|#else
