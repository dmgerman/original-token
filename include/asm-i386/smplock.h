...
mdefine_line|#define release_kernel_lock(task, cpu) &bslash;&n;do { &bslash;&n;&t;if (task-&gt;lock_depth &gt;= 0) &bslash;&n;&t;&t;__asm__ __volatile__(spin_unlock_string &bslash;&n;&t;&t;&t;:&quot;=m&quot; (__dummy_lock(&amp;kernel_flag))); &bslash;&n;&t;release_irqlock(cpu); &bslash;&n;&t;__sti(); &bslash;&n;} while (0)
multiline_comment|/*&n; * Re-acquire the kernel lock&n; */
DECL|macro|reacquire_kernel_lock
mdefine_line|#define reacquire_kernel_lock(task) &bslash;&n;do { &bslash;&n;&t;if (task-&gt;lock_depth &gt;= 0) &bslash;&n;&t;&t;__asm__ __volatile__(spin_lock_string &bslash;&n;&t;&t;&t;:&quot;=m&quot; (__dummy_lock(&amp;kernel_flag))); &bslash;&n;} while (0)
