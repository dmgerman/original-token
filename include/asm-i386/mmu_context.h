...
mdefine_line|#define get_mmu_context(prev, next) &bslash;&n;&t;do { if (next-&gt;flags &amp; PF_LAZY_TLB) &bslash;&n;&t;&t;{ mmget(prev-&gt;mm); next-&gt;mm = prev-&gt;mm; &bslash;&n;&t;&t;&t;next-&gt;thread.cr3 = prev-&gt;thread.cr3; } } while(0)
DECL|macro|put_mmu_context
mdefine_line|#define put_mmu_context(prev, next) &bslash;&n;&t;do { if (prev-&gt;flags &amp; PF_LAZY_TLB) &bslash;&n;&t;&t;&t;{ mmput(prev-&gt;mm); } } while(0)
