...
id|sg_io_hdr_t
suffix:semicolon
multiline_comment|/* 60 bytes long (on i386) */
...
multiline_comment|/* IOCTLs: The following are not required (or ignored) when the sg_io_hdr_t&n;&t;   interface is used. That are kept for backward compatibility with&n;&t;   the original and version 2 drivers. */
