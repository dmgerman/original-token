multiline_comment|/* $Id: ethtool.h,v 1.2 2000/01/31 04:59:19 davem Exp $&n; * ethtool.h: Defines for SparcLinux ethtool.&n; *&n; * Copyright (C) 1998 David S. Miller (davem@redhat.com)&n; */
