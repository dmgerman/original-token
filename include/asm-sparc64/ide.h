multiline_comment|/* $Id: ide.h,v 1.4 1997/08/30 16:29:29 davem Exp $&n; * ide.h: Ultra/PCI specific IDE glue.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
...
r_extern
r_int
id|sparc64_ide_ports_known
suffix:semicolon
r_extern
id|ide_ioreg_t
id|sparc64_ide_regbase
(braket
id|MAX_HWIFS
)braket
suffix:semicolon
