macro_line|#ifndef _ASM_SPARC64_SOCKIOS_H
DECL|macro|_ASM_SPARC64_SOCKIOS_H
mdefine_line|#define _ASM_SPARC64_SOCKIOS_H
...
macro_line|#endif /* !(_ASM_SPARC64_SOCKIOS_H) */
eof
