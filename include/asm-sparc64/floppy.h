...
suffix:semicolon
multiline_comment|/* We cannot do sparc_alloc_io here: it does request_region, which is the generic&n;&t;   floppy driver trying to do once again */
id|sun_fdc
op_assign
(paren
r_struct
