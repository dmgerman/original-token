multiline_comment|/* $Id: string.h,v 1.1 1996/12/26 14:22:40 davem Exp $&n; * string.h: External definitions for optimized assembly string&n; *           routines for the Linux Kernel.&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; */
...
macro_line|#endif /* (__KERNEL__) &amp;&amp; !(EXPORT_SYMTAB) */
