...
id|__setup_end
suffix:semicolon
multiline_comment|/* Used for initialization calls.. */
DECL|macro|__initcall
mdefine_line|#define __initcall(fn)&t;&bslash;&n;&t;static __attribute__ ((unused,__section__ (&quot;.initcall.init&quot;))) initcall_t __initcall_##fn = fn
multiline_comment|/* Used for kernel command line parameter setup */
DECL|macro|__setup
mdefine_line|#define __setup(str, fn) &bslash;&n;&t;static __attribute__ ((unused,__section__ (&quot;.setup.init&quot;))) struct kernel_param __setup_##fn = { str, fn }
DECL|macro|__init
