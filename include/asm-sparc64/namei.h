multiline_comment|/* $Id: namei.h,v 1.13 1998/10/28 08:13:49 jj Exp $&n; * linux/include/asm-sparc64/namei.h&n; *&n; * Routines to handle famous /usr/gnemul/s*.&n; * Included from linux/fs/namei.c&n; */
