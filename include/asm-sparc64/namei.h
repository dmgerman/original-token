multiline_comment|/* $Id: namei.h,v 1.14 1999/04/06 06:54:39 jj Exp $&n; * linux/include/asm-sparc64/namei.h&n; *&n; * Routines to handle famous /usr/gnemul/s*.&n; * Included from linux/fs/namei.c&n; */
