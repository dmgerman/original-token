...
mdefine_line|#define __prefix_lookup_dentry(name, follow_link)&t;&t;&t;&t;&bslash;&n;&t;dentry = __sparc64_lookup_dentry (name, follow_link);&t;&t;&t;&bslash;&n;&t;if (!IS_ERR (dentry)) return dentry;
