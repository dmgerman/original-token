multiline_comment|/* $Id: namei.h,v 1.17 2000/04/13 00:55:54 davem Exp $&n; * linux/include/asm-sparc64/namei.h&n; *&n; * Routines to handle famous /usr/gnemul/s*.&n; * Included from linux/fs/namei.c&n; */
