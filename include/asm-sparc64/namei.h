multiline_comment|/* $Id: namei.h,v 1.4 1997/06/07 08:32:56 ecd Exp $&n; * linux/include/asm-sparc64/namei.h&n; *&n; * Routines to handle famous /usr/gnemul/s*.&n; * Included from linux/fs/namei.c&n; */
