multiline_comment|/* $Id: namei.h,v 1.16 2000/04/08 02:15:17 davem Exp $&n; * linux/include/asm-sparc64/namei.h&n; *&n; * Routines to handle famous /usr/gnemul/s*.&n; * Included from linux/fs/namei.c&n; */
