multiline_comment|/* $Id: a.out.h,v 1.5 1999/07/30 09:31:09 davem Exp $ */
...
mdefine_line|#define STACK_TOP (current-&gt;thread.flags &amp; SPARC_FLAG_32BIT ? 0xf0000000 : TASK_SIZE)
macro_line|#endif
macro_line|#endif /* !(__ASSEMBLY__) */
