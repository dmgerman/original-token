multiline_comment|/* $Id: firehose.h,v 1.4 1998/12/02 10:16:47 davem Exp $&n; * firehose.h: Defines for the Fire Hose Controller (FHC) found&n; *             on Sunfire/Starfire/Wildfire systems.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
...
multiline_comment|/* FHC JTAG Control Register */
