multiline_comment|/* $Id: pgtable.h,v 1.49 1997/06/30 09:24:12 jj Exp $&n; * pgtable.h: SpitFire page table operations.&n; *&n; * Copyright 1996,1997 David S. Miller (davem@caip.rutgers.edu)&n; */
...
mdefine_line|#define flush_cache_all()&t;&bslash;&n;do {&t;unsigned long va;&t;&bslash;&n;&t;flushw_all();&t;&t;&bslash;&n;&t;for(va = 0;&t;&t;&bslash;&n;&t;    va&lt;(PAGE_SIZE&lt;&lt;1);&t;&bslash;&n;&t;    va += 32)&t;&t;&bslash;&n;spitfire_put_icache_tag(va,0x0);&bslash;&n;} while(0)
...
mdefine_line|#define flush_cache_page(vma, page)&t;&t;do { } while(0)
...
multiline_comment|/* Turning this off makes things much faster, but eliminates some&n; * sanity checking as well.&n; */
multiline_comment|/* #define PGTABLE_SANITY_CHECKS */
...
macro_line|#ifdef PGTABLE_SANITY_CHECKS
r_if
c_cond
(paren
id|pmd_bad
