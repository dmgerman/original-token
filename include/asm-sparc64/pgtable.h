multiline_comment|/* $Id: pgtable.h,v 1.28 1997/04/14 17:05:19 jj Exp $&n; * pgtable.h: SpitFire page table operations.&n; *&n; * Copyright 1996 David S. Miller (davem@caip.rutgers.edu)&n; */
...
id|temp
suffix:semicolon
multiline_comment|/* Commit all potential local stores to the instruction space&n;&t; * on this processor before the flush.&n;&t; */
id|membar
c_func
(paren
l_string|&quot;#StoreStore&quot;
...
suffix:semicolon
multiline_comment|/* Actually perform the flush. */
id|__asm__
id|__volatile__
c_func
(paren
