...
id|bus
suffix:semicolon
multiline_comment|/* Our toplevel parent SBUS&t;*/
DECL|member|next
r_struct
id|sbus_dev
op_star
id|next
suffix:semicolon
multiline_comment|/* Chain of siblings&t;&t;*/
DECL|member|child
r_struct
id|sbus_dev
op_star
id|child
suffix:semicolon
multiline_comment|/* Chain of children&t;&t;*/
DECL|member|parent
r_struct
id|sbus_dev
op_star
...
id|prom_node
suffix:semicolon
multiline_comment|/* OBP node of this device&t;*/
...
suffix:semicolon
multiline_comment|/* OBP device name property&t;*/
DECL|member|slot
r_int
id|slot
suffix:semicolon
multiline_comment|/* SBUS slot number&t;&t;*/
...
id|iommu
suffix:semicolon
multiline_comment|/* Opaque IOMMU cookie&t;*/
DECL|member|devices
r_struct
id|sbus_dev
op_star
id|devices
suffix:semicolon
multiline_comment|/* Tree of SBUS devices&t;*/
DECL|member|next
r_struct
id|sbus_bus
op_star
id|next
suffix:semicolon
multiline_comment|/* Next SBUS in system&t;*/
DECL|member|prom_node
r_int
id|prom_node
suffix:semicolon
multiline_comment|/* OBP node of SBUS&t;*/
DECL|member|prom_name
r_char
id|prom_name
(braket
