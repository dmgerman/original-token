macro_line|#ifndef _SPARC64_SHMBUF_H
DECL|macro|_SPARC64_SHMBUF_H
mdefine_line|#define _SPARC64_SHMBUF_H
multiline_comment|/* &n; * The shmid64_ds structure for sparc64 architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 2 miscellaneous 64-bit values&n; */
...
suffix:semicolon
macro_line|#endif /* _SPARC64_SHMBUF_H */
eof
