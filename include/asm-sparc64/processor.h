multiline_comment|/* $Id: processor.h,v 1.33 1997/08/19 14:18:36 jj Exp $&n; * include/asm-sparc64/processor.h&n; *&n; * Copyright (C) 1996 David S. Miller (davem@caip.rutgers.edu)&n; */
