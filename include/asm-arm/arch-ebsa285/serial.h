multiline_comment|/*&n; * linux/include/asm-arm/arch-ebsa285/serial.h&n; *&n; * Copyright (c) 1996,1997,1998 Russell King.&n; *&n; * Changelog:&n; *  15-10-1996&t;RMK&t;Created&n; *  25-05-1998&t;PJB&t;CATS support&n; */
...
mdefine_line|#define _SER_IRQ0&t;IRQ_ISA(4)
DECL|macro|_SER_IRQ1
mdefine_line|#define _SER_IRQ1&t;IRQ_ISA(3)
macro_line|#else
DECL|macro|_SER_IRQ0
mdefine_line|#define _SER_IRQ0&t;0
DECL|macro|_SER_IRQ1
mdefine_line|#define _SER_IRQ1&t;0
macro_line|#endif
