...
multiline_comment|/*&n; * The following gives a maximum memory size of 128MB (32MB in each bank).&n; */
DECL|macro|__virt_to_phys
mdefine_line|#define __virt_to_phys(x)&t;(((x) &amp; 0xf9ffffff) | ((x) &amp; 0x06000000) &lt;&lt; 2)
DECL|macro|__phys_to_virt
mdefine_line|#define __phys_to_virt(x)&t;(((x) &amp; 0xe7ffffff) | ((x) &amp; 0x18000000) &gt;&gt; 2)
