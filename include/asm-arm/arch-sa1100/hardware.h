multiline_comment|/*&n; * linux/include/asm-arm/arch-brutus/hardware.h&n; *&n; * Copyright (C) 1998 Nicolas Pitre &lt;nico@cam.org&gt;&n; *&n; * This file contains the hardware definitions for SA1100 architecture&n; */
