multiline_comment|/*&n; * linux/include/asm-arm/arch-l7200/io.h&n; *&n; * Copyright (C) 2000 Steven Hill (sjhill@cotw.com)&n; *&n; * Modifications:&n; *  21-03-2000&t;SJH&t;Created from linux/include/asm-arm/arch-nexuspci/io.h&n; */
