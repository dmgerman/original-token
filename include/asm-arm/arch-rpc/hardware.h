multiline_comment|/*&n; * linux/include/asm-arm/arch-rpc/hardware.h&n; *&n; * Copyright (C) 1996-1999 Russell King.&n; *&n; * This file contains the hardware definitions of the RiscPC series machines.&n; */
