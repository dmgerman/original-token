multiline_comment|/*&n; * linux/include/asm-arm/arch-rpc/time.h&n; *&n; * Copyright (c) 1996 Russell King.&n; *&n; * Changelog:&n; *  24-Sep-1996&t;RMK&t;Created&n; *  10-Oct-1996&t;RMK&t;Brought up to date with arch-sa110eval&n; *  04-Dec-1997&t;RMK&t;Updated for new arch/arm/time.c&n; */
...
multiline_comment|/*FIXME:&n;&t; * This doesn&squot;t seem to work.  Does RISC OS&n;&t; * actually use the RTC year?  It doesn&squot;t&n;&t; * seem to.  In that case, how does it update&n;&t; * the CMOS year?&n;&t; */
multiline_comment|/*year += (buf[3] &gt;&gt; 6) &amp; 3;*/
...
c_func
(paren
l_string|&quot;Year %4d mon %02X day %02X hour %02X min %02X sec %02X&bslash;n&quot;
comma
id|year
comma
id|buf
