multiline_comment|/*&n; * linux/include/asm-arm/arch-a5k/io.h&n; *&n; * Copyright (C) 1997 Russell King&n; *&n; * Modifications:&n; *  06-Dec-1997&t;RMK&t;Created.&n; */
...
DECL|macro|__outlc
mdefine_line|#define __outlc(v,p) __outwc((v),(p))
DECL|macro|__inlc
