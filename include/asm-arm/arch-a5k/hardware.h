multiline_comment|/*&n; * linux/include/asm-arm/arch-a5k/hardware.h&n; *&n; * Copyright (C) 1996 Russell King.&n; *&n; * This file contains the hardware definitions of the A5000 series machines.&n; */
