multiline_comment|/*&n; * linux/include/asm-arm/arch-nexuspci/keyboard.h&n; *&n; * Driver definitions for PCI card dummy keyboard.&n; *&n; * Copyright (C) 1998 Russell King&n; * Copyright (C) 1998 Philip Blundell&n; */
