multiline_comment|/*&n; * linux/include/asm-arm/arch-arc/processor.h&n; *&n; * Copyright (c) 1996 Russell King.&n; *&n; * Changelog:&n; *  10-09-1996&t;RMK&t;Created&n; */
...
mdefine_line|#define INIT_MMAP &bslash;&n;{ &amp;init_mm, 0, 0x02000000, PAGE_SHARED, VM_READ | VM_WRITE | VM_EXEC, NULL, &amp;init_mm.mmap }
macro_line|#endif
eof
