macro_line|#ifndef _ASMARM_MSGBUF_H
DECL|macro|_ASMARM_MSGBUF_H
mdefine_line|#define _ASMARM_MSGBUF_H
multiline_comment|/* &n; * The msqid64_ds structure for arm architecture.&n; * Note extra padding because this structure is passed back and forth&n; * between kernel and user space.&n; *&n; * Pad space is left for:&n; * - 64-bit time_t to solve y2038 problem&n; * - 2 miscellaneous 32-bit values&n; */
...
suffix:semicolon
macro_line|#endif /* _ASMARM_MSGBUF_H */
eof
