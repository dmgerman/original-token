...
mdefine_line|#define dma_cache_inv(start, size)&t;&t;&t;&t;&t;    &bslash;&n;&t;do { processor.u.armv3v4._cache_purge_area((unsigned long)(start),  &bslash;&n;&t;&t;((unsigned long)(start)+(size))); } while (0)
DECL|macro|dma_cache_wback
mdefine_line|#define dma_cache_wback(start, size)&t;&t;&t;&t;&t;    &bslash;&n;&t;do { processor.u.armv3v4._cache_wback_area((unsigned long)(start),  &bslash;&n;&t;&t;((unsigned long)(start)+(size))); } while (0)
DECL|macro|dma_cache_wback_inv
mdefine_line|#define dma_cache_wback_inv(start, size)&t;&t;&t;&t;    &bslash;&n;&t;do { processor.u.armv3v4._flush_cache_area((unsigned long)(start),  &bslash;&n;&t;&t;((unsigned long)(start)+(size)), 0); } while (0)
eof
