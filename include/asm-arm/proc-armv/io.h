...
mdefine_line|#define dma_cache_inv(start, size)&t;&t;&t;&t;&bslash;&n;&t;do { cpu_cache_purge_area((unsigned long)(start),&t;&bslash;&n;&t;&t;((unsigned long)(start)+(size))); } while (0)
DECL|macro|dma_cache_wback
mdefine_line|#define dma_cache_wback(start, size)&t;&t;&t;&t;&bslash;&n;&t;do { cpu_cache_wback_area((unsigned long)(start),&t;&bslash;&n;&t;&t;((unsigned long)(start)+(size))); } while (0)
DECL|macro|dma_cache_wback_inv
mdefine_line|#define dma_cache_wback_inv(start, size)&t;&t;&t;&bslash;&n;&t;do { cpu_flush_cache_area((unsigned long)(start),&t;&bslash;&n;&t;&t;((unsigned long)(start)+(size)), 0); } while (0)
eof
