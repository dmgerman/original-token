multiline_comment|/* $Id: irq.h,v 1.12 1996/04/03 02:17:34 davem Exp $&n; * irq.h: IRQ registers on the Sparc.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
