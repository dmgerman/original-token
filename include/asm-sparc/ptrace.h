...
mdefine_line|#define THREAD_UMASK      0x210
DECL|macro|THREAD_SADDR
mdefine_line|#define THREAD_SADDR      0x218
DECL|macro|THREAD_SDESC
mdefine_line|#define THREAD_SDESC      0x21c
DECL|macro|THREAD_KSP
mdefine_line|#define THREAD_KSP        0x220
DECL|macro|THREAD_KPC
mdefine_line|#define THREAD_KPC        0x224
