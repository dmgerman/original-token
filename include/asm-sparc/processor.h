multiline_comment|/* $Id: processor.h,v 1.78 2000/11/30 08:37:31 anton Exp $&n; * include/asm-sparc/processor.h&n; *&n; * Copyright (C) 1994 David S. Miller (davem@caip.rutgers.edu)&n; */
