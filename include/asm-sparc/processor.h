multiline_comment|/* $Id: processor.h,v 1.67 1998/07/31 20:03:23 zaitcev Exp $&n; * include/asm-sparc/processor.h&n; *&n; * Copyright (C) 1994 David S. Miller (davem@caip.rutgers.edu)&n; */
