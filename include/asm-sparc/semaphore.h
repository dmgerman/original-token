...
mdefine_line|#define __RWSEM_INITIALIZER(name) &bslash;&n;{ RW_LOCK_BIAS, 0, 0xff, 0xff, __WAIT_QUEUE_HEAD_INITIALIZER((name).wait), &bslash;&n;  __WAIT_QUEUE_HEAD_INITIALIZER((name).write_bias_wait) &bslash;&n;  __SEM_DEBUG_INIT(name) __RWSEM_DEBUG_INIT }
