...
(brace
multiline_comment|/* &n;&t; * We don&squot;t know what information this field contain.&n;&t; * We guess, PCI device function is in bits 15:8&n;&t; * So, ...&n;&t; */
DECL|member|which_io
r_int
r_int
id|which_io
suffix:semicolon
multiline_comment|/* Let it be which_io */
DECL|member|phys_hi
r_int
r_int
id|phys_hi
...
suffix:semicolon
DECL|struct|linux_prom_pci_assigned_addresses
r_struct
