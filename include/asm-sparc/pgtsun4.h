multiline_comment|/* $Id: pgtsun4.h,v 1.3 1998/01/30 11:00:01 jj Exp $&n; * pgtsun4.h:  Sun4 specific pgtable.h defines and code.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1998 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
