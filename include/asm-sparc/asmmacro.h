...
mdefine_line|#define GET_PROCESSOR_OFFSET(reg, tmp) &bslash;&n;&t;GET_PROCESSOR_ID(reg) &bslash;&n;&t;sethi&t;C_LABEL(cpu_offset), %tmp; &bslash;&n;&t;sll&t;%reg, 2, %reg; &bslash;&n;&t;or&t;%tmp, %lo(C_LABEL(cpu_offset)), %tmp; &bslash;&n;&t;ld&t;[%tmp + %reg], %reg;
