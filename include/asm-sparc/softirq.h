...
suffix:semicolon
multiline_comment|/* Linus, I&squot;d _really_ like to get rid of this synchronize_irq() -DaveM */
...
DECL|macro|softirq_trylock
mdefine_line|#define softirq_trylock() &bslash;&n;&t;(atomic_read(&amp;__sparc_bh_counter) ? 0 : ((atomic_set(&amp;__sparc_bh_counter,1)),1))
DECL|macro|softirq_endlock
mdefine_line|#define softirq_endlock()&t;(atomic_set(&amp;__sparc_bh_counter, 0))
DECL|macro|clear_active_bhs
