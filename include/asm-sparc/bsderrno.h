multiline_comment|/* $Id: bsderrno.h,v 1.3 1996/04/25 06:12:47 davem Exp $&n; * bsderrno.h: Error numbers for NetBSD binary compatibility&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
...
macro_line|#endif /* !(_SPARC_BSDERRNO_H) */
eof
