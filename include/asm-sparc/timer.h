...
multiline_comment|/* All accesses to the sun4c timer registers should use this macro. */
DECL|macro|SUN4C_TIMER_STRUCT
mdefine_line|#define  SUN4C_TIMER_STRUCT  ((volatile struct sun4c_timer_info *) TIMER_VADDR)
