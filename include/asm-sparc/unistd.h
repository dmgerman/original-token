multiline_comment|/* $Id: unistd.h,v 1.15 1995/11/25 02:33:12 davem Exp $ */
...
multiline_comment|/* XXX - _foo needs to be __foo, while __NR_bar could be _NR_bar.&n; * XXX These need to be fixed to check the condition codes to see&n; * XXX the return value is an errorno or success.&n; */
