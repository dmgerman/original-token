multiline_comment|/* $Id: turbosparc.h,v 1.3 1997/06/26 12:59:27 jj Exp $&n; * turbosparc.h:  Defines specific to the TurboSparc module.&n; *            This is SRMMU stuff.&n; *&n; * Copyright (C) 1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
