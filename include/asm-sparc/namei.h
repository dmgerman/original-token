multiline_comment|/* $Id: namei.h,v 1.12 1998/10/28 08:13:42 jj Exp $&n; * linux/include/asm-sparc/namei.h&n; *&n; * Routines to handle famous /usr/gnemul/s*.&n; * Included from linux/fs/namei.c&n; */
