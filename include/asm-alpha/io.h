...
multiline_comment|/*&n; * This is a stupid one: I&squot;ll make it a bitmap soon, promise..&n; *&n; * On the other hand: this allows gcc to optimize. Hmm. I&squot;ll&n; * have to use the __constant_p() stuff here.&n; *&n; * The PCI version just returns zero all the time, I do believe..&n; */
