...
mdefine_line|#define switch_to(prev,next) do { &bslash;&n;&t;current_set[0] = current = next; &bslash;&n;&t;alpha_switch_to((unsigned long) &amp;current-&gt;tss - 0xfffffc0000000000); &bslash;&n;} while (0)
r_extern
r_void
id|alpha_switch_to
c_func
