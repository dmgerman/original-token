macro_line|#ifndef _ALPHA_IOCTL_H
DECL|macro|_ALPHA_IOCTL_H
mdefine_line|#define _ALPHA_IOCTL_H
multiline_comment|/*&n; * The original linux ioctl numbering scheme was just a general&n; * &quot;anything goes&quot; setup, where more or less random numbers were&n; * assigned.  Sorry, I was clueless when I started out on this.&n; *&n; * On the alpha, we&squot;ll try to clean it up a bit, using a more sane&n; * ioctl numbering, and also trying to be compatible with OSF/1 in&n; * the process. I&squot;d like to clean it up for the i386 as well, but&n; * it&squot;s so painful recognizing both the new and the old numbers..&n; */
...
DECL|macro|_IOC
mdefine_line|#define _IOC(dir,type,nr,size)&t;&t;&t;&bslash;&n;&t;((unsigned int)&t;&t;&t;&t;&bslash;&n;&t; (((dir)  &lt;&lt; _IOC_DIRSHIFT) |&t;&t;&bslash;&n;&t;  ((type) &lt;&lt; _IOC_TYPESHIFT) |&t;&t;&bslash;&n;&t;  ((nr)   &lt;&lt; _IOC_NRSHIFT) |&t;&t;&bslash;&n;&t;  ((size) &lt;&lt; _IOC_SIZESHIFT)))
...
macro_line|#endif /* _ALPHA_IOCTL_H */
eof
