...
mdefine_line|#define T2_DMA_WIN_BASE_DEFAULT&t;(1024*1024*1024)
DECL|macro|T2_DMA_WIN_SIZE_DEFAULT
mdefine_line|#define T2_DMA_WIN_SIZE_DEFAULT&t;(1024*1024*1024)
macro_line|#if defined(CONFIG_ALPHA_GENERIC) || defined(CONFIG_ALPHA_SRM_SETUP)
DECL|macro|T2_DMA_WIN_BASE
mdefine_line|#define T2_DMA_WIN_BASE&t;&t;alpha_mv.dma_win_base
DECL|macro|T2_DMA_WIN_SIZE
mdefine_line|#define T2_DMA_WIN_SIZE&t;&t;alpha_mv.dma_win_size
macro_line|#else
DECL|macro|T2_DMA_WIN_BASE
mdefine_line|#define T2_DMA_WIN_BASE&t;&t;T2_DMA_WIN_BASE_DEFAULT
DECL|macro|T2_DMA_WIN_SIZE
mdefine_line|#define T2_DMA_WIN_SIZE&t;&t;T2_DMA_WIN_SIZE_DEFAULT
macro_line|#endif
...
c_func
(paren
l_string|&quot;T2: address 0x%lx not covered by HAE&bslash;n&quot;
comma
id|addr
)paren
suffix:semicolon
...
multiline_comment|/* ... which makes me wonder why we advertise we have DENSE memory at all.&n;   Anyway, guess that means we should emulate 64-bit access as two cycles.  */
DECL|function|t2_srm_readq
id|__EXTERN_INLINE
r_int
r_int
id|t2_srm_readq
...
DECL|macro|__readb
mdefine_line|#define __readb&t;&t;t2_srm_readb
DECL|macro|__readw
mdefine_line|#define __readw&t;&t;t2_srm_readw
DECL|macro|__readl
mdefine_line|#define __readl&t;&t;t2_srm_readl
DECL|macro|__readq
mdefine_line|#define __readq&t;&t;t2_srm_readq
DECL|macro|__writeb
mdefine_line|#define __writeb&t;t2_srm_writeb
DECL|macro|__writew
mdefine_line|#define __writew&t;t2_srm_writew
DECL|macro|__writel
mdefine_line|#define __writel&t;t2_srm_writel
DECL|macro|__writeq
mdefine_line|#define __writeq&t;t2_srm_writeq
macro_line|#else
DECL|macro|__readb
