...
mdefine_line|#define CIA_DMA_WIN_BASE_DEFAULT    (1024*1024*1024)
DECL|macro|CIA_DMA_WIN_SIZE_DEFAULT
mdefine_line|#define CIA_DMA_WIN_SIZE_DEFAULT    (1024*1024*1024)
r_extern
r_int
r_int
id|CIA_DMA_WIN_BASE
...
mdefine_line|#define CIA_DMA_WIN_BASE            (1024*1024*1024)
