macro_line|#ifndef _ALPHA_POSIX_TYPES_H
DECL|macro|_ALPHA_POSIX_TYPES_H
mdefine_line|#define _ALPHA_POSIX_TYPES_H
...
mdefine_line|#define&t;__FD_ZERO(set)&t;&bslash;&n;  ((void) memset ((__ptr_t) (set), 0, sizeof (__fd_set)))
