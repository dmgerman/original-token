multiline_comment|/* $Id: xwidget.h,v 1.1 2000/01/13 00:17:02 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * xwidget.h - generic crosstalk widget header file, derived from IRIX&n; * &lt;sys/xtalk/xtalkwidget.h&gt;, revision 1.32.&n; *&n; * Copyright (C) 1996, 1999 Silcon Graphics, Inc.&n; * Copyright (C) 1999 Ralf Baechle (ralf@gnu.org)&n; */
