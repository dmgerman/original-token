multiline_comment|/* $Id: sgimc.h,v 1.2 1999/12/04 03:59:13 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * sgimc.h: Definitions for memory controller hardware found on&n; *          SGI IP20, IP22, IP26, and IP28 machines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; * Copyright (C) 1999 Ralf Baechle&n; * Copyright (C) 1999 Silicon Graphics, Inc.&n; */
