multiline_comment|/* $Id: arch.h,v 1.2 2000/02/10 07:28:35 kanoj Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * SGI IP27 specific setup.&n; *&n; * Copyright (C) 1995 - 1997, 1999 Silcon Graphics, Inc.&n; * Copyright (C) 1999 Ralf Baechle (ralf@gnu.org)&n; */
...
mdefine_line|#define cputocnode(cpu)&t;&t;&t;&t;&bslash;&n;               (ASSERT(pdaindr[(cpu)].pda), (pdaindr[(cpu)].pda-&gt;p_nodeid))
DECL|macro|cputonasid
mdefine_line|#define cputonasid(cpu)&t;&t;&t;&t;&bslash;&n;               (ASSERT(pdaindr[(cpu)].pda), (pdaindr[(cpu)].pda-&gt;p_nasid))
...
mdefine_line|#define node_getnumslots(node)&t;(1)
DECL|macro|NODE_MAX_MEM_SIZE
mdefine_line|#define&t;NODE_MAX_MEM_SIZE&t;SLOT_SIZE * 1
macro_line|#else
DECL|macro|node_getnumslots
