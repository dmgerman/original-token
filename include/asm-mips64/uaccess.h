...
mdefine_line|#define __put_user_check(x,ptr,size) ({ &bslash;&n;long __pu_err; &bslash;&n;__typeof__(*(ptr)) __pu_val; &bslash;&n;long __pu_addr; &bslash;&n;__pu_val = (x); &bslash;&n;__pu_addr = (long) (ptr); &bslash;&n;__asm__(&quot;&quot;:&quot;=r&quot; (__pu_err)); &bslash;&n;if (__access_ok(__pu_addr,size,__access_mask)) { &bslash;&n;switch (size) { &bslash;&n;case 1: __put_user_asm(&quot;sb&quot;); break; &bslash;&n;case 2: __put_user_asm(&quot;sh&quot;); break; &bslash;&n;case 4: __put_user_asm(&quot;sw&quot;); break; &bslash;&n;case 8: __put_user_asm(&quot;sd&quot;); break; &bslash;&n;default: __put_user_unknown(); break; &bslash;&n;} } __pu_err; })
