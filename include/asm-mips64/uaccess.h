multiline_comment|/* $Id: uaccess.h,v 1.5 2000/02/21 18:05:07 ralf Exp $&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file &quot;COPYING&quot; in the main directory of this archive&n; * for more details.&n; *&n; * Copyright (C) 1996, 1997, 1998, 1999 by Ralf Baechle&n; * Copyright (C) 1999 Silicon Graphics, Inc.&n; */
...
mdefine_line|#define __put_user_nocheck(x,ptr,size) ({ &bslash;&n;long __pu_err; &bslash;&n;__typeof__(*(ptr)) __pu_val; &bslash;&n;long __pu_addr; &bslash;&n;__pu_val = (x); &bslash;&n;__pu_addr = (long) (ptr); &bslash;&n;__asm__(&quot;&quot;:&quot;=r&quot; (__pu_err)); &bslash;&n;switch (size) { &bslash;&n;case 1: __put_user_asm(&quot;sb&quot;); break; &bslash;&n;case 2: __put_user_asm(&quot;sh&quot;); break; &bslash;&n;case 4: __put_user_asm(&quot;sw&quot;); break; &bslash;&n;case 8: __put_user_asm(&quot;sd&quot;); break; &bslash;&n;default: __put_user_unknown(); break; &bslash;&n;} __pu_err; })
DECL|macro|__put_user_check
mdefine_line|#define __put_user_check(x,ptr,size,mask) ({ &bslash;&n;long __pu_err; &bslash;&n;__typeof__(*(ptr)) __pu_val; &bslash;&n;long __pu_addr; &bslash;&n;__pu_val = (x); &bslash;&n;__pu_addr = (long) (ptr); &bslash;&n;__asm__(&quot;&quot;:&quot;=r&quot; (__pu_err)); &bslash;&n;if (__access_ok(__pu_addr,size,mask)) { &bslash;&n;switch (size) { &bslash;&n;case 1: __put_user_asm(&quot;sb&quot;); break; &bslash;&n;case 2: __put_user_asm(&quot;sh&quot;); break; &bslash;&n;case 4: __put_user_asm(&quot;sw&quot;); break; &bslash;&n;case 8: __put_user_asm(&quot;sd&quot;); break; &bslash;&n;default: __put_user_unknown(); break; &bslash;&n;} } __pu_err; })
