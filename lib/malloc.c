...
multiline_comment|/*&n;&t; * Note that init_bucket_descriptor() does it&squot;s&n;&t; * own cli() before returning, and guarantees that&n;&t; * there is a bucket desc in the page.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
