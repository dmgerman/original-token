...
suffix:semicolon
multiline_comment|/*&n;&t; * Heisenbug Compensator(tm)&n;&t; * This bug shouldn&squot;t trigger, but for unknown reasons it&n;&t; * sometimes does. If there are no signs of list corruption,&n;&t; * we ignore the problem. Else we BUG()...&n;&t; */
r_if
c_cond
(paren
id|PageActive
...
c_func
(paren
l_string|&quot;VM: lru_cache_add, bit or list corruption..&bslash;n&quot;
)paren
suffix:semicolon
id|BUG
c_func
...
c_func
(paren
l_string|&quot;VM: lru_cache_add, page already in list!&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|page_already_on_list
suffix:semicolon
)brace
id|add_page_to_active_list
c_func
