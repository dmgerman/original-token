...
DECL|function|remove_from_mem_queue
r_static
r_int
r_int
...
c_func
(paren
l_string|&quot;nr_free_pages is %d, but no free memory found&bslash;n&quot;
comma
id|nr_free_pages
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;nr_secondary_pages is %d, but no free memory found&bslash;n&quot;
comma
id|nr_secondary_pages
)paren
suffix:semicolon
