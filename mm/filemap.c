...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Do the real work.. If the writer ends up delaying the write,&n;&t;&t; * the writer needs to increment the page use counts until he&n;&t;&t; * is done with the page.&n;&t;&t; */
id|bytes
op_sub_assign
id|copy_from_user
c_func
