...
multiline_comment|/*&n; * This should be a low-level fs-specific function (ie&n; * inode-&gt;i_op-&gt;readpage).&n; */
DECL|function|readpage
r_static
r_int
id|readpage
c_func
