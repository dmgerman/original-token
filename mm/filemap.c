...
DECL|macro|CLUSTER_SHIFT
mdefine_line|#define CLUSTER_SHIFT&t;&t;(PAGE_CACHE_SHIFT + page_cluster)
DECL|macro|CLUSTER_BYTES
mdefine_line|#define CLUSTER_BYTES&t;&t;(1 &lt;&lt; CLUSTER_SHIFT)
DECL|macro|CLUSTER_OFFSET
mdefine_line|#define CLUSTER_OFFSET(x)&t;(((x) &gt;&gt; CLUSTER_SHIFT) &lt;&lt; CLUSTER_SHIFT)
