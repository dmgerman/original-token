...
c_func
(paren
l_string|&quot;hm, busy page truncated? (not necesserily a bug)&bslash;n&quot;
)paren
suffix:semicolon
id|spin_unlock
c_func
...
id|address
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * It&squot;s worth dropping the write lock only at&n;&t;&t;&t; * this point. We are holding the page lock&n;&t;&t;&t; * so nobody can do anything bad to us.&n;&t;&t;&t; */
id|spin_unlock
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * we have dropped the lock so we have to&n;&t;&t;&t; * restart.&n;&t;&t;&t; */
r_goto
id|repeat
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/*&n;&t; * We might sleep here. Other processes might arrive and sleep on&n;&t; * the lock, but nobody is allowed to &squot;cross&squot; the lock and get a&n;&t; * reference to the page. We then remove the page from the hash&n;&t; * before unlocking it. This mechanizm ensures that 1) nobody gets&n;&t; * a half-freed page 2) nobody creates the same pagecache content&n;&t; * before we finish destroying this page. This is not a&n;&t; * performance problem as pages here are candidates for getting&n;&t; * freed, ie. it&squot;s supposed to be unlikely that the above situation&n;&t; * happens.&n;&t; */
r_if
c_cond
(paren
id|inode-&gt;i_op-&gt;flushpage
