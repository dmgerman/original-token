...
macro_line|#ifdef readahead_makes_sense_due_to_asynchronous_reads
id|offset
op_assign
(paren
id|offset
...
suffix:semicolon
multiline_comment|/* &n;&t; * And start IO on it..&n;&t; * (this should be asynchronous, but currently isn&squot;t)&n;&t; */
id|inode-&gt;i_op
op_member_access_from_pointer
id|readpage
c_func
...
multiline_comment|/*&n; * Find a cached page and wait for it to become up-to-date, return&n; * the page address.&n; */
