...
suffix:semicolon
multiline_comment|/*&n;&t; * The third argument is &quot;no_share&quot;, which tells the low-level code&n;&t; * to copy, not share the page even if sharing is possible.  It&squot;s&n;&t; * essentially an early COW detection.&n;&t; *&n;&t; * We need to grab the kernel lock for this..&n;&t; */
id|lock_kernel
c_func
(paren
)paren
