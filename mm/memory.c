...
(paren
id|KERN_ERR
l_string|&quot;Missing page in follow_page&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* &n; * Given a physical address, is there a useful struct page pointing to it?&n; */
...
multiline_comment|/*&n; * Force in an entire range of pages from the current process&squot;s user VA,&n; * and pin and lock the pages for IO.  &n; */
DECL|macro|dprintk
