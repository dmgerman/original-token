...
c_func
(paren
l_string|&quot;%s trying to clear NULL page-directory: not good&bslash;n&quot;
comma
id|tsk-&gt;comm
)paren
suffix:semicolon
...
multiline_comment|/*&n; * This function tries to find a page that is shared with the buffer cache,&n; * and if so it moves the buffer cache to a new location.&n; *&n; * It returns non-zero if we used up the &quot;new_page&quot; page.&n; */
DECL|function|unshare
r_static
r_int
id|unshare
c_func
...
c_func
(paren
l_string|&quot;Aieee... unshare(): no page available&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|PAGE_MASK
suffix:semicolon
multiline_comment|/* Ugh, here comes the _really_ ugly part.. */
r_if
c_cond
(paren
id|start
