...
id|end_wp_page
suffix:colon
multiline_comment|/*&n;&t;&t; * We can release the kernel lock now.. Now swap_out will see&n;&t;&t; * a dirty page and so won&squot;t get confused and flush_tlb_page&n;&t;&t; * won&squot;t SMP race. -Andrea&n;&t;&t; */
id|unlock_kernel
c_func
(paren
)paren
...
multiline_comment|/*&n; * This is called with the kernel lock held, we need&n; * to return without it.&n; */
