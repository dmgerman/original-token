...
id|map_nr
suffix:semicolon
multiline_comment|/*&n;&t; * We can avoid the copy if:&n;&t; * - we&squot;re the only user (count == 1)&n;&t; * - the only other user is the swap cache,&n;&t; *   and the only swap cache user is itself,&n;&t; *   in which case we can remove the page&n;&t; *   from the swap cache.&n;&t; */
r_switch
c_cond
(paren
id|page_count
...
c_func
(paren
l_string|&quot;do_wp_page: bogus page at address %08lx (nr %ld)&bslash;n&quot;
comma
id|address
comma
id|map_nr
