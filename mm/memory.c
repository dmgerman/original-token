...
multiline_comment|/* just share them.. */
id|mem_map
(braket
id|MAP_NR
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/* ok, need to mark it read-only, so invalidate aany possible old TB entry */
id|from
op_and_assign
op_complement
id|PAGE_RW
...
c_func
(paren
l_string|&quot; at kernel address %08lx&bslash;n&quot;
comma
id|address
)paren
suffix:semicolon
