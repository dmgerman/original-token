...
multiline_comment|/*&n; * We mark int dirty so the vm will not simply drop it&n; * The real work is done in shmem_writepage&n; */
DECL|function|shmem_swapout
r_int
id|shmem_swapout
c_func
(paren
...
id|out
suffix:semicolon
multiline_comment|/*&n;&t; * 1 means &quot;cannot write out&quot;.&n;&t; * We can&squot;t drop dirty pages&n;&t; * just because we ran out of&n;&t; * swap.&n;&t; */
id|error
op_assign
l_int|1
suffix:semicolon
