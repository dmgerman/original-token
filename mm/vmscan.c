...
(brace
multiline_comment|/* we just assigned swap_cnt, normalise values */
id|assign
op_assign
l_int|2
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/* small processes are swapped out less */
r_while
c_loop
(paren
(paren
...
id|i
suffix:semicolon
multiline_comment|/* if swap_cnt reaches 0 */
multiline_comment|/* we&squot;re big -&gt; hog treatment */
r_if
c_cond
(paren
op_logical_neg
