...
multiline_comment|/* The page is dirty, or locked, move to inactive_diry list. */
r_if
c_cond
(paren
id|page-&gt;buffers
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * Somebody else freed the bufferheads for us?&n;&t;&t;&t; * This really shouldn&squot;t happen, but we check&n;&t;&t;&t; * for it anyway.&n;&t;&t;&t; */
id|printk
c_func
(paren
l_string|&quot;VM: page_launder, found pre-cleaned page ?!&bslash;n&quot;
)paren
suffix:semicolon
id|UnlockPage
c_func
...
suffix:semicolon
multiline_comment|/* &n;&t;&t; * If we&squot;ve either completely gotten rid of the&n;&t;&t; * free page shortage or the inactive page shortage&n;&t;&t; * is getting low, then stop eating CPU time.&n;&t;&t; *&n;&t;&t; * We go to sleep for one second, but if it&squot;s needed&n;&t;&t; * we&squot;ll be woken up earlier...&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
