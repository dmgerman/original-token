...
id|want_wakeup
suffix:semicolon
multiline_comment|/*&n;&t; * Schedule for wakeup if there isn&squot;t lots&n;&t; * of free memory or if there is too much&n;&t; * of it used for buffers or pgcache.&n;&t; *&n;&t; * &quot;want_wakeup&quot; is our priority: 0 means&n;&t; * not to wake anything up, while 3 means&n;&t; * that we&squot;d better give kswapd a realtime&n;&t; * priority.&n;&t; */
id|want_wakeup
op_assign
l_int|0
suffix:semicolon
