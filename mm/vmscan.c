...
op_decrement
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Nonzero means we cleared out something, but only &quot;1&quot; means&n;&t;&t; * that we actually free&squot;d up a page as a result.&n;&t;&t; */
r_if
c_cond
(paren
id|swap_out_process
...
DECL|macro|free_memory
mdefine_line|#define free_memory(fn) &bslash;&n;&t;count++; do { if (!--count) goto done; } while (fn)
DECL|function|kswapd_free_pages
r_static
r_int
id|kswapd_free_pages
c_func
(paren
r_int
id|kswapd_state
...
suffix:semicolon
multiline_comment|/* max one hundreth of a second */
id|end_time
op_assign
id|jiffies
op_plus
...
suffix:semicolon
multiline_comment|/*&n;&t; * Set the base priority to something smaller than a&n;&t; * regular process. We will scale up the priority&n;&t; * dynamically depending on how much memory we need.&n;&t; */
id|current-&gt;priority
op_assign
(paren
id|DEF_PRIORITY
...
multiline_comment|/*&n; * Wake up kswapd according to the priority&n; *&t;0 - no wakeup&n; *&t;1 - wake up as a low-priority process&n; *&t;2 - wake up as a normal process&n; *&t;3 - wake up as an almost real-time process&n; *&n; * This plays mind-games with the &quot;goodness()&quot;&n; * function in kernel/sched.c.&n; */
DECL|function|kswapd_wakeup
r_static
r_inline
r_void
id|kswapd_wakeup
...
id|kswapd_task
suffix:semicolon
multiline_comment|/*&n;&t; * Only bother to try to wake kswapd up&n;&t; * if the task exists and can be woken.&n;&t; */
r_if
c_cond
(paren
id|p
...
id|want_wakeup
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Schedule for wakeup if there isn&squot;t lots&n;&t;&t; * of free memory or if there is too much&n;&t;&t; * of it used for buffers or pgcache.&n;&t;&t; *&n;&t;&t; * &quot;want_wakeup&quot; is our priority: 0 means&n;&t;&t; * not to wake anything up, while 3 means&n;&t;&t; * that we&squot;d better give kswapd a realtime&n;&t;&t; * priority.&n;&t;&t; */
id|want_wakeup
op_assign
l_int|0
suffix:semicolon
