...
id|tmo
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Wake up once a second to see if we need to make&n;&t;&t; * more memory available. When we get into a low&n;&t;&t; * memory situation, we start waking up more often.&n;&t;&t; *&n;&t;&t; * We consider &quot;freepages.low&quot; to be low on memory,&n;&t;&t; * but we also try to be aggressive if other processes&n;&t;&t; * are low on memory and would otherwise block when&n;&t;&t; * calling __get_free_page().&n;&t;&t; */
id|tmo
op_assign
id|HZ
suffix:semicolon
