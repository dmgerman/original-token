...
(brace
multiline_comment|/* &n;&t;&t; * We _will_ allow dirty cached mappings later on, once&n;&t;&t; * MAP_SHARED|MAP_ANONYMOUS is working, but for now&n;&t;&t; * catch this as a bug.&n;&t;&t; */
r_if
c_cond
(paren
id|is_page_shared
...
id|printk
(paren
l_string|&quot;VM: Found a shared writable dirty page!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Not good. We failed to free a page even though&n;&t;&t;&t; * we were synchronous. Complain and give up..&n;&t;&t;&t; */
id|printk
c_func
(paren
l_string|&quot;kswapd: failed to free page&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
