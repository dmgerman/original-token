...
suffix:semicolon
multiline_comment|/*&n;&t; * Hey, if somebody wants to kill us, be our guest. &n;&t; * Don&squot;t come running to mama if things don&squot;t work.&n;&t; */
id|siginitsetinv
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * kswapd isn&squot;t even meant to keep up with anything,&n;&t;&t; * so just a few pages per second is plenty: the only&n;&t;&t; * point is to make sure that the system doesn&squot;t stay&n;&t;&t; * forever in a really bad memory squeeze.&n;&t;&t; */
r_if
c_cond
(paren
id|nr_free_pages
