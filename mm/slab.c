...
macro_line|#if&t;(PAGE_SIZE != 8192 &amp;&amp; PAGE_SIZE != 4096 &amp;&amp; PAGE_SIZE != 16384 &amp;&amp; PAGE_SIZE != 32768)
...
multiline_comment|/* returns 0 if every slab is been freed -arca */
...
(paren
id|KERN_ERR
l_string|&quot;kmem_destroy: NULL ptr&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
(paren
id|KERN_ERR
l_string|&quot;kmem_destroy: Called during int - %s&bslash;n&quot;
comma
id|cachep-&gt;c_name
)paren
suffix:semicolon
...
id|cachep-&gt;c_nextp
suffix:semicolon
multiline_comment|/* remove the cachep from the cache_cache list. -arca */
id|prev-&gt;c_nextp
op_assign
id|cachep-&gt;c_nextp
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;kmem_destroy: Invalid cache addr %p&bslash;n&quot;
comma
id|cachep
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;kmem_destroy: Can&squot;t free all objects %p&bslash;n&quot;
comma
id|cachep
)paren
suffix:semicolon
