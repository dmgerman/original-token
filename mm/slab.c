...
suffix:semicolon
DECL|variable|slab_cache_drain_mask
r_int
r_int
id|slab_cache_drain_mask
suffix:semicolon
multiline_comment|/*&n; * Waits for all CPUs to execute slab_drain_local_cache().&n; * Caller must be holding cache_drain_sem.&n; */
DECL|function|slab_drain_all_sync
r_static
r_void
id|slab_drain_all_sync
c_func
(paren
r_void
)paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Called from per-cpu timer interrupt. */
DECL|function|slab_drain_local_cache
r_void
id|slab_drain_local_cache
c_func
(paren
