...
suffix:colon
macro_line|#if&t;SLAB_DEBUG_SUPPORT
multiline_comment|/* Need to poision the obj while holding the lock. */
r_if
c_cond
(paren
id|cachep-&gt;c_flags
...
id|red_zone
suffix:colon
multiline_comment|/* We hold the cache-lock while checking the red-zone, just incase&n;&t; * some tries to take this obj from us...&n;&t; */
r_if
c_cond
(paren
id|xchg
