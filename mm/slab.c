...
macro_line|#ifdef CONFIG_SMP
multiline_comment|/*&n; * called with local interrupts disabled&n; */
DECL|function|drain_cache
r_static
r_void
id|drain_cache
(paren
...
suffix:semicolon
multiline_comment|/*&n; * called with local interrupts disabled&n; */
DECL|function|ccupdate_callback
r_static
r_void
id|ccupdate_callback
(paren
r_void
op_star
id|__new
...
id|next
suffix:semicolon
multiline_comment|/* FIXME: is this really a good idea? */
r_if
c_cond
(paren
id|gfp_mask
