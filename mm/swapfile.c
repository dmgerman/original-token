...
id|new_swap_entry
suffix:semicolon
multiline_comment|/* We have the old entry in the page offset still */
r_if
c_cond
(paren
op_logical_neg
...
id|new_swap_entry
suffix:semicolon
multiline_comment|/* Has it been re-used for something else? */
id|swap_list_lock
c_func
(paren
)paren
...
r_goto
id|unlock_new_swap_entry
suffix:semicolon
multiline_comment|/* We&squot;re cool, we can just use the old one */
id|p-&gt;swap_map
(braket
id|offset
)braket
