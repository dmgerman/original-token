...
c_func
(paren
l_string|&quot;DebugVM: swap_free(entry %08lx, count now %d)&bslash;n&quot;
comma
id|entry
comma
id|p-&gt;swap_map
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Continue searching if the entry became unused.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|si-&gt;swap_map
...
(paren
id|KERN_ERR
l_string|&quot;try_to_unuse: entry %08lx count=%d&bslash;n&quot;
comma
id|entry
comma
id|si-&gt;swap_map
