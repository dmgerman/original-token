...
multiline_comment|/*&n; * If the swap count overflows (swap_map[] == 127), the entry is considered&n; * &quot;permanent&quot; and can&squot;t be reclaimed until the swap device is closed.&n; */
...
multiline_comment|/*&n; * The swap entry has been read in advance, and we return 1 to indicate&n; * that the page has been used or is no longer needed.&n; */
...
(brace
multiline_comment|/*&n;&t;&t;&t; * If we couldn&squot;t find an entry, there are several&n;&t;&t;&t; * possible reasons: someone else freed it first,&n;&t;&t;&t; * we freed the last reference to an overflowed entry,&n;&t;&t;&t; * or the system has lost track of the use counts.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|si-&gt;swap_map
...
c_func
(paren
l_string|&quot;try_to_unuse: entry %08lx &quot;
l_string|&quot;not in use&bslash;n&quot;
comma
id|entry
)paren
suffix:semicolon
