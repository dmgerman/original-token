...
suffix:semicolon
DECL|macro|MEM_TYPE_DMA
mdefine_line|#define MEM_TYPE_DMA&t;&t;0
DECL|macro|MEM_TYPE_NORMAL
mdefine_line|#define MEM_TYPE_NORMAL&t;&t;1
DECL|macro|MEM_TYPE_HIGH
mdefine_line|#define MEM_TYPE_HIGH&t;&t;2
DECL|variable|mem_type_strs
r_static
r_const
r_char
op_star
...
DECL|macro|NR_MEM_TYPES
mdefine_line|#define NR_MEM_TYPES&t;&t;3
macro_line|#else
DECL|macro|NR_MEM_TYPES
mdefine_line|#define NR_MEM_TYPES&t;&t;2
macro_line|#endif
