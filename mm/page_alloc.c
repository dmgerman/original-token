...
multiline_comment|/*&n;&t;&t; * Low priority (user) allocations must not&n;&t;&t; * succeed if we are having trouble allocating&n;&t;&t; * memory.&n;&t;&t; */
id|current-&gt;trashing_memory
op_assign
l_int|1
suffix:semicolon
