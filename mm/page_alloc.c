...
suffix:semicolon
multiline_comment|/* Are we reaching the critical stage? */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Not yet critical, so let kswapd handle it.. */
r_if
c_cond
(paren
id|z-&gt;free_pages
...
multiline_comment|/*&n;&t;&t; * In the atomic allocation case we only &squot;kick&squot; the&n;&t;&t; * state machine, but do not try to free pages&n;&t;&t; * ourselves.&n;&t;&t; */
id|tried
op_assign
l_int|1
suffix:semicolon
