...
DECL|macro|ZONE_BALANCED
mdefine_line|#define ZONE_BALANCED(zone) &bslash;&n;&t;(((zone)-&gt;free_pages &gt; (zone)-&gt;pages_low) &amp;&amp; (!(zone)-&gt;low_on_memory))
DECL|function|zone_balance_memory
r_static
r_inline
r_int
id|zone_balance_memory
(paren
id|zone_t
op_star
id|zone
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * In the atomic allocation case we only &squot;kick&squot; the&n;&t; * state machine, but do not try to free pages&n;&t; * ourselves.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n; * We are still balancing memory in a global way:&n; */
...
multiline_comment|/*&n;&t;&t;&t; * fastpath&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n; * The main chunk of the balancing code is in this offline branch:&n; */
id|balance
suffix:colon
r_if
c_cond
...
multiline_comment|/*&n; * Builds allocation fallback zone lists. We are basically ready&n; * to do NUMA-allocations, only this function has to be modified&n; * and the zonelists array be made per-CPU.&n; */
...
id|offset
suffix:semicolon
multiline_comment|/*&n;&t;&t; * It&squot;s unnecessery to balance the high memory zone&n;&t;&t; */
r_if
c_cond
(paren
id|j
