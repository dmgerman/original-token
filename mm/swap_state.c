...
c_func
(paren
l_string|&quot;Adding page cache to locked page&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;swap_cache: replacing non-empty entry&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|panic
(paren
l_string|&quot;Removing swap cache page with zero inode hash&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|panic
(paren
l_string|&quot;Removing swap cache page with wrong inode hash&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|panic
(paren
l_string|&quot;Removing swap cache from locked page&quot;
)paren
suffix:semicolon
...
id|panic
(paren
l_string|&quot;Removing page cache on unshared page&quot;
)paren
suffix:semicolon
