...
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME: copy sense, don&squot;t just assign pointer!!&n;&t; */
id|cgc-&gt;sense
op_assign
id|pc.sense
suffix:semicolon
