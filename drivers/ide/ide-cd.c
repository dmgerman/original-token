...
l_int|1
suffix:semicolon
multiline_comment|/* should be &quot;if multisession&quot;, but it does no harm. */
r_if
c_cond
(paren
id|ntracks
...
l_int|0
suffix:semicolon
multiline_comment|/* setup each minor to respond to a session */
id|minor
op_increment
suffix:semicolon
id|i
...
DECL|macro|__ACER50__
macro_line|#undef __ACER50__
macro_line|#ifdef __ACER50__
multiline_comment|/*&n; * the buffer struct used by ide_cdrom_get_capabilities()&n; */
DECL|struct|get_capabilities_buf
r_struct
id|get_capabilities_buf
(brace
DECL|member|pad
r_char
id|pad
...
id|cap
suffix:semicolon
multiline_comment|/* this is 4 bytes short of ATAPI standard */
DECL|member|extra_cap
r_char
id|extra_cap
(braket
l_int|4
...
suffix:semicolon
multiline_comment|/* Acer 50X needs the regulation size buffer */
)brace
suffix:semicolon
r_static
...
id|cgc
suffix:semicolon
multiline_comment|/*&n;&t; * Most drives don&squot;t care about the buffer size;&n;&t; * they return as much info as there&squot;s room for.&n;&t; * But some older drives (?) had trouble with the&n;&t; * standard size, preferring 4 bytes less.&n;&t; * And the modern Acer 50X rejects anything smaller&n;&t; * than the standard size.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* for all drives except Acer 50X */
r_do
(brace
...
(brace
multiline_comment|/*&n;&t;&t;&t; * The ACER/AOpen 24X cdrom has the speed&n;&t;&t;&t; * fields byte-swapped from the standard.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
macro_line|#ifndef __ACER50__
multiline_comment|/* Now with that done, update the speed fields */
r_do
(brace
multiline_comment|/* we seem to get stat=0x01,err=0x00 the first time (??) */
r_if
...
c_cond
(paren
id|buf.cap.dvd_ram_read
op_logical_or
id|buf.cap.dvd_r_read
op_logical_or
id|buf.cap.dvd_rom
)paren
id|CDROM_CONFIG_FLAGS
