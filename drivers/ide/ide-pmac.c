...
mdefine_line|#define IDE_SYSCLK_NS&t;30
...
r_return
suffix:semicolon
multiline_comment|/* The &quot;ata-4&quot; IDE controller of UMA machines is a bit different.&n;&t; * We don&squot;t do anything for PIO modes until we know how to do the&n;&t; * calculation.&n;&t; */
r_if
c_cond
(paren
id|pmac_ide
...
l_int|2
suffix:colon
multiline_comment|/* This one exists only for KL, I don&squot;t know about any&n;&t;&t;&t;    &t;   enable bit */
id|feature_set
c_func
(paren
id|np
...
id|drive-&gt;id
suffix:semicolon
multiline_comment|/* For now, we don&squot;t know these values */
r_if
c_cond
(paren
id|pmac_ide
...
id|timings
suffix:semicolon
multiline_comment|/* We support only those values */
r_if
c_cond
(paren
id|feature
...
multiline_comment|/* Put this channel into UDMA mode.&n;&t; * This value is set by MacOS on the iBook for U/DMA2&n;&t; */
r_switch
c_cond
(paren
id|feature
