multiline_comment|/*&n; * linux/drivers/ide/hpt366.c&t;&t;Version 0.17&t;Mar. 18, 2000&n; *&n; * Copyright (C) 1999-2000&t;&t;Andre Hedrick &lt;andre@suse.com&gt;&n; * May be copied or modified under the terms of the GNU General Public License&n; *&n; * Thanks to HighPoint Technologies for their assistance, and hardware.&n; * Special Thanks to Jon Burchmore in SanDiego for the deep pockets, his&n; * donation of an ABit BP6 mainboard, processor, and memory acellerated&n; * development and support.&n; */
...
l_int|0
suffix:semicolon
DECL|function|pci_rev_check_hpt366
r_static
r_int
r_int
id|pci_rev_check_hpt366
(paren
r_struct
id|pci_dev
op_star
