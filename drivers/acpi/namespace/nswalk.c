multiline_comment|/******************************************************************************&n; *&n; * Module Name: nswalk - Functions for walking the APCI namespace&n; *&n; *****************************************************************************/
...
c_cond
(paren
id|parent-&gt;child_table
)paren
(brace
id|this_entry
op_assign
id|parent-&gt;child_table-&gt;entries
suffix:semicolon
)brace
)brace
r_else
...
(brace
multiline_comment|/* Make sure this is valid entry first */
r_if
c_cond
(paren
(paren
...
id|level
suffix:semicolon
multiline_comment|/* Special case for the namespace root object */
r_if
c_cond
(paren
id|start_object
