...
suffix:semicolon
multiline_comment|/*&n;&t; * Install the default Op_region handlers, ignore the return&n;&t; * code right now.&n;&t; */
...
multiline_comment|/* TBD: [Investigate] Check for both forward and backslash?? */
r_if
c_cond
(paren
id|STRCMP
