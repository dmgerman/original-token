multiline_comment|/******************************************************************************&n; *&n; * Module Name: psargs - Parse AML opcode arguments&n; *              $Revision: 35 $&n; *&n; *****************************************************************************/
...
id|u32
DECL|function|acpi_ps_pkg_length_encoding_size
id|acpi_ps_pkg_length_encoding_size
(paren
id|u32
id|first_byte
)paren
(brace
multiline_comment|/*&n;&t; * Bits 6-7 contain the number of bytes&n;&t; * in the encoded package length (-1)&n;&t; */
r_return
(paren
(paren
id|first_byte
...
id|u32
DECL|function|xxx_acpi_ps_get_next_package_length
id|xxx_acpi_ps_get_next_package_length
(paren
id|ACPI_PARSE_STATE
op_star
id|parser_state
