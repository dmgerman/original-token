multiline_comment|/******************************************************************************&n; *&n; * Module Name: psparse - Parser top level AML parse routines&n; *              $Revision: 51 $&n; *&n; *****************************************************************************/
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Check if we need to replace the operator and its subtree&n;&t;&t;&t; * with a return value op&n;&t;&t;&t; */
id|parent_info
op_assign
id|acpi_ps_get_opcode_info
(paren
...
id|AE_CTRL_TRUE
suffix:colon
multiline_comment|/*&n;&t;&t;&t; * Predicate of an IF was true, and we are at the matching ELSE.&n;&t;&t;&t; * Just close out this package&n;&t;&t;&t; *&n;&t;&t;&t; * Parser_state-&gt;Aml is modified by the package length procedure&n;&t;&t;&t; */
id|parser_state-&gt;aml
op_assign
(paren
id|parser_state-&gt;aml
