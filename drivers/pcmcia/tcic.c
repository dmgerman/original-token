...
id|version
op_assign
l_string|&quot;tcic.c 1.104 1999/08/28 04:01:46 (David Hinds)&quot;
suffix:semicolon
DECL|macro|DEBUG
...
suffix:semicolon
DECL|macro|NFUNC
mdefine_line|#define NFUNC (sizeof(service_table)/sizeof(subfn_t))
DECL|function|tcic_service
r_static
r_int
id|tcic_service
c_func
...
l_int|2
comma
l_string|&quot;tcic_service(%d, %d, 0x%p)&bslash;n&quot;
comma
id|lsock
comma
id|cmd
