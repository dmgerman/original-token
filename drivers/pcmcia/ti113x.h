...
multiline_comment|/*&n; * Generic TI open - TI has an extension for the&n; * INTCTL register that sets the PCI CSC interrupt.&n; * Make sure we set it correctly at open and init&n; * time.&n; */
