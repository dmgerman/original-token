...
id|version
op_assign
l_string|&quot;cs.c 1.224 1999/08/28 04:01:45 (David Hinds)&quot;
suffix:semicolon
macro_line|#endif
...
multiline_comment|/*======================================================================&n;&n;    Reset a socket to the default state&n;    &n;======================================================================*/
...
comma
(paren
l_string|&quot;cs: shutdown_socket(%ld)&bslash;n&quot;
comma
id|i
)paren
)paren
...
comma
(paren
l_string|&quot;cs: setup_socket(%ld): applying power&bslash;n&quot;
comma
id|i
)paren
)paren
...
(paren
id|KERN_NOTICE
l_string|&quot;cs: socket %ld: unsupported &quot;
...
comma
(paren
l_string|&quot;cs: setup_socket(%ld): no card!&bslash;n&quot;
comma
id|i
)paren
)paren
...
comma
(paren
l_string|&quot;cs: resetting socket %ld&bslash;n&quot;
comma
id|i
)paren
)paren
...
comma
(paren
l_string|&quot;cs: reset done on socket %ld&bslash;n&quot;
comma
id|i
)paren
)paren
...
(paren
id|KERN_NOTICE
l_string|&quot;cs: socket %ld timed out during&quot;
...
suffix:semicolon
multiline_comment|/* If there was or is a card here, we need to do something&n;&t;       about it... but parse_events will sort it all out. */
r_if
c_cond
(paren
(paren
