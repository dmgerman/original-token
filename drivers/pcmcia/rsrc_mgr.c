...
id|resource_entry_t
suffix:semicolon
multiline_comment|/* Ordered linked lists of allocated IO and memory blocks */
DECL|variable|io_list
r_static
id|resource_entry_t
id|io_list
op_assign
...
suffix:semicolon
macro_line|#ifndef HAVE_MEMRESERVE
...
DECL|function|register_my_resource
r_static
r_int
id|register_my_resource
c_func
(paren
id|resource_entry_t
op_star
...
DECL|function|release_my_resource
r_static
r_void
id|release_my_resource
c_func
(paren
id|resource_entry_t
op_star
...
DECL|function|check_my_resource
r_static
r_int
id|check_my_resource
c_func
(paren
id|resource_entry_t
op_star
...
DECL|function|request_io_region
r_void
id|request_io_region
c_func
(paren
id|u_long
id|base
...
DECL|function|release_io_region
r_void
id|release_io_region
c_func
(paren
id|u_long
id|base
...
multiline_comment|/*======================================================================&n;&n;    These find ranges of I/O ports or memory addresses that are not&n;    currently allocated by other devices.&n;    &n;======================================================================*/
