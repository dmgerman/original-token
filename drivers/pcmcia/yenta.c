...
multiline_comment|/*&n; * Many chipsets (all TI chips?) seem to have&n; * problems sensing the power state of the card&n; * that was inserted at chip init time, so force&n; * it if necessary..&n; */
DECL|function|yenta_power_sense
r_static
r_void
id|yenta_power_sense
c_func
(paren
id|pci_socket_t
op_star
...
suffix:semicolon
multiline_comment|/*&n;&t; * Nothing inserted, nothing to sense..&n;&t; * ..or sense status already available.&n;&t; */
r_if
c_cond
(paren
id|status
...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * Ho humm. It reports a card, but it doesn&squot;t report&n;&t; * any voltages. Need to redo the VS test..&n;&t; */
id|cb_writel
c_func
(paren
id|socket
