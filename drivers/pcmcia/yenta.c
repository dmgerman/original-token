...
suffix:semicolon
multiline_comment|/* Set the IO interrupt and socket state */
id|reg
op_assign
id|state-&gt;io_irq
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Set host interrupt and CSC mask state */
id|reg
op_assign
id|socket-&gt;cb_irq
op_lshift
...
suffix:semicolon
multiline_comment|/*&n;&t; * Set power state..&n;&t; *&n;&t; * I wonder if we could do the Vcc/Vpp part through the&n;&t; * CB interface only..&n;&t; */
id|reg
op_assign
id|I365_PWR_NORESET
suffix:semicolon
