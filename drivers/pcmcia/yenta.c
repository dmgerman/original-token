...
id|socket-&gt;cb_irq
suffix:semicolon
multiline_comment|/* Uhhuh. Try falling back on ISA interrupts */
id|printk
c_func
(paren
l_string|&quot;CardBus: Hmm.. Bad PCI irq routing (irq%d)&bslash;n&quot;
comma
id|socket-&gt;cb_irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;dev=%p, bus=%p, parent=%p&bslash;n&quot;
comma
id|socket-&gt;dev
comma
id|bus
...
c_func
(paren
l_string|&quot;res = %p, bus-&gt;res = %p&bslash;n&quot;
comma
id|res
comma
id|bus-&gt;resource
