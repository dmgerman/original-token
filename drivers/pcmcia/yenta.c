...
multiline_comment|/*&n; * Watch a socket every second (and possibly in a&n; * more timely manner if the state change interrupt&n; * works..)&n; */
DECL|function|socket_thread
r_static
r_int
id|socket_thread
c_func
