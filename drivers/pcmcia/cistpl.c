...
l_int|3
comma
l_string|&quot;cs:  %#2.2x %#2.2x %#2.2x %#2.2x %#2.2x ...&bslash;n&quot;
comma
id|bus_readb
c_func
(paren
...
id|CS_SUCCESS
suffix:semicolon
multiline_comment|/* First tuple should be DEVICE */
r_if
c_cond
(paren
id|tuple.TupleCode
...
op_increment
suffix:semicolon
multiline_comment|/* All cards should have a MANFID tuple */
r_if
c_cond
(paren
id|read_tuple
...
op_increment
suffix:semicolon
multiline_comment|/* All cards should have either a VERS_1 or a VERS_2 tuple.  But&n;       at worst, we&squot;ll accept a CFTABLE_ENTRY that parses. */
r_if
c_cond
(paren
(paren
