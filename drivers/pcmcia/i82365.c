...
id|version
op_assign
l_string|&quot;i82365.c $Revision: 1.249 $ $Date: 1999/08/28 04:01:46 $ (David Hinds)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
multiline_comment|/* Set up interrupt handler, and/or polling */
macro_line|#ifdef CONFIG_ISA
r_if
c_cond
(paren
...
multiline_comment|/* pcic_init */
multiline_comment|/*====================================================================*/
DECL|function|pcic_finish
r_static
r_void
id|pcic_finish
c_func
...
multiline_comment|/*====================================================================*/
DECL|function|pcmcia_i82365_init
r_int
