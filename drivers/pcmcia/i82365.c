...
id|version
op_assign
l_string|&quot;i82365.c 1.254 1999/09/15 15:32:19 (David Hinds)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
l_int|1
suffix:semicolon
multiline_comment|/* Default memory base address for CardBus controllers */
DECL|variable|cb_mem_base
r_static
id|u_int
id|cb_mem_base
(braket
...
macro_line|#endif
macro_line|#ifndef PCI_VENDOR_ID_OMEGA
DECL|macro|PCI_VENDOR_ID_OMEGA
mdefine_line|#define PCI_VENDOR_ID_OMEGA&t;&t;0x119b
macro_line|#endif
macro_line|#ifndef PCI_DEVICE_ID_OMEGA_PCMCIA
...
multiline_comment|/* speed_convert */
DECL|function|to_ns
r_static
r_int
id|to_ns
...
c_func
(paren
l_string|&quot; PCI-to-CardBus at bus %d slot %d, mem 0x%08x&quot;
comma
id|t-&gt;bus
comma
id|PCI_SLOT
...
c_func
(paren
l_string|&quot; PCI-to-PCMCIA at bus %d slot %d, port %#x&quot;
comma
id|t-&gt;bus
comma
id|PCI_SLOT
...
id|max
suffix:semicolon
multiline_comment|/* PCI bus enumeration is broken on some systems */
r_for
c_loop
(paren
id|ns
...
id|r
suffix:semicolon
multiline_comment|/* Check for power management capabilities */
id|pci_readb
c_func
(paren
id|bus
...
multiline_comment|/* If capability exists, make sure we&squot;re in D0 state */
r_if
c_cond
(paren
id|s-&gt;pmcs
...
suffix:semicolon
multiline_comment|/* Simple sanity checks */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_NOTICE
l_string|&quot;  Bridge register mapping failed:&quot;
l_string|&quot; check cb_mem_base setting&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
suffix:semicolon
DECL|variable|pcic_service_table
r_static
id|subfn_t
id|pcic_service_table
(braket
)braket
op_assign
(brace
...
suffix:semicolon
DECL|macro|NFUNC
mdefine_line|#define NFUNC (sizeof(pcic_service_table)/sizeof(subfn_t))
DECL|function|pcic_service
r_static
r_int
id|pcic_service
c_func
...
multiline_comment|/* pcic_service */
multiline_comment|/*====================================================================*/
