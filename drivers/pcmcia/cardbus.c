...
(brace
multiline_comment|/* Unset resource address, assign new one! */
id|res-&gt;end
op_sub_assign
id|res-&gt;start
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * If we have a PCI interrupt for the bridge,&n;&t; * then use that..&n;&t; */
id|irq
op_assign
id|s-&gt;cap.pci_irq
suffix:semicolon
