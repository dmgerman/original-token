multiline_comment|/* $Id: pcikbd.c,v 1.3 1997/09/04 05:50:35 ecd Exp $&n; * pcikbd.c: Ultra/AX PC keyboard support.&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; *&n; * This code is mainly put together from various places in&n; * drivers/char, please refer to these sources for credits&n; * to the original authors.&n; */
...
DECL|function|pcikbd_pretranslate
r_int
...
id|status
suffix:semicolon
multiline_comment|/*&n;&t; * This IRQ might be shared with the 16550A serial chip,&n;&t; * so we check dev_id to see if it was for us.&n;&t; * (See also drivers/sbus/char/su.c).&n;&t; */
r_if
c_cond
(paren
id|dev_id
...
r_return
suffix:semicolon
multiline_comment|/* kbd_pt_regs = regs; */
id|status
op_assign
id|inb
c_func
...
(brace
multiline_comment|/* handle_scancode(scancode) */
suffix:semicolon
)brace
id|status
op_assign
...
c_func
(paren
l_string|&quot;pcikbd_init: no 8042 found&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;8042: can&squot;t get property &squot;%s&squot; from &squot;%s&squot;&bslash;n&quot;
comma
l_string|&quot;reg&quot;
comma
l_string|&quot;kb_ps2&quot;
...
c_func
(paren
l_string|&quot;8042: can&squot;t get region %lx, %d&bslash;n&quot;
comma
id|pcikbd_iobase
comma
(paren
...
mdefine_line|#define PSMOUSE_MINOR      1&t;&t;/* Minor device # for this mouse */
