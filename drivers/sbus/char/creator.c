...
c_func
(paren
l_string|&quot;TYPE %d DAC %d&bslash;n&quot;
comma
id|type
comma
id|ffbinfo-&gt;dac_rev
...
suffix:semicolon
DECL|macro|FFB_BLITC_START
mdefine_line|#define FFB_BLITC_START(attr) &bslash;&n;&t;{ &bslash;&n;&t;&t;register struct ffb_fbc *ffb = fbinfo[0].info.ffb.fbc; &bslash;&n;&t;&t;register u32 *clut = fbinfo[0].info.ffb.clut; &bslash;&n;&t;&t;int i; &bslash;&n;&t;&t;ffb-&gt;ppc = 0x203; &bslash;&n;&t;&t;ffb-&gt;fg = clut[attr &amp; 0xf]; &bslash;&n;&t;&t;ffb-&gt;fbc = 0x2000707f; &bslash;&n;&t;&t;ffb-&gt;rop = 0x83; &bslash;&n;&t;&t;ffb-&gt;pmask = 0xffffffff; &bslash;&n;&t;&t;ffb-&gt;bg = clut[attr&gt;&gt;4];
DECL|macro|FFB_BLITC_BODY4
mdefine_line|#define FFB_BLITC_BODY4(count,x,y,start,action) &bslash;&n;&t;&t;while (count &gt;= 4) { &bslash;&n;&t;&t;&t;count -= 4; &bslash;&n;&t;&t;    &t;ffb-&gt;fontw = 32; &bslash;&n;&t;&t;    &t;ffb-&gt;fontinc = 0x10000; &bslash;&n;&t;&t;    &t;ffb-&gt;fontxy = (y &lt;&lt; 16) + x; &bslash;&n;&t;&t;    &t;x += 32; &bslash;&n;&t;&t;    &t;start; &bslash;&n;&t;&t;    &t;for (i = 0; i &lt; CHAR_HEIGHT; i++) { &bslash;&n;&t;&t;    &t;&t;action; &bslash;&n;&t;&t;    &t;} &bslash;&n;&t;&t;}
DECL|macro|FFB_BLITC_BODY1
mdefine_line|#define FFB_BLITC_BODY1(x,y,action) &bslash;&n;&t;&t;    &t;ffb-&gt;fontw = 8; &bslash;&n;&t;&t;    &t;ffb-&gt;fontinc = 0x10000; &bslash;&n;&t;&t;    &t;ffb-&gt;fontxy = (y &lt;&lt; 16) + x; &bslash;&n;&t;&t;    &t;x += 8; &bslash;&n;&t;&t;    &t;for (i = 0; i &lt; CHAR_HEIGHT; i++) { &bslash;&n;&t;&t;    &t;&t;action; &bslash;&n;&t;&t;    &t;}
DECL|macro|FFB_BLITC_END
mdefine_line|#define FFB_BLITC_END &bslash;&n;&t;}
...
macro_line|#if 0
mdefine_line|#define FFB_FILL_START(attr) &bslash;&n;&t;{ &bslash;&n;&t;&t;register struct ffb_fbc *ffb = fbinfo[0].info.ffb.fbc; &bslash;&n;&t;&t;register u32 *clut = fbinfo[0].info.ffb.clut; &bslash;&n;&t;&t;ffb-&gt;ppc =0x1803; &bslash;&n;&t;&t;ffb-&gt;fg = clut[attr &amp; 0xf]; &bslash;&n;&t;&t;ffb-&gt;fbc = 0x2000707f; &bslash;&n;&t;&t;ffb-&gt;rop = 0x83; &bslash;&n;&t;&t;ffb-&gt;pmask = 0xffffffff; &bslash;&n;&t;&t;ffb-&gt;unk2 = 8;
mdefine_line|#define FFB_FILL_END &bslash;&n;&t;}
macro_line|#else
DECL|macro|FFB_FILL_START
mdefine_line|#define FFB_FILL_START(attr) &bslash;&n;&t;{ &bslash;&n;&t;&t;register struct ffb_fbc *ffb = fbinfo[0].info.ffb.fbc; &bslash;&n;&t;&t;ffb-&gt;ppc = 0x1803; &bslash;&n;&t;&t;ffb-&gt;fg = 0; &bslash;&n;&t;&t;ffb-&gt;fbc = 0x2000707f; &bslash;&n;&t;&t;ffb-&gt;rop = 0x83; &bslash;&n;&t;&t;ffb-&gt;pmask = 0xffffffff; &bslash;&n;&t;&t;ffb-&gt;unk2 = 8;
DECL|macro|FFB_FILL_END
mdefine_line|#define FFB_FILL_END &bslash;&n;&t;}
macro_line|#endif&t;
