...
suffix:semicolon
multiline_comment|/* (1152 * CHAR_HEIGHT) == 10010000000.0000 */
r_return
id|skip_bytes
op_plus
(paren
...
suffix:semicolon
multiline_comment|/* (1280 * CHAR_HEIGHT) == 10100000000.0000 */
r_return
id|skip_bytes
op_plus
(paren
...
id|prom_printf
(paren
l_string|&quot;console: unknown video resolution %dx%d, depth %d&bslash;n&quot;
comma
id|con_width
comma
id|con_height
...
c_cond
(paren
id|cursor-&gt;cmap.index
op_logical_and
id|cursor-&gt;cmap.count
op_ne
l_int|2
)paren
r_return
