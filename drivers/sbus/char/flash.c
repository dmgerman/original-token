multiline_comment|/* $Id: flash.c,v 1.10 1998/08/26 10:29:41 davem Exp $&n; * flash.c: Allow mmap access to the OBP Flash, for OBP updates.&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; */
