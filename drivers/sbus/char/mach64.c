...
(brace
multiline_comment|/*&n;&t;&t; * Fix the PROM&squot;s idea of MEM_CNTL settings...&n;&t;&t; */
id|tmp
op_assign
id|pcivga_readl
c_func
...
id|tmp
op_amp
id|MEM_SIZE_ALIAS_GTB
)paren
(brace
r_case
id|MEM_SIZE_512K_GTB
suffix:colon
id|mach64.total_vram
op_assign
l_int|0x80000
...
c_func
(paren
l_string|&quot;mach64_init: chip_type[%04x], total_vram[%08x]&bslash;n&quot;
comma
id|mach64.chip_type
comma
id|mach64.total_vram
