...
id|pcikbd_irq
suffix:semicolon
multiline_comment|/*&n; *&t;Keyboard Controller Registers&n; *&n; * NOTE: These are offsets from pcikbd_iobase, not absolute.&n; */
DECL|macro|KBD_STATUS_REG
mdefine_line|#define KBD_STATUS_REG&t;&t;0x04
DECL|macro|KBD_CNTL_REG
mdefine_line|#define KBD_CNTL_REG&t;&t;KBD_STATUS_REG
DECL|macro|KBD_DATA_REG
mdefine_line|#define KBD_DATA_REG&t;&t;0x00
