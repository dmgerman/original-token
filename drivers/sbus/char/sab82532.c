multiline_comment|/* $Id: sab82532.c,v 1.4 1997/09/03 17:04:21 ecd Exp $&n; * sab82532.c: ASYNC Driver for the SIEMENS SAB82532 DUSCC.&n; *&n; * Copyright (C) 1997  Eddie C. Dost  (ecd@skynet.be)&n; *&n; */
...
c_func
(paren
l_string|&quot;%s: SAB82532 at 0x%lx IRQ %x&bslash;n&quot;
comma
id|__FUNCTION__
comma
...
multiline_comment|/* Hooks for running a serial console. con_init() calls this if the&n; * console is run over one of the ttya/ttyb serial ports.&n; * &squot;chip&squot; should be zero, as for now we only have one chip on board.&n; * &squot;line&squot; is decoded as 0=ttya, 1=ttyb.&n; */
r_void
DECL|function|sab82532_cons_hook
id|sab82532_cons_hook
c_func
(paren
r_int
id|chip
...
c_func
(paren
l_string|&quot;sab82532: serial console is not implemented, yet&bslash;n&quot;
)paren
suffix:semicolon
id|prom_halt
c_func
...
(paren
id|KERN_INFO
l_string|&quot;ttyS%02d at 0x%lx (irq = %x) is a %s&bslash;n&quot;
comma
id|info-&gt;line
comma
(paren
