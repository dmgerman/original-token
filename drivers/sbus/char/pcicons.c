multiline_comment|/* $Id: pcicons.c,v 1.13 1998/04/01 06:55:11 ecd Exp $&n; * pcicons.c: PCI specific probing and console operations layer.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
