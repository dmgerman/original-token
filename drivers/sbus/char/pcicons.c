multiline_comment|/* $Id: pcicons.c,v 1.9 1997/08/28 02:23:24 ecd Exp $&n; * pcicons.c: PCI specific probing and console operations layer.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
...
l_int|1
suffix:semicolon
DECL|variable|pci_cursor_timer
r_static
r_struct
id|timer_list
id|pci_cursor_timer
...
DECL|function|pci_cursor_blink
r_static
r_void
id|pci_cursor_blink
c_func
