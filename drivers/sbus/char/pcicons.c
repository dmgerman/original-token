multiline_comment|/* $Id: pcicons.c,v 1.10 1997/10/04 08:52:57 ecd Exp $&n; * pcicons.c: PCI specific probing and console operations layer.&n; *&n; * Copyright (C) 1997 David S. Miller (davem@caip.rutgers.edu)&n; */
