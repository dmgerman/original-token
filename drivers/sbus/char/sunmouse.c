...
DECL|variable|mouse_bogon_bytes
r_static
r_int
id|mouse_bogon_bytes
op_assign
l_int|0
suffix:semicolon
DECL|variable|mouse_baud_changing
r_static
r_int
id|mouse_baud_changing
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* For reporting things to the user. */
...
(brace
multiline_comment|/* Push dummy 4th and 5th byte for last txn */
id|push_char
c_func
(paren
l_int|0x0
