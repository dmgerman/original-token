multiline_comment|/* $Id: zs.c,v 1.45 1999/09/01 08:09:35 davem Exp $&n; * zs.c: Zilog serial port driver for the Sparc.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996 Eddie C. Dost   (ecd@skynet.be)&n; * Fixes by Pete A. Zaitcev &lt;zaitcev@metabyte.com&gt;.&n; */
...
DECL|macro|ZS_WSYNC
mdefine_line|#define ZS_WSYNC(channel) &bslash;&n;&t;((void) *((volatile unsigned char *)(&amp;((channel)-&gt;control))))
macro_line|#endif
