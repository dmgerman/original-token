multiline_comment|/* $Id: zs.c,v 1.32 1998/11/08 11:15:29 davem Exp $&n; * zs.c: Zilog serial port driver for the Sparc.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; * Copyright (C) 1996 Eddie C. Dost   (ecd@skynet.be)&n; * Fixes by Pete A. Zaitcev &lt;zaitcev@metabyte.com&gt;.&n; */
...
id|central_node
suffix:semicolon
multiline_comment|/* Central bus zilogs must be checked for first,&n;&t;&t; * since Enterprise boxes have SBUS as well.&n;&t;&t; */
id|central_node
op_assign
id|prom_finddevice
c_func
