...
mdefine_line|#define SUNKBD_LOUT_TYP4    0x00
DECL|macro|SUNKBD_LOUT_TYP5
mdefine_line|#define SUNKBD_LOUT_TYP5    0x22
...
id|KIOCCMD
suffix:colon
multiline_comment|/* Need to support beep on/off, keyclick on/off */
r_return
l_int|0
suffix:semicolon
r_case
