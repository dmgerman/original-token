...
multiline_comment|/*&n; * This is TRUE if the module_init successfully loaded the module.&n; */
macro_line|#if 0
r_static
r_int
id|loaded_flag
...
id|regs
suffix:semicolon
multiline_comment|/* Apply ranges to here, do not pollute Sbus devices list. */
r_struct
...
multiline_comment|/** prom_apply_sbus_ranges (&amp;areg, 1); **/
id|regs
op_assign
id|sparc_alloc_io
(paren
