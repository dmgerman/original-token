...
suffix:semicolon
multiline_comment|/* NOTE: The read register 3, which holds the irq status,&n;&t;&t; *       does so for both channels on each chip.  Although&n;&t;&t; *       the status value itself must be read from the A&n;&t;&t; *       channel and is only valid when read from channel A.&n;&t;&t; *       Yes... broken hardware...&n;&t;&t; */
...
multiline_comment|/* Probe the PROM for the request zs chip number.&n; *&n; * Note: The Sun Voyager shows two addresses and two intr for it&squot;s&n; *       Zilogs, what the second does, I don&squot;t know. It does work&n; *       with using only the first number of each property.&n; */
