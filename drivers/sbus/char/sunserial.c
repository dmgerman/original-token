multiline_comment|/* serial.c: Serial port driver for the Sparc.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; */
...
mdefine_line|#define NUM_SERIAL 2     /* Two chips on board. */
...
mdefine_line|#define SUNKBD_RESET   0xff
DECL|macro|SUNKBD_L1
mdefine_line|#define SUNKBD_L1      0x01
DECL|macro|SUNKBD_UP
mdefine_line|#define SUNKBD_UP      0x80
DECL|macro|SUNKBD_A
mdefine_line|#define SUNKBD_A       0x4d
r_extern
r_void
id|sunkbd_inchar
c_func
...
suffix:semicolon
multiline_comment|/* Clear the line and continue execution... */
id|rs_recv_clear
c_func
(paren
id|info-&gt;zs_channel
...
suffix:semicolon
multiline_comment|/* *** Chip 2 *** */
multiline_comment|/* Channel A -- /dev/kbd, pass communication to keyboard driver */
r_if
c_cond
(paren
id|zs_intreg
...
id|info-&gt;zs_next
suffix:semicolon
multiline_comment|/* Channel B -- /dev/mouse, pass communication to mouse driver */
r_if
c_cond
(paren
id|zs_intreg
...
c_func
(paren
l_string|&quot;Sparc Zilog8530 serial driver version 1.00&bslash;n&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/* Probe the PROM for the request zs chip number. */
...
suffix:semicolon
macro_line|#ifdef OLD_STYLE_IRQ
id|tmp_irq.pri
op_and_assign
l_int|0xf
suffix:semicolon
...
c_func
(paren
l_string|&quot;not doing rs_init()&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(brace
multiline_comment|/* Tell keyboard driver about our presence. */
r_if
c_cond
(paren
id|zs_soft
...
c_func
(paren
l_string|&quot;Weird keyboard serial baud rate&quot;
)paren
suffix:semicolon
)brace
id|zs_soft
...
(brace
multiline_comment|/* Tell mouse driver about our presence. */
r_if
c_cond
(paren
id|zs_soft
...
c_func
(paren
l_string|&quot;Weird mouse serial baud rate&quot;
)paren
suffix:semicolon
)brace
id|zs_soft
...
suffix:semicolon
macro_line|#if 0 /* XXX hangs sun4c&squot;s sometimes */
id|write_zsreg
c_func
(paren
id|zs_soft
