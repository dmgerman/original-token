...
suffix:semicolon
multiline_comment|/* We need to keep track of the keyboard state, *ahead* of what&n; * the keyboard driver sees, which will be later on after the&n; * interrupt via tqueue wait queues and/or base-handler processing.&n; */
