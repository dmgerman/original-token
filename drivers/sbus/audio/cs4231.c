...
comma
l_int|0
multiline_comment|/*cs4231_chip-&gt;regs-&gt;dmacnc*/
)paren
suffix:semicolon
)brace
r_else
...
comma
l_int|0
multiline_comment|/*cs4231_chip-&gt;regs-&gt;dmapnc*/
)paren
suffix:semicolon
)brace
id|count
...
c_func
(paren
l_string|&quot;pintr&bslash;ncsr 0x%x acr 0x%x bcr %d&bslash;n&quot;
comma
id|readl
c_func
(paren
...
(paren
(paren
l_string|&quot;in eb4231 start output act %d pau %d&bslash;n&quot;
comma
id|cs4231_chip-&gt;perchip_info.play.active
comma
id|cs4231_chip-&gt;perchip_info.play.pause
...
(paren
(paren
l_string|&quot;about to go setup&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|dcsr
...
(paren
(paren
l_string|&quot;playing next block&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|eb4231_playintr
...
(paren
(paren
l_string|&quot;csr 0x%x acr 0x%x bcr %d&bslash;n&quot;
comma
id|readl
c_func
(paren
...
c_func
(paren
l_string|&quot;in eb4231_interrupt&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;play csr 0x%x capt csr 0x%x&bslash;n&quot;
comma
id|dummy1
comma
id|dummy2
...
(paren
(paren
l_string|&quot;in eb4231_interrupt2&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/* Clear the interrupt. */
...
(paren
(paren
l_string|&quot;play csr 0x%x&bslash;n&quot;
comma
id|dummy
)paren
)paren
...
(paren
id|KERN_INFO
l_string|&quot;audio%d: cs4231%c at 0x%x irq %d&bslash;n&quot;
comma
id|drv-&gt;index
comma
(paren
...
(paren
id|KERN_INFO
l_string|&quot;audio%d: cs4231%c at %p irq %s&bslash;n&quot;
comma
id|drv-&gt;index
comma
(paren
...
suffix:semicolon
multiline_comment|/* Make sure we can map the registers first */
r_if
c_cond
(paren
id|check_region
...
c_func
(paren
l_string|&quot;eb4231_attach: can&squot;t get region at %016lx&bslash;n&quot;
comma
id|edev-&gt;base_address
(braket
l_int|0
...
(paren
id|KERN_INFO
l_string|&quot;audio%d: cs4231%c(eb2) at %p irq %s&bslash;n&quot;
comma
id|drv-&gt;index
comma
(paren
