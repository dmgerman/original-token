...
suffix:semicolon
multiline_comment|/* I&squot;ve taken the liberty of setting half gain and&n;&t; * mid balance, to put the codec in a known state.&n;&t; */
id|dbri_set_output_balance
c_func
(paren
id|drv
