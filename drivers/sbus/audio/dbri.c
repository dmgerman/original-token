...
l_int|0
suffix:semicolon
multiline_comment|/* XXX - This routine can be called via interrupt.  If DBRI&n;         * was cmdlocked, that would cause a sleep, which would be&n;         * scheduling in an interrupt, and that&squot;s not allowed&n;         *&n;         * Fortunately, there&squot;s nothing else talking to our DBRI (yet),&n;         * so this isn&squot;t a problem (yet)&n;         */
id|dbri_cmdlock
c_func
(paren
id|dbri
