...
comma
(paren
l_string|&quot;DBRI cmd: %08x:%08x&bslash;n&quot;
comma
(paren
r_int
r_int
...
comma
(paren
l_string|&quot;DBRI: Chip completed command buffer (%d)&bslash;n&quot;
comma
id|MAXLOOPS
op_minus
id|maxloops
...
comma
(paren
l_string|&quot;DBRI: start audio output buf=%lx/%ld&bslash;n&quot;
comma
(paren
r_int
r_int
...
comma
(paren
l_string|&quot;DBRI: start audio input buf=%lx/%ld&bslash;n&quot;
comma
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* SunOS 5.5.1 audio(7I) man page says:&n;&t; * &quot;Upon the initial open() of the audio device, the driver&n;&t; *  will reset the data format of the device to the default&n;&t; *  state of 8-bit, 8KHz, mono u-law data.&quot;&n;&t; *&n;&t; * I&squot;ve also taken the liberty of setting half gain and&n;&t; * mid balance, to put the codec in a known state.&n;&t; */
id|dbri_set_output_channels
c_func
(paren
id|drv
...
comma
(paren
l_string|&quot;DBRI: DMA Cmd Block 0x%08x (0x%08x)&bslash;n&quot;
comma
(paren
r_int
)paren
