...
multiline_comment|/* force output to speaker for now */
id|map-&gt;mmr2
op_or_assign
id|AM_MAP_MMR2_LS
suffix:semicolon
multiline_comment|/* input from external microphone */
id|map-&gt;mmr2
op_or_assign
id|AM_MAP_MMR2_AINB
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* info-&gt;regs-&gt;der &amp; D_XMIT_ERRORS); */
)brace
...
multiline_comment|/* This should eventually be made to DTRT, whatever that ends up */
...
id|AUDIO_SPEAKER
suffix:semicolon
multiline_comment|/* some of these have only HEADPHONE */
)brace
...
multiline_comment|/* This chip also supports AUDIO_ENCODING_ALAW, add support later */
DECL|function|amd7930_get_output_encoding
r_static
r_int
id|amd7930_get_output_encoding
c_func
(paren
r_struct
id|sparcaudio_driver
...
DECL|function|amd7930_get_input_encoding
r_static
r_int
id|amd7930_get_input_encoding
c_func
(paren
r_struct
id|sparcaudio_driver
...
l_int|NULL
comma
multiline_comment|/* amd7930_set_output_channels */
id|amd7930_get_output_channels
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_input_channels */
id|amd7930_get_input_channels
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_output_precision */
id|amd7930_get_output_precision
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_input_precision */
id|amd7930_get_input_precision
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_output_port */
id|amd7930_get_output_port
comma
l_int|NULL
comma
...
l_int|NULL
comma
multiline_comment|/* amd7930_set_output_encoding */
id|amd7930_get_output_encoding
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_input_encoding */
id|amd7930_get_input_encoding
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_output_rate */
id|amd7930_get_output_rate
comma
l_int|NULL
comma
multiline_comment|/* amd7930_set_input_rate */
id|amd7930_get_input_rate
comma
id|amd7930_sunaudio_getdev_sunos
comma
...
r_private
suffix:semicolon
id|info-&gt;Bb.output_ptr
op_assign
id|info-&gt;Bb.input_ptr
op_assign
l_int|NULL
suffix:semicolon
id|info-&gt;Bb.output_count
op_assign
id|info-&gt;Bb.input_count
op_assign
l_int|0
suffix:semicolon
id|info-&gt;Bc.output_ptr
op_assign
id|info-&gt;Bc.input_ptr
op_assign
l_int|NULL
suffix:semicolon
id|info-&gt;Bc.output_count
op_assign
id|info-&gt;Bc.input_count
op_assign
l_int|0
suffix:semicolon
id|info-&gt;ints_on
