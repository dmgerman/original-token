multiline_comment|/*&n; * drivers/sbus/audio/audio.c&n; *&n; * Copyright (C) 1996 Thomas K. Dyas (tdyas@noc.rutgers.edu)&n; * Copyright (C) 1997,1998 Derrick J. Brashear (shadow@dementia.org)&n; * Copyright (C) 1997 Brent Baccala (baccala@freesoft.org)&n; * &n; * Mixer code adapted from code contributed by and&n; * Copyright (C) 1998 Michael Mraka (michael@fi.muni.cz)&n; * The mixer code cheats; Sparc hardware doesn&squot;t generally allow independent&n; * line control, and this fakes it badly.&n; *&n; * SNDCTL_DSP_SETFMT based on code contributed by&n; * Ion Badulescu (ionut@moisil.cs.columbia.edu)&n; *&n; * This is the audio midlayer that sits between the VFS character&n; * devices and the low-level audio hardware device drivers.&n; */
...
(brace
multiline_comment|/* &n;   * If !status, just restart current output.&n;   * If status &amp; 1, a buffer is finished; make it available again.&n;   * If status &amp; 2, a buffer was claimed for DMA and is still in use.&n;   *&n;   * The playing_count for non-DMA hardware should never be non-zero.&n;   */
r_if
c_cond
(paren
id|status
...
suffix:semicolon
multiline_comment|/* XXX do this right... */
...
(paren
(paren
l_string|&quot; for mono to %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
(paren
(paren
l_string|&quot; for stereo to to %d (bal %d)&bslash;n&quot;
comma
id|i
comma
id|j
...
(paren
(paren
l_string|&quot;setting output volume (0x%x)&quot;
comma
id|k
)paren
)paren
