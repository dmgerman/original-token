multiline_comment|/*&n; * drivers/sbus/audio/audio.c&n; *&n; * Copyright (C) 1996,1997 Thomas K. Dyas (tdyas@eden.rutgers.edu)&n; *&n; * This is the audio midlayer that sits between the VFS character&n; * devices and the low-level audio hardware device drivers.&n; */
...
id|bytes_to_copy
suffix:semicolon
multiline_comment|/* Activate the driver if more than page of data is waiting. */
r_if
c_cond
(paren
id|driver-&gt;output_size
