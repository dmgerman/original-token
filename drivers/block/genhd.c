...
suffix:semicolon
DECL|function|print_minor_name
r_static
r_void
id|print_minor_name
(paren
...
multiline_comment|/*&n;&t; * IDE devices use multiple major numbers, but the drives&n;&t; * are named as:  {hda,hdb}, {hdc,hdd}, {hde,hdf}, {hdg,hdh}..&n;&t; * This requires some creative handling here to find the&n;&t; * correct name to use, with some help from ide.c&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* more than large enough */
id|strcpy
c_func
(paren
id|name
...
suffix:semicolon
multiline_comment|/* courtesy ide.c */
id|name
(braket
id|strlen
c_func
...
c_func
(paren
l_string|&quot;Dev %d Sun disklabel: bad magic %08x&bslash;n&quot;
comma
id|dev
comma
id|label-&gt;magic
