...
DECL|function|sector_partition_scale
r_static
r_int
id|sector_partition_scale
c_func
(paren
id|kdev_t
id|dev
...
suffix:semicolon
macro_line|#ifdef CONFIG_BSD_DISKLABEL
multiline_comment|/* no bsd disklabel as a default */
id|kdev_t
id|bsd_kdev
op_assign
l_int|0
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * Examine the partition table for common translations.&n;&t;&t;&t; * This is useful for drives in situations where the&n;&t;&t;&t; * translated geometry is unavailable from the BIOS.&n;&t;&t;&t; */
r_for
c_loop
(paren
id|i
...
macro_line|#ifdef CONFIG_BSD_DISKLABEL
multiline_comment|/* tag first disklabel for late recognition */
r_if
c_cond
(paren
id|SYS_IND
...
id|res
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Don&squot;t bother touching M/O 2K media.&n;&t; */
r_if
c_cond
(paren
id|get_ptable_blocksize
...
id|rdb_done
suffix:colon
multiline_comment|/*&n;&t; *&t;FIXME: should restore the original size. Then we could clean&n;&t; *&t;up the M/O skip. Amiga people ?&n;&t; */
id|set_blocksize
c_func
(paren
id|dev
