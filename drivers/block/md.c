...
id|j
suffix:semicolon
multiline_comment|/*&t;&t;wait_event(mddev-&gt;recovery_wait,&n;&t;&t;&t;   atomic_read(&amp;mddev-&gt;recovery_active) &lt; window);&n;*/
id|blocks
op_assign
id|mddev-&gt;pers
op_member_access_from_pointer
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Recovery got interrupted ...&n;&t;&t;&t; * signal back that we have finished using the array.&n;&t;&t;&t; */
id|mddev-&gt;pers
op_member_access_from_pointer
id|diskop
c_func
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_MD_RAID0
id|raid0_init
(paren
)paren
suffix:semicolon
