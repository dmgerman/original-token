...
DECL|function|md_unplug_device
r_static
r_void
id|md_unplug_device
(paren
...
c_func
(paren
l_string|&quot;(read) %s&squot;s sb offset: %d&quot;
comma
id|partition_name
c_func
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * First insert a dummy inode.&n;&t; */
r_if
c_cond
(paren
id|rdev-&gt;inode
...
id|ENOMEM
suffix:semicolon
multiline_comment|/*&n;&t; * we dont care about any other fields&n;&t; */
id|rdev-&gt;inode-&gt;i_dev
op_assign
id|rdev-&gt;inode-&gt;i_rdev
op_assign
id|rdev-&gt;dev
suffix:semicolon
...
c_func
(paren
l_string|&quot; rdev %s: O:%s, SZ:%08d F:%d DN:%d &quot;
comma
id|partition_name
c_func
(paren
...
c_func
(paren
l_string|&quot;       * &lt;COMPLETE RAID STATE PRINTOUT&gt; *&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;%s&squot;s sb offset has changed from %d to %d, skipping&bslash;n&quot;
comma
id|partition_name
c_func
(paren
...
c_func
(paren
l_string|&quot;%s&squot;s size has changed from %d to %d since import, skipping&bslash;n&quot;
comma
id|partition_name
c_func
(paren
...
c_func
(paren
l_string|&quot;(write) %s&squot;s sb offset: %d&bslash;n&quot;
comma
id|partition_name
c_func
(paren
...
DECL|macro|GETBLK_FAILED
macro_line|#undef GETBLK_FAILED KERN_ERR
...
(paren
id|KERN_WARNING
l_string|&quot;Dev %s smaller than chunk_size: %dk &lt; %dk&bslash;n&quot;
comma
id|partition_name
c_func
(paren
...
id|EINVAL
suffix:semicolon
multiline_comment|/*&n;&t; * Drop all container device buffers, from now on&n;&t; * the only valid external interface is through the md&n;&t; * device.&n;&t; */
id|ITERATE_RDEV
c_func
(paren
id|mddev
...
multiline_comment|/* support old ioctls/init - cold add only */
...
DECL|macro|SET_SB
mdefine_line|#define SET_SB(x,v) mddev-&gt;sb-&gt;x = v
DECL|macro|SET_RSB
mdefine_line|#define SET_RSB(x,y) mddev-&gt;sb-&gt;disks[nr].x = y
r_static
r_void
id|autorun_array
(paren
...
l_int|16
suffix:semicolon
singleline_comment|//&t;int fault= (info &amp; 0x00FF00UL)&gt;&gt;8;
r_int
id|factor
op_assign
(paren
...
c_func
(paren
l_string|&quot;array md%d already has superbloc!!&bslash;n&quot;
comma
id|mdidx
c_func
(paren
...
(brace
multiline_comment|/* non-persistant super block */
r_int
id|devs
op_assign
id|mddev-&gt;nb_dev
...
id|MD_SB_MAGIC
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Generate a 128 bit UUID&n;&t;&t; */
id|get_random_bytes
c_func
(paren
op_amp
...
suffix:semicolon
multiline_comment|/* add each disc */
id|ITERATE_RDEV
c_func
(paren
id|mddev
...
r_else
(brace
multiline_comment|/* persistant super block - ignore the info and read the superblocks */
id|ITERATE_RDEV
c_func
(paren
id|mddev
...
c_func
(paren
l_string|&quot;%s has different UUID to %s .. dropping&bslash;n&quot;
comma
id|partition_name
c_func
(paren
...
multiline_comment|/* handle &quot;old style&quot; ioctls */
r_switch
c_cond
(paren
id|cmd
...
c_func
(paren
l_string|&quot;couldn&squot;t mdstart&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|abort_unlock
...
c_func
(paren
l_string|&quot;couldn&squot;t mdstop&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|abort_unlock
...
id|REGISTER_DEV
suffix:colon
multiline_comment|/* add this device to an unstarted array,&n;&t;&t; * create the array if needed */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;do_md_add failed %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t; * Always succeed&n;&t; */
r_return
(paren
l_int|0
)paren
...
suffix:semicolon
multiline_comment|/*&n;&t; * We do not want to overflow, so the order of operands and&n;&t; * the * 100 / 100 trick are important. We do a +1 to be&n;&t; * safe against division by zero. We only estimate anyway.&n;&t; *&n;&t; * dt: time until now&n;&t; * tt: total time&n;&t; * et: estimated finish time&n;&t; */
id|dt
op_assign
(paren
(paren
...
suffix:semicolon
r_else
multiline_comment|/*&n;&t;&t; * ignore rounding effects near finish time&n;&t;&t; */
id|et
op_assign
l_int|0
suffix:semicolon
...
mdefine_line|#define MAX_MD_BOOT_DEVS&t;16
r_struct
(brace
DECL|member|set
r_int
...
multiline_comment|/*&n;         * pick a XOR routine, runtime.&n;         */
