...
id|out
comma
l_string|&quot;pci bus %d function %d vendor %04x device %04x channel %d&bslash;n&quot;
comma
id|hwif-&gt;pci_bus
comma
id|hwif-&gt;pci_fn
