...
multiline_comment|/* with the semaphore waits are queued up &n;   A more generic routine would do a schedule a la timer.device */
...
l_int|0x19
suffix:semicolon
multiline_comment|/* count clock, force load, one-shot, start */
id|sleep_on
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;FD: probing units&bslash;nfound &quot;
)paren
suffix:semicolon
id|found
op_assign
