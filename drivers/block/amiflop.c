...
macro_line|#include &lt;asm/amifd.h&gt;
...
mdefine_line|#define MAX_SECTORS&t;22
...
id|on_attempts
suffix:semicolon
multiline_comment|/* track buffer */
DECL|variable|lastdrive
r_static
r_int
id|lastdrive
op_assign
...
c_func
(paren
l_string|&quot;fd: unmatched hw_rel&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|hw_nested
...
multiline_comment|/*======================================================================&n;  Turn off the motor of the given drive.  Unit must already be active.&n;  Returns standard floppy error code.&n;======================================================================*/
...
suffix:semicolon
macro_line|#ifdef MODULE
multiline_comment|/*&n;this is the last interrupt for any drive access, happens after&n;release. So we have to wait until now to decrease the use count.&n;*/
r_if
c_cond
(paren
id|fd_ref
...
multiline_comment|/*======================================================================&n;  Seek the drive to track 0.&n;  The drive must be active and the motor must be running.&n;  Returns standard floppy error code.&n;======================================================================*/
...
(paren
id|KERN_ERR
l_string|&quot;calibrate failed, turning motor off&bslash;n&quot;
)paren
suffix:semicolon
id|fd_motor_off
(paren
...
multiline_comment|/*======================================================================&n;  Seek the drive to the requested cylinder.&n;  The drive must have been calibrated at some point before this.&n;  The drive must also be active and the motor must be running.&n;======================================================================*/
...
multiline_comment|/*==========================================================================&n;  amiga_write converts track/labels data to raw track data&n;==========================================================================*/
...
multiline_comment|/*==========================================================================&n; scan_sync - looks for the next start of sector marked by a sync. d3 is the&n;&t;&t;sector number (10..0). When d3 = 10, can&squot;t be certain of a&n;&t;&t;starting sync.&n;==========================================================================*/
...
multiline_comment|/*==========================================================================&n;  amiga_read reads a raw track of data into a track buffer&n;==========================================================================*/
...
macro_line|#endif
multiline_comment|/*******************************************************************&n;   this reads a raw track of data into trackbuffer for ms-disks &n;*******************************************************************/
...
multiline_comment|/**************************************************************&n;  builds encoded track data from trackbuffer data&n;**************************************************************/
...
suffix:semicolon
multiline_comment|/* corresponds to rel_hw() in post_write() */
...
suffix:semicolon
multiline_comment|/* corresponds to get_hw() in raw_write */
)brace
...
l_int|1
suffix:semicolon
multiline_comment|/* we can not calibrate - no chance */
)brace
r_if
c_cond
(paren
...
multiline_comment|/* printk(&quot;redo_fd_request: can&squot;t handle auto detect&bslash;n&quot;);*/
multiline_comment|/* printk(&quot;redo_fd_request: default to normal&bslash;n&quot;);*/
id|drive
op_assign
id|device
op_amp
...
c_func
(paren
l_string|&quot;fd: sector %d + %d requested&bslash;n&quot;
comma
id|CURRENT-&gt;sector
comma
id|cnt
...
l_int|1
suffix:semicolon
id|flush_track_timer.data
op_assign
id|drive
suffix:semicolon
id|flush_track_timer.expires
op_assign
id|jiffies
op_plus
l_int|1
...
multiline_comment|/*======================================================================&n;  Return unit ID number of given disk&n;======================================================================*/
DECL|function|get_drive_id
r_static
r_int
r_int
id|get_drive_id
...
c_func
(paren
l_string|&quot;%sfd: drive 0 didn&squot;t identify, setting default %08lx&bslash;n&quot;
comma
(paren
id|called
op_eq
...
(brace
multiline_comment|/* &n;     * if it was a write from an interrupt,&n;     * we will call post_write from here&n;     */
id|writepending
op_assign
l_int|2
suffix:semicolon
...
id|motor_on_timer.next
op_assign
l_int|NULL
suffix:semicolon
id|motor_on_timer.prev
op_assign
l_int|NULL
suffix:semicolon
id|motor_on_timer.expires
...
id|flush_track_timer.next
op_assign
l_int|NULL
suffix:semicolon
id|flush_track_timer.prev
op_assign
l_int|NULL
suffix:semicolon
id|flush_track_timer.expires
...
l_int|0
suffix:semicolon
id|flush_track_timer.function
op_assign
id|flush_track_callback
suffix:semicolon
id|post_write_timer.next
op_assign
l_int|NULL
suffix:semicolon
id|post_write_timer.prev
op_assign
l_int|NULL
suffix:semicolon
id|post_write_timer.expires
...
suffix:semicolon
macro_line|#if 0 /* Doesn&squot;t seem to be correct */
r_if
c_cond
(paren
id|fd_def_df0
...
macro_line|#else
multiline_comment|/* Now we hope that every HD drive will identify itself correctly */
id|fd_def_df0
op_assign
id|FD_DD_3
suffix:semicolon
