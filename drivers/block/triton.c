...
DECL|macro|DISPLAY_TRITON_TIMINGS
macro_line|#undef DISPLAY_TRITON_TIMINGS&t;/* define this to display timings */
...
macro_line|#endif /* DISPLAY_TRITON_TIMINGS */
...
c_func
(paren
l_string|&quot;ide: i82371 PIIX (Triton) on PCI bus %d function %d&bslash;n&quot;
comma
id|bus
comma
id|fn
...
c_func
(paren
l_string|&quot;ide: bypassing BIOS; setting BMIBA to 0x%04x&bslash;n&quot;
comma
id|base
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ide: no such luck; DMA disabled&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
