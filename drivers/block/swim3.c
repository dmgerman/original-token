...
mdefine_line|#define IOCTL_MODE_BIT&t;8
DECL|macro|OPEN_WRITE_BIT
mdefine_line|#define OPEN_WRITE_BIT&t;16
...
DECL|function|fd_dma_interrupt
r_static
r_void
id|fd_dma_interrupt
c_func
...
(brace
multiline_comment|/* assume this is a PB3400 */
id|swims
op_assign
id|find_devices
c_func
...
(paren
id|KERN_ERR
l_string|&quot;Warning: only using first SWIM3 floppy controller&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_ERR
l_string|&quot;swim3: expecting 2 addrs and 2 intrs! (%d, %d)&bslash;n&quot;
comma
id|swims-&gt;n_addrs
comma
id|swims-&gt;n_intrs
...
(paren
id|KERN_ERR
l_string|&quot;Couldn&squot;t get irq %d for SWIM3 DMA&quot;
comma
id|fs-&gt;dma_intr
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;fd0: SWIM3 floppy controller&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
