...
suffix:semicolon
multiline_comment|/*&n; * Black list. Some drives incorrectly report their maximal PIO modes, at least&n; * in respect to CMD640. Here we keep info on some known drives.&n; */
