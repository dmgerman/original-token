...
multiline_comment|/* Forward declaration of function to create missing blocks in the &n;   backing file (can happen if the backing file is sparse) */
r_static
r_int
id|create_missing_block
c_func
(paren
r_struct
id|loop_device
...
(brace
multiline_comment|/* The backing file is a sparse file and this block&n;&t;&t;&t;&t;   doesn&squot;t exist.  If reading, return zeros.  If&n;&t;&t;&t;&t;   writing, force the underlying FS to create&n;&t;&t;&t;&t;   the block */
r_if
c_cond
(paren
id|current_request-&gt;cmd
...
DECL|function|create_missing_block
r_static
r_int
id|create_missing_block
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;loop: cannot create block - no backing file&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|FALSE
...
(paren
id|KERN_WARNING
l_string|&quot;loop: cannot create block - no file ops&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|FALSE
...
r_else
(brace
multiline_comment|/* Do what the default llseek() code would have done */
id|file-&gt;f_pos
op_assign
id|new_offset
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;loop: cannot create block - file not writeable&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|FALSE
...
(paren
id|KERN_WARNING
l_string|&quot;loop: cannot create block - FS write failed: code %d&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
multiline_comment|/* Usage checking must be done by the caller - usually with MOD_INC/DEC_* */
