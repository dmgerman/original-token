...
id|i
suffix:semicolon
multiline_comment|/* old ioctls&squot; for kernels &lt;= 1.3.33 */
multiline_comment|/* When the next even release will come around, we&squot;ll start&n;&t; * warning against these.&n;&t; * When the next odd release will come around, we&squot;ll fail with&n;&t; * -EINVAL */
r_if
c_cond
(paren
id|strcmp
...
c_func
(paren
l_string|&quot;obsolete floppy ioctl %x&bslash;n&quot;
comma
op_star
id|cmd
)paren
...
(paren
id|KERN_INFO
l_string|&quot;FDC %d is an 82078-1.&bslash;n&quot;
comma
id|fdc
)paren
suffix:semicolon
