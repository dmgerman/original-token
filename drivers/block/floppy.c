...
suffix:semicolon
multiline_comment|/*&n; * Auto-detection. Each drive type has a number of formats which are&n; * used in succession to try to read the disk. If the FDC cannot lock onto&n; * the disk, the next format is tried. This uses the variable &squot;probing&squot;.&n; */
DECL|macro|NUMBER
mdefine_line|#define&t;NUMBER(x)&t;(sizeof(x) / sizeof(*(x)))
DECL|variable|floppy_type_1
r_static
r_struct
id|floppy_struct
id|floppy_type_1
...
suffix:semicolon
DECL|macro|floppy_type_6
mdefine_line|#define&t;floppy_type_6&t;floppy_type_5&t;&t;/* 5 and 6 are the same */
...
suffix:semicolon
DECL|variable|floppy_num_types
r_static
r_int
id|floppy_num_types
(braket
...
suffix:semicolon
multiline_comment|/* This gives the end of the list */
DECL|variable|base_type_end
r_struct
id|floppy_struct
op_star
id|base_type_end
