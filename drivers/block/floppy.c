...
c_func
(paren
l_string|&quot;bad adrress. start=%p lg=%lx tb=%p&bslash;n&quot;
comma
id|current_addr
comma
id|raw_cmd.length
...
mdefine_line|#define IOCTL_ALLOWED (filp &amp;&amp; (filp-&gt;f_mode &amp; 8 ))
r_struct
id|floppy_struct
id|newparams
suffix:semicolon
...
multiline_comment|/* filp-&gt;f_op is NULL if the disk is mounted, and non-NULL if opened */
r_if
c_cond
(paren
id|filp-&gt;f_op
...
l_int|8
suffix:semicolon
multiline_comment|/* keep mtools working */
r_if
c_cond
(paren
id|UFDCS-&gt;rawcmd
...
multiline_comment|/* prevent dosemu from crashing */
id|filp-&gt;f_mode
op_and_assign
op_complement
l_int|3
