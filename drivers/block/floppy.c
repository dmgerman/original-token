...
mdefine_line|#define max_buffer_sectors MAX_BUFFER_SECTORS
...
DECL|macro|PROVEN_ABSENT
mdefine_line|#define PROVEN_ABSENT -4
...
multiline_comment|/*&n; * disk change.&n; * This routine is responsible for maintaining the changed_floppies flag,&n; * and the last_checked date.&n; *&n; * last_checked is the date of the last check which showed &squot;no disk change&squot;&n; * changed_floppies is set under two conditions:&n; * 1. The floppy has been changed after some i/o to that floppy already&n; *    took place.&n; * 2. No floppy disk is in the drive.&n; *&n; * For 1., maxblock is observed. Maxblock is 0 if no i/o has taken place yet.&n; * For 2., FD_DISK_NEWCHANGE is watched. FD_DISK_NEWCHANGE is cleared on&n; *  each seek. If a disk is present, the disk change line should also be&n; *  cleared on each seek. Thus, if FD_DISK_NEWCHANGE is clear, but the disk&n; *  change line is set, this means either that no disk is in the drive, or&n; *  that it has been removed since the last seek.&n; *&n; * This means that we really have a third possibility too:&n; *  The floppy has been changed after the last seek.&n; */
...
id|UDRS-&gt;maxblock
op_logical_or
multiline_comment|/* disk change check */
op_logical_neg
(paren
id|UDRS-&gt;flags
op_amp
...
(brace
multiline_comment|/* disk presence check */
multiline_comment|/* mark it changed or absent */
id|set_bit
c_func
(paren
id|drive
...
macro_line|#ifdef SILENT_DC_CLEAR
...
macro_line|#ifndef SILENT_DC_CLEAR
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;recal interrupt proven absent:&quot;
)paren
suffix:semicolon
macro_line|#endif
...
c_func
(paren
l_string|&quot;floppy interrupt on bizarre fdc&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* switch off dma gates */
r_for
c_loop
(paren
id|i
