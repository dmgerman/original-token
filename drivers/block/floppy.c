...
multiline_comment|/* ============================================ *&n; * old fd.h&t;&t;&t;&t;&t;*&n; * =========================================== */
DECL|macro|OLDFDCLRPRM
mdefine_line|#define OLDFDCLRPRM 0 /* clear user-defined parameters */
DECL|macro|OLDFDSETPRM
mdefine_line|#define OLDFDSETPRM 1 /* set user-defined parameters for current media */
DECL|macro|OLDFDSETMEDIAPRM
mdefine_line|#define OLDFDSETMEDIAPRM 1
DECL|macro|OLDFDDEFPRM
mdefine_line|#define OLDFDDEFPRM 2 /* set user-defined parameters until explicitly cleared */
DECL|macro|OLDFDDEFMEDIAPRM
mdefine_line|#define OLDFDDEFMEDIAPRM 2
DECL|macro|OLDFDGETPRM
mdefine_line|#define OLDFDGETPRM 3 /* get disk parameters */
DECL|macro|OLDFDGETMEDIAPRM
mdefine_line|#define OLDFDGETMEDIAPRM 3
DECL|macro|OLDFDMSGON
mdefine_line|#define&t;OLDFDMSGON  4 /* issue kernel messages on media type change */
DECL|macro|OLDFDMSGOFF
mdefine_line|#define&t;OLDFDMSGOFF 5 /* don&squot;t issue kernel messages on media type change */
DECL|macro|OLDFDFMTBEG
mdefine_line|#define OLDFDFMTBEG 6 /* begin formatting a disk */
DECL|macro|OLDFDFMTTRK
mdefine_line|#define&t;OLDFDFMTTRK 7 /* format the specified track */
DECL|macro|OLDFDFMTEND
mdefine_line|#define OLDFDFMTEND 8 /* end formatting a disk */
DECL|macro|OLDFDSETEMSGTRESH
mdefine_line|#define OLDFDSETEMSGTRESH&t;10&t;/* set fdc error reporting threshold */
DECL|macro|OLDFDFLUSH
mdefine_line|#define OLDFDFLUSH  11 /* flush buffers for media; either for verifying media, or for&n;                       handling a media change without closing the file&n;&t;&t;       descriptor */
DECL|macro|OLDFDSETMAXERRS
mdefine_line|#define OLDFDSETMAXERRS 12 /* set abortion and read_track threshold */
DECL|macro|OLDFDGETMAXERRS
mdefine_line|#define OLDFDGETMAXERRS 14 /* get abortion and read_track threshold */
DECL|macro|OLDFDGETDRVTYP
mdefine_line|#define OLDFDGETDRVTYP 16          /* get drive type: 5 1/4 or 3 1/2 */
DECL|macro|OLDFDSETDRVPRM
mdefine_line|#define OLDFDSETDRVPRM 20 /* set drive parameters */
DECL|macro|OLDFDGETDRVPRM
mdefine_line|#define OLDFDGETDRVPRM 21 /* get drive parameters */
DECL|macro|OLDFDGETDRVSTAT
mdefine_line|#define OLDFDGETDRVSTAT 22 /* get drive state */
DECL|macro|OLDFDPOLLDRVSTAT
mdefine_line|#define OLDFDPOLLDRVSTAT 23 /* get drive state */
DECL|macro|OLDFDRESET
mdefine_line|#define OLDFDRESET 24 /* reset FDC */
DECL|macro|OLDFD_RESET_IF_NEEDED
mdefine_line|#define OLDFD_RESET_IF_NEEDED 0
DECL|macro|OLDFD_RESET_IF_RAWCMD
mdefine_line|#define OLDFD_RESET_IF_RAWCMD 1
DECL|macro|OLDFD_RESET_ALWAYS
mdefine_line|#define OLDFD_RESET_ALWAYS 2
DECL|macro|OLDFDGETFDCSTAT
mdefine_line|#define OLDFDGETFDCSTAT 25 /* get fdc state */
DECL|macro|OLDFDWERRORCLR
mdefine_line|#define OLDFDWERRORCLR  27 /* clear write error and badness information */
DECL|macro|OLDFDWERRORGET
mdefine_line|#define OLDFDWERRORGET  28 /* get write error and badness information */
DECL|macro|OLDFDRAWCMD
mdefine_line|#define OLDFDRAWCMD 30 /* send a raw command to the fdc */
DECL|macro|OLDFDTWADDLE
mdefine_line|#define OLDFDTWADDLE 40 /* flicker motor-on bit before reading a sector */
...
suffix:semicolon
DECL|struct|old_floppy_fdc_state
r_struct
id|old_floppy_fdc_state
(brace
DECL|member|spec1
r_int
id|spec1
...
macro_line|#if 0
multiline_comment|/* disabled because of new buffer location for raw cmd */
r_if
c_cond
(paren
(paren
...
DECL|macro|COPYOUT
mdefine_line|#define COPYOUT(x) ECALL(fd_copyout( (void *)param, &amp;(x), sizeof(x)))
DECL|macro|COPYIN
mdefine_line|#define COPYIN(x) ECALL(fd_copyin( (void *)param, &amp;(x), sizeof(x)))
...
id|ptr-&gt;cmd_count
op_assign
id|old_raw_cmd.cmd_count
suffix:semicolon
id|ptr-&gt;track
op_assign
id|old_raw_cmd.track
suffix:semicolon
id|memcpy
c_func
(paren
...
multiline_comment|/* notice a disk change immediately, else&n;&t;&t;&t;&t; * we loose our settings immediately*/
id|CALL
c_func
(paren
id|poll_drive
...
l_int|1
suffix:semicolon
multiline_comment|/* invalidation. Invalidate only when needed, i.e.&n;&t;&t;&t; * when there are already sectors in the buffer cache&n;&t;&t;&t; * whose number will change. This is useful, because&n;&t;&t;&t; * mtools often changes the geometry of the disk after&n;&t;&t;&t; * looking at the boot block */
r_if
c_cond
(paren
id|DRS-&gt;maxblock
