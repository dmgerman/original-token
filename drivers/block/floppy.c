...
DECL|struct|translation_entry
r_static
r_struct
id|translation_entry
(brace
DECL|member|newcmd
r_int
id|newcmd
...
id|oldsize
suffix:semicolon
multiline_comment|/* size of 0x00xx-style ioctl. Reflects old structures, thus&n;&t;&t;  * use numeric values. NO SIZEOFS */
DECL|variable|translation_table
)brace
...
suffix:semicolon
DECL|function|normalize_0x02xx_ioctl
r_static
r_inline
r_int
id|normalize_0x02xx_ioctl
c_func
(paren
r_int
op_star
...
c_func
(paren
l_string|&quot;warning: obsolete ioctl 0x%x&bslash;n&quot;
comma
id|ocmd
)paren
suffix:semicolon
...
DECL|function|xlate_0x00xx_ioctl
r_static
r_inline
r_int
id|xlate_0x00xx_ioctl
c_func
(paren
r_int
op_star
...
id|i
suffix:semicolon
multiline_comment|/* kernels &lt;= 1.3.33 */
multiline_comment|/* we might want to start warning in 1.4.x (by then, no user&n;&t; * programs will have an excuse to use the old ioctls: there&n;&t; * will be a stable kernel supporting them :)&n;&t; *&n;&t; * when the first 1.5.x kernel will come out, this loop will&n;&t; * be removed as well.&n;&t; */
r_for
c_loop
(paren
id|i
...
id|EPERM
suffix:semicolon
multiline_comment|/* verify writability of result, and fail early */
r_if
c_cond
(paren
id|_IOC_DIR
