...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;2.5 Eberhard Moenkeberg &lt;emoenke@gwdg.de&gt;&quot;
...
DECL|macro|JUKEBOX
mdefine_line|#define JUKEBOX 0 /* tray control: eject if no disk is in */
DECL|macro|EJECT
