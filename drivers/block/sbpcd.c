...
macro_line|#endif MODULE
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;3.4 Eberhard Moenkeberg &lt;emoenke@gwdg.de&gt;&quot;
...
multiline_comment|/* &quot;sound card #9&quot; */
macro_line|#ifdef MODULE
multiline_comment|/*&n; * some &quot;hazardous&quot; locations (no harm with the loadable version)&n; * (will stop the bus if a NE2000 ethernet card resides at offset -0x10)&n; */
l_int|0x330
comma
l_int|0
comma
...
multiline_comment|/*==========================================================================*/
macro_line|#ifdef MODULE
multiline_comment|/* some restrictions for the &quot;loadable&quot; version */
DECL|macro|SBP_BUFFER_FRAMES
mdefine_line|#define SBP_BUFFER_FRAMES 2 /* kmalloc() limit */
DECL|macro|SBP_BUFFER_AUDIO_FRAMES
mdefine_line|#define SBP_BUFFER_AUDIO_FRAMES 0
macro_line|#else
DECL|macro|SBP_BUFFER_FRAMES
...
c_func
(paren
l_string|&quot;SBPCD: address %03X, type %s, drive ID %d&bslash;n&quot;
comma
id|CDo_command
comma
id|type
...
multiline_comment|/* CD200: not implemented yet */
(brace
)brace
id|DPRINTF
c_func
...
id|DBG_INF
comma
l_string|&quot;SBPCD: Looking for Matsushita, Panasonic, CreativeLabs, IBM, Longshine CD-ROM drives&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|DPRINTF
