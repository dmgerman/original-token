...
macro_line|#if PATCHLEVEL&gt;13
macro_line|#include &lt;linux/ddi.h&gt;
macro_line|#include &lt;linux/major.h&gt; 
macro_line|#else
DECL|macro|DDIOCSDBG
mdefine_line|#define DDIOCSDBG 0x9000
...
macro_line|#ifndef CONFIG_SBPCD
macro_line|#error &quot;SBPCD: &bslash;&quot;make config&bslash;&quot; again. Enable Matsushita/Panasonic CDROM support&quot;
macro_line|#endif
...
mdefine_line|#define MANY_SESSION 0
DECL|macro|CDMKE
mdefine_line|#define CDMKE
DECL|macro|FUTURE
...
multiline_comment|/*==========================================================================*/
multiline_comment|/*==========================================================================*/
multiline_comment|/*&n; * auto-probing address list&n; * inspired by Adam J. Richter from Yggdrasil&n; *&n; * still not good enough - can cause a hang.&n; *   example: a NE 2000 ehernet card at 300 will cause a hang probing 310.&n; * if that happens, reboot and use the LILO (kernel) command line.&n; * the conflicting possible ethernet card addresses get probed last - to&n; * minimize the hang possibilities. &n; *&n; * The SB Pro addresses get &quot;mirrored&quot; at 0x6xx - to avoid a type error,&n; * the 0x2xx-addresses must get checked before 0x6xx.&n; *&n; * what are other cards&squot; default and range ???&n; * what about ESCOM PowerSound???&n; * what about HighScreen???&n; */
...
suffix:semicolon
multiline_comment|/* to avoid possible &quot;printf&quot; bug */
id|SET_TIMER
c_func
(paren
id|mark_timeout
...
id|DBG_INF
comma
l_string|&quot;SBPCD: DiskInfo: first SetSpeed returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INF
comma
l_string|&quot;SBPCD: DiskInfo: second SetSpeed returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INF
comma
l_string|&quot;SBPCD: DiskInfo: first xx_ModeSense returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INF
comma
l_string|&quot;SBPCD: DiskInfo: second xx_ModeSense returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INF
comma
l_string|&quot;SBPCD: DiskInfo: first ReadCapacity returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INF
comma
l_string|&quot;SBPCD: DiskInfo: second ReadCapacity returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_IOC
comma
l_string|&quot;SBPCD: ioctl: DriveReset returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
multiline_comment|/*==========================================================================*/
multiline_comment|/*&n; *  We seem to get never an interrupt.&n; */
macro_line|#if SBPCD_USE_IRQ
DECL|function|sbpcd_interrupt
r_static
r_void
id|sbpcd_interrupt
c_func
...
id|DBG_IRQ
comma
l_string|&quot;SBPCD: INTERRUPT received - CDi_status=%02X&bslash;n&quot;
comma
id|st
)paren
)paren
...
suffix:semicolon
macro_line|#endif&t;SBPCD_DIS_IRQ
id|i
op_assign
id|maxtim_data
suffix:semicolon
...
multiline_comment|/*&n; * we could try to keep an &quot;open&quot; counter here and lock the door if 0-&gt;1.&n; * not done yet.&n; */
r_if
c_cond
(paren
op_logical_neg
...
id|i
suffix:semicolon
multiline_comment|/*&n; * we could try to count down an &quot;open&quot; counter here&n; * and unlock the door if zero.&n; * not done yet.&n; */
id|i
op_assign
id|MINOR
c_func
...
suffix:semicolon
multiline_comment|/*==========================================================================*/
multiline_comment|/*&n; *  SBP interrupt descriptor&n; */
macro_line|#if SBPCD_USE_IRQ
DECL|variable|sbpcd_sigaction
r_static
r_struct
id|sigaction
id|sbpcd_sigaction
...
id|DBG_INI
comma
l_string|&quot;SBPCD: check_region done.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
l_int|4
suffix:semicolon
multiline_comment|/* just one frame */
id|snarf_region
c_func
(paren
id|CDo_command
...
id|DBG_INF
comma
l_string|&quot;SBPCD: Can&squot;t get IRQ%d for sbpcd driver&bslash;n&quot;
comma
id|SBPCD_INTR_NR
)paren
)paren
...
multiline_comment|/*==========================================================================*/
multiline_comment|/*&n; * adopted from sr.c&n; *&n; * Check if the media has changed in the CD-ROM drive.&n; * used externally (isofs/inode.c) - but still does not work.&n; *&n; */
DECL|function|check_sbpcd_media_change
r_int
...
id|DBG_INF
comma
l_string|&quot;SBPCD: media_check: invalid device.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
