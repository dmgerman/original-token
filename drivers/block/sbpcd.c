...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;2.9 Eberhard Moenkeberg &lt;emoenke@gwdg.de&gt;&quot;
multiline_comment|/*&n; * still testing around...&n; */
DECL|macro|MULTISESSION_BY_DRIVER
mdefine_line|#define MULTISESSION_BY_DRIVER 0 /* needs &quot;#define MULTISESSION&quot; in&n;                                  * linux/fs/isofs/inode.c&n;                                  * if set to 0 here&n;                                  */
DECL|macro|TEAC
mdefine_line|#define TEAC 0 /* if 1: enable TEAC CD-55A support (not useable yet) */
DECL|macro|JUKEBOX
...
mdefine_line|#define SBP_BUFFER_AUDIO_FRAMES 4 /* driver&squot;s own read_ahead, read audio mode */
multiline_comment|/*==========================================================================*/
...
l_string|&quot;CR-5&quot;
suffix:semicolon
multiline_comment|/* Panasonic CR-56x */
DECL|variable|lcs_family
r_static
id|u_char
id|lcs_family
(braket
...
l_string|&quot;MATSHITA&quot;
suffix:semicolon
multiline_comment|/* Matsushita CR-52x */
...
multiline_comment|/*&n; * DDI interface: runtime trace bit pattern maintainance&n; */
...
r_else
multiline_comment|/* old_drive, different firmware levels */
(brace
r_if
c_cond
(paren
...
id|i
suffix:semicolon
DECL|macro|CMD_TEAC_RESET
mdefine_line|#define CMD_TEAC_RESET 0xc0
id|OUT
c_func
(paren
id|CDo_sel_d_i
...
c_func
(paren
l_string|&quot;%sDrive %d: %s (%.4s)&bslash;n&quot;
comma
id|printk_header
comma
id|DriveStruct
