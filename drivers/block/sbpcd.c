...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;3.1 Eberhard Moenkeberg &lt;emoenke@gwdg.de&gt;&quot;
multiline_comment|/*&n; * still testing around...&n; */
DECL|macro|MULTISESSION_BY_DRIVER
mdefine_line|#define MULTISESSION_BY_DRIVER 0 /* if set to 0 here, we need the counterpart&n;                                  * in linux/fs/isofs/inode.c&n;                                  */
DECL|macro|READ_AUDIO
mdefine_line|#define READ_AUDIO 4 /* max. number of audio frames to read with one */
multiline_comment|/* request (allocates n* 2352 bytes kernel memory!) */
DECL|macro|TEAC
mdefine_line|#define TEAC 0 /* if 1: enable TEAC CD-55A support (not usable yet) */
DECL|macro|CD200
mdefine_line|#define CD200 1 /* if 1: enable CD200 support (not usable yet) */
DECL|macro|JUKEBOX
mdefine_line|#define JUKEBOX 1 /* tray control: eject tray if no disk is in */
DECL|macro|EJECT
mdefine_line|#define EJECT 1 /* tray control: eject tray after last use */
...
l_int|0
comma
multiline_comment|/* CI-101P (default), WDH-7001C (default),&n;&t;       Galaxy (default), Reveal (one default) */
l_int|0x250
comma
l_int|1
comma
...
l_int|0
comma
multiline_comment|/* Lasermate, CI-101P, WDH-7001C, Galaxy, Reveal (other default),&n;               Longshine LCS-6853 (default) */
l_int|0x338
comma
l_int|0
comma
...
comma
multiline_comment|/* &quot;sound card #9&quot; */
multiline_comment|/*&n; * some &quot;hazardous&quot; locations&n; * (will stop the bus if a NE2000 ethernet card resides at offset -0x10)&n; */
macro_line|#if 0
l_int|0x330
comma
l_int|0
...
mdefine_line|#define NUM_PROBE  (sizeof(sbpcd_probe) / sizeof(int))
multiline_comment|/*==========================================================================*/
...
mdefine_line|#define SBP_BUFFER_FRAMES 4 /* driver&squot;s own read_ahead, data mode */
DECL|macro|SBP_BUFFER_AUDIO_FRAMES
mdefine_line|#define SBP_BUFFER_AUDIO_FRAMES READ_AUDIO /* buffer for read audio mode */
multiline_comment|/*==========================================================================*/
...
l_string|&quot;CD-55A&quot;
suffix:semicolon
multiline_comment|/* TEAC CD-55A (still unknown)*/
...
id|DBG_TIM
comma
l_string|&quot;SBPCD: timer expired.&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: CDi_stat_loop failed&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
r_else
multiline_comment|/* CD200, CD-55A */
(brace
)brace
r_return
(paren
...
id|DBG_STA
comma
l_string|&quot;SBPCD: ResponseStatus: response %2X.&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: p_door_locked bit %d before&bslash;n&quot;
comma
id|st_door_locked
)paren
)paren
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: p_door_locked bit %d after&bslash;n&quot;
comma
id|st_door_locked
)paren
)paren
...
id|DBG_LCK
comma
l_string|&quot;SBPCD: yy_CloseTray (drive %d)&bslash;n&quot;
comma
id|d
)paren
)paren
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: p_door_closed bit %d before&bslash;n&quot;
comma
id|st_door_closed
)paren
)paren
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: p_door_closed bit %d after&bslash;n&quot;
comma
id|st_door_closed
)paren
)paren
...
l_int|19
suffix:semicolon
multiline_comment|/* preliminary - has to get adjusted the following way:&n;           *   look at the first byte of frames 17 ff. until 0xFF is seen&n;           *   the frame before this one is the last continuation frame&n;           */
id|DPRINTF
c_func
(paren
(paren
id|DBG_MUL
comma
l_string|&quot;SBPCD: MultiSession CD detected: %02X %02X %02X %02X %02X %02X (%d)&bslash;n&quot;
comma
id|infobuf
(braket
l_int|0
...
id|DBG_MUL
comma
l_string|&quot;SBPCD: MultiSession Info: %02X %02X %02X %02X %02X %02X %02X %02X (%d)&bslash;n&quot;
comma
id|infobuf
(braket
l_int|0
...
id|DBG_MUL
comma
l_string|&quot;SBPCD: MultiSession base: %06X&bslash;n&quot;
comma
id|DriveStruct
(braket
id|d
...
l_int|19
suffix:semicolon
multiline_comment|/* preliminary - has to get adjusted the following way:&n;&t;   *   look at the first byte of frames 17 ff. until 0xFF is seen;&n;&t;   *   the frame before this one is the last repetition frame.&n;&t;   */
)brace
)brace
r_else
multiline_comment|/* CD200, CD-55A */
...
id|DBG_TEA
comma
l_string|&quot;SBPCD: TEAC soft reset.&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|sbp_sleep
...
multiline_comment|/*==========================================================================*/
DECL|function|look_for_TEAC_drive
r_static
r_int
id|look_for_TEAC_drive
c_func
(paren
r_int
id|drv_id
...
suffix:semicolon
multiline_comment|/* drive not present */
id|i
op_assign
id|inb
c_func
...
id|DBG_TEA
comma
l_string|&quot;SBPCD: TEAC look_for_drive: %02X.&bslash;n&quot;
comma
id|i
)paren
)paren
...
suffix:semicolon
multiline_comment|/* something else present */
r_return
(paren
l_int|1
)paren
...
multiline_comment|/*==========================================================================*/
DECL|function|find_teac_drives
r_static
r_int
id|find_teac_drives
c_func
...
id|DBG_TEA
comma
l_string|&quot;SBPCD: TEAC drive (id=%d) found.&bslash;n&quot;
comma
id|i
)paren
)paren
...
c_func
(paren
l_string|&quot;SBPCD: please mail the following lines to emoenke@gwdg.de:&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;&bslash;&quot;&bslash;nSBPCD: infobuf = &bslash;&quot;&quot;
)paren
suffix:semicolon
r_for
c_loop
...
l_int|0
suffix:semicolon
multiline_comment|/* check for CD200 and CD-55A first */
id|clr_cmdbuf
c_func
(paren
)paren
...
id|DBG_INI
comma
l_string|&quot;SBPCD: CMD2_READERR returns %d (ok anyway).&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INI
comma
l_string|&quot;SBPCD: CMD2_READ_VER returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
c_func
(paren
l_string|&quot;&bslash;n&bslash;nSBPCD: possibly CD-55A present.&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|DBG_INI
comma
l_string|&quot;SBPCD: CMD0_READERR returns %d (ok anyway).&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_INI
comma
l_string|&quot;SBPCD: CMD0_READ_VER returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
c_func
(paren
l_string|&quot;&bslash;n&bslash;nSBPCD: possibly TEAC CD-55A present.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;SBPCD: support is not fulfilled yet - drive gets ignored.&bslash;n&quot;
)paren
suffix:semicolon
id|ask_mail
c_func
...
c_func
(paren
l_string|&quot;&bslash;n&bslash;nSBPCD: new drive CD200 (%s)detected.&bslash;n&quot;
comma
id|DriveStruct
(braket
id|d
...
multiline_comment|/* only 1.01 known at time */
id|ask_mail
c_func
(paren
)paren
...
c_func
(paren
l_string|&quot;SBPCD: just wait some days...&bslash;n&bslash;n&quot;
)paren
suffix:semicolon
id|DriveStruct
(braket
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: drive type %02X&bslash;n&quot;
comma
id|DriveStruct
(braket
id|d
...
id|DBG_DID
comma
l_string|&quot;SBPCD: drive %d (ID=%d) activated.&bslash;n&quot;
comma
id|i
comma
id|DriveStruct
...
id|DBG_INI
comma
l_string|&quot;SBPCD: check_drives: drive %d (ID=%d) activated.&bslash;n&quot;
comma
id|ndrives
comma
id|j
...
c_func
(paren
l_string|&quot;%sDrive %d (ID=%d): %.9s (%.4s)&bslash;n&quot;
comma
id|printk_header
comma
id|d
...
c_func
(paren
l_string|&quot;SBPCD: ioctl: bad device: %04X&bslash;n&quot;
comma
id|inode-&gt;i_rdev
)paren
suffix:semicolon
...
id|DBG_IOC
comma
l_string|&quot;SBPCD: ioctl: xx_PlayAudio returns %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_IOX
comma
l_string|&quot;SBPCD: ioctl: yy_SpinDown returned %d.&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_IOC
comma
l_string|&quot;SBPCD: ioctl: CDROMEJECT_SW entered.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
id|DBG_AUD
comma
l_string|&quot;SBPCD: read_audio: SetSpeed error %d&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_IOC
comma
l_string|&quot;SBPCD: ioctl: CDROMMULTISESSION entered.&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|st
...
id|DBG_MUL
comma
l_string|&quot;SBPCD: ioctl: CDROMMULTISESSION done (%d, %08X).&bslash;n&quot;
comma
id|ms_info.xa_flag
comma
id|ms_info.addr.lba
...
id|DBG_IOC
comma
l_string|&quot;SBPCD: ioctl: CDROMMULTISESSION_SYS entered.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
...
id|DBG_MUL
comma
l_string|&quot;SBPCD: ioctl: CDROMMULTISESSION_SYS done (%d).&bslash;n&quot;
comma
(paren
(paren
r_int
...
c_func
(paren
l_string|&quot;SBPCD: do_request: bad device: %04X&bslash;n&quot;
comma
id|CURRENT-&gt;dev
)paren
suffix:semicolon
...
l_int|4
suffix:semicolon
macro_line|#if MULTISESSION_BY_DRIVER
r_if
c_cond
(paren
op_logical_neg
...
id|DBG_MUL
comma
l_string|&quot;SBPCD: ManySession: use %08X for %08X (msf)&bslash;n&quot;
comma
id|blk2msf
c_func
(paren
...
macro_line|#endif MULTISESSION_BY_DRIVER
r_if
c_cond
(paren
id|block
...
c_func
(paren
l_string|&quot;SBPCD: open: bad device: %04X&bslash;n&quot;
comma
id|ip-&gt;i_rdev
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;SBPCD: release: bad device: %04X&bslash;n&quot;
comma
id|ip-&gt;i_rdev
)paren
suffix:semicolon
...
id|DBG_INF
comma
l_string|&quot;SBPCD: Looking for Matsushita, Panasonic, CreativeLabs, IBM, Longshine, TEAC CD-ROM drives&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|DPRINTF
...
id|DBG_INI
comma
l_string|&quot;SBPCD: check_region: %03X is not free.&bslash;n&quot;
comma
id|addr
(braket
l_int|1
...
id|DBG_INF
comma
l_string|&quot;SBPCD: found %d TEAC drives. A wonder.&bslash;n&quot;
comma
id|i
)paren
)paren
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: init: first GetStatus: error_byte=%d&bslash;n&quot;
comma
id|DriveStruct
(braket
id|d
...
id|DBG_LCS
comma
l_string|&quot;SBPCD: init: second GetStatus: error_byte=%d&bslash;n&quot;
comma
id|DriveStruct
(braket
id|d
...
multiline_comment|/*&n; * Turn on the CD audio channels.&n; * For &quot;compatible&quot; soundcards (with &quot;SBPRO 0&quot; or &quot;SBPRO 2&quot;), the addresses&n; * are obtained from SOUND_BASE (see sbpcd.h).&n; */
r_if
c_cond
(paren
(paren
