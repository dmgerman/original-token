...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;3.3 Eberhard Moenkeberg &lt;emoenke@gwdg.de&gt;&quot;
multiline_comment|/*&n; * still testing around...&n; */
DECL|macro|TEAC
mdefine_line|#define TEAC 0 /* set to 1 for TEAC CD-55A detection test (not more) */
...
mdefine_line|#define DISTRIBUTION 1 /* I use it with a 0 here */
macro_line|#if 0
...
c_func
(paren
l_string|&quot;SBPCD: support is not fulfilled yet.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
