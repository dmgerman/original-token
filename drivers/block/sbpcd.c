...
DECL|macro|VERSION
mdefine_line|#define VERSION &quot;2.8 Eberhard Moenkeberg &lt;emoenke@gwdg.de&gt;&quot;
...
l_int|0
comma
multiline_comment|/* Lasermate, CI-101P, WDH-7001C, Galaxy, Reveal (other default) */
l_int|0x340
comma
l_int|0
comma
...
id|DBG_MUL
comma
l_string|&quot;SBPCD: MultiSession Info: %02X %02X %02X %02X %02X %02X %02X %02X&bslash;n&quot;
comma
id|infobuf
(braket
l_int|0
...
l_int|20
suffix:semicolon
multiline_comment|/* preliminary - has to get adjusted the following way:&n;           *   look at the first byte of frames 17 ff. until 0xFF is seen;&n;           *   the frame before this one is the last repetition frame.&n;           */
)brace
)brace
r_return
(paren
...
id|drv_260
suffix:semicolon
multiline_comment|/* still needs a closer look */
r_else
(brace
r_for
c_loop
