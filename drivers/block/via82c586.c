...
multiline_comment|/*&n;&t; * setting Channel read and End-of-sector FIFO flush.&n;&t; * (This feature ensures that FIFO flush is enabled:&n;         *  - for read DMA when interrupt asserts the given channel.&n;         *  - at the end of each sector for the given channel.)&n;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n; *  Sets VIA 82c586 FIFO configuration:&n; *  This chipsets gets a splitable fifo. This can be driven either by command&n; *  line option (eg &quot;splitfifo=2,2,3&quot; which asks this driver to switch all the &n; *  16 fifo levels to the second drive, and give it a threshold of 3 for (u)dma &n; *  triggering.&n; */
...
DECL|function|pci_init_via82c568
r_int
r_int
id|__init
...
DECL|function|ide_dmacapable_via82c586
r_void
