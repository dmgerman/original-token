...
multiline_comment|/* NOTE: we don&squot;t repeat the blk_size check even though we now have a&n;&t;&t; * new device.  stacking drivers are expected to know what&n;&t;&t; * they are doing.&n;&t;&t; */
id|q
op_assign
id|blk_get_queue
c_func
