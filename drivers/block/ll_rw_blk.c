...
suffix:semicolon
multiline_comment|/*&n; * Max number of segments per request&n; */
...
(brace
multiline_comment|/*&n;&t;&t; * If we are not allowed to merge these requests, then&n;&t;&t; * return.  If we are allowed to merge, then the count&n;&t;&t; * will have been updated to the appropriate number,&n;&t;&t; * and we shouldn&squot;t do it here too.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/*&n;&t;      * FIXME(eric) - this entire switch statement is going away&n;&t;      * soon, and we will instead key off of q-&gt;head_active to decide&n;&t;      * whether the top request in the queue is active on the device&n;&t;      * or not.&n;&t;      */
r_case
id|IDE0_MAJOR
suffix:colon
multiline_comment|/* same as HD_MAJOR */
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * The merge_fn is a more advanced way&n;&t;&t;&t;&t; * of accomplishing the same task.  Instead&n;&t;&t;&t;&t; * of applying a fixed limit of some sort&n;&t;&t;&t;&t; * we instead define a function which can&n;&t;&t;&t;&t; * determine whether or not it is safe to&n;&t;&t;&t;&t; * merge the request or not.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|q-&gt;merge_fn
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t;&t;&t; * See if this queue has rules that&n;&t;&t;&t;&t;&t; * may suggest that we shouldn&squot;t merge&n;&t;&t;&t;&t;&t; * this &n;&t;&t;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
macro_line|#else
macro_line|#if !defined (__mc68000__) &amp;&amp; !defined(CONFIG_PPC) &amp;&amp; !defined(__sparc__)&bslash;&n;    &amp;&amp; !defined(CONFIG_APUS) &amp;&amp; !defined(__sh__)
id|outb_p
c_func
(paren
l_int|0xc
