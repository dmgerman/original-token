multiline_comment|/*&n; *  linux/drivers/block/ll_rw_blk.c&n; *&n; * Copyright (C) 1991, 1992 Linus Torvalds&n; * Copyright (C) 1994,      Karl Keyte: Added support for disk statistics&n; * Elevator latency, (C) 2000  Andrea Arcangeli &lt;andrea@suse.de&gt; SuSE&n; * Queue request tables / lock, selectable elevator, Jens Axboe &lt;axboe@suse.de&gt;&n; */
...
comma
op_amp
id|req-&gt;q-&gt;request_freelist
)paren
suffix:semicolon
id|req-&gt;q-&gt;queue_requests
op_decrement
suffix:semicolon
id|wake_up
c_func
