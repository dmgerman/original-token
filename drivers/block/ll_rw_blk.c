...
DECL|macro|DEBUG_ELEVATOR
mdefine_line|#define DEBUG_ELEVATOR
...
DECL|function|get_request_latency
r_static
r_inline
r_int
id|get_request_latency
c_func
(paren
id|elevator_t
op_star
...
DECL|function|seek_to_not_starving_chunk
r_static
r_inline
r_struct
id|list_head
op_star
id|seek_to_not_starving_chunk
c_func
(paren
id|request_queue_t
op_star
...
id|KERN_WARNING
id|__FUNCTION__
l_string|&quot;: req latency %d req latency %d&bslash;n&quot;
comma
id|req-&gt;elevator_sequence
op_minus
id|q-&gt;elevator.sequence
...
id|max_segments
op_assign
id|q-&gt;elevator.max_bomb_segments
suffix:semicolon
id|entry
op_assign
id|seek_to_not_starving_chunk
...
suffix:semicolon
multiline_comment|/* lock got dropped so revalidate elevator */
id|empty
op_assign
l_int|1
suffix:semicolon
...
multiline_comment|/*&n;&t; * Dont start the IO if the buffer has been&n;&t; * invalidated meanwhile. (we have to do this&n;&t; * within the io request lock and atomically&n;&t; * before adding the request, see buffer.c&squot;s&n;&t; * insert_into_queues_exclusive() function.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * A fake &squot;everything went ok&squot; completion event.&n;&t;&t; * The bh doesnt matter anymore, but we should not&n;&t;&t; * signal errors to RAID levels.&n;&t; &t; */
id|bh
op_member_access_from_pointer
id|b_end_io
c_func
