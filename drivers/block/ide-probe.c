multiline_comment|/*&n; *  linux/drivers/block/ide-probe.c&t;Version 1.05&t;July 3, 1999&n; *&n; *  Copyright (C) 1994-1998  Linus Torvalds &amp; authors (see below)&n; */
...
multiline_comment|/*&n;&t; * FIXME(eric) - This needs to be tested.  I *think* that this&n;&t; * is correct.   Also, I believe that there is no longer any&n;&t; * reason to have multiple functions (do_ide[0-7]_request)&n;&t; * functions - the queuedata field could be used to indicate&n;&t; * the correct hardware group - either this, or we could add&n;&t; * a new field to request_queue_t to hold this information.&n;&t; */
id|drive
op_assign
op_amp
id|hwif-&gt;drives
