...
multiline_comment|/* The next two functions were stolen from cmd640.c, with a few modifications  */
...
c_func
(paren
l_string|&quot;%s: failed to read dma_base&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
