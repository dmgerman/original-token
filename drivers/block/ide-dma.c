multiline_comment|/*&n; *  linux/drivers/block/ide-dma.c&t;Version 4.01  November 30, 1997&n; *&n; *  Copyright (c) 1995-1998  Mark Lord&n; *  May be copied or modified under the terms of the GNU General Public License&n; */
...
DECL|macro|DEVID_PDC2046
mdefine_line|#define DEVID_PDC2046&t;(PCI_VENDOR_ID_PROMISE|(PCI_DEVICE_ID_PROMISE_20246   &lt;&lt;16))
...
(brace
multiline_comment|/*&n;&t;&t;&t; * The BM-DMA uses full 32bit addr, so we can&n;&t;&t;&t; * safely use __get_free_page() here instead&n;&t;&t;&t; * of __get_dma_pages() -- no ISA limitations.&n;&t;&t;&t; */
id|dmatable
op_assign
id|__get_free_pages
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* probe later if not set */
r_for
c_loop
(paren
id|port
...
id|pciirq
suffix:semicolon
multiline_comment|/* always probe for secondary irq */
r_if
c_cond
(paren
id|bmiba
...
c_func
(paren
l_string|&quot;%s: %sIDE device on PCI bus %d function %d&bslash;n&quot;
comma
id|d-&gt;name
comma
id|d-&gt;id
...
c_func
(paren
l_string|&quot;%s: device is disabled (BIOS)&bslash;n&quot;
comma
id|d-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: Bus-Master DMA is disabled (BIOS)&bslash;n&quot;
comma
id|d-&gt;name
)paren
suffix:semicolon
