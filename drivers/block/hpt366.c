...
mdefine_line|#define HPT366_ALLOW_ATA33_2&t;&t;1
DECL|macro|HPT366_ALLOW_ATA33_1
mdefine_line|#define HPT366_ALLOW_ATA33_1&t;&t;1
DECL|macro|HPT366_ALLOW_ATA33_0
mdefine_line|#define HPT366_ALLOW_ATA33_0&t;&t;1
r_extern
r_char
op_star
id|ide_xfer_verbose
...
c_func
(paren
l_string|&quot;%s: %s drive%d (0x%08x 0x%08x) 0x%04x&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|ide_xfer_verbose
...
c_func
(paren
l_string|&quot;%s: (ide_dma_timeout) reg52h=0x%02x&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|reg52h
...
c_func
(paren
l_string|&quot;%s: (ide_dma_timeout) reg50h=0x%02x reg52h=0x%02x :: again&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|reg50h
...
c_func
(paren
l_string|&quot;%s: reg5ah=0x%02x ATA-%s Cable Port%d&bslash;n&quot;
comma
id|name
comma
id|ata66
