...
multiline_comment|/* moved here from md.c - will be discarded later */
...
suffix:semicolon
multiline_comment|/* kdevname returns 32 bytes */
multiline_comment|/* disk_name requires 32 bytes */
r_struct
id|gendisk
op_star
id|hd
