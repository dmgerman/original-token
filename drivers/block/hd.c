...
id|printk
(paren
l_string|&quot;  hd%c: non-IDE device, %dMB, CHS=%d/%d/%d&bslash;n&quot;
comma
id|dev
op_plus
l_char|&squot;a&squot;
...
c_func
(paren
l_string|&quot;hd: obsolete syscall: HDIO_SETUNMASKINTR&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* drop into HDIO_SET_UNMASKINTR */
r_case
...
c_func
(paren
l_string|&quot;hd: obsolete syscall: HDIO_SETMULTCOUNT&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* drop into HDIO_SET_MULTCOUNT */
r_case
