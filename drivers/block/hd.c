...
id|printk
(paren
l_string|&quot; Default c/h/s=%d/%d/%d, TrkSize=%d, SectSize=%d, ECCbytes=%d&bslash;n&quot;
comma
id|ib
(braket
l_int|1
...
id|printk
(paren
l_string|&quot;&bslash;n (%s): Current c/h/s=%d/%d/%d, TotSect=%d&quot;
comma
(paren
(paren
(paren
...
id|printk
(paren
l_string|&quot; (%dMB IDE w/%dKB Cache, MaxMult=%d)&bslash;n&quot;
comma
id|ib
(braket
l_int|1
