...
DECL|macro|VERBOSE_DRIVE_INFO
mdefine_line|#define VERBOSE_DRIVE_INFO  0&t;/* set to 1 for more drive info at boot time */
...
macro_line|#if VERBOSE_DRIVE_INFO
DECL|variable|cfg_str
r_char
op_star
id|cfg_str
(braket
...
l_string|&quot;DualPort&quot;
comma
l_string|&quot;DualPortCache&quot;
)brace
suffix:semicolon
DECL|macro|YN
mdefine_line|#define YN(b)&t;(((b)==0)?&quot;no&quot;:&quot;yes&quot;)
DECL|function|dmpstr
r_static
r_void
id|dmpstr
(paren
...
id|printk
(paren
l_string|&quot;hd%c:  Drive Identification Info:&bslash;n&quot;
comma
id|dev
op_plus
...
id|printk
(paren
l_string|&quot; Default CHS=%d/%d/%d, TrkSize=%d, SectSize=%d, ECCbytes=%d&bslash;n&quot;
comma
id|ib
(braket
l_int|1
...
id|printk
(paren
l_string|&quot;, BuffSize=%dKB, MaxMultSect=%d&bslash;n&quot;
comma
id|ib
(braket
l_int|21
...
id|printk
(paren
l_string|&quot; Features: DblWordIO=%s, IORDY=%s, LBA=%s, DMA=%s&quot;
comma
id|YN
c_func
(paren
...
id|printk
(paren
l_string|&quot;&bslash;n (%s): Current CHS=%d/%d/%d, TotSect=%d&quot;
comma
(paren
(paren
(paren
...
c_func
(paren
l_string|&quot;&bslash;n CurMultSect=%d%s&quot;
comma
id|ib
(braket
l_int|59
...
id|printk
(paren
l_string|&quot;, DMA-1w=%04X, DMA-mw=%04X&quot;
comma
id|ib
(braket
l_int|62
...
macro_line|#endif /* VERBOSE_DRIVE_INFO */
...
id|printk
(paren
l_string|&quot;  hd%c: multiple mode not supported&bslash;n&quot;
comma
id|dev
op_plus
l_char|&squot;a&squot;
...
suffix:semicolon
multiline_comment|/* get first 128 ID bytes */
macro_line|#if VERBOSE_DRIVE_INFO
id|dump_identity
c_func
(paren
...
id|printk
(paren
l_string|&quot; (%dMB IDE w/%dKB Cache, MaxMult=%d, CHS=%d/%d/%d)&bslash;n&quot;
comma
id|ib
(braket
l_int|1
...
suffix:semicolon
multiline_comment|/* flush remaining 384 ID bytes */
id|insw
c_func
(paren
id|HD_DATA
