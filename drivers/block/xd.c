...
id|xd_wd_init_drive
comma
l_string|&quot; Western Digital WDXT-GEN2&quot;
)brace
comma
...
c_func
(paren
l_string|&quot;xd_dtc_init_drive: error setting step rate for drive %d&bslash;n&quot;
comma
id|drive
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;xd_dtc_init_drive: error reading geometry for drive %d&bslash;n&quot;
comma
id|drive
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;xd_wd_init_drive: error reading geometry for drive %d&bslash;n&quot;
comma
id|drive
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;xd_seagate_init_drive: error reading geometry from drive %d&bslash;n&quot;
comma
id|drive
)paren
suffix:semicolon
...
l_int|5
suffix:semicolon
multiline_comment|/* the IRQ and DMA channel are fixed on the Omti controllers */
id|xd_dma
op_assign
l_int|3
suffix:semicolon
