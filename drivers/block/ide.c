...
suffix:semicolon
multiline_comment|/*&n;&t; * Handle serialization, regardless of init sequence&n;&t; */
id|mate_hwif
op_assign
op_amp
id|ide_hwifs
...
id|hwif-&gt;serialized
op_logical_and
id|mate_hwif-&gt;present
)paren
(brace
id|hwgroup
op_assign
id|mate_hwif-&gt;hwgroup
suffix:semicolon
id|mate_irq
op_assign
id|mate_hwif-&gt;irq
...
multiline_comment|/*&n;&t; * If another hwif is sharing our irq, then join its hwgroup.&n;&t; */
r_if
c_cond
(paren
id|hwgroup
