...
macro_line|#if !defined(__SMP__) &amp;&amp; defined(DEBUG_SPINLOCKS) &amp;&amp; (DEBUG_SPINLOCKS &gt; 1)
DECL|function|ide_lock_name
r_static
r_const
r_char
op_star
...
DECL|macro|IDE_SPIN_LOCK_IRQ
mdefine_line|#define IDE_SPIN_LOCK_IRQ(msg,spinlock)&t;&t;&t;&t;&bslash;&n;{&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;static int __babble = 20;&t;&t;&t;&t;&bslash;&n;&t;__cli();&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;if ((spinlock)-&gt;lock &amp;&amp; __babble) {&t;&t;&t;&bslash;&n;&t;&t;__babble--;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;printk(&quot;ide_lock: %s: already locked (%s)&bslash;n&quot;, msg, ide_lock_name(spinlock)); &bslash;&n;&t;}&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;/* spin_lock_irq(spinlock); */&t;&t;&t;&t;&bslash;&n;&t;(spinlock)-&gt;lock = 1;&t;&t;&t;&t;&t;&bslash;&n;}
DECL|macro|IDE_SPIN_LOCK_IRQSAVE
mdefine_line|#define IDE_SPIN_LOCK_IRQSAVE(msg,spinlock,flags)&t;&t;&bslash;&n;{&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;__save_flags(flags);&t;&t;&t;&t;&t;&bslash;&n;&t;IDE_SPIN_LOCK_IRQ(msg,spinlock);&t;&t;&t;&bslash;&n;}
DECL|macro|IDE_SPIN_UNLOCK_IRQRESTORE
mdefine_line|#define IDE_SPIN_UNLOCK_IRQRESTORE(msg,spinlock,flags)&t;&t;&bslash;&n;{&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;static int __babble = 20;&t;&t;&t;&t;&bslash;&n;&t;__cli();&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;if (!((spinlock)-&gt;lock) &amp;&amp; __babble) {&t;&t;&t;&bslash;&n;&t;&t;__babble--;&t;&t;&t;&t;&t;&bslash;&n;&t;&t;printk(&quot;ide_unlock: %s: not locked (%s)&bslash;n&quot;, msg, ide_lock_name(spinlock)); &bslash;&n;&t;}&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;/* spin_unlock_irqrestore(msg,spinlock,flags); */&t;&bslash;&n;&t;(spinlock)-&gt;lock = 0;&t;&t;&t;&t;&t;&bslash;&n;&t;restore_flags(flags);&t;&t;&t;&t;&t;&bslash;&n;}
DECL|macro|IDE_SPIN_UNLOCK
mdefine_line|#define IDE_SPIN_UNLOCK(msg,spinlock)&t;&t;&t;&t;&bslash;&n;{&t;&t;&t;&t;&t;&t;&t;&t;&bslash;&n;&t;unsigned long __flags;&t;&t;&t;&t;&t;&bslash;&n;&t;__save_flags(__flags);&t;&t;&t;&t;&t;&bslash;&n;&t;IDE_SPIN_UNLOCK_IRQRESTORE(msg,spinlock,__flags);&t;&bslash;&n;}
macro_line|#else&t;/* DEBUG_SPINLOCKS */
DECL|macro|IDE_SPIN_LOCK_IRQ
mdefine_line|#define IDE_SPIN_LOCK_IRQ(msg,spinlock)&t;&t;&t;spin_lock_irq(spinlock)
DECL|macro|IDE_SPIN_LOCK_IRQSAVE
mdefine_line|#define IDE_SPIN_LOCK_IRQSAVE(msg,spinlock,flags)&t;spin_lock_irqsave(spinlock,flags)
DECL|macro|IDE_SPIN_UNLOCK
mdefine_line|#define IDE_SPIN_UNLOCK(msg,spinlock)&t;&t;&t;spin_unlock(spinlock)
DECL|macro|IDE_SPIN_UNLOCK_IRQRESTORE
mdefine_line|#define IDE_SPIN_UNLOCK_IRQRESTORE(msg,spinlock,flags)&t;spin_unlock_irqrestore(spinlock,flags)
...
suffix:semicolon
id|IDE_SPIN_LOCK_IRQSAVE
c_func
(paren
l_string|&quot;ide_set_handler&quot;
comma
op_amp
id|hwgroup-&gt;spinlock
comma
...
multiline_comment|/*&n; * As of linux-2.1.95, ll_rw_blk.c invokes our do_idex_request()&n; * functions with the io_request_spinlock already grabbed.&n; * Since we need to do our own spinlock&squot;s internally,&n; * on paths that don&squot;t necessarily originate through the&n; * do_idex_request() path.&n; *&n; * We have to undo the spinlock on entry, and restore it again on exit.&n; * Fortunately, this is mostly a nop for non-SMP kernels.&n; */
...
c_func
(paren
l_string|&quot;unlock_do_hwgroup_request&quot;
comma
op_amp
id|io_request_lock
)paren
...
id|do_hwgroup_request
(paren
l_string|&quot;from unlock_do_hwgroup_request&quot;
comma
id|hwgroup
)paren
suffix:semicolon
id|IDE_SPIN_LOCK_IRQ
c_func
(paren
l_string|&quot;unlock_do_hwgroup_request&quot;
comma
...
c_func
(paren
l_string|&quot;timer do_hwgroup_request&quot;
comma
id|hwgroup
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;drive_cmd do_hwgroup_request&quot;
comma
id|hwgroup
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: %s: channel busy&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|msg
