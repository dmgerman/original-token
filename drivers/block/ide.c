...
suffix:semicolon
multiline_comment|/* grab irqs, to ignore next edge */
id|OUT_BYTE
c_func
(paren
id|drive-&gt;ctl
...
suffix:semicolon
multiline_comment|/* restore irqs again */
)brace
r_else
(brace
