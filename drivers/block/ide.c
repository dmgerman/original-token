...
macro_line|#endif
macro_line|#ifdef CONFIG_BLK_DEV_TRITON
multiline_comment|/*&n;&t; * Apparently the BIOS32 services on Intel motherboards are buggy,&n;&t; * and won&squot;t find the PCI_DEVICE_ID_INTEL_82371_1 for us.&n;&t; * So we instead search for PCI_DEVICE_ID_INTEL_82371_0, and then add 1.&n;&t; */
id|ide_probe_pci
(paren
