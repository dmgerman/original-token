...
c_func
(paren
l_string|&quot; -- USE &quot;&quot;ide%c=serialize&quot;&quot; INSTEAD&quot;
comma
l_char|&squot;0&squot;
op_plus
id|hw
...
id|hwgroup
suffix:semicolon
multiline_comment|/*&n;&t; * First, we try to grab the irq&n;&t; */
id|save_flags
c_func
(paren
id|flags
...
multiline_comment|/*&n;&t; * Got the irq,  now set everything else up&n;&t; */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;serialized, disabled read-ahead, enabled secondary&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif /* SUPPORT_CMD640 */
...
(brace
multiline_comment|/* is device enabled? */
id|init
(paren
id|bus
comma
...
c_func
(paren
l_string|&quot;%s: SERIALIZE BUG!&bslash;n&quot;
comma
id|hwif-&gt;name
)paren
suffix:semicolon
