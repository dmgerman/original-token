...
multiline_comment|/* SunDisk drives: treat as non-removeable, force one unit */
r_if
c_cond
(paren
id|id-&gt;model
...
l_int|0
suffix:semicolon
multiline_comment|/* This assumes that there is only one group member */
id|free_irq
c_func
(paren
id|hwif-&gt;irq
