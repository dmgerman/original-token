...
id|fifoconfig
suffix:semicolon
multiline_comment|/* defined in via82cxxx.c used by ide_setup() */
...
multiline_comment|/*&n; * The below two are helpers used when modifying the drive timeout.&n; */
...
DECL|macro|restore_timeout
mdefine_line|#define restore_timeout(drive, old)&t;(drive-&gt;timeout = old)
...
id|handler
suffix:semicolon
multiline_comment|/* 0 means don&squot;t timeout */
r_if
c_cond
(paren
id|drive-&gt;timeout
...
c_func
(paren
l_string|&quot;%s: (disable_irq) %smasked_irq %d&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|masked_irq
...
c_func
(paren
l_string|&quot;%s: (enable_irq) %smasked_irq %d&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|masked_irq
...
macro_line|#endif /* MAX_HWIFS &gt; 6 */
macro_line|#if MAX_HWIFS &gt; 7
DECL|function|do_ide7_request
r_void
id|do_ide7_request
(paren
r_void
...
macro_line|#endif /* MAX_HWIFS &gt; 7 */
macro_line|#if MAX_HWIFS &gt; 8
DECL|function|do_ide8_request
r_void
id|do_ide8_request
(paren
r_void
...
macro_line|#endif /* MAX_HWIFS &gt; 8 */
macro_line|#if MAX_HWIFS &gt; 9
DECL|function|do_ide9_request
r_void
id|do_ide9_request
(paren
r_void
...
l_int|NULL
suffix:semicolon
multiline_comment|/* polling in progress or just don&squot;t timeout */
r_if
c_cond
(paren
id|hwgroup-&gt;poll_timeout
...
suffix:semicolon
multiline_comment|/*&n;&t; *  need something here for HPT34X.......AMH&n;&t; *  irq timeout: status=0x58 { DriveReady SeekComplete DataRequest }&n;&t; */
(paren
r_void
)paren
id|hwgroup-&gt;hwif
...
(brace
multiline_comment|/* &n;&t;&t;&t;&t; * Re-read drive-&gt;id for possible DMA mode &n;&t;&t;&t;&t; * change (copied from ide-probe.c)&n;&t;&t;&t;&t; */
r_struct
id|hd_driveid
op_star
id|id
...
c_func
(paren
l_string|&quot;ide: Enabled support for IDE doublers&bslash;n&quot;
)paren
suffix:semicolon
id|ide_doubler
op_assign
...
macro_line|#if defined(CONFIG_BLK_DEV_VIA82CXXX)
multiline_comment|/*&n;&t; *  Look for drive option &quot;splitfifo=...&quot;&n;&t; */
r_if
c_cond
(paren
id|s
...
l_int|0x3a
suffix:semicolon
multiline_comment|/* default config byte */
id|i
op_assign
id|match_parm
c_func
...
(brace
multiline_comment|/* sets threshold for primary Channel: */
id|byte
id|x
op_assign
l_int|4
...
(brace
multiline_comment|/* sets threshold for secondary Channel: */
id|byte
id|x
op_assign
l_int|4
...
l_int|1
suffix:colon
multiline_comment|/* set the FIFO config between channels to 0: */
id|tmp
op_and_assign
l_int|0x9f
suffix:semicolon
multiline_comment|/* set the needed FIFO config between channels: */
r_if
c_cond
(paren
id|vals
...
multiline_comment|/* primary fifo only */
id|tmp
op_or_assign
l_int|0x10
suffix:semicolon
...
multiline_comment|/* secondary fifo only */
id|tmp
op_or_assign
l_int|0x70
suffix:semicolon
...
multiline_comment|/* other shared fifo config */
id|tmp
op_or_assign
l_int|0x50
suffix:semicolon
...
multiline_comment|/* set the found option in fifoconfig */
id|fifoconfig
op_assign
id|tmp
suffix:semicolon
...
macro_line|#endif  /* defined(CONFIG_BLK_DEV_VIA82CXXX) */
r_if
c_cond
(paren
id|s
