...
c_func
(paren
l_string|&quot;%s: perhaps PCI INTA has not been set to IRQ15?&bslash;n&quot;
comma
id|drive-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: switching secondary interface to legacy mode&bslash;n&quot;
comma
id|drive-&gt;name
)paren
suffix:semicolon
