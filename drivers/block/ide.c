...
id|fifoconfig
suffix:semicolon
multiline_comment|/* defined in via82c586.c used by ide_setup()*/
macro_line|#endif
...
macro_line|#if defined(CONFIG_BLK_DEV_VIA82C586)
...
macro_line|#endif  /* defined(CONFIG_BLK_DEV_VIA82C586) */
r_if
c_cond
(paren
id|s
