...
multiline_comment|/* IDE_DRIVE_CMD is used to implement many features of the hdparm utility */
...
mdefine_line|#define IDE0_TIMER&t;&t;HD_TIMER
...
DECL|macro|OPTIMIZE_IRQS
mdefine_line|#define OPTIMIZE_IRQS&t;&t;0
DECL|macro|SUPPORT_SHARING_IRQ
macro_line|#undef&t;SUPPORT_SHARING_IRQ
DECL|macro|SUPPORT_SHARING_IRQ
mdefine_line|#define SUPPORT_SHARING_IRQ&t;0
macro_line|#ifdef CONFIG_BLK_DEV_HD
DECL|macro|HWIF
...
multiline_comment|/*&n; * Now for the data we need to maintain per-device:  ide_dev_t&n; *&n; * For fast indexing, sizeof(ide_dev_t) = 32 = power_of_2;&n; * Everything is carefully aligned on appropriate boundaries,&n; *  and several fields are placed for optimal (gcc) access.&n; *&n; * Ugh.  Actually, we&squot;re two bytes over (34 bytes).. gotta fix this someday.&n; */
...
DECL|member|be_quiet
r_int
id|be_quiet
suffix:colon
l_int|1
suffix:semicolon
multiline_comment|/* supress &quot;multiple mode&quot; msg at boot */
DECL|member|special
id|special_t
id|special
suffix:semicolon
...
multiline_comment|/*&n; * Returns:&t;0  device was identified&n; *&t;&t;1  device timed-out (no response to identify request)&n; *&t;&t;2  device aborted the command (refused to identify itself)&n; *&t;&t;3  bad status from device (possible for ATAPI drives)&n; *&t;&t;4  probe was not attempted&n; */
(brace
r_int
id|rc
suffix:semicolon
...
multiline_comment|/*&n; * Returns:&t;0  no device was found&n; *&t;&t;1  device was found (note: dev-&gt;present might still be 0)&n; */
(brace
r_if
c_cond
(paren
...
multiline_comment|/* second drive should only exist if first drive was found */
r_if
c_cond
(paren
id|probe_for_drive
...
l_int|1
suffix:semicolon
multiline_comment|/* don&squot;t probe for this drive */
r_return
suffix:semicolon
)brace
r_if
...
id|BAD_R_STAT
suffix:semicolon
multiline_comment|/* ignore WRERR_STAT */
r_return
suffix:semicolon
)brace
macro_line|#ifdef CONFIG_BLK_DEV_IDECD
