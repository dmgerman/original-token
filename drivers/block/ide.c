...
suffix:semicolon
multiline_comment|/*&n;&t; *  WIN_IDENTIFY returns little-endian info,&n;&t; *  WIN_PIDENTIFY return big-endian info.&n;&t; */
id|bswap
op_assign
(paren
id|cmd
