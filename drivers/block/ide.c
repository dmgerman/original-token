...
c_func
(paren
l_string|&quot;%s: cmd640 reg 09h == 0x%02x&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|get_cmd640_reg
...
c_func
(paren
l_string|&quot;%s: cmd640 reg 51h == 0x%02x&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|get_cmd640_reg
