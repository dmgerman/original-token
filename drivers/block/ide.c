...
DECL|macro|ANDRIES_GEOMETRY
mdefine_line|#define ANDRIES_GEOMETRY&t;0
...
id|drive
suffix:semicolon
macro_line|#if ANDRIES_GEOMETRY
multiline_comment|/*&n;&t; * This is the documented list of values (some version of)&n;&t; * OnTrack DM uses.&n;&t; */
r_static
r_const
id|byte
id|dm_head_vals
...
suffix:semicolon
multiline_comment|/*&n;&t; * This is a pure phantasy list - known to be incorrect.&n;&t; *&n;&t; * In fact it seems that EZD does not do anything to the CHS&n;&t; * values in the partition table, so whether EZD is present&n;&t; * or not should probably not influence the geometry.&n;&t; */
r_static
r_const
id|byte
id|ez_head_vals
...
macro_line|#endif /* FAKE_FDISK_FOR_EZDRIVE */
(brace
multiline_comment|/*&n;&t;&t;&t; * Update the current 3D drive values.&n;&t;&t;&t; */
id|drive-&gt;id-&gt;cur_cyls
op_assign
id|drive-&gt;bios_cyl
suffix:semicolon
...
macro_line|#else /* ANDRIES_GEOMETRY */
r_static
r_const
id|byte
id|head_vals
...
macro_line|#endif /* ANDRIES_GEOMETRY */
id|drive-&gt;part
(braket
l_int|0
)braket
