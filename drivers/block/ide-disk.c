...
l_int|10
suffix:semicolon
multiline_comment|/*&n;&t; * very large drives (8GB+) may lie about the number of cylinders&n;&t; * This is a split test for drives 8 Gig and Bigger only.&n;&t; */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;Fixing Geometry :: CHS=%d/%d/%d to CHS=%d/%d/%d&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;     CurSects=%d, LBASects=%d, &quot;
comma
op_star
(paren
r_int
...
c_func
(paren
l_string|&quot;Fixed CurSects=%d&bslash;n&quot;
comma
op_star
(paren
r_int
