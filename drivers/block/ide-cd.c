...
r_else
(brace
multiline_comment|/* for RAW and MODE2. */
id|blocksize
op_assign
id|CD_FRAMESIZE_RAW
suffix:semicolon
...
(brace
multiline_comment|/* For Mode2, skip the Sync, Header, and Subheader */
id|copy_to_user_ret
c_func
(paren
(paren
