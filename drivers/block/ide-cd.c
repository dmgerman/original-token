...
multiline_comment|/* Note that this takes speed in kbytes/second, so don&squot;t try requesting&n;   silly speeds like 2 here. Common speeds include:&n;     176 kbytes/second  --  1x&n;     353 kbytes/second  --  2x&n;     387 kbytes/second  --  2.2x&n;     528 kbytes/second  --  3x&n;     706 kbytes/second  --  4x&n;     1400 kbytes/second --  8x&n;     2800 kbytes/second --  16x&n;   ATAPI drives are free to select the speed you request or any slower&n;   rate :-( Requesting too fast a speed will _not_ produce an error. */
r_static
r_int
...
singleline_comment|//pc.c[4] = (speed &gt;&gt; 8) &amp; 0xff;&t;
multiline_comment|/* Write Drive speed in kbytes/second LSB */
singleline_comment|//pc.c[5] = speed &amp; 0xff;
r_return
id|cdrom_queue_packet_command
(paren
id|drive
...
id|stat
suffix:semicolon
multiline_comment|/* Now that that is done, update the speed fields */
r_do
(brace
