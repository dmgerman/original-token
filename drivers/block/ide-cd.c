...
suffix:semicolon
multiline_comment|/* we have to cheat a little here. the packet will eventually&n;&t; * be queued with ide_cdrom_packet(), which extracts the&n;&t; * drive from cdi-&gt;handle. Since this device hasn&squot;t been&n;&t; * registered with the Uniform layer yet, it can&squot;t do this.&n;&t; * Same goes cdi-&gt;ops.&n;&t; */
id|cdi-&gt;handle
op_assign
(paren
id|ide_drive_t
