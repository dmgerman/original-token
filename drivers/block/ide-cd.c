...
"&f;"
multiline_comment|/****************************************************************************&n; * drive_cmd handling.&n; *&n; * Most of the functions accessed via drive_cmd are not valid for ATAPI&n; * devices.  Only attempt to execute those which actually should be valid.&n; */
r_static
DECL|function|cdrom_do_drive_cmd
r_void
id|cdrom_do_drive_cmd
(paren
id|ide_drive_t
op_star
id|drive
...
(brace
macro_line|#if 0  /* This bit isn&squot;t done yet... */
r_if
c_cond
(paren
id|args
...
id|printk
(paren
l_string|&quot;%s: Unsupported drive command %02x %02x %02x&bslash;n&quot;
comma
id|drive-&gt;name
comma
id|args
...
multiline_comment|/* Vertos 300.&n;       There seem to be at least two different, incompatible versions&n;       of this drive floating around.  Luckily, they appear to return their&n;       id strings with different byte orderings. */
r_else
r_if
c_cond
(paren
