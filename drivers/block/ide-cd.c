...
multiline_comment|/* if the media has changed, check if a disc is in the drive&n;&t;   and read the toc info. */
r_if
c_cond
(paren
id|retval
...
(brace
multiline_comment|/* if cdrom_read_toc fails, return 1 to indicate&n;&t;&t;   that a disc change has occured. there might not&n;&t;&t;   be a disc in the drive. */
r_if
c_cond
(paren
(paren
