...
suffix:semicolon
multiline_comment|/*&n; * Interrupt routine to read the final status from a transfer.&n; */
DECL|function|cdrom_read_intr_2
r_static
r_void
id|cdrom_read_intr_2
(paren
id|ide_dev_t
op_star
id|dev
...
r_return
suffix:semicolon
multiline_comment|/* Error bit not set.&n;     Read the device registers to see how much data is waiting. */
id|len
op_assign
id|IN_BYTE
(paren
...
id|printk
(paren
l_string|&quot;cdrom_read_intr: funny value for read length %d&bslash;n&quot;
comma
id|len
)paren
suffix:semicolon
...
id|CD_FRAMESIZE
suffix:semicolon
multiline_comment|/* Wait for another interrupt with the final status. */
id|ide_handler
(braket
id|dev-&gt;hwif
)braket
...
l_int|1
suffix:semicolon
multiline_comment|/* lsb of transfer length */
...
id|printk
(paren
l_string|&quot;cdrom_start_read: funny request 0x%lx 0x%lx&bslash;n&quot;
comma
id|rq-&gt;current_nr_sectors
comma
id|rq-&gt;sector
...
(brace
multiline_comment|/* This can happen if there was an I/O error on the previous&n;         buffer in this request. */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n; * TODO:&n; *  Retrieve and interpret extended ATAPI error codes.&n; *  Transfer multiple sectors at once.&n; *  Read actual disk capacity.&n; *  Support demand-paged executables (1k block sizes?).&n; *  Multisession support.&n; *  Direct reading of audio data.&n; *  Eject-on-dismount.&n; *  Lock door while there&squot;s a mounted volume.&n; */
eof
