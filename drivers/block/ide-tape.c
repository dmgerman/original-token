...
mdefine_line|#define IDETAPE_MIN_PIPELINE_STAGES&t;100
DECL|macro|IDETAPE_MAX_PIPELINE_STAGES
mdefine_line|#define IDETAPE_MAX_PIPELINE_STAGES&t;200
...
multiline_comment|/*&n;&t; *&t;Position information&n;&t; */
...
DECL|macro|IDETAPE_PC_RQ
mdefine_line|#define IDETAPE_PC_RQ&t;&t;&t;90
...
mdefine_line|#define IDETAPE_LAST_RQ&t;&t;&t;94
...
DECL|macro|IDETAPE_MAX
mdefine_line|#define&t;IDETAPE_MAX(a,b)&t;((a)&gt;(b) ? (a):(b))
...
multiline_comment|/*&n; *&t;idetape_poll_for_dsc gets invoked by a timer (which was set&n; *&t;by idetape_postpone_request) to reinsert our postponed request&n; *&t;into the request queue.&n; *&n; * &t;Note that the procedure done here is different than the method&n; *&t;we are using in idetape_queue_pc_head - There we are putting&n; *&t;request(s) before our currently called request.&n; *&n; *&t;Here, on the other hand, HWGROUP(drive)-&gt;rq is not our request&n; *&t;but rather a request to another device. Therefore, we will let&n; *&t;it finish and only then service our postponed request --&gt; We don&squot;t&n; *&t;touch HWGROUP(drive)-&gt;rq.&n; */
...
(paren
id|KERN_ERR
l_string|&quot;tape-&gt;postponed_rq is NULL in idetape_poll_for_dsc&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
suffix:semicolon
macro_line|#endif /* IDETAPE_DEBUG_BUGS */
multiline_comment|/*&n;&t; *&t;Set the timer parameters.&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *&t;Insert the next request into the request queue.&n;&t;&t;&t; *&t;The choice of using ide_next or ide_end is now left to the user.&n;&t;&t;&t; */
...
(paren
id|KERN_ERR
l_string|&quot;ide-tape: unsupported page code in create_mode_sense_cmd&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif /* IDETAPE_DEBUG_BUGS */
id|pc-&gt;callback
...
id|printk
(paren
l_string|&quot;ide-tape: tape-&gt;last_stage == NULL&bslash;n&quot;
)paren
suffix:semicolon
r_else
macro_line|#endif /* IDETAPE_DEBUG_BUGS */
...
id|memset
(paren
id|tape-&gt;merge_stage-&gt;bh-&gt;b_data
op_plus
id|tape-&gt;merge_stage-&gt;bh-&gt;b_count
comma
l_int|0
comma
id|i
...
multiline_comment|/*&n;&t; *&t;Select the &quot;best&quot; DSC read/write polling frequency.&n;&t; *&t;The following algorithm attempts to find a balance between&n;&t; *&t;good latency and good system throughput. It will be nice to&n;&t; *&t;have all this configurable in run time at some point.&n;&t; */
id|t1
op_assign
(paren
id|tape-&gt;stage_size
...
(paren
id|KERN_NOTICE
l_string|&quot;ide-tape: we will use %lu jiffies&bslash;n&quot;
comma
id|tape-&gt;best_dsc_rw_frequency
)paren
suffix:semicolon
