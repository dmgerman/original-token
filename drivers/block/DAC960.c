...
mdefine_line|#define DAC960_DriverVersion                  &quot;2.3.5&quot;
DECL|macro|DAC960_DriverDate
mdefine_line|#define DAC960_DriverDate                     &quot;23 January 2000&quot;
...
c_func
(paren
l_string|&quot;Physical Drive %d:%d Not Responding&bslash;n&quot;
comma
id|Controller
comma
id|Parameter1
...
c_func
(paren
l_string|&quot;Physical Drive %d:%d COD Mismatch&bslash;n&quot;
comma
id|Controller
comma
id|Parameter1
...
DECL|function|DAC_back_merge_fn
r_static
r_int
id|DAC_back_merge_fn
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|DAC_front_merge_fn
r_static
r_int
id|DAC_front_merge_fn
c_func
(paren
id|request_queue_t
op_star
...
DECL|function|DAC_merge_requests_fn
r_static
r_int
id|DAC_merge_requests_fn
c_func
(paren
id|request_queue_t
op_star
...
id|DAC960_MonitoringCommand
op_logical_and
id|Controller-&gt;RebuildFlagPending
)paren
(brace
id|DAC960_Enquiry_T
op_star
...
op_assign
id|Controller-&gt;PendingRebuildFlag
suffix:semicolon
id|Controller-&gt;RebuildFlagPending
op_assign
l_bool|false
...
suffix:semicolon
r_case
id|DAC960_RebuildSuccessfullyTerminated
suffix:colon
id|DAC960_Progress
c_func
(paren
...
id|DAC960_MonitoringCommand
op_logical_and
id|Controller-&gt;RebuildStatusPending
)paren
(brace
id|Command-&gt;CommandStatus
op_assign
id|Controller-&gt;PendingRebuildStatus
suffix:semicolon
id|Controller-&gt;RebuildStatusPending
op_assign
l_bool|false
...
multiline_comment|/*&n;       * Leonard, I&squot;ll tie you, draw around you a pentagram&n;       * and read this file. Aloud. &n;       */
id|grok_partitions
c_func
(paren
op_amp
