...
suffix:semicolon
multiline_comment|/*&n;  DAC960_FileOperations is the File Operations structure for DAC960 Logical&n;  Disk Devices.&n;*/
r_static
id|FileOperations_T
...
multiline_comment|/*&n;  DAC960_CreateProcEntries creates the /proc/rd/... entries for the DAC960&n;  Driver.&n;*/
...
id|ControllerNumber
suffix:semicolon
id|DAC960_ProcDirectoryEntry.name
op_assign
l_string|&quot;rd&quot;
suffix:semicolon
id|DAC960_ProcDirectoryEntry.namelen
op_assign
id|strlen
c_func
(paren
...
suffix:semicolon
id|DAC960_ProcDirectoryEntry.mode
op_assign
id|S_IFDIR
op_or
id|S_IRUGO
...
suffix:semicolon
id|StatusProcEntry.name
op_assign
l_string|&quot;status&quot;
suffix:semicolon
id|StatusProcEntry.namelen
op_assign
id|strlen
c_func
(paren
...
suffix:semicolon
id|StatusProcEntry.mode
op_assign
id|S_IFREG
op_or
id|S_IRUGO
suffix:semicolon
id|StatusProcEntry.read_proc
op_assign
id|DAC960_ProcReadStatus
suffix:semicolon
id|proc_register
...
suffix:semicolon
id|ControllerProcEntry-&gt;name
op_assign
id|Controller-&gt;ControllerName
suffix:semicolon
id|ControllerProcEntry-&gt;namelen
op_assign
id|strlen
c_func
(paren
...
op_assign
op_amp
id|Controller-&gt;InitialStatusProcEntry
suffix:semicolon
id|InitialStatusProcEntry-&gt;name
op_assign
l_string|&quot;initial_status&quot;
suffix:semicolon
id|InitialStatusProcEntry-&gt;namelen
op_assign
id|strlen
c_func
(paren
...
suffix:semicolon
id|InitialStatusProcEntry-&gt;mode
op_assign
id|S_IFREG
op_or
id|S_IRUGO
suffix:semicolon
id|InitialStatusProcEntry-&gt;data
op_assign
id|Controller
suffix:semicolon
id|InitialStatusProcEntry-&gt;read_proc
op_assign
id|DAC960_ProcReadInitialStatus
suffix:semicolon
id|proc_register
...
op_assign
op_amp
id|Controller-&gt;CurrentStatusProcEntry
suffix:semicolon
id|CurrentStatusProcEntry-&gt;name
op_assign
l_string|&quot;current_status&quot;
suffix:semicolon
id|CurrentStatusProcEntry-&gt;namelen
op_assign
id|strlen
c_func
(paren
...
suffix:semicolon
id|CurrentStatusProcEntry-&gt;mode
op_assign
id|S_IFREG
op_or
id|S_IRUGO
suffix:semicolon
id|CurrentStatusProcEntry-&gt;data
op_assign
id|Controller
suffix:semicolon
id|CurrentStatusProcEntry-&gt;read_proc
op_assign
id|DAC960_ProcReadCurrentStatus
suffix:semicolon
id|proc_register
...
op_assign
op_amp
id|Controller-&gt;UserCommandProcEntry
suffix:semicolon
id|UserCommandProcEntry-&gt;name
op_assign
l_string|&quot;user_command&quot;
suffix:semicolon
id|UserCommandProcEntry-&gt;namelen
op_assign
id|strlen
c_func
(paren
...
id|S_IRUSR
suffix:semicolon
id|UserCommandProcEntry-&gt;data
op_assign
id|Controller
suffix:semicolon
id|UserCommandProcEntry-&gt;read_proc
op_assign
id|DAC960_ProcReadUserCommand
suffix:semicolon
...
id|proc_root
comma
id|DAC960_ProcDirectoryEntry.low_ino
)paren
suffix:semicolon
)brace
