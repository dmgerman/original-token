...
multiline_comment|/*&n; * High speed xor_block operation for RAID4/5 pipelined for Alpha EV5.&n; * There is a second version using EV6 prefetch instructions.&n; *&n; * Copyright (C) 2000 Richard Henderson (rth@redhat.com)&n; */
DECL|function|XORBLOCK_TEMPLATE
id|XORBLOCK_TEMPLATE
c_func
(paren
...
"$"
l_int|18
macro_line|# 5 cycles from $18 load
op_xor
"$"
l_int|1
comma
...
"$"
l_int|21
macro_line|# 5 cycles from $21 load
id|stq
"$"
l_int|2
comma
...
"$"
l_int|16
macro_line|# 7 cycles from $16 load
id|stq
"$"
l_int|16
comma
...
"$"
l_int|19
macro_line|# 7 cycles from $19 load
id|stq
"$"
l_int|19
comma
...
"$"
l_int|16
macro_line|# 4 cycles from $16 load
id|stq
"$"
l_int|5
comma
...
"$"
l_int|17
macro_line|# 7 cycles from $17 load
op_xor
"$"
l_int|5
comma
...
"$"
l_int|21
macro_line|# 8 cycles from $21 load
id|ldq
"$"
l_int|6
comma
...
"$"
l_int|17
macro_line|# 8 cycles from $17 load
op_xor
"$"
l_int|7
comma
...
"$"
l_int|19
macro_line|# 5 cycles from $19 load
op_xor
"$"
l_int|20
comma
...
"$"
l_int|19
macro_line|# 8 cycles from $19 load
id|stq
"$"
l_int|17
comma
...
"$"
l_int|20
macro_line|# 8 cycles from $20 load
id|ldq
"$"
l_int|4
comma
...
"$"
l_int|18
macro_line|# 6 cycles from $18 load
id|ldq
"$"
l_int|5
comma
...
multiline_comment|/* ARG! We&squot;ve run out of asm arguments!  We&squot;ve got to reload&n;&t;   all those pointers we just loaded.  */
suffix:colon
l_string|&quot;r&quot;
(paren
id|bh_ptr
...
DECL|macro|prefetch
mdefine_line|#define prefetch(base, ofs) &bslash;&n;&t;asm(&quot;ldq $31,%2(%0)&quot; : &quot;=r&quot;(base) : &quot;0&quot;(base), &quot;i&quot;(ofs))
DECL|function|XORBLOCK_TEMPLATE
id|XORBLOCK_TEMPLATE
c_func
(paren
...
"$"
l_int|19
macro_line|# 6 cycles from $19 load
id|ldq
"$"
l_int|31
comma
...
"$"
l_int|21
macro_line|# 6 cycles from $21 load
id|ldq
"$"
l_int|31
comma
...
(brace
multiline_comment|/* Force the use of alpha_prefetch if EV6, as it&n;&t;&t;   is significantly faster in the cold cache case.  */
id|fastest
op_assign
op_amp
id|t_xor_block_alpha_prefetch
suffix:semicolon
)brace
macro_line|#endif
id|xor_block
