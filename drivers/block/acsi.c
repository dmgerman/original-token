multiline_comment|/*&n; * acsi.c -- Device driver for Atari ACSI hard disks&n; *&n; * Copyright 1994 Roman Hodek &lt;Roman.Hodek@informatik.uni-erlangen.de&gt;&n; *&n; * Some parts are based on hd.c by Linus Thorvalds&n; *&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file COPYING in the main directory of this archive for&n; * more details.&n; *&n; */
...
multiline_comment|/* The data returned by MODE SENSE differ between the old Atari&n; * harddisks and SCSI disks connected to ACSI. In the following, both&n; * formats are defined and some macros to operate on them potably.&n; */
r_typedef
r_struct
(brace
DECL|member|dummy
...
(brace
multiline_comment|/* I left out the GETGEO cmd; This doesn&squot;t make much sense for&n;&t;&t; * ACSI disks...&n;&t;&t; */
r_case
id|BLKGETSIZE
suffix:colon
...
suffix:semicolon
macro_line|#endif
DECL|variable|acsi_symbol_table
r_static
r_struct
id|symbol_table
id|acsi_symbol_table
op_assign
(brace
