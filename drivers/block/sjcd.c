multiline_comment|/*&n; *   Sanyo CD-ROM device driver implementation.&n; *&n; *   Copyright (C) 1995  Vadim V. Model&n; *&n; *   model@cecmow.enet.dec.com&n; *   vadim@rbrf.msk.su&n; *   vadim@ipsun.ras.ru&n; *&n; *  This driver is based on pre-works by Eberhard Moenkeberg (emoenke@gwdg.de);&n; *  it was developed under use of mcd.c from Martin Harriss, with help of&n; *  E. van der Maarel (maarel@marin.nl).&n; *&n; *  It is planned to include these routines into sbpcd.c later - to make&n; *  a &quot;mixed use&quot; on one cable possible for all kinds of drives which use&n; *  the SoundBlaster/Panasonic style CDROM interface. But today, the&n; *  ability to install directly from CDROM is more important than flexibility.&n; *&n; *  This program is free software; you can redistribute it and/or modify&n; *  it under the terms of the GNU General Public License as published by&n; *  the Free Software Foundation; either version 2 of the License, or&n; *  (at your option) any later version.&n; *&n; *  This program is distributed in the hope that it will be useful,&n; *  but WITHOUT ANY WARRANTY; without even the implied warranty of&n; *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; *  GNU General Public License for more details.&n; *&n; *  You should have received a copy of the GNU General Public License&n; *  along with this program; if not, write to the Free Software&n; *  Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; */
...
macro_line|#ifdef CONFIG_ISP_16
...
multiline_comment|/*&n; * Set up device. Not yet implemented.&n; */
...
c_func
(paren
l_string|&quot;Sanyo CDR-H94A device driver setup is called (%s).&bslash;n&quot;
comma
id|str
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n; * Following staff is intended for initialization of the cdrom. It&n; * first looks for presence of device. If the device is present, it&n; * will be reset. Then read the version of the drive and load status.&n; */
r_static
r_struct
(brace
DECL|member|major
...
c_func
(paren
l_string|&quot;skip sjcd_init&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|mem_start
...
macro_line|#ifdef CONFIG_ISP_16
multiline_comment|/*&n;   * Initialize the CDROM interface of the card.&n;   */
id|isp16_cdi_setup
c_func
(paren
id|ISP_CDROM_SANYO
...
id|ISP_CDROM_IRQ_10
comma
id|ISP_CDROM_DMA_DISABLED
comma
id|ISP_CDROM_PORT_340
)paren
suffix:semicolon
macro_line|#endif
macro_line|#if 0
