...
mdefine_line|#define cm206_base cm206 /* for compatible &quot;insmod&quot; parameter passing */
...
id|CM206_IRQ
suffix:semicolon
multiline_comment|/* must directly follow cm206_base */
DECL|macro|DEBUG
...
id|CDROM_LBA
suffix:semicolon
multiline_comment|/* too bad if fsm requested! */
r_return
l_int|1
suffix:semicolon
)brace
...
macro_line|#endif
multiline_comment|/* Wow is this piece of #ifdeffing ugly! */
macro_line|#ifdef MODULE
DECL|macro|OK
...
id|i
suffix:semicolon
macro_line|#ifdef AUTO_PROBE_MODULE
r_if
c_cond
(paren
op_logical_neg
