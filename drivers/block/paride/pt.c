...
mdefine_line|#define PT_VERSION      &quot;1.0&quot;
DECL|macro|PT_MAJOR
...
DECL|macro|PT_TMO
mdefine_line|#define PT_TMO          800             /* interrupt timeout in jiffies */
DECL|macro|PT_SPIN_DEL
mdefine_line|#define PT_SPIN_DEL     50              /* spin delay in micro-seconds  */
DECL|macro|PT_RESET_TMO
mdefine_line|#define PT_RESET_TMO    30&t;&t;/* 3 seconds */
...
DECL|macro|PT_SPIN
mdefine_line|#define PT_SPIN         (10000/PT_SPIN_DEL)*PT_TMO  
DECL|macro|STAT_ERR
...
mdefine_line|#define DEVICE_NR(x)&t;(x % 128)
