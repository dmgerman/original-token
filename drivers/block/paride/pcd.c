...
mdefine_line|#define PCD_READY_TMO&t;    20
DECL|macro|PCD_SPIN
mdefine_line|#define PCD_SPIN&t;&t;(10000/PCD_DELAY)*PCD_TMO
DECL|macro|IDE_ERR
...
suffix:semicolon
DECL|macro|PCD_NAMELEN
mdefine_line|#define PCD_NAMELEN&t;8
...
c_func
(paren
l_string|&quot;%s: %s is not a CDROM&bslash;n&quot;
comma
id|PCD.name
comma
id|PCD.drive
...
c_func
(paren
l_string|&quot;%s: No CDROM drive found&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
