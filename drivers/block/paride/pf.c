...
DECL|macro|PF_SPIN
mdefine_line|#define PF_SPIN         (10000/PF_SPIN_DEL)*PF_TMO  
DECL|macro|STAT_ERR
...
DECL|macro|DBMSG
mdefine_line|#define DBMSG(msg)      NULL
...
c_func
(paren
l_string|&quot;%s: OUCH: b_reqnext != NULL&bslash;n&quot;
comma
id|PF.name
)paren
suffix:semicolon
