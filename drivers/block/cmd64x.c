multiline_comment|/* $Id: cmd64x.c,v 1.20 1999/12/30 03:48:37&n; *&n; * cmd64x.c: Enable interrupts at initialization time on Ultra/PCI machines.&n; *           Note, this driver is not used at all on other systems because&n; *           there the &quot;BIOS&quot; has done all of the following already.&n; *           Due to massive hardware bugs, UltraDMA is only supported&n; *           on the 646U2 and not on the 646U.&n; *&n; * Copyright (C) 1998       Eddie C. Dost  (ecd@skynet.be)&n; * Copyright (C) 1998       David S. Miller (davem@dm.cobaltmicro.com)&n; * Copyright (C) 1999       Andre Hedrick (andre@suse.com)&n; */
