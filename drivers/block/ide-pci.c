multiline_comment|/*&n; *  linux/drivers/block/ide-pci.c&t;Version 1.03  May 1, 1999&n; *&n; *  Copyright (c) 1998-1999  Andre Hedrick&n; *&n; *  Copyright (c) 1995-1998  Mark Lord&n; *  May be copied or modified under the terms of the GNU General Public License&n; */
...
suffix:semicolon
multiline_comment|/* FIXME - this is too ugly, and looks senseless. Why not just use resource[4]? */
id|dev-&gt;resource
(braket
l_int|0
)braket
