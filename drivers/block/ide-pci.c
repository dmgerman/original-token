...
c_func
(paren
l_string|&quot;%s: IDE controller run unsupported mode three!!!&bslash;n&quot;
comma
id|d2-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: IDE controller report to &lt;andre@suse.com&gt;&bslash;n&quot;
comma
id|d-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: OVERRIDE IDE controller not advisable this mode!!!&bslash;n&quot;
comma
id|d2-&gt;name
)paren
suffix:semicolon
...
DECL|function|ide_forward_scan_pcibus
r_void
id|__init
id|ide_forward_scan_pcibus
(paren
r_void
)paren
(brace
...
DECL|function|ide_reverse_scan_pcibus
r_void
id|__init
id|ide_reverse_scan_pcibus
(paren
r_void
)paren
(brace
