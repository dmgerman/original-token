...
mdefine_line|#define CDU31A_READAHEAD 64  /* 64 sector, 32kB, 16 reads read-ahead */
...
suffix:semicolon
multiline_comment|/* Points to the&n;&t;&t;&t;&t;&t;&t;&t;     table of&n;&t;&t;&t;&t;&t;&t;&t;     contents. */
...
multiline_comment|/* A disk changed variable for every possible session.  When a disk change&n;   is detected, these will all be set to TRUE.  As the upper layers ask&n;   for disk_changed status for individual minor numbers, they will be&n;   cleared. */
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Used for 1024 byte blocksize. */
...
suffix:semicolon
multiline_comment|/* Check for multi-session disks. */
r_if
c_cond
(paren
id|dev
...
c_func
(paren
l_string|&quot;CDU31A: Invalid device request: %d&bslash;n&quot;
comma
id|dev
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;CDU31A: session TOC not read: %d&bslash;n&quot;
comma
id|dev
)paren
suffix:semicolon
...
multiline_comment|/* Check for base read of multi-session disk. */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;CDU31A: Not a multi-session disk: %d&bslash;n&quot;
comma
id|dev
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;CDU31A: Request for invalid TOC track: %d&bslash;n&quot;
comma
id|dev
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;CDU31A: Unable to alloc mem for TOC&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
multiline_comment|/* For points that do not exist, move the data over them&n;            to the right location. */
r_if
c_cond
(paren
id|ses_tocs
...
multiline_comment|/* A negative irq_used will attempt an autoirq. */
r_if
c_cond
(paren
id|irq_used
