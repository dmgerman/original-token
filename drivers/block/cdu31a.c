...
op_increment
suffix:semicolon
multiline_comment|/* Issue a reset on an error (the second time), otherwise just delay */
r_if
c_cond
(paren
id|num_retries
