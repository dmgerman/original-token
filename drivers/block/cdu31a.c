...
(brace
multiline_comment|/*&n;          * The drive has to be polled for status on a byte-by-byte basis&n;          * to know if the data is ready.  Yuck.  I really wish I could use DMA.&n;          */
id|clear_data_ready
c_func
(paren
)paren
...
multiline_comment|/*&n; * Do a command that does not involve data transfer.&n; */
r_static
r_void
...
multiline_comment|/*&n; * Handle an attention from the drive.  This will return 1 if it found one&n; * or 0 if not (if one is found, the caller might want to call again).&n; */
r_static
r_int
...
c_func
(paren
l_string|&quot;, capable of audio playback&quot;
)paren
suffix:semicolon
)brace
id|printk
