...
op_assign
l_string|&quot;$Id: ixj.c,v 3.4 1999/12/16 22:18:36 root Exp root $&quot;
suffix:semicolon
...
r_else
singleline_comment|//  Internet LineJACK, Internet PhoneJACK Lite or
...
singleline_comment|//    printk(KERN_INFO &quot;Opening board %d&bslash;n&quot;, NUM(inode-&gt;i_rdev));
id|printk
c_func
(paren
id|KERN_INFO
...
suffix:semicolon
singleline_comment|// Send apps notice of frame
)brace
)brace
)brace
...
suffix:semicolon
singleline_comment|// Send apps notice of empty buffer
macro_line|#ifdef PERFMON_STATS
op_increment
id|j-&gt;frameswritten
suffix:semicolon
...
suffix:semicolon
singleline_comment|// Stop playback
id|j-&gt;play_mode
op_assign
op_minus
l_int|1
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;First initialise the queues&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Now we can probe&n;&t; */
r_if
c_cond
(paren
id|ixjdebug
...
suffix:semicolon
singleline_comment|//  if (ixj_major)
singleline_comment|//    unregister_chrdev(ixj_major, &quot;ixj&quot;);
r_for
c_loop
(paren
id|cnt
...
c_func
(paren
l_string|&quot;Internet PhoneJACK/Internet LineJACK module - www.quicknet.net&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
...
(paren
id|KERN_INFO
l_string|&quot;ixj: found card at 0x%x&bslash;n&quot;
comma
id|ixj
(braket
id|cnt
...
multiline_comment|/*    if(j-&gt;ver.low != 0x12)&n;   {&n;   if(ixj_WriteDSPCommand(7, board))&n;   return -1;&n;   if(ixj_WriteDSPCommand(159, board))&n;   return -1;&n;   if(ixj_WriteDSPCommand(21, board))&n;   return -1;&n;   if(ixj_WriteDSPCommand(0x0FF5, board))&n;   return -1;&n;   } */
)brace
r_return
l_int|0
suffix:semicolon
...
singleline_comment|//  if(ti-&gt;tone_index &gt; 12 &amp;&amp; ti-&gt;tone_index &lt; 28)
(brace
r_if
c_cond
(paren
