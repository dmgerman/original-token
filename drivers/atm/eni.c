...
c_func
(paren
l_string|&quot;peek reject (eff &lt;&lt; 2=%ld)&bslash;n&quot;
comma
id|eff
op_lshift
l_int|2
...
(paren
id|DEV_LABEL
l_string|&quot;(itf %d): peek reject for %ld &quot;
...
l_int|3
suffix:semicolon
multiline_comment|/* @@@ improve this */
r_if
c_cond
(paren
id|size
...
multiline_comment|/*&n;&t; * Looping a few times in here is probably far cheaper than keeping&n;&t; * track of TX completions all the time, so let&squot;s poll a bit ...&n;&t; */
r_while
c_loop
(paren
id|eni_in
...
id|KERN_CRIT
id|DEV_LABEL
l_string|&quot;SKBs in BACKLOG !!!&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_if
...
c_func
(paren
l_string|&quot;misc interrupt&bslash;n&quot;
comma
l_int|0
comma
l_int|0
...
id|page
comma
l_string|&quot;tx[%d]:    0x%06lx-0x%06lx (%6ld bytes), &quot;
l_string|&quot;rsv %d cps, shp %d cps%s&bslash;n&quot;
comma
id|i
comma
id|tx-&gt;send
