...
id|EBUSY
suffix:semicolon
multiline_comment|/*&n;&t; * Here we don&squot; t need the irq version of spinlocks because&n;&t; * the parport_lowlevel irq handler must not change the cad,&n;&t; * and so has no one reason to write_lock() the cad_lock spinlock.&n;&t; *&t;&t;&t;&t;&t;&t;-arca&n;&t; */
id|read_lock
c_func
(paren
op_amp
...
DECL|function|autoprobe_read_proc
r_static
r_int
id|autoprobe_read_proc
(paren
r_char
op_star
id|page
...
id|out_fail
suffix:semicolon
id|pp-&gt;pdir.probe-&gt;read_proc
op_assign
id|autoprobe_read_proc
suffix:semicolon
id|pp-&gt;pdir.probe-&gt;data
op_assign
id|pp
suffix:semicolon
r_return
