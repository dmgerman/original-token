...
id|gpe_enable
suffix:semicolon
singleline_comment|// clear previously disabled events before enabling
id|pm1_enabling
op_assign
(paren
id|pm1_enable
...
l_int|3
suffix:colon
multiline_comment|/* Disable PCI arbitration while sleeping,&n;&t;&t;   to avoid DMA corruption? */
r_if
c_cond
(paren
