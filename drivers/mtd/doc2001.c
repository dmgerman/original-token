...
multiline_comment|/* $Id: doc2001.c,v 1.4 2000/07/03 10:01:38 dwmw2 Exp $ */
...
(paren
id|KERN_NOTICE
l_string|&quot;Ignoring DiskOnChip Millennium at 0x%lX - already configured&bslash;n&quot;
comma
id|this-&gt;physadr
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Unfortunately, we don&squot;t have support for the DiskOnChip Millennium yet.&bslash;n&quot;
)paren
suffix:semicolon
id|iounmap
c_func
