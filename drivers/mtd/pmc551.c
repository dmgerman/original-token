...
multiline_comment|/*&n;         * Set to be prefetchable&n;         */
id|pci_read_config_dword
c_func
(paren
id|dev
...
l_int|0x8
suffix:semicolon
multiline_comment|/*&n;         * Put it back the way it was&n;         */
id|pci_write_config_dword
c_func
(paren
id|dev
...
(paren
id|KERN_NOTICE
l_string|&quot;pmc551: %dM (0x%x) of %sprefetchable memory at 0x%lx&bslash;n&quot;
comma
id|size
op_div
l_int|1024
...
suffix:semicolon
multiline_comment|/*&n;         * Turn on PCI memory and I/O bus access just for kicks&n;         */
...
suffix:semicolon
multiline_comment|/*&n;         * Config DRAM&n;         */
id|pci_write_config_word
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/*&n;         * Must be held high for some duration of time to take effect??&n;         */
r_for
c_loop
(paren
id|i
...
multiline_comment|/*&n;         * Check to see the state of the memory&n;         * FIXME: perhaps hide some of this around an #ifdef DEBUG as&n;         * it doesn&squot;t effect or enhance cards functionality&n;         */
id|pci_read_config_dword
c_func
(paren
id|dev
...
singleline_comment|//static int __init init_pmc551(void)
...
(paren
id|KERN_NOTICE
l_string|&quot;Ramix PMC551 PCI Mezzanine Ram Driver. (C) 1999,2000 Nortel Networks.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
(paren
id|KERN_NOTICE
l_string|&quot;Total memory is %dM&bslash;n&quot;
comma
id|length
op_div
l_int|1024
