...
multiline_comment|/* check_cmd_set() will have used get_module_symbol to increase&n;&t;   the use count of the module which provides the command set &n;&t;   driver. If we&squot;re quitting, we have to decrease it again.&n;&t;*/
r_if
c_cond
(paren
id|cfi-&gt;cmdset_setup
...
(paren
id|KERN_WARNING
l_string|&quot;cfi_cfi_probe called with strange buswidth %d&bslash;n&quot;
comma
id|map-&gt;buswidth
)paren
suffix:semicolon
