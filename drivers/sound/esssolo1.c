...
id|ENOMEM
suffix:semicolon
multiline_comment|/* work around a problem of the alpha port */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;solo1: requested DMA buffer below 16M but got 0x%lx, Alpha bug?&bslash;n&quot;
comma
(paren
r_int
r_int
...
(paren
id|KERN_INFO
l_string|&quot;solo1: version v0.11 time &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;
...
(paren
id|KERN_ERR
l_string|&quot;solo1: cannot register misc device&bslash;n&quot;
)paren
suffix:semicolon
id|free_irq
c_func
