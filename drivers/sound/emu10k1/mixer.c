...
DECL|macro|PCMLEVEL
mdefine_line|#define PCMLEVEL 140&t;&t;
singleline_comment|// almost silence
macro_line|#endif
r_int
id|vol
op_assign
...
suffix:semicolon
singleline_comment|// to correctly handle mono voice here we would need
singleline_comment|// to go into stereo mode and move the voice to the right &amp; left
singleline_comment|// looks a bit overcomlicated...
)brace
)brace
r_return
l_int|1
...
singleline_comment|// 20dB / (34.5dB + 12dB + 20dB) * 100 = 30
(brace
id|l1
op_sub_assign
l_int|30
...
id|SOUND_MIXER_PCM
suffix:colon
singleline_comment|// needs to be before default: !!
(brace
r_int
id|i
suffix:semicolon
