multiline_comment|/*&n; * drivers/sound/waveartist.c&n; *&n; * The low level driver for the RWA010 Rockwell Wave Artist&n; * codec chip used in the Corel Computer NetWinder.&n; *&n; * Cleaned up and integrated into 2.1 by Russell King (rmk@arm.linux.org.uk)&n; */
multiline_comment|/*&n; * Copyright (C) by Corel Computer 1998&n; *&n; * RWA010 specs received under NDA from Rockwell&n; *&n; * Copyright (C) by Hannu Savolainen 1993-1997&n; *&n; * OSS/Free for Linux is distributed under the GNU GENERAL PUBLIC LICENSE (GPL)&n; * Version 2 (June 1991). See the &quot;COPYING&quot; file distributed with this software&n; * for more info.&n; */
...
DECL|macro|VNC_INTERNAL_SPKR
mdefine_line|#define&t;VNC_INTERNAL_SPKR&t;0x01&t;
singleline_comment|//the sw mute on/off control bit
DECL|macro|VNC_INTERNAL_MIC
mdefine_line|#define&t;VNC_INTERNAL_MIC&t;0x10&t;
singleline_comment|//the hw internal/handset mic bit
multiline_comment|/* Use RECSRC = speaker to mark the internal microphone&n; *&n; * Some cheating involved here: there is no way to relay&n; * to the system, which microphone in in use&n; * (left = handset, or right = internal)&n; *&n; * So while I do not flag SPEAKER in the Recording Devices&n; * Mask, when on internal&n; *&n; * mike - I set the speaker bit hi. Some mixers can be&n; * confused a bit...&n; */
DECL|macro|POSSIBLE_RECORDING_DEVICES
mdefine_line|#define POSSIBLE_RECORDING_DEVICES&t;(SOUND_MASK_LINE |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_MIC |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_LINE1)&t;
singleline_comment|//Line1 = analog phone
DECL|macro|SUPPORTED_MIXER_DEVICES
mdefine_line|#define SUPPORTED_MIXER_DEVICES&t;&t;(SOUND_MASK_SYNTH |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_PCM |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_LINE |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_MIC | &bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_LINE1 |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_RECLEV |&bslash;&n;&t;&t;&t;&t;&t; SOUND_MASK_VOLUME)
...
DECL|member|handset_mute_sw
r_int
id|handset_mute_sw
suffix:colon
l_int|1
suffix:semicolon
multiline_comment|/* 1 - handset controlled in sw */
...
r_static
r_int
DECL|function|waveartist_sendcmd
id|waveartist_sendcmd
c_func
(paren
r_struct
id|address_info
...
c_func
(paren
l_string|&quot;waveartist_sendcmd: cmd=0x%04X...&quot;
comma
id|cmd
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * flush the port&n;&t;&t; */
id|count
op_assign
id|inw
c_func
...
multiline_comment|/*&n;&t; * preset timeout at 5000 loops&n;&t; */
id|count
op_assign
l_int|5000
suffix:semicolon
...
(brace
multiline_comment|/* wait till CMD_WE is high&n;&t;&t;&t; * then output the command&n;&t;&t;&t; */
id|outw
c_func
(paren
id|cmd
...
multiline_comment|/* ready BEFORE timeout?&n;&t; */
r_if
c_cond
(paren
id|debug_flg
...
suffix:semicolon
singleline_comment|// discard second word == 0
id|rev
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t; * Mute output until the playback really starts. This&n;&t; * decreases clicking (hope so).&n;&t; */
id|waveartist_mute
c_func
(paren
id|devc
...
c_func
(paren
l_string|&quot;waveartist: error setting the record format to %d&bslash;n&quot;
comma
id|portc-&gt;audio_format
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;waveartist: error setting record to %d channels&bslash;n&quot;
comma
id|portc-&gt;channels
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;waveartist: error setting the record speed &quot;
l_string|&quot;to %dHz.&bslash;n&quot;
comma
id|portc-&gt;speed
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;waveartist: error setting the record data path &quot;
...
c_func
(paren
l_string|&quot;waveartist: error setting the playback speed &quot;
l_string|&quot;to %dHz.&bslash;n&quot;
comma
id|portc-&gt;speed
)paren
...
c_func
(paren
l_string|&quot;waveartist: error setting the playback to&quot;
l_string|&quot; %d channels&bslash;n&quot;
comma
id|portc-&gt;channels
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;waveartist: error setting the playback data path &quot;
l_string|&quot;to 0x%X&bslash;n&quot;
comma
l_int|0
)paren
...
c_func
(paren
l_string|&quot;waveartist: error setting the playback format to %d&bslash;n&quot;
comma
id|portc-&gt;audio_format
)paren
suffix:semicolon
...
suffix:semicolon
singleline_comment|//RMK&t;disable_dma(audio_devs[dev]-&gt;dmap_in-&gt;dma);
...
suffix:semicolon
singleline_comment|//RMK&t;enable_dma(audio_devs[dev]-&gt;dmap_in-&gt;dma);
id|devc-&gt;audio_mode
op_and_assign
op_complement
id|PCM_ENABLE_INPUT
...
suffix:semicolon
singleline_comment|//RMK&t;disable_dma(audio_devs[dev]-&gt;dmap_out-&gt;dma);
id|waveartist_sendcmd
c_func
(paren
op_amp
...
suffix:semicolon
singleline_comment|//RMK&t;enable_dma(audio_devs[dev]-&gt;dmap_out-&gt;dma);
id|devc-&gt;audio_mode
op_and_assign
op_complement
id|PCM_ENABLE_OUTPUT
...
suffix:semicolon
macro_line|#if 1
multiline_comment|/* New mixer programming - switch recording source&n;&t; * using R/L_ADC_Mux_Select.  We are playing with&n;&t; * left/right mux bit fields in reg 9.&n;&t; *&n;&t; * We can not switch Mux_Select while recording, so&n;&t; * for microphones, enable both left and right and&n;&t; * play with levels only!&n;&t; *&n;&t; * Unfortunately, we need to select the src of mono&n;&t; * recording (left or right) before starting the&n;&t; * recording - so can not dynamically switch between&n;&t; * handset amd internal microphones...&n;&t; */
...
l_int|0x03F
suffix:semicolon
singleline_comment|//kill current left/right mux input select
r_switch
c_cond
(paren
id|input
...
(brace
multiline_comment|/*&n;&t;&t; * Handset or internal MIC&n;&t;&t; */
r_case
id|SOUND_MASK_MIC
suffix:colon
multiline_comment|/*&n;&t;&t; * handset not plugged in?&n;&t;&t; */
r_if
c_cond
(paren
id|devc-&gt;handset_state
op_amp
id|VNC_INTERNAL_MIC
)paren
(brace
multiline_comment|/*&n;&t;&t;&t; * set mono recording from right mic&n;&t;&t;&t; */
id|waveartist_sendcmd
c_func
(paren
op_amp
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/*&n;&t;&t;&t; * right=mic, left=none&n;&t;&t;&t; */
id|vals
(braket
l_int|1
)braket
...
l_int|0x0028
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * pretend int mic&n;&t;&t;&t; */
id|devc-&gt;rec_devices
op_or_assign
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * set mono rec from left mic&n;&t;&t;&t; */
id|waveartist_sendcmd
c_func
(paren
op_amp
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/*&n;&t;&t;&t; * right=none, left=mic&n;&t;&t;&t; */
id|vals
(braket
l_int|1
)braket
...
l_int|0x0005
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * show no int mic&n;&t;&t;&t; */
id|devc-&gt;rec_devices
op_and_assign
op_complement
id|SOUND_MASK_SPEAKER
...
id|SOUND_MASK_LINE1
suffix:colon
multiline_comment|/*&n;&t;&t; * set mono rec from left aux1&n;&t;&t; */
id|waveartist_sendcmd
c_func
(paren
op_amp
...
id|SOUND_MASK_LINE
suffix:colon
multiline_comment|/*&n;&t;&t; * set mono rec from left (default)&n;&t;&t; */
id|waveartist_sendcmd
c_func
(paren
op_amp
...
suffix:semicolon
macro_line|#else
multiline_comment|/* This part is good, if input connected to&n;&t; * a mixer, so can be used for record-only modes...&n;&t; */
multiline_comment|/*&n;&t; * get reg 4&n;&t; */
id|vals
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t; * get reg 8&n;&t; */
id|vals
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * left = none, right = mic, RX filter gain&n;&t;&t;&t; */
id|vals
(braket
l_int|1
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * left = mic, RX filter gain, right = none;&n;&t;&t;&t; */
id|vals
(braket
l_int|1
)braket
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * left = Aux1, right = none&n;&t;&t; */
id|vals
(braket
l_int|1
)braket
...
id|SOUND_MASK_LINE
suffix:colon
multiline_comment|/*&n;&t;&t; * left = Line, right = Line&n;&t;&t; */
id|vals
(braket
l_int|1
)braket
...
c_func
(paren
l_string|&quot;RECSRC %d: left(4) 0x%04X, right(8) 0x%04X.&bslash;n&quot;
comma
id|level
comma
id|vals
...
(brace
multiline_comment|/* Master volume (0-7)&n;&t; * We have 3 bits on the Left/Right Mixer Gain,&n;&t; * bits 3,2,1 on 3 and 7&n;&t; */
r_case
id|SOUND_MIXER_VOLUME
suffix:colon
id|devc-&gt;levels
...
r_break
suffix:semicolon
multiline_comment|/* External line (0-31)&n;&t; * use LOUT/ROUT bits 10...6, reg 1 and 5&n;&t; */
r_case
id|SOUND_MIXER_LINE
suffix:colon
id|devc-&gt;levels
...
r_break
suffix:semicolon
multiline_comment|/* Mono microphone (0-3) mute,&n;&t; * 0db,10db,20db&n;&t; */
r_case
id|SOUND_MIXER_MIC
suffix:colon
macro_line|#if 1
...
suffix:semicolon
macro_line|#else
multiline_comment|/* we do not need to mute volume of&n;&t;&t; * an unused mic - it is simply unused...&n;&t;&t; */
r_if
c_cond
(paren
id|devc-&gt;handset_state
...
r_break
suffix:semicolon
multiline_comment|/* Recording level (0-7)&n;&t; */
r_case
id|SOUND_MIXER_RECLEV
suffix:colon
id|devc-&gt;levels
...
r_break
suffix:semicolon
multiline_comment|/* Mono External Aux1 (0-31)&n;&t; * use LINE1 bits 5...1, reg 1 and 5&n;&t; */
r_case
id|SOUND_MIXER_LINE1
suffix:colon
id|devc-&gt;levels
...
r_break
suffix:semicolon
multiline_comment|/* WaveArtist PCM (0-32767)&n;&t; */
r_case
id|SOUND_MIXER_PCM
suffix:colon
id|devc-&gt;levels
...
r_break
suffix:semicolon
multiline_comment|/* Internal synthesizer (0-31)&n;&t; */
r_case
id|SOUND_MIXER_SYNTH
suffix:colon
id|devc-&gt;levels
...
suffix:semicolon
multiline_comment|/*&n;&t; * set input for ADC to come from&n;&t; * a mux (left and right) == reg 9,&n;&t; * initially none&n;&t; */
id|waveartist_cmd3
c_func
(paren
id|devc
...
suffix:semicolon
multiline_comment|/* set default input device = internal mic&n;&t; * current recording device = none&n;&t; * no handset&n;&t; */
id|devc-&gt;recmask
op_assign
l_int|0
suffix:semicolon
...
id|VNC_INTERNAL_MIC
suffix:semicolon
singleline_comment|//&t;waveartist_mixer_set(devc, SOUND_MIXER_RECSRC, SOUND_MASK_MIC);
multiline_comment|/*&n;&t; * start from enabling the hw setting&n;&t; */
id|devc-&gt;handset_mute_sw
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
macro_line|#if 0
singleline_comment|//use this call to override the automatic handset behaviour - ignore handset
singleline_comment|//bit 0x80 = total control over handset - do not react to plug/unplug
singleline_comment|//bit 0x10 = 1 == internal mic, otherwise handset mic
singleline_comment|//bit 0x01 = 1 == mute internal speaker, otherwise unmute
r_if
c_cond
(paren
id|cmd
...
id|arg
suffix:semicolon
singleline_comment|//&t;&t;printk(&quot;MIXER_PRIVATE1: passed parameter = 0x%X.&bslash;n&quot;,val);
r_return
op_minus
id|EINVAL
suffix:semicolon
singleline_comment|//check if parameter is logical...
id|devc-&gt;soft_mute_flag
op_assign
id|val
suffix:semicolon
id|temp
...
(brace
singleline_comment|//&t;&t;&t;printk(&quot;MIXER_PRIVATE1: mute_mono(0x%X).&bslash;n&quot;,temp);
id|vnc_mute
c_func
(paren
id|devc
...
singleline_comment|//&t;&t;temp = devc-&gt;handset_state;
singleline_comment|// do not check if it is not already in
singleline_comment|// the right setting, since we are
singleline_comment|// laying about the current state...
singleline_comment|//&t;&t;if ((val &amp; VNC_INTERNAL_MIC) != temp) {
id|devc-&gt;handset_state
op_assign
id|val
op_amp
id|VNC_INTERNAL_MIC
suffix:semicolon
singleline_comment|//&t;&t;&t;printk(&quot;MIXER_PRIVATE1: mixer_set(0x%X).&bslash;n&quot;,devc-&gt;handset_state);
id|wa_mixer_set
c_func
(paren
id|devc
...
suffix:semicolon
singleline_comment|//&t;&t;&t;devc-&gt;handset_state = temp;
)brace
r_return
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;MIXER_PRIVATE2: passed parameter = 0x%X.&bslash;n&quot;
comma
id|val
)paren
suffix:semicolon
...
suffix:semicolon
singleline_comment|//PAUSE the ADC
)brace
r_else
r_if
c_cond
...
suffix:semicolon
singleline_comment|//RESUME the ADC
)brace
r_else
(brace
r_return
...
id|EINVAL
suffix:semicolon
singleline_comment|//invalid parameters...
)brace
r_return
l_int|0
suffix:semicolon
...
suffix:semicolon
singleline_comment|//reg 14 is actually a command: read,write,reset
r_int
id|val
suffix:semicolon
r_int
...
(brace
singleline_comment|//reset command??
id|wavnc_mixer_reset
c_func
(paren
id|devc
)paren
...
singleline_comment|//&t;&t;&t;printk(&quot;WaveArtist Mixer: Private write command.&bslash;n&quot;);
id|wa_sendcmd
c_func
(paren
l_int|0x32
...
suffix:semicolon
singleline_comment|//Pair1 - word 1 and 5
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
suffix:semicolon
singleline_comment|//Pair2 - word 2 and 6
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
suffix:semicolon
singleline_comment|//Pair3 - word 3 and 7
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
suffix:semicolon
singleline_comment|//Pair4 - word 4 and 8
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
suffix:semicolon
singleline_comment|//Pair5 - word 9 and 10
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
suffix:semicolon
singleline_comment|//set left and right PCM
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
suffix:semicolon
singleline_comment|//set left and right FM
id|wa_sendcmd
c_func
(paren
id|mixer_reg
...
singleline_comment|//&t;&t;&t;printk(&quot;WaveArtist Mixer: Private read command.&bslash;n&quot;);
singleline_comment|//first read all current values...
id|save_flags
c_func
(paren
id|flags
...
suffix:semicolon
singleline_comment|// get ready for command nn30H
r_while
c_loop
(paren
op_logical_neg
...
suffix:semicolon
singleline_comment|//wait for response ready...
id|mixer_reg
(braket
id|i
)braket
...
multiline_comment|/*&n; * Corel Netwinder specifics...&n; */
r_static
r_void
DECL|function|vnc_mute
id|vnc_mute
c_func
(paren
id|wavnc_info
...
singleline_comment|// the state should be &quot;querable&quot; via a private IOCTL call
id|temp
op_assign
id|inb
c_func
...
c_func
(paren
l_string|&quot;waveartist: can&squot;t find device to unload&bslash;n&quot;
)paren
suffix:semicolon
)brace
