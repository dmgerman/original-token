...
(paren
id|KERN_DEBUG
l_string|&quot;sv: io ports: 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x&bslash;n&quot;
comma
id|s-&gt;iosb
comma
id|s-&gt;ioenh
...
(paren
id|KERN_INFO
l_string|&quot;sv: found adapter at io %#06x irq %u dmaa %#06x dmac %#06x revision %u&bslash;n&quot;
comma
id|s-&gt;ioenh
comma
id|s-&gt;irq
