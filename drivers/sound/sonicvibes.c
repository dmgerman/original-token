...
id|magic
suffix:semicolon
multiline_comment|/* we keep sv cards in a linked list */
DECL|member|next
r_struct
id|sv_state
op_star
...
(paren
id|KERN_INFO
l_string|&quot;sv: version v0.24 time &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;
...
(brace
multiline_comment|/* take care of ISA aliases */
id|ddmanamelen
op_assign
id|strlen
c_func
