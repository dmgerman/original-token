...
id|dmaio
comma
l_string|&quot;if the motherboard BIOS did not allocate DDMA io, allocate them starting at this address&quot;
)paren
suffix:semicolon
id|MODULE_AUTHOR
c_func
...
(paren
id|KERN_INFO
l_string|&quot;sv: version v0.18 time &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;
...
(paren
id|KERN_INFO
l_string|&quot;sv: BIOS did not allocate DDMA channel A io, allocated at %#x&bslash;n&quot;
comma
id|s-&gt;iodmaa
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;sv: BIOS did not allocate DDMA channel C io, allocated at %#x&bslash;n&quot;
comma
id|s-&gt;iodmac
)paren
suffix:semicolon
...
suffix:semicolon
singleline_comment|//outb(0xff, s-&gt;iodmaa + SV_DMA_RESET);
singleline_comment|//outb(0xff, s-&gt;iodmac + SV_DMA_RESET);
id|inb
c_func
(paren
id|s-&gt;ioenh
...
DECL|function|sonicvibesdmaio_setup
r_static
r_int
id|__init
id|sonicvibesdmaio_setup
c_func
(paren
r_char
op_star
