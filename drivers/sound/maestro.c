...
mdefine_line|#define DRIVER_VERSION &quot;0.10&quot;
...
suffix:semicolon
multiline_comment|/* swptr is always in bytes as read from an apu.. */
r_int
id|bptr
op_assign
id|s-&gt;dma_dac.swptr
...
suffix:semicolon
multiline_comment|/* Disconnect from the CHI.  Enabling this in made a dell 7500 work. */
id|w
op_and_assign
op_complement
(paren
...
r_static
r_int
DECL|function|maestro_apm_suspend
id|maestro_apm_suspend
c_func
(paren
r_void
)paren
...
r_static
r_int
DECL|function|maestro_apm_resume
id|maestro_apm_resume
c_func
(paren
r_void
)paren
