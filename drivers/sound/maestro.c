...
mdefine_line|#define DRIVER_VERSION &quot;0.06&quot;
...
macro_line|#undef CONFIG_APM /* see notes above */
...
DECL|macro|NR_DSPS
mdefine_line|#define NR_DSPS&t;&t;1 /* our wavecache setup demands this. */
...
macro_line|#endif
multiline_comment|/* 1 page of DMA-able memory for mixer apu buffers,&n;&t;&t;shared amongst dsp?s. */
DECL|member|mixpage
r_void
op_star
id|mixpage
...
l_int|NULL
suffix:semicolon
multiline_comment|/* no idea what these do */
id|maestro_ac97_set
c_func
(paren
id|iobase
...
macro_line|#if 0 /* used to be set, lets try using the codec defaults */
...
suffix:semicolon
multiline_comment|/* the regs are read only, duh  :) */
multiline_comment|/*&t;maestro_ac97_set(iobase, 0x26, 0x000F);*/
macro_line|#if 0 /* this is a really good way to hang&n;&t;codecs.  we need a better way. */
r_if
c_cond
(paren
id|maestro_ac97_get
...
multiline_comment|/* well this seems to work a little&n;&t;&t;better on my pci board.. probably&n;&t;&t;because gpio is wired to ac97 reset */
...
suffix:semicolon
multiline_comment|/* put our base address in the right region */
id|wave_set_register
c_func
(paren
id|ess
...
l_int|0x00200000
suffix:semicolon
multiline_comment|/* bit 21 -&gt; second region for mixbuf */
id|M_printk
c_func
(paren
...
c_func
(paren
l_string|&quot;maestro: allocated %ld bytes at %p&bslash;n&quot;
comma
id|PAGE_SIZE
op_lshift
id|order
...
multiline_comment|/* only called by ess_write (dac ness ) */
...
multiline_comment|/* again, the mode passed is shifted/masked */
...
id|offset
suffix:semicolon
multiline_comment|/*&t;M_printk(&quot;writing %d to %p and %p from %p:%d bufs: %d&bslash;n&quot;,count/2, left,right,real_buffer,offset,bufsize);*/
r_if
c_cond
(paren
id|mode
...
c_func
(paren
l_string|&quot;maestro: %d -1 bob clients&bslash;n&quot;
comma
id|s-&gt;card-&gt;bob_running
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;suspending.. blowing away apus&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
c_func
(paren
l_string|&quot;suspending.. stopping bob&bslash;n&quot;
)paren
suffix:semicolon
id|stop_bob
c_func
...
(brace
multiline_comment|/* undo marking the page as reserved */
id|clear_bit
c_func
(paren
id|PG_reserved
...
suffix:semicolon
multiline_comment|/* free mixpage */
id|free_pages
c_func
(paren
(paren
...
suffix:semicolon
multiline_comment|/* allocate a page for the input mixer APUs &n;&t;&t;512 * NR_DSPS must fit in here !!*/
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_WARNING
l_string|&quot;maestro: can&squot;t allocate mixer page.&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
c_func
(paren
l_string|&quot;reg_callback: %d&bslash;n&quot;
comma
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* mark the page reserved */
id|set_bit
c_func
(paren
id|PG_reserved
...
r_break
suffix:semicolon
multiline_comment|/* divide the page into smaller chunks */
id|s-&gt;mixbuf
op_assign
id|card-&gt;mixpage
op_plus
