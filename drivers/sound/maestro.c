...
mdefine_line|#define DRIVER_VERSION &quot;0.07&quot;
...
mdefine_line|#define MAX_DSP_ORDER&t;3
DECL|macro|MAX_DSPS
mdefine_line|#define MAX_DSPS&t;(1&lt;&lt;3)
DECL|macro|NR_DSPS
...
multiline_comment|/*&t;&t;&t;spin_lock(&amp;card-&gt;lock);&n;&t;&t;&t;val = card-&gt;mix.read_mixer(card,i);&n;&t;&t;&t;spin_unlock(&amp;card-&gt;lock);*/
id|val
op_assign
id|card-&gt;mix.mixer_state
(braket
...
op_or
id|DSP_CAP_TRIGGER
multiline_comment|/*| DSP_CAP_MMAP*/
comma
(paren
r_int
op_star
...
multiline_comment|/* silly limited pci poop */
id|printk
c_func
(paren
id|KERN_DEBUG
...
(paren
id|KERN_DEBUG
l_string|&quot;maestro: %ld byte DMA buffer longer than APU can express!&bslash;n&quot;
comma
id|PAGE_SIZE
op_lshift
id|order
