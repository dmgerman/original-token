...
multiline_comment|/*&n; * The timer is now active and will reinvoke this function&n; * after the timer expires. Return to the caller now.&n; */
r_return
suffix:semicolon
)brace
r_break
...
id|this_one
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t; * Restore queue&n;&t;&t;&t;&t;&t; */
id|seq_playing
op_assign
l_int|1
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t;   * Echo back to the process&n;&t;&t;&t;&t;&t; */
r_break
suffix:semicolon
r_case
id|SEQ_PRIVATE
...
id|printk
(paren
l_string|&quot;Using timer #%d&bslash;n&quot;
comma
id|tmr_no
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t;&t;&t; * Queue not&n;&t;&t;&t;&t;&t;&t;&t;&t; * empty&n;&t;&t;&t;&t;&t;&t;&t;&t; */
(brace
id|DO_SLEEP
(paren
id|seq_sleeper
...
id|n
suffix:semicolon
multiline_comment|/*&n;   * This routine sends one byte to the Midi channel.&n;   */
multiline_comment|/*&n;   * If the output Fifo is full, it waits until there&n;   */
multiline_comment|/*&n;   * is space in the queue&n;   */
id|n
op_assign
l_int|300
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Timeout in jiffies&n;&t;&t;&t;&t; */
r_while
c_loop
(paren
id|n
...
(brace
multiline_comment|/*&n; *    Sending just a ACTIVE SENSING message should be enough to stop all&n; *      playing notes. Since there are devices not recognizing the&n; *      active sensing, we have to send some all notes off messages also.&n; */
id|midi_outc
(paren
id|i
comma
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t;&t;&t; * Channel&n;&t;&t;&t;&t;&t;&t;&t;&t; * msg&n;&t;&t;&t;&t;&t;&t;&t;&t; */
id|midi_outc
(paren
id|i
comma
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t; * All notes off&n;&t;&t;&t;&t;&t; */
id|midi_outc
(paren
id|i
comma
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Dummy parameter&n;&t;&t;&t;&t; */
)brace
id|midi_devs
(braket
id|i
