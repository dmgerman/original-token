...
mdefine_line|#define CS4281_MAJOR_VERSION &t;0
DECL|macro|CS4281_MINOR_VERSION
mdefine_line|#define CS4281_MINOR_VERSION &t;4   
macro_line|#ifdef __ia64__
DECL|macro|CS4281_ARCH
mdefine_line|#define CS4281_ARCH&t;     &t;64  
singleline_comment|//architecture key
macro_line|#else
DECL|macro|CS4281_ARCH
mdefine_line|#define CS4281_ARCH&t;     &t;32  
singleline_comment|//architecture key
macro_line|#endif
...
id|mix
suffix:semicolon
singleline_comment|// wave stuff   // Note that play &amp; record formats must be the same *wb.
DECL|member|fmt
r_int
id|fmt
suffix:semicolon
...
singleline_comment|// --------------------------------------------------------------------- 
singleline_comment|//
singleline_comment|//&t;&t;Hardware Interfaces For the CS4281
singleline_comment|//
singleline_comment|//******************************************************************************
...
mdefine_line|#define INTERRUPT_RATE_MS       100                      
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: prog_dmabuf(): numfrag=%d fragsize=%d fragsamples=%d fragshift=%d&bslash;n&quot;
comma
id|db-&gt;numfrag
comma
id|db-&gt;fragsize
...
suffix:semicolon
singleline_comment|//
singleline_comment|// fill with silence, and wait on turning off the DAC until interrupt routine.
singleline_comment|// wait on &quot;Poke(pBA0+BA0_DCR0, temp1 | DCRn_MSK);    // Stop Play DMA&quot;
singleline_comment|//
id|CS_DBGOUT
c_func
(paren
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: prog_codec(): format=0x%.8x rate=%d&bslash;n&quot;
comma
id|format
comma
id|s-&gt;rate
...
l_int|0
suffix:semicolon
singleline_comment|// Neither writing or reading.
id|spin_unlock_irqrestore
c_func
(paren
op_amp
...
mdefine_line|#define VALIDATE_STATE(s)                         &bslash;&n;({                                                &bslash;&n;&t;if (!(s) || (s)-&gt;magic != CS4281_MAGIC) { &bslash;&n;&t;&t;printk(invalid_magic);            &bslash;&n;&t;&t;return -ENXIO;                    &bslash;&n;&t;}                                         &bslash;&n;})
singleline_comment|// --------------------------------------------------------------------- 
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_read()+ &bslash;n&quot;
)paren
)paren
suffix:semicolon
id|VALIDATE_STATE
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_write()+ &bslash;n&quot;
)paren
)paren
suffix:semicolon
id|VALIDATE_STATE
...
l_int|0
suffix:semicolon
singleline_comment|// program channels 
id|s-&gt;channels
op_assign
id|val
ques
...
suffix:colon
singleline_comment|// Selects ONE fmt
r_if
c_cond
(paren
id|get_user
...
l_int|0
suffix:semicolon
singleline_comment|// program format 
r_if
c_cond
(paren
id|val
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_release(): inode=0x%.8x file=0x%.8x&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_open(): inode=0x%.8x file=0x%.8x&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_ERR
l_string|&quot;cs4281: Program dmabufs failed.&bslash;n&quot;
)paren
suffix:semicolon
id|cs4281_release
c_func
...
suffix:semicolon
singleline_comment|//
singleline_comment|// ok, at this point we assume that the fifos have been filled
singleline_comment|// with silence and so we now turn off the DMA engine.
singleline_comment|// if FMODE_WRITE is set that means that some thread
singleline_comment|// attempted to start_dac, which probably means that an open
singleline_comment|// occurred, so do not stop the dac in this case.
singleline_comment|//
r_if
c_cond
(paren
...
(paren
id|KERN_INFO
l_string|&quot;cs4281: cs4281_interrupt() stopping play DMA&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|writel
...
suffix:semicolon
singleline_comment|// Stop Play DMA
id|s-&gt;endofbuffer
op_assign
l_int|0
suffix:semicolon
...
mdefine_line|#define NR_DEVICE 8          
