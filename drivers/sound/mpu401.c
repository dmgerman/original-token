...
mdefine_line|#define mpu401_status(base)&t;&t;INB(STATPORT(base))
DECL|macro|input_avail
mdefine_line|#define input_avail(base)&t;&t;(!(mpu401_status(base)&amp;INPUT_AVAIL))
DECL|macro|output_ready
mdefine_line|#define output_ready(base)&t;&t;(!(mpu401_status(base)&amp;OUTPUT_READY))
DECL|macro|write_command
mdefine_line|#define write_command(base, cmd)&t;&t;OUTB(cmd, COMDPORT(base))
DECL|macro|read_data
mdefine_line|#define read_data(base)&t;&t;INB(DATAPORT(base))
DECL|macro|write_data
mdefine_line|#define write_data(base, byte)&t;OUTB(byte, DATAPORT(base))
DECL|macro|OUTPUT_READY
...
suffix:semicolon
DECL|macro|STORE
mdefine_line|#define STORE(cmd) &bslash;&n;if (devc-&gt;opened &amp; OPEN_READ) &bslash;&n;{ &bslash;&n;  int len; &bslash;&n;  unsigned char obuf[8]; &bslash;&n;  cmd; &bslash;&n;  seq_input_event(obuf, len); &bslash;&n;}
DECL|macro|_seqbuf
...
l_int|0xB0
suffix:colon
multiline_comment|/*&n; * Fix the controller value (combine MSB and LSB)&n; */
r_if
c_cond
(paren
id|msg
...
id|printk
(paren
l_string|&quot;MPU: Unknown midi channel message %02x&bslash;n&quot;
comma
id|msg
(braket
l_int|0
...
id|ST_INIT
suffix:semicolon
multiline_comment|/*&n; *    Real time messages&n; */
r_case
l_int|0xf8
suffix:colon
...
id|printk
(paren
l_string|&quot;MPU-401: Interrupt #%d?&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;MPU: No ACK to command (0x%x)&bslash;n&quot;
comma
(paren
r_int
)paren
...
id|printk
(paren
l_string|&quot;MPU: No response(%d) to command (0x%x)&bslash;n&quot;
comma
id|i
comma
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t; * Send MPU-401 RESET Command&n;&t;&t;&t;&t;&t;&t; */
