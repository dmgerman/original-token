...
l_int|31
suffix:semicolon
multiline_comment|/* Offset has to compensate for the fact we finished the segment&n;&t;   on the IRQ so we are at next_segment,0 */
singleline_comment|//&t;printk(&quot;BANK%d &quot;, offset);
id|offset
op_mul_assign
(paren
id|dmabuf-&gt;dmasize
...
suffix:semicolon
singleline_comment|//&t;printk(&quot;DMASZ=%d&quot;, dmabuf-&gt;dmasize);
singleline_comment|//&t;offset += 1024-(4*inw(state-&gt;card-&gt;iobase+c-&gt;port+OFF_PICB));
singleline_comment|//&t;printk(&quot;OFF%d &quot;, offset);
r_return
id|offset
suffix:semicolon
)brace
