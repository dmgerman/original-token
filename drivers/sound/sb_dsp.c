...
id|printk
(paren
l_string|&quot;Hmm... Could this be an ESS488 based card (rev %d)&bslash;n&quot;
comma
id|ess_minor
op_amp
l_int|0x0f
...
id|printk
(paren
l_string|&quot;Hmm... Could this be an ESS688 based card (rev %d)&bslash;n&quot;
comma
id|ess_minor
op_amp
l_int|0x0f
...
suffix:semicolon
macro_line|#ifdef JAZZ16
multiline_comment|/* Allocate 16 bit dma&n;&t; */
r_if
c_cond
(paren
id|Jazz16_detected
