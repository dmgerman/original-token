...
suffix:colon
multiline_comment|/*&t;&t;&t;printk(KERN_INFO LOGNAME &quot;: Write underflow&bslash;n&quot;); */
id|reset_play_queue
c_func
(paren
)paren
...
suffix:colon
multiline_comment|/*&t;&t;&t;printk(KERN_INFO LOGNAME &quot;: Read overflow&bslash;n&quot;); */
id|reset_record_queue
c_func
(paren
)paren
...
comma
macro_line|#ifndef LINUX20
macro_line|#  if LINUX_VERSION_CODE &gt;= 0x020100 + 118
l_int|NULL
comma
macro_line|#  endif /* &gt;= 2.1.118 */
macro_line|#endif
id|dev_close
comma
)brace
