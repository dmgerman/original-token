...
mdefine_line|#define CTRL_XCTL1      0x40000000  /* ? mic impedance */
...
macro_line|#ifdef CONFIG_SOUND_ES1370_JOYPORT_BOOT
...
(paren
id|KERN_INFO
l_string|&quot;es1370: version v0.19 time &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;
...
(paren
id|KERN_ERR
l_string|&quot;es1370: io ports %#x-%#x in use&bslash;n&quot;
comma
id|s-&gt;io
comma
id|s-&gt;io
...
(paren
id|KERN_INFO
l_string|&quot;es1370: found adapter at io %#06x irq %u&bslash;n&quot;
id|KERN_INFO
