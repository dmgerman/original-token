...
multiline_comment|/*&n; * Depending on the audiochannel ESS devices can&n; * have different clock settings.&n; * callers of ess_speed only do an audionum suggestion, which means&n; * input suggests 1, output suggests 2. This suggestion is only true&n; * however when doing duplex.&n; */
...
multiline_comment|/*&n; * FKS: Change this!! it&squot;s the old routine!&n; */
...
(paren
id|KERN_INFO
l_string|&quot;FKS: mixer_reset&bslash;n&quot;
)paren
suffix:semicolon
id|ess_setmixer
(paren
