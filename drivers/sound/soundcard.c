...
multiline_comment|/*&n; * Thomas Sailer   : ioctl code reworked (vmalloc/vfree removed)&n; *                   integrated sound_switch.c&n; * Stefan Reinauer : integrated /proc/sound (equals to /dev/sndstat,&n; *                   which should disappear in the near future)&n; * Eric Dumas      : devfs support (22-Jan-98) &lt;dumas@linux.eu.org&gt; with fixups&n; *                   by C. Scott Ananian &lt;cananian@alumni.princeton.edu&gt;&n; * Richard Gooch   : moved common (non OSS-specific) devices to sound_core.c&n; *&n; * Rob Riggs&t;&t;Added persistent DMA buffers support (1998/10/17)&n; */
