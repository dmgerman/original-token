...
id|val
suffix:semicolon
multiline_comment|/*&n;     * Set the left right&n;   */
r_if
c_cond
(paren
id|mix_devices
...
multiline_comment|/*&n; * Allocate DMA&n; */
r_if
c_cond
(paren
id|mode
...
multiline_comment|/* Don&squot;t leave IRQ reserved */
id|snd_release_irq
(paren
id|devc-&gt;irq
)paren
...
multiline_comment|/* Release the second DMA channel */
(brace
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Playback enable, dual DMA channel mode.&n;&t;&t;&t;&t; * auto calibration on.&n;&t;&t;&t;&t; */
)brace
id|ad_leave_MCE
(paren
id|devc
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Capture enable, dual DMA channel mode,&n;&t;&t;&t;&t; * auto calibration on.&n;&t;&t;&t;&t; */
)brace
id|ad_leave_MCE
(paren
id|devc
...
id|printk
(paren
l_string|&quot;ad1848 detect error - step A&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
id|printk
(paren
l_string|&quot;ad1848 detect error - step F(%d/%x/%x)&bslash;n&quot;
comma
id|i
comma
id|tmp1
...
id|dma_playback
suffix:semicolon
multiline_comment|/* Use just single DMA */
id|devc-&gt;opened
op_assign
l_int|0
suffix:semicolon
...
id|printk
(paren
l_string|&quot;ad1848: Problems when clearing interrupt, status=%x&bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
