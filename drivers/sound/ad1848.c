...
multiline_comment|/*&n; * Let&squot;s have some delay&n; */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/*&n; * This code fragment ensures that the playback FIFO is empty before&n; * setting the codec for playback. Enabling playback for a moment should&n; * be enough to do that.&n; */
r_int
id|tmout
suffix:semicolon
id|ad_write
...
multiline_comment|/* outb(( 0x0b),  devc-&gt;base); */
r_for
c_loop
(paren
id|i
...
id|printk
(paren
l_string|&quot;ad1848: I25 = %02x&bslash;n&quot;
comma
id|ad_read
(paren
id|devc
