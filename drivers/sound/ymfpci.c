...
c_func
(paren
l_string|&quot;ymfpci: ioctl cmd 0x%x&bslash;n&quot;
comma
id|cmd
)paren
suffix:semicolon
...
id|ctrl
suffix:semicolon
multiline_comment|/* ymfpci_proc_done(codec); */
id|unregister_sound_dsp
c_func
(paren
id|codec-&gt;dev_audio
...
id|ENODEV
suffix:semicolon
multiline_comment|/*&n;&t; * Print our proud ego-nursing &quot;Hello, World!&quot; message as in MS-DOS.&n;&t; */
multiline_comment|/* printk(KERN_INFO &quot;ymfpci: Yamaha YMF7xx&bslash;n&quot;); */
multiline_comment|/*&n;&t; * Not very efficient, but Alan did it so in cs46xx.c.&n;&t; */
id|foundone
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;ymfpci: No devices found.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
