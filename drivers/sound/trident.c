...
mdefine_line|#define seek_offset(dma_ptr, buffer, dma_count, cnt, offset)&t;(dma_ptr) += (offset);&t;&bslash;&n;&t;&t;&t;&t;&t;&t;&t;&t;(buffer) += (offset);&t;&bslash;&n;&t;&t;&t;&t;&t;&t;&t;&t;(dma_count) += (offset);&t;&bslash;&n;&t;&t;&t;&t;&t;&t;&t;&t;(cnt) -= (offset);
DECL|variable|ali_multi_channels
r_static
r_const
r_int
id|ali_multi_channels
(braket
)braket
op_assign
(brace
...
r_static
r_int
id|ali_allocate_multi_channels
c_func
(paren
r_struct
id|trident_state
...
DECL|function|ali_allocate_multi_channels
r_static
r_int
id|ali_allocate_multi_channels
c_func
