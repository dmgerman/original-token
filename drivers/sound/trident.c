...
mdefine_line|#define DRIVER_VERSION &quot;0.14.5&quot;
...
multiline_comment|/* trident_update_ptr is called by interrupt handler or by process via&n;&t;&t;&t;   ioctl/poll, we only wake up the waiting process when we have more&n;&t;&t;&t;   than 1/2 buffer of data to process (always true for interrupt handler) */
r_if
c_cond
(paren
id|dmabuf-&gt;count
...
suffix:semicolon
macro_line|#ifdef DEBUG
multiline_comment|/* Sanity check to make sure that every state has a channel&n;&t;   and vice versa. */
id|u32
id|done
op_assign
l_int|0
...
(paren
id|KERN_ERR
l_string|&quot;trident: channel allocated to two states&bslash;n&quot;
)paren
suffix:semicolon
id|ns
op_increment
...
(paren
id|KERN_ERR
l_string|&quot;trident: number of states != number of channels&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_for
