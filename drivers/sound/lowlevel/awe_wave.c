...
id|shared
suffix:semicolon
multiline_comment|/* shared index */
DECL|member|name
r_int
r_char
id|name
...
l_int|1
suffix:semicolon
multiline_comment|/* use PnP as default */
DECL|macro|AWE_NUM_CHIPS
mdefine_line|#define AWE_NUM_CHIPS&t;3
DECL|variable|pnp_ids
r_static
r_int
r_int
id|pnp_ids
...
c_func
(paren
l_string|&quot;AWE32: PnP setup ports: %x:%x:%x&bslash;n&quot;
comma
id|port
(braket
l_int|0
...
id|name
op_assign
l_string|&quot;Soundblaster AWE32/AWE64 PnP&quot;
suffix:semicolon
id|pnp_awe
(braket
id|i
...
c_func
(paren
l_string|&quot;AWE32: [program(%d) %d/%d]&bslash;n&quot;
comma
id|voice
comma
id|instr_no
...
id|readbuf_flags
suffix:semicolon
macro_line|#ifdef MALLOC_LOOP_DATA
...
multiline_comment|/* already initialized by PnP */
r_return
l_int|1
suffix:semicolon
r_if
...
comma
l_int|NULL
multiline_comment|/*&amp;std_midi_synth*/
comma
(brace
l_int|0
)brace
comma
multiline_comment|/* input_info */
id|awe_midi_open
comma
...
l_int|NULL
multiline_comment|/*start_read*/
comma
l_int|NULL
multiline_comment|/*end_read*/
comma
l_int|NULL
comma
