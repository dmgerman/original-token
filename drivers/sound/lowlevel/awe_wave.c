multiline_comment|/*&n; * sound/awe_wave.c&n; *&n; * The low level driver for the AWE32/Sound Blaster 32 wave table synth.&n; *   version 0.4.2; Sep. 1, 1997&n; *&n; * Copyright (C) 1996,1997 Takashi Iwai&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2 of the License, or&n; * (at your option) any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; */
...
DECL|macro|FX_SET
mdefine_line|#define FX_SET(rec,type,value) &bslash;&n;&t;((rec)-&gt;flags[type] = 1, (rec)-&gt;val[type] = (value))
DECL|macro|FX_ADD
mdefine_line|#define FX_ADD(rec,type,value) &bslash;&n;&t;((rec)-&gt;flags[type] = 2, (rec)-&gt;val[type] = (value))
DECL|macro|FX_UNSET
mdefine_line|#define FX_UNSET(rec,type) &bslash;&n;&t;((rec)-&gt;flags[type] = 0, (rec)-&gt;val[type] = 0)
...
id|current_alloc_time
suffix:semicolon
multiline_comment|/* keep channel info for terminating release echo if necessary */
r_if
c_cond
(paren
id|keep_ch_info
...
multiline_comment|/*awe_tweak_voice(voice);*/
)brace
...
l_int|NULL
comma
multiline_comment|/* global: attenuation */
id|awe_set_volume
comma
)brace
suffix:semicolon
