...
id|printk
(paren
l_string|&quot;MC7 not writeable (%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
id|printk
(paren
l_string|&quot;MC7 not writeable2 (%x)&bslash;n&quot;
comma
id|tmp
)paren
)paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n; * A temporarary kludge which drops the device back to mode1.&n; * This removes problems with interrupts but disables full duplex.&n; * A better solution should be introduced later.&n; */
id|mad_write
(paren
id|MC5_PORT
comma
