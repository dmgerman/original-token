...
mdefine_line|#define VIA_VERSION&t;&quot;1.1.5&quot;
...
id|DPRINTK
(paren
l_string|&quot;EXIT, status=0x%X, returning -EIO&bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
...
DECL|function|via_ac97_wait_valid
r_static
id|u32
id|via_ac97_wait_valid
(paren
...
id|DPRINTK
(paren
l_string|&quot;EXIT valid, tmp=0x%X, cnt=%d&bslash;n&quot;
comma
id|tmp
comma
id|counter
...
id|DPRINTK
(paren
l_string|&quot;EXIT, tmp=0x%X, cnt=%d%s&bslash;n&quot;
comma
id|tmp
comma
id|counter
...
macro_line|#endif
macro_line|#if 0
multiline_comment|/*&n;&t; * reset AC97 controller&n;&t; */
id|pci_read_config_byte
c_func
(paren
id|pdev
...
suffix:semicolon
multiline_comment|/* init other mixer defaults */
r_for
c_loop
(paren
id|idx
...
macro_line|#if 0
multiline_comment|/* chipset init copied from via */
id|pci_write_config_byte
c_func
(paren
id|pdev
...
macro_line|#if 0
multiline_comment|/* chipset init copied from ALSA */
id|pci_write_config_byte
c_func
(paren
id|pdev
