...
multiline_comment|/*&n; * linux/kernel/chr_drv/sound/pas2_mixer.c&n; * &n; * Mixer routines for the Pro Audio Spectrum cards.&n; * &n; * Copyright by Hannu Savolainen 1993&n; * &n; * Redistribution and use in source and binary forms, with or without&n; * modification, are permitted provided that the following conditions are&n; * met: 1. Redistributions of source code must retain the above copyright&n; * notice, this list of conditions and the following disclaimer. 2.&n; * Redistributions in binary form must reproduce the above copyright notice,&n; * this list of conditions and the following disclaimer in the documentation&n; * and/or other materials provided with the distribution.&n; * &n; * THIS SOFTWARE IS PROVIDED BY THE AUTHOR AND CONTRIBUTORS ``AS IS&squot;&squot; AND ANY&n; * EXPRESS OR IMPLIED WARRANTIES, INCLUDING, BUT NOT LIMITED TO, THE IMPLIED&n; * WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE ARE&n; * DISCLAIMED.  IN NO EVENT SHALL THE AUTHOR OR CONTRIBUTORS BE LIABLE FOR&n; * ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL&n; * DAMAGES (INCLUDING, BUT NOT LIMITED TO, PROCUREMENT OF SUBSTITUTE GOODS OR&n; * SERVICES; LOSS OF USE, DATA, OR PROFITS; OR BUSINESS INTERRUPTION) HOWEVER&n; * CAUSED AND ON ANY THEORY OF LIABILITY, WHETHER IN CONTRACT, STRICT&n; * LIABILITY, OR TORT (INCLUDING NEGLIGENCE OR OTHERWISE) ARISING IN ANY WAY&n; * OUT OF THE USE OF THIS SOFTWARE, EVEN IF ADVISED OF THE POSSIBILITY OF&n; * SUCH DAMAGE.&n; * &n; */
...
(brace
multiline_comment|/* Select input or output mixer */
id|left
op_or_assign
id|mixer
suffix:semicolon
...
(brace
multiline_comment|/* Bass and trebble are mono devices&t; */
id|pas_write
(paren
...
id|SOUND_MIXER_IMIX
suffix:colon
multiline_comment|/* Recording monitor (0-31) (Only available&n;&t;&t;&t;&t; * on the Output Mixer) */
id|levels
(braket
id|whichDev
)braket
...
(brace
DECL|macro|cmix
mdefine_line|#define cmix(v) ((((v.r*100+7)/15)&lt;&lt;8)| ((v.l*100+7)/15))
r_struct
id|sb_mixer_levels
id|l
suffix:semicolon
...
op_or_assign
(paren
id|P_C_MIXER_CROSS_R_TO_L
op_or
id|P_C_MIXER_CROSS_L_TO_R
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;   * setmixer (OUT_FILTER, ((dsp_stereo ? STEREO_DAC : MONO_DAC) |&n;   * (p.filter_output ? FILT_ON : FILT_OFF)));&n;   */
r_return
(paren
l_int|0
)paren
