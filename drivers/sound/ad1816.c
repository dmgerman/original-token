...
r_else
(brace
multiline_comment|/* remove specified soundcard */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* ----------------------------- 2.1.xxx module stuff ----------------- */
DECL|variable|ad1816_interrupt
id|EXPORT_SYMBOL
c_func
(paren
id|ad1816_interrupt
