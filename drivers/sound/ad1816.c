multiline_comment|/*&n; *&n; * AD1816 lowlevel sound driver for Linux 2.2.0 and above&n; *&n; * Copyright (C) 1998 by Thorsten Knabe &lt;tek@rbg.informatik.tu-darmstadt.de&gt;&n; *&n; * Based on the CS4232/AD1848 driver Copyright (C) by Hannu Savolainen 1993-1996&n; *&n; * This software is still under development. New versions of the driver &n; * are available from:&n; * http://www.student.informatik.tu-darmstadt.de/~tek/projects/linux.html&n; * or http://www.tu-darmstadt.de/~tek01/projects/linux.html&n; * &n; * Please report any bugs to: tek@rbg.informatik.tu-darmstadt.de&n; *&n; *&n; * version: 1.3&n; * cvs: $Header: /home/tek/CVSROOT/sound22/ad1816.c,v 1.3 1999/04/18 16:41:41 tek Exp $&n; * status: experimental&n; * date: 1999/4/18&n; *&n; * Changes:&n; *&t;Oleg Drokin: Some cleanup of load/unload functions.&t;1998/11/24&n; *&t;&n; *&t;Thorsten Knabe: attach and unload rewritten, &n; *&t;some argument checks added&t;&t;&t;&t;1998/11/30&n; *&n; *&t;Thorsten Knabe: Buggy isa bridge workaround added&t;1999/01/16&n; *&t;&n; *&t;David Moews/Thorsten Knabe: Introduced options &n; *&t;parameter. Added slightly modified patch from &n; *&t;David Moews to disable dsp audio sources by setting &n; *&t;bit 0 of options parameter. This seems to be&n; *&t;required by some Aztech/Newcom SC-16 cards.&t;&t;1999/04/18&n; *&n; *&t;Christoph Hellwig: Adapted to module_init/module_exit.&t;2000/03/03&n; */
...
DECL|macro|DEBUGLOG
mdefine_line|#define DEBUGLOG(x) x
DECL|macro|DEBUGWARN
mdefine_line|#define DEBUGWARN(x) x
