...
suffix:semicolon
multiline_comment|/*&n; *    Return the chip back to GUS compatible mode.&n; */
id|gus_write8
(paren
l_int|0x19
comma
...
r_break
suffix:semicolon
multiline_comment|/* This is just a temporary hack used for reading the ROM patch set. */
r_case
...
suffix:semicolon
multiline_comment|/* Select ROM I/O access */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
DECL|variable|gus_audio_operations
r_static
r_struct
id|audio_operations
id|gus_audio_operations
op_assign
(brace
l_string|&quot;Gravis UltraSound&quot;
comma
...
id|EINVAL
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;   * Was there a bug?&n;&t;&t;&t;&t; */
id|offs
op_add_assign
id|sample_ptrs
(braket
...
id|EINVAL
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t;   * Invalid offset&n;&t;&t;&t;&t; */
id|n
op_assign
id|samples
(braket
