...
multiline_comment|/*&n; * Define this to enable recording,&n; * this is curently broken and using it will cause data corruption&n; * in kernel- and user-space!&n; */
multiline_comment|/* #define CS46XX_ENABLE_RECORD */
...
mdefine_line|#define DRIVER_VERSION &quot;0.09&quot;
...
(paren
id|KERN_ERR
l_string|&quot;cs461x: playback schedule timeout, &quot;
l_string|&quot;dmasz %u fragsz %u count %i hwptr %u swptr %u&bslash;n&quot;
comma
id|dmabuf-&gt;dmasize
comma
...
(brace
multiline_comment|/* Manage the EAPD bit on the Crystal 4297 */
r_int
id|old
op_assign
id|card-&gt;amplifier
