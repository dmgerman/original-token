multiline_comment|/*&n; * sound/sb16_dsp.c&n; *&n; * The low level driver for the SoundBlaster DSP chip.&n; */
...
macro_line|#if defined(CONFIG_SB) &amp;&amp; defined(CONFIG_AUDIO)
r_extern
r_int
id|sbc_base
suffix:semicolon
...
r_static
r_void
DECL|function|sb16_dsp_trigger
id|sb16_dsp_trigger
(paren
r_int
id|dev
