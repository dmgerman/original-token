...
DECL|macro|StopDMA
mdefine_line|#define StopDMA() custom.aud[0].audvol = custom.aud[1].audvol = 0; &bslash;&n;&t;&t;custom.aud[2].audvol = custom.aud[3].audvol = 0; &bslash;&n;&t;&t;custom.dmacon = AMI_AUDIO_OFF;
...
suffix:semicolon
multiline_comment|/* We really want to execute a DMA stop command, after the AWACS&n;&t; * is initialized.&n;&t; * For reasons I don&squot;t understand, it stops the hissing noise&n;&t; * common to many PowerBook G3 systems (like mine :-).  Maybe it&n;&t; * is just the AWACS control register change......&n;&t; */
id|out_le32
c_func
(paren
op_amp
...
multiline_comment|/* XXXX debugging code */
r_for
c_loop
(paren
id|j
