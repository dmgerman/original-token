...
suffix:semicolon
multiline_comment|/* ++TeSche: before changing any of these it&squot;s&n;&t;&t;&t; * probably wise to wait until sound playing has&n;&t;&t;&t; * settled down. */
r_case
id|SNDCTL_DSP_SPEED
suffix:colon
id|sound_fsync
