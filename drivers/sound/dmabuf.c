...
id|buffsize
suffix:semicolon
multiline_comment|/* reorganize_buffers (dev, audio_devs[dev]-&gt;dmap_out); */
r_if
c_cond
(paren
id|audio_devs
...
id|buffsize
suffix:semicolon
multiline_comment|/* reorganize_buffers (dev, audio_devs[dev]-&gt;dmap_in); */
)brace
r_else
(brace
id|audio_devs
