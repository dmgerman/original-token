...
id|dmap_out
suffix:semicolon
multiline_comment|/* Don&squot;t allow touching pages too close to the playing ones */
r_int
id|lim
op_assign
id|dmap-&gt;nbufs
...
id|dmap-&gt;qtail
suffix:semicolon
macro_line|#if defined(PPC) || defined(sparc) || defined(HPPA)
id|dmap-&gt;neutral_byte
op_assign
id|dmap-&gt;raw_buf
(braket
...
multiline_comment|/* Delay playback until there are at least two fragments (to prevent hiccup) */
r_if
c_cond
(paren
id|dmap-&gt;qlen
...
multiline_comment|/* Handle cards with non automode DMA in new way */
r_if
c_cond
(paren
id|physaddr
...
multiline_comment|/* Not fragment 0 */
r_return
id|count
suffix:semicolon
id|count
...
(brace
multiline_comment|/* printk (&quot;Sound: Recording overrun&bslash;n&quot;); */
id|dmap-&gt;underrun_count
op_increment
suffix:semicolon
r_if
