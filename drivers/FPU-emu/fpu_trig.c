...
multiline_comment|/* Not needed now with new code&n;#define FPTAN 1&n; */
...
(brace
multiline_comment|/* A denormal result has been produced.&n;&t;       Precision must have been lost, this is always&n;&t;       an underflow. */
id|arith_underflow
c_func
(paren
id|st0_ptr
...
suffix:semicolon
multiline_comment|/* Must be down. */
)brace
id|push
c_func
(paren
...
(brace
multiline_comment|/* A denormal result has been produced.&n;&t;     Precision must have been lost.&n;&t;     This is by definition an underflow. */
id|arith_underflow
c_func
(paren
id|st1_ptr
