multiline_comment|/*---------------------------------------------------------------------------+&n; |  poly_sin.c                                                               |&n; |                                                                           |&n; |  Computation of an approximation of the sin function and the cosine       |&n; |  function by a polynomial.                                                |&n; |                                                                           |&n; | Copyright (C) 1992,1993,1994                                              |&n; |                       W. Metzenthen, 22 Parker St, Ormond, Vic 3163,      |&n; |                       Australia.  E-mail   billm@vaxc.cc.monash.edu.au    |&n; |                                                                           |&n; |                                                                           |&n; +---------------------------------------------------------------------------*/
...
(brace
multiline_comment|/* The argument is &gt; 0.88309101259 */
multiline_comment|/* We use sin(arg) = cos(pi/2-arg) */
id|fixed_arg
op_assign
id|significand
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* Is a valid positive nr */
id|significand
c_func
(paren
id|result
