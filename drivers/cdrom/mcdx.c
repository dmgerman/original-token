...
multiline_comment|/*  actions done on open:&n; *  1)  get the drives status &n; *  2)  set the stuffp.readcmd if a CD is in.&n; *  (return no error if no CD is found, since ioctl() &n; *  needs an opened device */
(brace
r_struct
id|s_drive_stuff
op_star
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* We don&squot;t allow multiple users of a drive.  In case of data CDs&n;     * they&squot;ll be used by mounting, which ensures anyway exclusive&n;&t; * usage. In case of audio CDs it&squot;s meaningless to try playing to&n;&t; * different tracks at once! (md)&n;&t; * - Hey, what about cat /dev/cdrom? Why shouldn&squot;t it called by&n;&t; * more then one process at any time?  (hs) */
r_if
c_cond
(paren
id|stuffp-&gt;users
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;MOD_DEC_USE_COUNT;&n;&t;&t;&t;stuffp-&gt;xxx = 0;&n;&t;&t;&t;return -EIO;&n;&t;&t;&t;*/
)brace
r_else
(brace
...
multiline_comment|/* if (!tries) MOD_DEC_USE_COUNT, return -EIO; */
)brace
...
multiline_comment|/* stuffp-&gt;xxx = 0; */
)brace
...
c_func
(paren
l_string|&quot;Version 2.14(hs) for %s&bslash;n&quot;
comma
id|kernel_version
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;(%s) installed at 0x%3p, irq %d.&quot;
