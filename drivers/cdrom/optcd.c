...
suffix:semicolon
DECL|macro|SET_REQ_TIMER
mdefine_line|#define SET_REQ_TIMER(func, jifs) &bslash;&n;&t;req_timer.expires = jiffies+(jifs); &bslash;&n;&t;req_timer.function = (void *) (func); &bslash;&n;&t;add_timer(&amp;req_timer);
DECL|macro|CLEAR_REQ_TIMER
mdefine_line|#define CLEAR_REQ_TIMER&t;del_timer(&amp;req_timer)
DECL|function|poll
r_static
r_void
id|poll
