...
l_int|0
suffix:semicolon
multiline_comment|/* don&squot;t unlock the door on multiple opens */
r_if
c_cond
(paren
(paren
...
id|EINVAL
suffix:semicolon
multiline_comment|/* do max 8 frames at the time */
id|frames
op_assign
id|ra.nframes
OG
...
suffix:semicolon
multiline_comment|/* copy back sense data */
r_if
c_cond
(paren
id|ret
