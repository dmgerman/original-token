...
id|ti.track_mode
suffix:semicolon
multiline_comment|/* write_type 0 == packet/incremental writing */
id|wp.write_type
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* MODE1 or MODE2 writing */
r_switch
c_cond
(paren
id|ti.data_mode
...
c_func
(paren
l_string|&quot;%s: writeable with %s packets of %lu in length&quot;
comma
id|cdi-&gt;name
comma
id|wp.fp
