...
l_int|0x5a
suffix:semicolon
multiline_comment|/* MODE_SENSE_10 */
id|cgc-&gt;cmd
(braket
l_int|2
)braket
...
l_int|0x55
suffix:semicolon
multiline_comment|/* MODE_SELECT_10 */
id|cgc-&gt;cmd
(braket
l_int|1
)braket
...
id|CD_DO_IOCTL
comma
l_string|&quot;entering audio ioctl (start/stop)&bslash;n&quot;
)paren
suffix:semicolon
id|cgc.cmd
(braket
...
id|CD_DO_IOCTL
comma
l_string|&quot;entering audio ioctl (pause/resume)&bslash;n&quot;
)paren
suffix:semicolon
id|cgc.cmd
(braket
...
id|CD_DO_IOCTL
comma
l_string|&quot;entering send_packet&bslash;n&quot;
)paren
suffix:semicolon
id|IOCTL_IN
c_func
