...
multiline_comment|/* Now all the audio-ioctls follow, they are all routed through the&n;&t;   same call audio_ioctl(). */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* FIXME: only 1&squot;s and 0&squot;s should be accepted */
r_if
c_cond
(paren
id|write
