...
id|cdi-&gt;next
suffix:semicolon
multiline_comment|/* we need to find the device this way when IDE devices such&n;&t; * as /dev/hdc2 are opened. SCSI drives will be found above and&n;&t; * so will /dev/hdc, for instance.&n;&t; */
r_if
c_cond
(paren
id|cdi
...
id|CD_WARNING
comma
l_string|&quot;Recieved invalid manufacture info length (%d)&bslash;n&quot;
comma
id|s-&gt;bca.len
)paren
suffix:semicolon
...
id|EINVAL
suffix:semicolon
multiline_comment|/* do between 1 and 8 frames at the time */
r_if
c_cond
(paren
id|ra.nframes
...
id|EINVAL
suffix:semicolon
multiline_comment|/* just a nice round figure */
r_if
c_cond
(paren
(paren
...
id|CDROM_MSF
suffix:semicolon
multiline_comment|/* get toc entry for start and end track */
id|entry.cdte_track
op_assign
id|ti.cdti_trk0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* clear the first three */
id|memset
c_func
(paren
id|buffer
...
(brace
multiline_comment|/* usually commands just copy data one way, i.e.&n;&t;&t;&t; * we send a buffer to the drive and the command&n;&t;&t;&t; * specifies whether the drive will read or&n;&t;&t;&t; * write to that buffer. usually the buffers&n;&t;&t;&t; * are very small, so we don&squot;t loose that much&n;&t;&t;&t; * by doing a redundant copy each time. */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;can&squot;t get write perms&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;can&squot;t get read perms&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/* reasonable limits */
r_if
c_cond
(paren
id|cgc.buflen
...
c_func
(paren
l_string|&quot;invalid size given&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/* return the buffer size of writeable drives */
DECL|function|cdrom_read_buffer_capacity
r_static
r_int
id|cdrom_read_buffer_capacity
c_func
(paren
r_struct
id|cdrom_device_info
...
multiline_comment|/* return 0 if succesful and the disc can be considered writeable. */
DECL|function|cdrom_setup_writemode
r_static
r_int
id|cdrom_setup_writemode
c_func
...
id|ret
suffix:semicolon
multiline_comment|/* if the media is erasable, then it is either CD-RW or&n;&t; * DVD-RW - use fixed packets for those. non-erasable media&n;&t; * indicated CD-R or DVD-R media, use varible sized packets for&n;&t; * those (where the packet size is a bit less than the buffer&n;&t; * capacity of the drive. */
r_if
c_cond
(paren
id|di.erasable
...
(brace
id|cdi-&gt;write.fpacket
op_assign
l_int|1
suffix:semicolon
multiline_comment|/* FIXME: DVD-RW is 16, should get the packet size instead */
id|cdi-&gt;write.packet_size
op_assign
l_int|32
suffix:semicolon
)brace
...
id|CD_WARNING
comma
l_string|&quot;can&squot;t write to this disc&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
multiline_comment|/* NWA is only for CD-R and DVD-R. -RW media is randomly&n;&t; * writeable once it has been formatted. */
id|cdi-&gt;write.nwa
op_assign
id|ti.nwa_v
ques
...
l_int|5
suffix:semicolon
multiline_comment|/* should be ok with both CD and DVD */
r_if
c_cond
(paren
(paren
...
id|CD_WARNING
comma
l_string|&quot;%s: writeable with %lu block %s packets&bslash;n&quot;
comma
id|cdi-&gt;name
comma
id|cdi-&gt;write.packet_size
...
suffix:semicolon
id|cdrom_root_table-&gt;child-&gt;de-&gt;fill_inode
op_assign
op_amp
id|cdrom_procfs_modcount
suffix:semicolon
