...
DECL|macro|IOCTL_IN
mdefine_line|#define IOCTL_IN(arg, type, in) { &bslash;&n;            int ret=copy_from_user(&amp;in, (type *) arg, sizeof in); &bslash;&n;            if (ret) return ret; }
DECL|macro|IOCTL_OUT
mdefine_line|#define IOCTL_OUT(arg, type, out) { &bslash;&n;            int ret=copy_to_user((type *) arg, &amp;out, sizeof out); &bslash;&n;            if (ret) return ret; }
...
multiline_comment|/* This code is similar to that in open_for_data. The routine is called&n;   in case a audio play operation is requested. It doesn&squot;t make much sense&n;   to do this on a data disc.&n;*/
...
id|cdrom_drive_info
comma
l_string|&quot;CD-ROM information&bslash;n&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|buf
comma
l_string|&quot;drive name:&bslash;t&bslash;t%s&bslash;n&quot;
comma
id|cdi-&gt;name
)paren
suffix:semicolon
...
id|buf
comma
l_string|&quot;drive speed:&bslash;t&bslash;t%d&bslash;n&quot;
comma
id|cdi-&gt;speed
)paren
suffix:semicolon
...
id|buf
comma
l_string|&quot;drive # of slots:&bslash;t%d&bslash;n&quot;
comma
id|cdi-&gt;capacity
)paren
suffix:semicolon
...
id|buf
comma
l_string|&quot;Can close tray:&bslash;t&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can open tray:&bslash;t&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can lock tray:&bslash;t&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can change speed:&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can select disk:&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can read multisession:&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can read MCN:&bslash;t&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Reports media changed:&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
...
id|buf
comma
l_string|&quot;Can play audio:&bslash;t&bslash;t%d&bslash;n&quot;
comma
(paren
(paren
id|cdi-&gt;ops-&gt;capability
