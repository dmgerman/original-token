...
id|cmd
suffix:semicolon
multiline_comment|/* First, disable the device to avoid side&n;&t;&t;   effects of possibly overlapping I/O and&n;&t;&t;   memory ranges.&n;&t;&t;   Except the VGA - for obvious reason. :-)  */
r_if
c_cond
(paren
id|dev
