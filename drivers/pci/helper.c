multiline_comment|/*&n; * $Id$&n; *&n; * drivers/pci/helper.c&n; *&n; * Copyright 1999 Jeff Garzik &lt;jgarzik@mandrakesoft.com&gt;&n; * This software is free.  See the file COPYING for licensing details.&n; *&n; */
