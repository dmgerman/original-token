...
id|parent-&gt;sysdata
suffix:semicolon
multiline_comment|/*&n;&t; * Set up the primary, secondary and subordinate&n;&t; * bus numbers.  Read resource ranges behind the bridge.&n;&t; */
id|child-&gt;number
op_assign
id|child-&gt;secondary
op_assign
...
multiline_comment|/*&n; * Read the config data for a PCI device&n; * and sanity-check it and fill in the dev&n; * structure...&n; */
...
id|bus-&gt;secondary
suffix:semicolon
multiline_comment|/* Allocate the device ahead of time.. */
id|dev
op_assign
id|kmalloc
c_func
