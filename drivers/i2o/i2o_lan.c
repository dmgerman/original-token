...
suffix:semicolon
singleline_comment|// FIXME on 64-bit host
id|u32
op_star
id|sgl_elem
op_assign
...
r_return
suffix:semicolon
multiline_comment|/* Getting unused buckets back? */
r_if
c_cond
(paren
id|msg
...
op_amp
id|I2O_LAN_DSC_RECEIVE_ABORTED
)paren
(brace
id|i2o_lan_release_buckets
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: Releasing unused sk_buff %p (trl_count=%d).&bslash;n&quot;
comma
id|dev-&gt;name
comma
(paren
...
multiline_comment|/* Note: EventAck necessary only for events that cause the device to&n;&t; * syncronize with the user.&n;&t; */
)brace
...
suffix:semicolon
singleline_comment|//&t;read_unlock_bh(&amp;dev_mc_lock);
r_return
suffix:semicolon
)brace
DECL|variable|i2o_lan_set_mc_list_task
r_static
r_struct
id|tq_struct
id|i2o_lan_set_mc_list_task
op_assign
(brace
l_int|0
comma
...
(brace
id|i2o_lan_set_mc_list_task.data
op_assign
(paren
r_void
op_star
