...
id|tx_count
suffix:semicolon
multiline_comment|/* nbr of outstanding TXes */
DECL|member|max_tx
id|u32
id|max_tx
suffix:semicolon
...
singleline_comment|// Getting unused buckets back
id|i2o_lan_release_buckets
c_func
(paren
id|dev
...
(paren
id|KERN_INFO
l_string|&quot;Buckets_remaining = %d, bucket_count = %d, trl_count = %d&bslash;n&quot;
comma
id|msg
(braket
l_int|5
...
suffix:semicolon
singleline_comment|// Check to see if HDM queue is full..if so...stay busy
r_if
c_cond
(paren
op_increment
...
suffix:semicolon
singleline_comment|//        &t;&t;&t;printk(&quot;%s: Unable to query LAN_OPTIONAL_802_3_HISTORICAL_STATS.&bslash;n&quot;,dev-&gt;name);
r_else
(brace
id|dprintk
c_func
