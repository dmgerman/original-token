...
id|reply_flag
suffix:semicolon
singleline_comment|// needed by scalar/table queries
DECL|member|stats
r_struct
id|fddi_statistics
id|stats
suffix:semicolon
multiline_comment|/*&t;first fields are same as in struct net_device_stats stats; */
...
c_func
(paren
l_string|&quot;Releasing unused bucket&bslash;n&quot;
)paren
suffix:semicolon
id|skb
op_assign
...
singleline_comment|// reply to a util get/set
(brace
singleline_comment|// flag for the i2o_post_wait
r_int
op_star
id|flag
op_assign
...
suffix:semicolon
singleline_comment|// ReqStatus != I2O_REPLY_STATUS_SUCCESS
op_star
id|flag
op_assign
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* &n; * NOTE: here we assume that also in batch mode we will get only &n; * one packet per bucket. This can be ensured by setting the &n; * PacketOrphanLimit to MaxPacketSize, as well as the bucket size.&n; */
r_do
(brace
multiline_comment|/* packet is not at all needed here */
id|packet
op_assign
(paren
r_struct
...
l_int|12
suffix:semicolon
singleline_comment|// msg header + SGLs
id|u32
id|total
op_assign
l_int|0
...
(paren
id|KERN_INFO
l_string|&quot;%s: Allocating %d buckets (size %d).&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|I2O_BUCKET_COUNT
...
(paren
id|KERN_INFO
l_string|&quot;PacketOrphanLimit set to %d&bslash;n&quot;
comma
id|val
)paren
suffix:semicolon
macro_line|#ifdef 0
multiline_comment|/*&n; * I2O spec 2.0: there should be proper default values for other attributes &n; * used in batch mode.&n; */
multiline_comment|/* set LAN_RECEIVE_INFO attributes */
id|val
op_assign
l_int|10
suffix:semicolon
singleline_comment|// RxMaxBucketsReply
r_if
c_cond
(paren
id|i2o_params_set
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Unable to set RxMaxBucketsReply.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|10
suffix:semicolon
singleline_comment|// RxMaxPacketsBuckets
r_if
c_cond
(paren
id|i2o_params_set
...
l_int|10
suffix:semicolon
singleline_comment|// MaxRxBatchCount
r_if
c_cond
(paren
id|i2o_params_set
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Unable to set MaxRxBatchCount.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
l_int|10
suffix:semicolon
singleline_comment|// MaxTxBatchCount
r_if
c_cond
(paren
id|i2o_params_set
...
(paren
id|KERN_WARNING
l_string|&quot;%s Unable to set MaxTxBatchCount.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Unable to unclaim I2O LAN device (tid=%d)&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|i2o_dev-&gt;id
...
multiline_comment|/*&n; * net_device_stats(): Return statistical information.&n; */
...
suffix:semicolon
multiline_comment|/* query LAN_HISTORICAL_STATS scalar parameter group 0x0100 */
id|i2o_query_scalar
c_func
(paren
id|iop
...
suffix:semicolon
singleline_comment|// other net_device_stats and FDDI class specific fields follow ...
r_return
(paren
r_struct
id|net_device_stats
...
(paren
id|KERN_INFO
l_string|&quot;Entered i2o_lan_set_multicast_list().&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
multiline_comment|/*&n; * FIXME: For some reason this kills interrupt handler in i2o_post_wait :-(&n; * &n; */
id|dprintk
c_func
(paren
id|KERN_INFO
l_string|&quot;dev-&gt;flags = 0x%08X, dev-&gt;mc_count = 0x%08X&bslash;n&quot;
comma
id|dev-&gt;flags
comma
id|dev-&gt;mc_count
...
(paren
id|KERN_WARNING
l_string|&quot;i2o_lan: Unable to query filter mask.&bslash;n&quot;
)paren
suffix:semicolon
id|dprintk
c_func
(paren
id|KERN_INFO
l_string|&quot;filter_mask = 0x%08X&bslash;n&quot;
comma
id|filter_mask
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;i2o_lan: Unable to enable promiscuous multicast mode.&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|dprintk
...
(paren
id|KERN_INFO
l_string|&quot;i2o_lan: Promiscuous multicast mode enabled.&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
)brace
singleline_comment|// &t;if ((dev-&gt;flags &amp; IFF_ALLMULTI) || dev-&gt;mc_count &gt; HW_MAX_ADDRS)
singleline_comment|// &t;{
singleline_comment|//        &t;// Disable promiscuous mode, use normal mode.
singleline_comment|// &t;&t;hardware_set_filter(NULL);
singleline_comment|//
singleline_comment|//&t;&t;dprintk(KERN_INFO &quot;i2o_lan: Disabled promiscuous mode, uses normal mode&bslash;n&quot;); 
singleline_comment|//
singleline_comment|//&t;&t;filter_mask = 0x00000000; 
singleline_comment|//&t;&t;i2o_params_set(iop, i2o_dev-&gt;id, lan_context, 0x0001, 3,
singleline_comment|//&t;&t;&t;&t;&amp;filter_mask, 4, &amp;priv-&gt;reply_flag);
...
(brace
singleline_comment|// Walk the address list, and load the filter
singleline_comment|//              hardware_set_filter(dev-&gt;mc_list);
id|filter_mask
op_assign
l_int|0x00000004
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;i2o_lan: Unable to enable unicast mode.&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|dprintk
...
(paren
id|KERN_INFO
l_string|&quot;i2o_lan: Unicast mode enabled.&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
id|I2O_LAN_ETHERNET
suffix:colon
multiline_comment|/* Note: init_etherdev calls &n;&t;&t;&t; ether_setup() and register_netdevice() &n;&t;&t;&t; and allocates the priv structure&t; */
id|dev
op_assign
id|init_etherdev
c_func
...
r_break
suffix:semicolon
multiline_comment|/*&n;#ifdef CONFIG_ANYLAN&n;&t;case I2O_LAN_100VG:&n;&t;&t;printk(KERN_WARNING &quot;i2o_lan: 100base VG not yet supported&bslash;n&quot;);&n;&t;&t;break;&n;#endif&n;*/
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;#ifdef CONFIG_FIBRE_CHANNEL&n;&t;case I2O_LAN_FIBRE_CHANNEL:&n;&t;&t;printk(KERN_WARNING &quot;i2o_lan: Fibre Channel not yet supported&bslash;n&quot;);&n;&t;break;&n;#endif&n;*/
r_case
id|I2O_LAN_UNKNOWN
suffix:colon
r_default
...
multiline_comment|/* not I2O_CLASS_LAN device*/
r_continue
suffix:semicolon
r_if
c_cond
