...
id|bucket_count
suffix:semicolon
multiline_comment|/*&n;    * Keep track of no. of outstanding TXes&n;    */
...
(paren
id|KERN_INFO
l_string|&quot;%s: DDM out of buckets (count = %d)! &quot;
l_string|&quot;Number of posts = %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|msg
