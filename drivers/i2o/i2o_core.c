...
(paren
id|KERN_INFO
l_string|&quot;%s busy: %d users for controller.&bslash;n&quot;
comma
id|c-&gt;name
comma
id|users
...
(brace
multiline_comment|/* Ask the IOP to switch into RESET state */
id|i2o_reset_controller
c_func
(paren
id|c
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Sometimes we get here, but a message can&squot;t be read. Why? */
r_if
c_cond
(paren
(paren
...
singleline_comment|//&t;if (iop-&gt;status_block-&gt;iop_state == ADAPTER_STATE_HOLD ||
r_if
c_cond
(paren
id|iop-&gt;status_block-&gt;iop_state
