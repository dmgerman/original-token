...
c_func
(paren
l_string|&quot;Quiescing controller %p != %p&bslash;n&quot;
comma
id|c
comma
op_star
...
(brace
multiline_comment|/* Quiesce is rejected on hold state */
r_if
c_cond
(paren
id|iop-&gt;status
...
(paren
id|KERN_INFO
l_string|&quot;Dumping I2O message @ %p&bslash;n&quot;
comma
id|msg
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;&bslash;tmsg[%d] = %#10x&bslash;n&quot;
comma
id|i
comma
id|msg
...
suffix:semicolon
multiline_comment|/*&n;&t; * Attach core to I2O PCI subsystem&n;&t; */
macro_line|#ifdef CONFIG_I2O_PCI_MODULE
r_if
c_cond
(paren
