...
(paren
id|KERN_WARNING
l_string|&quot;i2o: Too many managers for TID %d&bslash;n&quot;
comma
id|d-&gt;lct_data-&gt;tid
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Timeout waiting for message frame (%s).&bslash;n&quot;
comma
id|c-&gt;name
comma
id|why
...
(paren
id|KERN_INFO
l_string|&quot;%s: LCT was truncated.&bslash;n&quot;
comma
id|c-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;%s: Not in READY or OPERATIONAL state&bslash;n&quot;
comma
id|c-&gt;name
)paren
)paren
...
id|ADAPTER_TID
suffix:semicolon
multiline_comment|/* msg[2] and msg[3] filled in i2o_post_wait */
...
(paren
id|KERN_INFO
l_string|&quot;%s: Unable to quiesce.&bslash;n&quot;
comma
id|c-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: Could not enable, %d&bslash;n&quot;
comma
id|c-&gt;name
comma
id|ret
...
(paren
id|KERN_INFO
l_string|&quot;%s: Unable to clear, %#10x&bslash;n&quot;
comma
id|c-&gt;name
comma
id|ret
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Reset rejected.&bslash;n&quot;
comma
id|c-&gt;name
)paren
suffix:semicolon
...
id|ret
suffix:semicolon
multiline_comment|/* See i2o_status_block */
macro_line|#if 0
id|iop-&gt;status-&gt;current_mem_base
suffix:semicolon
id|iop-&gt;status-&gt;current_mem_size
suffix:semicolon
id|iop-&gt;status-&gt;current_io_base
suffix:semicolon
id|iop-&gt;status-&gt;current_io_size
suffix:semicolon
macro_line|#endif
id|privmem
(braket
...
id|ADAPTER_TID
suffix:semicolon
multiline_comment|/* [2] and [3] filled in i2o_post_wait */
id|msg
(braket
l_int|4
)braket
...
multiline_comment|/* &n;         * Provide three SGL-elements:&n;         * System table (SysTab), Private memory space declaration and &n;         * Private i/o space declaration  &n;&t; */
id|msg
(braket
l_int|6
)braket
...
(paren
id|KERN_INFO
l_string|&quot;%s: Unable to set SysTab, %d&bslash;n&quot;
comma
id|iop-&gt;name
comma
id|ret
...
multiline_comment|/*&n; * Shutdown I2O system&n; *&n; * 1. Quiesce all controllers&n; * 2. Delete all controllers&n; */
...
suffix:semicolon
singleline_comment|// Update IOP status block
)brace
r_for
c_loop
(paren
...
(paren
id|KERN_INFO
l_string|&quot;%s: Configuring I2O controller at 0x%08X.&bslash;n&quot;
comma
id|c-&gt;name
comma
(paren
...
multiline_comment|/*&n;         *      Scatter Gather List&n;         */
id|__raw_writel
c_func
(paren
l_int|0x54000000
...
id|ret
suffix:semicolon
multiline_comment|/*&n;         *      Finally we go online&n;         */
id|ret
op_assign
id|i2o_enable_controller
c_func
...
multiline_comment|/*&n;         *      Grab the LCT, see what is attached&n;         */
id|ret
op_assign
id|i2o_lct_get
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;i2o: i2o_post_wait reply after timeout!&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/*&n; *      Send UTIL_EVENT messages&n; */
...
(paren
id|KERN_ERR
l_string|&quot;i2o: Unable to install core handler.&bslash;nI2O stack not loaded!&quot;
)paren
suffix:semicolon
r_return
l_int|0
