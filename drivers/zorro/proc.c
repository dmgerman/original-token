multiline_comment|/*&n; *&t;$Id: proc.c,v 1.1.2.1 1998/06/07 23:21:01 geert Exp $&n; *&n; *&t;Procfs interface for the Zorro bus.&n; *&n; *&t;Copyright (C) 1998 Geert Uytterhoeven&n; *&n; *&t;Heavily based on the procfs interface for the PCI bus, which is&n; *&n; *&t;Copyright (C) 1997, 1998 Martin Mares &lt;mj@atrey.karlin.mff.cuni.cz&gt;&n; */
...
id|buf
comma
l_string|&quot;%02x&bslash;t%04x%02x%02x&bslash;t%08x&bslash;t%08x&bslash;t%02x&bslash;n&quot;
comma
id|slot
comma
id|manuf
...
DECL|variable|proc_zorro_devices
r_static
r_struct
id|proc_dir_entry
id|proc_zorro_devices
op_assign
(brace
