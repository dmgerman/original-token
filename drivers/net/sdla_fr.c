...
id|TracingEnabled
suffix:semicolon
multiline_comment|/* variable for checking interrupts within the ISR routine */
DECL|variable|int_occur
r_static
r_int
id|int_occur
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;%s:Interrupt Occurred within an ISR&bslash;n&quot;
comma
id|card-&gt;devname
)paren
suffix:semicolon
