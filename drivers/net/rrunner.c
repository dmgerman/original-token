...
id|version
op_assign
l_string|&quot;rrunner.c: v0.09 12/14/98  Jes Sorensen (Jes.Sorensen@cern.ch)&bslash;n&quot;
suffix:semicolon
r_static
r_int
r_int
...
multiline_comment|/*&n; * Local variables:&n; * compile-command: &quot;gcc -D__SMP__ -D__KERNEL__ -I../../include -Wall -Wstrict-prototypes -O2 -pipe -fomit-frame-pointer -fno-strength-reduce -m486 -malign-loops=2 -malign-jumps=2 -malign-functions=2 -DCPU=686 -c rrunner.c&quot;&n; * End:&n; */
eof
