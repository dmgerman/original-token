...
id|version
op_assign
l_string|&quot;rrunner.c: v0.17 03/09/99  Jes Sorensen (Jes.Sorensen@cern.ch)&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * These seem to have no real effect as the Firmware sets&n;&t; * it&squot;s own default values&n;&t; */
id|writel
c_func
(paren
l_int|0x10
