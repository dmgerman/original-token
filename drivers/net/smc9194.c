...
suffix:semicolon
multiline_comment|/* check if the area is available */
r_if
c_cond
(paren
id|check_region
...
r_continue
suffix:semicolon
multiline_comment|/* check this specific address */
r_if
c_cond
(paren
id|smc_probe
...
id|irqval
suffix:semicolon
multiline_comment|/* see if I need to initialize the ethernet card structure */
r_if
c_cond
(paren
id|dev
...
(paren
id|CARDNAME
l_string|&quot;: %s(r:%d) at %#3x IRQ:%d INTF:%s MEM:%db &quot;
comma
id|version_string
comma
id|revision_register
