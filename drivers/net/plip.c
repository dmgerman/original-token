...
multiline_comment|/*&n;    Written 1993 by Donald Becker and TANABE Hiroyasu.&n;    This code is distributed under the GPL.&n;    &n;    The current author is reached as hiro@sanpo.t.u-tokyo.ac.jp .&n;    For more information do &squot;whois -h whois.nic.ad.jp HT043JP&squot;&n;&n;    The original author may be reached as becker@super.org or&n;    C/O Supercomputing Research Ctr., 17100 Science Dr., Bowie MD 20715&n;&n;    This is parallel port packet pusher.  It&squot;s actually more general&n;    than the &quot;IP&quot; in its name suggests -- but &squot;plip&squot; is just such a&n;    great name!&n;&n;    This driver was first developed by D. Becker, when he was inspired by&n;    Russ Nelson&squot;s parallel port packet driver.  He also did the update&n;    to 0.99.10.&n;&n;    It was further developed by Tommy Thorn (tthorn@daimi.aau.dk).&n;&n;    Recent versions were debugged and maintained by TANABE Hiroyasu.&n;&n;    Updated for 0.99pl12 by Donald Becker.&n;    &n;    Changes even more Alan Cox &lt;iiitac@pyr.swan.ac.uk&gt;&n;    Fixed: sets skb-&gt;arp=1, always claims success like ethernet, doesn&squot;t&n;    free skb and then claim fail. Incorrect brackets causing reset problem&n;    Attempting to make it work (works for me - email me if it does work)&n;    &n;    Bugs:&n;    &t;Should be timer oriented state machine. &n;    &t;Should never use jiffies for timeouts.&n;    &t;Protocol is buggy when broadcasts occur (Must ask Russ Nelson)&n;    &t;Can hang forever on collisions (tough - you fix it!).&n;    &t;I get 15K/second NFS throughput (about 20-25K second IP).&n;    &t;Change the protocol back.&n;    &t;&n;*/
...
id|version
op_assign
l_string|&quot;Net2Debugged PLIP 1.01 (from plip.c:v0.15 for 0.99pl12+, 8/11/93)&bslash;n&quot;
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* probably wrong interrupt */
id|length
op_assign
id|get_byte
c_func
...
(paren
(paren
l_string|&quot;%s: wrong header octet&bslash;n&quot;
comma
id|dev-&gt;name
)paren
)paren
...
(paren
(paren
l_string|&quot;remote end become unready while sending&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
l_int|1
suffix:semicolon
multiline_comment|/* select plip type */
(brace
multiline_comment|/* Use stripped ethernet header if each first 5 octet of eth&n;&t; * address is same.&n;&t; */
r_int
id|i
suffix:semicolon
r_struct
...
suffix:semicolon
multiline_comment|/* send header octet */
(brace
multiline_comment|/* send packet&squot;s length */
multiline_comment|/*&n;&t; * in original plip (before v0.1), it was sent with little endian.&n;&t; * but in internet, network byteorder is big endian,&n;&t; * so changed to use big endian.&n;&t; * maybe using &squot;ntos()&squot; is better.&n;&t; */
id|send_byte
c_func
(paren
id|dev
...
r_static
r_int
DECL|function|plip_send_enethdr
id|plip_send_enethdr
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|plip_rebuild_enethdr
id|plip_rebuild_enethdr
c_func
(paren
r_struct
