...
DECL|macro|HeathrowFCR
mdefine_line|#define HeathrowFCR 0x0038&t;/* FCR offset from Heathrow Base Address */
DECL|macro|fcrEnetEnabledBits
mdefine_line|#define fcrEnetEnabledBits&t;0x60000000 /* mask to enable Enet Xcvr/Controller */
DECL|macro|fcrResetEnetCell
mdefine_line|#define fcrResetEnetCell&t;0x80000000 /* mask used to reset Enet cell */
DECL|macro|fcrClearResetEnetCell
mdefine_line|#define fcrClearResetEnetCell&t;0x7fffffff /* mask used to clear reset Enet cell */
DECL|macro|fcrDisableEnet
mdefine_line|#define fcrDisableEnet&t;&t;0x1fffffff /* mask to disable Enet Xcvr/Controller */
...
suffix:semicolon
multiline_comment|/* yuck--double buffering */
DECL|member|tx_fill
r_int
id|tx_fill
suffix:semicolon
...
id|fcrDisableEnet
suffix:semicolon
multiline_comment|/* clear out Xvr and Controller Bit */
id|out_le32
c_func
(paren
id|heathrowFCR
...
id|fcrResetEnetCell
suffix:semicolon
multiline_comment|/* set bit to reset them */
id|out_le32
c_func
(paren
id|heathrowFCR
...
(paren
(paren
l_string|&quot;bmac: double buffering, double=%#08x, skb-&gt;data=%#08x, len=%d&bslash;n&quot;
comma
id|doubleBuf
comma
id|skb-&gt;data
...
(brace
multiline_comment|/* zero out tx cmds, alloc space for double buffering */
id|addr
op_assign
(paren
r_char
...
l_int|0
suffix:semicolon
multiline_comment|/* XXDEBUG((&quot;bmac_intr: cleared tbusy, empty=%d fill=%d&bslash;n&quot;, */
multiline_comment|/* &t;&t; i, bp-&gt;tx_fill)); */
id|mark_bh
c_func
(paren
id|NET_BH
...
multiline_comment|/*     while(dev-&gt;tbusy) schedule(); */
multiline_comment|/* Lock out others. */
multiline_comment|/*     set_bit(0, (void *) &amp;dev-&gt;tbusy); */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* &t;{ */
multiline_comment|/* &t;    unsigned char random_packet[100]; */
multiline_comment|/* &t;    unsigned int i; */
multiline_comment|/* &t;    struct sk_buff *skb = dev_alloc_skb(RX_BUFLEN+2); */
multiline_comment|/* &t;    unsigned char *data = skb_put(skb, sizeof(random_packet)); */
multiline_comment|/* XXDEBUG((&quot;transmitting random packet&bslash;n&quot;)); */
multiline_comment|/* &t;    for (i = 0; i &lt; sizeof(random_packet); i++) data[i] = i; */
multiline_comment|/* &t;    bmac_transmit_packet(skb, dev); */
multiline_comment|/* XXDEBUG((&quot;done transmitting random packet&bslash;n&quot;)); */
multiline_comment|/* &t;} */
)brace
id|restore_flags
c_func
...
(paren
id|KERN_ERR
l_string|&quot;can&squot;t use BMAC %s: expect 3 addrs and 3 intrs&bslash;n&quot;
comma
id|bmacs-&gt;full_name
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* XXX this doesn&squot;t look right (but it&squot;s never used :-) */
id|dev-&gt;priv
op_assign
id|kmalloc
c_func
...
(paren
id|KERN_ERR
l_string|&quot;Can&squot;t get mac-address for BMAC at %lx&bslash;n&quot;
comma
id|dev-&gt;base_addr
)paren
suffix:semicolon
...
(paren
(paren
l_string|&quot;bmac: free doubles&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*MEMORY LEAK BELOW!!! FIX!!! */
r_if
c_cond
(paren
id|bp-&gt;tx_double
...
(paren
id|KERN_DEBUG
l_string|&quot;bmac: clearing tbusy&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_if
