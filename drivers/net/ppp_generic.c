...
suffix:semicolon
multiline_comment|/*&n; * Bits in flags: SC_NO_TCP_CCID, SC_CCP_OPEN, SC_CCP_UP, SC_LOOP_TRAFFIC,&n; * SC_MULTILINK, SC_MP_SHORTSEQ, SC_MP_XSHORTSEQ.&n; * Bits in rstate: SC_DECOMP_RUN, SC_DC_ERROR, SC_DC_FERROR.&n; * Bits in xstate: SC_COMP_RUN&n; */
DECL|macro|SC_FLAG_BITS
mdefine_line|#define SC_FLAG_BITS&t;(SC_NO_TCP_CCID|SC_CCP_OPEN|SC_CCP_UP|SC_LOOP_TRAFFIC &bslash;&n;&t;&t;&t; |SC_MULTILINK|SC_MP_SHORTSEQ|SC_MP_XSHORTSEQ)
...
id|MPHDRLEN
suffix:semicolon
multiline_comment|/* XXX gotta do A/C and prot compression here */
r_do
(brace
id|list
op_assign
...
r_else
(brace
multiline_comment|/* channel got unregistered, too bad */
id|kfree_skb
c_func
(paren
id|skb
...
(paren
id|KERN_DEBUG
l_string|&quot;PPP: MP fragments out of order&quot;
...
(brace
multiline_comment|/* this can&squot;t happen, anyway toss the skb */
id|printk
c_func
(paren
id|KERN_ERR
...
l_int|0
suffix:semicolon
multiline_comment|/* reset len, allow for protocol ID compression */
id|len
op_assign
id|p-&gt;data
(braket
