multiline_comment|/*      $Id: com90xx.c,v 1.9 1998/03/21 18:02:51 alan Exp $&n;&n;   Derived from the original arcnet.c,&n;   Written 1994-1996 by Avery Pennarun,&n;   which was in turn derived from skeleton.c by Donald Becker.&n;&n;   **********************&n;&n;   The original copyright of skeleton.c was as follows:&n;&n;   skeleton.c Written 1993 by Donald Becker.&n;   Copyright 1993 United States Government as represented by the&n;   Director, National Security Agency.  This software may only be used&n;   and distributed according to the terms of the GNU Public License as&n;   modified by SRC, incorporated herein by reference.&n;&n;   **********************&n;&n;   For more details, see drivers/net/arcnet.c&n;&n;   **********************&n; */
...
id|version
op_assign
l_string|&quot;com90xx.c: v3.00 97/11/09 Avery Pennarun &lt;apenwarr@worldvisions.ca&gt; et al.&bslash;n&quot;
suffix:semicolon
