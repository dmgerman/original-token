...
DECL|macro|MAX_WD_MODS
mdefine_line|#define MAX_WD_MODS&t;4&t;/* Max number of wd modules allowed */
DECL|macro|NAMELEN
mdefine_line|#define NAMELEN&t;&t;9&t;/* # of chars for storing dev-&gt;name */
...
(paren
id|KERN_WARNING
l_string|&quot;modules: No wd80x3 card found (i/o = 0x%x).&bslash;n&quot;
comma
id|io
(braket
id|this_dev
