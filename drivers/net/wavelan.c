...
c_func
(paren
l_string|&quot;%s: Initialized WaveLAN.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot; could not wavelan_map_irq(0x%x, %d).&bslash;n&quot;
comma
id|ioaddr
comma
id|psa.psa_int_req_no
...
id|ioaddr
suffix:semicolon
multiline_comment|/*&n;&t; * Apparently the third numeric argument to LILO&squot;s&n;&t; * `ether=&squot; control line arrives here as `dev-&gt;mem_start&squot;.&n;&t; * If it is non-zero we use it instead of the PSA NWID.&n;&t; */
r_if
c_cond
(paren
id|dev-&gt;mem_start
