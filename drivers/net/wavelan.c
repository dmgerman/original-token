...
macro_line|#endif
multiline_comment|/*&n;   * Inform upper layers.&n;   */
r_if
c_cond
(paren
id|lp-&gt;tx_n_in_use
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: wv_82586_reconfig(): delayed (busy = %ld, start = %d)&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|dev-&gt;tbusy
...
suffix:semicolon
multiline_comment|/*&n;  {&n;    tbd_t&t;tbd;&n;&n;    obram_read(ioaddr, actx.tx_tbd_offset, (unsigned char *)&amp;tbd, sizeof(tbd));&n;    printk(&quot; tbd_status=0x%x,&quot;, tbd.tbd_status);&n;  }&n;  */
id|printk
c_func
(paren
l_string|&quot;|&quot;
...
macro_line|#endif&t;/* DEBUG_I82586_SHOW */
...
multiline_comment|/* Warning : each channel is 11MHz wide, so some of the channels&n;   * will interfere... */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Disable nwid in the mmc (no check) */
id|m.w.mmw_loopt_sel
op_assign
...
multiline_comment|/*&n;   * If some higher layer thinks we&squot;ve missed&n;   * a tx-done interrupt we are passed NULL.&n;   * Caution: dev_tint() handles the cli()/sti() itself.&n;   */
r_if
c_cond
(paren
id|skb
...
(paren
id|KERN_INFO
l_string|&quot;%s: wavelan_packet_xmit(): skb == NULL&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/*&n;   * Block a timer-based transmit from overlapping.&n;   * In other words, prevent reentering this routine.&n;   */
r_if
c_cond
(paren
id|set_bit
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;   * Clear the onboard RAM.&n;   */
id|memset
c_func
(paren
op_amp
...
multiline_comment|/*&n;   * Construct the command unit structures:&n;   * scp, iscp, scb, cb.&n;   */
id|memset
c_func
(paren
op_amp
...
multiline_comment|/*&n;   * Overwrite the predecessor NOP link&n;   * so that it points to the configure action.&n;   */
id|nop_addr
op_assign
id|txpred
op_plus
...
id|dce_status
suffix:semicolon
multiline_comment|/*&n;       * Interrupt from the modem management controller.&n;       * This will clear it -- ignored for now.&n;       */
id|mmc_read
c_func
(paren
id|ioaddr
...
suffix:semicolon
multiline_comment|/*&n;   * Acknowledge the interrupt(s).&n;   */
id|ack_cmd
op_assign
id|status
op_amp
...
multiline_comment|/*&n;   * Flush the Tx and disable Rx.&n;   */
id|wv_82586_stop
c_func
(paren
id|dev
