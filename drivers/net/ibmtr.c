...
l_string|&quot;         v2.1.35  5/ 1/97 Paul Norton &lt;pnorton@cts.com&gt;&bslash;n&quot;
suffix:semicolon
...
(brace
multiline_comment|/* create whitewashed LLC header in sk buffer */
r_struct
id|trllc
op_star
id|local_llc
...
suffix:semicolon
multiline_comment|/* copy the real LLC header to the sk buffer */
id|data
op_add_assign
id|hdr_len
suffix:semicolon
