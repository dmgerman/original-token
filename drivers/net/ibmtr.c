...
multiline_comment|/* use memcpy to read/write frame data instead of for-loop */
DECL|macro|USE_MEMCPY
mdefine_line|#define USE_MEMCPY 1
...
l_string|&quot;         v2.1.10 11/20/96 Paul Norton &lt;pnorton@cts.com&gt;&bslash;n&quot;
suffix:semicolon
