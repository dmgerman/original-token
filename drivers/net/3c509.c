...
(paren
id|KERN_INFO
l_string|&quot;%s: %s port selected.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|if_port_text
...
(paren
id|KERN_ERR
l_string|&quot;%s: %s port not supported.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|if_port_text
...
(paren
id|KERN_ERR
l_string|&quot;%s: cannot change interrupt.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;%s: cannot change base address.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
DECL|macro|MAX_3C_CARDS
mdefine_line|#define MAX_3C_CARDS&t;4&t;/* Max number of NE cards per module */
DECL|macro|NAMELEN
...
(paren
id|KERN_WARNING
l_string|&quot;3c509.c: No 3c509 card found (i/o = 0x%x).&bslash;n&quot;
comma
id|io
(braket
id|this_dev
