...
id|version
op_assign
l_string|&quot;3c509.c:1.12 6/4/97 becker@cesdis.gsfc.nasa.gov&bslash;n&quot;
suffix:semicolon
...
DECL|macro|MCA_NUMBER_OF_SLOTS
mdefine_line|#define MCA_NUMBER_OF_SLOTS 8
DECL|macro|MCA_PORT_POS_SEL
mdefine_line|#define MCA_PORT_POS_SEL 0x096
DECL|macro|MCA_PORT_ID_REG_0
mdefine_line|#define MCA_PORT_ID_REG_0 0x100
DECL|macro|MCA_PORT_ID_REG_1
mdefine_line|#define MCA_PORT_ID_REG_1 0x101
DECL|macro|MCA_SELECT_BIT
mdefine_line|#define MCA_SELECT_BIT 0x08
r_if
c_cond
(paren
id|MCA_bus
...
c_func
(paren
l_string|&quot;3c529: probing...&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* This should probably be done once early on and read into&n;&t;&t; * a structure somewhere... */
r_for
c_loop
(paren
id|mca_slot
...
id|mca_slot
OL
id|MCA_NUMBER_OF_SLOTS
suffix:semicolon
id|mca_slot
op_increment
)paren
(brace
multiline_comment|/* Select MCA slot i */
id|outb_p
c_func
(paren
id|mca_slot
...
op_eq
l_int|0x62F6
multiline_comment|/* TP or coax */
op_logical_or
id|mca_id
op_eq
l_int|0x62F7
)paren
multiline_comment|/* TP only */
(brace
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;3c529: Found with id 0x%x at slot %d&bslash;n&quot;
comma
id|mca_id
comma
id|mca_slot
...
multiline_comment|/* Read values from POS registers so now disable */
id|outb
c_func
(paren
l_int|0
...
c_func
(paren
l_string|&quot;3c529: Adapter found but disabled in slot %d&bslash;n&quot;
comma
id|mca_slot
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Found and adapter is enabled */
r_if
c_cond
(paren
id|el3_debug
...
c_func
(paren
l_string|&quot;3c529: pos registers 0:0x%x 1:0x%x 2:0x%x 3:0x%x&bslash;n&quot;
comma
id|posreg
(braket
l_int|0
...
suffix:semicolon
multiline_comment|/* Select PnP config control register. */
id|outb
c_func
(paren
l_int|0x02
...
suffix:semicolon
multiline_comment|/* Return to WaitForKey state. */
...
multiline_comment|/* Parameter that may be passed into the module. */
DECL|variable|debug
r_static
r_int
id|debug
