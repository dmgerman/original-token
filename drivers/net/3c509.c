...
suffix:semicolon
multiline_comment|/* free the skb, we&squot;re done with it */
id|dev_kfree_skb
c_func
(paren
id|skb
...
suffix:semicolon
multiline_comment|/*&n;&t; * Do we have room in the send queue?&n;&t; */
r_if
c_cond
(paren
id|lp-&gt;size
...
op_increment
suffix:semicolon
multiline_comment|/* fake a transmit interrupt to get it started */
id|el3_tx
c_func
(paren
id|dev
...
multiline_comment|/*&n;&t; * No space, check if we might have timed out?&n;&t; */
r_if
c_cond
(paren
id|jiffies
...
multiline_comment|/* free the skb, we might as well drop it on the floor */
id|dev_kfree_skb
c_func
(paren
id|skb
