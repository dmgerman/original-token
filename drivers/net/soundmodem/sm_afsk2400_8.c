...
multiline_comment|/*&n; * This driver is intended to be compatible with TCM3105 modems&n; * overclocked to 8MHz. The mark and space frequencies therefore&n; * lie at 3970 and 2165 Hz.&n; * Note that I do _not_ recommend the building of such links, I provide&n; * this only for the users who live in the coverage area of such&n; * a &quot;legacy&quot; link.&n; */
macro_line|#include &quot;sm.h&quot;
macro_line|#include &quot;sm_tbl_afsk2400_8.h&quot;
multiline_comment|/* --------------------------------------------------------------------- */
...
multiline_comment|/* --------------------------------------------------------------------- */
DECL|variable|sm_afsk2400_8_tx
r_const
r_struct
id|modem_tx_info
id|sm_afsk2400_8_tx
...
suffix:semicolon
DECL|variable|sm_afsk2400_8_rx
r_const
r_struct
id|modem_rx_info
id|sm_afsk2400_8_rx
