...
(paren
id|KERN_ERR
l_string|&quot;%s: sbc resource registers cannot be set; &quot;
l_string|&quot;PnP device and IRQ/DMA specified wrongly?&bslash;n&quot;
comma
id|sm_drvname
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * DMA channel 1 (8bit) does input (capture),&n;&t; * DMA channel 2 (16bit) does output (playback)&n;&t; */
id|disable_dma
c_func
(paren
id|dev-&gt;dma
...
l_int|1
suffix:semicolon
multiline_comment|/* dmabuflen must be a multiple of 4 */
id|SCSTATE-&gt;dmabuflen
op_assign
id|sm-&gt;mode_rx-&gt;srate
op_div
