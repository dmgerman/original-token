...
suffix:semicolon
multiline_comment|/* Chip-specific media selection (timer functions prototyped above). */
r_static
r_void
...
(paren
id|KERN_ERR
l_string|&quot;tulip: skipping LMC card.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
multiline_comment|/* Bring the 21041/21143 out of sleep mode.&n;&t;   Caution: Snooze mode does not work with some boards! */
r_if
c_cond
(paren
id|tulip_tbl
...
suffix:semicolon
multiline_comment|/* Disable interrupts, stop the chip, gather stats. */
r_if
c_cond
(paren
id|csr6
...
suffix:semicolon
multiline_comment|/* Put the 21143 into sleep mode. */
id|pci_write_config_dword
c_func
(paren
id|pdev
