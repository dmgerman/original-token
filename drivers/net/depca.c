...
id|version
op_assign
l_string|&quot;depca.c:v0.32 2/19/94 davies@wanton.enet.dec.com&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define DEPCA_SIGNATURE {&quot;DEPCA&quot;,&quot;DE100&quot;,&quot;DE200&quot;,&quot;DE202&quot;,&quot;DE210&quot;,&quot;&quot;}
...
id|offset
suffix:semicolon
multiline_comment|/*&n;    ** Stop the DEPCA. Enable the DBR ROM. Disable interrupts and remote boot&n;    */
id|STOP_DEPCA
suffix:semicolon
id|nicsr
op_assign
...
c_func
(paren
l_string|&quot;,&bslash;n      with 32kB RAM&quot;
)paren
suffix:semicolon
)brace
r_else
...
l_int|0x0000
suffix:semicolon
multiline_comment|/* 64kbyte RAM */
id|printk
c_func
(paren
l_string|&quot;,&bslash;n      with 64kB RAM&quot;
)paren
suffix:semicolon
)brace
id|mem_start
...
suffix:semicolon
multiline_comment|/*&n;&t;** Calculate the ring size based on the available RAM&n;&t;** found above. Allocate an equal number of buffers, each&n;&t;** of size PKT_BUF_SZ (1544 bytes) to the Tx and Rx. Make sure&n;&t;** that this ring size is &lt;= RING_SIZE. The ring size must be&n;&t;** a power of 2.&n;&t;*/
id|j
op_assign
(paren
(paren
...
multiline_comment|/*&n;** Look for a special sequence in the Ethernet station address PROM that&n;** is common across all DEPCA products.&n;*/
