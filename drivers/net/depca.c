...
id|version
op_assign
l_string|&quot;depca.c:v0.41 5/26/95 davies@wanton.lkg.dec.com&bslash;n&quot;
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Clear the multicast table first */
r_for
c_loop
(paren
id|i
