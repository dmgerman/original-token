...
id|version
op_assign
l_string|&quot;depca.c:v0.37 7/22/94 davies@wanton.lkg.dec.com&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define DEPCA_SIGNATURE {&quot;DEPCA&quot;,&quot;DE100&quot;,&bslash;&n;                         &quot;DE200&quot;,&quot;DE201&quot;,&quot;DE202&quot;,&quot;DE210&quot;,&bslash;&n;                         &quot;DE422&quot;,&bslash;&n;                         &quot;&quot;}
...
macro_line|#endif
macro_line|#ifndef DEPCA_EISA_IO_PORTS 
...
macro_line|#ifdef MODULE                         /* pattern in ROM */
id|printk
c_func
(paren
...
c_func
(paren
l_string|&quot;,&bslash;n      has 128kB RAM&quot;
)paren
suffix:semicolon
)brace
r_else
...
multiline_comment|/* Initialise the data structures wrt CPU */
id|memset
c_func
(paren
id|lp-&gt;rx_ring
...
macro_line|#endif /* MODULE */
"&f;"
multiline_comment|/*&n; * Local variables:&n; *  kernel-compile-command: &quot;gcc -D__KERNEL__ -I/usr/src/linux/net/inet -Wall -Wstrict-prototypes -O6 -m486 -c depca.c&quot;&n; *&n; *  module-compile-command: &quot;gcc -D__KERNEL__ -DMODULE -I/usr/src/linux/net/inet -Wall -Wstrict-prototypes -O6 -m486 -c depca.c&quot;&n; * End:&n; */
eof
