...
id|version
op_assign
l_string|&quot;depca.c:v0.383 2/22/94 davies@wanton.lkg.dec.com&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n; *&t;This is a tweak to keep the insmod program happy. It can only&n; *&t;set int values with var=value so we split these out.&n; */
DECL|variable|irq
r_int
id|irq
op_assign
