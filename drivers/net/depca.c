...
id|version
op_assign
l_string|&quot;depca.c:v0.43 96/8/16 davies@maniac.ultranet.com&bslash;n&quot;
suffix:semicolon
...
DECL|macro|ALIGN8
mdefine_line|#define ALIGN8      ((u_long)8 - 1)&t;/* 2 longword (quadword) align */
DECL|macro|ALIGN
mdefine_line|#define ALIGN         ALIGN8&t;/* Keep the LANCE happy... */
...
id|bus_offset
suffix:semicolon
multiline_comment|/* (E)ISA bus address offset vs LANCE     */
DECL|member|sh_mem
id|u_long
id|sh_mem
suffix:semicolon
multiline_comment|/* Physical start addr of shared mem area */
...
id|LA_MASK
suffix:semicolon
multiline_comment|/* LANCE re-mapped start address */
id|lp-&gt;dma_buffs
op_assign
id|mem_start
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* To auto-IRQ we enable the initialization-done and DMA err,&n;&t;&t;&t;&t;&t;   interrupts. For now we will always get a DMA error. */
r_if
c_cond
(paren
id|dev-&gt;irq
...
suffix:semicolon
multiline_comment|/* Stop ring access */
id|set_bit
c_func
(paren
l_int|0
...
c_func
(paren
l_string|&quot;&bslash;t0x%lx  0x%lx&bslash;n&quot;
comma
(paren
id|u_long
)paren
...
c_func
(paren
l_string|&quot;&bslash;nDescriptor buffers:&bslash;nRX: &quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;&bslash;tmulticast hash table: &quot;
)paren
suffix:semicolon
r_for
c_loop
...
multiline_comment|/*&n;   ** Perform IOCTL call functions here. Some are privileged operations and the&n;   ** effective uid is checked in those cases.&n;   ** All MCA IOCTLs will not work here and are for testing purposes only.&n; */
