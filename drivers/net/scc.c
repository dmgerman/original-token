DECL|macro|RCS_ID
mdefine_line|#define RCS_ID &quot;$Id: scc.c,v 1.66 1997/01/08 22:56:06 jreuter Exp jreuter $&quot;
DECL|macro|VERSION
...
l_int|1
suffix:semicolon
multiline_comment|/* &n;&t;&t; * Throw away transmission queue. &n;&t;&t; */
r_if
c_cond
(paren
id|scc-&gt;tx_wdog.next
...
(paren
id|KERN_INFO
l_string|&quot;Copyright 1993,1996 Joerg Reuter DL1BKE (jreuter@lykos.tng.oche.de)&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|result
