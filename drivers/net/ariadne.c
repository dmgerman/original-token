...
id|priv
suffix:semicolon
multiline_comment|/* Ethernet is part 0, Parallel is part 1 */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Check if any interrrupt has been&n;&t;return;&t;&t;&t;&t;   generated by the board. */
r_if
c_cond
(paren
id|dev-&gt;interrupt
