...
mdefine_line|#define&t;X25_HRDHDR_SZ&t;6&t;&t;/* max encapsulation header size */
...
multiline_comment|/* This is an extention of the &squot;struct device&squot; we create for each network&n; * interface to keep the rest of X.25 channel-specific data.&n; */
...
r_default
suffix:colon
multiline_comment|/* unwanter interrupt */
id|spur_intr
c_func
(paren
id|card
...
multiline_comment|/*&n;&t;&t;unsigned long flags;&n;&n;&t;&t;save_flags(flags);&n;&t;&t;cli();&n;&n;&t;&t;restore_flags(flags);&n;*/
)brace
)brace
