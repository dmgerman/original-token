...
id|__devinitdata
op_assign
l_string|&quot;3c59x.c:v0.99L+LK1.1.6  28 May 2000  Donald Becker and others. http://www.scyld.com/network/vortex.html &quot;
l_string|&quot;$Revision: 1.97 $&bslash;n&quot;
suffix:semicolon
id|MODULE_AUTHOR
c_func
(paren
...
comma
(brace
l_string|&quot;3CCFE575CT Cyclone CardBus&quot;
comma
id|PCI_USES_IO
op_or
id|PCI_USES_MASTER
...
comma
(brace
l_string|&quot;3CCFEM656 Cyclone CardBus&quot;
comma
id|PCI_USES_IO
op_or
id|PCI_USES_MASTER
...
comma
(brace
l_string|&quot;3CCFEM656 Cyclone CardBus(0x6564)&quot;
comma
...
suffix:semicolon
macro_line|#if 0&t;/* AKPM: This is done in vortex_probe1, and seems to be wrong anyway... */
multiline_comment|/* Inverted LED polarity */
r_if
c_cond
(paren
id|device_id
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Inverted polarity of MII power bit */
r_if
c_cond
(paren
(paren
...
id|KERN_ERR
id|PFX
l_string|&quot;vortex_open() fails: returning %d&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* AKPM: protect mdio state */
id|mii_status
op_assign
id|mdio_read
c_func
...
suffix:semicolon
"&f;"
multiline_comment|/*&n; * Local variables:&n; *  compile-command: &quot;gcc -DMODULE -D__KERNEL__ -Wall -Wstrict-prototypes -O6 -c 3c59x.c `[ -f /usr/include/linux/modversions.h ] &amp;&amp; echo -DMODVERSIONS`&quot;&n; *  cardbus-compile-command: &quot;gcc -DCONFIG_HOTPLUG -DMODULE -D__KERNEL__ -Wall -Wstrict-prototypes -O6 -c 3c59x.c -o 3c575_cb.o -I/usr/src/linux/pcmcia-cs-3.0.9/include/&quot;&n; *  c-indent-level: 4&n; *  c-basic-offset: 4&n; *  tab-width: 4&n; * End:&n; */
eof
