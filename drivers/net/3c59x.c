...
id|version
op_assign
l_string|&quot;3c59x.c:v0.25 5/17/96 becker@cesdis.gsfc.nasa.gov&bslash;n&quot;
suffix:semicolon
multiline_comment|/* &quot;Knobs&quot; that turn on special features. */
multiline_comment|/* Enable the experimental automatic media selection code. */
...
mdefine_line|#define VORTEX_DEBUG 2
...
comma
l_int|3
multiline_comment|/* 10baseT-&gt;10base2 */
comma
(paren
l_int|14
op_star
...
comma
l_int|5
multiline_comment|/* 100baseTX-&gt;100baseFX */
comma
(paren
l_int|14
op_star
...
comma
l_int|6
multiline_comment|/* 100baseFX-&gt;MII */
comma
(paren
l_int|14
op_star
...
comma
l_int|0
multiline_comment|/* Undefined/100baseT4 */
comma
l_int|0
)brace
comma
...
c_func
(paren
l_string|&quot;  Overriding PCI latency timer (CFLT) setting of&quot;
l_string|&quot; %d, new value is 255.&bslash;n&quot;
comma
id|pci_latency
)paren
suffix:semicolon
...
multiline_comment|/* We actually have free room. */
id|dev-&gt;tbusy
op_assign
l_int|0
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* Wait a while to see if there really is room. */
r_for
c_loop
(paren
id|i
...
macro_line|#endif /* MODULE */
"&f;"
multiline_comment|/*&n; * Local variables:&n; *  compile-command: &quot;gcc -DMODULE -D__KERNEL__ -I/usr/src/linux/net/inet -Wall -Wstrict-prototypes -O6 -m486 -c 3c59x.c -o ../../modules/3c59x.o&quot;&n; *  c-indent-level: 4&n; *  tab-width: 4&n; * End:&n; */
eof
