...
l_int|0
suffix:semicolon
multiline_comment|/* Caution!  These entries must be consistent. */
...
(paren
id|KERN_INFO
l_string|&quot;vortex_attach(bus %d, function %d)&bslash;n&quot;
comma
id|bus
comma
id|devfn
...
c_func
(paren
l_string|&quot;No 3Com Vortex/Boomerang cards found.&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|cards_found
...
multiline_comment|/* Handle products we don&squot;t recognize, but might still work with. */
r_if
c_cond
(paren
id|product_ids
...
(paren
id|KERN_INFO
l_string|&quot;  MII transceiver found at address %d, status %4x.&bslash;n&quot;
comma
id|phy
comma
id|mii_status
...
suffix:semicolon
multiline_comment|/* Set a timer to reenable interrupts. */
r_break
suffix:semicolon
)brace
)brace
