multiline_comment|/*&n; * SDLA      An implementation of a driver for the Sangoma S502/S508 series&n; *           multi-protocol PC interface card.  Initial offering is with &n; *           the DLCI driver, providing Frame Relay support for linux.&n; *&n; *           Global definitions for the Frame relay interface.&n; *&n; * Version:  @(#)sdla.c   0.10   23 Mar 1996&n; *&n; * Credits:  Sangoma Technologies, for the use of 2 cards for an extended&n; *                                 period of time.&n; *           David Mandelstam &lt;dm@sangoma.com&gt; for getting me started on &n; *                            this project, and incentive to complete it.&n; *           Gene Kozen &lt;74604.152@compuserve.com&gt; for providing me with&n; *                      important information about the cards.&n; *&n; * Author:   Mike McLagan &lt;mike.mclagan@linux.org&gt;&n; *&n; *           This program is free software; you can redistribute it and/or&n; *           modify it under the terms of the GNU General Public License&n; *           as published by the Free Software Foundation; either version&n; *           2 of the License, or (at your option) any later version.&n; */
...
id|version
op_assign
l_string|&quot;SDLA driver v0.10, 23 Mar 1996, mike.mclagan@linux.org&quot;
suffix:semicolon
...
multiline_comment|/*&n;          * Further processing could be done here &n;          * printk(KERN_DEBUG &quot;%s: Unhandled return code 0x%2.2X&bslash;n&quot;, dev-&gt;name, ret);&n;          *&n;          */
)brace
)brace
...
l_int|2
suffix:semicolon
multiline_comment|/* 1/2 second timeout */
id|save_flags
c_func
(paren
id|pflags
...
multiline_comment|/* per Alan Cox, we can drop the packet on the floor if it doesn&squot;t go */
id|dev_kfree_skb
c_func
(paren
id|skb
...
id|split
suffix:semicolon
multiline_comment|/* lets get the data */
id|sdla_read
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* ==========================================================&n;NOTE:  This is rather a useless action right now, as the&n;       driver does not support protocols other than FR right&n;       now.  However, Sangoma has modules for a number of&n;       other protocols.&n;============================================================*/
r_case
id|SDLA_PROTOCOL
suffix:colon
r_if
