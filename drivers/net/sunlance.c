...
id|version
op_assign
l_string|&quot;sunlance.c:v1.6 19/Apr/96 Miguel de Icaza (miguel@nuclecu.unam.mx)&bslash;n&quot;
suffix:semicolon
...
l_int|2
suffix:semicolon
multiline_comment|/* What to set here? */
r_if
c_cond
(paren
id|td-&gt;tmd1_bits
