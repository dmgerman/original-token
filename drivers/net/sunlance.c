...
multiline_comment|/*&n;&t;Written 1995 by Miguel de Icaza&n;  Sources:&n;&t;The Linux  depca driver&n;&t;The Linux  lance driver.&n;&t;The Linux  skeleton driver.&n;        The NetBSD Sparc/Lance driver.&n;&t;Theo Deraadt (deraadt@theos.com)&n;&t;NCR92C990 Lan Controller manual&n;*/
...
id|version
op_assign
l_string|&quot;lance.c:v1.2 29/Oct/95 Miguel de Icaza (miguel@nuclecu.unam.mx)&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define RX_BUFF_SIZE            1536
DECL|macro|TX_BUFF_SIZE
mdefine_line|#define TX_BUFF_SIZE            1536
...
multiline_comment|/* The DVMA will provide the remaining bytes for us */
...
id|printk
(paren
l_string|&quot;LANCE opened after %d ticks, csr0=%4.4x&bslash;n&quot;
comma
id|i
comma
id|ll-&gt;rdp
...
id|LE_C0_INEA
suffix:semicolon
multiline_comment|/* FIXME: Add slot prediction */
r_for
c_loop
(paren
id|rd
...
id|rd-&gt;rmd1_bits
suffix:semicolon
multiline_comment|/* Check if we own the packet */
r_if
c_cond
(paren
id|bits
...
id|printk
(paren
l_string|&quot;Incomplete frame&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* Count only the end frame as a tx error, not the beginning */
r_if
...
suffix:semicolon
multiline_comment|/* To make life easier to us while Sparc Linux becomes self hosting: */
(brace
r_struct
id|rtentry
id|server_route
...
id|printk
(paren
l_string|&quot;Lance stopped: csr0=%4.4x&bslash;n&quot;
comma
id|ll-&gt;rdp
)paren
suffix:semicolon
