...
multiline_comment|/*&n;    if ((lp-&gt;scb.cmd != (struct i596_cmd *) I596_NULL) &amp;&amp; (dev-&gt;start)) ack_cmd | = CUC_START;&n;*/
id|boguscnt
op_assign
l_int|100
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: close timed timed out with status %4.4x, cmd %4.4x.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|lp-&gt;scb.status
