multiline_comment|/******************************************************************************&n; *&n; * Name:      &t;skge.c&n; * Project:&t;GEnesis, PCI Gigabit Ethernet Adapter&n; * Version:&t;$Revision: 1.25 $&n; * Date:       &t;$Date: 1999/10/07 14:47:52 $&n; * Purpose:&t;The main driver source module&n; *&n; ******************************************************************************/
...
suffix:semicolon
multiline_comment|/* Descriptors need 8 byte alignment */
id|BusAddr
op_assign
id|virt_to_bus
c_func
...
(brace
multiline_comment|/* use original skb */
...
r_else
(brace
multiline_comment|/* alloc new skb and copy data */
id|skb_reserve
c_func
(paren
id|pNewMsg
