...
suffix:semicolon
multiline_comment|/*&n;   #ifdef MODULE&n;   dev-&gt;ifindex = dev_new_index();&n;   lp-&gt;next_module = root_lance_dev;&n;   root_lance_dev = lp;&n;   #endif&n; */
r_return
l_int|0
suffix:semicolon
)brace
...
multiline_comment|/*&n;   #ifdef MODULE&n;&n;   int&n;   init_module(void)&n;   {&n;   root_lance_dev = NULL;&n;   return dec_lance_probe(NULL);&n;   }&n;&n;   void&n;   cleanup_module(void)&n;   {&n;   struct lance_private *lp;&n;&n;   while (root_lance_dev) {&n;   lp = root_lance_dev-&gt;next_module;&n;&n;   unregister_netdev(root_lance_dev-&gt;dev);&n;   kfree(root_lance_dev-&gt;dev);&n;   root_lance_dev = lp;&n;   }&n;   }&n;&n;   #endif -* MODULE */
eof
