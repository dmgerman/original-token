...
(brace
multiline_comment|/* Do we actually need to handle this case? */
r_if
c_cond
(paren
id|S_ethdev_init
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: load_8390_module called when pointers already present&bslash;n&quot;
comma
id|driver
)paren
suffix:semicolon
...
multiline_comment|/* Attempt to get the first symbol */
id|S_ethdev_init
op_assign
(paren
r_void
...
(brace
multiline_comment|/* It failed. See if we have request_module() */
r_int
(paren
op_star
id|request_mod
...
multiline_comment|/* OK - we have request_module() - try it */
id|request_mod
op_assign
(paren
r_void
...
suffix:semicolon
multiline_comment|/* Retry getting ethdev_init */
id|S_ethdev_init
op_assign
(paren
r_void
...
multiline_comment|/* Get addresses for the other functions */
id|S_NS8390_init
op_assign
(paren
r_void
