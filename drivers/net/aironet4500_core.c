...
c_func
(paren
l_string|&quot; reenter-bad end exit &bslash;n&quot;
)paren
suffix:semicolon
singleline_comment|//&t;enable_irq(dev-&gt;irq);
id|restore_flags
...
(brace
singleline_comment|//&t;printk(KERN_ERR &quot;%s staled tx_buff found, age %uld jiffies&bslash;n&quot;,dev-&gt;name,
singleline_comment|//&t;&t;jiffies - fid-&gt;transmit_start_time );
id|awc_fid_queue_remove
c_func
(paren
op_amp
...
(brace
singleline_comment|// &t;dev-&gt;tbusy = 0;
id|mark_bh
c_func
(paren
id|NET_BH
