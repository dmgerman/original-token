...
id|version
op_assign
l_string|&quot;myri_sbus.c:v1.0 10/Dec/96 David S. Miller (davem@caipfs.rutgers.edu)&bslash;n&quot;
suffix:semicolon
...
(paren
(paren
l_string|&quot;resetting, return 0&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|printk
...
(paren
(paren
l_string|&quot;skb is null, aieee... returning 0&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|dev_tint
...
(paren
(paren
l_string|&quot;tbusy, maybe a race? returning 1&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|printk
...
(paren
id|KERN_DEBUG
l_string|&quot;eth_header_cache_update: %04x cache is not &quot;
...
(paren
(paren
l_string|&quot;Registers mapped: cregs[%p] lregs[%p] lanai[%p] lanai3[%p]&bslash;n&quot;
comma
id|mp-&gt;cregs
comma
id|mp-&gt;lregs
...
c_func
(paren
id|mp-&gt;myri_sbus_dev-&gt;my_bus-&gt;prom_node
comma
...
suffix:semicolon
macro_line|#if 1 /* XXX Until sun4m SBUS burst workaround is written. */
r_if
c_cond
(paren
id|sparc_cpu_model
