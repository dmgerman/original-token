...
(paren
id|KERN_NOTICE
l_string|&quot;%s: Arlan found at %#5x, &bslash;n &quot;
comma
id|dev-&gt;name
comma
id|memaddr
...
(brace
singleline_comment|// up(&amp;priv-&gt;card_lock);
r_goto
id|bad_end
suffix:semicolon
)brace
...
id|buf
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If some higher layer thinks we&squot;ve missed an tx-done interrupt&n;&t;&t; * we are passed NULL. Caution: dev_tint() handles the cli()/sti()&n;&t;&t; * itself.&n;&t;&t; */
id|length
op_assign
id|ETH_ZLEN
OL
