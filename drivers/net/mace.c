...
(paren
id|KERN_ERR
l_string|&quot;can&squot;t use MACE %s: expect 3 addrs and 3 intrs&bslash;n&quot;
comma
id|maces-&gt;full_name
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Can&squot;t get mac-address for MACE at %lx&bslash;n&quot;
comma
id|dev-&gt;base_addr
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * Either there weren&squot;t the two bytes buffered up, or they&n;&t;&t; * didn&squot;t have an end-of-packet indication.  Maybe we ought&n;&t;&t; * to flush the transmit FIFO just in case (by setting the&n;&t;&t; * XMTFWU bit with the transmitter disabled).&n;&t;&t; */
id|mb-&gt;xmtfc
op_assign
id|AUTO_PAD_XMIT
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;mace: tx dmastat=%x %x bad_runt=%d pr=%x fs=%x fc=%x&bslash;n&quot;
comma
id|ld_le32
c_func
(paren
