...
suffix:semicolon
DECL|macro|put_driver_status
mdefine_line|#define put_driver_status(x) put_driver_status_common((x), 0)
DECL|macro|put_driver_status_nolock
mdefine_line|#define put_driver_status_nolock(x) put_driver_status_common((x), 1)
...
DECL|function|put_driver_status_common
r_static
r_void
id|put_driver_status_common
c_func
...
(paren
id|KERN_INFO
l_string|&quot;%s: DMA timeout - restarting.&bslash;n&quot;
comma
id|cosa-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* FIXME: This works for COSA only (not SRP) */
id|cosa-&gt;rxtx
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;cosa%d: end of transfer.&bslash;n&quot;
comma
id|cosa-&gt;num
)paren
suffix:semicolon
...
multiline_comment|/*&n;&t; * Clear the RXBIT, TXBIT and IRQBIT (the latest should be&n;&t; * cleared anyway).&n;&t; */
id|flags1
op_assign
id|claim_dma_lock
c_func
