multiline_comment|/*&n; *&t;Wavelan ISA driver&n; *&n; *&t;&t;Jean II - HPLB &squot;96&n; *&n; * Reorganisation and extension of the driver.&n; * Original copyrigth follow. See wavelan.p.h for details.&n; *&n; * This file contain the declarations of the Wavelan hardware. Note that&n; * the Wavelan ISA include a i82586 controler (see definitions in&n; * file i82586.h).&n; *&n; * The main difference between the ISA hardware and the pcmcia one is&n; * the Ethernet Controler (i82586 instead of i82593).&n; * The i82586 allow multiple transmit buffers. The PSA need to be accessed&n; * through the host interface.&n; */
