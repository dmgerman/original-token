...
suffix:semicolon
id|olympic_priv-&gt;olympic_multicast_set
op_assign
l_int|0
suffix:semicolon
r_if
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Re-entering interrupt &bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
multiline_comment|/* RFC 1469 Says we must support using the functional address C0 00 00 04 00 00&n;                         * We do this with a set functional address mask.&n;&t;&t;&t; */
id|ata
op_assign
id|olympic_priv-&gt;olympic_lap
op_plus
...
(brace
multiline_comment|/* Hmmm, need to set the functional mask */
id|writeb
c_func
(paren
