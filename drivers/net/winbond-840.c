...
op_assign
l_string|&quot;winbond-840.c:v1.01 5/15/2000  Donald Becker &lt;becker@scyld.com&gt;&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/* Condensed operations for readability.&n;   The compatibility defines are in kern_compat.h */
...
macro_line|#elif defined(split_buffer)
(brace
multiline_comment|/* Work around the Tx-FIFO-full bug by splitting our transmit packet&n;&t;&t;   into two pieces, the first which may be loaded without overflowing&n;&t;&t;   the FIFO, and the second which contains the remainder of the&n;&t;&t;   packet.  When we get a Tx-done interrupt that frees enough room&n;&t;&t;   in the FIFO we mark the remainder of the packet as loadable.&n;&n;&t;&t;   This has the problem that the Tx descriptors are written both&n;&t;&t;   here and in the interrupt handler.&n;&t;&t;*/
r_int
id|buf1size
op_assign
id|TX_FIFO_SIZE
...
(brace
multiline_comment|/* We fit into one descriptor. */
id|np-&gt;tx_ring
(braket
id|entry
)braket
...
r_else
(brace
multiline_comment|/* We must use two descriptors. */
r_int
r_int
id|entry2
suffix:semicolon
