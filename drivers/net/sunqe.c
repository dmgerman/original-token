multiline_comment|/* sunqe.c: Sparc QuadEthernet 10baseT SBUS card driver.&n; *          Once again I am out to prove that every ethernet&n; *          controller out there can be most efficiently programmed&n; *          if you make it look like a LANCE.&n; *&n; * Copyright (C) 1996, 1999 David S. Miller (davem@redhat.com)&n; */
...
id|version
op_assign
l_string|&quot;sunqe.c:v2.0 9/9/99 David S. Miller (davem@redhat.com)&bslash;n&quot;
suffix:semicolon
...
id|mregs-&gt;mpcnt
suffix:semicolon
multiline_comment|/* Reload multicast information, this will enable the receiver&n;&t; * and transmitter.  But set the base mconfig value right now.&n;&t; */
id|qe_set_multicast
c_func
(paren
id|qep-&gt;dev
...
multiline_comment|/* Reclaim TX&squot;d frames from the ring. */
