...
suffix:semicolon
multiline_comment|/* Plug-n-Play routine */
r_static
r_inline
r_int
r_char
id|read_resource_data
c_func
(paren
r_void
)paren
...
suffix:semicolon
"&f;"
multiline_comment|/* Plug-n-Play constants */
DECL|variable|READ_DATA_PORT
r_static
r_const
r_int
id|READ_DATA_PORT
...
l_int|0x203
suffix:semicolon
multiline_comment|/* This port number may change!!! */
DECL|variable|ADDRESS_PORT
r_static
r_const
r_int
id|ADDRESS_PORT
...
l_int|0xa79
suffix:semicolon
multiline_comment|/* Plug-n-Play read resource mechanism */
r_static
r_inline
r_int
r_char
DECL|function|read_resource_data
id|read_resource_data
c_func
(paren
r_void
...
suffix:semicolon
multiline_comment|/* Select PnP status register. */
r_while
c_loop
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* read resource data */
id|outb
c_func
(paren
l_int|0x04
...
suffix:semicolon
multiline_comment|/* Select PnP resource data register. */
r_return
id|inb
c_func
(paren
...
suffix:semicolon
multiline_comment|/* &quot;GIC1000&quot; */
multiline_comment|/* Reset the ISA PnP mechanism */
id|outb
c_func
(paren
l_int|0x02
...
multiline_comment|/* send initiation key */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* set card CSN into configuration mode */
r_for
c_loop
(paren
id|csn
...
suffix:semicolon
multiline_comment|/* Select PnP wake[CSN] register. */
id|outb
c_func
(paren
id|csn
...
suffix:semicolon
multiline_comment|/* Wake[CSN] */
multiline_comment|/* check card ID */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* SB1000 not found */
r_if
c_cond
(paren
id|csn
...
multiline_comment|/* found: get serial number and skip checksum */
id|serial_number
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* get I/O port base address */
id|outb
c_func
(paren
l_int|0x60
...
suffix:semicolon
multiline_comment|/* Select PnP I/O port base address 0. */
id|ioaddr
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/* Select PnP I/O port base address 1. */
id|ioaddr
(braket
l_int|1
)braket
...
suffix:semicolon
multiline_comment|/* Select PnP IRQ level select 0. */
id|irq
op_assign
id|inb
c_func
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: sb1000 at (%#3.3lx,%#3.3lx), csn %d, &quot;
