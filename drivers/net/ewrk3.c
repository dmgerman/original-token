...
mdefine_line|#define EWRK3_TOTAL_SIZE 0x20           /* required I/O address space */
...
(brace
multiline_comment|/* Module or fixed location */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* Register I/O Region */
id|request_region
c_func
(paren
id|base_addr
...
c_func
(paren
l_string|&quot;%s: ewrk3_probe(): Detected a device already registered at 0x%02x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|base_addr
...
r_else
(brace
multiline_comment|/* already know what ewrk3 h/w is here */
id|status
op_assign
id|ewrk3_hw_init
c_func
...
(brace
multiline_comment|/* Anything else registered here? */
r_if
c_cond
(paren
op_logical_neg
