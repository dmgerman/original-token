...
mdefine_line|#define WAIT_4_SCB_CMD() { int i; &bslash;&n;  for(i=0;i&lt;16384;i++) { &bslash;&n;    if(!p-&gt;scb-&gt;cmd_cuc) break; &bslash;&n;    DELAY_18(); &bslash;&n;    if(i == 16383) { &bslash;&n;      printk(&quot;%s: scb_cmd timed out: %04x,%04x .. disabeling i82586!!&bslash;n&quot;,dev-&gt;name,p-&gt;scb-&gt;cmd_cuc,p-&gt;scb-&gt;cus); &bslash;&n;       if(!p-&gt;reseted) { p-&gt;reseted = 1; ni_reset586(); } } } }
DECL|macro|WAIT_4_SCB_CMD_RUC
mdefine_line|#define WAIT_4_SCB_CMD_RUC() { int i; &bslash;&n;  for(i=0;i&lt;16384;i++) { &bslash;&n;    if(!p-&gt;scb-&gt;cmd_ruc) break; &bslash;&n;    DELAY_18(); &bslash;&n;    if(i == 16383) { &bslash;&n;      printk(&quot;%s: scb_cmd (ruc) timed out: %04x,%04x .. disabeling i82586!!&bslash;n&quot;,dev-&gt;name,p-&gt;scb-&gt;cmd_ruc,p-&gt;scb-&gt;rus); &bslash;&n;       if(!p-&gt;reseted) { p-&gt;reseted = 1; ni_reset586(); } } } }
...
l_int|0
suffix:semicolon
multiline_comment|/* linkpointer of xmit-command allready points to next nop cmd */
id|p-&gt;nop_cmds
(braket
id|next_nop
)braket
...
c_func
(paren
l_string|&quot;%s: Can&squot;t apply promiscuous/multicastmode to a not running interface.&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
