...
id|version
op_assign
l_string|&quot;lance32.c:v0.02 17.3.96 tsbogend@bigbug.franken.de&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/*&n; * History:&n; * v0.01:  Initial version&n; *         only tested on Alpha Noname Board&n; * v0.02:  changed IRQ handling for new interrupt scheme (dev_id)&n; *         tested on a ASUS SP3G&n; */
