...
id|version
op_assign
l_string|&quot;sis900.c: v1.07.01  08/08/2000&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/* SiS630E A1, The Mac address is hardcoded in the RFCR register so it is actually not necessary to&n;   probe the MAC address */
DECL|function|sis630ea1_get_mac_addr
r_static
r_int
id|sis630ea1_get_mac_addr
c_func
(paren
r_struct
id|pci_dev
...
id|i
suffix:semicolon
multiline_comment|/* reload MAC address */
id|reg
op_assign
id|inl
c_func
