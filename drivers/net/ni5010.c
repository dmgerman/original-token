...
(paren
id|KERN_WARNING
l_string|&quot;%s: Failed to allocate device memory&bslash;n&quot;
comma
id|boardname
)paren
suffix:semicolon
...
(brace
multiline_comment|/* &n;                 * If we get here, some higher level has decided we are broken.&n;&t;&t; * There should really be a &quot;kick me&quot; function call instead. &n;&t;&t; */
r_int
id|tickssofar
op_assign
id|jiffies
...
multiline_comment|/* &n;         * Block a timer-based transmit from overlapping.  This could better be&n;&t; * done with atomic_swap(1, dev-&gt;tbusy), but test_and_set_bit() works as well. &n;&t; */
r_if
c_cond
(paren
id|test_and_set_bit
...
(paren
id|KERN_WARNING
l_string|&quot;%s: Reentering IRQ-handler!&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
