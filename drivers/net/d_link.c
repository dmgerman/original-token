...
DECL|macro|D_LINK_SLOW_DOWN
mdefine_line|#define D_LINK_SLOW_DOWN SLOW_DOWN_IO; SLOW_DOWN_IO; SLOW_DOWN_IO
...
multiline_comment|/*&n; * For fix to TCP &quot;slowdown&quot;, take a look at the &quot;#define D_LINK_MAX_WINDOW&quot;&n; * near the end of the file...&n; */
...
macro_line|#ifndef D_LINK_IO
DECL|macro|D_LINK_IO
mdefine_line|#define D_LINK_IO 0x378
macro_line|#endif
DECL|macro|DATA_PORT
mdefine_line|#define DATA_PORT&t;(D_LINK_IO)
DECL|macro|STATUS_PORT
mdefine_line|#define STATUS_PORT&t;(D_LINK_IO + 1)
DECL|macro|COMMAND_PORT
mdefine_line|#define COMMAND_PORT&t;(D_LINK_IO + 2)
macro_line|#ifndef D_LINK_IRQ
DECL|macro|D_LINK_IRQ
mdefine_line|#define D_LINK_IRQ&t;7
macro_line|#endif
multiline_comment|/*&n; * It really should look like this, and autoprobing as well...&n; *&n;#define DATA_PORT&t;(dev-&gt;base_addr + 0)&n;#define STATUS_PORT&t;(dev-&gt;base_addr + 1)&n;#define COMMAND_PORT&t;(dev-&gt;base_addr + 2)&n;#define D_LINK_IRQ&t;dev-&gt;irq&n; */
...
DECL|macro|select_prn
mdefine_line|#define select_prn() outb_p(SELECT_PRN, COMMAND_PORT); D_LINK_SLOW_DOWN
DECL|macro|select_nic
mdefine_line|#define select_nic() outb_p(SELECT_NIC, COMMAND_PORT); D_LINK_SLOW_DOWN
...
(paren
(paren
l_string|&quot;d_link_start_xmit:len=%d, page %d/%d&bslash;n&quot;
comma
id|skb-&gt;len
comma
id|tx_fifo_in
...
id|sk-&gt;max_unacked
op_assign
id|D_LINK_MAX_WINDOW
op_minus
id|D_LINK_TCP_WINDOW_DIFF
suffix:semicolon
r_if
c_cond
(paren
