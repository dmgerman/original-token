...
c_func
(paren
l_string|&quot;3c503.c: memory failure or memory address conflict.&bslash;n&quot;
)paren
suffix:semicolon
id|dev-&gt;mem_start
op_assign
...
multiline_comment|/* No shared memory, use programmed I/O. Ugh. */
id|outb
c_func
(paren
l_int|0
...
suffix:semicolon
multiline_comment|/* Header is &lt; 8 bytes, so only check the FIFO at the beginning. */
id|fifo_watchdog
op_assign
id|jiffies
suffix:semicolon
