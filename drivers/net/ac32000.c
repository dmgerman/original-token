...
id|version
op_assign
l_string|&quot;ac3200.c:v0.03 2/6/94 Donald Becker (becker@super.org)&bslash;n&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;n%s: AC3200 at %#x, IRQ %d, %s port, shared memory at %#x-%#x.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ioaddr
