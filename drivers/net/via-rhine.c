...
id|versionA
op_assign
l_string|&quot;via-rhine.c:v1.03a-LK1.1.2  3/19/2000  Written by Donald Becker&bslash;n&quot;
suffix:semicolon
...
macro_line|#error  See the last lines of the source file for the proper compile-command.
macro_line|#endif
...
(paren
id|KERN_ERR
l_string|&quot;unable to init PCI device (card #%d)&bslash;n&quot;
comma
id|card_idx
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* if tx_full is set, they&squot;re all dirty, not clean */
r_while
c_loop
(paren
id|np-&gt;dirty_tx
