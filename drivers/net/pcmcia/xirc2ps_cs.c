...
suffix:semicolon
multiline_comment|/* dummy, not used anymore */
DECL|variable|lockup_hack
r_static
r_int
id|lockup_hack
op_assign
...
id|i
suffix:semicolon
multiline_comment|/* Note that registers 14, 1d,1e and 1f are reserved and should&n;     * not be read according to the DP83840A specs.&n;     */
id|printk
c_func
(paren
id|KERN_DEBUG
l_string|&quot;%s: MII register dump:&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
id|PRESENT_OPTION
suffix:semicolon
multiline_comment|/* Allocate space for a device structure */
id|dev
op_assign
id|kmalloc
c_func
...
(paren
id|KERR_XIRC
l_string|&quot;re-entering isr on irq %d (dev=%p)&bslash;n&quot;
comma
id|irq
comma
id|dev
...
multiline_comment|/****************&n; * We never need to do anything when a IIps device is &quot;initialized&quot;&n; * by the net software, because we only register already-found cards.&n; */
r_static
r_int
...
(brace
multiline_comment|/* kludge to print the mii regsiters */
id|mii_dump
c_func
(paren
id|dev
...
(brace
multiline_comment|/* according to the DP83840A specs the auto negotation process&n;&t; * may take up to 3.5 sec, so we use this also for our ML6692&n;&t; * Fixme: Better to use a timer here!&n;&t; */
r_for
c_loop
(paren
id|i
