...
id|version
op_assign
l_string|&quot;pcnet_cs.c 1.117 2000/05/04 01:29:47 (David Hinds)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
mdefine_line|#define IS_AX88190&t;0x20
...
op_assign
(brace
multiline_comment|/* D-Link DL10019 chipset */
l_int|0x00
comma
l_int|0x00
comma
...
(paren
id|KERN_INFO
l_string|&quot;%s: NE2000 (DL10019 rev %02x): &quot;
comma
id|dev-&gt;name
comma
id|inb
...
suffix:semicolon
multiline_comment|/* Start by assuming the link is bad */
id|info-&gt;link_status
op_assign
l_int|1
suffix:semicolon
...
multiline_comment|/*======================================================================&n;&n;    MII interface support for DL10019 based cards&n;&n;    There are two types of DL10019 based cards.  Some have the MII IO&n;    direction bit as 0x10, others as 0x20; setting both bits seems to&n;    work on all cards.&n;&n;======================================================================*/
