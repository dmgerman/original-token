...
mdefine_line|#define PCMCIA_DEBUG 6
...
id|version
op_assign
l_string|&quot;pcnet_cs.c 1.94 1999/07/29 06:04:49 (David Hinds)&quot;
suffix:semicolon
macro_line|#else
DECL|macro|DEBUG
...
DECL|macro|IS_DL10019A
mdefine_line|#define IS_DL10019A&t;0x10
...
op_assign
(brace
multiline_comment|/* Unknown NE2000 Clone */
l_int|0x00
comma
l_int|0x00
comma
...
suffix:semicolon
DECL|variable|dl_fast_info
r_static
id|hw_info_t
id|dl_fast_info
op_assign
(brace
multiline_comment|/* D-Link EtherFast */
l_int|0x00
comma
l_int|0x00
comma
...
multiline_comment|/*======================================================================&n;&n;    For the Linksys EtherFast 10/100 card&n;&n;======================================================================*/
DECL|function|get_dl_fast
r_static
id|hw_info_t
op_star
id|get_dl_fast
...
(paren
id|KERN_NOTICE
l_string|&quot;pcnet_cs: unable to read hardware net address&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|config_undo
...
(paren
id|KERN_INFO
l_string|&quot;%s: NE2000 Compatible: io %#3lx, irq %d,&quot;
comma
id|dev-&gt;name
comma
id|dev-&gt;base_addr
...
suffix:semicolon
multiline_comment|/* For D-Link EtherFast, wait for something(?) to happen */
r_if
c_cond
(paren
id|info-&gt;flags
...
(paren
id|KERN_NOTICE
l_string|&quot;%s: transceiver selection not &quot;
...
l_string|&quot;[DMAstat:%1x][irqlock:%1x][intr:%ld]&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ei_status.dmaing
...
l_int|0
comma
l_string|&quot;pcnet driver registered&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
singleline_comment|//__initcall(init_pcnet_cs);
macro_line|#ifdef MODULE
