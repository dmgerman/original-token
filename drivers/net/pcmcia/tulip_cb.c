...
op_assign
l_string|&quot;tulip.c:v0.91 4/14/99 becker@cesdis.gsfc.nasa.gov (modified by danilo@cs.uni-magdeburg.de for XIRCOM CBE, fixed by Doug Ledford)&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
DECL|macro|PCI_ADDR0_IO
mdefine_line|#define PCI_ADDR0_IO (PCI_USES_IO|PCI_ADDR0)
...
comma
(brace
l_string|&quot;Lite-On LC82C115 PNIC-II&quot;
comma
l_int|0x11AD
comma
l_int|0xc115
...
"&f;"
multiline_comment|/* A list of all installed Tulip devices. */
...
id|pdev-&gt;irq
suffix:semicolon
macro_line|#elif defined(PCI_SUPPORT_VER3)
r_struct
id|pci_dev
op_star
id|pdev
...
(paren
id|KERN_INFO
l_string|&quot;Found %s at PCI I/O address %#lx.&bslash;n&quot;
comma
id|pci_tbl
(braket
id|chip_idx
...
id|max_interrupt_work
suffix:semicolon
macro_line|#if defined(__i386__) &amp;&amp; defined(SMP_CHECK)
r_if
c_cond
(paren
id|test_and_set_bit
...
(paren
id|KERN_ERR
l_string|&quot;%s: Duplicate entry of the interrupt handler by &quot;
