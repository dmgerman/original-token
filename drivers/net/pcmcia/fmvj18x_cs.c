...
macro_line|#endif
multiline_comment|/*&n;   For debugging this driver you may need more information.&n;   To enable printing registers or status, set &squot;fmvj18x_debug=#&squot; option .&n; */
macro_line|#ifdef FMVJ18X_DEBUG
DECL|variable|fmvj18x_debug
r_static
r_int
id|fmvj18x_debug
op_assign
...
l_int|2
suffix:semicolon
macro_line|#endif /* FMVJ18X_DEBUG */
