...
l_int|0
suffix:semicolon
multiline_comment|/* default=auto */
multiline_comment|/*&n;   * 0=auto&n;   * 1=10base-T (twisted pair)&n;   * 2=10base-2 (BNC)&n;   */
...
suffix:semicolon
multiline_comment|/* Allocate private data area for this device. */
id|dev-&gt;priv
op_assign
id|kmalloc
c_func
...
id|OrigCorValue
suffix:semicolon
multiline_comment|/* Find our client handle. */
r_for
c_loop
(paren
id|link
...
(paren
id|KERN_NOTICE
l_string|&quot;nmclan_cs: bad device pointer!&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
l_int|1
suffix:semicolon
macro_line|#endif /* #if TIMEOUT_TX */
id|DEBUG
c_func
(paren
l_int|3
