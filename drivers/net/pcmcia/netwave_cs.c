...
l_int|NULL
suffix:semicolon
multiline_comment|/*    modwin_t mod;&n;&t;  short iobase, *phys_addr;&n;&t;  */
id|handle
op_assign
id|link-&gt;handle
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* ((netwave_private *)link-&gt;priv)-&gt;block = 1; */
...
l_int|1
suffix:semicolon
multiline_comment|/* Find the correct dev_link_t */
r_for
c_loop
(paren
id|link
