...
suffix:semicolon
macro_line|#ifdef BROKEN_FEATURES
id|MODULE_PARM
c_func
(paren
id|use_fifo_buffer
...
suffix:semicolon
macro_line|#ifdef BROKEN_FEATURES
multiline_comment|/* Performance features: best left disabled. */
multiline_comment|/* Set to buffer all Tx/RxFIFO accesses. */
DECL|variable|use_fifo_buffer
r_static
r_int
id|use_fifo_buffer
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Set iff memory ops are faster than I/O ops. */
DECL|variable|use_memory_ops
r_static
r_int
id|use_memory_ops
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Set iff disabling the WAIT signal is reliable and faster. */
DECL|variable|no_wait
r_static
r_int
id|no_wait
op_assign
...
multiline_comment|/*&n;   We never need to do anything when a tc574 device is &quot;initialized&quot;&n;   by the net software, because we only register already-found cards.&n;*/
DECL|function|tc574_init
r_static
r_int
id|tc574_init
c_func
...
suffix:semicolon
multiline_comment|/* Make up a Odie-specific data structure. */
id|dev-&gt;priv
op_assign
id|kmalloc
c_func
...
(paren
id|KERN_INFO
l_string|&quot;  Acceleration window at memory base %#lx.&bslash;n&quot;
comma
id|dev-&gt;mem_start
)paren
suffix:semicolon
...
suffix:semicolon
macro_line|#ifdef BROKEN_FEATURES
multiline_comment|/* Set the PIO ctrl bits in the PC card LAN COR using Runner window 1. */
r_if
c_cond
(paren
id|dev-&gt;mem_start
...
multiline_comment|/* Iff use_memory_ops worked! */
id|lan_cor
op_or_assign
l_int|0x10
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* New: On the Vortex/Odie we must also clear the BadSSD counter.. */
id|inb
c_func
(paren
id|ioaddr
...
(brace
multiline_comment|/* Avoid other accesses to the chip while RunnerWrCtrl is non-zero. */
id|save_flags
c_func
(paren
id|flags
...
l_int|0
comma
l_string|&quot;TxFree %x, tx length %x, RunnerWrCtrl is %4.4x.&bslash;n&quot;
comma
id|inw
c_func
(paren
...
l_int|0
comma
l_string|&quot; RunnerWr/RdCtrl is %4.4x/%4.4x, TxFree %x.&bslash;n&quot;
comma
id|inw
c_func
(paren
...
suffix:semicolon
multiline_comment|/* With Vortex and later we must also clear the BadSSD counter. */
id|EL3WINDOW
c_func
(paren
l_int|4
...
l_int|0
comma
l_string|&quot;Start Rx %x -- RunnerRdCtrl is %4.4x.&bslash;n&quot;
comma
id|pkt_len
comma
id|inw
...
l_int|0
comma
l_string|&quot; RunnerRdCtrl is now %4.4x.&bslash;n&quot;
comma
id|inw
c_func
(paren
...
l_int|0
comma
l_string|&quot; Rx packet with data %2.2x:%2.2x:%2.2x&bslash;n&quot;
comma
id|skb-&gt;head
(braket
l_int|0
