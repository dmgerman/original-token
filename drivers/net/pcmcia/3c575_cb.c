...
id|version
op_assign
l_string|&quot;3c575_cb.c:v0.99L+LK1.1.2  3/19/2000  Donald Becker and others  http://cesdis.gsfc.nasa.gov/linux/drivers/vortex.html&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
DECL|macro|PFX
mdefine_line|#define PFX &quot;3c575_cb: &quot;
...
id|CH_3CCFEM656
comma
DECL|enumerator|CH_3C575_2
id|CH_3C575_2
comma
DECL|enumerator|CH_BOOMERANG
id|CH_BOOMERANG
comma
)brace
suffix:semicolon
...
l_int|4
comma
multiline_comment|/* XXX is 4 correct eisa idx? */
id|vortex_cards_found
)paren
suffix:semicolon
r_if
...
multiline_comment|/* NOTE: pdev can be NULL, for the case of an EISA driver */
