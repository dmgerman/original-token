...
id|version
op_assign
l_string|&quot;3c59x.c:v0.99L 5/28/99 Donald Becker http://cesdis.gsfc.nasa.gov/linux/drivers/vortex.html&bslash;n&quot;
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/* The Cyclone requires config space re-write if powered down. */
id|acpi_wake
c_func
(paren
id|pci_bus
...
id|pdev-&gt;irq
suffix:semicolon
macro_line|#elif LINUX_VERSION_CODE &gt;= 0x20155
r_struct
id|pci_dev
op_star
id|pdev
...
id|i
suffix:semicolon
multiline_comment|/* Should be if(HAS_ACPI) */
id|acpi_wake
c_func
(paren
id|vp-&gt;pci_bus
...
multiline_comment|/* Change from D3 (sleep) to D0 (active).&n;   Problem: The Cyclone forgets all PCI config info during the transition! */
DECL|function|acpi_wake
r_static
r_void
id|acpi_wake
c_func
