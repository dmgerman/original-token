...
suffix:semicolon
multiline_comment|/* construct private data for the 885 ethernet */
id|dev-&gt;priv
op_assign
id|kmalloc
c_func
...
op_increment
suffix:semicolon
multiline_comment|/* Access is via I/O space, bus master enabled... */
...
(paren
id|KERN_INFO
l_string|&quot;  PCI master bit not set! Now setting.&bslash;n&quot;
)paren
suffix:semicolon
id|cmd
op_or_assign
...
(paren
id|KERN_INFO
l_string|&quot;  Enabling I/O space.&bslash;n&quot;
)paren
suffix:semicolon
id|cmd
op_or_assign
...
l_string|&quot; low at %d.  Setting to 255.&bslash;n&quot;
comma
id|latency
)paren
suffix:semicolon
