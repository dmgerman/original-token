...
id|version
op_assign
l_string|&quot;znet.c:v0.04 5/10/94 becker@cesdis.gsfc.nasa.gov&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define ZNET_DEBUG 3
macro_line|#endif
...
c_func
(paren
l_string|&quot;Not opened -- resource busy?!?&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|EBUSY
...
suffix:semicolon
multiline_comment|/* Transmitter timeout, could be a serious problems. */
r_if
c_cond
(paren
id|dev-&gt;tbusy
...
(brace
multiline_comment|/*do_command(ioaddr, CMD0_CONFIGURE+CMD0_CHNL_1, sizeof(i593_init) + 2,&n;&t;&t;&t;   zn.tx_buffer);*/
multiline_comment|/*do_command(ioaddr, CMD0_CONFIGURE+CMD0_CHNL_1, 32, zn.tx_buffer);*/
multiline_comment|/*outb(CMD0_CONFIGURE+CMD0_CHNL_1, ioaddr);*/
r_if
c_cond
(paren
id|znet_debug
...
c_func
(paren
l_string|&quot;Terminal addr is %04x, cnt. %03x...&quot;
comma
id|addr
op_lshift
l_int|1
...
(brace
multiline_comment|/* This isn&squot;t needed, but is here for safety. */
id|outb
c_func
(paren
id|CMD0_NOP
...
c_func
(paren
l_string|&quot;znet: do_command() while the i82593 is busy.&bslash;n&quot;
)paren
suffix:semicolon
id|cli
c_func
...
multiline_comment|/* wait_for_done - this is a blatent rip-off of the wait_for_done routine&n; ** from the Crynwr packet driver.&t;It does not work correctly - doesn&squot;t&n; ** acknowledge the interrupts it gets or something.  It does determine&n; ** when the command is done, or if there are none executing, though...&n; **&t;&t;-Mike&n; */
DECL|function|wait_for_done
r_static
r_int
id|wait_for_done
c_func
...
l_int|0
suffix:semicolon
multiline_comment|/* check to see if we are busy */
id|outb
c_func
(paren
id|CMD0_NOP
...
c_func
(paren
l_string|&quot;wait_for_done(): Not busy, status %02x.&bslash;n&quot;
comma
id|stat
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Command completed after %d ticks status %02x.&bslash;n&quot;
comma
id|ticks
comma
id|stat
...
c_func
(paren
l_string|&quot;wait_for_done: command not ACK&squot;d, status %02x after abort %02x.&bslash;n&quot;
comma
id|stat
comma
id|inb
...
suffix:semicolon
multiline_comment|/* should re-initialize here... */
r_return
l_int|1
suffix:semicolon
)brace
macro_line|#endif /* notdef */
