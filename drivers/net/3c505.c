...
DECL|macro|ELP_DMA
mdefine_line|#define ELP_DMA      6&t;&t;/* DMA channel to use */
...
suffix:semicolon
id|adapter-&gt;current_dma.copy_flag
op_assign
l_int|0
suffix:semicolon
r_if
...
c_func
(paren
l_string|&quot;%s: could not allocate DMA channel&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Could not allocate DMA buffer&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|adapter-&gt;dmaing
...
r_else
(brace
multiline_comment|/* Otherwise, it must just be in a strange state.  We probably&n;&t;&t;&t;&t; * need to kick it.&n;&t;&t;&t;&t; */
id|printk
c_func
(paren
...
suffix:semicolon
multiline_comment|/* set up the DMA channel */
id|dev-&gt;dma
op_assign
id|ELP_DMA
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: not responding to second PCB&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
