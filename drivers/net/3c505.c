...
multiline_comment|/* These should be moved to the private data area */
DECL|variable|send_pcb_semaphore
r_static
r_int
...
l_int|0
suffix:semicolon
DECL|variable|rx_restart_needed
r_static
r_int
id|rx_restart_needed
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s: interrupt - receiver start deferred&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
