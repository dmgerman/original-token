...
DECL|macro|BAYCOM_ALT_SER12
mdefine_line|#define BAYCOM_ALT_SER12
multiline_comment|/* --------------------------------------------------------------------- */
...
id|KERN_INFO
l_string|&quot;baycom: version 0.4 compiled &quot;
id|__TIME__
l_string|&quot; &quot;
id|__DATE__
l_string|&quot;&bslash;n&quot;
...
id|bit_pll
suffix:semicolon
macro_line|#ifdef BAYCOM_ALT_SER12
...
id|txshreg
suffix:semicolon
macro_line|#else /* BAYCOM_ALT_SER12 */
DECL|member|interm_sample
r_int
r_char
id|interm_sample
suffix:semicolon
macro_line|#endif /* BAYCOM_ALT_SER12 */
DECL|member|ser12
)brace
id|ser12
suffix:semicolon
...
macro_line|#ifdef BAYCOM_ALT_SER12
DECL|macro|SER12_BAUD
mdefine_line|#define SER12_BAUD 1200
multiline_comment|/* --------------------------------------------------------------------- */
r_extern
r_inline
r_int
...
(paren
id|KERN_INFO
l_string|&quot;%s: ser12(alt modem) at iobase 0x%lx irq %u options &quot;
