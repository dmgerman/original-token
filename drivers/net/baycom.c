...
(paren
id|KERN_INFO
l_string|&quot;baycom: ser12 at iobase 0x%lx irq %u options &quot;
...
(paren
id|KERN_INFO
l_string|&quot;baycom: close ser12 at iobase 0x%lx irq %u&bslash;n&quot;
comma
id|dev-&gt;base_addr
comma
id|dev-&gt;irq
...
(paren
id|KERN_INFO
l_string|&quot;baycom: par96 at iobase 0x%lx irq %u &quot;
l_string|&quot;options 0x%x&bslash;n&quot;
comma
id|dev-&gt;base_addr
comma
id|dev-&gt;irq
...
(paren
id|KERN_INFO
l_string|&quot;baycom: close par96 at iobase 0x%lx irq %u&bslash;n&quot;
comma
id|dev-&gt;base_addr
comma
id|dev-&gt;irq
...
suffix:semicolon
r_case
id|BAYCOMCTL_GETMODEMTYPE
suffix:colon
id|bi.data.mt.modem_type
op_assign
id|BAYCOM_MODEM_INVALID
suffix:semicolon
r_if
...
(paren
id|KERN_ERR
l_string|&quot;baycom: BAYCOMCTL_GETMODEMTYPE: &quot;
l_string|&quot;modem ops invalid&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|bi.data.mt.options
op_assign
id|bc-&gt;options
suffix:semicolon
r_break
...
(paren
id|KERN_INFO
l_string|&quot;baycom: compiled %s %s&bslash;n&quot;
comma
id|__TIME__
comma
id|__DATE__
...
(paren
id|KERN_WARNING
l_string|&quot;baycom: cannot register net &quot;
...
(paren
id|KERN_INFO
l_string|&quot;baycom: v0.1 (C) 1996 Thomas Sailer HB9JNX/AE4WA&bslash;n&quot;
)paren
suffix:semicolon
id|baycom_ports
(braket
