...
macro_line|#ifdef start_bh_atomic&t;&t;&t;/* This checks for kernels &gt;= 1.1.0. */
...
multiline_comment|/* Block input and output, similar to the Crynwr packet driver.&n;   Note that transfer with the EtherTwist+ must be on word boundaries. */
r_static
r_int
...
suffix:semicolon
multiline_comment|/* Caution: this relies on 8390.c rounding up allocations! */
id|memcpy
c_func
(paren
id|buf
