...
multiline_comment|/* This file is distributed under the GPL.&n;   Some of these names and comments are from the Crynwr packet drivers. */
DECL|macro|EL2H
...
mdefine_line|#define E33G_STARTPG&t;(EL2H+0)       /* Start page, must match EN0_STARTPG */
