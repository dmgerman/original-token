...
id|version
op_assign
l_string|&quot;cs89x0.c: v2.3.99-pre1-2 Russell Nelson &lt;nelson@crynwr.com&gt;, Andrew Morton &lt;andrewm@uow.edu.au&gt;&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define DEBUGGING&t;0
...
multiline_comment|/*&n;&t; * FIXME: we should check this, but really the isapnp stuff should have given&n;&t; * us a free region.  Sort this out when the isapnp is sorted out&n;&t; */
id|request_region
c_func
(paren
id|ioaddr
...
(brace
multiline_comment|/* Search the mapping table for the corrisponding IRQ pin. */
r_for
c_loop
(paren
id|i
