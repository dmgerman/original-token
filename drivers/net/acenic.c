multiline_comment|/*&n; * acenic.c: Linux driver for the Alteon AceNIC Gigabit Ethernet card&n; *           and other Tigon based cards.&n; *&n; * Copyright 1998 by Jes Sorensen, &lt;Jes.Sorensen@cern.ch&gt;.&n; *&n; * Thanks to Alteon and 3Com for providing hardware and documentation&n; * enabling me to write this driver.&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2 of the License, or&n; * (at your option) any later version.&n; */
DECL|macro|DEBUG
...
id|version
op_assign
l_string|&quot;acenic.c: v0.13 11/25/98  Jes Sorensen (Jes.Sorensen@cern.ch)&bslash;n&quot;
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;Shared mem not enabled - &quot;
l_string|&quot;unable to configure AceNIC&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
c_func
(paren
l_string|&quot;Gigabit Ethernet at 0x%08x, irq %i, PCI latency %i &quot;
...
suffix:semicolon
multiline_comment|/*&n;&t; * Wait for the firmware to spin up - max 2 seconds.&n;&t; */
id|myjif
op_assign
id|jiffies
op_plus
...
macro_line|#if 0
multiline_comment|/*&n;&t; * Since we are also using a spinlock, I wonder if this is&n;&t; * actually worth it.&n;&t; */
r_if
c_cond
(paren
id|test_and_set_bit
