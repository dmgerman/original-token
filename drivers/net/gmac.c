...
multiline_comment|/* Driver version 1.1, kernel 2.4.x */
DECL|macro|GMAC_VERSION
mdefine_line|#define GMAC_VERSION&t;&quot;v1.1k4&quot;
...
suffix:semicolon
multiline_comment|/* Link ? For now we handle only the 5201 PHY */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n; * Lookup for a PHY on the mii interface and reset it&n; */
r_static
r_int
...
(paren
id|KERN_ERR
l_string|&quot;%s Warning ! Unsupported BCM5400 PHY !&bslash;n&quot;
comma
id|gm-&gt;dev-&gt;name
)paren
suffix:semicolon
