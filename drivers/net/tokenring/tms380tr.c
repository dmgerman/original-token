...
multiline_comment|/* &n;&t; * Let&squot;s check for pci adapters first &n;&t; */
r_if
c_cond
(paren
id|tms380tr_probe1
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * No pci cards found, let&squot;s check for isa&n;&t; */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* Region already used */
r_continue
suffix:semicolon
)brace
r_if
...
id|start
suffix:semicolon
multiline_comment|/*&t;&t;pci_ioaddr &amp;= ~3; */
multiline_comment|/* Don&squot;t return from here, just continue on the card discovery loop - MLP */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
id|pci_device-&gt;vendor
comma
id|pci_device-&gt;device
)paren
)paren
)paren
r_continue
...
multiline_comment|/* At this point we have found a valid tms380tr PCI TR card. */
id|pci_ioaddr
op_and_assign
op_complement
l_int|3
...
multiline_comment|/*&n; * Passing an ioaddr of 0 tells us to do a pci card search&n; */
