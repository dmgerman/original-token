...
id|version
op_assign
l_string|&quot;LanStreamer.c v0.1.0 12/10/99 - Mike Sullivan&quot;
suffix:semicolon
...
suffix:semicolon
id|streamer_priv-&gt;streamer_multicast_set
op_assign
l_int|0
suffix:semicolon
r_if
...
(paren
id|KERN_INFO
l_string|&quot;%s: IBM PCI tokenring card. I/O at %hx, MMIO at %p, using irq %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
(paren
...
l_int|512
suffix:semicolon
multiline_comment|/* streamer_priv-&gt;pkt_buf_sz; */
id|writel
c_func
(paren
id|virt_to_bus
...
suffix:semicolon
multiline_comment|/* offset 12 word */
id|writew
c_func
(paren
(paren
...
suffix:semicolon
multiline_comment|/* offset 14 word */
id|writew
c_func
(paren
(paren
...
suffix:semicolon
multiline_comment|/* offset 16 word */
id|memcpy
c_func
(paren
id|dev-&gt;dev_addr
...
(brace
multiline_comment|/* Multicast options have changed */
id|dmi
op_assign
id|dev-&gt;mc_list
suffix:semicolon
...
(brace
multiline_comment|/* Turn multicast on */
multiline_comment|/* RFC 1469 Says we must support using the functional address C0 00 00 04 00 00&n;&t;&t;&t; * We do this with a set functional address mask.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* need to set functional mask */
id|writew
c_func
(paren
...
r_else
(brace
multiline_comment|/* Turn multicast off */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Hmmm, need to reset the functional mask */
id|writew
c_func
(paren
id|SRB_SET_FUNC_ADDRESS
