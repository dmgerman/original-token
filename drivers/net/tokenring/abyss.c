...
id|version
op_assign
l_string|&quot;abyss.c: v1.01 22/01/2000 by Adam Fritzler&bslash;n&quot;
suffix:semicolon
...
id|card
suffix:semicolon
multiline_comment|/* We only support Madge Smart 16/4 PCI Mk2 (Abyss) cards */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * The TMS SIF registers lay 0x10 above the card base address.&n;&t;&t; */
id|dev-&gt;base_addr
op_add_assign
l_int|0x10
suffix:semicolon
...
c_func
(paren
l_string|&quot;abyss: register_trdev() returned non-zero.&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
(paren
id|KERN_NOTICE
l_string|&quot;abyss.c: No cards found.&bslash;n&quot;
)paren
suffix:semicolon
)brace
