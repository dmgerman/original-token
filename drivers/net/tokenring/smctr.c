...
id|version
op_assign
l_string|&quot;smctr.c: v1.0 1/1/00 by jschlst@turbolinux.com&bslash;n&quot;
suffix:semicolon
...
DECL|function|smctr_find_adapter
r_static
r_int
id|__init
id|smctr_find_adapter
...
c_func
(paren
l_string|&quot;%s: smctr_find_adapter %#4x&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ioaddr
...
macro_line|#endif
multiline_comment|/* See if we have a SMCTR card floating around. */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;         * If some higher layer thinks we&squot;ve missed an tx-done interrupt we&n;         * are passed NULL.&n;         */
r_if
c_cond
(paren
id|skb
