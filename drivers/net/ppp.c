...
multiline_comment|/* $Id: ppp.c,v 1.19 1998/07/07 04:27:37 paulus Exp $ */
...
multiline_comment|/*&n;&t; * Verify the FCS of the frame and discard the FCS characters&n;&t; * from the end of the buffer.&n;&t; */
r_if
c_cond
(paren
id|ppp-&gt;rfcs
