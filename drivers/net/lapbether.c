...
macro_line|#include &lt;linux/lapbether.h&gt;
...
suffix:semicolon
DECL|variable|lapbeth_eth_addr
r_static
r_char
id|lapbeth_eth_addr
(braket
...
(paren
id|KERN_DEBUG
l_string|&quot;lapbeth: wrong dest address&bslash;n&quot;
)paren
suffix:semicolon
id|kfree_skb
c_func
...
multiline_comment|/*&t;Ioctl commands&n; *&n; *&t;&t;SIOCSLAPBETHADDR&t;set the destination and accepted&n; *&t;&t;&t;&t;&t;source ethernet address (broadcast&n; *&t;&t;&t;&t;&t;or multicast: accept all)&n; */
