...
id|version
op_assign
l_string|&quot;lance.c:v0.13f 10/18/93 becker@super.org&bslash;n&quot;
suffix:semicolon
...
macro_line|#endif
multiline_comment|/* Set the number of Tx and Rx buffers. */
macro_line|#ifndef LANCE_BUFFER_LOG_SZ
...
macro_line|#else
DECL|macro|RING_SIZE
mdefine_line|#define RING_SIZE&t;(1 &lt;&lt; (LANCE_BUFFERS_LOG_SZ))
DECL|macro|RING_MOD_MASK
mdefine_line|#define RING_MOD_MASK&t;(RING_SIZE - 1)
DECL|macro|RING_LEN_BITS
mdefine_line|#define RING_LEN_BITS&t;(LANCE_BUFFER_LOG_SZ &lt;&lt; 13)
macro_line|#endif
...
macro_line|#ifndef MEM_START_ALLOC
...
macro_line|#ifdef MEM_START_ALLOC
id|dev-&gt;priv
op_assign
(paren
r_void
