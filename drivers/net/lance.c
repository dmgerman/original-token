...
suffix:semicolon
multiline_comment|/* A mapping from the chip ID number to the part number and features.&n;   These are fro the datasheets -- in real life the &squot;970 version&n;   reportedly has the same ID as the &squot;965. */
