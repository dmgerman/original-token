...
id|irtty_wait_until_sent
suffix:semicolon
id|self-&gt;idev.set_dtr_rts
op_assign
id|irtty_set_dtr_rts
suffix:semicolon
id|self-&gt;idev.set_raw_mode
op_assign
id|irtty_set_raw_mode
suffix:semicolon
id|self-&gt;idev.raw_write
op_assign
id|irtty_raw_write
suffix:semicolon
id|self-&gt;idev.raw_read
op_assign
id|irtty_raw_read
suffix:semicolon
...
multiline_comment|/* &n; *  Function irtty_change_speed (self, speed)&n; *&n; *    Change the speed of the serial port. The driver layer must check that&n; *    all transmission has finished using the irtty_wait_until_sent() &n; *    function.&n; */
...
multiline_comment|/*&n; * Function irtty_set_raw_mode (idev, status)&n; *&n; *    For the airport dongle, we need support for reading raw characters&n; *    from the IrDA device. This function switches between those modes. &n; *    FALSE is the default mode, and will then treat incoming data as IrDA &n; *    packets.&n; */
DECL|function|irtty_set_raw_mode
r_void
id|irtty_set_raw_mode
c_func
(paren
...
multiline_comment|/*&n; * Function irtty_raw_read (idev, buf, len)&n; *&n; *    Receive incomming data. This function sleeps, so it must only be&n; *    called with a process context. Timeout is currently defined to be&n; *    a multiple of 10 ms.&n; */
