...
comma
id|__FUNCTION__
l_string|&quot; description too long: %s&bslash;n&quot;
comma
id|idev-&gt;description
)paren
suffix:semicolon
...
multiline_comment|/*&n; * Function airport_change_speed (tty, baud)&n; *&n; *    Change speed of the Airport type IrDA dongles.&n; */
...
suffix:semicolon
multiline_comment|/* The dongle falls back to 9600 baud */
r_if
c_cond
(paren
id|current_baudrate
...
comma
id|__FUNCTION__
l_string|&quot; resetting speed to 9600 baud&bslash;n&quot;
)paren
suffix:semicolon
id|ASSERT
c_func
...
multiline_comment|/*&n; * Function airport_reset (idev)&n; *&n; *      Reset the Airport type dongle. Warning, this function must only be&n; *      called with a process context!&n; *&n; */
...
(paren
id|idev-&gt;set_raw_mode
multiline_comment|/* The airport needs this */
comma
r_return
suffix:semicolon
)paren
...
multiline_comment|/*&n; * Function airport_init_qos (qos)&n; *&n; *    Initialize QoS capabilities&n; *&n; */
DECL|function|airport_init_qos
r_static
r_void
id|airport_init_qos
c_func
