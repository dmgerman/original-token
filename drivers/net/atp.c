...
id|dev-&gt;base_addr
suffix:semicolon
multiline_comment|/* If we get here, some higher level has decided we are broken. */
id|printk
c_func
(paren
id|KERN_WARNING
