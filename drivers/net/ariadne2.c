multiline_comment|/*&n; *  Amiga Linux/m68k Ariadne II Ethernet Driver&n; *&n; *  (C) Copyright 1998 by some Elitist 680x0 Users(TM)&n; *&n; *  ---------------------------------------------------------------------------&n; *&n; *  This program is based on all the other NE2000 drivers for Linux&n; *&n; *  ---------------------------------------------------------------------------&n; *&n; *  This file is subject to the terms and conditions of the GNU General Public&n; *  License.  See the file COPYING in the main directory of the Linux&n; *  distribution for more details.&n; *&n; *  ---------------------------------------------------------------------------&n; *&n; *  The Ariadne II is a Zorro-II board made by Village Tronic. It contains a&n; *  Realtek RTL8019AS Ethernet Controller.&n; */
...
DECL|macro|ARIADNE2_BOOTROM
mdefine_line|#define ARIADNE2_BOOTROM&t;0xc000
DECL|macro|NE_BASE
...
(paren
id|KERN_ERR
l_string|&quot;ariadne2.c: Passed a NULL device.&bslash;n&quot;
)paren
suffix:semicolon
id|dev
op_assign
...
c_func
(paren
l_string|&quot;%s: AriadNE2 at 0x%08lx, Ethernet Address &quot;
