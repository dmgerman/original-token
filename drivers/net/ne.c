...
(paren
id|KERN_NOTICE
l_string|&quot;ne.c: Module autoprobing not allowed. Append &bslash;&quot;io=0xNNN&bslash;&quot; value(s).&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_WARNING
l_string|&quot;ne.c: No NE*000 card found (i/o = 0x%x).&bslash;n&quot;
comma
id|io
(braket
id|this_dev
