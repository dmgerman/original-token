...
id|version
op_assign
l_string|&quot;DLCI driver v0.10, 23 Mar 1996, mike.mclagan@linux.org&quot;
suffix:semicolon
...
op_increment
suffix:semicolon
multiline_comment|/* per Alan Cox, always return 0, let the slave free the packet */
id|ret
op_assign
l_int|0
suffix:semicolon
...
id|DLCI_DEVADD
suffix:colon
multiline_comment|/* can only add on the primary device */
r_if
c_cond
(paren
op_star
...
id|DLCI_DEVDEL
suffix:colon
multiline_comment|/* can&squot;t delete the primary device */
r_if
c_cond
(paren
op_logical_neg
