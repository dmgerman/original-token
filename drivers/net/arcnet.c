...
id|version
op_assign
l_string|&quot;arcnet.c: v2.41 ALPHA 96/02/10 Avery Pennarun &lt;apenwarr@foxnet.net&gt;&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/**************************************************************************/
multiline_comment|/* This driver supports three different &quot;virtual ARCnet devices&quot; running&n; * on the same adapter, in order to communicate with various different&n; * TCP/IP-over-ARCnet implementations.  They are:&n; *&t;arc0&t;- RFC1201 Internet-standard protocol&n; *&t;arc0e&t;- Ethernet-encapsulation protocol (as used by Windows)&n; *&t;arc0s&t;- &quot;Simpler&quot; (but outdated) RFC1051 internet standard.&n; *&n; * arc0e and arc0s are created when arc0 is ifconfig&squot;ed up.  You can disable&n; * either or both of them by undefining CONFIG_ARCNET_ETH and/or&n; * CONFIG_ARCNET_1051.&n; */
DECL|macro|CONFIG_ARCNET_ETH
mdefine_line|#define CONFIG_ARCNET_ETH
DECL|macro|CONFIG_ARCNET_1051
mdefine_line|#define CONFIG_ARCNET_1051
...
mdefine_line|#define SLOW_XMIT_COPY
...
multiline_comment|/* Define this to speed up the autoprobe by assuming if only one io port and&n; * shmem are left in the list at Stage 5, they must correspond to each&n; * other.&n; *&n; * This is undefined by default because it might not always be true.  Speed&n; * demons can turn it on - I think it should be fine if you only have one&n; * ARCnet card installed.&n; *&n; * If no ARCnet cards are installed, this delay never happens anyway and thus&n; * the option has no effect.&n; */
...
multiline_comment|/*#define ARCNET_DEBUG_MAX (D_NORMAL|D_EXTRA|D_INIT|D_INIT_REASONS) */
...
mdefine_line|#define ARCNET_DEBUG (D_NORMAL|D_EXTRA|D_INIT)
multiline_comment|/*#define ARCNET_DEBUG (D_NORMAL)*/
macro_line|#endif
...
DECL|macro|BUGMSG
mdefine_line|#define BUGMSG(x,msg,args...) BUGMSG2(x,&quot;%6s: &quot; msg, dev-&gt;name , ## args)
...
id|D_INIT_REASONS
comma
l_string|&quot;(mem=%Xh, not %Xh)&bslash;n&quot;
comma
op_star
id|cptr
comma
...
multiline_comment|/* skip this if an IRQ was given, because maybe we&squot;re on a&n;&t;&t; * machine that locks during autoirq!&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* remove port and shmem from the lists */
op_star
id|port
op_assign
id|ports
