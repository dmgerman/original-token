...
mdefine_line|#define RTL8139_VERSION &quot;0.9.0&quot;
...
mdefine_line|#define RTL8139_NDEBUG 0&t;/* define to 1 to disable lightweight runtime checks */
macro_line|#if RTL8139_NDEBUG
DECL|macro|assert
...
mdefine_line|#define RX_DMA_BURST&t;4&t;/* Maximum PCI burst, &squot;4&squot; is 256 bytes */
DECL|macro|TX_DMA_BURST
mdefine_line|#define TX_DMA_BURST&t;4&t;/* Calculate as 16&lt;&lt;val. */
...
mdefine_line|#define NUM_TX_DESC&t;4&t;/* Number of Tx descriptor registers. */
...
suffix:semicolon
multiline_comment|/* read after write, to avoid rtl8139 bug w/ posted MMIO writes */
DECL|macro|RTL_W8
mdefine_line|#define RTL_W8(reg, val8)&t;do { writeb (val8, ioaddr + reg); readb (ioaddr + reg); } while (0)
DECL|macro|RTL_W16
mdefine_line|#define RTL_W16(reg, val16)&t;do { writew (val16, ioaddr + reg); readw (ioaddr + reg); } while (0)
DECL|macro|RTL_W32
mdefine_line|#define RTL_W32(reg, val32)&t;do { writel (val32, ioaddr + reg); readl (ioaddr + reg); } while (0)
DECL|macro|RTL_R8
...
DECL|function|rtl8139_name_from_chip
r_static
r_const
r_char
op_star
id|__devinit
id|rtl8139_name_from_chip
(paren
id|chip_t
id|chip
)paren
...
DECL|function|rtl8139_init_pci
r_static
r_int
id|__devinit
id|rtl8139_init_pci
...
id|KERN_ERR
id|PFX
l_string|&quot;no PIO resource, aborting&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|KERN_ERR
id|PFX
l_string|&quot;no MMIO resource, aborting&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
multiline_comment|/* tp zeroed in init_etherdev */
id|tp-&gt;drv_flags
op_assign
id|PCI_COMMAND_IO
op_or
...
suffix:semicolon
multiline_comment|/* Enable PM &amp; PCI VPD */
id|RTL_W8
(paren
id|HltClk
comma
...
suffix:semicolon
multiline_comment|/* Check this value: the documentation contradicts ifself.  Is the&n;&t;   IFG correct with bit 28:27 zero, or with |0x03000000 ? */
id|RTL_W32
(paren
id|TxConfig
comma
...
id|DPRINTK
(paren
l_string|&quot;%s: Queued Tx packet at %p size %lu to slot %d.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|skb-&gt;data
...
id|KERN_WARNING
id|PFX
l_string|&quot;abnormal interrupt, card ejected? (ok to ignore)&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
l_int|0
suffix:semicolon
multiline_comment|/* Grrr, avoid bogus &quot;uninitialized&quot; warning */
id|spin_lock_irq
(paren
op_amp
id|tp-&gt;lock
...
l_string|&quot; loaded (%d device%s registered)&bslash;n&quot;
comma
id|rc
comma
id|rc
