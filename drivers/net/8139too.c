...
mdefine_line|#define RTL8139_VERSION &quot;0.9.11&quot;
...
multiline_comment|/* define to 1 to enable PIO instead of MMIO */
...
(brace
multiline_comment|/* handle signed int overflow */
id|atomic_sub
(paren
id|cur_tx
comma
