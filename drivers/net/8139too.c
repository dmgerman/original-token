...
mdefine_line|#define RTL8139_VERSION &quot;0.9.4.1&quot;
DECL|macro|RTL8139_MODULE_NAME
mdefine_line|#define RTL8139_MODULE_NAME &quot;8139too&quot;
DECL|macro|RTL8139_DRIVER_NAME
mdefine_line|#define RTL8139_DRIVER_NAME   RTL8139_MODULE_NAME &quot; Fast Ethernet driver &quot; RTL8139_VERSION
DECL|macro|PFX
mdefine_line|#define PFX RTL8139_MODULE_NAME &quot;: &quot;
DECL|macro|RTL8139_DEBUG
macro_line|#undef RTL8139_DEBUG /* define to 1 to enable copious debugging info */
...
macro_line|#undef RTL8139_NDEBUG&t;/* define to 1 to disable lightweight runtime checks */
...
mdefine_line|#define PCI_GET_DRIVER_DATA(pdev)&t;&t;((pdev)-&gt;driver_data)
DECL|macro|PCI_SET_DRIVER_DATA
mdefine_line|#define PCI_SET_DRIVER_DATA(pdev,data)&t;(((pdev)-&gt;driver_data) = (data))
...
mdefine_line|#define RX_BUF_TOT_LEN (RX_BUF_LEN + RX_BUF_PAD)
...
mdefine_line|#define RX_FIFO_THRESH&t;4&t;/* Rx buffer level before first PCI xfer.  */
DECL|macro|RX_DMA_BURST
mdefine_line|#define RX_DMA_BURST&t;4&t;/* Maximum PCI burst, &squot;7&squot; is unlimited */
DECL|macro|TX_DMA_BURST
mdefine_line|#define TX_DMA_BURST&t;4&t;/* Maximum PCI burst, &squot;4&squot; is 256 */
...
c_func
(paren
l_string|&quot;MMIO region size == 0x%02X&bslash;n&quot;
comma
id|mmio_len
)paren
suffix:semicolon
...
id|KERN_ERR
id|PFX
l_string|&quot;cannot enable PCI device (bus %d, &quot;
l_string|&quot;devfn %d), aborting&bslash;n&quot;
comma
id|pdev-&gt;bus-&gt;number
comma
id|pdev-&gt;devfn
...
id|DPRINTK
(paren
l_string|&quot;chipset id (%d/%d/%d) == %d, &squot;%s&squot;&bslash;n&quot;
comma
id|CH_8139
comma
id|CH_8139A
...
(paren
id|KERN_INFO
l_string|&quot;%s: &squot;%s&squot; board found at 0x%lx, IRQ %d&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|board_info
...
(paren
id|KERN_INFO
l_string|&quot;%s:   Chip is &squot;%s&squot;&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|rtl_chip_info
...
suffix:semicolon
multiline_comment|/* if link status not ok... */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_INFO
l_string|&quot;%s: no link, starting NWay&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
multiline_comment|/* Reset N-Way to chipset defaults */
id|RTL_W16
(paren
id|BasicModeCtrl
comma
...
r_break
suffix:semicolon
multiline_comment|/* Set N-Way to sane defaults */
id|RTL_W16_F
(paren
id|FIFOTMS
comma
...
multiline_comment|/* XXX writing Config1 here is flat out wrong */
multiline_comment|/* RTL_W8 (Config1, tp-&gt;full_duplex ? 0x60 : 0x20); */
)brace
id|tmp
op_assign
id|RTL_R8
...
multiline_comment|/* disable magic packet scanning, which is enabled&n;&t; * when PM is enabled above (Config1) */
id|RTL_W8
(paren
id|Config3
comma
...
macro_line|#ifndef RTL_TUNE_TWISTER
...
macro_line|#endif /* RTL_TUNE_TWISTER */
DECL|function|rtl8139_timer
r_static
r_void
id|rtl8139_timer
(paren
...
suffix:semicolon
multiline_comment|/* drop lock held in rtl8139_interrupt */
id|spin_unlock
(paren
op_amp
id|tp-&gt;lock
...
suffix:semicolon
multiline_comment|/* obtain lock need for rtl8139_interrupt */
id|spin_lock
(paren
op_amp
id|tp-&gt;lock
...
l_int|4
suffix:semicolon
multiline_comment|/* This could presumably use two calls to copy_and_sum()? */
id|memcpy
(paren
id|skb_put
(paren
...
id|DPRINTK
(paren
l_string|&quot;%s:   rtl8139_set_rx_mode(%4.4x) done -- Rx config %8.8x.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|dev-&gt;flags
