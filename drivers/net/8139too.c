...
mdefine_line|#define RTL8139_VERSION &quot;0.9.3.3&quot;
...
mdefine_line|#define RTL8139B_IO_SIZE 0xFF
...
id|chip_t
suffix:semicolon
multiline_comment|/* indexed by chip_t, above */
r_static
r_struct
(brace
DECL|member|name
...
DECL|member|extended_regs
r_int
id|extended_regs
suffix:semicolon
multiline_comment|/* bool: supports regs &gt; 0x80 ? */
)brace
suffix:semicolon
id|MODULE_AUTHOR
(paren
...
suffix:semicolon
multiline_comment|/* dev-&gt;priv/tp zeroed in init_etherdev */
id|dev-&gt;priv
op_assign
id|tp
op_assign
...
multiline_comment|/* disable interrupt generation while handling this interrupt */
id|RTL_W16
(paren
id|IntrMask
comma
