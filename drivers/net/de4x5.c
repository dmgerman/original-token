multiline_comment|/*  de4x5.c: A DIGITAL DE425/DE434/DE435/DE500 ethernet driver for Linux.&n;&n;    Copyright 1994, 1995 Digital Equipment Corporation.&n;&n;    This software may be used and distributed according to the terms of&n;    the GNU Public License, incorporated herein by reference.&n;&n;    This driver is written for the Digital Equipment Corporation series&n;    of EtherWORKS ethernet cards:&n;&n;        DE425 TP/COAX EISA&n;&t;DE434 TP PCI&n;&t;DE435 TP/COAX/AUI PCI&n;&t;DE450 TP/COAX/AUI PCI&n;&t;DE500 10/100 PCI Fasternet&n;&n;    The driver has been tested on a relatively busy network using the DE425,&n;    DE434, DE435 and DE500 cards and benchmarked with &squot;ttcp&squot;: it transferred&n;    16M of data to a DECstation 5000/200 as follows:&n;&n;                TCP           UDP&n;             TX     RX     TX     RX&n;    DE425   1030k  997k   1170k  1128k&n;    DE434   1063k  995k   1170k  1125k&n;    DE435   1063k  995k   1170k  1125k&n;    DE500   1063k  998k   1170k  1125k  in 10Mb/s mode&n;&n;    All  values are typical (in   kBytes/sec) from a  sample  of 4 for  each&n;    measurement. Their error is +/-20k on a quiet (private) network and also&n;    depend on what load the CPU has.&n;&n;    The author may    be reached  at  davies@wanton.lkg.dec.com  or  Digital&n;    Equipment Corporation, 550 King Street, Littleton MA 01460.&n;&n;    =========================================================================&n;    This driver has been written  substantially  from scratch, although  its&n;    inheritance of style and stack interface from &squot;ewrk3.c&squot; and in turn from&n;    Donald Becker&squot;s &squot;lance.c&squot; should be obvious.&n;&n;    Upto 15 EISA cards can be supported under this driver, limited primarily&n;    by the available IRQ lines.  I have  checked different configurations of&n;    multiple depca, EtherWORKS 3 cards and de4x5 cards and  have not found a&n;    problem yet (provided you have at least depca.c v0.38) ...&n;&n;    PCI support has been added  to allow the driver  to work with the DE434,&n;    DE435, DE450 and DE500 cards. The I/O accesses are a bit of a kludge due&n;    to the differences in the EISA and PCI CSR address offsets from the base&n;    address.&n;&n;    The ability to load  this driver as a  loadable module has been included&n;    and used  extensively during the  driver development (to save those long&n;    reboot sequences).  Loadable module support  under PCI and EISA has been&n;    achieved by letting the driver autoprobe as if it were compiled into the&n;    kernel, except that there is no autoprobing of the IRQ lines. This is of&n;    no great  consequence except do make sure  you&squot;re not sharing interrupts&n;    with  anything that cannot  accomodate  interrupt sharing!  The existing&n;    register_netdevice() code will only allow one device to be registered at&n;    a time. &n;&n;    ************************************************************************&n;    For now, please only use the &squot;io=??&squot; assignment (see  2. below, ?? != 0)&n;    when loading a module.&n;    ************************************************************************&n;&n;    Essentially, the I/O address and IRQ information  are ignored and filled&n;    in later by  the PCI BIOS   during the PCI  probe.  Note  that the board&n;    should be in the system at boot time so that its I/O address and IRQ are&n;    allocated by the PCI BIOS automatically. &n;&n;    To utilise this ability, you have to do 8 things:&n;&n;    0) have a copy of the loadable modules code installed on your system.&n;    1) copy de4x5.c from the  /linux/drivers/net directory to your favourite&n;    temporary directory.&n;    2) edit the source code near line 3779 to reflect the I/O address you&squot;re&n;    using (only  if you want to manually  load the module),  or assign these&n;    when loading by:&n;&n;                   insmod de4x5.o io=0xghh         where g = bus number&n;&t;&t;                                        hh = device number   &n;&n;    3) compile  de4x5.c, but include -DMODULE in  the command line to ensure&n;    that the correct bits are compiled (see end of source code).&n;    4) if you are wanting to add a new  card, goto 5. Otherwise, recompile a&n;    kernel with the de4x5 configuration turned off and reboot.&n;    5) insmod de4x5.o [io=0xghh]&n;    6) run the net startup bits for your new eth?? interface(s) manually &n;    (usually /etc/rc.inet[12] at boot time). &n;    7) enjoy!&n;&n;    To unload a module, turn off the associated interface(s) &n;    &squot;ifconfig eth?? down&squot; then &squot;rmmod de4x5&squot;.&n;&n;    Automedia detection is included so that in  principal you can disconnect&n;    from, e.g.  TP, reconnect  to BNC  and  things will still work  (after a&n;    pause whilst the   driver figures out   where its media went).  My tests&n;    using ping showed that it appears to work....&n;&n;    By  default,  the driver will  now   autodetect any  DECchip based card.&n;    Should you have a need to restrict the driver to DIGITAL only cards, you&n;    can compile with a  DEC_ONLY define, or if  loading as a module, use the&n;    &squot;dec_only=1&squot;  parameter. However, this  &quot;feature&quot; is in no way supported&n;    nor  tested in this  driver  and the user  may use  it  at his/her  sole&n;    discretion.   I have had  2 conflicting reports that  my  driver will or&n;    won&squot;t work  with Znyx.   Try  Donald Becker&squot;s &squot;tulip.c&squot; if   this driver&n;    doesn&squot;t work for you. I will not be supporting Znyx  and SMC cards since&n;    I have  no information on  them and  can&squot;t test  them in  a system (this&n;    applies most particularly to the DC21140 based cards).&n;&n;    I&squot;ve changed the timing routines to  use the kernel timer and scheduling&n;    functions  so that the  hangs  and other assorted  problems that occured&n;    while autosensing the  media  should be gone.  A  bonus  for the DC21040&n;    auto  media sense algorithm is  that it can now  use one that is more in&n;    line with the  rest (the DC21040  chip doesn&squot;t  have a hardware  timer).&n;    The downside is the 1 &squot;jiffies&squot; (10ms) resolution.&n;&n;    IEEE 802.3u MII interface code has  been added in anticipation that some&n;    products may use it in the future.&n;&n;    The SMC9332 card  has a non-compliant SROM  which needs fixing -  I have&n;    patched this  driver to detect it  because the SROM format used complies&n;    to a previous DEC-STD format.&n;&n;    TO DO:&n;    ------&n;&n;&n;    Revision History&n;    ----------------&n;&n;    Version   Date        Description&n;  &n;      0.1     17-Nov-94   Initial writing. ALPHA code release.&n;      0.2     13-Jan-95   Added PCI support for DE435&squot;s.&n;      0.21    19-Jan-95   Added auto media detection.&n;      0.22    10-Feb-95   Fix interrupt handler call &lt;chris@cosy.sbg.ac.at&gt;.&n;                          Fix recognition bug reported by &lt;bkm@star.rl.ac.uk&gt;.&n;&t;&t;&t;  Add request/release_region code.&n;&t;&t;&t;  Add loadable modules support for PCI.&n;&t;&t;&t;  Clean up loadable modules support.&n;      0.23    28-Feb-95   Added DC21041 and DC21140 support. &n;                          Fix missed frame counter value and initialisation.&n;&t;&t;&t;  Fixed EISA probe.&n;      0.24    11-Apr-95   Change delay routine to use &lt;linux/udelay&gt;.&n;                          Change TX_BUFFS_AVAIL macro.&n;&t;&t;&t;  Change media autodetection to allow manual setting.&n;&t;&t;&t;  Completed DE500 (DC21140) support.&n;      0.241   18-Apr-95   Interim release without DE500 Autosense Algorithm.&n;      0.242   10-May-95   Minor changes.&n;      0.30    12-Jun-95   Timer fix for DC21140.&n;                          Portability changes.&n;&t;&t;&t;  Add ALPHA changes from &lt;jestabro@ant.tay1.dec.com&gt;.&n;&t;&t;&t;  Add DE500 semi automatic autosense.&n;&t;&t;&t;  Add Link Fail interrupt TP failure detection.&n;&t;&t;&t;  Add timer based link change detection.&n;&t;&t;&t;  Plugged a memory leak in de4x5_queue_pkt().&n;      0.31    13-Jun-95   Fixed PCI stuff for 1.3.1.&n;      0.32    26-Jun-95   Added verify_area() calls in de4x5_ioctl() from a&n;                          suggestion by &lt;heiko@colossus.escape.de&gt;.&n;      0.33     8-Aug-95   Add shared interrupt support (not released yet).&n;      0.331   21-Aug-95   Fix de4x5_open() with fast CPUs.&n;                          Fix de4x5_interrupt().&n;                          Fix dc21140_autoconf() mess.&n;&t;&t;&t;  No shared interrupt support.&n;      0.332   11-Sep-95   Added MII management interface routines.&n;      0.40     5-Mar-96   Fix setup frame timeout &lt;maartenb@hpkuipc.cern.ch&gt;.&n;                          Add kernel timer code (h/w is too flaky).&n;&t;&t;&t;  Add MII based PHY autosense.&n;&t;&t;&t;  Add new multicasting code.&n;&t;&t;&t;  Add new autosense algorithms for media/mode &n;&t;&t;&t;  selection using kernel scheduling/timing.&n;&t;&t;&t;  Re-formatted.&n;&t;&t;&t;  Made changes suggested by &lt;jeff@router.patch.net&gt;:&n;&t;&t;&t;    Change driver to detect all DECchip based cards&n;&t;&t;&t;    with DEC_ONLY restriction a special case.&n;&t;&t;&t;    Changed driver to autprobe as a module. No irq&n;&t;&t;&t;    checking is done now - assume BIOS is good!&n;&t;&t;&t;  Added SMC9332 detection &lt;manabe@Roy.dsl.tutics.ac.jp&gt;&n;&n;    =========================================================================&n;*/
...
id|version
op_assign
l_string|&quot;de4x5.c:v0.40 96/3/5 davies@wanton.lkg.dec.com&bslash;n&quot;
suffix:semicolon
...
(brace
multiline_comment|/* MII interface? */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;%s: MII search failed, no device found when one was expected&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Search the MII anyway! */
)brace
...
suffix:semicolon
multiline_comment|/*&n;&t;** Allocate contiguous receive buffers, long word aligned. &n;&t;*/
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Initialise the adapter state */
id|lp-&gt;state
op_assign
id|CLOSED
suffix:semicolon
...
id|OMR_PR
suffix:semicolon
multiline_comment|/* Turn of promiscuous mode */
r_if
c_cond
(paren
id|lp-&gt;chipset
...
suffix:semicolon
multiline_comment|/* Queue the buffer locally */
r_return
l_int|0
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;%s: transmit busy, lost media or stale skb found:&bslash;n  STS:%08x&bslash;n  tbusy:%ld&bslash;n  lostMedia:%d&bslash;n  IMR:%08x&bslash;n  OMR:%08x&bslash;n Stale skb: %s&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|inl
...
suffix:semicolon
multiline_comment|/*&n;&t;    ** If no more device structures and can&squot;t use the current one, &n;&t;    ** malloc one up. If memory could not be allocated, print an error&n;&t;    **message.&n;&t;    */
r_if
c_cond
(paren
(paren
...
r_else
(brace
multiline_comment|/*&n;&t;&t;    ** If the memory was allocated, point to the new memory&n;&t;&t;    ** area and initialize it (name, I/O address, next device&n;&t;&t;    ** (NULL) and initialisation probe routine).&n;&t;&t;    */
id|tmp-&gt;name
op_assign
(paren
r_char
...
suffix:semicolon
multiline_comment|/* Hard RESET the PHY dev. */
id|udelay
c_func
(paren
l_int|1000
...
suffix:semicolon
multiline_comment|/* Assert for 1ms */
id|outl
c_func
(paren
l_int|0x00
...
suffix:semicolon
multiline_comment|/* Wait for 2ms */
id|mii_wr
c_func
(paren
id|MII_CR_RST
...
multiline_comment|/*&n;** Create a loopback ethernet packet with an invalid CRC&n;*/
...
multiline_comment|/*&n;** Set up the Ethernet PROM counter to the start of the Ethernet address on&n;** the DC21040, else  read the SROM for the other chips.&n;*/
...
(brace
multiline_comment|/* Assume SMC9332 for now */
id|dev-&gt;dev_addr
(braket
id|i
)braket
...
multiline_comment|/*&n;static void srom_busy(u_int command, u_long addr)&n;{&n;   sendto_srom((command &amp; 0x0000ff00) | DT_CS, addr);&n;   &n;   while (!((getfrom_srom(addr) &gt;&gt; 3) &amp; 0x01)) {&n;       de4x5_ms_delay(1);&n;   }&n;   &n;   sendto_srom(command &amp; 0x0000ff00, addr);&n;   &n;   return;&n;}&n;*/
...
multiline_comment|/*&n;** Here&squot;s 3 ways to calculate the OUI from the ID registers. One&squot;s a brain&n;** dead approach, 2 aren&squot;t (clue: mine isn&squot;t!).&n;*/
...
id|id
suffix:semicolon
multiline_comment|/* Issue a hard PHY reset - Broadcom is screwed up otherwise */
id|outl
c_func
(paren
id|GEP_HRST
...
DECL|function|de4x5_switch_to_mii
r_static
r_int
id|de4x5_switch_to_mii
c_func
...
id|RESET_DE4X5
suffix:semicolon
multiline_comment|/* Restore the GEP */
r_if
c_cond
(paren
id|lp-&gt;chipset
...
DECL|function|de4x5_switch_to_srl
r_static
r_int
id|de4x5_switch_to_srl
c_func
...
id|omr
suffix:semicolon
multiline_comment|/* Deassert the OMR_PS bit in CSR6 */
id|omr
op_assign
(paren
id|inl
...
c_func
(paren
l_string|&quot;&bslash;nMII CR:  %x&bslash;n&quot;
comma
id|mii_rd
c_func
(paren
...
ques
c_cond
l_string|&quot;link down or incompatible connection.&quot;
suffix:colon
(paren
id|lp-&gt;media
op_eq
...
macro_line|#ifdef MODULE
multiline_comment|/*&n;** Note now that module autoprobing is allowed under EISA and PCI. The&n;** IRQ lines will not be auto-detected; instead I&squot;ll rely on the BIOSes&n;** to &quot;do the right thing&quot;.&n;**&n;** NB: Current register_netdevice() code does not permit assigning io=0 as&n;** this driver will autoprobe all instances of acceptable DECchips. The&n;** cleanup_module() code needs work still....(just to unload modules owned&n;** by this driver).&n;*/
...
id|io
suffix:semicolon
multiline_comment|/* Now autoprobe the module */
id|thisDE4X5.irq
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Is an interface up?       */
)brace
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;de4x5: Cannot unload modules - %d interface%s%s still active.&bslash;n&quot;
comma
id|keep_loaded
comma
(paren
...
(brace
multiline_comment|/* MAC buffers allocated?    */
id|kfree
c_func
(paren
id|lp-&gt;cache.buf
...
suffix:semicolon
multiline_comment|/* Free the MAC buffers      */
)brace
id|release_region
c_func
(paren
...
(brace
multiline_comment|/* Are MAC buffers allocated */
id|kfree
c_func
(paren
id|lp-&gt;cache.buf
...
macro_line|#endif /* MODULE */
"&f;"
multiline_comment|/*&n; * Local variables:&n; *  compile-command: &quot;gcc -D__KERNEL__ -I/usr/src/linux/net/inet -Wall -Wstrict-prototypes -O2 -m486 -c de4x5.c&quot;&n; *&n; *  compile-command: &quot;gcc -D__KERNEL__ -DMODULE -I/usr/src/linux/net/inet -Wall -Wstrict-prototypes -O2 -m486 -c de4x5.c&quot;&n; * End:&n; */
eof
