...
id|version
op_assign
l_string|&quot;de4x5.c:V0.5 97/1/30 davies@maniac.ultranet.com&bslash;n&quot;
suffix:semicolon
...
c_func
(paren
l_string|&quot;de4x5: Detected a %s chip. Currently this is unsupported in this driver.&bslash;nPlease email the author to request its inclusion!&bslash;n&quot;
comma
(paren
id|is_DC21142
ques
...
l_int|0
suffix:semicolon
multiline_comment|/*&t;lp-&gt;timeout = -1;*/
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;** This mapping keeps the original media codes and FDX flag unchanged.&n;** While it isn&squot;t strictly necessary, it helps me for the moment...&n;*/
r_static
r_void
...
multiline_comment|/*&n;** General PHY reset function.&n;*/
r_static
r_int
...
(brace
multiline_comment|/* MII device specific reset */
id|srom_exec
c_func
(paren
id|dev
...
c_func
(paren
l_string|&quot;dc21142_infoleaf()&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|DE4X5_AUTOSENSE_MS
...
c_func
(paren
l_string|&quot;dc21143_infoleaf()&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|DE4X5_AUTOSENSE_MS
