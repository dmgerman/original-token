...
id|version
op_assign
l_string|&quot;de4x5.c:v0.42 96/4/26 davies@wanton.lkg.dec.com&bslash;n&quot;
suffix:semicolon
...
macro_line|#if !defined(__alpha__) &amp;&amp; !defined(DE4X5_DO_MEMCPY)
r_for
c_loop
(paren
id|i
