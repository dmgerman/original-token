...
id|version
op_assign
l_string|&quot;de4x5.c:V0.541 1998/8/24 davies@maniac.ultranet.com&bslash;n&quot;
suffix:semicolon
...
id|MAX_EISA_SLOTS
suffix:semicolon
multiline_comment|/* Only PCI probes */
macro_line|#endif
...
multiline_comment|/* If the address starts with 00 a0, we have to bit-reverse&n;       each byte of the address. */
r_if
c_cond
(paren
id|dev-&gt;dev_addr
