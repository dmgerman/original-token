...
id|version
op_assign
l_string|&quot;de4x5.c:V0.52 1997/4/26 davies@maniac.ultranet.com&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define cpu_to_le16(a) ((((a) &amp; 0x00ffU) &lt;&lt; 8) | (((a) &amp; 0xff00U) &gt;&gt; 8))
DECL|macro|cpu_to_le32
mdefine_line|#define cpu_to_le32(a) ((((a) &amp; 0x000000ffU) &lt;&lt; 24) |&bslash;&n;&t;&t;        (((a) &amp; 0x0000ff00U) &lt;&lt;  8) |&bslash;&n;&t;&t;        (((a) &amp; 0x00ff0000U) &gt;&gt;  8) |&bslash;&n;&t;&t;        (((a) &amp; 0xff000000U) &gt;&gt; 24))
macro_line|#else
DECL|macro|cpu_to_le16
...
id|DE4X5_MCA_EN
suffix:colon
multiline_comment|/* Enable pass all multicast addresses*/
r_if
c_cond
(paren
id|suser
