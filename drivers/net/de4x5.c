...
id|version
op_assign
l_string|&quot;de4x5.c:v0.451 96/12/28 davies@maniac.ultranet.com&bslash;n&quot;
suffix:semicolon
...
macro_line|#ifdef MODULE
multiline_comment|/*&n;** Note now that module autoprobing is allowed under EISA and PCI. The&n;** IRQ lines will not be auto-detected; instead I&squot;ll rely on the BIOSes&n;** to &quot;do the right thing&quot;.&n;**&n;** The module autoprobe will only load one instance of the driver and&n;** hardware.&n;*/
