...
id|version
op_assign
l_string|&quot;de4x5.c:T0.531 1997/12/21 davies@maniac.ultranet.com&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n;** Allow per adapter set up. For modules this is simply a command line&n;** parameter, e.g.: &n;** insmod de4x5 args=&squot;eth1:fdx autosense=BNC eth0:autosense=100Mb&squot;.&n;**&n;** For a compiled in driver, place e.g.&n;** DE4X5_OPTS = -DDE4X5_PARM=&squot;&quot;eth0:fdx autosense=AUI eth2:autosense=TP&quot;&squot; &n;** in linux/drivers/net/CONFIG&n;*/
...
c_func
(paren
l_string|&quot;%s: Found MII device not currently supported. Please mail the following dump to&bslash;nthe author:&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
