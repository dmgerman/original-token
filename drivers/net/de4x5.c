...
id|version
op_assign
l_string|&quot;de4x5.c:v0.241 4/18/95 davies@wanton.lkg.dec.com&bslash;n&quot;
suffix:semicolon
...
multiline_comment|/*#define DESC_ALIGN    u_long dummy[4]; / * Must agree with DESC_SKIP_LEN */
...
mdefine_line|#define ENABLE_IRQs { &bslash;&n;    imr |= irq_en;&bslash;&n;    outl(imr, DE4X5_IMR);                   /* Enable the IRQs */&bslash;&n;}
DECL|macro|DISABLE_IRQs
mdefine_line|#define DISABLE_IRQs {&bslash;&n;    imr = inl(DE4X5_IMR);&bslash;&n;    imr &amp;= ~irq_en;&bslash;&n;    outl(imr, DE4X5_IMR);                   /* Disable the IRQs */&bslash;&n;}
DECL|macro|UNMASK_IRQs
mdefine_line|#define UNMASK_IRQs {&bslash;&n;    imr |= irq_mask;&bslash;&n;    outl(imr, DE4X5_IMR);                   /* Unmask the IRQs */&bslash;&n;}
DECL|macro|MASK_IRQs
mdefine_line|#define MASK_IRQs {&bslash;&n;    imr = inl(DE4X5_IMR);&bslash;&n;    imr &amp;= ~irq_mask;&bslash;&n;    outl(imr, DE4X5_IMR);                   /* Mask the IRQs */&bslash;&n;}
...
multiline_comment|/*#define TX_BUFFS_AVAIL ((lp-&gt;tx_ring[lp-&gt;tx_new].status)&gt;=0 ? 1 : 0)*/
...
suffix:semicolon
multiline_comment|/*static void    srom_busy(u_long command, u_short address);*/
r_static
r_void
id|sendto_srom
c_func
...
mdefine_line|#define RESET_DE4X5 {&bslash;&n;    long i;&bslash;&n;    i=inl(DE4X5_BMR);&bslash;&n;    outl(i | BMR_SWR, DE4X5_BMR);&bslash;&n;    outl(i, DE4X5_BMR);&bslash;&n;    for (i=0;i&lt;5;i++) inl(DE4X5_BMR);&bslash;&n;}
"&f;"
...
c_func
(paren
l_string|&quot;%s: Fatal bus error occurred, sts=0x%08lx, device stopped.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|sts
...
(brace
multiline_comment|/* Force 10Mb/s (_100Mb for 100Mb/s) */
id|lp-&gt;media
op_assign
(paren
id|lp-&gt;autosense
...
c_func
(paren
l_string|&quot;%s: Mode is forced to %s&bslash;n&quot;
comma
id|dev-&gt;name
comma
(paren
...
multiline_comment|/*&n;static void srom_busy(u_long command, u_short addr)&n;{&n;  sendto_srom((command &amp; 0x0000ff00) | DT_CS, addr);&n;&n;  while (!((getfrom_srom(addr) &gt;&gt; 3) &amp; 0x01)) {&n;    dce_ms_delay(1);&n;  }&n;&n;  sendto_srom(command &amp; 0x0000ff00, addr);&n;&n;  return;&n;}&n;*/
