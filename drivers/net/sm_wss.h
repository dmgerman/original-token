...
c_func
(paren
l_string|&quot;sm: wss: %cx fmt: 0x%02x ifc: 0x%02x&bslash;n&quot;
comma
l_string|&quot;rt&quot;
(braket
id|send
...
(paren
id|KERN_DEBUG
l_string|&quot;sm wss: modtx %u modrx %u srt %u buflen %u&bslash;n&quot;
comma
id|sm-&gt;mode_tx-&gt;dmabuflenmodulo
comma
id|sm-&gt;mode_rx-&gt;dmabuflenmodulo
...
macro_line|#undef NEXT_HW_INFO
DECL|macro|NEXT_HW_INFO
mdefine_line|#define NEXT_HW_INFO (&amp;hw_wss)
multiline_comment|/* --------------------------------------------------------------------- */
...
(paren
id|KERN_DEBUG
l_string|&quot;sm wssfdx: modtx %u modrx %u srt %u buflen %u&bslash;n&quot;
comma
id|sm-&gt;mode_tx-&gt;dmabuflenmodulo
comma
id|sm-&gt;mode_rx-&gt;dmabuflenmodulo
...
macro_line|#undef NEXT_HW_INFO
DECL|macro|NEXT_HW_INFO
mdefine_line|#define NEXT_HW_INFO (&amp;hw_wssfdx)
multiline_comment|/* --------------------------------------------------------------------- */
DECL|macro|SCSTATE
