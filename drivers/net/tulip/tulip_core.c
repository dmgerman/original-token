...
op_assign
l_string|&quot;Linux Tulip driver version 0.9.4 (Feb 28, 2000)&bslash;n&quot;
suffix:semicolon
...
l_int|0xE000
suffix:semicolon
macro_line|#elif defined(__i386__) || defined(__powerpc__) || defined(__sparc__)
DECL|variable|csr0
r_static
r_int
id|csr0
...
comma
(brace
l_string|&quot;Xircom tulip work-alike&quot;
comma
l_int|128
comma
l_int|0x0801fbff
...
(paren
id|KERN_INFO
l_string|&quot;tulip.c: tulip_outl_CSR6 too many attempts,&quot;
