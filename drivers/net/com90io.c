...
id|version
op_assign
l_string|&quot;com90io.c: v3.00 97/11/09 Avery Pennarun &lt;apenwarr@worldvisions.ca&gt; et al.&bslash;n&quot;
suffix:semicolon
...
id|D_NORMAL
comma
l_string|&quot;ARCnet COM90xx in IO-mapped mode:  &quot;
l_string|&quot;station %02Xh found at %03lXh, IRQ %d.&bslash;n&quot;
comma
id|lp-&gt;stationid
comma
id|dev-&gt;base_addr
...
DECL|function|arc90io_openclose
r_static
r_void
id|arc90io_openclose
c_func
...
r_static
r_void
DECL|function|arc90io_inthandler
id|arc90io_inthandler
c_func
(paren
r_struct
...
id|D_DURING
comma
l_string|&quot;in arc90io_inthandler (status=%Xh, intmask=%Xh)&bslash;n&quot;
comma
id|ARCSTATUS
comma
id|lp-&gt;intmask
...
id|D_NORMAL
comma
l_string|&quot;Network reconfiguration detected&quot;
l_string|&quot; (status=%Xh, config=%X)&bslash;n&quot;
comma
id|status
comma
id|lp-&gt;config
...
r_static
r_void
DECL|function|arc90io_prepare_tx
id|arc90io_prepare_tx
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;com90xx IO-MAP: Too many ARCnet devices registered (max %d).&bslash;n&quot;
comma
id|MAX_ARCNET_DEVS
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;com90xx IO-MAP: You must give an IO address.&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
c_func
(paren
l_string|&quot;com90xx IO-MAP: Too many arguments.&bslash;n&quot;
)paren
suffix:semicolon
r_case
l_int|2
