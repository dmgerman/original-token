multiline_comment|/* $Id: sgiseeq.c,v 1.1 1997/06/09 08:34:30 ralf Exp $&n; * sgiseeq.c: Seeq8003 ethernet driver for SGI machines.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; */
...
multiline_comment|/* If the HPC aint doin nothin, and there are more packets&n;&t;&t; * with ETXD cleared and XIU set we must make very certain&n;&t;&t; * that we restart the HPC else we risk locking up the&n;&t;&t; * adapter.  The following read of tx_ndptr is only safe&n;&t;&t; * iff the HPCDMA is not active!&n;&t;&t; */
id|td
op_assign
(paren
r_struct
...
multiline_comment|/* Is the skippy buf even reasonable? */
r_if
c_cond
(paren
id|skb
...
c_func
(paren
l_string|&quot;%s: skb len is %ld&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|skb-&gt;len
