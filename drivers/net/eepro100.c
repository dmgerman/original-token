...
id|version
op_assign
l_string|&quot;eepro100.c:v1.09j+LK1.0 Feb 13, 2000  Linux Kernel Team  http://cesdis.gsfc.nasa.gov/linux/drivers/eepro100.html&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
DECL|macro|EEPRO100_MODULE_NAME
mdefine_line|#define EEPRO100_MODULE_NAME &quot;eepro100&quot;
DECL|macro|PFX
...
id|KERN_ERR
id|PFX
l_string|&quot;cannot reserve I/O ports&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_none
...
id|KERN_ERR
id|PFX
l_string|&quot;Could not allocate ethernet device.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_free_tx_ring
suffix:semicolon
)brace
r_if
c_cond
...
id|KERN_ERR
id|PFX
l_string|&quot;Could not allocate ethernet device private info.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
...
id|KERN_ERR
id|PFX
l_string|&quot;Could not enable PCI device&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|err_out_free_netdev
