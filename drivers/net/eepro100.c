...
DECL|macro|virt_to_le32bus
mdefine_line|#define virt_to_le32bus(addr)  cpu_to_le32(virt_to_bus(addr))
DECL|macro|le32bus_to_virt
mdefine_line|#define le32bus_to_virt(addr)  bus_to_virt(le32_to_cpu(addr))
...
(paren
id|KERN_INFO
l_string|&quot;Failed to map PCI address %#x.&bslash;n&quot;
comma
id|pciaddr
)paren
suffix:semicolon
...
suffix:semicolon
macro_line|#if !defined(final_version) &amp;&amp; !defined(__powerpc__)
r_if
c_cond
(paren
id|bus_to_virt
