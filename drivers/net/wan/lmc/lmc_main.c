...
suffix:semicolon
multiline_comment|/*&n;         * SPARC PCI Bios doesn&squot;t set the BUS Master bit, unlike intel&n;         * Without it we won&squot;t do much packet work&n;         * Do this to everyone&n;         */
id|pci_read_config_word
c_func
(paren
id|pci_find_slot
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Align the io address on the 32 bit boundry just in case */
id|pci_ioaddr
op_and_assign
op_complement
l_int|3
