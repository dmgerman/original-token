...
l_int|NULL
suffix:semicolon
DECL|variable|comx_normal_inode_ops
r_struct
id|inode_operations
...
suffix:semicolon
singleline_comment|// for mkdir
DECL|variable|comx_debug_inode_ops
r_static
r_struct
id|inode_operations
id|comx_debug_inode_ops
suffix:semicolon
singleline_comment|// mas a file_ops
DECL|variable|comx_normal_file_ops
r_static
r_struct
id|file_operations
id|comx_normal_file_ops
suffix:semicolon
singleline_comment|// with open/relase
DECL|variable|comx_debug_file_ops
r_static
r_struct
id|file_operations
id|comx_debug_file_ops
suffix:semicolon
singleline_comment|// with lseek+read
r_static
r_void
...
DECL|function|comx_debug_lseek
r_static
id|loff_t
id|comx_debug_lseek
c_func
...
DECL|function|comx_file_release
r_static
r_int
id|comx_file_release
c_func
(paren
r_struct
id|inode
...
suffix:semicolon
singleline_comment|// We may run into trouble when debug_area is filled
singleline_comment|// from irq inside read. no problem if the buffer is
singleline_comment|// large enough
r_while
c_loop
(paren
id|count
...
suffix:semicolon
singleline_comment|// ez egy normalis /proc konyvtar
id|new_dir-&gt;nlink
op_assign
l_int|2
suffix:semicolon
...
id|ret
suffix:semicolon
multiline_comment|/* Egyelore miert ne ? */
r_if
c_cond
(paren
id|dir-&gt;i_ino
...
suffix:semicolon
singleline_comment|//&t;proc_unregister(&amp;comx_root_dir, dentry-&gt;d_inode-&gt;i_ino);
id|MOD_DEC_USE_COUNT
suffix:semicolon
r_return
l_int|0
...
suffix:semicolon
id|comx_root_inode_ops.lookup
op_assign
op_amp
id|comx_lookup
suffix:semicolon
id|comx_root_inode_ops.mkdir
op_assign
op_amp
id|comx_mkdir
suffix:semicolon
id|comx_root_inode_ops.rmdir
op_assign
op_amp
id|comx_rmdir
suffix:semicolon
...
suffix:semicolon
id|comx_normal_inode_ops.default_file_ops
op_assign
op_amp
id|comx_normal_file_ops
suffix:semicolon
id|comx_normal_inode_ops.lookup
op_assign
op_amp
id|comx_lookup
suffix:semicolon
...
suffix:semicolon
id|comx_debug_inode_ops.default_file_ops
op_assign
op_amp
id|comx_debug_file_ops
suffix:semicolon
...
id|comx_normal_file_ops
comma
id|proc_net_inode_operations.default_file_ops
comma
r_sizeof
(paren
r_struct
...
suffix:semicolon
id|comx_normal_file_ops.open
op_assign
op_amp
id|comx_file_open
suffix:semicolon
id|comx_normal_file_ops.release
op_assign
op_amp
id|comx_file_release
suffix:semicolon
...
suffix:semicolon
id|comx_debug_file_ops.llseek
op_assign
op_amp
id|comx_debug_lseek
suffix:semicolon
id|comx_debug_file_ops.read
op_assign
op_amp
id|comx_debug_read
suffix:semicolon
