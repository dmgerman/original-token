...
id|version
op_assign
l_string|&quot;sunhme.c:v1.1 10/Oct/96 David S. Miller (davem@caipfs.rutgers.edu)&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Downgrade duplex if full. */
r_if
c_cond
(paren
id|hp-&gt;sw_bmcr
...
c_func
(paren
l_string|&quot;%s: Auto-Negotiation timeout, trying force link &quot;
l_string|&quot;mode BMCR=0x%04x.&bslash;n&quot;
comma
id|hp-&gt;dev-&gt;name
comma
id|hp-&gt;sw_bmcr
...
(brace
multiline_comment|/* Ooops, something bad happened, go to force&n;&t;&t;&t;&t;&t; * mode.&n;&t;&t;&t;&t;&t; */
r_goto
id|do_force_mode
suffix:semicolon
)brace
...
(brace
id|hp-&gt;enet_stats.rx_length_errors
op_increment
suffix:semicolon
)brace
r_if
...
(brace
id|hp-&gt;enet_stats.rx_over_errors
op_increment
suffix:semicolon
id|hp-&gt;enet_stats.rx_fifo_errors
op_increment
suffix:semicolon
)brace
