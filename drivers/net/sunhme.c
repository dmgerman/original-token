...
multiline_comment|/* XXX Convert these to direct function hookup once new&n; * XXX PCI dvma interfaces are propagated and in use everywhere.&n; */
DECL|function|pci_hme_dma_map
r_static
id|u32
id|pci_hme_dma_map
c_func
...
DECL|function|pci_hme_dma_unmap
r_static
r_void
id|pci_hme_dma_unmap
c_func
(paren
r_void
op_star
...
DECL|function|pci_hme_dma_sync
r_static
r_void
id|pci_hme_dma_sync
c_func
...
macro_line|#if 0 /* XXX Once new PCI interfaces are in place... XXX */
...
macro_line|#else
DECL|macro|hme_dma_map
mdefine_line|#define hme_dma_map(__hp, __ptr, __size) &bslash;&n;&t;(virt_to_bus(__ptr))
DECL|macro|hme_dma_unmap
mdefine_line|#define hme_dma_unmap(__hp, __addr, __size) &bslash;&n;&t;do { } while(0)
DECL|macro|hme_dma_sync
mdefine_line|#define hme_dma_sync(__hp, __addr, __size) &bslash;&n;&t;do { } while(0)
macro_line|#endif
macro_line|#endif
macro_line|#endif
...
suffix:semicolon
macro_line|#ifndef __sparc_v9__
multiline_comment|/*&n;&t; * P3: Dirty trick to get uncacheable memory as we have no dma_sync.&n;&t; */
id|hp-&gt;happy_block
op_assign
id|ioremap
c_func
