...
id|len
comma
l_string|&quot;SCSI channel expansion Module: %s installed&bslash;n&quot;
comma
(paren
id|bt-&gt;sx1
op_eq
...
id|len
comma
l_string|&quot;Cache Module: %sinstalled.&bslash;n&quot;
comma
(paren
id|cc-&gt;csh
)paren
...
id|len
comma
l_string|&quot;Timer Modification: %sinstalled&bslash;n&quot;
comma
(paren
id|cc-&gt;tmr
op_eq
...
id|len
comma
l_string|&quot;SmartROM: %senabled&bslash;n&quot;
comma
(paren
id|bt-&gt;srom
op_eq
...
id|len
comma
l_string|&quot;HBA indicates %salarm.&bslash;n&quot;
comma
(paren
id|bt-&gt;alrm
op_eq
...
l_string|&quot;&t; Reads:&t;      Min:(ms)     Max:(ms)     Ave:(ms)&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
id|len
comma
l_string|&quot;&t; Writes:      Min:(ms)     Max:(ms)     Ave:(ms)&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
