multiline_comment|/* &n; * NCR 5380 generic driver routines.  These should make it *trivial*&n; * &t;to implement 5380 SCSI drivers under Linux with a non-trantor&n; *&t;architecture.&n; *&n; * Copyright 1993, Drew Eckhardt&n; *&t;Visionary Computing &n; *&t;(Unix and Linux consulting and custom programming)&n; * &t;drew@colorado.edu&n; *&t;+1 (303) 440-4894&n; *&n; * DISTRIBUTION REALEASE 3. &n; *&n; * For more information, please consult &n; *&n; * NCR 5380 Family&n; * SCSI Protocol Controller&n; * Databook&n; *&n; * NCR Microelectronics&n; * 1635 Aeroplaza Drive&n; * Colorado Springs, CO 80916&n; * 1+ (719) 578-3400&n; * 1+ (800) 334-5454&n; */
multiline_comment|/*&n; * $Log: NCR5380.c,v $&n; */
multiline_comment|/*&n; * Furthur development / testing that should be done : &n; * 1.  Test USLEEP code &n; * 2.  Test SCSI-II tagged queueing (I have no devices which support &n; *&t;tagged queueing)&n; * 3.  Flesh out REAL_DMA code (my sample board doesn&squot;t support this)&n; *&t;Perhaps some of the 680x0 porting crew can help out here?&n; * 4.  Test linked command handling code after Eric is ready with &n; *      the high level code.&n; * 5.  Tie instance handling into Eric&squot;s multi-host patches&n; */
...
c_func
(paren
l_string|&quot;scsi : unknown interrupt&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
macro_line|#endif
...
macro_line|#if (defined(PSEUDO_DMA))
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* &n;&t;&t;     * Use the status and message bytes from the original &n;&t;&t;     * command.&n;&t;&t;     */
r_if
c_cond
(paren
id|cmd-&gt;cmnd
