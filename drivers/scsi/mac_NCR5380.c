...
multiline_comment|/* &n; * Michael: To port Romans driver to the Macintosh, I&squot;ve left most of the code &n; * unchanged, in order to make later implemantation of REAL_DMA easier. &n; *&n; * Alan: In order to make it easier to read and as the 5380 based Mac&squot;s never&n; *&t;  have DMA I took the real DMA out of mac_scsi.c but not this file.&n; *&n; *&t;With luck we can merge this back with the ST folks in time.&n; *&n; * Changes:&n; * &n; * - all Falcon-specific stuff (ST-DMA locking) was removed&n; *&n; * &n; */
...
suffix:semicolon
r_else
macro_line|#ifndef EMULATE_PSEUDO_DMA
id|NCR5380_write
c_func
(paren
id|MODE_REG
...
macro_line|#ifdef REAL_DMA
multiline_comment|/* On the Medusa, it is a must to initialize the DMA before&n;     * starting the NCR. This is also the cleaner way for the TT.&n;     */
id|save_flags
c_func
(paren
id|flags
...
l_int|0
suffix:semicolon
macro_line|#else /* defined(PSEUDO_DMA) */
r_if
c_cond
(paren
id|p
...
multiline_comment|/* Michael: When using pseudo-DMA emulation, we must &n;&t;&t;&t; * take care to take into account the residual from &n;&t;&t;&t; * the current transfer as determined by either the &n;&t;&t;&t; * interrupt routine ot the pseudo-transfer functions&n;&t;&t;&t; * (whichever notices it first).&n;&t;&t;&t; */
r_if
c_cond
(paren
