...
DECL|macro|VERSION
mdefine_line|#define VERSION          &quot;$Revision: 5.22 $&quot;
...
l_int|0
suffix:semicolon
multiline_comment|/* Quantum ISA-200S */
...
id|flag
suffix:semicolon
multiline_comment|/* 1 == PCI_bus, 2 == ISA_200S */
...
(brace
multiline_comment|/* The Quantum board is slightly different. */
id|port_base
op_assign
op_star
(paren
