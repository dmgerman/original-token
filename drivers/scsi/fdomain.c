...
DECL|macro|VERSION
mdefine_line|#define VERSION          &quot;$Revision: 5.20 $&quot;
...
l_int|0
suffix:semicolon
multiline_comment|/* Get the IRQ from the options. */
id|interrupt_level
op_assign
id|ints
(braket
...
multiline_comment|/* This is a bad sign.  It usually means that someone patched the&n;&t; BIOS signature list (the signatures variable) to contain a BIOS&n;&t; signature for a board *OTHER THAN* the TMC-1660/TMC-1680.  It&n;&t; also means that we don&squot;t have a Version 2.0 BIOS :-)&n;       */
macro_line|#if DEBUG_DETECT
r_if
c_cond
(paren
...
r_else
(brace
multiline_comment|/* The proper way of doing this is to use ask the PCI bus for the&n;            device IRQ and interrupt level.&n;&n;&t;    Until the Linux kernel supports this sort of PCI bus query, we&n;&t;    scan down a bunch of addresses (Future Domain tech support says&n;&t;    we will probably find the address before we get to 0xf800).&n;&t;    This works fine on some systems -- other systems may have to&n;&t;    scan more addresses.  If you have to modify this section for&n;&t;    your installation, please send mail to faith@cs.unc.edu. */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;Future Domain: LOOPBACK TEST FAILED, FAILING DETECT!&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
c_func
(paren
l_string|&quot;Future Domain: Driver requires interruptions&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
c_func
(paren
l_string|&quot;Future Domain: current_SC-&gt;scsi_done() == NULL&quot;
)paren
suffix:semicolon
)brace
r_else
...
c_func
(paren
l_string|&quot;Future Domain: my_done() called outside of command&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#if DEBUG_RACE
...
c_func
(paren
l_string|&quot;Future Domain: target = %d, command = %x, &quot;
...
c_func
(paren
l_string|&quot;Future Domain: Message = %x&bslash;n&quot;
comma
id|current_SC-&gt;SCp.Message
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Future Domain: REQUEST SENSE &quot;
...
c_func
(paren
l_string|&quot;Future Domain: fdomain_16x0_queue() NOT REENTRANT!&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#if EVERY_ACCESS
