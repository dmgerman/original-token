multiline_comment|/* imm.c   --  low level driver for the IOMEGA MatchMaker&n; * parallel port SCSI host adapter.&n; * &n; * (The IMM is the embedded controller in the ZIP Plus drive.)&n; * &n; * Current Maintainer: David Campbell (Perth, Western Australia)&n; *                     campbell@gear.torque.net&n; *                     dcampbel@p01.as17.honeywell.com.au&n; *&n; * My unoffical company acronym list is 21 pages long:&n; *      FLA:    Four letter acronym with built in facility for&n; *              future expansion to five letters.&n; */
...
multiline_comment|/*&n; * Command line parameters (for built-in driver):&n; *&n; * Syntax:  imm=base[,mode[,use_sg]]&n; *&n; * For example:  imm=0x378   or   imm=0x378,0,3&n; *&n; */
DECL|function|imm_setup
r_void
id|imm_setup
c_func
(paren
...
(brace
multiline_comment|/* Disable ALL known ports */
r_int
id|i
suffix:semicolon
r_for
...
c_func
(paren
l_string|&quot;IMM: I only use between 2 to 3 parameters.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/* Claim the bus so it remembers what we do to the control&n;         * registers. [ CTR and ECP ]&n;         */
r_if
c_cond
(paren
id|imm_pb_claim
...
id|dev-&gt;port-&gt;modes
suffix:semicolon
multiline_comment|/* Mode detection works up the chain of speed&n;         * This avoids a nasty if-then-else-if-... tree&n;         */
id|imm_hosts
(braket
id|i
)braket
...
suffix:semicolon
multiline_comment|/* aimmrently a sane mode */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;imm bus reset called for invalid command.&bslash;n&quot;
)paren
suffix:semicolon
r_return
...
suffix:semicolon
multiline_comment|/* Since the command was already on the timer queue imm_interrupt&n;     * will be called shortly.&n;     */
r_return
