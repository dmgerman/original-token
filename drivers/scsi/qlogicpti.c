...
id|buf
comma
l_string|&quot;PTI Qlogic,ISP SBUS SCSI irq %d regs at %08lx&quot;
comma
id|host-&gt;irq
comma
(paren
...
id|again
suffix:semicolon
multiline_comment|/* It is ok to take irq&squot;s on one qpti while the other&n;&t; * is amidst the processing of a reset.&n;&t; */
id|running
op_increment
suffix:semicolon
macro_line|#if 0 /* XXX Investigate why resets cause this with one controller. */
r_if
c_cond
(paren
id|running
...
c_func
(paren
l_string|&quot;qlogicpti_intr_handler: yieee, recursive interrupt!&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
multiline_comment|/* Handle all ISP interrupts showing */
id|repeat
suffix:colon
id|again
op_assign
