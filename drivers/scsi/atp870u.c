...
id|find_host
suffix:colon
multiline_comment|/*      SCpnt-&gt;result = 0x00080000;&n;&t;SCpnt-&gt;scsi_done(SCpnt);&n;&t;dev-&gt;working=0;&n;&t;dev-&gt;quhdu=0;&n;&t;dev-&gt;quendu=0;&n;&t;return (SCSI_RESET_SUCCESS | SCSI_RESET_BUS_RESET);  */
r_return
(paren
...
id|buffer
comma
l_string|&quot;ACARD AEC-6710/6712 PCI Ultra/W SCSI-3 Adapter Driver V2.0+ac &quot;
)paren
suffix:semicolon
r_return
id|buffer
...
id|BLS
comma
l_string|&quot;ACARD AEC-671X Driver Version: 2.0+ac&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
