...
DECL|macro|PciDeviceFn
mdefine_line|#define PciDeviceFn(n)&t;&t;((d)&amp;0xff)
DECL|macro|__PciDev
...
macro_line|#if LINUX_VERSION_CODE &gt;= LinuxVersionCode(2,1,0)
DECL|macro|GetPages
mdefine_line|#define GetPages(order) __get_free_pages(GFP_ATOMIC | GFP_DMA_32BIT, order)
macro_line|#else
DECL|macro|GetPages
mdefine_line|#define GetPages(order) __get_free_pages(GFP_ATOMIC | GFP_DMA_32BIT, order, 0)
macro_line|#endif
...
multiline_comment|/*&n;&t;**&t;DEL 441 - 53C876 Rev 5 - Part Number 609-0392787/2788 - ITEM 2.&n;&t;**&t;Disable overlapped arbitration for all dual-function &n;&t;**&t;devices, regardless revision id.&n;&t;**&t;We may consider it is a post-chip-design feature. ;-)&n;&t;*/
r_if
c_cond
(paren
id|np-&gt;device_id
...
id|DPR
suffix:semicolon
multiline_comment|/*&n;&t;**&t;If 64 bit (895A/896/1010) write the CCNTL1 register to &n;&t;**&t;enable 40 bit address table indirect addressing for MOVE.&n;&t;**&t;Also write CCNTL0 if 64 bit chip, since this register seems &n;&t;**&t;to only be used by 64 bit cores.&n;&t;*/
r_if
c_cond
(paren
id|np-&gt;features
