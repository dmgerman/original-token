multiline_comment|/*&n; * sgiwd93.c: SGI WD93 scsi driver.&n; *&n; * Copyright (C) 1996 David S. Miller (dm@engr.sgi.com)&n; *&n; * (In all truth, Jed Schimmel wrote all this code.)&n; *&n; * $Id: sgiwd93.c,v 1.1 1998/05/01 01:35:42 ralf Exp $&n; */
...
suffix:semicolon
DECL|variable|proc_scsi_sgiwd93
r_struct
id|proc_dir_entry
