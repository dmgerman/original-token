...
multiline_comment|/* Set the following macro to 1 to reload the ISP2100&squot;s firmware.  This is&n;   version 1.13 of the firmware. */
...
DECL|macro|virt_to_bus_high32
mdefine_line|#define virt_to_bus_high32(x)  ((u32) (0xffffffff &amp; (virt_to_bus(x)&gt;&gt;32)))
DECL|macro|bus_to_virt_low32
...
c_func
(paren
l_string|&quot;wwn: %08x%08x  scsi_id: %x  loop_id: %x&bslash;n&quot;
comma
(paren
id|u_int
)paren
...
id|REQUEST_SENSE
suffix:colon
multiline_comment|/* scsi.c expects sense info in a different buffer */
id|cmd-&gt;dataseg
(braket
l_int|0
)braket
...
l_int|1
suffix:semicolon
id|control_block-&gt;max_frame_len
op_assign
id|isp2100_read_nvram_word
c_func
(paren
...
suffix:semicolon
id|control_block-&gt;exec_throttle
op_assign
id|isp2100_read_nvram_word
c_func
(paren
