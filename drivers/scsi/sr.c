...
c_func
(paren
l_string|&quot;sr_photocd: oops, CD-ROM reports an error.&bslash;n&quot;
)paren
suffix:semicolon
id|sector
op_assign
...
c_func
(paren
l_string|&quot;sr_photocd: multisession PhotoCD detected&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
suffix:semicolon
multiline_comment|/* first I do a set_density-call (for reading XA-sectors) ... */
id|SCpnt
op_assign
id|allocate_device
c_func
...
l_int|1
suffix:semicolon
multiline_comment|/* ... and then I ask, if there is a multisession-Disk */
id|SCpnt
op_assign
id|allocate_device
c_func
...
c_func
(paren
l_string|&quot;sr_photocd: multisession PhotoCD detected: %lu&bslash;n&quot;
comma
id|sector
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sr_photocd: there is no special photocd-code for this drive&bslash;n&quot;
)paren
suffix:semicolon
id|sector
op_assign
...
multiline_comment|/* this is for support of multisession-CD&squot;s */
r_if
c_cond
(paren
id|block
