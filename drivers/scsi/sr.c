...
id|CDC_SELECT_DISC
suffix:semicolon
multiline_comment|/*else    I don&squot;t think it can close its tray&n;&t;&t;scsi_CDs[i].cdi.mask |= CDC_CLOSE_TRAY; */
id|scsi_free
c_func
(paren
id|buffer
...
multiline_comment|/* use buffer for ISA DMA */
id|buflen
op_assign
(paren
id|cgc-&gt;buflen
...
c_func
(paren
l_string|&quot;sr: SCSI DMA pool exhausted.&quot;
)paren
suffix:semicolon
r_return
op_minus
...
l_int|NULL
suffix:semicolon
multiline_comment|/* write DMA buffer back if used */
r_if
c_cond
(paren
id|buffer
