...
(brace
multiline_comment|/*&n;&t;&t; * Umm, yeah, right.   Swapping to a cdrom.  Nice try.&n;&t;&t; */
r_return
l_int|0
suffix:semicolon
)brace
...
c_func
(paren
l_string|&quot;sr.c:Bad 1K block number requested (%d %ld)&quot;
comma
id|block
comma
id|SCpnt-&gt;request.nr_sectors
...
c_func
(paren
l_string|&quot;sr.c:Bad 2K block number requested (%d %ld)&quot;
comma
id|block
comma
id|SCpnt-&gt;request.nr_sectors
