...
multiline_comment|/*&n; * Here I tried to implement support for multisession-CD&squot;s&n; * &n; * Much of this has do be done with vendor-specific SCSI-commands, because&n; * multisession is newer than the SCSI-II standard.&n; * So I have to complete it step by step. Useful information is welcome.&n; *&n; * Actually works:&n; *   - NEC:     Detection and support of multisession CD&squot;s. Special handling&n; *              for XA-disks is not necessary.&n; *     &n; *   - TOSHIBA: setting density is done here now, mounting PhotoCD&squot;s should&n; *              work now without running the program &quot;set_density&quot;&n; *              Multisession CD&squot;s are supported too.&n; *&n; *   Gerd Knorr &lt;kraxel@cs.tu-berlin.de&gt; &n; */
multiline_comment|/*&n; * 19950704 operator@melchior.cuivre.fdn.fr (Thomas Quinot)&n; *&n; *   - SONY:&t;Same as Nec.&n; *&n; *   - PIONEER: works with SONY code (may be others too ?)&n; *&n; * 19961011&n; *&n; *   - HP:      reportedly working.&n; */
...
id|buf
suffix:semicolon
DECL|macro|CLEAR_CMD_BUFFER
mdefine_line|#define CLEAR_CMD_BUFFER memset (buf, 0, sizeof buf);
r_int
r_char
op_star
id|cmd
...
l_int|4
suffix:semicolon
multiline_comment|/* and receive 4 bytes */
id|cmd
(braket
l_int|0
)braket
...
l_int|12
suffix:semicolon
multiline_comment|/* and receive 12 bytes */
id|cmd
(braket
l_int|0
)braket
...
l_int|12
suffix:semicolon
multiline_comment|/* we send 12 bytes... */
id|sic-&gt;outlen
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* and receive nothing */
id|cmd
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/* spinup (avoid timeout) */
id|CLEAR_CMD_BUFFER
suffix:semicolon
id|sic-&gt;inlen
op_assign
...
(paren
id|KERN_DEBUG
l_string|&quot;sr_photocd: use HP code&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|CLEAR_CMD_BUFFER
...
(paren
id|KERN_WARNING
l_string|&quot;sr_photocd: ioctl error (HP-1): 0x%x&bslash;n&quot;
comma
id|rc
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;sr_photocd: (HP) No finished session&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;sr_photocd: ioctl error (HP-2): 0x%x&bslash;n&quot;
comma
id|rc
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* HP documentation states that Logical Start Address is&n;           returned as three (!) bytes, and that rec[8] is&n;           reserved. This is strange, because a LBA usually is&n;           4 bytes long. */
macro_line|#else
id|sector
op_assign
id|rec
