...
mdefine_line|#define AIC7XXX_C_VERSION  &quot;5.1.19&quot;
DECL|macro|NUMBER
...
macro_line|#if defined(__i386__) || defined(__alpha__)
macro_line|#ifdef CONFIG_PCI
multiline_comment|/*&n;   * PCI-bus chipset probe.&n;   */
macro_line|#if LINUX_VERSION_CODE &gt; KERNEL_VERSION(2,1,92)
r_if
c_cond
(paren
...
comma
id|PCI_DEVICE_ID_INTEL_82450GX
comma
l_int|NULL
)paren
)paren
...
macro_line|#else
mdefine_line|#define PCI_DEVICE_ID_INTEL_82451NX 0x84ca
r_if
c_cond
(paren
id|pcibios_present
