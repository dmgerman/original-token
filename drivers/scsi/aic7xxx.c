...
mdefine_line|#define AIC7XXX_C_VERSION  &quot;5.0.17&quot;
DECL|macro|NUMBER
...
suffix:semicolon
multiline_comment|/*&n;   * The next 64 (or 128 on 64 bit machines)....&n;   */
DECL|member|dev_negotiation_cmnd
id|Scsi_Cmnd
op_star
id|dev_negotiation_cmnd
(braket
id|MAX_TARGETS
)braket
suffix:semicolon
