...
(paren
id|KERN_WARNING
l_string|&quot;scsi%d: Target %d, channel %c, initiating &quot;
l_string|&quot;wide negotiation on a narrow bus - rejecting!&quot;
comma
id|p-&gt;host_no
comma
id|target
...
(brace
multiline_comment|/*&n;           * Since paging only occurs on aic78x0 chips, we can use&n;           * Auto Access Pause to clear the command count.&n;           */
id|outb
c_func
(paren
l_int|0
...
suffix:semicolon
multiline_comment|/*&n;   * Set FIFO depth and command out count.  These are only used when&n;   * paging is enabled and should not be touched for AIC-7770 based&n;   * adapters; FIFODEPTH and CMDOUTCNT overlay SCSICONF and SCSICONF+1&n;   * which are used to control termination.&n;   */
r_if
c_cond
(paren
id|p-&gt;flags
