...
mdefine_line|#define AIC7XXX_C_VERSION  &quot;5.1.17&quot;
DECL|macro|NUMBER
...
id|DEVICE_SCSI_3
suffix:semicolon
multiline_comment|/*&n;         * OK, we are a SCSI 3 device and we are in need of negotiation.&n;         * Use PPR messages instead of WDTR and SDTR messages.&n;         */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/*&n;           * As per the draft specs, any device capable of supporting any of&n;           * the option values other than 0 are not allowed to reject the&n;           * PPR message.  Instead, they must negotiate out what they do&n;           * support instead of rejecting our offering.&n;           */
id|p-&gt;needppr
op_and_assign
op_complement
id|target_mask
...
(brace
multiline_comment|/*&n;                   * This is already a negotiation command, so we must have&n;                   * already done PPR, WDTR or SDTR.  Since our negotiation&n;                   * could have gotten rejected, we don&squot;t really know the&n;                   * full state of things.  Don&squot;t do anything here, and allow&n;                   * the negotiation_complete() handler to do the right&n;                   * thing.&n;                   */
...
multiline_comment|/*&n;         * If we aren&squot;t on one of the new Ultra3 cards, then reject any PPR&n;         * message since we can&squot;t support any option field other than 0&n;         */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|INFO_LEAD
l_string|&quot;dev_flags=0x%x, Pending:%c, PPR:%c/%c, WDTR:%c/%c, &quot;
l_string|&quot;SDTR:%c/%c, q_depth=%d:%d&bslash;n&quot;
comma
id|p-&gt;host_no
comma
l_int|0
...
c_func
(paren
l_string|&quot;SCBPTR CONTROL TAG NEXT&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;   %3d      %02x  %02x   %02x&bslash;n&quot;
comma
id|i
comma
id|aic_inb
