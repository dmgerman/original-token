...
op_increment
suffix:semicolon
multiline_comment|/* Keep track of interrupts for /proc/scsi */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;aic7xxx_isr: Received MSG_WDTR, scsi_id = %d, &quot;
