...
(brace
multiline_comment|/* Set Index and SCB pointer */
id|megaCfg-&gt;scbList
(braket
id|idx
)braket
...
multiline_comment|/* Convert result to error */
r_switch
c_cond
(paren
id|SCpnt-&gt;result
...
multiline_comment|/*----------------------------------------------------&n; * Process pending queue list&n; *&n; * Run as a scheduled task &n; *----------------------------------------------------*/
DECL|function|mega_runque
r_static
r_void
id|mega_runque
c_func
