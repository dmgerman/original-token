...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_aen_drain_queue(): Bad response, flags = 0x%x.&bslash;n&quot;
comma
id|command_packet-&gt;flags
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_initconnection(): Bad response, flags = 0x%x.&bslash;n&quot;
comma
id|command_packet-&gt;flags
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_initialize_units(): Bad response, flags = 0x%x.&bslash;n&quot;
comma
id|command_packet-&gt;flags
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: tw_interrupt(): Bad response, flags = 0x%x.&bslash;n&quot;
comma
id|command_packet-&gt;flags
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;3w-xxxx: twioctl(): Bad command packet virtual address.&bslash;n&quot;
)paren
suffix:semicolon
id|tw_dev-&gt;state
(braket
