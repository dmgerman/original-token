multiline_comment|/*&n;&n;  Linux Driver for BusLogic SCSI Host Adapters&n;&n;  Copyright 1995 by Leonard N. Zubkoff &lt;lnz@dandelion.com&gt;&n;&n;  See BusLogic.c for licensing information.&n;&n;*/
...
multiline_comment|/*&n;  Define the number of Incoming and Outgoing Mailboxes used by this driver.&n;  Since BusLogic Host Adapters have room to buffer 32 commands internally,&n;  there is significant virtue in setting BusLogic_MailboxCount to 32 or above.&n;  The maximum possible value is 255, since the MailboxCount parameter to the&n;  Initialize Extended Mailbox command is limited to a single byte.&n;*/
DECL|macro|BusLogic_MailboxCount
mdefine_line|#define BusLogic_MailboxCount&t;&t;&t;32
...
multiline_comment|/*&n;  Define the default number of Concurrent Commands per Logical Unit to allow&n;  for Target Devices on non-ISA and ISA Host Adapters.&n;*/
DECL|macro|BusLogic_Concurrency
mdefine_line|#define BusLogic_Concurrency&t;&t;&t;7
DECL|macro|BusLogic_Concurrency_ISA
mdefine_line|#define BusLogic_Concurrency_ISA&t;&t;1
...
multiline_comment|/*&n;  Define the possible Tracing Options.&n;*/
...
comma
multiline_comment|/* undocumented */
DECL|enumerator|BusLogic_InquireBoardModelAndRevision
...
suffix:semicolon
multiline_comment|/*&n;  Define the Inquire Board Model and Revision reply structure.&n;*/
DECL|struct|BusLogic_ModelAndRevision
r_typedef
r_struct
id|BusLogic_ModelAndRevision
(brace
DECL|member|Model
r_int
r_char
...
DECL|typedef|BusLogic_ModelAndRevision_T
...
DECL|member|LevelTriggeredInterrupts
id|boolean
id|LevelTriggeredInterrupts
suffix:colon
l_int|1
suffix:semicolon
DECL|member|Misc
...
suffix:semicolon
multiline_comment|/*&n;  Define the Requested Reply Length type used by the Inquire Setup Information,&n;  Inquire Board Model and Revision, Inquire Synchronous Period, and Inquire&n;  Extended Setup Information commands.&n;*/
...
l_int|5
suffix:semicolon
multiline_comment|/* Byte 17 Bits 0-2 */
...
multiline_comment|/*&n;  BusLogic_Delay waits for Seconds to elapse.  It must be called with&n;  interrupts enabled so that jiffies is updated.&n;*/
