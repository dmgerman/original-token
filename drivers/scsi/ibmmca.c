multiline_comment|/*&n; * Low Level Driver for the IBM Microchannel SCSI Subsystem&n; *&n; * Copyright (c) 1995 Strom Systems, Inc. under the terms of the GNU &n; * General Public License. Written by Martin Kolinek, December 1995.&n; * Further development by: Chris Beauregard, Klaus Kudielka, Michael Lang&n; * See the file README.ibmmca for a detailed description of this driver,&n; * the commandline arguments and the history of its development.&n; * See the WWW-page: http://www.uni-mainz.de/~langm000/linux.html for latest&n; * updates and info.&n; */
multiline_comment|/******************* HEADER FILE INCLUDES ************************************/
macro_line|#ifndef LINUX_VERSION_CODE
macro_line|#include &lt;linux/version.h&gt;
macro_line|#endif
multiline_comment|/* choose adaption for Kernellevel */
DECL|macro|local_LinuxVersionCode
mdefine_line|#define local_LinuxVersionCode(v, p, s) (((v)&lt;&lt;16)+((p)&lt;&lt;8)+(s))
macro_line|#if LINUX_VERSION_CODE &lt; local_LinuxVersionCode(2,1,0)
DECL|macro|OLDKERN
...
mdefine_line|#define IBMMCA_SCSI_DRIVER_VERSION &quot;3.1e&quot;
multiline_comment|/*--------------------------------------------------------------------*/
...
l_int|0
suffix:semicolon
multiline_comment|/* use_adisplay is set by ibmmcascsi=adisplay, which offers a higher&n; * level of displayed luxus on PS/2 95 (really fancy! :-))) */
DECL|variable|use_adisplay
r_static
r_int
id|use_adisplay
op_assign
...
mdefine_line|#define PS2_DISK_LED_ON(ad,id) {&bslash;&n;&t;if( use_display ) { outb((char)(id+48), MOD95_LED_PORT ); &bslash;&n;        outb((char)(ad+48), MOD95_LED_PORT+1); } &bslash;&n;        else if( use_adisplay ) { if (id&lt;7) outb((char)(id+48), &bslash;&n;&t;MOD95_LED_PORT+1+id); outb((char)(ad+48), MOD95_LED_PORT); } &bslash;&n;&t;else outb(inb(PS2_SYS_CTR) | 0xc0, PS2_SYS_CTR); &bslash;&n;}
multiline_comment|/* bug fixed, Dec 15, 1997, where | was replaced by &amp; here */
DECL|macro|PS2_DISK_LED_OFF
mdefine_line|#define PS2_DISK_LED_OFF() {&bslash;&n;&t;if( use_display ) { outb( &squot; &squot;, MOD95_LED_PORT ); &bslash;&n;        outb(&squot; &squot;, MOD95_LED_PORT+1); } &bslash;&n;        if ( use_adisplay ) { outb(&squot; &squot;,MOD95_LED_PORT ); &bslash;&n;&t;outb(&squot; &squot;,MOD95_LED_PORT+1); outb(&squot; &squot;,MOD95_LED_PORT+2); &bslash;&n;        outb(&squot; &squot;,MOD95_LED_PORT+3); outb(&squot; &squot;,MOD95_LED_PORT+4); &bslash;&n;        outb(&squot; &squot;,MOD95_LED_PORT+5); outb(&squot; &squot;,MOD95_LED_PORT+6); &bslash;&n;&t;outb(&squot; &squot;,MOD95_LED_PORT+7); } &bslash;&n;&t;else outb(inb(PS2_SYS_CTR) &amp; 0x3f, PS2_SYS_CTR); &bslash;&n;}
multiline_comment|/*--------------------------------------------------------------------*/
...
id|_IBM_DS
suffix:semicolon
multiline_comment|/* This hostadapters pos-registers pos2 and pos3 */
DECL|member|_pos2
DECL|member|_pos3
r_int
id|_pos2
...
multiline_comment|/* special flags for hostdata structure */
...
suffix:semicolon
multiline_comment|/* whole pos register-line */
...
l_int|0
suffix:semicolon
multiline_comment|/* make sure, host_index is 0, else this won&squot;t work and&n;&t;&t;    never dare to ask, what happens, if an interrupt-handler&n;&t;&t;    does not work :-((( .... */
...
l_int|0
suffix:semicolon
multiline_comment|/* no errors by default */
...
c_func
(paren
l_string|&quot;IBM MCA SCSI: ERROR - subsystem hardware failure!&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;              Last SCSI-command=0x%X, ldn=%d, host=%d.&bslash;n&quot;
comma
id|last_scsi_command
c_func
(paren
...
c_func
(paren
l_string|&quot;IBM MCA SCSI: ERROR - software sequencing error!&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;IBM MCA SCSI: ERROR - command error!&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
...
c_func
(paren
l_string|&quot;              SCB End Status Word.........: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
c_func
(paren
l_string|&quot;              Command Status..............: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
c_func
(paren
l_string|&quot;              Device Status...............: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
c_func
(paren
l_string|&quot;              Command Error...............: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
c_func
(paren
l_string|&quot;              Device Error................: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
c_func
(paren
l_string|&quot;              Last SCB Address (LSW)......: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
dot
id|tsb.low_of_last_scb_adr
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;              Last SCB Address (MSW)......: %x&bslash;n&quot;
comma
id|ld
c_func
(paren
...
c_func
(paren
l_string|&quot;              Send report to the maintainer.&bslash;n&quot;
)paren
suffix:semicolon
id|panic
c_func
(paren
l_string|&quot;IBM MCA SCSI: Fatal errormessage from the subsystem!&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
multiline_comment|/* IBM describes the status-mask to be 0x1e, but this is not conform&n;&t; * with SCSI-defintion, I suppose, it is a printing error in the&n;&t; * technical reference and assume as mask 0x3e. (ML) */
id|cmd-&gt;result
op_assign
(paren
id|ld
...
id|len
comma
l_string|&quot;Adapter cathegory: forced detected&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
id|len
comma
l_string|&quot;Port offset: 0x%x&bslash;n&quot;
comma
(paren
(paren
id|pos2
...
id|len
comma
l_string|&quot;I/O base address range: 0x%x-0x%x&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;IBM MCA SCSI: No Microchannel-bus support present -&gt; Aborting.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;              chip rev.=%d, port-offset=0x%x, subsystem=%s&bslash;n&quot;
comma
(paren
(paren
id|pos
...
(brace
multiline_comment|/* maybe ESDI, or other producers&squot; SCSI-hosts */
id|free_irq
(paren
id|IM_IRQ
comma
...
id|printk
(paren
l_string|&quot;IBM MCA SCSI: Reset completed without known error.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#ifdef OLDKERN   
id|restore_flags
