...
mdefine_line|#define IM_CMD_REG   0x3540&t;/*Command Interface, (4 bytes long) */
DECL|macro|IM_ATTN_REG
mdefine_line|#define IM_ATTN_REG  0x3544&t;/*Attention (1 byte) */
DECL|macro|IM_CTR_REG
mdefine_line|#define IM_CTR_REG   0x3545&t;/*Basic Control (1 byte) */
DECL|macro|IM_INTR_REG
mdefine_line|#define IM_INTR_REG  0x3546&t;/*Interrupt Status (1 byte, read only) */
DECL|macro|IM_STAT_REG
mdefine_line|#define IM_STAT_REG  0x3547&t;/*Basic Status (1 byte, read only) */
...
l_int|0
suffix:semicolon
multiline_comment|/*scsi id (physical unit number) of subsystem (set during detect) */
DECL|variable|subsystem_pun
r_static
r_int
id|subsystem_pun
suffix:semicolon
multiline_comment|/*array to convert (pun, lun) into logical device number */
DECL|variable|get_ldn
r_static
r_int
r_char
id|get_ldn
...
DECL|variable|local_checking_phase_flag
r_static
r_int
id|local_checking_phase_flag
suffix:semicolon
DECL|variable|got_interrupt
r_static
r_int
id|got_interrupt
suffix:semicolon
DECL|variable|stat_result
r_static
r_int
id|stat_result
suffix:semicolon
multiline_comment|/*reset status and its values (used only when doing reset) */
...
id|printk
(paren
l_string|&quot;ibmmca SCSI: spurious/shared interrupt?&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
r_else
(brace
multiline_comment|/*reset disk led counter, turn of disk led */
id|disk_rw_in_progress
op_assign
l_int|0
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* printk(&quot;cmd=%02x ireg=%02x ds=%02x cs=%02x de=%02x ce=%02x&bslash;n&quot;, &n;         cmd-&gt;cmnd[0], intr_reg, &n;         ld[ldn].tsb.dev_status, ld[ldn].tsb.cmd_status, &n;         ld[ldn].tsb.dev_error, ld[ldn].tsb.cmd_error); */
...
id|len
comma
l_string|&quot;Detected at boot: %s&bslash;n&quot;
comma
id|setup_called
ques
c_cond
...
id|printk
(paren
l_string|&quot;IBM MCA SCSI: forced detection, scsi id=%d.&bslash;n&quot;
comma
id|subsystem_pun
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;IBM MCA SCSI: integrated SCSI found, scsi id=%d.&bslash;n&quot;
comma
id|subsystem_pun
)paren
suffix:semicolon
...
id|printk
(paren
l_string|&quot;IBM MCA SCSI: %s found in slot %d, scsi id=%d.&bslash;n&quot;
comma
id|subsys_list
(braket
id|j
...
multiline_comment|/*return &quot;nothing found&quot; */
r_return
l_int|0
suffix:semicolon
)brace
...
(brace
multiline_comment|/*verify that one value (between 0 and 7) was specified */
r_if
c_cond
(paren
id|setup_called
...
id|printk
(paren
l_string|&quot;IBM MCA SCSI: usage: ibmmcascsi=&lt;ADAPTER_SCSI_ID&gt;&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(brace
multiline_comment|/*initialize local data */
id|memset
(paren
id|ld
comma
...
suffix:semicolon
multiline_comment|/*search for the subsystem, return 0 if not found */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
multiline_comment|/*if got here, one ibm mca subsystem has been detected */
r_return
l_int|1
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* printk(&quot;issue scsi cmd=%02x to ldn=%d&bslash;n&quot;, scsi_cmd, ldn); */
r_switch
c_cond
(paren
id|scsi_cmd
...
(brace
multiline_comment|/*do a reset instead, since abort does not work well for me at present */
r_return
id|ibmmca_reset
(paren
id|cmd
...
suffix:semicolon
multiline_comment|/*if reset failed, just return error */
r_if
c_cond
(paren
id|reset_status
...
id|printk
(paren
l_string|&quot;IBM MCA SCSI: reset finished well.&bslash;n&quot;
)paren
suffix:semicolon
(brace
r_int
