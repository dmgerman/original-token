...
id|found
suffix:semicolon
multiline_comment|/*&n;     * Patched by ZP Gu to work with the 9556 as well; the 9556 has&n;     * pos2 = 05, but it should be 00, as it should be interfaced&n;     * via port = 0x3540.&n;     */
