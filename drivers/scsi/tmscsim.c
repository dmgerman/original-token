...
l_int|0
suffix:semicolon
DECL|variable|mech1addr
r_static
id|ULONG
id|mech1addr
suffix:semicolon
DECL|variable|mech2bus
DECL|variable|mech2Agent
DECL|variable|mech2CfgSPenR
r_static
id|UCHAR
id|mech2bus
comma
...
id|wlval
comma
id|PCI_CFG1_ADDRESS_REG
)paren
suffix:semicolon
)brace
)brace
r_void
DECL|function|DC390_DisableCfg
id|DC390_DisableCfg
c_func
(paren
id|USHORT
...
r_else
multiline_comment|/* use mech #1 method */
(brace
id|mech1addr
op_assign
l_int|0x80000000
...
c_func
(paren
l_string|&quot;DC390: Mech=%2x,&bslash;n&quot;
comma
(paren
id|UCHAR
)paren
...
c_func
(paren
l_string|&quot;DC390_detect: reading configuration registers error!&bslash;n&quot;
)paren
suffix:semicolon
id|InitialTime
op_assign
