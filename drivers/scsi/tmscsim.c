...
multiline_comment|/***********************************************************************&n; * Function : static void dc390_initDCB()&n; *&n; * Purpose :  initialize the internal structures for a given DCB&n; *&n; * Inputs : cmd - pointer to this scsi cmd request block structure&n; ***********************************************************************/
