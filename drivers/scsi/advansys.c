multiline_comment|/* $Id: advansys.c,v 1.50 1998/05/08 23:39:15 bobf Exp bobf $ */
DECL|macro|ASC_VERSION
mdefine_line|#define ASC_VERSION &quot;3.1E&quot;    /* AdvanSys Driver Version */
...
macro_line|#endif /* version &gt;= 2.1.95 */
...
macro_line|#else /* version &lt; v2.1.93 */
multiline_comment|/*&n; * For earlier than v2.1.93 the driver has its own PCI configuration.&n; * If PCI is not needed in a kernel before v2.1.93 this define can be&n; * turned-off to make the driver object smaller.&n; */
DECL|macro|ASC_CONFIG_PCI
mdefine_line|#define ASC_CONFIG_PCI
...
mdefine_line|#define ASC_LIB_SERIAL_NUMBER  113
DECL|typedef|uchar
r_typedef
r_int
r_char
...
mdefine_line|#define ADV_LIB_VERSION_MINOR  45
...
DECL|macro|ASC_PCI_VENDORID
mdefine_line|#define ASC_PCI_VENDORID        0x10CD
DECL|macro|ASC_PCI_DEVICE_ID_CNT
mdefine_line|#define ASC_PCI_DEVICE_ID_CNT   4       /* PCI Device ID count. */
...
l_int|1
suffix:semicolon
macro_line|#endif /* ASC_CONFIG_PCI */
macro_line|#endif /* version &lt; v2.1.93 */
...
l_int|2
comma
l_string|&quot;advansys_detect: devfn %d, bus number %d&bslash;n&quot;
comma
id|pci_devp-&gt;devfn
comma
id|pci_devp-&gt;bus-&gt;number
)paren
suffix:semicolon
id|iop
op_assign
...
id|ep-&gt;init_sdtr
op_assign
id|asc_dvc_varp-&gt;cfg-&gt;sdtr_enable
suffix:semicolon
id|ep-&gt;disc_enable
op_assign
...
macro_line|#else /* version &gt;= v1.3.70 */
multiline_comment|/*&n;            * If request_irq() fails with the SA_INTERRUPT flag set,&n;            * then try again without the SA_INTERRUPT flag set. This&n;            * allows IRQ sharing to work even with other drivers that&n;            * do not set the SA_INTERRUPT flag.&n;            *&n;            * If SA_INTERRUPT is not set, then interrupts are enabled&n;            * before the driver interrupt function is called.&n;            */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;advansys_detect: board %d: request_irq(): IRQ %d already in use.&bslash;n&quot;
comma
id|boardp-&gt;id
comma
id|shp-&gt;irq
...
c_func
(paren
l_string|&quot;advansys_detect: board %d: request_irq(): IRQ %d not valid.&bslash;n&quot;
comma
id|boardp-&gt;id
comma
id|shp-&gt;irq
...
c_func
(paren
l_string|&quot;advansys_detect: board %d: request_irq(): IRQ %d failed with %d&bslash;n&quot;
comma
id|boardp-&gt;id
comma
id|shp-&gt;irq
...
id|info
comma
macro_line|#if LINUX_VERSION_CODE &lt; ASC_LINUX_VERSION(2,1,92)
l_string|&quot;AdvanSys SCSI %s: %s %u CDB: BIOS %X, IO %X/%X, IRQ %u, DMA %u&quot;
comma
macro_line|#else /* version &gt;= v2.1.92 */ 
l_string|&quot;AdvanSys SCSI %s: %s %u CDB: BIOS %X, IO %lX/%X, IRQ %u, DMA %u&quot;
comma
macro_line|#endif /* version &gt;= v2.1.92 */ 
id|ASC_VERSION
comma
id|busname
comma
...
comma
macro_line|#else /* version &gt;= v2.1.92 */ 
l_string|&quot;AdvanSys SCSI %s: %s %u CDB: IO %lX/%X, IRQ %u&quot;
comma
macro_line|#endif /* version &gt;= v2.1.92 */ 
id|ASC_VERSION
comma
...
comma
macro_line|#else /* version &gt;= v2.1.92 */ 
l_string|&quot;AdvanSys SCSI %s: %s %u CDB: BIOS %X, IO %lX/%X, IRQ %u&quot;
comma
macro_line|#endif /* version &gt;= v2.1.92 */ 
id|ASC_VERSION
comma
...
l_int|1
comma
l_string|&quot;advansys_reset: ret %d&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon
...
multiline_comment|/* Interrupts could be enabled here. */
multiline_comment|/*&n;     * It is possible for the request done function to re-enable&n;     * interrupts without confusing the driver. But here the&n;     * original flags aren&squot;t restored until all requests have been&n;     * completed.&n;     */
id|asc_scsi_done_list
c_func
(paren
id|done_scp
...
multiline_comment|/*&n;         * If an INQUIRY command completed successfully, then call&n;         * the AscInquiryHandling() function to set-up the device.&n;         */
r_if
c_cond
(paren
id|scp-&gt;cmnd
...
multiline_comment|/*&n;         * If there was an underrun without any other error,&n;         * set DID_ERROR to indicate the underrun error.&n;         *&n;         * Note: There is no way yet to indicate the number&n;         * of underrun bytes.&n;         */
r_if
c_cond
(paren
id|scp-&gt;result
...
multiline_comment|/*&n;     * If the &squot;init_tidmask&squot; bit isn&squot;t already set for the target and the&n;     * current request finished normally, then set the bit for the target&n;     * to indicate that a device is present.&n;     */
r_if
c_cond
(paren
(paren
...
l_int|4
comma
l_string|&quot;asc_get_pci_cfg: slotFound %d&bslash;n &quot;
comma
id|pciDevice-&gt;slotFound
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Current available ROM BIOS release is 3.1C. */
r_if
c_cond
(paren
id|major
...
multiline_comment|/*&n; * Add serial number to information bar if signature AAh&n; * is found in at bit 15-9 (7 bits) of word 1.&n; *&n; * Serial Number consists fo 12 alpha-numeric digits.&n; *&n; *       1 - Product type (A,B,C,D..)  Word0: 15-13 (3 bits)&n; *       2 - MFG Location (A,B,C,D..)  Word0: 12-10 (3 bits)&n; *     3-4 - Product ID (0-99)         Word0: 9-0 (10 bits)&n; *       5 - Product revision (A-J)    Word0:  &quot;         &quot;&n; *&n; *           Signature                 Word1: 15-9 (7 bits)&n; *       6 - Year (0-9)                Word1: 8-6 (3 bits) &amp; Word2: 15 (1 bit)&n; *     7-8 - Week of the year (1-52)   Word1: 5-0 (6 bits)&n; *&n; *    9-12 - Serial Number (A001-Z999) Word2: 14-0 (15 bits)&n; *&n; * Note 1: Only production cards will have a serial number.&n; *&n; * Note 2: Signature is most significant 7 bits (0xFE).&n; *&n; * Returns ASC_TRUE if serial number found, otherwise returns ASC_FALSE.&n; */
id|STATIC
r_int
...
(brace
multiline_comment|/* Product type is P=Prototype */
op_star
id|cp
op_add_assign
l_int|0x8
...
suffix:semicolon
multiline_comment|/*&n;         * Year - 6th digit.&n;         *&n;         * If bit 15 of third word is set, then the&n;         * last digit of the year is greater than 7.&n;         */
r_if
c_cond
(paren
id|serialnum
...
suffix:semicolon
macro_line|#else /* ASC_CONFIG_PCI */
r_return
l_int|0
suffix:semicolon
macro_line|#endif /* ASC_CONFIG_PCI */
...
c_func
(paren
l_string|&quot; can_tagged_qng %x, cmd_qng_enabled %x, disc_enable %x, sdtr_enable %x,&bslash;n&quot;
comma
id|h-&gt;can_tagged_qng
comma
...
id|STATIC
r_int
DECL|function|AscTagQueuingSafe
id|AscTagQueuingSafe
c_func
(paren
id|ASC_SCSI_INQUIRY
...
id|STATIC
r_void
DECL|function|AscInquiryHandling
id|AscInquiryHandling
c_func
(paren
id|ASC_DVC_VAR
