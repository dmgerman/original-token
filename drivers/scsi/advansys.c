multiline_comment|/* $Id: advansys.c,v 1.14 1996/05/10 00:26:31 bobf Exp bobf $ */
...
mdefine_line|#define ADVANSYS_DEBUG /* Enable for debugging and assertions. */
DECL|macro|ADVANSYS_STATS
mdefine_line|#define ADVANSYS_STATS /* Enable for statistics and tracing. */
macro_line|#ifdef LINUX_1_2
DECL|macro|ADVANSYS_STATS_1_2_PRINT
macro_line|#undef ADVANSYS_STATS_1_2_PRINT /* Enable to print statistics to console. */
macro_line|#endif /* LINUX_1_2 */
...
mdefine_line|#define ASC_LIB_VERSION_MINOR  16
DECL|macro|ASC_LIB_SERIAL_NUMBER
mdefine_line|#define ASC_LIB_SERIAL_NUMBER  53
DECL|typedef|uchar
r_typedef
r_int
r_char
...
DECL|macro|UB_ERR
mdefine_line|#define UB_ERR   (__u8)(0xFF)
DECL|macro|UW_ERR
mdefine_line|#define UW_ERR   (__u16)(0xFFFF)
DECL|macro|UL_ERR
mdefine_line|#define UL_ERR   (__u32)(0xFFFFFFFFUL)
DECL|macro|iseven_word
mdefine_line|#define iseven_word( val )  ( ( ( ( __u16 )val) &amp; ( __u16 )0x0001 ) == 0 )
DECL|macro|isodd_word
mdefine_line|#define isodd_word( val )   ( ( ( ( __u16 )val) &amp; ( __u16 )0x0001 ) != 0 )
DECL|macro|toeven_word
mdefine_line|#define toeven_word( val )  ( ( ( __u16 )val ) &amp; ( __u16 )0xFFFE )
DECL|macro|biton
mdefine_line|#define biton( val, bits )   ((( __u16 )( val &gt;&gt; bits ) &amp; (__u16)0x0001 ) != 0 )
DECL|macro|bitoff
mdefine_line|#define bitoff( val, bits )  ((( __u16 )( val &gt;&gt; bits ) &amp; (__u16)0x0001 ) == 0 )
DECL|macro|lbiton
mdefine_line|#define lbiton( val, bits )  ((( __u32 )( val &gt;&gt; bits ) &amp; (__u32)0x00000001UL ) != 0 )
DECL|macro|lbitoff
mdefine_line|#define lbitoff( val, bits ) ((( __u32 )( val &gt;&gt; bits ) &amp; (__u32)0x00000001UL ) == 0 )
DECL|macro|absh
...
mdefine_line|#define BigToLittle(dWord) &bslash;&n;    ((__u32) (SwapWords(MAKELONG(SwapBytes(LO_WORD(dWord)), SwapBytes(HI_WORD(dWord))))))
...
DECL|macro|PortAddr
mdefine_line|#define PortAddr&t;&t;&t;unsigned short
DECL|macro|Ptr2Func
mdefine_line|#define Ptr2Func        &t;ulong
DECL|macro|inp
mdefine_line|#define inp(port)        &t;inb(port)
DECL|macro|inpw
mdefine_line|#define inpw(port)       &t;inw(port)
DECL|macro|outp
...
DECL|macro|CC_TARGET_MODE
mdefine_line|#define CC_TARGET_MODE         FALSE
DECL|macro|CC_SCAM
mdefine_line|#define CC_SCAM                FALSE
DECL|macro|CC_LITTLE_ENDIAN_HOST
mdefine_line|#define CC_LITTLE_ENDIAN_HOST  TRUE
macro_line|#ifndef CC_TEST_LRAM_ENDIAN
macro_line|#if CC_LITTLE_ENDIAN_HOST
DECL|macro|CC_TEST_LRAM_ENDIAN
mdefine_line|#define CC_TEST_LRAM_ENDIAN     FALSE
macro_line|#else
DECL|macro|CC_TEST_LRAM_ENDIAN
mdefine_line|#define CC_TEST_LRAM_ENDIAN     TRUE
macro_line|#endif
macro_line|#endif
...
macro_line|#ifndef CC_TARGET_MODE
DECL|macro|CC_TARGET_MODE
mdefine_line|#define CC_TARGET_MODE         FALSE
macro_line|#endif
macro_line|#ifndef CC_STRUCT_ALIGNED
DECL|macro|CC_STRUCT_ALIGNED
mdefine_line|#define CC_STRUCT_ALIGNED      FALSE
macro_line|#endif
macro_line|#ifndef CC_LITTLE_ENDIAN_HOST
DECL|macro|CC_LITTLE_ENDIAN_HOST
mdefine_line|#define CC_LITTLE_ENDIAN_HOST  TRUE
macro_line|#endif
macro_line|#if !CC_LITTLE_ENDIAN_HOST
...
macro_line|#endif
macro_line|#endif
macro_line|#ifndef CC_MEMORY_MAPPED_IO
DECL|macro|CC_MEMORY_MAPPED_IO
mdefine_line|#define CC_MEMORY_MAPPED_IO    FALSE
macro_line|#endif
macro_line|#ifndef CC_WRITE_IO_COUNT
DECL|macro|CC_WRITE_IO_COUNT
mdefine_line|#define CC_WRITE_IO_COUNT      FALSE
macro_line|#endif
macro_line|#ifndef CC_CLEAR_DMA_REMAIN
DECL|macro|CC_CLEAR_DMA_REMAIN
mdefine_line|#define CC_CLEAR_DMA_REMAIN    FALSE
macro_line|#endif
...
DECL|macro|ASC_IS_PNP
mdefine_line|#define ASC_IS_PNP          (0x0010)
...
DECL|macro|ASC_TAG_FLAG_ADD_ONE_BYTE
mdefine_line|#define ASC_TAG_FLAG_ADD_ONE_BYTE     0x10
DECL|macro|ASC_TAG_FLAG_ISAPNP_ADD_BYTES
mdefine_line|#define ASC_TAG_FLAG_ISAPNP_ADD_BYTES 0x40
...
mdefine_line|#define ASC_DEF_SCSI1_QNG    2
DECL|macro|ASC_MAX_SCSI1_QNG
mdefine_line|#define ASC_MAX_SCSI1_QNG    2
...
DECL|macro|ASC_STOP_SEND_INT_TO_HOST
mdefine_line|#define ASC_STOP_SEND_INT_TO_HOST   0x80
...
mdefine_line|#define ASC_DEF_MAX_TOTAL_QNG   (0x40)
...
DECL|macro|ASC_BUG_FIX_ADD_ONE_BYTE
mdefine_line|#define ASC_BUG_FIX_ADD_ONE_BYTE     0x0001
...
DECL|macro|ASC_MAX_SDTR_PERIOD_INDEX
mdefine_line|#define ASC_MAX_SDTR_PERIOD_INDEX  7
...
DECL|macro|ASC_SDTR_PERIOD_IX_MIN
mdefine_line|#define ASC_SDTR_PERIOD_IX_MIN  7
...
DECL|macro|ASC_CNTL_NO_PCI_FIX_ASYN_XFER
mdefine_line|#define ASC_CNTL_NO_PCI_FIX_ASYN_XFER ( ushort )0x0020
...
DECL|macro|ASCV_CDBCNT_B
mdefine_line|#define ASCV_CDBCNT_B         ( ushort )0x004C
...
DECL|macro|IOP_ASPI_ID_LOW
mdefine_line|#define IOP_ASPI_ID_LOW  (0x01)
DECL|macro|IOP_ASPI_ID_HIGH
mdefine_line|#define IOP_ASPI_ID_HIGH (0x00)
...
DECL|macro|SC_SEL
mdefine_line|#define SC_SEL   (0x80)
DECL|macro|SC_BSY
mdefine_line|#define SC_BSY   (0x40)
DECL|macro|SC_ACK
mdefine_line|#define SC_ACK   (0x20)
DECL|macro|SC_REQ
mdefine_line|#define SC_REQ   (0x10)
DECL|macro|SC_ATN
mdefine_line|#define SC_ATN   (0x08)
DECL|macro|SC_IO
mdefine_line|#define SC_IO    (0x04)
DECL|macro|SC_CD
mdefine_line|#define SC_CD    (0x02)
DECL|macro|SC_MSG
mdefine_line|#define SC_MSG   (0x01)
...
mdefine_line|#define AscGetChipIFC( port )               inp( (port)+IOP_REG_IFC )
DECL|macro|AscPutChipIFC
mdefine_line|#define AscPutChipIFC( port, data )         outp( (port)+IOP_REG_IFC, data )
...
DECL|macro|AscPutChipLramData
mdefine_line|#define AscPutChipLramData( port, data )    outpw( (port)+IOP_RAM_DATA, data )
DECL|macro|AscGetChipLramData
mdefine_line|#define AscGetChipLramData( port )          inpw( (port)+IOP_RAM_DATA )
DECL|macro|AscWriteChipSyn
mdefine_line|#define AscWriteChipSyn( port, data )       outp( (port)+IOP_SYN_OFFSET, data )
DECL|macro|AscReadChipSyn
mdefine_line|#define AscReadChipSyn( port )              inp( (port)+IOP_SYN_OFFSET )
DECL|macro|AscWriteChipIH
mdefine_line|#define AscWriteChipIH( port, data )        outpw( (port)+IOP_REG_IH, data )
DECL|macro|AscReadChipIH
mdefine_line|#define AscReadChipIH( port )               inpw( (port)+IOP_REG_IH )
DECL|macro|AscWriteChipScsiID
mdefine_line|#define AscWriteChipScsiID( port, data )    outp( (port)+IOP_REG_ID, data )
DECL|macro|AscReadChipScsiID
mdefine_line|#define AscReadChipScsiID( port )           inp( (port)+IOP_REG_ID )
DECL|macro|AscGetChipDmaSpeed
mdefine_line|#define AscGetChipDmaSpeed( port )         ( uchar )inp( (port)+IOP_DMA_SPEED )
DECL|macro|AscSetChipDmaSpeed
mdefine_line|#define AscSetChipDmaSpeed( port, data )   outp( (port)+IOP_DMA_SPEED, data )
DECL|macro|AscGetChipQP
mdefine_line|#define AscGetChipQP( port )               ( uchar )inp( (port)+IOP_REG_QP )
DECL|macro|AscSetPCAddr
mdefine_line|#define AscSetPCAddr( port, data )         outpw( (port)+IOP_REG_PC, data )
DECL|macro|AscGetPCAddr
mdefine_line|#define AscGetPCAddr( port )               inpw( (port)+IOP_REG_PC )
...
mdefine_line|#define AscGetChipEEPData( port )          inpw( (port)+IOP_EEP_DATA )
...
mdefine_line|#define AscIsIntPending( port )           ( AscGetChipStatus( port ) &amp; CSW_INT_PENDING )
...
mdefine_line|#define ASC_CFG_MSW_CLR_MASK    0xF0C0
...
DECL|macro|ASC_BOARD
mdefine_line|#define ASC_BOARD(host) ((struct asc_board *) &amp;(host)-&gt;hostdata)
DECL|macro|NO_ISA_DMA
mdefine_line|#define NO_ISA_DMA&t;0xff&t;&t;/* No ISA DMA Channel Used */
...
DECL|macro|ASC_PCI_REV_A_INIT
mdefine_line|#define ASC_PCI_REV_A_INIT&t;&t;0x01
DECL|macro|ASC_PCI_REV_A_DONE
mdefine_line|#define ASC_PCI_REV_A_DONE&t;&t;0x02
DECL|macro|ASC_PCI_REV_B_INIT
mdefine_line|#define ASC_PCI_REV_B_INIT&t;&t;0x04
DECL|macro|ASC_PCI_REV_B_DONE
mdefine_line|#define ASC_PCI_REV_B_DONE&t;&t;0x08
...
multiline_comment|/*&n; * --- Driver Macros&n; */
macro_line|#ifndef ADVANSYS_STATS
DECL|macro|ASC_STATS
mdefine_line|#define ASC_STATS(counter)
DECL|macro|ASC_STATS_ADD
mdefine_line|#define ASC_STATS_ADD(counter, count)
macro_line|#else /* ADVANSYS_STATS */
DECL|macro|ASC_STATS
mdefine_line|#define ASC_STATS(counter)&t;&t;&t;&t;asc_stats.counter++
DECL|macro|ASC_STATS_ADD
mdefine_line|#define ASC_STATS_ADD(counter, count)&t;asc_stats.counter += (count)
...
DECL|member|pending_tidmask
id|ASC_SCSI_BIT_ID_TYPE
id|pending_tidmask
suffix:semicolon
multiline_comment|/* Pending command mask */
DECL|member|pending
id|Scsi_Cmnd
op_star
id|pending
...
id|interrupt
suffix:semicolon
multiline_comment|/* # calls to advansys_interrupt() */
...
id|cont_xfer
suffix:semicolon
multiline_comment|/* contiguous transfer total (512 byte units) */
DECL|member|sg_cnt
id|ulong
id|sg_cnt
suffix:semicolon
...
id|sg_elem
suffix:semicolon
multiline_comment|/* scatter-gather element total */
DECL|member|sg_xfer
id|ulong
id|sg_xfer
suffix:semicolon
...
multiline_comment|/*&n;&t; * Number of times interrupts disabled in advansys_queuecommand() and&n;&t; * asc_isr_callback(), respectively. For the former indicates how many&n;&t; * times commands were pending when a new command was received.&n;&t; */
DECL|member|cmd_disable
id|ulong
id|cmd_disable
suffix:semicolon
DECL|member|intr_disable
id|ulong
id|intr_disable
suffix:semicolon
multiline_comment|/*&n;&t; * Number of times asc_enqueue() called. Indicates how many ASC_BUSY&n;&t; * returns have occurred.&n;&t; */
DECL|member|enqueue
id|ulong
id|enqueue
suffix:semicolon
...
id|dequeue
suffix:semicolon
multiline_comment|/* # calls to asc_dequeue(). */
multiline_comment|/*&n;&t; * Number of times asc_rmqueue() called and the specified command&n;&t; * was found and removed.&n;&t; */
DECL|member|rmqueue
id|ulong
id|rmqueue
suffix:semicolon
DECL|variable|asc_stats
)brace
id|asc_stats
suffix:semicolon
macro_line|#endif /* ADVANSYS_STATS */
...
id|asc_scsi_done
suffix:semicolon
multiline_comment|/* Commands needing done function call. */
...
multiline_comment|/*&n;&t; * User read of /proc/scsi/advansys file.&n;&t; */
...
suffix:semicolon
multiline_comment|/* Always copy read data to the beginning of the buffer. */
op_star
id|start
op_assign
id|buffer
...
id|length
suffix:semicolon
multiline_comment|/* Get board information. */
id|cp
op_assign
(paren
r_char
...
id|cnt
suffix:semicolon
multiline_comment|/*&n;&t; * Get and copy information for each device attached to the board.&n;&t; */
id|cp
op_assign
op_amp
id|prtbuf
...
id|cp
comma
l_string|&quot;&bslash;nDevices attached to SCSI Host %d:&bslash;n&quot;
comma
id|shp-&gt;host_no
)paren
suffix:semicolon
...
macro_line|#ifdef ADVANSYS_STATS
multiline_comment|/*&n;&t; * prtbuf[] has about 6 lines worth of space. If the statistics ever&n;&t; * get longer than 6 lines, prtbuf[] should be increased in size. If&n;&t; * prtbuf[] is too small it will not be overwritten. Instead the user&n;&t; * just won&squot;t get all of the available statistics.&n;&t; */
id|cp
op_assign
op_amp
id|prtbuf
...
l_int|0
comma
l_string|&quot;advansys_detect: unknown bus type&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Save a pointer to the Scsi_host of each found board. */
id|asc_host
(braket
id|asc_board_count
op_increment
...
l_int|0
comma
l_string|&quot;advansys_detect: unknown adapter type&quot;
)paren
suffix:semicolon
id|shp-&gt;unchecked_isa_dma
op_assign
...
multiline_comment|/*&n;&t;&t;&t; * Get the board configuration.  AscInitGetConfig() may change&n;&t;&t;&t; * the board&squot;s bus_type value. The asc_bus[bus] value should no&n;&t;&t;&t; * longer be used.&n;&t;&t;&t; */
id|ASC_DBG
c_func
(paren
l_int|2
...
l_int|0
comma
l_string|&quot;AscInitGetConfig: I/O port address modified&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitGetConfig: EEPROM checksum error&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitGetConfig: IRQ modified&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitGetConfig: Tag queuing enabled w/o disconnects&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitGetConfig: Unknown warning: %x&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitGetConfig: error: init_state %x, err_code %x&bslash;n&quot;
comma
id|boardp-&gt;init_state
comma
id|boardp-&gt;err_code
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitSetConfig: I/O port address modified&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitSetConfig: EEPROM checksum error&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitSetConfig: IRQ modified&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitSetConfig: Tag queuing w/o disconnects&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitSetConfig: Unknown warning: %x&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitSetConfig: error: init_state %x, err_code %x&bslash;n&quot;
comma
id|boardp-&gt;init_state
comma
id|boardp-&gt;err_code
...
id|shp-&gt;this_id
op_assign
id|boardp-&gt;cfg-&gt;chip_scsi_id
suffix:semicolon
multiline_comment|/* Maximum number of queues this adapter can handle. */
id|shp-&gt;can_queue
op_assign
id|boardp-&gt;max_total_qng
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * XXX - Command queuing limits are maintained per target&n;&t;&t;&t; * by AdvanSys adapters. Set &squot;cmd_per_lun&squot; to the minimum&n;&t;&t;&t; * value of the all the target settings for the adapter.&n;&t;&t;&t; *&n;&t;&t;&t; * For now set &squot;cmd_per_lun&squot; to &squot;max_total_qng&squot;. This&n;&t;&t;&t; * value should be adjusted every time a new device is&n;&t;&t;&t; * found in asc_init_dev().&n;&t;&t;&t; *&n;&t;&t;&t; * XXX - memory allocation is done by the mid-level scsi&n;&t;&t;&t; * driver based on &squot;cmd_per_lun&squot;. If &squot;sg_tablesize&squot; is too large&n;&t;&t;&t; * allocation failures can occur in scsi_register_host().&n;&t;&t;&t; * A &squot;Scsi_Cmnd&squot; structure is pre-allocated for each command&n;&t;&t;&t; * also DMA memory is reserved. Set it artificially low for now.&n;&t;&t;&t; *&n;&t;&t;&t; * shp-&gt;cmd_per_lun = boardp-&gt;max_total_qng;&n;&t;&t;&t; */
macro_line|#ifdef MODULE
id|shp-&gt;cmd_per_lun
op_assign
l_int|1
...
suffix:semicolon
multiline_comment|/* Maximum number of scatter-gather elements adapter can handle. */
multiline_comment|/*&n;&t;&t;&t; * XXX - memory allocation is done by the mid-level scsi&n;&t;&t;&t; * driver based on sg_tablesize. If &squot;sg_tablesize&squot; is too large&n;&t;&t;&t; * allocation failures can occur in scsi_register_host().&n;&t;&t;&t; */
macro_line|#ifdef MODULE
id|shp-&gt;sg_tablesize
op_assign
l_int|8
...
l_int|0
comma
l_string|&quot;advansys_detect: request_dma() %d failed %d&bslash;n&quot;
comma
id|shp-&gt;dma_channel
comma
id|ret
...
l_int|0
comma
l_string|&quot;advansys_detect: request_irq() failed %d&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon
...
l_int|0
comma
l_string|&quot;AscInitAsc1000Driver: error: init_state %x, err_code %x&bslash;n&quot;
comma
id|boardp-&gt;init_state
comma
id|boardp-&gt;err_code
...
multiline_comment|/*&n; * advansys_info()&n; *&n; * Return suitable for printing on the console with the argument&n; * adapter&squot;s configuration information.&n; */
r_const
r_char
op_star
...
l_int|0
comma
l_string|&quot;advansys_info: unknown bus type %d&bslash;n&quot;
comma
id|boardp-&gt;bus_type
)paren
suffix:semicolon
...
macro_line|#endif /* ADVANSYS_STATS_1_2_PRINT */
macro_line|#endif /* LINUX_1_2 */
...
l_int|1
comma
l_string|&quot;advansys_queuecommand: asc_execute_pending() %x&bslash;n&quot;
comma
id|ASC_BOARD
c_func
(paren
...
multiline_comment|/*&n; * advansys_abort()&n; *&n; * Abort the specified command and reset the device&n; * associated with the command &squot;scp&squot;.&n; */
r_int
...
multiline_comment|/*&n; * advansys_reset()&n; *&n; * Reset all devices and the SCSI bus for the board&n; * associated with &squot;scp&squot;.&n; */
r_int
...
r_else
(brace
multiline_comment|/* Remove any pending commands, set DID_RESET, and done them.  */
r_for
c_loop
(paren
id|i
...
macro_line|#ifdef LINUX_1_3
multiline_comment|/*&n; * asc_proc_copy() &n; *&n; * Copy proc information to a read buffer considering the current read&n; * offset in the file and the remaining space in the read buffer.&n; */
id|STATIC
r_int
...
macro_line|#endif /* LINUX_1_3 */
multiline_comment|/*&n; * First-level interrupt handler.&n; */
id|STATIC
r_void
macro_line|#ifdef LINUX_1_2
...
l_int|0
comma
l_string|&quot;asc_execute_scsi_cmnd: use_sg %d &gt; %d&bslash;n&quot;
comma
id|scp-&gt;use_sg
comma
id|ASC_MAX_SG_LIST
...
l_int|0
comma
l_string|&quot;asc_execute_scsi_cmnd: AscExeScsiQueue() ASC_ERROR err_code %x&bslash;n&quot;
comma
id|boardp-&gt;err_code
)paren
suffix:semicolon
...
l_int|1
comma
l_string|&quot;asc_isr_callback: boardp %x, qdonep %x&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Note: The status_byte() macro used by target drivers&n;&t;&t;&t;&t; * defined in scsi.h shifts the status byte returned by&n;&t;&t;&t;&t; * host drivers right by 1 bit. This is why target drivers&n;&t;&t;&t;&t; * also use left shifted status byte definitions. For instance&n;&t;&t;&t;&t; * target drivers use CHECK_CONDITION, defined to 0x1, instead&n;&t;&t;&t;&t; * of the SCSI defined check condition value of 0x2.&n;&t;&t;&t;&t; */
id|scp-&gt;result
op_assign
id|DRIVER_BYTE
c_func
...
l_int|1
comma
l_string|&quot;asc_isr_callback: asc_execute_pending() %x&bslash;n&quot;
comma
id|ASC_BOARD
c_func
(paren
...
multiline_comment|/*&n; * Execute as many pending requests as possible for the&n; * board specified by &squot;Scsi_Host&squot;.&n; */
id|STATIC
r_void
DECL|function|asc_execute_pending
id|asc_execute_pending
c_func
(paren
r_struct
...
suffix:semicolon
multiline_comment|/*&n;&t; * Execute pending commands for devices attached to&n;&t; * the current board in round-robin fashion.&n;&t; */
id|scan_tidmask
op_assign
id|ASC_BOARD
c_func
...
suffix:semicolon
multiline_comment|/* Return true for the board&squot;s target id. */
r_if
c_cond
(paren
id|boardp-&gt;cfg-&gt;chip_scsi_id
...
id|save_use_tagged_qng
op_assign
id|boardp-&gt;use_tagged_qng
suffix:semicolon
id|save_can_tagged_qng
op_assign
id|boardp-&gt;cfg-&gt;can_tagged_qng
suffix:semicolon
id|ASC_DBG
c_func
(paren
...
l_int|0
comma
l_string|&quot;asc_init_dev: AscInitPollBegin() failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|ASC_FALSE
...
l_int|0
comma
l_string|&quot;asc_init_dev: AscInitPollTarget() ASC_ERROR&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;asc_init_dev: AscInitPollTarget() unknown ret %d&bslash;n&quot;
comma
id|ret
)paren
suffix:semicolon
...
suffix:semicolon
macro_line|#ifdef ASC_SET_CMD_PER_LUN
multiline_comment|/*&n;&t; * XXX - Refer to the comment in advansys_detect()&n;&t; * regarding cmd_per_lun.&n;&t; */
r_for
c_loop
(paren
id|i
...
macro_line|#endif /* ASC_SET_CMD_PER_LUN */
r_return
id|found
suffix:semicolon
)brace
...
(brace
multiline_comment|/*&n;&t;&t; * save these registers so we can restore them after we are done&n;&t;&t; */
id|t2CFA
op_assign
id|inp
c_func
...
multiline_comment|/*&n;&t;&t; * go out and write the bus and enable registers&n;&t;&t; */
...
r_else
(brace
multiline_comment|/*&n;&t;&t; * type 1 configuration mechanism&n;&t;&t; *&n;&t;&t; * save the CONFIG_ADDRESS and CONFIG_DATA register values&n;&t;&t; */
id|t1CFC
op_assign
id|inpw
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * read in the word from CONFIG_DATA&n;&t;&t; */
id|tmp
op_assign
(paren
id|ushort
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * restore the registers used for our transaction&n;&t;&t; */
id|outp
c_func
(paren
l_int|0xCF8
...
multiline_comment|/*&n; * Add a &squot;Scsi_Cmnd&squot; to the end of specified &squot;Scsi_Host&squot; &n; * target device pending command list. Set &squot;pending_tidmask&squot;&n; * to indicate a command is queued for the device.&n; *&n; * &squot;flag&squot; may be either ASC_FRONT or ASC_BACK.&n; *&n; * The &squot;Scsi_Cmnd&squot; host_scribble field is used as a next pointer.&n; */
id|STATIC
r_void
...
multiline_comment|/*&n; * Return first pending &squot;Scsi_Cmnd&squot; on the specified &squot;Scsi_Host&squot;&n; * for the specified target device. Clear the &squot;pending_tidmask&squot;&n; * bit for the device if no more commands are left queued for it.&n; *&n; * The &squot;Scsi_Cmnd&squot; host_scribble field is used as a next pointer.&n; */
id|STATIC
id|Scsi_Cmnd
op_star
...
multiline_comment|/*&n; * Remove the specified &squot;Scsi_Cmnd&squot; from the specified &squot;Scsi_Host&squot;&n; * for the specified target device. Clear the &squot;pending_tidmask&squot;&n; * bit for the device if no more commands are left queued for it.&n; *&n; * The &squot;Scsi_Cmnd&squot; host_scribble field is used as a next pointer.&n; *&n; * Return ASC_TRUE if the command was found and removed, otherwise&n; * return ASC_FALSE if the command was not found.&n; */
id|STATIC
r_int
...
r_break
suffix:semicolon
multiline_comment|/* Note: Don&squot;t iterate, *scpp may be NULL. */
)brace
)brace
r_if
c_cond
...
macro_line|#ifdef ADVANSYS_STATS
DECL|macro|ASC_PRT_STATS_NEXT
mdefine_line|#define ASC_PRT_STATS_NEXT() &bslash;&n;&t;if (cp) { &bslash;&n;&t;&t;totlen += len; &bslash;&n;&t;&t;leftlen -= len; &bslash;&n;&t;&t;if (leftlen == 0) { &bslash;&n;&t;&t;&t;return totlen; &bslash;&n;&t;&t;} &bslash;&n;&t;&t;cp += len; &bslash;&n;&t;}
multiline_comment|/*&n; * asc_prt_stats()&n; *&n; * Note: no single line should be greater than 160 characters, cf.&n; * asc_prt_stats_line().&n; *&n; * Return the number of characters copied into &squot;cp&squot;. No more than&n; * &squot;cplen&squot; characters will be copied to &squot;cp&squot;.&n; */
id|STATIC
r_int
DECL|function|asc_prt_stats
id|asc_prt_stats
c_func
(paren
r_char
...
id|leftlen
comma
l_string|&quot;&bslash;nAdvanSys SCSI Host Driver Statistics:&bslash;n&quot;
)paren
suffix:semicolon
id|ASC_PRT_STATS_NEXT
c_func
(paren
)paren
suffix:semicolon
...
id|leftlen
comma
l_string|&quot; interrupt %lu, callback %lu, cmd_disable %lu, intr_disable %lu,&bslash;n&quot;
comma
id|s-&gt;interrupt
comma
id|s-&gt;callback
...
id|leftlen
comma
l_string|&quot; error %lu, enqueue %lu, dequeue %lu, rmqueue %lu,&bslash;n&quot;
comma
id|s-&gt;error
comma
id|s-&gt;enqueue
...
id|leftlen
comma
l_string|&quot; cont_cnt %lu, cont_xfer %lu: avg_xfer=%lu kb&bslash;n&quot;
comma
id|s-&gt;cont_cnt
comma
id|s-&gt;cont_xfer
...
id|leftlen
comma
l_string|&quot; sg_cnt %lu, sg_elem %lu, sg_xfer %lu: avg_elem=%lu, avg_size=%lu kb&bslash;n&quot;
comma
id|s-&gt;sg_cnt
comma
id|s-&gt;sg_elem
...
multiline_comment|/*&n; * asc_prt_stats_line()&n; *&n; * If &squot;cp&squot; is NULL print to the console, otherwise print to a buffer.&n; *&n; * Return 0 if printing to the console, otherwise return the number of&n; * bytes written to the buffer.&n; *&n; * Note: If any single line is greater than 160 bytes the stack&n; * will be corrupted. &squot;s[]&squot; is defined to be 160 bytes.&n; */
r_int
DECL|function|asc_prt_stats_line
id|asc_prt_stats_line
c_func
(paren
r_char
...
c_func
(paren
l_string|&quot;hostdata (struct asc_board)&bslash;n&quot;
)paren
suffix:semicolon
id|asc_prt_dvc_var
c_func
...
c_func
(paren
l_string|&quot; overrun_buf %x&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot; int_count %ld, req_count %ld, busy_count %ld, cfg %x, saved_ptr2func %x&bslash;n&quot;
comma
id|h-&gt;int_count
comma
id|h-&gt;req_count
...
id|scsiq-&gt;sg_head-&gt;entry_to_copy
op_assign
id|scsiq-&gt;sg_head-&gt;entry_cnt
suffix:semicolon
id|n_q_required
...
DECL|variable|_sdtr_period_tbl_
id|uchar
id|_sdtr_period_tbl_
(braket
id|ASC_SYN_XFER_NO
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: begin&bslash;n&quot;
)paren
suffix:semicolon
id|iop_base
op_assign
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscResetChipAndScsiBus()&bslash;n&quot;
)paren
suffix:semicolon
id|AscResetChipAndScsiBus
c_func
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscFindSignature()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscDisableInterrupt()&bslash;n&quot;
)paren
suffix:semicolon
id|AscDisableInterrupt
c_func
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscInitLram()&bslash;n&quot;
)paren
suffix:semicolon
id|warn_code
op_or_assign
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscLoadMicroCode()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscInitMicroCodeVar()&bslash;n&quot;
)paren
suffix:semicolon
id|warn_code
op_or_assign
...
l_int|3
comma
l_string|&quot;AscInitAsc1000Driver: AscEnableInterrupt()&bslash;n&quot;
)paren
suffix:semicolon
id|AscEnableInterrupt
c_func
...
id|asc_dvc-&gt;dvc_cntl
op_amp
id|ASC_CNTL_NO_PCI_FIX_ASYN_XFER
)paren
)paren
(brace
r_if
...
l_int|3
comma
l_string|&quot;AscInitPollIsrCallBack: done_stat %x, host_stat %x&bslash;n&quot;
comma
...
l_int|3
comma
l_string|&quot;AscInitPollIsrCallBack: isr_callback %x&bslash;n&quot;
comma
(paren
r_int
)paren
...
macro_line|#if CC_TEST_LRAM_ENDIAN
macro_line|#endif
r_int
...
l_int|3
comma
l_string|&quot;AscInitPollTarget: PollScsiInquiry()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;AscInitPollTarget: InitTestUnitReady()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;AscInitPollTarget: PollScsiReadCapacity()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;PollQueueDone: AscExeScsiQueue()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;PollQueueDone: AscPollQDone()&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
l_int|3
comma
l_string|&quot;PollQueueDone: AscPollQDone() status %x&bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
...
l_int|3
comma
l_string|&quot;PollQueueDone: AscAbortSRB() scsiq %x&bslash;n&quot;
comma
(paren
r_int
)paren
...
l_int|3
comma
l_string|&quot;InitTestUnitReady: PollScsiTestUnitReady()&bslash;n&quot;
)paren
suffix:semicolon
id|PollScsiTestUnitReady
c_func
...
l_int|3
comma
l_string|&quot;InitTestUnitReady: done_stat %x&bslash;n&quot;
comma
id|scsiq-&gt;r3.done_stat
)paren
suffix:semicolon
...
l_int|3
comma
l_string|&quot;AscPollQDone: loop %d, err_code %x, done_stat %x, scsi_stat %x&bslash;n&quot;
comma
id|loop
comma
id|asc_dvc-&gt;err_code
...
l_int|3
comma
l_string|&quot;AscPollQDone: AscISR()&bslash;n&quot;
)paren
suffix:semicolon
id|AscISR
c_func
...
l_int|3
comma
l_string|&quot;AscPollQDone: sta %x&bslash;n&quot;
comma
id|sta
)paren
suffix:semicolon
...
r_int
DECL|function|AscVerWriteLramWord
id|AscVerWriteLramWord
c_func
(paren
id|PortAddr
