...
suffix:semicolon
multiline_comment|/* FIXME - if the device implements soft resets, the command will still&n;&t;  be running after the bus reset. In this case we should do nothing&n;&t;  and let the command continue. -ERY */
r_if
c_cond
(paren
id|current_SC
