...
mdefine_line|#define CURRENT_SC&t;  (HOSTDATA(shpnt)-&gt;current_SC)
DECL|macro|ISSUE_SC
...
DECL|macro|ADDMSG
mdefine_line|#define ADDMSG(x)&t;  (MSG(MSGLEN++)=x)
...
c_func
(paren
l_string|&quot;&bslash;naha152x: invalid override SETUP0={0x%x,%d,%d,%d,%d,%d,%d}&bslash;n&quot;
comma
id|override.io_port
comma
id|override.irq
...
c_func
(paren
l_string|&quot;&bslash;naha152x: invalid override SETUP1={0x%x,%d,%d,%d,%d,%d,%d}&bslash;n&quot;
comma
id|override.io_port
comma
id|override.irq
...
c_func
(paren
l_string|&quot;&bslash;naha152x: invalid module argument aha152x=0x%x,%d,%d,%d,%d,%d,%d&bslash;n&quot;
comma
id|setup
(braket
id|setup_count
...
c_func
(paren
l_string|&quot;&bslash;naha152x: invalid module argument aha152x1=0x%x,%d,%d,%d,%d,%d,%d&bslash;n&quot;
comma
id|setup
(braket
id|setup_count
...
c_func
(paren
l_string|&quot;detected %d controllers&bslash;n&quot;
comma
id|setup_count
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;aha152x%d: IRQ %d already in use. Configure another.&bslash;n&quot;
comma
id|i
comma
id|setup
...
c_func
(paren
l_string|&quot;&bslash;naha152x%d: Unexpected error code on&quot;
l_string|&quot; requesting IRQ %d.&bslash;n&quot;
comma
id|i
comma
id|setup
...
c_func
(paren
l_string|&quot;unexpected MSGO; rejecting, &quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
c_func
(paren
l_string|&quot;vital data:&bslash;nioports 0x%04x to 0x%04x&bslash;n&quot;
comma
id|shpnt-&gt;io_port
comma
id|shpnt-&gt;io_port
...
c_func
(paren
l_string|&quot;current queued %d commands&bslash;n&quot;
comma
id|HOSTDATA
c_func
(paren
...
c_func
(paren
l_string|&quot;enabled debugging options:&bslash;n&quot;
)paren
suffix:semicolon
id|PDEBUG
c_func
...
c_func
(paren
l_string|&quot;queue status:&bslash;nnot yet issued commands:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
