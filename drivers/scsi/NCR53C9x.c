multiline_comment|/* NCR53C9x.c:  Generic SCSI driver code for NCR53C9x chips.&n; *&n; * Originally esp.c : EnhancedScsiProcessor Sun SCSI driver code.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * Most DMA dependencies put in driver specific files by &n; * Jesper Skov (jskov@cygnus.co.uk)&n; */
...
macro_line|#include &quot;sparc_esp.h&quot;
...
macro_line|#endif
macro_line|#if defined(CONFIG_BLZ1230_SCSI)||defined(CONFIG_BLZ2060_SCSI)||defined(CONFIG_CYBERSTORMII_SCSI)
DECL|macro|SYMBIOS_HACK
mdefine_line|#define SYMBIOS_HACK
macro_line|#else
DECL|macro|SYMBIOS_HACK
macro_line|#undef SYMBIOS_HACK
macro_line|#endif
...
macro_line|#if defined(DEBUG_STATE_MACHINE) || defined(DEBUG_ESP)
...
id|printk
(paren
l_string|&quot;Detected SymBIOS chip with no family code.&bslash;n&quot;
)paren
suffix:semicolon
id|version
op_assign
...
id|esp-&gt;config2
suffix:semicolon
macro_line|#ifndef SYMBIOS_HACK
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Set up the HME counters */
id|eregs-&gt;esp_tclow
op_assign
id|i
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Using DVMA for status/message bytes is&n;&t;&t;&t;&t;&t; * unreliable on HME, nice job QLogic.&n;&t;&t;&t;&t;&t; * Happy Meal indeed....&n;&t;&t;&t;&t;&t; */
id|esp_cmd
c_func
(paren
id|esp
...
macro_line|#endif /* CONFIG_SCSI_SUNESP */
r_if
c_cond
(paren
id|esp-&gt;erev
