multiline_comment|/* NCR53C9x.c:  Generic SCSI driver code for NCR53C9x chips.&n; *&n; * Originally esp.c : EnhancedScsiProcessor Sun SCSI driver code.&n; *&n; * Copyright (C) 1995 David S. Miller (davem@caip.rutgers.edu)&n; *&n; * Most DMA dependencies put in driver specific files by &n; * Jesper Skov (jskov@cygnus.co.uk)&n; *&n; * Set up to use GETREG/SETREG (preprocessor macros in NCR53c9x.h) by&n; * Tymm Twillman (tymm@coe.missouri.edu)&n; */
