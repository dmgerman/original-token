...
(paren
id|KERN_CRIT
l_string|&quot;aic7xxx: possible overflow at first position&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
(paren
id|KERN_CRIT
l_string|&quot;aic7xxx: possible overflow at second position&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
(paren
id|KERN_CRIT
l_string|&quot;aic7xxx: possible overflow at third position&bslash;n&quot;
)paren
suffix:semicolon
id|len
op_add_assign
...
id|lun
suffix:semicolon
multiline_comment|/*&n;     * XXX: Need to fix this to avoid overflow...&n;     * Fixed - gordo.&n;     */
id|size
op_add_assign
id|sprintf
c_func
...
(paren
id|KERN_CRIT
l_string|&quot;aic7xxx: possible overflow at loop %d:%d&bslash;n&quot;
comma
id|target
comma
id|lun
...
l_int|0
suffix:semicolon
multiline_comment|/* off end of file */
)brace
r_else
r_if
c_cond
