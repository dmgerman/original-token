...
id|block
suffix:semicolon
multiline_comment|/*&n;&t;&t;   * Now remove the locks for all of the related hosts.&n;&t;&t;   */
r_for
c_loop
(paren
id|block
...
multiline_comment|/*&n;&t;&t;   * Now wake them up.  We do this in two separate stages to prevent&n;&t;&t;   * race conditions.&n;&t;&t;   */
r_for
c_loop
(paren
id|block
...
multiline_comment|/*&n;&t;&t;   * If we might have deadlocked, get things started again.  Only&n;&t;&t;   * for block devices - character devices should never deadlock.&n;&t;&t;   */
r_if
c_cond
(paren
id|scsi_maybe_deadlocked
