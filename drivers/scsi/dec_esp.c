multiline_comment|/*&n; * dec_esp.c: Driver for SCSI chips on IOASIC based TURBOchannel DECstations&n; *&n; * TURBOchannel changes by Harald Koerfgen&n; *&n; * based on jazz_esp.c:&n; * Copyright (C) 1997 Thomas Bogendoerfer (tsbogend@alpha.franken.de)&n; *&n; * jazz_esp is based on David S. Miller&squot;s ESP driver and cyber_esp&n; */
...
suffix:semicolon
singleline_comment|//&t;&t;panic(&quot;stop&quot;);
op_star
id|isr
op_and_assign
op_complement
...
multiline_comment|/*&n;&t; * This driver will only work on IOASIC machines&n;&t; * so we can avoid an indirect function call here&n;&t; * and flush the writeback buffer the fast way&n;&t; */
id|dummy
op_assign
op_star
id|isr
