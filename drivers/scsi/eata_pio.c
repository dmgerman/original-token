...
DECL|function|eata_pio_scsi_done
r_void
id|eata_pio_scsi_done
(paren
id|Scsi_Cmnd
op_star
id|SCpnt
...
suffix:semicolon
multiline_comment|/* TRUE as long as bytes &n;&t;&t;&t;&t;&t;&t;     are to transfer */
r_if
c_cond
(paren
id|eata_pio_send_command
...
c_func
(paren
l_string|&quot;eata_pio_queue target %d, pid %ld, HBA busy, returning DID_ERROR, done.&bslash;n&quot;
comma
id|cmd-&gt;target
comma
id|cmd-&gt;pid
...
c_func
(paren
l_string|&quot;eata_pio_abort called pid: %ld target: %x lun: %x reason %x&bslash;n&quot;
comma
id|cmd-&gt;pid
comma
id|cmd-&gt;target
...
c_func
(paren
l_string|&quot;HBA no. Boardtype: Revis: EATA: Bus: BaseIO: IRQ: Ch: ID: Pr: QS: SG: CPL:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;scsi%-2d: %.10s v%s 2.0%c  %s %#.4x   %2d   %d   %d   %c  %2d  %2d  %2d&bslash;n&quot;
comma
id|HBA_ptr-&gt;host_no
comma
id|SD
