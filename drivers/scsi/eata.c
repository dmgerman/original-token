...
DECL|macro|ISA_RANGE
mdefine_line|#define ISA_RANGE       0x0fff
DECL|macro|EISA_RANGE
mdefine_line|#define EISA_RANGE      0xfc88
...
c_func
(paren
l_string|&quot;%s: rev. 2.0%c, %s, PORT 0x%03x, IRQ %u, %s, SG %d, &quot;
"&bslash;"
l_string|&quot;Mbox %d, TC %d.&bslash;n&quot;
comma
id|BN
c_func
(paren
...
c_func
(paren
l_string|&quot;EATA/DMA 2.0x: Copyright (C) 1994, 1995, 1996 Dario Ballabio.&bslash;n&quot;
)paren
suffix:semicolon
id|restore_flags
c_func
