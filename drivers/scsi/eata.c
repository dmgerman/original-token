...
mdefine_line|#define MAX_TAGGED_CMD_PER_LUN 16
DECL|macro|SKIP
mdefine_line|#define SKIP 1
DECL|macro|FALSE
...
c_func
(paren
l_string|&quot;%s: address 0x%03x, unusable %s board (%d%d), detaching.&bslash;n&quot;
comma
id|name
comma
id|port_base
...
c_func
(paren
l_string|&quot;%s: 2.0%c, %s 0x%03x, IRQ %u, %s, SG %d, MB %d, TC %d, LC %d, &quot;
"&bslash;"
l_string|&quot;MQ %d.&bslash;n&quot;
comma
id|BN
c_func
(paren
...
c_func
(paren
l_string|&quot;%s: Vers. 0x%x, ocs %u, tar %u, SYNC 0x%x, sec. %u, &quot;
"&bslash;"
l_string|&quot;infol %ld, cpl %ld spl %ld.&bslash;n&quot;
comma
id|name
comma
id|info.version
...
c_func
(paren
l_string|&quot;%s: max_lun %u, pci %u, eisa %u.&bslash;n&quot;
comma
id|name
comma
id|info.max_lun
...
r_continue
suffix:semicolon
multiline_comment|/* Reverse the returned address order */
id|io_port
(braket
id|MAX_PCI
op_minus
...
c_func
(paren
l_string|&quot;EATA/DMA 2.0x: Copyright (C) 1994-1997 Dario Ballabio.&bslash;n&quot;
)paren
suffix:semicolon
id|restore_flags
c_func
