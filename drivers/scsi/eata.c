...
c_func
(paren
l_string|&quot;EATA/DMA 2.0x: Copyright (C) 1994-1999 Dario Ballabio.&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot;%s config options -&gt; tc:%c, lc:%c, mq:%d, eh:%c, rs:%c, et:%c.&bslash;n&quot;
comma
id|driver_name
comma
id|tag_type
...
DECL|function|eata2x_old_abort
r_int
id|eata2x_old_abort
c_func
(paren
...
DECL|function|eata2x_old_reset
r_int
id|eata2x_old_reset
c_func
(paren
