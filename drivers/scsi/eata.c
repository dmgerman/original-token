...
c_func
(paren
l_string|&quot;%s: unusable EISA board found (%d%d%d%d), detaching.&bslash;n&quot;
comma
id|name
comma
id|info.haaval
...
c_func
(paren
l_string|&quot;%s: unusable ISA board found (%d%d%d%d), detaching.&bslash;n&quot;
comma
id|name
comma
id|info.haaval
