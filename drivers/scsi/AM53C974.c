...
multiline_comment|/***********************************************************************&n;* Function : AM53C974_information_transfer(struct Scsi_Host *instance, *&n;*                          unsigned char statreg, unsigned char isreg, *&n;*                         unsigned char instreg, unsigned char cfifo,  *&n;*                         unsigned char dmastatus)                     *&n;*                                                                      *&n;* Purpose : handle phase changes                                       *&n;*                                                                      *&n;* Inputs : instance - which AM53C974                                   *&n;*          statreg - stus register                                     *&n;*          isreg - internal state register                             *&n;*          instreg - interrupt status register                         *&n;*          cfifo - number of bytes in FIFO                             *&n;*          dmastatus - dma status register                             *&n;*                                                                      *&n;* Returns : nothing                                                    *&n;************************************************************************/
