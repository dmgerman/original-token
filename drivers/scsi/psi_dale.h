...
multiline_comment|/************************************************/
DECL|macro|REG_DATA
mdefine_line|#define&t;REG_DATA&t;&t;&t;&t;&t;&t;0x80
DECL|macro|REG_ERROR
mdefine_line|#define&t;REG_ERROR&t;&t;&t;&t;&t;&t;0x84
DECL|macro|REG_SECTOR_COUNT
mdefine_line|#define&t;REG_SECTOR_COUNT&t;&t;&t;&t;0x88
DECL|macro|REG_LBA_0
mdefine_line|#define&t;REG_LBA_0&t;&t;&t;&t;&t;&t;0x8C
DECL|macro|REG_LBA_8
mdefine_line|#define&t;REG_LBA_8&t;&t;&t;&t;&t;&t;0x90
DECL|macro|REG_LBA_16
mdefine_line|#define&t;REG_LBA_16&t;&t;&t;&t;&t;&t;0x94
DECL|macro|REG_LBA_24
mdefine_line|#define&t;REG_LBA_24&t;&t;&t;&t;&t;&t;0x98
DECL|macro|REG_STAT_CMD
mdefine_line|#define&t;REG_STAT_CMD&t;&t;&t;&t;&t;0x9C
DECL|macro|REG_STAT_SEL
mdefine_line|#define&t;REG_STAT_SEL&t;&t;&t;&t;&t;0xA0
DECL|macro|REG_FAIL
mdefine_line|#define&t;REG_FAIL&t;&t;&t;&t;&t;&t;0xB0
DECL|macro|REG_ALT_STAT
mdefine_line|#define&t;REG_ALT_STAT&t;&t;&t;&t;&t;0xB8
DECL|macro|REG_DRIVE_ADRS
mdefine_line|#define&t;REG_DRIVE_ADRS&t;&t;&t;&t;&t;0xBC
DECL|macro|DALE_DATA_SLOW
mdefine_line|#define&t;DALE_DATA_SLOW&t;&t;&t;&t;&t;0x00040000L
DECL|macro|DALE_DATA_MODE2
mdefine_line|#define&t;DALE_DATA_MODE2&t;&t;&t;&t;&t;0x00040000L
DECL|macro|DALE_DATA_MODE3
mdefine_line|#define&t;DALE_DATA_MODE3&t;&t;&t;&t;&t;0x00050000L
DECL|macro|DALE_DATA_MODE4
mdefine_line|#define&t;DALE_DATA_MODE4&t;&t;&t;&t;&t;0x00060000L
DECL|macro|DALE_DATA_MODE4P
mdefine_line|#define&t;DALE_DATA_MODE4P&t;&t;&t;&t;0x00070000L
...
mdefine_line|#define&t;DALE_CHANNEL_DEVICE_0&t;&t;&t;0&t;&t;
singleline_comment|// device channel locations
DECL|macro|DALE_CHANNEL_DEVICE_1
mdefine_line|#define&t;DALE_CHANNEL_DEVICE_1&t;&t;&t;1
DECL|macro|DALE_CHANNEL_DEVICE_2
mdefine_line|#define&t;DALE_CHANNEL_DEVICE_2&t;&t;&t;2
DECL|macro|DALE_CHANNEL_DEVICE_3
mdefine_line|#define&t;DALE_CHANNEL_DEVICE_3&t;&t;&t;3
DECL|macro|DALE_SCRATH_DEVICE_0
mdefine_line|#define&t;DALE_SCRATH_DEVICE_0&t;&t;&t;4&t;&t;
singleline_comment|// device type codes
DECL|macro|DALE_SCRATH_DEVICE_1
mdefine_line|#define&t;DALE_SCRATH_DEVICE_1&t;&t;&t;5
DECL|macro|DALE_SCRATH_DEVICE_2
mdefine_line|#define DALE_SCRATH_DEVICE_2&t;&t;&t;6
DECL|macro|DALE_SCRATH_DEVICE_3
mdefine_line|#define&t;DALE_SCRATH_DEVICE_3&t;&t;&t;7
DECL|macro|DALE_RAID_0_STATUS
mdefine_line|#define&t;DALE_RAID_0_STATUS&t;&t;&t;&t;8
DECL|macro|DALE_RAID_1_STATUS
mdefine_line|#define DALE_RAID_1_STATUS&t;&t;&t;&t;9
DECL|macro|DALE_TIMING_MODE
mdefine_line|#define&t;DALE_TIMING_MODE&t;&t;&t;&t;12&t;&t;
singleline_comment|// bus master timing mode (2, 3, 4, 5)
DECL|macro|DALE_NUM_DRIVES
mdefine_line|#define&t;DALE_NUM_DRIVES&t;&t;&t;&t;&t;13&t;&t;
singleline_comment|// number of addressable drives on this board
DECL|macro|DALE_RAID_ON
mdefine_line|#define&t;DALE_RAID_ON&t;&t;&t;&t;&t;14 &t;&t;
singleline_comment|// RAID status On
DECL|macro|DALE_LAST_ERROR
mdefine_line|#define&t;DALE_LAST_ERROR&t;&t;&t;&t;&t;15&t;&t;
singleline_comment|// Last error code from BIOS
multiline_comment|/************************************************/
multiline_comment|/*&t;&t;Dale cable select bits&t;&t;&t;&t;&t;*/
multiline_comment|/************************************************/
DECL|macro|SEL_NONE
mdefine_line|#define&t;SEL_NONE&t;&t;&t;&t;&t;&t;0x00
DECL|macro|SEL_1
mdefine_line|#define&t;SEL_1&t;&t;&t;&t;&t;&t;&t;0x01
DECL|macro|SEL_2
mdefine_line|#define&t;SEL_2&t;&t;&t;&t;&t;&t;&t;0x02
multiline_comment|/************************************************/
multiline_comment|/*&t;&t;Programmable Interrupt Controller&t;&t;*/
multiline_comment|/************************************************/
DECL|macro|PIC1
mdefine_line|#define&t;PIC1&t;&t;&t;&t;&t;&t;&t;0x20&t;&t;
singleline_comment|// first 8259 base port address
DECL|macro|PIC2
mdefine_line|#define&t;PIC2&t;&t;&t;&t;&t;&t;&t;0xA0&t;&t;
singleline_comment|// second 8259 base port address
DECL|macro|INT_OCW1
mdefine_line|#define&t;INT_OCW1&t;&t;&t;&t;&t;&t;1&t;&t;&t;
singleline_comment|// Operation Control Word 1: IRQ mask
DECL|macro|EOI
mdefine_line|#define&t;EOI&t;&t;&t;&t;&t;&t;&t;&t;0x20&t;&t;
