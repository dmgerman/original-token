...
id|link_id
suffix:semicolon
multiline_comment|/* reference cp for linked commands */
DECL|member|sglist
r_struct
id|sg_list
op_star
...
c_func
(paren
l_string|&quot;%s: %s 0x%03x, BIOS 0x%05x, IRQ %u, %s, SG %d, MB %d, UC %d, &quot;
"&bslash;"
l_string|&quot;LC %d, MQ %d.&bslash;n&quot;
comma
id|BN
c_func
(paren
...
c_func
(paren
l_string|&quot;%s: qcomm, target %d.%d:%d, pid %ld, Mbox %d ready.&bslash;n&quot;
comma
id|BN
c_func
(paren
...
DECL|function|process_ready_list
r_static
r_inline
r_void
id|process_ready_list
c_func
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;%s: ihdlr, target %d.%d:%d, pid %ld, Mbox %d, link_id %d, &quot;
"&bslash;"
l_string|&quot;n_ready %d, adapter busy, will abort.&bslash;n&quot;
comma
id|BN
c_func
(paren
...
c_func
(paren
l_string|&quot;%s: ihdlr, target %d.%d:%d, pid %ld, Mbox %d in use, link_id %d,&quot;
l_string|&quot; n_ready %d.&bslash;n&quot;
comma
id|BN
c_func
(paren
