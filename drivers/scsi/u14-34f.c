...
DECL|macro|SKIP
mdefine_line|#define SKIP UINT_MAX
DECL|macro|FALSE
...
c_func
(paren
l_string|&quot;%s: %s 0x%03x, BIOS 0x%05x, IRQ %u, %s, SG %d, MB %d, of:%c, &quot;
"&bslash;"
l_string|&quot;lc:%c, mq:%d.&bslash;n&quot;
comma
id|BN
c_func
(paren
...
c_func
(paren
l_string|&quot;UltraStor 14F/34F: Copyright (C) 1994-1997 Dario Ballabio.&bslash;n&quot;
)paren
suffix:semicolon
id|restore_flags
c_func
...
c_func
(paren
l_string|&quot;%s: qcomm, target %d.%d:%d, pid %ld, request sense ignored.&bslash;n&quot;
comma
id|BN
c_func
(paren
