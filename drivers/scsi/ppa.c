multiline_comment|/* ppa.c   --  low level driver for the IOMEGA PPA3 &n; * parallel port SCSI host adapter.&n; * &n; * (The PPA3 is the embedded controller in the ZIP drive.)&n; * &n; * (c) 1995,1996 Grant R. Guenther, grant@torque.net,&n; * under the terms of the GNU Public License.&n; * &n; * Current Maintainer: David Campbell (Perth, Western Australia, GMT+0800)&n; *                     campbell@gear.torque.net&n; *                     dcampbel@p01.as17.honeywell.com.au&n; */
...
suffix:semicolon
multiline_comment|/* Whe can safe schedule() here */
id|ppb
op_assign
id|PPA_BASE
c_func
...
multiline_comment|/*&n; * Here is the asm code for the SPP/PS2 protocols for the i386.&n; * This has been optimised for speed on 386/486 machines. There will&n; * be very little improvement on the current 586+ machines as it is the&n; * IO statements which will limit throughput.&n; */
macro_line|#ifdef __i386__
DECL|macro|BYTE_OUT
mdefine_line|#define BYTE_OUT(reg) &bslash;&n;&t;&quot;&t;movb &quot; #reg &quot;,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;addl $2,%%edx&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb $0x0e,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb $0x0c,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;subl $2,%%edx&bslash;n&quot;
...
"&bslash;"
l_string|&quot;&t;movl (%%esi),%%ebx&bslash;n&quot;
"&bslash;"
id|BYTE_OUT
c_func
(paren
...
"&bslash;"
l_string|&quot;&t;rorl $16,%%ebx&bslash;n&quot;
"&bslash;"
id|BYTE_OUT
c_func
(paren
...
"&bslash;"
l_string|&quot;&t;addl $4,%%esi&bslash;n&quot;
"&bslash;"
...
"&bslash;"
l_string|&quot;&t;incl %%esi&bslash;n&quot;
"&bslash;"
l_string|&quot;&t;loop .loop_loose_bo&bslash;n&quot;
"&bslash;"
...
DECL|macro|BYTE_IN
mdefine_line|#define BYTE_IN(reg) &bslash;&n;&t;&quot;&t;inb (%%dx),%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb %%al,&quot; #reg &quot;&bslash;n&quot; &bslash;&n;&t;&quot;&t;addl $2,%%edx&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb $0x27,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb $0x25,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;subl $2,%%edx&bslash;n&quot;
...
l_string|&quot;&t;rorl $16,%%ebx&bslash;n&quot;
"&bslash;"
l_string|&quot;&t;movl %%ebx,(%%esi)&bslash;n&quot;
"&bslash;"
l_string|&quot;&t;addl $4,%%esi&bslash;n&quot;
"&bslash;"
...
l_string|&quot;&t;incl %%esi&bslash;n&quot;
"&bslash;"
l_string|&quot;&t;loop .loop_loose_bi&bslash;n&quot;
"&bslash;"
...
DECL|macro|NIBBLE_IN
mdefine_line|#define NIBBLE_IN(reg) &bslash;&n;&t;&quot;&t;incl %%edx&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb $0x04,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;decl %%edx&bslash;n&quot; &bslash;&n;&t;&quot;&t;inb (%%dx),%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;andb $0xf0,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb %%al,&quot; #reg &quot;&bslash;n&quot; &bslash;&n;&t;&quot;&t;incl %%edx&bslash;n&quot; &bslash;&n;&t;&quot;&t;movb $0x06,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;outb %%al,(%%dx)&bslash;n&quot; &bslash;&n;&t;&quot;&t;decl %%edx&bslash;n&quot; &bslash;&n;&t;&quot;&t;inb (%%dx),%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;shrb $4,%%al&bslash;n&quot; &bslash;&n;&t;&quot;&t;orb %%al,&quot; #reg &quot;&bslash;n&quot;
...
l_string|&quot;&t;incl %%esi&bslash;n&quot;
"&bslash;"
l_string|&quot;&t;loop .loop_loose_ni&bslash;n&quot;
"&bslash;"
...
macro_line|#else&t;&t;&t;&t;/* Old style C routines */
DECL|function|ppa_byte_out
r_static
r_inline
r_int
...
suffix:semicolon
macro_line|#if CONFIG_SCSI_PPA_HAVE_PEDANTIC &gt; 1
id|r
op_assign
id|ppa_epp_out
c_func
...
op_decrement
suffix:semicolon
multiline_comment|/* This is a SCSI BUS reset signal */
r_if
c_cond
(paren
op_logical_neg
...
l_int|1
suffix:semicolon
multiline_comment|/* wait that ppa_wakeup claims parport */
r_case
l_int|1
suffix:colon
...
suffix:semicolon
multiline_comment|/*&n;     * PHASE1:&n;     * Bring the interface crashing down on whatever is running&n;     * hopefully this will kill the request.&n;     * Bring back up the interface, reset the drive (and anything&n;     * attached for that manner)&n;     */
r_if
c_cond
(paren
id|cmd
...
multiline_comment|/*&n;     * PHASE2:&n;     * Sanity check for the sake of mid-level driver&n;     */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;ppa bus reset called for invalid command.&bslash;n&quot;
)paren
suffix:semicolon
r_return
...
multiline_comment|/*&n;     * PHASE3:&n;     * Flag the current command as having died due to reset&n;     */
id|ppa_connect
c_func
(paren
id|host_no
...
suffix:semicolon
multiline_comment|/* Since the command was already on the timer queue ppa_interrupt&n;     * will be called shortly.&n;     */
r_return
