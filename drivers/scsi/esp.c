...
mdefine_line|#define ESP_IS_MY_DVMA(esp, dma)  &bslash;&n;&t;(!dma-&gt;SBus_dev || &bslash;&n;&t; ((esp-&gt;edev-&gt;my_bus == dma-&gt;SBus_dev-&gt;my_bus) &amp;&amp; &bslash;&n;          (esp-&gt;edev-&gt;slot == dma-&gt;SBus_dev-&gt;slot) &amp;&amp; &bslash;&n;&t;  (!strcmp(dma-&gt;SBus_dev-&gt;prom_name, &quot;dma&quot;) || &bslash;&n;&t;   !strcmp(dma-&gt;SBus_dev-&gt;prom_name, &quot;espdma&quot;))))
id|esp_node
op_assign
...
r_else
(brace
multiline_comment|/* On HME, two reg sets exist, first is DVMA,&n;&t;&t; * second is ESP registers.&n;&t;&t; */
id|esp-&gt;eregs
op_assign
id|eregs
op_assign
...
macro_line|#else
multiline_comment|/* On Ultra we must always call request_irq for each&n;&t; * esp, so that imap registers get setup etc.&n;&t; */
id|dcookie.real_dev_id
op_assign
id|esp
suffix:semicolon
