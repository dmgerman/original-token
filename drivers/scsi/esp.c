multiline_comment|/* esp.c:  EnhancedScsiProcessor Sun SCSI driver code.&n; *&n; * Copyright (C) 1995, 1998 David S. Miller (davem@caip.rutgers.edu)&n; */
...
macro_line|#else
DECL|macro|esp_cmd
mdefine_line|#define esp_cmd(__esp, __eregs, __cmd)&t;(__eregs)-&gt;esp_cmd = (__cmd)
macro_line|#endif
...
mdefine_line|#define esp_setcount(__eregs, __cnt, __hme) &bslash;&n;&t;(__eregs)-&gt;esp_tclow = ((__cnt) &amp; 0xff); &bslash;&n;&t;(__eregs)-&gt;esp_tcmed = (((__cnt) &gt;&gt; 8) &amp; 0xff); &bslash;&n;&t;if(__hme) { &bslash;&n;&t;&t;(__eregs)-&gt;fas_rlo = 0; &bslash;&n;&t;&t;(__eregs)-&gt;fas_rhi = 0; &bslash;&n;&t;}
DECL|macro|esp_getcount
mdefine_line|#define esp_getcount(__eregs) &bslash;&n;&t;((((__eregs)-&gt;esp_tclow)&amp;0xff) | &bslash;&n;&t; ((((__eregs)-&gt;esp_tcmed)&amp;0xff) &lt;&lt; 8))
DECL|macro|fcount
mdefine_line|#define fcount(__esp, __eregs) &bslash;&n;&t;(((__esp)-&gt;erev == fashme) ? &bslash;&n;&t;  (__esp)-&gt;hme_fifo_workaround_count : &bslash;&n;&t;  (__eregs)-&gt;esp_fflags &amp; ESP_FF_FBYTES)
DECL|macro|fnzero
mdefine_line|#define fnzero(__esp, __eregs) &bslash;&n;&t;(((__esp)-&gt;erev == fashme) ? 0 : &bslash;&n;&t; (__eregs)-&gt;esp_fflags &amp; ESP_FF_ONOTZERO)
