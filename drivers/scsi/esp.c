...
id|i
suffix:semicolon
multiline_comment|/* Hold off if we&squot;ve been reselected or an IRQ is showing... */
r_if
c_cond
(paren
id|esp-&gt;disconnected_SC
...
suffix:semicolon
multiline_comment|/* XXX The casts are extremely gross, but with 64-bit kernel&n;&t;&t; * XXX and 32-bit SBUS what am I to do? -DaveM&n;&t;&t; */
id|SCpnt-&gt;SCp.ptr
op_assign
(paren
r_char
...
suffix:semicolon
multiline_comment|/* XXX Again these casts are sick... -DaveM */
id|SCpnt-&gt;SCp.ptr
op_assign
(paren
r_char
...
id|DMA_RST_SCSI
suffix:semicolon
multiline_comment|/* This would explain a lot. */
id|tmp
op_or_assign
(paren
id|DMA_PARITY_OFF
...
multiline_comment|/* This cannot be done until this very moment. -DaveM */
id|synchronize_irq
c_func
(paren
)paren
