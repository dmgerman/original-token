...
id|Sg_device
suffix:semicolon
multiline_comment|/* 40 bytes long on i386 */
r_static
r_int
id|sg_fasync
c_func
...
(brace
multiline_comment|/* assumed to be called with sg_dev_arr_lock held */
...
(brace
multiline_comment|/* if this is to be locked remember that it is called from _bh */
id|Sg_request
op_star
id|srp
suffix:semicolon
