...
id|sg_version_str
op_assign
l_string|&quot;Version: 3.1.10 (20000123)&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Need to add &squot;rwlock_t sg_rw_lock = RW_LOCK_UNLOCKED;&squot; for list protection */
...
id|done
suffix:semicolon
multiline_comment|/* 1 -&gt; bh handler done, 0 -&gt; prior to bh */
...
id|EAGAIN
suffix:semicolon
multiline_comment|/* No available command blocks, or, interrupted while waiting */
)brace
...
suffix:semicolon
multiline_comment|/* dxfer_len overwrites SCpnt-&gt;bufflen, hence need for b_malloc_len */
r_return
l_int|0
suffix:semicolon
)brace
...
id|result
suffix:semicolon
multiline_comment|/* Don&squot;t do anything till scsi mid level visibility */
r_return
l_int|0
suffix:semicolon
r_case
...
c_func
(paren
l_string|&quot;sg_attach: rejected since exceeds dev_max=%d&bslash;n&quot;
comma
id|sg_template.dev_max
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Need to stop sg_cmd_done_bh() playing with this list during this loop */
...
c_func
(paren
l_string|&quot;sg_dev_arr NULL, death is imminent&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
c_func
(paren
l_string|&quot;   FD(%d): timeout=%d bufflen=%d &quot;
...
c_func
(paren
l_string|&quot; sgat=%d op=0x%02x&bslash;n&quot;
comma
id|usg
comma
(paren
...
c_func
(paren
l_string|&quot;host&bslash;tchan&bslash;tid&bslash;tlun&bslash;ttype&bslash;tdiscon&bslash;tqdepth&bslash;ttq&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
