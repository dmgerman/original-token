...
c_func
(paren
l_string|&quot;mesh: expected 2 addrs and intrs (got %d/%d)&quot;
comma
id|mesh-&gt;n_addrs
comma
id|mesh-&gt;n_intrs
...
c_func
(paren
l_string|&quot;couldn&squot;t register mesh host&quot;
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;mesh_queue %p: command is&quot;
comma
id|cmd
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;    ct=%4x seq=%2x bs=%4x fc=%2x exc=%2x err=%2x sp=%2x&bslash;n&quot;
comma
(paren
id|mr-&gt;count_hi
op_lshift
...
(paren
id|KERN_DEBUG
l_string|&quot;    goes_out=%d dma_st=%d dma_ct=%d n_msgout=%d&bslash;n&quot;
comma
id|ms-&gt;data_goes_out
comma
id|ms-&gt;dma_started
...
(paren
id|KERN_DEBUG
l_string|&quot;    target %d: req=%p phase=%d saved_ptr=%d&bslash;n&quot;
comma
id|t
comma
id|tp-&gt;current_req
...
suffix:semicolon
multiline_comment|/* asynchronous initially */
id|out_le32
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;inappropriate mesh_start (ms=%p)&quot;
comma
id|ms
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;mesh: start_phase but no cmd?&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;mesh: reselected in phase %d/%d&bslash;n&quot;
comma
id|ms-&gt;msgphase
comma
id|ms-&gt;phase
...
(paren
id|KERN_DEBUG
l_string|&quot;mesh: saved_ptr=%x phase=%d cmd=%p&bslash;n&quot;
comma
id|tp-&gt;saved_ptr
comma
id|tp-&gt;phase
...
(paren
id|KERN_DEBUG
l_string|&quot;mesh_intr, bs0=%x int=%x exc=%x err=%x phase=%d msgphase=%d&bslash;n&quot;
comma
id|mr-&gt;bus_status0
comma
id|mr-&gt;interrupt
...
(paren
id|KERN_ERR
l_string|&quot;mesh: parity error&bslash;n&quot;
)paren
suffix:semicolon
id|stat
op_assign
...
(brace
multiline_comment|/* This can happen if we issue a command to&n;&t;&t;&t;&t;   get the bus just after the target&n;&t;&t;&t;&t;   reselects us. */
r_static
r_int
...
(paren
id|KERN_ERR
l_string|&quot;mesh: error %x (exc = %x)&bslash;n&quot;
comma
id|err
comma
id|exc
...
(brace
multiline_comment|/* target wants to do something different:&n;&t;&t;&t;   find out what it wants and do it. */
id|phase_mismatch
c_func
(paren
id|ms
...
(paren
id|KERN_WARNING
l_string|&quot;mesh: rejecting message %x from target %d&bslash;n&quot;
comma
id|ms-&gt;msgin
(braket
l_int|0
