...
multiline_comment|/*&n; *&t;PIO data transfer routines using the scather gather table.&n; */
...
(paren
id|KERN_ERR
l_string|&quot;ide-scsi: scather gather table too small, discarding data&bslash;n&quot;
)paren
suffix:semicolon
id|idescsi_discard_data
(paren
...
(paren
id|KERN_ERR
l_string|&quot;ide-scsi: scather gather table too small, padding with zeros&bslash;n&quot;
)paren
suffix:semicolon
id|idescsi_output_zeros
(paren
