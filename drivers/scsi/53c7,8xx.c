...
id|real
suffix:semicolon
macro_line|#endif /* def SCSI_MALLOC */
id|tmp-&gt;size
op_assign
id|size
suffix:semicolon
multiline_comment|/* Insert all but last into list */
r_if
c_cond
(paren
id|i
...
suffix:semicolon
multiline_comment|/*&n;     * XXX - we need to figure this size based on whether&n;     * or not we&squot;ll be using any additional messages.&n;     */
id|patch_dsa_32
c_func
(paren
id|tmp-&gt;dsa
...
multiline_comment|/*&n; * Function : static int shutdown (struct Scsi_Host *host)&n; * &n; * Purpose : does a clean (we hope) shutdown of the NCR SCSI &n; *&t;chip.  Use prior to dumping core, unloading the NCR driver,&n; *&t;etc.&n; * &n; * Returns : 0 on success&n; */
...
suffix:semicolon
multiline_comment|/* &n; * For now, we take the simplest solution : reset the SCSI bus. Eventually,&n; * - If a command is connected, kill it with an ABORT message&n; * - If commands are disconnected, connect to each target/LUN and &n; *&t;do a ABORT, followed by a SOFT reset, followed by a hard &n; *&t;reset.  &n; */
id|NCR53c7x0_write8
c_func
(paren
id|SCNTL1_REG
...
suffix:semicolon
multiline_comment|/* FIXME : need to recursively free tpnt structure */
r_if
c_cond
(paren
id|host-&gt;irq
