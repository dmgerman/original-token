...
multiline_comment|/*&n;&t; * This is a temporary hack for the time being.&n;&t; * In some cases, the ll_rw_blk layer is creating&n;&t; * bounce buffers for us - this implies that we don&squot;t&n;&t; * need to down here, but queue management becomes quite&n;&t; * difficult otherwise.  When the ll_rw_blk layer gets&n;&t; * cleaned up to handle bounce buffers better, then&n;&t; * this hack can be cleaned up.&n;&t; */
r_if
c_cond
(paren
id|sector
...
c_func
(paren
l_string|&quot;Unable to merge ambiguous block request&quot;
)paren
suffix:semicolon
)brace
)brace
