multiline_comment|/************************************************************************&n; * GDT ISA/EISA/PCI Disk Array Controller driver for Linux              *&n; *                                                                      *&n; * gdth.c                                                               *&n; * Copyright (C) 1995-97 ICP vortex Computersysteme GmbH, Achim Leubner *&n; *                                                                      *&n; * &lt;achim@vortex.de&gt;                                                    *&n; *                                                                      *&n; * This program is free software; you can redistribute it and/or modify *&n; * it under the terms of the GNU General Public License as published    *&n; * by the Free Software Foundation; either version 2 of the License,    *&n; * or (at your option) any later version.                               *&n; *                                                                      *&n; * This program is distributed in the hope that it will be useful,      *&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of       *&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the         *&n; * GNU General Public License for more details.                         *&n; *                                                                      *&n; * You should have received a copy of the GNU General Public License    *&n; * along with this kernel; if not, write to the Free Software           *&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.            *&n; *                                                                      *&n; * Tested with Linux 1.2.13, ..., 2.1.61                                *&n; *                                                                      *&n; * $Log: gdth.c,v $&n; * Revision 1.10  1997/10/31 12:29:57  achim&n; * Read heads/sectors from host drive&n; *&n; * Revision 1.9  1997/09/04 10:07:25  achim&n; * IO-mapping with virt_to_bus(), readb(), writeb(), ...&n; * register_reboot_notifier() to get a notify on shutdown used&n; *&n; * Revision 1.8  1997/04/02 12:14:30  achim&n; * Version 1.00 (see gdth.h), tested with kernel 2.0.29&n; *&n; * Revision 1.7  1997/03/12 13:33:37  achim&n; * gdth_reset() changed, new async. events&n; *&n; * Revision 1.6  1997/03/04 14:01:11  achim&n; * Shutdown routine gdth_halt() implemented&n; *&n; * Revision 1.5  1997/02/21 09:08:36  achim&n; * New controller included (RP, RP1, RP2 series)&n; * IOCTL interface implemented&n; *&n; * Revision 1.4  1996/07/05 12:48:55  achim&n; * Function gdth_bios_param() implemented&n; * New constant GDTH_MAXC_P_L inserted&n; * GDT_WRITE_THR, GDT_EXT_INFO implemented&n; * Function gdth_reset() changed&n; *&n; * Revision 1.3  1996/05/10 09:04:41  achim&n; * Small changes for Linux 1.2.13&n; *&n; * Revision 1.2  1996/05/09 12:45:27  achim&n; * Loadable module support implemented&n; * /proc support corrections made&n; *&n; * Revision 1.1  1996/04/11 07:35:57  achim&n; * Initial revision&n; *&n; *&n; * $Id: gdth.c,v 1.10 1997/10/31 12:29:57 achim Exp $ &n; ************************************************************************/
...
c_func
(paren
l_string|&quot;GDT-PCI: error %s reading configuration space&quot;
comma
id|pcibios_strerror
c_func
(paren
