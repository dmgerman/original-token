...
id|cnt
suffix:semicolon
multiline_comment|/* GDT PCI ctr. found, now read resources from config space */
macro_line|#if LINUX_VERSION_CODE &gt;= 0x010300
...
(paren
(paren
l_string|&quot;GET_IOCHAN_DESC supported!&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|ha-&gt;bus_cnt
...
suffix:semicolon
multiline_comment|/* read board info, fill ctr_name[] */
r_if
c_cond
(paren
id|gdth_internal_cmd
...
(paren
(paren
l_string|&quot;BOARD_INFO supported!&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|strcpy
...
(brace
multiline_comment|/* raw device: evaluate mapping (sectors per head, heads per cylinder) */
r_if
c_cond
(paren
id|disk-&gt;capacity
...
(paren
(paren
l_string|&quot;gdth_bios_param(): raw device -&gt; params evaluated&bslash;n&quot;
)paren
)paren
suffix:semicolon
)brace
