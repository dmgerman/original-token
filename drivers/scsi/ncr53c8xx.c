...
macro_line|#if LINUX_VERSION_CODE &gt;= LinuxVersionCode(2,1,93)
macro_line|#if 0&t;/* not yet needed */
r_static
id|spinlock_t
id|driver_lock
suffix:semicolon
...
macro_line|#else
macro_line|#if 0&t;/* not yet needed */
mdefine_line|#define&t;NCR_LOCK_DRIVER(flags)     do {;} while (0)
mdefine_line|#define&t;NCR_UNLOCK_DRIVER(flags)   do {;} while (0)
macro_line|#endif
DECL|macro|NCR_INIT_LOCK_NCB
...
macro_line|#endif
multiline_comment|/*&n;**&t;Address translation&n;**&n;**&t;The driver has to provide physical memory addresses to &n;**&t;the script processor. Because some architectures use &n;**&t;different physical addresses from the PCI BUS, we must &n;**&t;use virt_to_bus instead of virt_to_phys.&n;*/
DECL|macro|vtophys
...
macro_line|#endif&t;/* __i386__ || !NCR_IOMAPPED */
...
DECL|macro|CACHE_LINE_SHIFT
mdefine_line|#define CACHE_LINE_SHIFT&t;5
DECL|macro|CACHE_LINE_SIZE
mdefine_line|#define CACHE_LINE_SIZE&t;&t;ALIGN_SIZE(CACHE_LINE_SHIFT)
DECL|macro|CACHE_LINE_MASK
mdefine_line|#define CACHE_LINE_MASK&t;&t;ALIGN_MASK(CACHE_LINE_SHIFT)
...
suffix:semicolon
multiline_comment|/* 0x00 */
DECL|macro|SYMBIOS_REMOVABLE_FLAGS
mdefine_line|#define SYMBIOS_REMOVABLE_FLAGS&t;(3)&t;&t;/* 0=none, 1=bootable, 2=all */
DECL|member|host_id
id|u_char
id|host_id
suffix:semicolon
...
DECL|macro|assert
mdefine_line|#define&t;assert(expression) { &bslash;&n;&t;if (!(expression)) { &bslash;&n;&t;&t;(void)printk(KERN_ERR &bslash;&n;&t;&t;&t;&quot;assertion &bslash;&quot;%s&bslash;&quot; failed: file &bslash;&quot;%s&bslash;&quot;, line %d&bslash;n&quot;, &bslash;&n;&t;&t;&t;#expression, &bslash;&n;&t;&t;&t;__FILE__, __LINE__); &bslash;&n;&t;} &bslash;&n;}
...
l_int|0
comma
multiline_comment|/* CHECK THE SOURCE FOR &squot;send_wdtr&squot; IF YOU INTEND TO CHANGE SOMETHING HERE */
id|SCR_INT
op_xor
id|IFFALSE
(paren
...
l_int|0
comma
multiline_comment|/* CHECK THE SOURCE FOR &squot;send_sdtr&squot; IF YOU INTEND TO CHANGE SOMETHING HERE */
id|SCR_INT
op_xor
id|IFFALSE
(paren
...
macro_line|#ifdef&t;SCSI_NCR_SHARE_IRQ
DECL|macro|NCR_SA_INTERRUPT_FLAGS
mdefine_line|#define&t;NCR_SA_INTERRUPT_FLAGS (SA_INTERRUPT | SA_SHIRQ)
r_if
c_cond
(paren
id|bootverbose
...
id|printk
(paren
l_string|&quot;SYNC transfers not supported.&bslash;n&quot;
)paren
suffix:semicolon
)brace
suffix:semicolon
...
l_int|8
suffix:semicolon
multiline_comment|/* Should raise SIR_NEGO_PROTO */
)brace
r_break
suffix:semicolon
macro_line|#if 0
...
id|printk
(paren
l_string|&quot;ncr53c8xx: setup=disc:%c,specf:%d,ultra:%d,tags:%d,sync:%d,&quot;
...
id|printk
(paren
l_string|&quot;ncr53c8xx: setup=mpar:%c,spar:%c,fsn=%c,verb:%d,debug:0x%x,&quot;
l_string|&quot;led:%c,settle:%d,irqm:%d,nvram:0x%x,pcifix:0x%x&bslash;n&quot;
comma
id|YesNo
c_func
(paren
...
macro_line|#if defined(__i386__)
multiline_comment|/*&n;&t; *&t;Ignore Symbios chips controlled by SISL RAID controller.&n;&t; */
r_if
c_cond
(paren
id|chip
...
multiline_comment|/*&n;&t; *&t;Several fix-up for power/pc.&n;&t; *&t;Should not be performed by the driver.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
