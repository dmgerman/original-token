...
id|printf
(paren
l_string|&quot;%s: Ultra SCSI support enabled&bslash;n&quot;
comma
id|ncr_name
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Enable clock doubler&t;*/
id|DELAY
c_func
(paren
l_int|10
...
suffix:semicolon
multiline_comment|/* Select clock doubler&t;*/
id|OUTB
c_func
(paren
id|nc_stest3
...
id|printf
(paren
l_string|&quot;%s: enabling clock doubler&bslash;n&quot;
comma
id|ncr_name
c_func
(paren
...
suffix:semicolon
multiline_comment|/* Safe timing for now&t;*/
id|OUTB
c_func
(paren
id|nc_stest1
...
suffix:semicolon
multiline_comment|/*&n;&t;**&t;Deduce the value of controller sync period from scntl3.&n;&t;**&t;p2 is twice this value since we do integer calculations.&n;&t;*&t;(12.5 ns would give inaccurate results)&n;&t;*/
id|p2
op_assign
(paren
id|scntl3
...
id|printf
(paren
l_string|&quot;%s: clock doubler found&bslash;n&quot;
comma
id|ncr_name
c_func
(paren
...
c_func
(paren
l_string|&quot;ncr53c8xx: setup=mpar:%c,spar:%c,fsn=%c,verb:%d,debug:0x%x&bslash;n&quot;
comma
id|YesNo
c_func
(paren
