...
macro_line|#endif
macro_line|#else  /* Incomplete emulation of current PCI code for pre-2.2 kernels */
DECL|typedef|pcidev_t
r_typedef
r_int
r_int
...
suffix:semicolon
DECL|macro|PCIDEV_NULL
mdefine_line|#define PCIDEV_NULL            (~0u)
DECL|macro|PciBusNumber
mdefine_line|#define PciBusNumber(d)                ((d)&gt;&gt;8)
DECL|macro|PciDeviceFn
mdefine_line|#define PciDeviceFn(n)         ((d)&amp;0xff)
DECL|macro|__PciDev
mdefine_line|#define __PciDev(busn, devfn)  (((busn)&lt;&lt;8)+(devfn))
...
macro_line|#endif /* LINUX_VERSION_CODE &gt;= LinuxVersionCode(2,2,0) */
...
id|printk
(paren
l_string|&quot;device did not report SYNC.&bslash;n&quot;
)paren
suffix:semicolon
)brace
suffix:semicolon
...
c_func
(paren
l_string|&quot;ncr53c8xx: NvRAM type=%x trailer=%x %x %x %x %x %x byte_count=%d/%d checksum=%x/%x&bslash;n&quot;
comma
id|nvram-&gt;type
comma
id|nvram-&gt;trailer
