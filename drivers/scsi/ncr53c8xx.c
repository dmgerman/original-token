...
id|printf
(paren
l_string|&quot;%s: DIFF mode set&bslash;n&quot;
comma
id|ncr_name
c_func
(paren
...
c_func
(paren
l_string|&quot;ncr53c8xx: unit=%d chip=%s rev=0x%x base=0x%x, io_port=0x%x, irq=%d&bslash;n&quot;
comma
id|unit
comma
id|chip-&gt;name
...
multiline_comment|/*&n;&t;**&t;Fill in target structure.&n;&t;**&t;Prepare sync negotiation according to actual SCSI bus mode.&n;&t;*/
r_for
c_loop
(paren
id|i
...
multiline_comment|/*==========================================================&n;**&n;**&t;ncr chip exception handler for SCSI bus mode change&n;**&n;**==========================================================&n;**&n;**&t;I&squot;m not quite sure of what is to be done in such a&n;**&t;situation.&n;**&t;For now,&n;**&t;Reset the bus if some devices use too fast sync transfers.&n;**&t;Otherwise, just try to renegotiate sync with targets. &n;**&n;**----------------------------------------------------------&n;*/
...
l_int|0xffffff
suffix:semicolon
multiline_comment|/*&n;&t;**&t;Take into account dma fifo and various buffers and latches,&n;&t;**&t;only if the interrupted phase was DATA OUT.&n;&t;*/
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;&t; * Remove not wished features.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
macro_line|#endif
multiline_comment|/*&n;&t; * Remove features that will not work&n;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/*&n;&t; * Try to attach the controller&n;&t; */
r_return
id|ncr_attach
(paren
id|tpnt
