multiline_comment|/* gdth_proc.c &n; * $Id: gdth_proc.c,v 1.11 1998/12/17 15:52:35 achim Exp $&n; */
...
id|len
comma
l_string|&quot;%s Disk Array Controller&bslash;n&quot;
comma
id|ha-&gt;ctr_name
)paren
suffix:semicolon
...
id|len
comma
l_string|&quot;%s Disk Array Controller (Bus %d)&bslash;n&quot;
comma
id|ha-&gt;ctr_name
comma
id|busnum
