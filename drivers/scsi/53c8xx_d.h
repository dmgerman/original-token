...
l_int|0x00000000
comma
multiline_comment|/*&n;; FIXME : we need to accomodate bit fielded and binary here for &squot;7xx/&squot;8xx chips&n;&t;JUMP REL (wrong_dsa), IF NOT dsa_temp_target, AND MASK 0xf8&n;&n;at 0x00000040 : */
l_int|0x8084f800
comma
l_int|0x00ffff48
comma
...
l_int|0x00000000
comma
multiline_comment|/*&n;; FIXME : we need to accomodate bit fielded and binary here for &squot;7xx/&squot;8xx chips&n;&t;JUMP REL (wrong_dsa), IF NOT dsa_temp_lun, AND MASK 0xf8&n;&n;at 0x0000004b : */
l_int|0x8084f800
comma
l_int|0x00ffff1c
comma
...
l_int|0x00000000
comma
multiline_comment|/*&n;&n;&n;&n;; Note that other_out and other_in loop until a non-data phase&n;; is discoverred, so we only execute return statements when we&n;; can go on to the next data phase block move statement.&n;&n;ENTRY other_out&n;other_out:&n;&n;&n;&n;    INT int_err_unexpected_phase, WHEN CMD&n;&n;at 0x000000cf : */
l_int|0x9a0b0000
comma
l_int|0x00000000
comma
...
DECL|variable|A_addr_reconnect_dsa_head_used
id|u32
...
DECL|variable|A_dsa_restore_pointers_used
id|u32
...
DECL|variable|A_dsa_save_data_pointer_used
id|u32
...
DECL|variable|A_dsa_temp_addr_array_value_used
id|u32
...
DECL|variable|A_dsa_temp_addr_dsa_value_used
id|u32
...
DECL|variable|A_dsa_temp_addr_new_value_used
id|u32
...
DECL|variable|A_dsa_temp_addr_next_used
id|u32
...
DECL|variable|A_dsa_temp_addr_residual_used
id|u32
...
DECL|variable|A_dsa_temp_addr_saved_pointer_used
id|u32
...
DECL|variable|A_dsa_temp_addr_saved_residual_used
id|u32
...
DECL|variable|A_dsa_temp_next_used
id|u32
...
DECL|variable|A_int_debug_panic_used
id|u32
