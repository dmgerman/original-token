multiline_comment|/*&n; * Sun3 SCSI stuff by Erik Verbruggen (erik@bigmama.xtdnet.nl)&n; *&n; * Adapted from mac_scsinew.h:&n; */
...
mdefine_line|#define NCR5380_read(reg) sun3scsi_read(_instance, reg)
DECL|macro|NCR5380_write
mdefine_line|#define NCR5380_write(reg, value) sun3scsi_write(_instance, reg, value)
