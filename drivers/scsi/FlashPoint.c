...
multiline_comment|/*&n;  If CONFIG_PCI is not set, force CONFIG_SCSI_OMIT_FLASHPOINT.&n;*/
...
mdefine_line|#define SccbMgr_config_adapter&t;&t;FlashPoint_HardResetHostAdapter
...
macro_line|#endif
multiline_comment|/*----------------------------------------------------------------------&n; *&n; *&n; *   Copyright 1995-1996 by Mylex Corporation.  All Rights Reserved&n; *&n; *   This file is available under both the GNU General Public License&n; *   and a BSD-style copyright; see LICENSE.FlashPoint for details.&n; *&n; *   $Workfile:   harpoon.h  $&n; *&n; *   Description:  Register definitions for HARPOON ASIC.&n; *&n; *   $Date: 1997/01/31 02:14:28 $&n; *&n; *   $Revision: 1.6 $&n; *&n; *----------------------------------------------------------------------*/
multiline_comment|/*#include &lt;globals.h&gt;*/
...
id|SccbGlobalFlags
suffix:semicolon
macro_line|#ident &quot;$Id: sccb.c 1.17 1997/02/11 21:06:41 mohan Exp $&quot;
multiline_comment|/*----------------------------------------------------------------------&n; *&n; *&n; *   Copyright 1995-1996 by Mylex Corporation.  All Rights Reserved&n; *&n; *   This file is available under both the GNU General Public License&n; *   and a BSD-style copyright; see LICENSE.FlashPoint for details.&n; *&n; *   $Workfile:   sccb.c  $&n; *&n; *   Description:  Functions relating to handling of the SCCB interface&n; *                 between the device driver and the HARPOON.&n; *&n; *   $Date: 1997/02/11 21:06:41 $&n; *&n; *   $Revision: 1.17 $&n; *&n; *----------------------------------------------------------------------*/
multiline_comment|/*#include &lt;globals.h&gt;*/
macro_line|#if (FW_TYPE==_UCB_MGR_)
...
macro_line|#endif
macro_line|#ident &quot;$Id: sccb_dat.c 1.9 1997/01/31 02:12:58 mohan Exp $&quot;
multiline_comment|/*----------------------------------------------------------------------&n; *&n; *&n; *   Copyright 1995-1996 by Mylex Corporation.  All Rights Reserved&n; *&n; *   This file is available under both the GNU General Public License&n; *   and a BSD-style copyright; see LICENSE.FlashPoint for details.&n; *&n; *   $Workfile:   sccb_dat.c  $&n; *&n; *   Description:  Functions relating to handling of the SCCB interface &n; *                 between the device driver and the HARPOON.&n; *&n; *   $Date: 1997/01/31 02:12:58 $&n; *&n; *   $Revision: 1.9 $&n; *&n; *----------------------------------------------------------------------*/
multiline_comment|/*#include &lt;globals.h&gt;*/
macro_line|#if (FW_TYPE==_UCB_MGR_)
multiline_comment|/*#include &lt;budi.h&gt;*/
macro_line|#endif
...
multiline_comment|/*#include &lt;target.h&gt;*/
multiline_comment|/*#include &lt;harpoon.h&gt;*/
macro_line|#if defined(OS2) || defined (SOLARIS_REAL_MODE)
...
macro_line|#ident &quot;$Id: scam.c 1.16 1997/01/31 02:11:12 mohan Exp $&quot;
multiline_comment|/*----------------------------------------------------------------------&n; *&n; *&n; *   Copyright 1995-1996 by Mylex Corporation.  All Rights Reserved&n; *&n; *   This file is available under both the GNU General Public License&n; *   and a BSD-style copyright; see LICENSE.FlashPoint for details.&n; *&n; *   $Workfile:   scam.c  $&n; *&n; *   Description:  Functions relating to handling of the SCAM selection&n; *                 and the determination of the SCSI IDs to be assigned&n; *                 to all perspective SCSI targets.&n; *&n; *   $Date: 1997/01/31 02:11:12 $&n; *&n; *   $Revision: 1.16 $&n; *&n; *----------------------------------------------------------------------*/
multiline_comment|/*#include &lt;globals.h&gt;*/
macro_line|#if (FW_TYPE==_UCB_MGR_)
multiline_comment|/*#include &lt;budi.h&gt;*/
macro_line|#endif
