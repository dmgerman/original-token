...
c_func
(paren
l_string|&quot;HBA no. VID: Boardtype:  Revis: Bus: BaseIO: IRQ: Chan: ID: Prim: QS: SG: CPL:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot; 0x%04x   %2d     %d   %d     %d  %2d  %2d   %2d&bslash;n&quot;
comma
(paren
id|uint
)paren
