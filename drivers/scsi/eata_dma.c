...
id|information
op_assign
l_string|&quot;EATA SCSI HBA Driver&bslash;n&quot;
suffix:semicolon
r_return
id|information
suffix:semicolon
...
c_func
(paren
l_string|&quot;IRQ %d received, base 0x%04x, pid %lx, target: %x, &quot;
l_string|&quot;lun: %x, ea_s: 0x%02x, hba_s: 0x%02x &bslash;n&quot;
comma
id|irq
comma
id|base
...
l_int|16
suffix:semicolon
multiline_comment|/* These two lines are new */
r_break
suffix:semicolon
r_case
l_int|0x02
...
c_func
(paren
l_string|&quot;scsi_stat: 0x%02x, result: 0x%08x&bslash;n&quot;
comma
id|scsi_stat
comma
id|result
...
c_func
(paren
l_string|&quot;Calling scsi_done(%lx)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;returned from scsi_done(%lx)&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;eata_dma: get_conf_PIO, error during transfer for HBA at %lx&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;EATA compliant HBA detected. EATA Level %x&bslash;n&quot;
comma
(paren
id|uint
)paren
...
multiline_comment|/* if gc-&gt;DMA_valid it must be a PM2011 and we have to register it */
id|dma_channel
op_assign
(paren
l_int|8
...
c_func
(paren
l_string|&quot;Unable to allocate DMA channel %d for HBA PM2011.&bslash;n&quot;
comma
id|dma_channel
)paren
suffix:semicolon
...
multiline_comment|/* flag: -1 scan for primary   HBA&n; *        0 scan for secondary HBA&n; * buf :  pointer to data structure for read config command&n; */
...
(brace
multiline_comment|/* We just found a primary EISA, so there is no primary&n;&t;&t;&t; * ISA HBA and we can take it from the EISA list. &n;&t;&t;&t; */
id|ISAbases
(braket
l_int|0
)braket
...
(brace
multiline_comment|/* We&squot;ve found a secondary EISA, so there is no &n;&t;&t;&t; * secondary ISA HBA  */
id|ISAbases
(braket
l_int|1
)braket
...
l_int|0
suffix:semicolon
multiline_comment|/* and we can take it from the list and return it */
id|EISAbases
(braket
id|i
)braket
...
c_func
(paren
l_string|&quot;No vaild IRQ. HBA removed from list&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
c_func
(paren
l_string|&quot;Kernel PCI support not enabled. Skipping.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#else
id|unchar
...
(brace
multiline_comment|/* Check if the address is vaild */
r_if
c_cond
(paren
id|base
...
c_func
(paren
l_string|&quot;Now scanning for PCI HBAs&bslash;n&quot;
)paren
suffix:semicolon
id|find_PCI
c_func
...
c_func
(paren
l_string|&quot;Now scanning for EISA HBAs&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;Now scanning for ISA HBAs&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;&bslash;nRegistered HBAs:&bslash;n&quot;
)paren
suffix:semicolon
id|printk
c_func
(paren
l_string|&quot; # Type: BaseIO: IRQ: Chan: ID: Prim: QS: SG: CPL:&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
c_func
(paren
l_string|&quot;%2d   %c   0x%04x   %2d     %d   %d     %d  %2d  %2d   %2d&bslash;n&quot;
comma
id|i
comma
id|SD
