...
l_string|&quot;unfinished.&bslash;nEATA: %x HBA: %x SCSI: %x spadr %lx &quot;
l_string|&quot;spadrirq %lx, irq%d&bslash;n&quot;
comma
id|base
comma
(paren
...
l_int|8
suffix:semicolon
multiline_comment|/* We artificially limit this to conserve &n;&t;&t;&t;&t;  * memory, which would be needed for ISA &n;&t;&t;&t;&t;  * bounce buffers */
)brace
r_else
id|sh-&gt;cmd_per_lun
op_assign
...
c_func
(paren
l_string|&quot;eata_dma: find_PCI, HBA at bus %d, device %d,&quot;
...
c_func
(paren
l_string|&quot;eata_dma: find_PCI, DEVICECLASSID %x didn&squot;t match&bslash;n&quot;
comma
id|rev_device
)paren
suffix:semicolon
