...
multiline_comment|/*&n;  BusLogic_CreateCCBs allocates the initial CCBs for Host Adapter.&n;*/
...
c_func
(paren
l_string|&quot;Allocated %d additional CCBs&bslash;n&quot;
comma
id|HostAdapter
comma
id|Allocated
