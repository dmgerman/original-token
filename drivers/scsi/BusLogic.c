...
mdefine_line|#define BusLogic_DriverVersion&t;&t;&quot;2.0.11&quot;
DECL|macro|BusLogic_DriverDate
mdefine_line|#define BusLogic_DriverDate&t;&t;&quot;31 January 1998&quot;
...
suffix:semicolon
multiline_comment|/*&n;  BusLogic_Options can be assigned a string by the Loadable Kernel Module&n;  Installation Facility to be parsed for BusLogic Driver Options&n;  specifications.&n;*/
r_static
r_char
DECL|variable|BusLogic_Options
op_star
id|BusLogic_Options
op_assign
l_int|NULL
...
r_else
(brace
id|BusLogic_LastRegisteredHostAdapter-&gt;NextAll
op_assign
id|HostAdapter
suffix:semicolon
id|BusLogic_LastRegisteredHostAdapter
...
id|BusLogic_FirstRegisteredHostAdapter
op_assign
id|BusLogic_FirstRegisteredHostAdapter-&gt;NextAll
suffix:semicolon
r_if
c_cond
(paren
...
l_int|NULL
op_logical_and
id|PreviousHostAdapter-&gt;NextAll
op_ne
id|HostAdapter
)paren
id|PreviousHostAdapter
...
multiline_comment|/*&n;&t;  Issue the Inquire PCI Host Adapter Information command to determine&n;&t;  the ISA Compatible I/O Port.  If the ISA Compatible I/O Port is&n;&t;  known and enabled, note that the particular Standard ISA I/O&n;&t;  Address should not be probed.&n;&t;*/
...
id|Common
suffix:colon
multiline_comment|/*&n;    Initialize the Host Adapter Full Model Name and Interrupt Label fields&n;    from the Model Name.&n;  */
id|strcpy
c_func
(paren
id|HostAdapter-&gt;FullModelName
