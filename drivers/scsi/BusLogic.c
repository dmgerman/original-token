...
suffix:semicolon
multiline_comment|/*&n;  BusLogic_ProbeOptions is a bit mask of Probe Options to be applied&n;  across all Host Adapters.&n;*/
r_static
r_int
...
suffix:semicolon
multiline_comment|/*&n;  BusLogic_IRQ_UsageCount stores a count of the number of Host Adapters using&n;  a given IRQ Channel, which is necessary to support PCI, EISA, or MCA shared&n;  interrupts.&n;*/
r_static
r_int
...
multiline_comment|/*&n;&t;If there are multiple BusLogic PCI SCSI Host Adapters present and if&n;&t;they are enumerated by the PCI BIOS in an order other than by strictly&n;&t;increasing Bus Number and Device Number, then interrogate the setting&n;&t;of the AutoSCSI &quot;Use Bus And Device # For PCI Scanning Seq.&quot; option.&n;&t;If it is ON, and if the first enumeratedBusLogic Host Adapter is a&n;&t;BT-948/958/958D, then sort the PCI Host Adapter I/O Addresses by&n;&t;increasing Bus Number and Device Number so that the Host Adapters are&n;&t;recognized in the same order by the Linux kernel as by the Host&n;&t;Adapter&squot;s BIOS.&n;      */
r_if
c_cond
(paren
id|ProbeAddressCount
...
(brace
multiline_comment|/*&n;&t;&t;Sort the I/O Addresses such that the corresponding&n;&t;&t;PCI devices are in ascending order by Bus Number and&n;&t;&t;Device Number.&n;&t;      */
r_int
id|LastInterchange
op_assign
id|ProbeAddressCount
...
multiline_comment|/*&n;    Issue the Inquire Generic I/O Port Information command to read the&n;    IRQ Channel from all PCI Host Adapters, and the Termination Information&n;    from &quot;W&quot; Series Host Adapters.&n;  */
r_if
c_cond
(paren
id|HostAdapter-&gt;ModelName
...
suffix:semicolon
multiline_comment|/*&n;&t;Save the IRQ Channel in the Host Adapter structure.&n;      */
id|HostAdapter-&gt;IRQ_Channel
op_assign
id|GenericIOPortInformation.PCIAssignedIRQChannel
suffix:semicolon
...
c_func
(paren
l_string|&quot;scsi%d: Illegal CCB #%ld status %d in &quot;
...
c_func
(paren
l_string|&quot;scsi%d: Aborted CCB #%ld to Target %d &quot;
...
c_func
(paren
l_string|&quot;scsi%d: Bus Device Reset CCB #%ld to Target %d Completed&bslash;n&quot;
comma
id|HostAdapter-&gt;HostNumber
comma
id|CCB-&gt;SerialNumber
...
c_func
(paren
l_string|&quot;scsi%d: CCB #%ld to Target %d Impossible State&bslash;n&quot;
comma
id|HostAdapter-&gt;HostNumber
comma
id|CCB-&gt;SerialNumber
...
c_func
(paren
l_string|&quot;scsi%d: CCB #%ld to Target %d Aborted&bslash;n&quot;
comma
id|HostAdapter-&gt;HostNumber
comma
id|CCB-&gt;SerialNumber
...
c_func
(paren
l_string|&quot;scsi%d: CCB #%ld Target %d: Result %X &quot;
...
c_func
(paren
l_string|&quot;scsi%d: Unable to Abort CCB #%ld to Target %d - &quot;
...
c_func
(paren
l_string|&quot;scsi%d: Aborting CCB #%ld to Target %d&bslash;n&quot;
comma
id|HostAdapter-&gt;HostNumber
comma
id|CCB-&gt;SerialNumber
...
c_func
(paren
l_string|&quot;scsi%d: Bus Device Reset already pending to Target %d&bslash;n&quot;
comma
id|HostAdapter-&gt;HostNumber
comma
id|TargetID
...
c_func
(paren
l_string|&quot;scsi%d: Sending Bus Device Reset CCB #%ld to Target %d&bslash;n&quot;
comma
id|HostAdapter-&gt;HostNumber
comma
id|CCB-&gt;SerialNumber
