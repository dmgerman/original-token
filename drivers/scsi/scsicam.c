...
multiline_comment|/*&n; * Function : static int partsize(struct buffer_head *bh, unsigned long &n; *&t;capacity,unsigned int *cyls, unsigned int *hds, unsigned int secs);&n; *&n; * Purpose : to determine the BIOS mapping used to create the partition&n; *&t;table, storing the results in *cyls, *hds, and *secs &n; *&n; * Returns : -1 on failure, 0 on success.&n; *&n; */
