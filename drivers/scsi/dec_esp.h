multiline_comment|/* dec_esp.h: Defines and structures for the JAZZ SCSI driver.&n; *&n; * DECstation changes Copyright (C) 1998 Harald Koerfgen&n; *&n; * based on jazz_esp.h:&n; * Copyright (C) 1997 Thomas Bogendoerfer (tsbogend@alpha.franken.de)&n; */
