...
multiline_comment|/*&n; * Function : const char *t128_info(void)&n; *&n; * Purpose : provide further information about this driver.&n; *&n; * Returns : an empty string.&n; */
