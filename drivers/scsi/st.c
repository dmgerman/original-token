...
id|ST_MAX_BUFFERS
suffix:semicolon
DECL|macro|MAX_SCSI_TAPES
mdefine_line|#define MAX_SCSI_TAPES 8
...
c_func
(paren
l_string|&quot;st: Allocated tape buffer %d.&bslash;n&quot;
comma
id|st_nbr_buffers
)paren
suffix:semicolon
