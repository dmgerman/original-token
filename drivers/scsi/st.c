...
id|st_nbr_buffers
suffix:semicolon
DECL|variable|st_req_nbr_buffers
r_static
r_int
id|st_req_nbr_buffers
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* need to do the check with interrupts off. -RAB */
id|save_flags
c_func
(paren
id|flags
...
id|i
suffix:semicolon
multiline_comment|/*&n;      * If there was a bus reset, block further access&n;      * to this device.  If the user wants to rewind the tape,&n;      * then reset the flag and allow access again.&n;      */
r_if
c_cond
(paren
id|STp-&gt;device-&gt;was_reset
...
multiline_comment|/* FIXME - if we are hitting this because we are loading a tape module&n;  as a loadable driver, we should not use kmalloc - it will allocate&n;  a 64Kb region in order to buffer about 32Kb.  Try using 31 blocks&n;  instead. */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;Not enough memory for buffer %d.&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
