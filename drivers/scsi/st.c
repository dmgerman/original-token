multiline_comment|/*&n;  SCSI Tape Driver for Linux version 1.1 and newer. See the accompanying&n;  file README.st for more information.&n;&n;  History:&n;  Rewritten from Dwayne Forsyth&squot;s SCSI tape driver by Kai Makisara.&n;  Contribution and ideas from several people including (in alphabetical&n;  order) Klaus Ehrenfried, Steve Hirsch, Wolfgang Denk, Andreas Koppenh&quot;ofer,&n;  J&quot;org Weule, and Eric Youngdale.&n;&n;  Copyright 1992 - 1996 Kai Makisara&n;&t;&t; email Kai.Makisara@metla.fi&n;&n;  Last modified: Sun Apr  7 20:33:27 1996 by root@kai.makisara.fi&n;  Some small formal changes - aeb, 950809&n;*/
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*      if (!STp-&gt;modes[mode].defined)&n;&t;return (-ENXIO); */
id|new_session
op_assign
id|TRUE
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;st%d: Can&squot;t set default block size to %d bytes.&bslash;n&quot;
comma
id|dev
comma
id|STm-&gt;default_blksize
...
(paren
id|KERN_WARNING
l_string|&quot;st%d: Can&squot;t set default density to %x.&bslash;n&quot;
comma
id|dev
comma
id|STm-&gt;default_density
...
(brace
multiline_comment|/* Force unless explicitly changed by the user */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_WARNING
l_string|&quot;st%d: Can&squot;t set default density %x.&bslash;n&quot;
comma
id|dev
comma
id|STm-&gt;default_density
...
(paren
id|KERN_INFO
l_string|&quot;st%d:    can bsr: %d, two FMs: %d, fast mteom: %d, auto lock: %d, defs for wr: %d &bslash;n&quot;
comma
id|dev
comma
id|STp-&gt;can_bsr
