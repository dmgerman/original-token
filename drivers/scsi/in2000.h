...
mdefine_line|#define FAST_READ2_IO()    &bslash;&n;   __asm__ __volatile__ (&quot;&bslash;n &bslash;&n;   cld                    &bslash;n &bslash;&n;   orl %%ecx, %%ecx       &bslash;n &bslash;&n;   jz 1f                  &bslash;n &bslash;&n;   rep                    &bslash;n &bslash;&n;   insw (%%dx),%%es:(%%edi) &bslash;n &bslash;&n;1: &quot;                       &bslash;&n;   : &quot;=D&quot; (sp)                   /* output */   &bslash;&n;   : &quot;d&quot; (f), &quot;D&quot; (sp), &quot;c&quot; (i)  /* input */    &bslash;&n;   : &quot;edx&quot;, &quot;ecx&quot;, &quot;edi&quot; )       /* trashed */
DECL|macro|FAST_WRITE2_IO
mdefine_line|#define FAST_WRITE2_IO()   &bslash;&n;   __asm__ __volatile__ (&quot;&bslash;n &bslash;&n;   cld                    &bslash;n &bslash;&n;   orl %%ecx, %%ecx       &bslash;n &bslash;&n;   jz 1f                  &bslash;n &bslash;&n;   rep                    &bslash;n &bslash;&n;   outsw %%ds:(%%esi),(%%dx) &bslash;n &bslash;&n;1: &quot;                       &bslash;&n;   : &quot;=S&quot; (sp)                   /* output */   &bslash;&n;   : &quot;d&quot; (f), &quot;S&quot; (sp), &quot;c&quot; (i)  /* input */    &bslash;&n;   : &quot;edx&quot;, &quot;ecx&quot;, &quot;esi&quot; )       /* trashed */
...
macro_line|#if LINUX_VERSION_CODE &lt; 0x020100   /* 2.0.xx */
DECL|macro|in2000__INITFUNC
macro_line|# define in2000__INITFUNC(function) function
DECL|macro|in2000__INIT
macro_line|# define in2000__INIT
DECL|macro|in2000__INITDATA
macro_line|# define in2000__INITDATA
DECL|macro|CLISPIN_LOCK
macro_line|# define CLISPIN_LOCK(flags)   do { save_flags(flags); cli(); } while(0)
