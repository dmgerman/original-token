...
mdefine_line|#define FAST_READ2_IO()    &bslash;&n;   __asm__ __volatile__ (&quot;&bslash;n &bslash;&n;   cld                    &bslash;n &bslash;&n;   orl %%ecx, %%ecx       &bslash;n &bslash;&n;   jz 1f                  &bslash;n &bslash;&n;   rep                    &bslash;n &bslash;&n;   insw %%dx              &bslash;n &bslash;&n;1: &quot;                       &bslash;&n;   : &quot;=D&quot; (sp)                   /* output */   &bslash;&n;   : &quot;d&quot; (f), &quot;D&quot; (sp), &quot;c&quot; (i)  /* input */    &bslash;&n;   : &quot;edx&quot;, &quot;ecx&quot;, &quot;edi&quot; )       /* trashed */
DECL|macro|FAST_WRITE2_IO
mdefine_line|#define FAST_WRITE2_IO()   &bslash;&n;   __asm__ __volatile__ (&quot;&bslash;n &bslash;&n;   cld                    &bslash;n &bslash;&n;   orl %%ecx, %%ecx       &bslash;n &bslash;&n;   jz 1f                  &bslash;n &bslash;&n;   rep                    &bslash;n &bslash;&n;   outsw %%dx             &bslash;n &bslash;&n;1: &quot;                       &bslash;&n;   : &quot;=S&quot; (sp)                   /* output */   &bslash;&n;   : &quot;d&quot; (f), &quot;S&quot; (sp), &quot;c&quot; (i)  /* input */    &bslash;&n;   : &quot;edx&quot;, &quot;ecx&quot;, &quot;esi&quot; )       /* trashed */
...
DECL|macro|IN2000
mdefine_line|#define IN2000 {  proc_dir:        &amp;proc_scsi_in2000,   /* pointer to /proc/scsi directory entry */ &bslash;&n;                  proc_info:       in2000_proc_info,    /* pointer to proc info function */ &bslash;&n;                  name:            &quot;Always IN2000&quot;,     /* device name */ &bslash;&n;                  detect:          in2000_detect,       /* returns number of in2000&squot;s found */ &bslash;&n;                  queuecommand:    in2000_queuecommand, /* queue scsi command, don&squot;t wait */ &bslash;&n;                  abort:           in2000_abort,        /* abort current command */ &bslash;&n;                  reset:           in2000_reset,        /* reset scsi bus */ &bslash;&n;                  bios_param:      in2000_biosparam,    /* figures out BIOS parameters for lilo, etc */ &bslash;&n;                  can_queue:       IN2000_CAN_Q,        /* max commands we can queue up */ &bslash;&n;                  this_id:         IN2000_HOST_ID,      /* host-adapter scsi id */ &bslash;&n;                  sg_tablesize:    IN2000_SG,           /* scatter-gather table size */ &bslash;&n;                  cmd_per_lun:     IN2000_CPL,          /* commands per lun */ &bslash;&n;                  use_clustering:  DISABLE_CLUSTERING, &bslash;&n;&t;&t;  use_new_eh_code: 0&t;&t;&t;/* Enable new error code */ &bslash;&n;                }
