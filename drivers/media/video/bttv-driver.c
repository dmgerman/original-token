...
DECL|macro|IDEBUG
mdefine_line|#define IDEBUG(x)&t;/* Debug interrupt handler */
DECL|macro|MIN
...
(brace
multiline_comment|/* i2c bit_adapter */
id|memcpy
c_func
(paren
op_amp
...
macro_line|#ifdef HACKING
multiline_comment|/* playing with kiobufs and dma-to-userspace. 2.4.x only&n;   Yes, I know: cut+paste programming is ugly.&n;   will fix later, this is proof-of-concept right now. */
DECL|function|make_vrisctab_kiobuf
r_static
r_int
id|make_vrisctab_kiobuf
c_func
(paren
r_struct
id|bttv
...
op_ge
l_int|12
multiline_comment|/* more is&squot;nt yet ... PALETTEFMT_MAX */
)paren
r_return
op_minus
id|EINVAL
...
c_func
(paren
l_string|&quot;bttv%d: cap vgrab_kiobuf: queue %d (%d:%dx%d)&bslash;n&quot;
comma
id|btv-&gt;nr
comma
l_int|0
...
(brace
multiline_comment|/* begin of Horrible Hack &lt;grin@tolna.net&gt; */
id|v.flags
op_or_assign
...
macro_line|#ifdef HACKING
multiline_comment|/* playing with kiobufs and dma-to-userspace */
r_case
id|BTTV_JUST_HACKING
suffix:colon
(brace
...
c_func
(paren
l_string|&quot;bttv%d: hack: userland args: %dx%d, fmt=%d, buf=%lx, len=%d&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|hack.width
...
id|hack_oops
suffix:semicolon
multiline_comment|/* have a look */
id|printk
c_func
(paren
l_string|&quot;bttv%d: hack: kiobuf: nr_pages=%d, offset=%d, length=%d, locked=%d&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|iobuf-&gt;nr_pages
...
c_func
(paren
l_string|&quot;bttv%d: hack: pages (bus addr):&quot;
comma
id|btv-&gt;nr
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* start capture */
id|err
op_assign
op_minus
id|EINVAL
...
c_func
(paren
l_string|&quot;bttv%d: hack: capture started&bslash;n&quot;
comma
id|btv-&gt;nr
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;bttv%d: hack: cap sync: sleep on %d&bslash;n&quot;
comma
id|btv-&gt;nr
comma
l_int|0
...
c_func
(paren
l_string|&quot;bttv%d: hack: capture done&bslash;n&quot;
comma
id|btv-&gt;nr
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;bttv%d: gpio: out_enable=0x%x, data=0x%x, in=0x%x&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|btread
...
id|printk
(paren
l_string|&quot;bttv%d: IRQ_GPINT&bslash;n&quot;
comma
id|btv-&gt;nr
)paren
)paren
...
id|printk
(paren
l_string|&quot;bttv%d: IRQ_I2CDONE&bslash;n&quot;
comma
id|btv-&gt;nr
)paren
)paren
...
c_func
(paren
l_string|&quot;memory: 0x%lx.&bslash;n&quot;
comma
id|btv-&gt;bt848_adr
)paren
suffix:semicolon
