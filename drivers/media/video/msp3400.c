...
c_func
(paren
l_string|&quot;msp34xx: setvolume: %d:%d 0x%02x 0x%02x&bslash;n&quot;
comma
id|left
comma
id|right
...
multiline_comment|/* so let&squot;s redirect sound from tuner via SCART */
multiline_comment|/* volume prescale for SCART */
id|msp3400c_write
c_func
(paren
id|client
...
multiline_comment|/* set prescale / stereo */
r_switch
c_cond
(paren
id|val
...
suffix:semicolon
multiline_comment|/* set prescale */
id|msp3400c_write
c_func
(paren
id|client
