...
suffix:semicolon
multiline_comment|/*&n; * The following function is exported for module usage.  It will&n; * be called from high-level drivers such as the raw driver.&n; */
DECL|function|hpsb_get_host_list
r_int
...
suffix:semicolon
singleline_comment|//kernel_thread(hpsb_host_thread, host, 
