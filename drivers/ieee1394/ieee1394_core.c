multiline_comment|/*&n; * IEEE 1394 for Linux&n; *&n; * Core support: hpsb_packet management, packet handling and forwarding to&n; *               csr or lowlevel code&n; *&n; * Copyright (C) 1999 Andreas E. Bombe&n; */
...
multiline_comment|/* &quot;if is contender and link active&quot; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* check that no ports go to a parent */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;including selfid 0x%x&bslash;n&quot;
comma
id|sid
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;warning - topology map will therefore not &quot;
l_string|&quot;be valid&quot;
)paren
suffix:semicolon
)brace
...
DECL|function|swap_quadlets_on_le
r_inline
r_void
id|swap_quadlets_on_le
c_func
(paren
id|quadlet_t
op_star
