...
multiline_comment|/* This must be called with the async.queue_lock held. */
...
multiline_comment|/* reg_write(lynx, FIFO_SIZES, 0x00555555); */
id|reg_write
c_func
(paren
id|lynx
...
suffix:semicolon
singleline_comment|//printk(&quot;buf 0x%08x %x count %d offset %d&bslash;n&quot;, physbuf, physbuf % 3, count, offset);
id|count
op_and_assign
op_complement
l_int|3
