...
suffix:semicolon
multiline_comment|/* Tell the controller where the AR program is */
id|reg_write
c_func
(paren
id|ohci
...
id|ohci-&gt;id
comma
l_string|&quot;reqTxComplete int received&quot;
)paren
suffix:semicolon
)brace
r_if
...
l_int|0
suffix:semicolon
multiline_comment|/* we calculate the number of received bytes from the&n;&t;&t;   residual count field */
id|rcv_bytes
op_assign
id|AR_RESP_BUF_SIZE
op_minus
...
id|ohci-&gt;id
comma
l_string|&quot;AR_status 0x%x %d, %d bytes read&quot;
comma
id|ohci-&gt;AR_resp_prg-&gt;status
comma
id|ohci-&gt;AR_resp_prg-&gt;status
...
id|ohci-&gt;id
comma
l_string|&quot;AR resp DMA program status value 0x%x is incorrect!&quot;
comma
id|ohci-&gt;AR_resp_prg-&gt;status
)paren
suffix:semicolon
)brace
multiline_comment|/* --------------- FIXME ---------------------------------&n;&t;&t;   this is a complete hack... we stop the dma prg&n;&t;&t;   and start it again so as to reset the dma buffer address&n;&t;&t;   Very slow, very bad design... to change ASAP */
multiline_comment|/* stop the channel program if it&squot;s still running */
id|reg_write
c_func
(paren
...
suffix:semicolon
multiline_comment|/* ---------------- end of FIXME --------------------------*/
)brace
r_if
c_cond
(paren
...
multiline_comment|/* AR dma buffer allocation */
id|ohci-&gt;AR_resp_buf
op_assign
id|kmalloc
c_func
...
multiline_comment|/* AR dma program allocation */
id|ohci-&gt;AR_resp_prg
op_assign
(paren
r_struct
...
c_func
(paren
l_string|&quot;failed to allocate AR response DMA program&quot;
)paren
suffix:semicolon
)brace
...
id|p
comma
l_string|&quot;&bslash;n### ohci data ###&bslash;n&quot;
)paren
suffix:semicolon
id|p
op_add_assign
...
id|p
comma
l_string|&quot;AR_resp_buf : %p  AR_resp_prg: %p&bslash;n&quot;
comma
id|ohci-&gt;AR_resp_buf
comma
id|ohci-&gt;AR_resp_prg
