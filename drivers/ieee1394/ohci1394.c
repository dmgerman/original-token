...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* &n;&t; * clear the interrupt event register, except for the&n;&t; * bus reset event interrupt (if any). This is an&n;&t; * attempt to comply with ohci spec 7.2.3.2&n;&t; */
id|reg_write
c_func
(paren
id|ohci
...
suffix:semicolon
macro_line|#else
multiline_comment|/* The above attempt doesn&squot;t work */
id|reg_write
c_func
(paren
id|ohci
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* clear the bus reset event */
id|reg_write
c_func
(paren
id|ohci
...
multiline_comment|/*&n;&t; * Problem: How can I ensure that the AT bottom half will be&n;&t; * executed before the AR bottom half (both events may have&n;&t; * occured within a single irq event)&n;&t; * Quick hack: just launch it within the IRQ handler&n;&t; */
r_if
c_cond
(paren
id|event
...
id|ohci-&gt;id
comma
l_string|&quot;Got reqTxComplete interrupt status=0x%08X&quot;
comma
id|reg_read
c_func
(paren
...
id|ohci-&gt;id
comma
l_string|&quot;Got respTxComplete interrupt status=0x%08X&quot;
comma
id|reg_read
c_func
(paren
