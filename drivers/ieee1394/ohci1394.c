...
multiline_comment|/* host-&gt;attempt_root = 1; */
id|PRINT
c_func
(paren
id|KERN_INFO
...
suffix:semicolon
multiline_comment|/* &n;&t; * self-id dma buffer allocation&n;&t; * FIXME: some early chips may need 8KB alignment for the &n;&t; * selfid buffer&n;&t; */
id|ohci-&gt;selfid_buf_cpu
op_assign
id|pci_alloc_consistent
c_func
