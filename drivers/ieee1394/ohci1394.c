...
(brace
multiline_comment|/* FIXME : how many contexts are available ? */
id|reg_write
c_func
(paren
id|ohci
...
suffix:semicolon
multiline_comment|/* &n;&t; * Accept AT requests from all nodes. This probably &n;&t; * will have to be controlled from the subsystem&n;&t; * on a per node basis.&n;&t; * (Tip by Emilie Chung &lt;emilie.chung@axis.com&gt;)&n;&t; */
id|reg_write
c_func
(paren
id|ohci
...
id|ohci-&gt;id
comma
l_string|&quot;Unexpected packet tcode=%d in AT DMA&quot;
comma
id|tcode
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Async Receive Request */
r_if
c_cond
(paren
id|tcode
...
(brace
multiline_comment|/* Async Receive Response */
r_if
c_cond
(paren
id|tcode
