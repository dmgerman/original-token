...
l_int|0x00000001
suffix:semicolon
multiline_comment|/* save people from themselves */
r_if
c_cond
(paren
id|channel
...
id|ohci-&gt;id
comma
l_string|&quot;listening enabled on channel %u&quot;
comma
id|channel
)paren
suffix:semicolon
...
id|ohci-&gt;id
comma
l_string|&quot;listening disabled on channel %u&quot;
comma
id|channel
)paren
suffix:semicolon
...
id|KERN_ERR
comma
l_string|&quot;unable to register proc file&quot;
)paren
suffix:semicolon
r_return
op_minus
