...
suffix:semicolon
multiline_comment|/* FIXME - generate speed map */
...
multiline_comment|/* Read FCP register space */
DECL|function|read_fcp
r_static
r_int
id|read_fcp
c_func
...
multiline_comment|/* Write FCP register space */
