multiline_comment|/*&n; * IEEE 1394 for Linux&n; *&n; * Transaction support.&n; *&n; * Copyright (C) 1999 Andreas E. Bombe&n; */
...
(brace
multiline_comment|/* FIXME: Lengths not multiple of 4 are not implemented.  Mainly&n;                 * there is the problem with little endian machines because we&n;                 * always swap to little endian on receive.  If we read 5 bytes&n;                 * 12345 we receive them as 12345000 and swap them to 43210005.&n;                 * How should we copy that to the caller?  Require *buffer to be&n;                 * a full quadlet multiple in length? */
r_return
op_minus
id|EACCES
suffix:semicolon
...
(brace
multiline_comment|/* FIXME: Lengths not multiple of 4 are not implemented.  See function&n;                 * hpsb_read for explanation, same reason, different direction. */
r_return
op_minus
id|EACCES
suffix:semicolon
