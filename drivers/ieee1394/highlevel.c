multiline_comment|/*&n; * IEEE 1394 for Linux&n; *&n; * Copyright (C) 1999 Andreas E. Bombe&n; */
...
(brace
multiline_comment|/* Addresses or lengths not a multiple of a quadlet pose a big&n;                 * problem on little endian machines because we always do this&n;                 * in arch endian and swapping would mess it all up.  So we &n;                 * simply don&squot;t allow this at all. */
r_return
id|RCODE_TYPE_ERROR
suffix:semicolon
)brace
