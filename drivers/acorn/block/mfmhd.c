...
DECL|macro|MFM_DISK_MAJOR
mdefine_line|#define MFM_DISK_MAJOR&t;13
DECL|macro|XT_DISK_MAJOR
macro_line|#undef  XT_DISK_MAJOR
DECL|macro|XT_DISK_MAJOR
mdefine_line|#define XT_DISK_MAJOR&t;-1
DECL|macro|MAJOR_NR
mdefine_line|#define MAJOR_NR&t;MFM_DISK_MAJOR
...
suffix:semicolon
DECL|macro|mfm_init
mdefine_line|#define mfm_init xd_init
DECL|macro|mfm_setup
mdefine_line|#define mfm_setup xd_setup
...
multiline_comment|/*&n; * Tell the user about the drive if we decided it exists.  Also,&n; * set the size of the drive.&n; */
