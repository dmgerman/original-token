...
multiline_comment|/* if the file is mounted OR (writable now AND writable at open&n;&t;&t;   time) Linus: Does this cover all cases? */
id|block_fsync
c_func
(paren
id|inode
