...
id|buffer_rw_t
suffix:semicolon
multiline_comment|/*&n; * ether3 read/write.  Slow things down a bit...&n; */
DECL|macro|ether3_outb
mdefine_line|#define ether3_outb(v,r)&t;{ outb((v),(r)); udelay(1); }
DECL|macro|ether3_outw
mdefine_line|#define ether3_outw(v,r)&t;{ outw((v),(r)); udelay(1); }
...
(paren
id|KERN_ERR
l_string|&quot;ether3_probe1: no memory&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/*&n; * Allocate memory in transmitter ring buffer.&n; */
r_static
r_int
DECL|function|ether3_alloc_tx
id|ether3_alloc_tx
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;%s: transmit error: next pointer = %04X&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|tx_tail
