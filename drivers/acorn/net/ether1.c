...
DECL|macro|tx_done
mdefine_line|#define tx_done(dev) 0
multiline_comment|/* ------------------------------------------------------------------------- */
...
id|version
op_assign
l_string|&quot;ether1 ethernet driver (c) 1995 Russell King v1.05&bslash;n&quot;
suffix:semicolon
DECL|macro|BUS_16
...
(paren
id|KERN_INFO
l_string|&quot;%s: ether1 found [%d, %04lx, %d]&quot;
comma
id|dev-&gt;name
comma
id|priv-&gt;bus_type
...
(paren
id|KERN_WARNING
l_string|&quot;%s: %s - resetting device&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|reason
...
(brace
multiline_comment|/*&n;&t;&t; * If we get here, some higher level has decided that we are broken.&n;&t;&t; * There should really be a &quot;kick me&quot; function call instead.&n;&t;&t; */
r_int
id|tickssofar
op_assign
id|jiffies
...
id|dev
comma
l_string|&quot;transmit timeout, network cable problem?&quot;
)paren
suffix:semicolon
id|dev-&gt;trans_start
op_assign
...
id|nop
suffix:semicolon
multiline_comment|/*&n;&t;&t; * insert packet followed by a nop&n;&t;&t; */
id|txaddr
op_assign
id|ether1_txalloc
(paren
