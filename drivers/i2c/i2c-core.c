...
mdefine_line|#define i2cproc_init()
...
suffix:semicolon
multiline_comment|/* actually i2c_dummy-&gt;add_adapter */
macro_line|#ifdef CONFIG_PROC_FS
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* actually i2c_dummy-&gt;del_adapter */
macro_line|#ifdef CONFIG_PROC_FS
r_if
c_cond
(paren
...
multiline_comment|/* &amp;&amp; (client-&gt;driver-&gt;flags &amp; I2C_DF_NOTIFY) */
)paren
multiline_comment|/* detaching devices is unconditional of the set notify&n;&t;&t;&t; * flag, as _all_ clients that reside on the adapter&n;&t;&t;&t; * must be deleted, as this would cause invalid states.&n;&t;&t;&t; */
id|client-&gt;driver
op_member_access_from_pointer
id|detach_client
c_func
...
suffix:semicolon
multiline_comment|/* i2c_detach_client(client); --- frodo */
)brace
multiline_comment|/* all done, now unregister */
id|adapters
(braket
id|i
)braket
...
(paren
id|KERN_WARNING
l_string|&quot; i2c-core.o: register_driver(%s) - enlarge I2C_DRIVER_MAX.&bslash;n&quot;
comma
id|driver-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Notify all existing adapters and clients to dummy driver */
id|ADAP_LOCK
c_func
(paren
)paren
...
(paren
id|KERN_WARNING
l_string|&quot; i2c-core.o: unregister_driver: [%s] not found&bslash;n&quot;
comma
id|driver-&gt;name
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*i2c_detach_client(client);*/
id|driver
op_member_access_from_pointer
id|detach_client
c_func
...
suffix:semicolon
multiline_comment|/*&t;client-&gt;driver-&gt;detach_client(client);*/
id|adapter-&gt;clients
(braket
id|i
)braket
...
multiline_comment|/* Filter out dummy clients */
r_if
c_cond
(paren
id|client-&gt;driver-&gt;id
...
DECL|function|i2c_dummy_client
r_static
r_void
id|i2c_dummy_client
c_func
