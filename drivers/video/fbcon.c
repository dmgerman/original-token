...
suffix:semicolon
multiline_comment|/* Unlike vgacon, we have to set palette before resize on directcolor, &n;                              so that it is drawn with correct colors */
id|vc_resize_con
c_func
(paren
id|nr_rows
...
suffix:semicolon
multiline_comment|/* So that we set origin correctly */
)brace
r_if
c_cond
(paren
...
multiline_comment|/* FIXME: Implement for wide fonts */
r_return
op_minus
id|EINVAL
suffix:semicolon
