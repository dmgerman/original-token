...
id|SM_UP
suffix:colon
multiline_comment|/* K.Garloff@ping.de, 98/10/21: If logo is diplayed, only save logo&n;&t;     * and not the hole top region. In combination with the logo being&n;&t;     * displayed on the right side, this allows scrollback feature&n;&t;     * when bootlogo is displayed. */
r_if
c_cond
(paren
id|t
