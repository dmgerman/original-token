multiline_comment|/*&n; *  linux/drivers/video/fbcon.c -- Low level frame buffer based console driver&n; *&n; *&t;Copyright (C) 1995 Geert Uytterhoeven&n; *&n; *&n; *  This file is based on the original Amiga console driver (amicon.c):&n; *&n; *&t;Copyright (C) 1993 Hamish Macdonald&n; *&t;&t;&t;   Greg Harp&n; *&t;Copyright (C) 1994 David Carter [carter@compsci.bristol.ac.uk]&n; *&n; *&t;      with work by William Rucklidge (wjr@cs.cornell.edu)&n; *&t;&t;&t;   Geert Uytterhoeven&n; *&t;&t;&t;   Jes Sorensen (jds@kom.auc.dk)&n; *&t;&t;&t;   Martin Apel&n; *&n; *  and on the original Atari console driver (atacon.c):&n; *&n; *&t;Copyright (C) 1993 Bjoern Brauel&n; *&t;&t;&t;   Roman Hodek&n; *&n; *&t;      with work by Guenther Kelleter&n; *&t;&t;&t;   Martin Schaller&n; *&t;&t;&t;   Andreas Schwab&n; *&n; *&n; *  The low level operations for the various display memory organizations are&n; *  now in separate source files.&n; *&n; *  Currently only the following organizations are supported:&n; *&n; *    - non-accelerated:&n; *&n; *&t;  o mfb&t;&t; Monochrome&n; *&t;  o ilbm&t; Interleaved bitplanes &#xfffd; la Amiga&n; *&t;  o afb&t;&t; Bitplanes &#xfffd; la Amiga&n; *&t;  o iplan2p[248] Interleaved bitplanes &#xfffd; la Atari (2, 4 and 8 planes)&n; *&t;  o cfb{8,16}    Packed pixels (8 and 16 bpp)&n; *&n; *    - accelerated:&n; *&n; *&t;  o cyber&t; CyberVision64 packed pixels (accelerated)&n; *&t;  o retz3&t; Retina Z3 packed pixels (accelerated)&n; *&t;  o mach64&t; ATI Mach 64 packed pixels (accelerated)&n; *&n; *  To do:&n; *&n; *    - Implement 16 plane mode (iplan2p16)&n; *    - Add support for 24/32 bit packed pixels (cfb{24,32})&n; *    - Hardware cursor&n; *&n; *&n; *  This file is subject to the terms and conditions of the GNU General Public&n; *  License.  See the file COPYING in the main directory of this archive for&n; *  more details.&n; */
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_FBCON_RETINAZ3
r_extern
r_int
id|fbcon_init_retz3
c_func
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_FBCON_MACH64
r_extern
r_int
id|fbcon_init_mach64
c_func
(paren
r_void
)paren
...
id|kmem_start
suffix:semicolon
multiline_comment|/* Initialize all built-in low level drivers */
macro_line|#ifdef CONFIG_FBCON_RETINAZ3
id|fbcon_init_retz3
c_func
(paren
...
multiline_comment|/* Be careful when changing dispsw, it might be the current console.  */
id|old_dispsw
op_assign
id|p-&gt;dispsw
suffix:semicolon
...
macro_line|#if defined(CONFIG_FBCON_CFB16) || defined(CONFIG_FBCON_CYBER) || &bslash;&n;    defined(CONFIG_FBCON_RETINAZ3)
r_if
c_cond
(paren
(paren
...
macro_line|#endif
macro_line|#if defined(CONFIG_FBCON_CFB8) || defined(CONFIG_FBCON_CYBER) || &bslash;&n;    defined(CONFIG_FBCON_RETINAZ3)
r_if
c_cond
(paren
id|depth
...
l_int|NULL
suffix:semicolon
DECL|function|fbcon_register_driver
r_int
id|fbcon_register_driver
c_func
(paren
...
DECL|function|fbcon_unregister_driver
r_int
id|fbcon_unregister_driver
c_func
(paren
...
(brace
multiline_comment|/* First try an accelerated driver */
id|dispsw
op_assign
id|probe_list
c_func
...
multiline_comment|/* Then try an unaccelerated driver */
id|dispsw
op_assign
id|probe_list
c_func
...
id|open_dummy
comma
multiline_comment|/* release_dummy */
id|misc_dummy
comma
multiline_comment|/* bmove_dummy */
(paren
r_void
(paren
op_star
...
id|misc_dummy
comma
multiline_comment|/* rev_char_dummy */
(paren
r_void
(paren
op_star
...
suffix:semicolon
DECL|variable|fbcon_register_driver
id|EXPORT_SYMBOL
c_func
(paren
id|fbcon_register_driver
...
suffix:semicolon
DECL|variable|fbcon_unregister_driver
id|EXPORT_SYMBOL
c_func
(paren
id|fbcon_unregister_driver
