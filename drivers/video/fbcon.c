...
suffix:semicolon
multiline_comment|/*&n;     *  We assume initial frame buffer devices can be opened this&n;     *  many times&n;     */
r_for
c_loop
(paren
id|j
...
suffix:semicolon
multiline_comment|/* Must be done after fbcon_set_disp to prevent excess updates */
id|conp-&gt;vc_display_fg
op_assign
op_amp
id|info-&gt;display_fg
...
(paren
id|KERN_ERR
l_string|&quot;fbcon_set_disp: No support for fontwidth %d&bslash;n&quot;
comma
id|fontwidth
c_func
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;fbcon_set_disp: type %d (aux %d, depth %d) not &quot;
