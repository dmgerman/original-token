...
l_int|0
suffix:semicolon
multiline_comment|/* Set colors if visual is PSEUDOCOLOR and we have enough colors, or for&n;     * TRUECOLOR */
r_if
c_cond
(paren
(paren
...
macro_line|#endif
macro_line|#ifdef CONFIG_FBCON_VGA
r_if
c_cond
(paren
id|depth
