multiline_comment|/* $Id: creatorfb.c,v 1.17 1998/12/28 11:23:37 jj Exp $&n; * creatorfb.c: Creator/Creator3D frame buffer driver&n; *&n; * Copyright (C) 1997,1998 Jakub Jelinek (jj@ultra.linux.cz)&n; */
