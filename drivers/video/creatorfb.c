multiline_comment|/* $Id: creatorfb.c,v 1.16 1998/12/21 05:14:39 davem Exp $&n; * creatorfb.c: Creator/Creator3D frame buffer driver&n; *&n; * Copyright (C) 1997,1998 Jakub Jelinek (jj@ultra.linux.cz)&n; */
