multiline_comment|/*&n; *&n; * Hardware accelerated Matrox Millenium I, II, Mystique and G200&n; *&n; * (c) 1998 Petr Vandrovec &lt;vandrove@vc.cvut.cz&gt;&n; *&n; * Version: 1.3 1998/10/28 &n; *&n; * MTRR stuff: 1998 Tom Rini &lt;tmrini@ntplx.net&gt;&n; *&n; * Contributors: &quot;menion?&quot; &lt;menion@mindless.com&gt;&n; *                     Betatesting, fixes, ideas&n; *&n; *               &quot;Kurt Garloff&quot; &lt;garloff@kg1.ping.de&gt;&n; *                     Betatesting, fixes, ideas, videomodes, videomodes timmings&n; *&n; *               &quot;Tom Rini&quot; &lt;tmrini@ntplx.net&gt;&n; *                     MTRR stuff, betatesting, fixes, ideas&n; *&n; *               &quot;Gerd Knorr&quot; &lt;kraxel@goldbach.isdn.cs.tu-berlin.de&gt;&n; *                     Betatesting&n; *&n; *               &quot;Kelly French&quot; &lt;targon@hazmat.com&gt;&n; *                     Betatesting, bug reporting&n; *&n; *               &quot;Pablo Bianucci&quot; &lt;pbian@pccp.com.ar&gt;&n; *                     Fixes, ideas, betatesting&n; *&n; *               &quot;Inaky Perez Gonzalez&quot; &lt;inaky@peloncho.fis.ucm.es&gt;&n; *                     Fixes, enhandcements, ideas, betatesting&n; *&n; *               &quot;Paul Womar&quot; &lt;Paul@pwomar.demon.co.uk&gt;&n; *               &quot;Ryuichi Oikawa&quot; &lt;roikawa@rr.iiij4u.or.jp&gt;&n; *               &quot;Owen Waller&quot; &lt;O.Waller@ee.qub.ac.uk&gt;&n; *                     PPC betatesting &n; *                     &n; * (following author is not in any relation with this code, but his code&n; *  is included in this driver)&n; *&n; * Based on framebuffer driver for VBE 2.0 compliant graphic boards&n; *     (c) 1998 Gerd Knorr &lt;kraxel@cs.tu-berlin.de&gt;&n; *&n; * (following author is not in any relation with this code, but his ideas&n; *  were used when writting this driver)&n; *&n; *&t;&t; FreeVBE/AF (Matrox), &quot;Shawn Hargreaves&quot; &lt;shawn@talula.demon.co.uk&gt;&n; *&n; */
...
DECL|macro|PCI_SS_ID_MATROX_UNSPECIFIED
mdefine_line|#define PCI_SS_ID_MATROX_UNSPECIFIED&t;&t;0xFF00
...
id|visual
suffix:semicolon
multiline_comment|/* unfortunately, fix */
DECL|member|video_type
r_int
id|video_type
suffix:semicolon
...
mdefine_line|#define ACCESS_FBINFO(x) (minfo-&gt;x)
DECL|macro|ACCESS_FBINFO2
mdefine_line|#define ACCESS_FBINFO2(info, x) (((struct matrox_fb_info*)info)-&gt;x)
DECL|macro|MINFO
...
DECL|member|_mga_ydstorg
r_int
r_int
id|_mga_ydstorg
suffix:semicolon
DECL|member|_curr_ydstorg
r_int
r_int
id|_curr_ydstorg
suffix:semicolon
...
mdefine_line|#define mga_ydstorg(x)&t;ACCESS_FBINFO2(x, _mga_ydstorg)
DECL|macro|curr_ydstorg
mdefine_line|#define curr_ydstorg(x)&t;ACCESS_FBINFO2(x, _curr_ydstorg)
macro_line|#else
DECL|macro|mga_ydstorg
mdefine_line|#define mga_ydstorg(x) (0)
DECL|macro|curr_ydstorg
mdefine_line|#define curr_ydstorg(x) (0)
macro_line|#endif
...
mdefine_line|#define     TVP3026A_XLATCHCTRL_4_3&t;0x07
...
macro_line|#endif
DECL|macro|mga_inb
mdefine_line|#define mga_inb(addr)&t;(*(volatile u_int8_t*)(ACCESS_FBINFO(mmio)+(addr)))
multiline_comment|/* #define mga_inw(addr)&t;*(volatile u_int16_t*)(ACCESS_FBINFO(mmio)+(addr)) */
DECL|macro|mga_inl
mdefine_line|#define mga_inl(addr)&t;(*(volatile u_int32_t*)(ACCESS_FBINFO(mmio)+(addr)))
DECL|macro|mga_outb
mdefine_line|#define mga_outb(addr,val) *(volatile u_int8_t*)(ACCESS_FBINFO(mmio)+(addr))=(val)
multiline_comment|/* #define mga_outw(addr,val) *(volatile u_int16_t*)(ACCESS_FBINFO(mmio)+(addr))=(val) */
DECL|macro|mga_outl
mdefine_line|#define mga_outl(addr,val) *(volatile u_int32_t*)(ACCESS_FBINFO(mmio)+(addr))=(val)
DECL|macro|mga_readr
mdefine_line|#define mga_readr(port,idx) (mga_outb((port),(idx)), mga_inb((port)+1))
macro_line|#ifdef __LITTLE_ENDIAN
DECL|macro|__mga_outw
mdefine_line|#define __mga_outw(addr,val) *(volatile u_int16_t*)(ACCESS_FBINFO(mmio)+(addr))=(val)
DECL|macro|mga_setr
mdefine_line|#define mga_setr(addr,port,val) __mga_outw(addr, ((val)&lt;&lt;8) | (port))
macro_line|#else
DECL|macro|mga_setr
...
l_int|4
suffix:semicolon
multiline_comment|/* TODO: set OPMODE_DMA_LE for BE */
r_if
c_cond
(paren
id|fontwidth
...
multiline_comment|/* TODO: restore OPMODE for BE */
id|WaitTillIdle
c_func
(paren
id|MINFO
...
id|M_RAMDAC_BASE
op_plus
id|TVP3026_X_DATAREG
comma
id|val
)paren
suffix:semicolon
)brace
DECL|function|inTi3026
r_static
r_int
id|inTi3026
c_func
...
(paren
id|KERN_INFO
l_string|&quot;matroxfb: now accelerated&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|memcpy
...
comma
l_int|0x1F
multiline_comment|/*Memsizedependent*/
comma
...
l_int|8
suffix:semicolon
multiline_comment|/* if now out of memory, try shrink virtual height */
multiline_comment|/* but if new virtual height is smaller than visible height, return -EINVAL */
r_if
c_cond
(paren
id|var-&gt;yres_virtual
...
suffix:semicolon
multiline_comment|/* 03258A31 is x7AF0, default is 0x02032521 */
macro_line|#if 0
id|hw-&gt;MXoptionReg
op_or_assign
l_int|0x1000
...
(brace
macro_line|#if defined(FBCON_HAS_CFB8) || defined(FBCON_HAS_CFB4)
macro_line|#ifdef FBCON_HAS_CFB4
r_case
l_int|4
suffix:colon
...
suffix:semicolon
multiline_comment|/* wait for PLL only if PLL clock requested (always for PowerMode) */
r_if
c_cond
(paren
id|hw-&gt;MiscOutReg
...
suffix:semicolon
DECL|macro|RSDepth
mdefine_line|#define RSDepth(X)&t;(((X) &gt;&gt; 4) &amp; 0x0F)
DECL|macro|RS8bpp
...
suffix:semicolon
DECL|macro|RSCreate
mdefine_line|#define RSCreate(X,Y)&t;((X) | ((Y) &lt;&lt; 4))
DECL|member|vesa
DECL|member|info
DECL|variable|RSptr
DECL|variable|__initdata
...
l_int|0
suffix:semicolon
multiline_comment|/* &quot;matrox:hwcursor&quot; */
DECL|variable|dev
r_static
r_int
id|dev
...
(paren
id|KERN_ERR
l_string|&quot;matroxfb: unknown parameter %s&bslash;n&quot;
comma
id|this_opt
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;matroxfb: PCI OPTION = %08X&bslash;n&quot;
comma
id|hw-&gt;MXoptionReg
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* wait for retrace, draw black square and so on... */
)brace
macro_line|#endif
macro_line|#ifdef CONFIG_FB_MATROX_MILLENIUM
...
id|PCI_SS_VENDOR_ID_MATROX
comma
id|PCI_SS_ID_MATROX_UNSPECIFIED
comma
id|DEVF_VIDEO64BIT
op_or
id|DEVF_SWAPS
...
suffix:semicolon
multiline_comment|/* do we really need ioremap_nocache? */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* displaying is possible only in first 8MB */
r_if
c_cond
(paren
id|avamem
...
c_func
(paren
l_string|&quot;Accelerated FBDev driver for Matrox Millenium/Mystique&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func
...
id|vesa
comma
l_string|&quot;Startup videomode (0x100-0x1FF) (default=0x101)&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func
...
id|depth
comma
l_string|&quot;Color depth (8,15,16,24,32) (default=vesa)&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func
