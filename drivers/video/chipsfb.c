...
id|io_base
suffix:semicolon
DECL|member|chips_base_phys
r_int
r_int
id|chips_base_phys
suffix:semicolon
DECL|member|chips_io_phys
r_int
r_int
id|chips_io_phys
suffix:semicolon
...
suffix:semicolon
DECL|macro|write_xr
mdefine_line|#define write_xr(num,val)&t;{ out_8(p-&gt;io_base + 0x3D6, num); out_8(p-&gt;io_base + 0x3D7, val); }
DECL|macro|read_xr
mdefine_line|#define read_xr(num,var)&t;{ out_8(p-&gt;io_base + 0x3D6, num); var = in_8(p-&gt;io_base + 0x3D7); }
DECL|macro|write_fr
mdefine_line|#define write_fr(num,val)&t;{ out_8(p-&gt;io_base + 0x3D0, num); out_8(p-&gt;io_base + 0x3D1, val); }
DECL|macro|read_fr
mdefine_line|#define read_fr(num,var)&t;{ out_8(p-&gt;io_base + 0x3D0, num); var = in_8(p-&gt;io_base + 0x3D1); }
DECL|macro|write_cr
mdefine_line|#define write_cr(num,val)&t;{ out_8(p-&gt;io_base + 0x3D4, num); out_8(p-&gt;io_base + 0x3D5, val); }
DECL|macro|read_cr
mdefine_line|#define read_cr(num,var)&t;{ out_8(p-&gt;io_base + 0x3D4, num); var = in_8(p-&gt;io_base + 0x3D5); }
...
DECL|function|chips_pan_display
r_static
r_int
id|chips_pan_display
c_func
...
id|bit_depth
op_assign
id|new_disp-&gt;var.bits_per_pixel
suffix:semicolon
r_if
c_cond
(paren
id|old_disp-&gt;var.bits_per_pixel
op_ne
id|bit_depth
)paren
(brace
...
c_func
(paren
l_string|&quot;fb%d: Chips 65550 frame buffer&bslash;n&quot;
comma
id|GET_FB_IDX
c_func
(paren
