...
suffix:semicolon
multiline_comment|/*&n;static void retz3_fb_set_disp(int con);&n;*/
r_static
r_int
id|get_video_mode
c_func
...
DECL|function|retz3_fb_release
r_static
r_int
id|retz3_fb_release
c_func
...
id|z3fb_inverse
suffix:semicolon
multiline_comment|/*&n;&t;retz3_fb_set_disp(con);&n;*/
r_if
c_cond
(paren
