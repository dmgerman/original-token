...
macro_line|#endif
multiline_comment|/* &n; *  The MAX_x defines are used to specify the maximum ranges for &n; *  parameters that affect the size of the frame buffer memory&n; *  region.  Since the frame buffer memory is not dynamically &n; *  alocated, the maximum size that will be used is allocated.&n; */
macro_line|#if defined (CONFIG_SA1100_PENNY)
DECL|macro|MAX_BITS_PER_PIXEL
mdefine_line|#define MAX_BITS_PER_PIXEL   &t;&t;8
DECL|macro|MAX_SCREEN_SIZE_H
mdefine_line|#define MAX_SCREEN_SIZE_H   &t;&t;640
DECL|macro|MAX_SCREEN_SIZE_V
mdefine_line|#define MAX_SCREEN_SIZE_V    &t;&t;480
macro_line|#elif defined(CONFIG_SA1100_BRUTUS)
DECL|macro|MAX_BITS_PER_PIXEL
mdefine_line|#define MAX_BITS_PER_PIXEL   &t;&t;8
DECL|macro|MAX_SCREEN_SIZE_H
mdefine_line|#define MAX_SCREEN_SIZE_H   &t;&t;320
DECL|macro|MAX_SCREEN_SIZE_V
mdefine_line|#define MAX_SCREEN_SIZE_V    &t;&t;240
macro_line|#elif defined (CONFIG_SA1100_THINCLIENT)
DECL|macro|MAX_BITS_PER_PIXEL
mdefine_line|#define MAX_BITS_PER_PIXEL   &t;&t;8 
multiline_comment|/*#define MAX_BITS_PER_PIXEL   &t;&t;16*/
DECL|macro|MAX_SCREEN_SIZE_H
mdefine_line|#define MAX_SCREEN_SIZE_H   &t;&t;640
DECL|macro|MAX_SCREEN_SIZE_V
mdefine_line|#define MAX_SCREEN_SIZE_V    &t;&t;480
...
DECL|macro|MAX_BITS_PER_PIXEL
mdefine_line|#define MAX_BITS_PER_PIXEL   &t;&t;4
DECL|macro|MAX_SCREEN_SIZE_H
mdefine_line|#define MAX_SCREEN_SIZE_H   &t;&t;640
DECL|macro|MAX_SCREEN_SIZE_V
mdefine_line|#define MAX_SCREEN_SIZE_V    &t;&t;200
DECL|macro|REVERSE_VIDEO_4BIT
mdefine_line|#define REVERSE_VIDEO_4BIT
...
mdefine_line|#define MAX_SCREEN_SIZE_V      &t;&t;240
macro_line|#endif
multiline_comment|/* Default resolutions */
macro_line|#if defined(CONFIG_SA1100_PENNY) 
...
macro_line|#else
DECL|macro|DEFAULT_XRES
mdefine_line|#define DEFAULT_XRES&t;MAX_SCREEN_SIZE_H
DECL|macro|DEFAULT_YRES
mdefine_line|#define DEFAULT_YRES&t;MAX_SCREEN_SIZE_V
DECL|macro|DEFAULT_BPP
mdefine_line|#define DEFAULT_BPP&t;MAX_BITS_PER_PIXEL
macro_line|#endif
multiline_comment|/* Memory size macros for determining required FrameBuffer size */
DECL|macro|MAX_PALETTE_NUM_ENTRIES
mdefine_line|#define MAX_PALETTE_NUM_ENTRIES         256
DECL|macro|ADJUSTED_MAX_BITS_PER_PIXEL
mdefine_line|#define ADJUSTED_MAX_BITS_PER_PIXEL     (MAX_BITS_PER_PIXEL &gt; 8 ? 16 : MAX_BITS_PER_PIXEL)
DECL|macro|MAX_PALETTE_MEM_SIZE
mdefine_line|#define MAX_PALETTE_MEM_SIZE            (MAX_PALETTE_NUM_ENTRIES * 2)
DECL|macro|MAX_PIXEL_MEM_SIZE
mdefine_line|#define MAX_PIXEL_MEM_SIZE              ((MAX_SCREEN_SIZE_H * MAX_SCREEN_SIZE_V * ADJUSTED_MAX_BITS_PER_PIXEL ) / 8)
DECL|macro|MAX_FRAMEBUFFER_MEM_SIZE
mdefine_line|#define MAX_FRAMEBUFFER_MEM_SIZE   &t;(MAX_PIXEL_MEM_SIZE + MAX_PALETTE_MEM_SIZE + 32)
DECL|macro|ALLOCATED_FB_MEM_SIZE
mdefine_line|#define ALLOCATED_FB_MEM_SIZE           (PAGE_ALIGN (MAX_FRAMEBUFFER_MEM_SIZE + PAGE_SIZE * 2))
...
l_int|0x00f
suffix:semicolon
macro_line|#ifdef REVERSE_VIDEO_4BIT
id|pal
op_assign
l_int|15
op_minus
...
suffix:semicolon
singleline_comment|// Decode var contents into a par structure, adjusting any
singleline_comment|// out of range values.  
r_if
c_cond
(paren
(paren
...
singleline_comment|// If the console has changed and the console has defined
singleline_comment|// a changevar function, call that function.
r_if
c_cond
(paren
id|chgvar
...
suffix:semicolon
singleline_comment|// If the current console is selected, update the palette 
r_if
c_cond
(paren
id|con
...
id|LCCR3_VrtSnchH
suffix:semicolon
multiline_comment|/*&n;&t;&t;           ((current_var.sync &amp; FB_SYNC_HOR_HIGH_ACT) ?&n;&t;&t;           LCCR3_HorSnchH : LCCR3_HorSnchL) +&n;&t;&t;           ((current_var.sync &amp; FB_SYNC_VERT_HIGH_ACT) ?&n;&t;&t;           LCCR3_VrtSnchH : LCCR3_VrtSnchL);&n;&t;*/
macro_line|#elif defined(CONFIG_SA1100_LART) 
id|DPRINTK
c_func
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Restore status of interrupts */
id|restore_flags
c_func
(paren
id|flags
...
c_func
(paren
l_string|&quot;sa1100fb:  Disabling LCD controller&bslash;n&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sa1100fb: LCD already disabled&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
c_func
(paren
l_string|&quot;sa1100fb: Enabling LCD controller&bslash;n&quot;
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* disable the interrupts and save flags */
id|save_flags_cli
c_func
(paren
id|flags
...
r_static
r_int
DECL|function|sa1100fb_release
id|sa1100fb_release
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|sa1100fb_pan_display
id|sa1100fb_pan_display
c_func
(paren
r_struct
...
l_int|1
suffix:semicolon
multiline_comment|/* Request the interrupt in the init routine only because */
multiline_comment|/* this driver will not be used as a module.              */
r_if
c_cond
(paren
id|request_irq
...
suffix:semicolon
multiline_comment|/* This driver cannot be unloaded */
id|MOD_INC_USE_COUNT
suffix:semicolon
)brace
