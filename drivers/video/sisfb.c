multiline_comment|/*&n; * SiS 300/630/540 frame buffer device For Kernal 2.3.x&n; *&n; * This driver is partly based on the VBE 2.0 compliant graphic &n; * boards framebuffer driver, which is &n; * &n; * (c) 1998 Gerd Knorr &lt;kraxel@goldbach.in-berlin.de&gt;&n; *&n; */
...
(brace
multiline_comment|/* not support virtual screen yet */
r_return
op_minus
id|EINVAL
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;sisfb: abort, cannot reserve video memory at 0x%lx&bslash;n&quot;
comma
id|ivideo.video_base
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;sisfb: abort, cannot reserve mmio memory at 0x%lx&bslash;n&quot;
comma
id|ivideo.mmio_base
)paren
suffix:semicolon
