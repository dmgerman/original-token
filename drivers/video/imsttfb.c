...
suffix:semicolon
multiline_comment|/* IBM ramdac direct registers */
r_enum
(brace
...
suffix:semicolon
multiline_comment|/* IBM ramdac indirect registers */
r_enum
(brace
...
l_int|0x05
comma
multiline_comment|/* (0x00) Power Management  [multiples of 4 unblack screen] */
DECL|enumerator|DACOP
id|DACOP
op_assign
l_int|0x06
comma
multiline_comment|/* (0x02) DAC Operation  [0-3 coloured, 4-7 green, odd light, even dark] */
...
l_int|0x0c
comma
multiline_comment|/* () 16 Bits/Pixel Control  [15 or 1 for 555] */
...
l_int|0x10
comma
multiline_comment|/* (0x05) Pixel PLL Control 1  [5-7 ok] */
DECL|enumerator|PIXCTL2
id|PIXCTL2
op_assign
l_int|0x11
comma
multiline_comment|/* (0x00) Pixel PLL Control 2  [multiples of 20 ok] */
...
DECL|enumerator|PIXCLKM
id|PIXCLKM
op_assign
l_int|0x20
comma
multiline_comment|/* () Pixel Clock M */
DECL|enumerator|PIXCLKN
id|PIXCLKN
op_assign
l_int|0x21
comma
multiline_comment|/* () Pixel Clock N */
DECL|enumerator|PIXCLKP
id|PIXCLKP
op_assign
l_int|0x22
comma
multiline_comment|/* () Pixel Clock P */
DECL|enumerator|PIXCLKC
id|PIXCLKC
op_assign
l_int|0x23
comma
multiline_comment|/* () Pixel Clock C */
DECL|enumerator|CURSCTL
id|CURSCTL
op_assign
l_int|0x30
comma
multiline_comment|/* (0x00) Cursor Control  [1=curs1, 2=curs2, 5=curs3] */
...
l_int|0x35
comma
multiline_comment|/* () ???  [position relative to CURSX] */
DECL|enumerator|CURSHOTY
id|CURSHOTY
op_assign
l_int|0x36
comma
multiline_comment|/* () ???  [position relative to CURSY] */
DECL|enumerator|CURSACAEN
id|CURSACAEN
op_assign
l_int|0x37
comma
multiline_comment|/* () ???  [even=cursor on, odd=cursor off] */
...
DECL|macro|set_555
mdefine_line|#define set_555(_p)&t;set_16(_p, 15)
DECL|macro|set_565
...
r_static
r_int
DECL|function|imsttfb_set_font
id|imsttfb_set_font
(paren
r_struct
id|display
...
c_func
(paren
l_string|&quot;fb%d: %s frame buffer; %uMB vram; chip version %u&bslash;n&quot;
comma
id|GET_FB_IDX
c_func
(paren
...
macro_line|#if defined(CONFIG_FB_OF) || defined(CONFIG_PPC)
DECL|function|__initfunc
id|__initfunc
c_func
(paren
