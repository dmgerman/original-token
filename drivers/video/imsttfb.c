...
DECL|macro|set_555
mdefine_line|#define set_555(_p)&t;set_16(_p, 0x01)
DECL|macro|set_565
mdefine_line|#define set_565(_p)&t;set_16(_p, 0x03)
r_static
r_void
...
suffix:semicolon
multiline_comment|/* out_le32(&amp;p-&gt;dc_regs[S2SA], fb_offset_new); */
id|out_le32
c_func
(paren
op_amp
...
r_inline
r_void
DECL|function|imsttfb_rectfill
id|imsttfb_rectfill
(paren
r_struct
id|display
...
c_func
(paren
l_string|&quot;updatevar: %u + %u &gt; %u&bslash;n&quot;
comma
id|sy
comma
id|height
