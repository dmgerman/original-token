...
suffix:semicolon
multiline_comment|/*&n; *   Memory-mapped I/O functions for Sparc PCI&n; */
...
DECL|function|igafb_pan_display
r_static
r_int
id|igafb_pan_display
c_func
(paren
r_struct
id|fb_var_screeninfo
...
id|info-&gt;frame_buffer_phys
suffix:semicolon
multiline_comment|/*&n;&t; * The right test would be to look if there is a base I/O address.&n;&t; * But it appears that IGA 1682 reuses _memory_ address as a base&n;&t; * for I/O accesses.&n;&t; */
r_if
c_cond
(paren
id|iga2000
...
r_else
(brace
multiline_comment|/* Obtain virtual address and correct physical by PCIC shift */
id|info-&gt;io_base
op_assign
id|pcic_alloc_io
c_func
...
suffix:semicolon
multiline_comment|/* XXX Here we left I/O allocated */
id|kfree
c_func
(paren
id|info
