...
multiline_comment|/*&n;     * If we get here no fb was specified and we default to pass the&n;     * options to the first frame buffer that has an init and a setup&n;     * function.&n;     */
r_for
c_loop
(paren
id|i
