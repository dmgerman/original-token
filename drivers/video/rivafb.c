...
macro_line|#ifndef CONFIG_PCI /* sanity check */
...
DECL|macro|assert
mdefine_line|#define assert(expr) &bslash;&n;&t;if(!(expr)) { &bslash;&n;        printk( &quot;Assertion failed! %s,%s,%s,line=%d&bslash;n&quot;,&bslash;&n;        #expr,__FILE__,__FUNCTION__,__LINE__); &bslash;&n;&t;*(int*)0 = 0; &bslash;&n;        }
macro_line|#else
DECL|macro|assert
...
DECL|macro|io_out8
mdefine_line|#define io_out8 outb
DECL|macro|io_in8
mdefine_line|#define io_in8 inb
DECL|macro|FatalError
mdefine_line|#define FatalError panic
DECL|macro|NUM_SEQ_REGS
mdefine_line|#define NUM_SEQ_REGS 0x05
DECL|macro|NUM_CRT_REGS
mdefine_line|#define NUM_CRT_REGS 0x41
DECL|macro|NUM_GRC_REGS
mdefine_line|#define NUM_GRC_REGS 0x09
DECL|macro|NUM_ATC_REGS
mdefine_line|#define NUM_ATC_REGS 0x15
multiline_comment|/* max number of VGA controllers we scan for */
DECL|macro|RIVA_MAX_VGA_CONTROLLERS
mdefine_line|#define RIVA_MAX_VGA_CONTROLLERS 8
DECL|macro|PFX
...
suffix:semicolon
DECL|variable|riva_pci_probe_list
r_static
r_const
r_struct
id|riva_chip_info
id|riva_pci_probe_list
(braket
)braket
op_assign
(brace
...
id|ram_amount
suffix:semicolon
multiline_comment|/* amount of RAM on card, in megabytes */
...
id|con_cmap
suffix:semicolon
macro_line|#endif /* FBCON_HAS_CFB16 | FBCON_HAS_CFB32 */
)brace
suffix:semicolon
...
id|riva_fb_ops
suffix:semicolon
macro_line|#warning FIXME: set monspecs to what???
id|info-&gt;display_fg
op_assign
l_int|NULL
suffix:semicolon
...
multiline_comment|/**&n; * riva_pci_region_size&n; * @pd: pointer to PCI device to be configured&n; *&n; * DESCRIPTION:&n; * Obtains from the PCI bus the size of the address space allocated to&n; * the given card&squot;s base address zero region.&n; */
r_static
DECL|function|riva_pci_region_size
id|u32
id|riva_pci_region_size
(paren
r_struct
...
macro_line|#if 0
multiline_comment|/**&n; * riva_pci_iomap&n; * @nv:&n; *&n; * DESCRIPTION:&n; */
r_static
r_void
id|riva_pci_region_init
(paren
...
suffix:semicolon
multiline_comment|/* from GGI */
multiline_comment|/* Get the base addresses */
...
suffix:semicolon
macro_line|#ifdef SHOULDUSETHAT
multiline_comment|/* This function should return an int. */
r_if
c_cond
(paren
op_logical_neg
...
macro_line|#endif /* 0 */
multiline_comment|/**&n; * riva_pci_iounmap&n; * @rinfo:&n; *&n; * DESCRIPTION:&n; */
r_static
DECL|function|riva_pci_iounmap
r_void
id|riva_pci_iounmap
(paren
r_struct
...
DECL|function|riva_pci_register
r_static
r_int
id|__init
id|riva_pci_register
...
DECL|function|riva_pci_register_devices
r_static
r_int
id|__init
id|riva_pci_register_devices
...
(brace
macro_line|#warning FIXME: is this all we need to do?
r_struct
id|rivafb_info
op_star
id|tmp
...
id|info
suffix:semicolon
multiline_comment|/* unused function arg */
)brace
...
multiline_comment|/**&n; * rivafb_get_fix&n; * @fix:&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; */
...
id|p-&gt;line_length
suffix:semicolon
macro_line|#warning FIXME: set up MMIO region
id|fix-&gt;mmio_start
op_assign
l_int|0
suffix:semicolon
...
l_int|0
suffix:semicolon
macro_line|#warning FIXME: reference riva acceleration fb.h constant here
id|fix-&gt;accel
op_assign
id|FB_ACCEL_NONE
suffix:semicolon
...
multiline_comment|/**&n; * rivafb_get_var&n; * @var:&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; */
...
multiline_comment|/**&n; * rivafb_set_var&n; * @var:&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; */
...
multiline_comment|/**&n; * rivafb_get_cmap&n; * @cmap:&n; * @kspc:&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; *&n; * NOTES:&n; * Copied from matroxfb::matroxfb_get_cmap()&n; */
...
multiline_comment|/**&n; * rivafb_set_cmap&n; * @cmap:&n; * @kspc:&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; *&n; * NOTES:&n; * Copied from matroxfb::matroxfb_set_cmap()&n; */
...
(brace
multiline_comment|/* FIXME: do the dirty deed */
)brace
id|dsp-&gt;var.xoffset
op_assign
id|var-&gt;xoffset
...
multiline_comment|/**&n; * rivafb_ioctl&n; * @inode:&n; * @file:&n; * @cmd:&n; * @arg:&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; */
...
multiline_comment|/**&n; * rivafb_switch&n; * @con:&n; * @info:&n; *&n; * DESCRIPTION:&n; */
