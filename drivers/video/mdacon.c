...
l_int|0x3b8
suffix:semicolon
multiline_comment|/*  Make sure there is an MDA card present.&n;&t; *  Are there smarter methods around?&n;&t; */
id|p
op_assign
(paren
id|u16
...
c_func
(paren
l_string|&quot;mdacon: MDA with %ldK of memory detected.&bslash;n&quot;
comma
id|mda_vram_len
op_div
l_int|1024
...
suffix:semicolon
multiline_comment|/* enable video &amp; blinking */
)brace
r_return
l_int|0
suffix:semicolon
