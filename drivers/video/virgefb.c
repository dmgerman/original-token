...
macro_line|#if 1
DECL|macro|vgawb_3d
mdefine_line|#define vgawb_3d(reg,dat) &bslash;&n;                (*((unsigned char *)(CyberVGARegs + (reg ^ 3))) = dat)
DECL|macro|vgaww_3d
...
c_func
(paren
l_string|&quot;CV3D detected running in Z2 mode ... not yet supported!&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
