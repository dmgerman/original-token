...
suffix:semicolon
DECL|macro|FUNCID
mdefine_line|#define FUNCID { printk(KERN_INFO &quot;entering %s&bslash;n&quot;, __FUNCTION__); }
id|__openfirmware
DECL|function|platinum_open
r_static
r_int
id|platinum_open
c_func
...
DECL|function|platinum_release
r_static
r_int
id|platinum_release
c_func
...
(paren
id|KERN_ERR
l_string|&quot;Error in platinum_set_var, calling platinum_var_to_par: %d.&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Not activating, in platinum_set_var.&bslash;n&quot;
)paren
suffix:semicolon
id|platinum_par_to_var
c_func
...
DECL|function|platinum_pan_display
r_static
r_int
id|platinum_pan_display
c_func
...
multiline_comment|/* DOH.  This makes platinum_set_var compare, you guessed it, */
...
multiline_comment|/*&n;&t;struct fb_info_platinum *p = (struct fb_info_platinum *) info;&n;&t;int&t;ctrl;&n;&n;&t;ctrl = ld_le32(&amp;p-&gt;platinum_regs-&gt;ctrl.r) | 0x33;&n;&t;if (blank_mode)&n;&t;&t;--blank_mode;&n;&t;if (blank_mode &amp; VESA_VSYNC_SUSPEND)&n;&t;&t;ctrl &amp;= ~3;&n;&t;if (blank_mode &amp; VESA_HSYNC_SUSPEND)&n;&t;&t;ctrl &amp;= ~0x30;&n;&t;out_le32(&amp;p-&gt;platinum_regs-&gt;ctrl.r, ctrl);&n;*/
...
DECL|macro|STORE_D2
mdefine_line|#define STORE_D2(a, d) { &bslash;&n;&t;out_8(&amp;p-&gt;cmap_regs-&gt;addr, (a+32)); &bslash;&n;&t;out_8(&amp;p-&gt;cmap_regs-&gt;d2, (d)); &bslash;&n;}
...
c_func
(paren
l_string|&quot;fb%d: platinum display adapter&bslash;n&quot;
comma
id|GET_FB_IDX
c_func
(paren
...
suffix:semicolon
multiline_comment|/* out_be32(&amp;p-&gt;platinum_regs-&gt;reg[27].r, 0x2aa); */
id|STORE_D2
c_func
(paren
l_int|0
...
suffix:semicolon
singleline_comment|//&t;p-&gt;frame_buffer = p-&gt;base_frame_buffer
singleline_comment|//&t;&t;&t;+ platinum_reg_init[p-&gt;par.vmode-1]-&gt;fb_offset;
macro_line|#ifdef CONFIG_FB_COMPAT_XPMAC
macro_line|#if 0
id|console_set_cmap_ptr
op_assign
...
(paren
id|KERN_ERR
l_string|&quot;Bad  resolution in platinum_var_to_par()!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;Bad  virtual resolution in platinum_var_to_par()!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;Bad color mode in platinum_var_to_par()!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;Bad vram size requested in platinum_var_to_par()!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(brace
multiline_comment|/* I&squot;m not sure if platinum has any specific requirements --&t;*/
multiline_comment|/* if we have a regvals struct, we&squot;re good to go?&t;&t;*/
id|printk
c_func
(paren
id|KERN_ERR
l_string|&quot;platinum_reg_init failed platinum_var_to_par()!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_ERR
l_string|&quot;Bad color mode in platinum_par_to_var()!&bslash;n&quot;
)paren
suffix:semicolon
id|par-&gt;cmode
op_assign
...
macro_line|#endif
DECL|function|platinum_init_fix
r_static
r_void
id|platinum_init_fix
c_func
...
DECL|function|platinum_par_to_fix
r_static
r_void
id|platinum_par_to_fix
c_func
...
suffix:semicolon
singleline_comment|//&t;fix-&gt;line_length = par-&gt;vxres &lt;&lt; par-&gt;cmode;
id|fix-&gt;line_length
op_assign
id|platinum_reg_init
(braket
...
DECL|function|platinum_init_display
r_static
r_void
id|platinum_init_display
c_func
...
DECL|function|platinum_par_to_display
r_static
r_void
id|platinum_par_to_display
c_func
...
(paren
id|KERN_ERR
l_string|&quot;Scroll mode not YREDRAW in platinum_par_to_display!!&bslash;n&quot;
)paren
suffix:semicolon
id|disp-&gt;scrollmode
op_assign
...
DECL|function|platinum_par_to_all
r_static
r_void
id|platinum_par_to_all
c_func
...
(brace
multiline_comment|/* Parse user speficied options (`video=platinumfb:&squot;) */
id|FUNCID
suffix:semicolon
)brace
macro_line|#endif
