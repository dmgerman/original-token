...
(paren
id|KERN_ERR
l_string|&quot;platinum_ioctl not yet implemented&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
mdefine_line|#define invalidate_cache(addr) &bslash;&n;&t;asm volatile(&quot;eieio; dcbi 0,%1&quot; &bslash;&n;&t;: &quot;=m&quot; (*(addr)) : &quot;r&quot; (addr) : &quot;memory&quot;);
macro_line|#else
DECL|macro|invalidate_cache
