multiline_comment|/* $Id: cgsixfb.c,v 1.2 1998/07/13 12:47:14 jj Exp $&n; * cgsixfb.c: CGsix (GX,GXplus) frame buffer driver&n; *&n; * Copyright (C) 1996,1998 Jakub Jelinek (jj@ultra.linux.cz)&n; * Copyright (C) 1996 Miguel de Icaza (miguel@nuclecu.unam.mx)&n; * Copyright (C) 1996 Eddie C. Dost (ecd@skynet.be)&n; */
...
comma
multiline_comment|/* FIXME: This should really be fbsize */
(brace
id|CG6_DHC
comma
id|CG6_DHC_OFFSET
...
id|fb-&gt;s.cg6.tec-&gt;tec_matrix
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.tec-&gt;tec_clip
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.tec-&gt;tec_vdc
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;clip
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;offx
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;offy
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;clipminx
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;clipminy
op_assign
l_int|0
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;clipmaxx
op_assign
id|fb-&gt;type.fb_width
op_minus
l_int|1
suffix:semicolon
id|fb-&gt;s.cg6.fbc-&gt;clipmaxy
op_assign
...
id|idstring
comma
l_string|&quot;cgsix at %02x.%08lx TEC Rev %x CPU %s Rev %x&quot;
comma
id|fb-&gt;iospace
comma
id|phys
