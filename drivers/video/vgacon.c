...
suffix:semicolon
r_void
DECL|function|clear_status_line
id|clear_status_line
c_func
(paren
r_void
...
(brace
macro_line|#if CONFIG_COMMENT_INT==3
id|u16
op_star
id|org
suffix:semicolon
...
macro_line|#if CONFIG_COMMENT_INT==3
r_void
DECL|function|paint_status_line
id|paint_status_line
c_func
(paren
r_int
id|timer
...
op_increment
suffix:semicolon
mdefine_line|#define DISP( x ) scr_writew(  (((i&amp;x) ? 0x90:0) &lt;&lt; 8) + &squot; &squot;, org++ );
id|DISP
c_func
(paren
l_int|0x80
