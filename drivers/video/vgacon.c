...
multiline_comment|/* KNOWN PROBLEMS/TO DO ========================================FIXME======== *&n; *&n; *&t;- monochrome attribute encoding (convert abscon &lt;-&gt; VGA style)&n; *&n; *&t;- add support for VESA blanking&n; *&n; *&t;- Cursor shape fixes&n; *&n; * KNOWN PROBLEMS/TO DO ==================================================== */
...
DECL|macro|VGA_CAN_DO_64KB
macro_line|#undef VGA_CAN_DO_64KB
DECL|macro|dac_reg
...
(brace
multiline_comment|/* FIXME: Implement! */
multiline_comment|/* FIXME: Check if we really ignore everything when the console is blanked. */
r_if
c_cond
(paren
id|blank
...
(brace
multiline_comment|/* FIXME: Better scrollback strategy, maybe move it to generic code&n;&t; *&t;  and leave only vga_set_mem_top here.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* FIXME: Handle scrolling down or by more lines? */
r_if
c_cond
(paren
op_logical_neg
