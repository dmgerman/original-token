...
suffix:semicolon
DECL|macro|_READCTL
mdefine_line|#define _READCTL(member, out) &bslash;&n;{ &bslash;&n;  struct p9100_ctrl *actual; &bslash;&n;  actual = (struct p9100_ctrl *)fb-&gt;s.p9100.ctrl; &bslash;&n;  out = actual-&gt; ## member ; &bslash;&n;}
DECL|macro|READCTL
mdefine_line|#define READCTL(member, out) &bslash;&n;{ &bslash;&n;  struct p9100_ctrl *enab, *actual; &bslash;&n;  actual = (struct p9100_ctrl *)fb-&gt;s.p9100.ctrl; &bslash;&n;  enab = (struct p9100_ctrl *)fb-&gt;s.p9100.fbmem; &bslash;&n;  out = enab-&gt; ## member ; &bslash;&n;  out = actual-&gt; ## member ; &bslash;&n;}
DECL|macro|WRITECTL
mdefine_line|#define WRITECTL(member, val) &bslash;&n;{ &bslash;&n;  u32 __writetmp; &bslash;&n;  struct p9100_ctrl *enab, *actual; &bslash;&n;  actual = (struct p9100_ctrl *)fb-&gt;s.p9100.ctrl; &bslash;&n;  enab = (struct p9100_ctrl *)fb-&gt;s.p9100.fbmem; &bslash;&n;  __writetmp = enab-&gt; ## member ; &bslash;&n;  actual-&gt; ## member = val; &bslash;&n;}
...
c_func
(paren
l_string|&quot;updating %d colors starting at %d&bslash;n&quot;
comma
id|count
comma
id|index
