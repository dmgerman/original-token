multiline_comment|/*&n; * Permedia2 framebuffer driver.&n; * Copyright (c) 1998-1999 Ilario Nardinocchi (nardinoc@CS.UniBO.IT)&n; * Copyright (c) 1999 Jakub Jelinek (jakub@redhat.com)&n; * Based on linux/drivers/video/skeletonfb.c by Geert Uytterhoeven.&n; * --------------------------------------------------------------------------&n; * $Id: pm2fb.c,v 1.163 1999/02/21 14:06:49 illo Exp $&n; * --------------------------------------------------------------------------&n; * TODO multiple boards support&n; * --------------------------------------------------------------------------&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file README.legal in the main directory of this archive&n; * for more details.&n; */
