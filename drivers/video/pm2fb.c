multiline_comment|/*&n; * Permedia2 framebuffer driver.&n; * Copyright (c) 1998-1999 Ilario Nardinocchi (nardinoc@CS.UniBO.IT)&n; * Based on linux/drivers/video/skeletonfb.c by Geert Uytterhoeven.&n; * --------------------------------------------------------------------------&n; * $Id: pm2fb.c,v 1.1.2.1 1999/01/12 19:53:02 geert Exp $&n; * --------------------------------------------------------------------------&n; * This file is subject to the terms and conditions of the GNU General Public&n; * License.  See the file README.legal in the main directory of this archive&n; * for more details.&n; */
...
DECL|macro|MMAP
mdefine_line|#define MMAP(a,b)&t;(unsigned char* )kernel_map((unsigned long )(a), &bslash;&n;&t;&t;&t;&t;&t;b, KERNELMAP_NOCACHE_SER, NULL)
macro_line|#else
DECL|macro|MMAP
mdefine_line|#define MMAP(a,b)&t;ioremap(a, b)
macro_line|#endif
...
mdefine_line|#define OPTF_OLD_MEM&t;&t;0x00000001
DECL|macro|OPTF_YPAN
mdefine_line|#define OPTF_YPAN&t;&t;0x00000002
r_static
r_struct
(brace
DECL|member|font
...
c_func
(paren
l_string|&quot;invalid width %lu&bslash;n&quot;
comma
id|xres
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;width not supported: %lu&bslash;n&quot;
comma
id|xres
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;virtual width not supported: %lu&bslash;n&quot;
comma
id|p.width
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;height not supported: %lu&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;virtual height not supported: %lu&bslash;n&quot;
comma
id|p.height
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;pixclock too high (%luKHz)&bslash;n&quot;
comma
id|p.pixclock
)paren
suffix:semicolon
...
id|i-&gt;current_par.height
comma
id|pm2fb_options.user_mode.height
)paren
suffix:semicolon
)brace
)brace
...
c_func
(paren
l_string|&quot;bad depth %lu&bslash;n&quot;
comma
id|i-&gt;current_par.depth
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;fb%d: %s (%s), using %ldK of video memory.&bslash;n&quot;
comma
id|GET_FB_IDX
c_func
(paren
