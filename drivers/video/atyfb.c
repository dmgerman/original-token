...
suffix:semicolon
macro_line|#else
macro_line|#ifdef __sparc__v9__
id|temp
op_assign
id|info-&gt;ati_regbase
op_plus
...
(brace
multiline_comment|/*&n;&t;&t; * What to do here? - The contents of MEM_CNTL do not&n;&t;&t; * seem to match my documentation, and touching this&n;&t;&t; * register makes the output unusable.&n;&t;&t; * (green bars across the screen and similar effects).&n;&t;&t; *&n;&t;&t; * Eddie C. Dost  (ecd@skynet.be)&n;&t;&t; */
id|j
op_assign
l_int|0x87010184
suffix:semicolon
...
(brace
id|display-&gt;dispsw-&gt;cursor
op_assign
id|atyfb_cursor
suffix:semicolon
id|display-&gt;dispsw-&gt;set_font
op_assign
id|atyfb_set_font
suffix:semicolon
)brace
