...
DECL|macro|PLL_DEBUG
macro_line|#undef PLL_DEBUG
...
c_func
(paren
l_string|&quot;%d%c %d MHz PLL, %d Mhz MCLK&bslash;n&quot;
comma
id|info-&gt;total_vram
op_eq
l_int|0x80000
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * FIXME: Read the PLL to figure actual Refresh Rate.&n;&t;&t; *        Default to 66Hz for now.&n;&t;&t; */
id|h_total
op_assign
id|var-&gt;xres
op_plus
