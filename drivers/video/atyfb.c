...
multiline_comment|/******************************************************************************&n;&n;  TODO:&n;&n;  (ecd):&n;&n;    - fix initialization of cursor timer.&n;&n;    - add code to support cursor on all cards and all ramdacs.&n;&n;    - make cursor parameters controllable via ioctl()s.&n;&n;&t;&t;&t;&t;&t;&t;(Anyone to help with all this?)&n;&n;******************************************************************************/
...
comma
multiline_comment|/*  { 0x5656, 0x5656, &quot;mach64VT4 (ATI264VT4)&quot; }, */
...
comma
multiline_comment|/*  { 0x4756, 0x4756, &quot;3D RAGE IIC&quot; }, */
(brace
l_int|0x4742
comma
l_int|0x4742
...
macro_line|#endif /* defined(CONFIG_PMAC) || defined(CONFIG_CHRP) */
multiline_comment|/* ------------------------------------------------------------------------- */
...
c_func
(paren
l_string|&quot;PLL_REF_DIV:   %02x (%02x)&bslash;n&quot;
comma
id|pll-&gt;pll_ref_div
comma
id|aty_ld_pll
...
c_func
(paren
l_string|&quot;PLL_GEN_CNTL:  %02x (%02x)&bslash;n&quot;
comma
id|pll-&gt;pll_gen_cntl
comma
id|aty_ld_pll
...
c_func
(paren
l_string|&quot;MCLK_FB_DIV:   %02x (%02x)&bslash;n&quot;
comma
id|pll-&gt;mclk_fb_div
comma
id|aty_ld_pll
...
c_func
(paren
l_string|&quot;PLL_VCLK_CNTL: %02x (%02x)&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;VCLK_POST_DIV: %02x (%02x)&bslash;n&quot;
comma
...
c_func
(paren
l_string|&quot;VCLK0_FB_DIV:  %02x (%02x)&bslash;n&quot;
comma
id|pll-&gt;vclk_fb_div
comma
id|aty_ld_pll
...
c_func
(paren
l_string|&quot;PLL_EXT_CNTL:  %02x (%02x)&bslash;n&quot;
comma
id|pll-&gt;pll_ext_cntl
comma
id|aty_ld_pll
...
c_func
(paren
l_string|&quot;atyfb: %s [0x%04x rev 0x%2x] &quot;
comma
id|chipname
comma
id|Gx
...
c_func
(paren
l_string|&quot;%d MHz PLL, %d Mhz MCLK&bslash;n&quot;
comma
id|pll
comma
id|mclk
