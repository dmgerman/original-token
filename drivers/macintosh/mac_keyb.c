...
multiline_comment|/* Enable full feature set of the keyboard&n;&t;   -&gt;get it to send separate codes for left and right shift,&n;&t;   control, option keys */
r_for
c_loop
(paren
id|i
...
multiline_comment|/* Register 1 is usually used for device identification.&n;&t;       Here, we try to identify a known device and call the&n;&t;       appropriate init function */
id|adb_request
c_func
(paren
op_amp
