...
DECL|variable|pmu_has_backlight
r_static
r_int
id|pmu_has_adb
comma
id|pmu_has_backlight
suffix:semicolon
...
id|pmu_send_request
comma
multiline_comment|/*pmu_queue_request,*/
id|pmu_adb_autopoll
comma
id|pmu_poll
comma
...
c_func
(paren
l_string|&quot;find_via_pmu: node = %p, addrs =&quot;
comma
id|vias-&gt;node
)paren
suffix:semicolon
...
id|flags
suffix:semicolon
multiline_comment|/* Currently, we use brute-force cli() for syncing with GPIO&n;&t; * interrupt. I&squot;ll make this smarter later, along with some&n;&t; * spinlocks for SMP */
id|save_flags
c_func
(paren
id|flags
...
id|PMU_HEATHROW_BASED
suffix:colon
multiline_comment|/* We cannot use nvram_read_byte here (not yet initialized) */
id|pmu_request
c_func
(paren
op_amp
...
id|PMU_KEYLARGO_BASED
suffix:colon
multiline_comment|/* the G3 PB 1999 has a backlight node&n;&t;&t;&t;   and chrp-structured nvram */
multiline_comment|/* XXX should read macos&squot;s &quot;blkt&quot; property in nvram&n;&t;&t;&t;   for this node.  For now this ensures that the&n;&t;&t;&t;   backlight doesn&squot;t go off as soon as linux boots. */
id|backlight_level
op_assign
l_int|20
suffix:semicolon
