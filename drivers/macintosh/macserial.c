...
c_func
(paren
l_string|&quot;PowerMac Z8530 serial driver version 1.01&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* XXX tested only with wallstreet PowerBook,&n;&t;&t;&t;   should do no harm anyway */
id|conn
op_assign
id|get_property
c_func
