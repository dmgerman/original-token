...
id|zs_conschan
suffix:semicolon
multiline_comment|/*&n; * Initialization values for when a channel is used for&n; * kernel gdb support.&n; */
...
suffix:semicolon
multiline_comment|/*&n; * Initialization values for when a channel is used for&n; * a serial console.&n; */
DECL|variable|cons_init_regs
r_static
r_int
r_char
id|cons_init_regs
...
suffix:semicolon
multiline_comment|/*&n; * Hooks for running a serial console.  con_init() calls this if the&n; * console is being run over one of the serial ports.&n; * &squot;channel&squot; is decoded as 1=modem, 2=printer.&n; */
r_void
...
c_func
(paren
l_string|&quot;rs_cons_hook called twice?&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
c_func
(paren
l_string|&quot;rs_cons_hook: channel = %d?&bslash;n&quot;
comma
id|channel
)paren
suffix:semicolon
...
id|zs_conschan
op_assign
id|zs_consinfo-&gt;zs_channel
suffix:semicolon
id|zs_consinfo-&gt;clk_divisor
op_assign
l_int|16
suffix:semicolon
id|zs_consinfo-&gt;zs_baud
op_assign
l_int|38400
suffix:semicolon
id|zs_consinfo-&gt;is_cons
op_assign
l_int|1
suffix:semicolon
id|memcpy
