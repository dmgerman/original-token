...
singleline_comment|//&t;&t;printk(&quot;rs_interrupt: irq %d, zs_intreg 0x%x&bslash;n&quot;, irq, (int)zs_intreg);
macro_line|#endif&t;
r_if
c_cond
(paren
...
(brace
multiline_comment|/* Power down modem */
id|feature_set
c_func
(paren
id|info-&gt;dev_node
...
(brace
multiline_comment|/* Power up modem */
id|feature_set
c_func
(paren
id|info-&gt;dev_node
...
(brace
multiline_comment|/* Just in case the modem is up, shut it down */
id|feature_set
c_func
(paren
id|ch
