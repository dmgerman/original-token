multiline_comment|/*&n; * Exported procedures for the ATI/mach64 display driver on PowerMacs.&n; *&n; * Copyright (C) 1997 Michael AK Tesch&n; *  written with much help from Jon Howell&n; *&t;&n; * This program is free software; you can redistribute it and/or&n; * modify it under the terms of the GNU General Public License&n; * as published by the Free Software Foundation; either version&n; * 2 of the License, or (at your option) any later version.&n; */
r_extern
r_void
id|map_aty_display
c_func
...
mdefine_line|#define CLOCK_STROBE&t;0x40
...
mdefine_line|#define PLL_DUTY_CYC&t;0xE0
DECL|macro|PLL_OVERRIDE
mdefine_line|#define PLL_OVERRIDE&t;0x01
DECL|macro|PLL_MCLK_RST
mdefine_line|#define PLL_MCLK_RST&t;0x02
DECL|macro|OSC_EN
mdefine_line|#define OSC_EN&t;&t;&t;0x04
DECL|macro|EXT_CLK_EN
mdefine_line|#define EXT_CLK_EN&t;&t;0x08
DECL|macro|MCLK_SRC_SEL
mdefine_line|#define MCLK_SRC_SEL&t;0x70
DECL|macro|EXT_CLK_CNTL
mdefine_line|#define EXT_CLK_CNTL&t;0x80
DECL|macro|VCLK_SRC_SEL
mdefine_line|#define VCLK_SRC_SEL&t;0x03
DECL|macro|PLL_VCLK_RST
mdefine_line|#define PLL_VCLK_RST&t;0x04
...
DECL|macro|EISA
mdefine_line|#define EISA&t;&t;1
DECL|macro|LOCAL_BUS
mdefine_line|#define LOCAL_BUS&t;6
DECL|macro|PCI
...
mdefine_line|#define DAC_STG1700&t;&t;&t;0x06
DECL|macro|DAC_ATT498
mdefine_line|#define DAC_ATT498&t;&t;&t;0x16
DECL|macro|DAC_STG1702
mdefine_line|#define DAC_STG1702&t;&t;&t;0x07
DECL|macro|DAC_SC15021
mdefine_line|#define DAC_SC15021&t;&t;&t;0x17
DECL|macro|DAC_ATT21C498
mdefine_line|#define DAC_ATT21C498&t;&t;0x27
DECL|macro|DAC_STG1703
mdefine_line|#define DAC_STG1703&t;&t;&t;0x37
DECL|macro|DAC_CH8398
mdefine_line|#define DAC_CH8398&t;&t;&t;0x47
...
mdefine_line|#define CLK_STG1703&t;&t;&t;2
DECL|macro|CLK_CH8398
mdefine_line|#define CLK_CH8398&t;&t;&t;3
