...
mdefine_line|#define MB_RESET_COUNT&t;40
...
mdefine_line|#define MB_IDE_WAIT&t;1500
r_static
r_void
id|poll_media_bay
c_func
...
suffix:semicolon
multiline_comment|/* I suppose this is enough delay to stabilize MB_CONTENT ... */
id|mdelay
c_func
(paren
l_int|10
...
suffix:semicolon
multiline_comment|/* We re-enable the bay using it&squot;s previous content only if&n;&t;&t;&t;   it did not change */
r_if
c_cond
(paren
id|MB_CONTENTS
...
suffix:semicolon
multiline_comment|/* Clear the bay reset */
id|feature_clear
c_func
(paren
id|bay-&gt;dev_node
...
suffix:semicolon
multiline_comment|/* This small delay makes sure the device has time&n;&t;&t;&t;&t;&t;   to assert the BUSY bit (used by IDE sleep) */
id|udelay
c_func
(paren
l_int|100
...
suffix:semicolon
multiline_comment|/* We reset the state machine timers in case we were in the&n;&t;&t;&t;&t;&t;   middle of a wait loop */
r_if
c_cond
(paren
id|bay-&gt;reset_timer
