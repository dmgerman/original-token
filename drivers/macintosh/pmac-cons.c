...
comma
macro_line|#if 0&t;/* not right for 3D mach64 yet */
(brace
...
suffix:semicolon
multiline_comment|/* in arch/ppc/pmac/prom.c */
DECL|macro|cmapsz
...
(paren
id|KERN_INFO
l_string|&quot;No usable display device found&quot;
l_string|&quot;- using serial console&bslash;n&quot;
)paren
suffix:semicolon
id|serial_console
op_assign
l_int|1
suffix:semicolon
multiline_comment|/* no screen - fall back to serial */
r_return
suffix:semicolon
)brace
id|ap
...
l_int|1
suffix:semicolon
multiline_comment|/* inhibits prom_print */
id|can_do_color
op_assign
l_int|1
suffix:semicolon
...
id|address
suffix:semicolon
multiline_comment|/* temporary kludge for valkyrie */
r_if
c_cond
(paren
id|strcmp
