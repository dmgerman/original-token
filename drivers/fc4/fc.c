...
id|size
comma
l_string|&quot;FCP SCSI cmd &amp; rsp queues&quot;
comma
id|dma
)paren
suffix:semicolon
)brace
DECL|function|fc_sync_dma_entry
r_static
r_inline
id|dma_handle
id|fc_sync_dma_entry
c_func
(paren
r_void
op_star
...
DECL|function|fc_sync_dma_exit
r_static
r_inline
r_void
id|fc_sync_dma_exit
...
DECL|function|fc_sync_dma_entry_sg
r_static
r_inline
r_void
id|fc_sync_dma_entry_sg
c_func
(paren
r_struct
id|scatterlist
...
DECL|function|fc_sync_dma_exit_sg
r_static
r_inline
r_void
id|fc_sync_dma_exit_sg
c_func
(paren
r_struct
id|scatterlist
...
suffix:semicolon
DECL|macro|LSMAGIC
mdefine_line|#define LSMAGIC&t;0x2a3b4d2a
r_typedef
r_struct
(brace
...
suffix:semicolon
DECL|macro|LSOMAGIC
mdefine_line|#define LSOMAGIC 0x2a3c4e3c
r_typedef
r_struct
(brace
multiline_comment|/* Must be first */
...
(paren
(paren
l_string|&quot;Receive solicited %d %d %d&bslash;n&quot;
comma
id|proto
comma
id|token
...
id|token
suffix:semicolon
multiline_comment|/* Make us sure */
r_if
c_cond
(paren
(paren
...
(paren
(paren
l_string|&quot;Initializing FLOGI packets&bslash;n&quot;
)paren
)paren
r_for
c_loop
...
(paren
(paren
l_string|&quot;Sending FLOGI/PLOGI packets&bslash;n&quot;
)paren
)paren
r_for
c_loop
...
(paren
(paren
l_string|&quot;Chose token %ld %08lx&bslash;n&quot;
comma
id|i
comma
(paren
...
id|printk
(paren
l_string|&quot;%s: SG for use_sg &gt; 1 not handled yet&bslash;n&quot;
comma
id|fc-&gt;name
)paren
suffix:semicolon
...
(paren
(paren
l_string|&quot;Trying to enque %08x&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
(paren
l_string|&quot;hw_enque succeeded for %08x&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
(paren
l_string|&quot;Putting into que1 %08x&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
(paren
l_string|&quot;Entering SCSI queuecommand %08x&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
(paren
l_string|&quot;Putting into que0&bslash;n&quot;
)paren
)paren
id|fcp_scsi_insert_queue
(paren
...
(brace
multiline_comment|/* The hw tell us we can try again queue some packet */
r_if
c_cond
(paren
id|fc-&gt;hw_enque
...
id|printk
(paren
l_string|&quot;FC: AIEEE, abort!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
id|printk
(paren
l_string|&quot;FC: AIEEE, reset!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
