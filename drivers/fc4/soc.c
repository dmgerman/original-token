...
(paren
(paren
l_string|&quot;soc_solicited, %d packets arrived&bslash;n&quot;
comma
(paren
id|sw_cq-&gt;in
op_minus
...
suffix:semicolon
multiline_comment|/* We have intentionally defined FC_STATUS_* constants to match SOC_* constants, otherwise&n;&t;&t;&t;   we&squot;d have to translate status */
id|fcp_receive_solicited
c_func
(paren
id|fc
...
(brace
multiline_comment|/* Ask the hardware about it if they haven&squot;t arrived yet */
id|s-&gt;regs-&gt;cmd
op_assign
(paren
id|sw_cq-&gt;out
...
id|printk
(paren
l_string|&quot;%s: Invalid R_CTL %02x continuation entries&bslash;n&quot;
comma
id|fc-&gt;name
comma
id|r_ctl
...
id|printk
(paren
l_string|&quot;%s: Unknown LS_CMD %02x&bslash;n&quot;
comma
id|fc-&gt;name
comma
id|buf
...
id|printk
(paren
l_string|&quot;%s: Unsolicited R_CTL %02x not handled&bslash;n&quot;
comma
id|fc-&gt;name
comma
id|r_ctl
...
(paren
(paren
l_string|&quot;SOC uses IRQ%d&bslash;n&quot;
comma
id|irq
)paren
)paren
...
multiline_comment|/* FIXME: sparc_dvma_free() ??? */
)brace
)brace
macro_line|#endif
eof
