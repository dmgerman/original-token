...
c_func
(paren
l_string|&quot;Winbond unkown chip type&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
multiline_comment|/* We know about this one. */
r_continue
suffix:semicolon
id|printk
(paren
id|KERN_INFO
l_string|&quot;Unknown PCI parallel I/O card (%04x/%04x)&bslash;n&quot;
l_string|&quot;Please send &squot;lspci&squot; output to &quot;
l_string|&quot;tim@cyberelk.demon.co.uk&bslash;n&quot;
comma
id|pcidev-&gt;vendor
comma
id|pcidev-&gt;device
...
id|superio
comma
l_string|&quot;Enable Super-IO chipset probe&quot;
)paren
suffix:semicolon
id|MODULE_PARM
c_func
