...
suffix:semicolon
multiline_comment|/* Capture mode, Enable DRAM, PC enable */
r_for
c_loop
(paren
id|y
...
l_int|16
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Avoid overrunning the given buffer&t;&n;&t;&t; */
id|n
op_assign
(paren
(paren
...
id|buf
suffix:semicolon
multiline_comment|/* Bytes left in frame */
id|n
op_assign
id|count
op_minus
...
(brace
multiline_comment|/* But only as many as needed */
id|n
op_assign
id|dw
suffix:semicolon
...
multiline_comment|/*&n;&t; *&t;Set back to capture even frames&n;&t; */
r_if
c_cond
(paren
id|wh
