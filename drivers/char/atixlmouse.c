multiline_comment|/*&n; * ATI XL Bus Mouse Driver for Linux&n; * by Bob Harris (rth@sparta.com)&n; *&n; * Uses VFS interface for linux 0.98 (01OCT92)&n; *&n; * version 0.3&n; */
...
l_int|3
suffix:semicolon
multiline_comment|/* 3 data bytes returned */
)brace
