...
multiline_comment|/*&n; * For fun, somebody might look into using the MMU for this.&n; * NOTE! It&squot;s not trivial: you have to check that the mapping&n; * is a private mapping and if so you can just map in the&n; * zero page directly. But shared mappings _have_ to use the&n; * physical copy.&n; */
