...
DECL|struct|pp_port_list_struct
r_struct
id|pp_port_list_struct
(brace
DECL|member|port
r_struct
id|parport
...
suffix:semicolon
multiline_comment|/* pp_attach and pp_detach are for keeping a list of currently&n; * available ports, held under a mutex.  We do this rather than&n; * using parport_enumerate because it stops a load of races.&n; */
DECL|function|pp_attach
r_static
r_void
id|pp_attach
(paren
...
id|KERN_WARNING
id|CHRDEV
l_string|&quot;: memory squeeze&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
id|KERN_WARNING
id|CHRDEV
l_string|&quot;: unable to register driver&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
