...
id|printk
(paren
l_string|&quot;serial167: cy_get_user: error == %d&bslash;n&quot;
comma
id|error
)paren
suffix:semicolon
...
id|panic
(paren
l_string|&quot;Couldn&squot;t get serial IRQs&quot;
)paren
suffix:semicolon
)brace
