...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * If we&squot;re opening the master pty, just return.  If we&squot;re&n;&t; * trying to open the slave pty, then we have to wait for the&n;&t; * master pty to open.&n;&t; */
r_if
c_cond
(paren
id|tty-&gt;driver.subtype
