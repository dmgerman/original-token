...
id|old_pty_driver
suffix:semicolon
multiline_comment|/* only the master pty gets this ioctl (which is why we&n;&t; * assign it here, instead of up with the rest of the&n;&t; * pty_driver initialization. &lt;cananian@alumni.princeton.edu&gt;&n;&t; */
id|pty_driver.ioctl
op_assign
id|pty_ioctl
suffix:semicolon
