multiline_comment|/*&n; * APM BIOS driver for Linux&n; * Copyright 1994, 1995 Stephen Rothwell (Stephen.Rothwell@pd.necisa.oz.au)&n; *&n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2, or (at your option) any&n; * later version.&n; *&n; * This program is distributed in the hope that it will be useful, but&n; * WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU&n; * General Public License for more details.&n; *&n; * $Id: apm_bios.c,v 0.22 1995/03/09 14:12:02 sfr Exp $&n; *&n; * October 1995, Rik Faith (faith@cs.unc.edu):&n; *    Minor enhancements and updates (to the patch set) for 1.3.x&n; *&n; * Reference:&n; *&n; *   Intel Corporation, Microsoft Corporation. Advanced Power Management&n; *   (APM) BIOS Interface Specification, Revision 1.1, September 1993.&n; *   Intel Order Number 241704-001.  Microsoft Part Number 781-110-X01.&n; *&n; * [This document is available free from Intel by calling 800.628.8686 (fax&n; * 916.356.6100) or 800.548.4725.  It is also available from Microsoft by&n; * calling 206.882.8080; and is ftpable from&n; * ftp://ftp.intel.com/pub/IAL/software_specs/apmv11.doc]&n; *&n; */
...
id|p
comma
l_string|&quot;BIOS version: %d.%d&bslash;nFlags: 0x%02x&bslash;n&quot;
comma
(paren
id|apm_bios_info.version
op_rshift
...
id|p
comma
l_string|&quot;AC: %s&bslash;nBattery status: %s&bslash;nBattery life: &quot;
comma
id|power_stat
comma
id|bat_stat
...
id|p
comma
l_string|&quot;Battery flag: 0x%02x&bslash;nBattery life: &quot;
comma
(paren
id|cx
op_rshift
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * This is not clear from the spec, but at least one&n;&t;&t; * machine needs this to be a 64k segment.&n;&t;&t; */
id|set_limit
c_func
(paren
id|gdt
