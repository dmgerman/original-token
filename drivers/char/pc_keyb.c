...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Wait for input data to become available.  This bit will&n;&t;&t; * then be cleared by the following read of the DATA&n;&t;&t; * register.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Check to see if a timeout error has occurred.  This means&n;&t;&t; * that transmission was started but did not complete in the&n;&t;&t; * normal time cycle.  PERR is set when a parity error occurred&n;&t;&t; * in the last transmission.&n;&t;&t; */
r_if
c_cond
(paren
id|status
...
mdefine_line|#define disable_keyboard()&t;do { send_cmd(KBD_CCMD_KBD_DISABLE); kb_wait(); } while (0)
