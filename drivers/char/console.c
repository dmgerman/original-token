...
macro_line|#else
DECL|macro|DO_UPDATE
mdefine_line|#define DO_UPDATE IS_FG
macro_line|#endif
...
multiline_comment|/* FIXME: Can we do the whole scrollback logic here and call the driver&n; *&t;  only for changing the display? Yes, there is some magic with&n; *&t;  blanked screens, but we could unblank here. (Argh, there might&n; *&t;  be some problems with unblanking since this is called from real&n; *&t;  interrupts...)  --mj&n; */
...
multiline_comment|/* FIXME: Does it make sense to hide cursor on non-fg consoles? */
...
l_int|0
suffix:semicolon
multiline_comment|/* If console does not have save_screen routine,&n;&t;    &t;&t;     we should clear the screen */
id|vc_init
c_func
(paren
id|currcons
...
multiline_comment|/* FIXME: Cursor sometimes disappears when resizing */
multiline_comment|/* FIXME: We could also take data from the scrollback buffer */
...
multiline_comment|/* FIXME: Use console_bh for switching! */
r_if
c_cond
(paren
id|par
...
l_char|&squot;E&squot;
suffix:semicolon
multiline_comment|/* Arno:&n;&t;&t;&t; * Doesn&squot;t work, because csi_J(c,2)&n;&t;&t;&t; * calls con_clear and doesn&squot;t print&n;&t;&t;&t; * the erase char..&t;FIXME&n;&t;&t;&t; */
id|csi_J
c_func
(paren
id|currcons
...
multiline_comment|/* FIXME: Handle tabs in a special way and use putcs for them as well */
id|FLUSH
id|do_con_trol
c_func
(paren
...
multiline_comment|/*&n; * This routine initializes console interrupts, and does nothing&n; * else. If you want the screen to clear, call tty_write with&n; * the appropriate escape-sequence.&n; *&n; * FIXME: return early if we don&squot;t _have_ a video card installed.&n; */
...
(brace
multiline_comment|/* No height given, try guessing */
r_for
c_loop
(paren
id|h
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Empty fonts not allowed */
)brace
id|nonzero
suffix:colon
id|i
