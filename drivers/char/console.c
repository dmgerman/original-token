...
mdefine_line|#define IS_VISIBLE (*display_fg == vc_cons[currcons].d)
...
multiline_comment|/* FIXME: call poke_blanked_console? */
id|unblank_screen
c_func
(paren
)paren
...
c_func
(paren
l_string|&quot;Console: switching to %s %s %dx%d&bslash;n&quot;
comma
id|vc_cons
(braket
id|fg_console
