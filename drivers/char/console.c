...
multiline_comment|/* used in vga.c/tga.c/etc.c... :-) */
...
multiline_comment|/* these two also used in vesa_blank.c */
...
multiline_comment|/* these three also used in selection.c */
...
DECL|macro|last_lpos
mdefine_line|#define last_lpos (((video_mem_term-video_mem_base)/video_num_columns/2)-video_num_lines+1)
DECL|macro|last_origin_rel
mdefine_line|#define last_origin_rel ( last_lpos * video_num_columns )
DECL|macro|last_origin
mdefine_line|#define last_origin ( video_mem_base + last_origin_rel * 2 )
DECL|variable|__scrollback_mode
r_int
r_int
id|__scrollback_mode
suffix:semicolon
multiline_comment|/* 1 means scrollback can wrap */
r_extern
r_void
id|__set_origin
c_func
...
id|last_origin_rel
suffix:semicolon
multiline_comment|/* in case the top part of the screen has been modified since&n;&t;&t;&t; * the scroll wrapped, copy the top bit back to the bottom */
id|count
op_assign
(paren
id|video_num_lines
...
(brace
multiline_comment|/* assume __scrollback_mode == 1 */
id|lines
op_add_assign
id|__origin
suffix:semicolon
...
multiline_comment|/* we&squot;ve wrapped into kept region */
id|__scrollback_mode
op_assign
l_int|0
suffix:semicolon
