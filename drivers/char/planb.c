...
suffix:semicolon
multiline_comment|/* Clear the ram out, leave no junk */
id|memptr
op_assign
id|mem
suffix:semicolon
...
multiline_comment|/*  Useful for using vmalloc()ed memory as DMA target  */
DECL|function|vmalloc_to_bus
r_static
r_int
r_int
id|vmalloc_to_bus
...
(paren
id|KERN_ERR
l_string|&quot;PlanB: Double alloc of fbuffer!&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
DECL|macro|SWAP4
mdefine_line|#define SWAP4(x) (((x&gt;&gt;24) &amp; 0x000000ff) |&bslash;&n;                  ((x&gt;&gt;8)  &amp; 0x0000ff00) |&bslash;&n;                  ((x&lt;&lt;8)  &amp; 0x00ff0000) |&bslash;&n;                  ((x&lt;&lt;24) &amp; 0xff000000))
...
(paren
id|KERN_ERR
l_string|&quot;PlanB: Bad irq number (%d) or handler&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_ERR
l_string|&quot;PlanB: I don&squot;t know why, but IRQ %d busy&bslash;n&quot;
comma
(paren
r_int
)paren
