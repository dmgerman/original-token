...
l_int|0xffff
suffix:semicolon
multiline_comment|/* No glyph for this character (yet) */
)brace
id|p2
(braket
id|unicode
...
multiline_comment|/*&n;   * UNI_DIRECT_BASE indicates the start of the region in the User Zone&n;   * which always has a 1:1 mapping to the currently loaded font.  The&n;   * UNI_DIRECT_MASK indicates the bit span of the region.&n;   */
r_else
r_if
c_cond
(paren
