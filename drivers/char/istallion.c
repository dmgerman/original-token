...
c_func
(paren
l_string|&quot;STALLION: Warning, unit %d I/O address %x conflicts &quot;
...
c_func
(paren
l_string|&quot;STALLION: %s found, unit=%d io=%x mem=%x &quot;
...
c_func
(paren
l_string|&quot;STALLION: no room for more probed boards, &quot;
...
multiline_comment|/*****************************************************************************/
multiline_comment|/*&n; *&t;Memory device open code. Need to keep track of opens and close&n; *&t;for module handling.&n; */
DECL|function|stli_memopen
r_static
r_int
id|stli_memopen
c_func
