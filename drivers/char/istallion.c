...
c_func
(paren
l_string|&quot;STALLION: failed to probe shared memory region for %s in EISA slot=%d&bslash;n&quot;
comma
id|stli_brdnames
(braket
id|brdp-&gt;brdtype
...
r_continue
suffix:semicolon
multiline_comment|/*&n; *&t;&t;Check that we have room for this new board in our board&n; *&t;&t;info table.&n; */
r_if
c_cond
(paren
id|stli_nrbrds
...
c_func
(paren
l_string|&quot;STALLION: no room for more probed boards, maximum supported %d&bslash;n&quot;
comma
id|STL_MAXBRDS
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;STALLION: too many boards in configuration table, truncating to %d&bslash;n&quot;
comma
id|STL_MAXBRDS
)paren
suffix:semicolon
...
multiline_comment|/*&n; *&t;Now go probing for EISA boards if enabled.&n; */
r_if
c_cond
(paren
id|stli_eisaprobe
