...
mdefine_line|#define&t;STL_MAXBAUD&t;921600
...
c_func
(paren
l_string|&quot;STALLION: Warning, unit %d I/O address %x conflicts with another device&bslash;n&quot;
comma
id|brdp-&gt;brdnr
comma
id|brdp-&gt;iobase
...
c_func
(paren
l_string|&quot;stli_memwrite(ip=%x,fp=%x,buf=%x,count=%lu)&bslash;n&quot;
comma
(paren
r_int
)paren
