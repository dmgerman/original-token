...
macro_line|#include &lt;linux/digiPCI.h&gt;
macro_line|#endif /* ENABLE_PCI */
macro_line|#include &lt;linux/digi1.h&gt;
macro_line|#include &lt;linux/digiFep1.h&gt;
macro_line|#include &lt;linux/epca.h&gt;
...
suffix:semicolon
r_else
multiline_comment|/* Else get special mapped memory above RAM */
id|memaddr
op_assign
(paren
id|unchar
...
macro_line|#ifdef ENABLE_PCI
multiline_comment|/* --------------------- Begin get_PCI_configuration  ---------------------- */
DECL|function|get_PCI_configuration
r_int
id|get_PCI_configuration
c_func
(paren
...
multiline_comment|/* Is this an io address ? */
(paren
op_star
id|base_addr0
)paren
...
(paren
id|KERN_ERR
l_string|&quot;&lt;Error&gt; - DIGI PCI error: board not initializing due to error&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/* End get_PCI_configuration */
...
(brace
multiline_comment|/* Begin for each POSSIBLE remaining board */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Begin found XR */
r_if
c_cond
(paren
id|get_PCI_configuration
...
(brace
multiline_comment|/* Store a PCI/XR into the boards structure */
id|boards
(braket
id|boards_found
op_plus
...
suffix:semicolon
multiline_comment|/* Most cards use base_addr0, but some use base_addr2 */
id|boards
(braket
id|boards_found
op_plus
...
(brace
multiline_comment|/* ------------------------------------------------------------&n;&t;&t;&t;&t;&t;&t;Standard physical addresses are valid to the kernel as long &n;&t;&t;&t;&t;&t;&t;as they aren&squot;t above RAM. Higher addresses (Such as are &n;&t;&t;&t;&t;&t;&t;typical of a PCI system) need to be mapped in with the &n;&t;&t;&t;&t;&t;&t;ioremap command.  For boards using such high addresses the&n;&t;&t;&t;&t;&t;&t;driver will store both addresses.  One address (The physical)&n;&t;&t;&t;&t;&t;&t;will be held for the apps use (And mmap) and the other (The&n;&t;&t;&t;&t;&t;&t;ioremapped address) will be used in the kernel.&n; &n;&t;&t;&t;&t;&t;---------------------------------------------------------------- */
id|boards
(braket
id|boards_found
op_plus
...
op_increment
suffix:semicolon
multiline_comment|/* --------------------------------------------------------------&n;&t;&t;&t;&t;&t;I don&squot;t know what the below does, but the hardware guys say&n;&t;&t;&t;&t;&t;its required on everything except PLX (In this case XRJ).&n;&t;&t;&t;&t;---------------------------------------------------------------- */
...
multiline_comment|/* End store a PCI/XR into the board structure */
)brace
multiline_comment|/* End found XR */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Begin found XEM */
r_if
c_cond
(paren
id|get_PCI_configuration
...
(brace
multiline_comment|/* Begin store a PCI/XEM into the boards structure */
id|boards
(braket
id|boards_found
op_plus
...
(brace
multiline_comment|/* ------------------------------------------------------------&n;&t;&t;&t;&t;&t;&t;Standard physical addresses are valid to the kernel as long &n;&t;&t;&t;&t;&t;&t;as they aren&squot;t above RAM. Higher addresses (Such as are &n;&t;&t;&t;&t;&t;&t;typical of a PCI system) need to be mapped in with the &n;&t;&t;&t;&t;&t;&t;ioremap command.  For boards using such high addresses the&n;&t;&t;&t;&t;&t;&t;driver will store both addresses.  One address (The physical)&n;&t;&t;&t;&t;&t;&t;will be held for the apps use (And mmap) and the other (The&n;&t;&t;&t;&t;&t;&t;vremapped address) will be used in the kernel.&n; &n;&t;&t;&t;&t;&t;---------------------------------------------------------------- */
id|boards
(braket
id|boards_found
op_plus
...
multiline_comment|/* End store a PCI/XEM into the boards structure */
)brace
multiline_comment|/* End found XEM */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Begin found CX */
r_if
c_cond
(paren
id|get_PCI_configuration
...
(brace
multiline_comment|/* Begin store a PCI/CX into the boards structure */
id|boards
(braket
id|boards_found
op_plus
...
multiline_comment|/* End store a PCI/CX into the boards structure */
)brace
multiline_comment|/* End found CX */
r_if
c_cond
(paren
op_logical_neg
...
(brace
multiline_comment|/* Begin found XRJ */
r_if
c_cond
(paren
id|get_PCI_configuration
...
(brace
multiline_comment|/* Begin store a PCI/XRJ into the boards structure */
id|boards
(braket
id|boards_found
op_plus
...
multiline_comment|/* End store a PCI/XRJ into the boards structure */
)brace
multiline_comment|/* End found XRJ */
)brace
multiline_comment|/* End for each POSSIBLE remaining board */
r_return
id|pci_count
suffix:semicolon
)brace
