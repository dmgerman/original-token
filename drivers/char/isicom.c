...
(paren
id|KERN_DEBUG
l_string|&quot;ISILoad:Firmware loader Opened!!!&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif&t;
...
(paren
id|KERN_DEBUG
l_string|&quot;ISILoad:Firmware loader Close(Release)d&bslash;n&quot;
comma
)paren
suffix:semicolon
macro_line|#endif&t;
...
c_func
(paren
l_string|&quot;&bslash;nISILoad:Card%d reset failure (Possible bad I/O Port Address 0x%x).&bslash;n&quot;
comma
id|card
op_plus
l_int|1
...
multiline_comment|/*&n; *&t;Replaced the code below with hopefully a faster loop - sameer&n; */
multiline_comment|/*&t;&t;&t;&t;&t;&n;&t;&t;while (1) {&n;&t;&t;&t;wrd = port-&gt;xmit_buf[port-&gt;xmit_tail++];&n;&t;&t;&t;port-&gt;xmit_tail = port-&gt;xmit_tail &amp; (SERIAL_XMIT_SIZE - 1);&n;&t;&t;&t;port-&gt;xmit_cnt--;&n;&t;&t;&t;if (--txcount &gt; 0) {&n;&t;&t;&t;&t;wrd |= (port-&gt;xmit_buf[port-&gt;xmit_tail++] &lt;&lt; 8);&n;&t;&t;&t;&t;port-&gt;xmit_tail = port-&gt;xmit_tail &amp; (SERIAL_XMIT_SIZE - 1);&n;&t;&t;&t;&t;port-&gt;xmit_cnt--;&n;&t;&t;&t;&t;outw(wrd, base);&n;&t;&t;&t;&t;if (--txcount &lt;= 0) break;&n;&t;&t;&t;}&n;&t;&t;&t;else {&n;&t;&t;&t;&t;outw(wrd, base);&n;&t;&t;&t;&t;break;&n;&t;&t;&t;}&n;&t;&t;}&n;*/
id|InterruptTheCard
c_func
(paren
id|base
...
(paren
id|KERN_DEBUG
l_string|&quot;ISICOM: interrupt: not handling irq%d!.&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
multiline_comment|/*  open on higher 8 dev files on a 8 port card !!! */
r_if
c_cond
(paren
id|card-&gt;port_count
...
(paren
id|KERN_ERR
l_string|&quot;ISICOM: Opened &gt;8 on a 8 port card.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
