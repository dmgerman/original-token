...
comma
macro_line|#endif
macro_line|#ifdef CONFIG_FB_VGA
(brace
l_string|&quot;vga&quot;
comma
id|vgafb_init
...
comma
macro_line|#endif 
macro_line|#ifdef CONFIG_FB_MDA
(brace
l_string|&quot;mda&quot;
comma
id|mdafb_init
...
multiline_comment|/*&n;     *  Probe for all builtin frame buffer devices&n;     */
DECL|function|__initfunc
id|__initfunc
c_func
(paren
...
multiline_comment|/*&n;     * If we get here no fb was specified and we default to pass the&n;     * options to the first frame buffer that has an init and a setup&n;     * fuction.&n;     */
r_for
c_loop
(paren
id|i
