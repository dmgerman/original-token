...
(paren
id|KERN_INFO
l_string|&quot;  id: %s (0x%04x), vendor: %s (0x%04x)&bslash;n&quot;
comma
id|cards
(braket
id|n1
...
suffix:semicolon
macro_line|#if 1
multiline_comment|/* not yet, but that&squot;s the plan for autodetect... */
id|btv-&gt;type
op_assign
id|cards
(braket
...
(paren
id|KERN_INFO
l_string|&quot;  please mail card type, id + vendor to &quot;
)paren
suffix:semicolon
id|printk
c_func
...
macro_line|#if 1
multiline_comment|/* DEBUG: dump eeprom content if available */
r_if
c_cond
(paren
id|I2CRead
