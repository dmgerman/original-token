...
macro_line|#ifdef LOCK_I2C_BUS
macro_line|# error INSTALL ERROR
macro_line|# error gcc uses the old, obsolete i2c.h include file.  Please install the &bslash;&n;&t;new i2c stack.  Please install it by patching the kernel, otherwise &bslash;&n;&t;gcc will not find the new header files.
macro_line|#endif
...
l_int|0x13eb
comma
l_string|&quot;Hauppauge Computer Works Inc&quot;
)brace
comma
(brace
l_int|0x1461
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d: id: %s (0x%04x), vendor: %s (0x%04x)&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|cards
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d:   =&gt; card=%d (%s)&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|cards
...
(paren
id|KERN_INFO
l_string|&quot;please mail id + vendor, board name and &quot;
...
c_func
(paren
l_string|&quot;bttv%d: vbi: po=%08lx pe=%08lx&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|virt_to_bus
...
c_func
(paren
l_string|&quot;bttv%d: prisc: ro=%08lx re=%08lx&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|virt_to_bus
...
c_func
(paren
l_string|&quot;bttv%d: vrisc: ro=%08lx re=%08lx&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|virt_to_bus
...
c_func
(paren
l_string|&quot;bttv%d: make_clip: pal=%d size=%dx%d, bpl=%d bpp=%d&bslash;n&quot;
comma
id|btv-&gt;nr
comma
...
c_func
(paren
l_string|&quot;bttv%d: cap vgrab: queue %d&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|mp-&gt;frame
...
suffix:semicolon
multiline_comment|/* If we were asked to auto-detect, then do so! */
r_if
c_cond
(paren
id|btv-&gt;type
...
(brace
multiline_comment|/* many bt878 cards have a eeprom @ 0xa0 =&gt; read ID&n;&t;&t;   and try to identify it */
r_if
c_cond
(paren
id|I2CRead
...
multiline_comment|/* STB cards have a eeprom @ 0xae */
)brace
r_else
r_if
c_cond
...
dot
id|tea63xx
multiline_comment|/* &amp;&amp;&n;&t;    I2CRead(btv, I2C_TEA6300, &quot;TEA63xx&quot;) &gt;= 0 */
)paren
(brace
r_if
c_cond
...
suffix:semicolon
multiline_comment|/* wake up any waiting processes&n;&t;&t;   because shutdown flag is set, no new processes (in this queue) &n;&t;&t;   are expected&n;&t;&t;*/
id|btv-&gt;shutdown
op_assign
l_int|1
suffix:semicolon
