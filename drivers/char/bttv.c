...
mdefine_line|#define I2C_DELAY   50&t;&t;/* Was 10 - some reports that more is needed&n;&t;&t;&t;&t;   regardless of what the spec says */
DECL|macro|I2C_SET
...
multiline_comment|/* Maximum sample number per VBI line is 2044, NTSC delivers 1600&n;   Note that we write 2048-aligned to keep alignment to memory pages &n;   VBI_RISC is written so that it applies to either 2044 or 1600&n;*/
DECL|macro|VBI_SPL
...
l_int|0
suffix:semicolon
multiline_comment|/* cevans - prevents panic if initialization bails due to memory&n;         * alloc failures!&n;         */
id|btv-&gt;video_dev.minor
op_assign
op_minus
l_int|1
