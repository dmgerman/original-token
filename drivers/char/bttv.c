...
DECL|variable|i2c_algo_template
r_static
r_struct
id|i2c_algo_bit_data
id|i2c_algo_template
op_assign
(brace
l_int|NULL
comma
...
suffix:semicolon
DECL|variable|i2c_adap_template
r_static
r_struct
id|i2c_adapter
id|i2c_adap_template
op_assign
(brace
l_string|&quot;bt848&quot;
comma
...
suffix:semicolon
DECL|variable|i2c_client_template
r_static
r_struct
id|i2c_client
id|i2c_client_template
op_assign
(brace
...
c_func
(paren
l_string|&quot;bttv%d: i2c read 0x%x: %d&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|addr
...
multiline_comment|/*&t;Imagenation L-Model PXC200 Framegrabber */
...
id|tmp
suffix:semicolon
multiline_comment|/*&t;Initialise GPIO-connevted stuff */
id|btwrite
c_func
(paren
l_int|1
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x09) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x0a) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x0b) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x0c) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x0d) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x01) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x02) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x03) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x04) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x05) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x06) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(paren
id|KERN_INFO
l_string|&quot;I2C Write(0x00) = %i&bslash;nI2C Read () = %x&bslash;n&bslash;n&quot;
comma
id|tmp
comma
id|I2CRead
...
(brace
l_string|&quot;Magic TView CPH061 (bt878)&quot;
comma
l_int|3
comma
l_int|1
...
comma
(brace
l_string|&quot;Askey/Typhoon/Anubis Magic TView&quot;
comma
l_int|3
comma
l_int|1
...
suffix:semicolon
DECL|macro|TVCARDS
mdefine_line|#define TVCARDS (sizeof(tvcards)/sizeof(struct tvcard))
multiline_comment|/* ----------------------------------------------------------------------- */
DECL|function|audio
r_static
r_void
...
(paren
id|KERN_DEBUG
l_string|&quot;vbiodd: 0x%lx&bslash;n&quot;
comma
(paren
r_int
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;vbievn: 0x%lx&bslash;n&quot;
comma
(paren
r_int
)paren
...
(brace
multiline_comment|/* yuv-to-offscreen (BT848_COLOR_FMT_YUY2) */
id|bpp
op_assign
l_int|2
suffix:semicolon
id|bpl
op_assign
id|btv-&gt;win.win2.pitch
suffix:semicolon
id|adr
op_assign
id|btv-&gt;win.vidadr
op_plus
id|btv-&gt;win.win2.start
suffix:semicolon
)brace
r_else
(brace
...
(brace
multiline_comment|/* yuv-to-offscreen */
id|format
op_assign
id|BT848_COLOR_FMT_YUY2
suffix:semicolon
...
multiline_comment|/* int oldAudio = btv-&gt;audio; */
...
suffix:colon
(brace
multiline_comment|/* experimental -- right now it handles unclipped yuv data only */
r_struct
id|video_window2
id|vo
suffix:semicolon
...
macro_line|#if 0
macro_line|#warning this should be handled by tda9855.c
r_else
r_if
c_cond
(paren
...
macro_line|#if 0
macro_line|#warning please use tda8425.c instead
r_static
r_void
id|init_tda8425
c_func
...
id|BTTV_STB
suffix:semicolon
macro_line|#if 0&t;/* bad idea: 0xc0 is used for the tuner on _many_ boards */
)brace
r_else
r_if
c_cond
...
multiline_comment|/* print which board we have found */
id|printk
c_func
(paren
id|KERN_INFO
...
(brace
multiline_comment|/* PHILIPS FI1216MK2 tuner (PAL/SECAM) */
id|btv-&gt;tuner_type
op_assign
id|TUNER_PHILIPS_SECAM
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d: audio chip: MSP34xx&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d: audio chip: TDA985x&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d: fader chip: TEA63xx&bslash;n&quot;
comma
id|i
)paren
suffix:semicolon
...
(brace
multiline_comment|/*wake_up_interruptible(&amp;btv-&gt;capq);*/
id|btv-&gt;last_field
op_assign
id|btv-&gt;field
suffix:semicolon
