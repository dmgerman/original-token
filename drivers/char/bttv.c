...
(brace
multiline_comment|/*  printk(&quot;adr: 0x%8x, &quot;,adr);&n;&t;printk(&quot;phys: 0x%8x, &quot;,(uvirt_to_phys(adr)));&n;&t;printk(&quot;bus: 0x%8x&bslash;n&quot;,virt_to_bus(phys_to_virt(uvirt_to_phys(adr))));&n;&t;*/
r_return
id|virt_to_bus
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;bttv: Double alloc of fbuffer!&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(brace
multiline_comment|/* enable least significant GPIO output nibble */
id|btwrite
c_func
(paren
l_int|0x0f
...
id|btv-&gt;win.color_fmt
suffix:semicolon
multiline_comment|/*&t;RGB8 seems to be a 9x5x5 GRB color cube starting at&n;&t; *&t;color 16. Why the h... can&squot;t they even mention this in the&n;&t; *&t;datasheet???  [AC - because its a standard format so I guess&n;&t; *&t;it never occured them]&n;&t; *&t;Enable dithering in this mode&n;&t; */
r_if
c_cond
(paren
id|format
...
multiline_comment|/* FIXME: norm should be in video_channel struct &n;&t;&t;&t;   composite source can have different norms too&n;&t;&t;&t; */
id|btv-&gt;win.norm
op_assign
id|v.mode
suffix:semicolon
...
id|triton1
op_or
multiline_comment|/*&t;        BT848_INT_PABORT|BT848_INT_RIPERR|BT848_INT_PPERR|&n;&t;&t;BT848_INT_FDSR|BT848_INT_FTRGT|BT848_INT_FBUS|*/
id|BT848_INT_SCERR
op_or
id|BT848_INT_RISCI
op_or
...
(paren
id|KERN_INFO
l_string|&quot;bttv: Brooktree Bt%d (rev %d) &quot;
comma
id|btv-&gt;id
comma
id|btv-&gt;revision
