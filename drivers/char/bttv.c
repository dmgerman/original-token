...
comma
multiline_comment|/* &quot;Leadtek WinView 601&quot;, */
(brace
l_int|3
comma
l_int|1
...
comma
multiline_comment|/* AVEC Intercapture */
(brace
l_int|3
comma
l_int|2
...
comma
multiline_comment|/* LifeView FlyKit w/o Tuner */
(brace
l_int|3
comma
l_int|1
...
suffix:semicolon
multiline_comment|/* volume rear left 0dB  */
id|I2CWrite
c_func
(paren
id|bus
...
suffix:semicolon
multiline_comment|/* volume rear right 0dB */
id|I2CWrite
c_func
(paren
id|bus
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d: fader chip: TEA6320&bslash;n&quot;
comma
id|btv-&gt;nr
)paren
suffix:semicolon
...
id|btv-&gt;video_dev.name
comma
l_string|&quot;BT848(Leadtek WinView 601)&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
id|printk
(paren
l_string|&quot;bttv%d: astat %08x stat %08x&bslash;n&quot;
comma
id|btv-&gt;nr
comma
id|astat
...
(paren
id|KERN_INFO
l_string|&quot;bttv%d: remapping to : 0x%lx.&bslash;n&quot;
comma
id|bttv_num
comma
id|remap
