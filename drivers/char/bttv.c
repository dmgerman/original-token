...
suffix:semicolon
multiline_comment|/* Ugh ugh ugh .. schedule ? */
id|udelay
c_func
(paren
l_int|100000
...
l_int|0
suffix:semicolon
multiline_comment|/* In PAL 650 blocks of 256 DWORDs are sampled, but only if VDELAY&n;           is 2. We&squot;ll have to handle this inside the IRQ handler ... */
r_for
c_loop
(paren
id|line
...
(paren
id|KERN_INFO
l_string|&quot;bttv: audio chip: TDA9850&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;bttv: audio chip: TDA8425&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_switch
...
(paren
id|KERN_INFO
l_string|&quot;bttv: internal PLL, single crystal operation enabled.&bslash;n&quot;
)paren
suffix:semicolon
id|btv-&gt;pll
op_assign
