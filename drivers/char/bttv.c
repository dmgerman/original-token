...
comma
multiline_comment|/* CEI Raffles Card */
(brace
l_int|3
comma
l_int|3
...
comma
multiline_comment|/* Lucky Star Image World ConferenceTV */
(brace
l_int|3
comma
l_int|1
...
comma
multiline_comment|/* Phoebe Tv Master + FM */
(brace
l_int|3
comma
l_int|1
...
comma
multiline_comment|/* Modular Technology MM205 PCTV, bt878 */
(brace
l_int|2
comma
l_int|1
...
comma
multiline_comment|/* Magic TView CPH061 (bt878) */
(brace
l_int|3
comma
l_int|1
...
multiline_comment|/* TEA 6320 Audio Support by Michael Wrighton&n;                           mgw1@cec.wustl.edu */
r_if
c_cond
(paren
id|btv-&gt;audio_chip
...
suffix:semicolon
multiline_comment|/* at least Raffles card uses input B */
r_else
id|I2CWrite
c_func
(paren
...
id|btv-&gt;video_dev.name
comma
l_string|&quot;(Image World ConferenceTV)&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
