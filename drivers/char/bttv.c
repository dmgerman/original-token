...
(paren
id|KERN_DEBUG
l_string|&quot;bttv: PCI-BIOS not present or not accessible!&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
r_continue
suffix:semicolon
multiline_comment|/* Ok, Bt848 or Bt849 found! */
id|btv
op_assign
op_amp
id|bttvs
...
suffix:semicolon
multiline_comment|/* pci_read_config_dword(btv-&gt;dev, PCI_BASE_ADDRESS_0, &amp;btv-&gt;bt848_adr); */
id|btv-&gt;bt848_adr
op_assign
