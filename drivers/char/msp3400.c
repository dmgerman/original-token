...
c_func
(paren
l_string|&quot;msp3400: setvolume: 0x%02x&bslash;n&quot;
comma
id|val
op_rshift
l_int|8
...
c_func
(paren
l_string|&quot;msp3400: DC %d/%d&bslash;n&quot;
comma
id|val1
comma
id|val2
...
(brace
multiline_comment|/* stereo available -- check current mode */
id|UNLOCK_I2C_BUS
c_func
(paren
id|msp-&gt;bus
...
multiline_comment|/* dump registers (for debugging) */
r_if
c_cond
(paren
id|debug
...
id|rev2
suffix:semicolon
multiline_comment|/*&n;&t; *&t;MSP3400&squot;s are for now only assumed to live on busses&n;&t; *&t;connected to a BT848. Adjust as and when you get new&n;&t; *&t;funky cards using these components.&n;&t; */
r_if
c_cond
(paren
id|device-&gt;bus-&gt;id
...
(paren
id|KERN_INFO
l_string|&quot;msp3400: init: chip=%s%s&bslash;n&quot;
comma
id|device-&gt;name
comma
id|msp-&gt;nicam
