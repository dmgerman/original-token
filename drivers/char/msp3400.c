...
l_int|0
suffix:semicolon
macro_line|#if 0 /* fixme: quick &amp; dirty for testing */
r_if
c_cond
(paren
id|msp-&gt;main
...
(brace
multiline_comment|/* This is a french mono channel =&gt; AM */
id|printk
c_func
(paren
...
(brace
multiline_comment|/* autodetect does&squot;nt work well with AM ... */
id|max1
op_assign
l_int|3
suffix:semicolon
...
(brace
macro_line|#if 1 /* dump status register */
id|val
op_assign
id|msp3400c_read
c_func
...
id|i
suffix:semicolon
multiline_comment|/* search for the right one... */
r_for
c_loop
(paren
id|i
