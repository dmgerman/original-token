...
c_func
(paren
l_string|&quot;cyz_interrupt: board not yet loaded (INT %d).&bslash;n&bslash;r&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cyc:start_xmit retval was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cyc: flush_buffer retval was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
