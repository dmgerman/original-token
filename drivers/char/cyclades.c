...
singleline_comment|//#define NR_PORTS        64
DECL|macro|NR_PORTS
mdefine_line|#define NR_PORTS        128
...
mdefine_line|#define __initfunc(__arginit)&t;__arginit
DECL|macro|copy_from_user
mdefine_line|#define copy_from_user&t;&t;memcpy_fromfs
DECL|macro|copy_to_user
mdefine_line|#define copy_to_user&t;&t;memcpy_tofs
DECL|macro|cy_get_user
mdefine_line|#define cy_get_user&t;&t;get_fs_long
DECL|macro|cy_put_user
mdefine_line|#define cy_put_user&t;&t;put_fs_long
DECL|macro|ioremap
mdefine_line|#define ioremap&t;&t;&t;vremap
macro_line|#endif
...
mdefine_line|#define Z_FPGA_CHECK(card) &bslash;&n;    ((((struct RUNTIME_9060 *)((card).ctl_addr))-&gt;init_ctrl&amp;(1&lt;&lt;17))!=0)
DECL|macro|ISZLOADED
mdefine_line|#define ISZLOADED(card)&t;(((ZO_V1==((struct RUNTIME_9060 *) &bslash;&n;&t;&t;&t;((card).ctl_addr))-&gt;mail_box_0) || &bslash;&n;&t;&t;&t;Z_FPGA_CHECK(card)) &amp;&amp; &bslash;&n;&t;&t;&t;(ZFIRM_ID==((struct FIRM_ID *) &bslash;&n;&t;&t;&t;((card).base_addr+ID_ADDRESS))-&gt;signature))
...
id|printk
(paren
l_string|&quot;Cyclades-Z Error: you need an external power supply for this number of ports.&bslash;n&bslash;rFirmware halted.&bslash;r&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_else
...
c_func
(paren
l_string|&quot;Cyclades-Z firmware not yet loaded&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return
...
c_func
(paren
l_string|&quot;Cyclades-Z/PCI: found winaddr=0x%x ctladdr=0x%x&bslash;n&quot;
comma
id|cy_pci_addr2
comma
id|cy_pci_addr0
...
c_func
(paren
l_string|&quot;Cyclades-Z/PCI found at 0x%x &quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Cyclades-Z/PCI: relocate winaddr=0x%x ctladdr=0x%x&bslash;n&quot;
comma
id|cy_pci_addr2
comma
id|cy_pci_addr0
...
c_func
(paren
l_string|&quot;Cyclades-Z/PCI: FPGA id %lx, ver %lx&bslash;n&quot;
comma
l_int|0xff
op_amp
(paren
...
c_func
(paren
l_string|&quot;for Cyclades-Z/PCI at 0x%x.&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Cyclades-Z/PCI #%d: 0x%x-0x%x, IRQ%d, &quot;
comma
id|j
op_plus
l_int|1
...
c_func
(paren
l_string|&quot;Cyclades-Z/PCI #%d: 0x%x-0x%x, &quot;
comma
id|j
op_plus
l_int|1
...
(brace
multiline_comment|/* Cyclades-8Zo/PCI */
id|number_z_boards
op_increment
suffix:semicolon
id|mailbox
