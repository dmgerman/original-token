...
id|intr_base_addr
suffix:semicolon
multiline_comment|/* This is the per-card data structure containing a card&squot;s base&n;   address.  Here are declarations for some common addresses.&n;   Add entries to match your configuration (there are sixty-&n;   four possible from 0x80000 to 0xFE000) */
