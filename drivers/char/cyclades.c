...
suffix:semicolon
multiline_comment|/* This is the per-channel data structure containing pointers, flags&n;   and variables for the port. This driver supports a maximum of NR_PORTS.&n;   If the total number of ports is larger than NR_PORTS, change this&n;   constant in the definition bellow. No other change is necessary to&n;   support more boards/ports. */
DECL|macro|NR_PORTS
...
id|channel
suffix:semicolon
multiline_comment|/* CP(&squot;L&squot;);CP1(1 &amp;&amp; C_CLOCAL(tty)); CP1(1 &amp;&amp; (base_addr[CyMSVR1&lt;&lt;index] &amp; CyDCD) ); */
r_if
c_cond
(paren
op_logical_neg
...
id|printk
(paren
l_string|&quot;Kernel without PCI support.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
