...
DECL|macro|CHARS_IN_BUF
mdefine_line|#define CHARS_IN_BUF(buf_ctrl) &bslash;&n;    ((buf_ctrl-&gt;rx_put - &bslash;&n;      buf_ctrl-&gt;rx_get + &bslash;&n;      buf_ctrl-&gt;rx_bufsize) % &bslash;&n;&t;&t;  buf_ctrl-&gt;rx_bufsize)
DECL|macro|SPACE_IN_BUF
mdefine_line|#define SPACE_IN_BUF(buf_ctrl) &bslash;&n;    ((buf_ctrl-&gt;tx_get - &bslash;&n;      buf_ctrl-&gt;tx_put + &bslash;&n;      buf_ctrl-&gt;tx_bufsize - 1) % &bslash;&n;&t;&t;  buf_ctrl-&gt;tx_bufsize)
...
mdefine_line|#define memcpy_fromfs&t;copy_from_user
DECL|macro|memcpy_tofs
mdefine_line|#define memcpy_tofs&t;copy_to_user
DECL|macro|put_fs_long
mdefine_line|#define put_fs_long&t;put_user
DECL|macro|vremap
mdefine_line|#define vremap&t;&t;ioremap
...
id|printk
(paren
l_string|&quot;cyclades: get_fs_long: error == %d&bslash;n&quot;
comma
id|error
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n; * tmp_buf is used as a temporary buffer by serial_write.  We need to&n; * lock it in case the memcpy_fromfs blocks while swapping in a page,&n; * and some other program tries to do a serial write at the same time.&n; * Since the lock will only come under contention when the system is&n; * swapping and available memory is low, it makes sense to share one&n; * buffer across all the serial ports, since it significantly saves&n; * memory if large numbers of serial ports are open.  This buffer is&n; * allocated when the first cy_open occurs.&n; */
...
suffix:semicolon
multiline_comment|/**************************************************&n;error = verify_area(VERIFY_WRITE, (void *) arg, sizeof(unsigned long));&n;memcpy_tofs  (to, from, count);&n;***************************************************************&n;error = verify_area(VERIFY_READ,  (void *) arg, sizeof(unsigned long *));&n;memcpy_fromfs(to, from, count);&n;**************************************************/
r_static
r_inline
r_int
...
suffix:semicolon
multiline_comment|/*&n;         * Delay for 0.1 seconds -- we use a busy loop since this may &n;         * occur during the bootup sequence&n;         */
id|timeout
op_assign
id|jiffies
op_plus
...
multiline_comment|/******** Start of block of Cyclom-Z specific code *********/
multiline_comment|/***********************************************************/
r_static
r_int
...
r_static
r_int
DECL|function|cyz_update_channel
id|cyz_update_channel
c_func
(paren
r_struct
id|cyclades_card
...
multiline_comment|/* cyz_update_channel */
r_static
r_void
...
(brace
multiline_comment|/* SP(&quot;Open Wakeup&bslash;n&quot;); */
id|cy_sched_event
c_func
(paren
id|info
...
(brace
multiline_comment|/* SP(&quot;Hangup&bslash;n&quot;); */
id|cy_sched_event
c_func
(paren
id|info
...
(brace
multiline_comment|/* cy_start isn&squot;t used because... &n;&t;&t;&t;       HW flow is handled by the board */
multiline_comment|/* SP(&quot;Write Wakeup&bslash;n&quot;); */
id|cy_sched_event
c_func
(paren
id|info
...
(brace
multiline_comment|/* cy_stop isn&squot;t used because &n;&t;&t;&t;       HW flow is handled by the board */
multiline_comment|/* SP(&quot;Write stop&bslash;n&quot;); */
)brace
)brace
)brace
r_break
...
multiline_comment|/* we&squot;d like to use memcpy(t, f, n) and memset(s, c, count)&n;&t;&t;   for performance, but because of buffer boundaries, there&n;&t;&t;   may be several steps to the operation */
r_while
c_loop
(paren
l_int|0
...
multiline_comment|/* poll every 40 ms */
id|cyz_timerlist.expires
op_assign
id|jiffies
op_plus
...
multiline_comment|/********** End of block of Cyclom-Z specific code *********/
multiline_comment|/***********************************************************/
...
suffix:semicolon
multiline_comment|/* was C_CM_RESET */
r_if
c_cond
(paren
id|retval
...
c_func
(paren
l_string|&quot;cyc:startup(1) retval was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cyc:startup(2) retval was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* REALLY SHOULD WAIT FOR LAST CHARACTER TO BE&n;&t;   SENT BEFORE DROPPING THE LINE !!!  (Perhaps&n;&t;   set some flag that is read when XMTY happens.)&n;&t;   Other choices are to delay some fixed interval&n;&t;   or schedule some later processing.&n;&t; */
id|save_flags
c_func
(paren
id|flags
...
c_func
(paren
l_string|&quot;cyc:shutdown retval was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cyc:block_til_ready retval was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cyclom-Z firmware not yet loaded&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|tty
suffix:semicolon
multiline_comment|/* Some drivers have (incorrect/incomplete) code to test&n;       against a race condition.  Should add good code here!!! */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* 5 seconds timeout */
id|shutdown
c_func
(paren
id|info
...
r_else
(brace
multiline_comment|/* Since polling is already in place,&n;&t;    nothing further need be done.  */
)brace
)brace
...
(brace
multiline_comment|/*&n;        case B0: ch_ctrl-&gt;comm_baud = 0; break;&n;&t;*/
r_case
id|B50
suffix:colon
...
c_func
(paren
l_string|&quot;cyc:set_line_char retval at %d was %x&bslash;n&quot;
comma
id|__LINE__
comma
id|retval
...
c_func
(paren
l_string|&quot;cyc:set_modem_info retval at %d was %x&bslash;n&quot;
comma
id|__LINE__
comma
id|retval
...
l_int|244
suffix:semicolon
multiline_comment|/* better value than CyCLOCK_25_1MS * 5&n;&t;&t;&t;&t;&t;  to run clock at 200 Hz */
multiline_comment|/*&n;        printk(&quot; chip #%d at %#6lx is rev 0x%2x&bslash;n&quot;,&n;               chip_number, (unsigned long)base_addr,&n;&t;       base_addr[CyGFRCR&lt;&lt;index]);&n;        */
)brace
r_return
id|chip_number
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cyclom-Y/ISA found at 0x%x &quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Cyclom-Y/ISA #%d: 0x%x-0x%x, IRQ%d, &quot;
comma
id|j
op_plus
l_int|1
...
c_func
(paren
l_string|&quot;Cyclom-Y/PCI:found  winaddr=0x%x ioaddr=0x%x&bslash;n&quot;
comma
id|cy_pci_addr2
comma
id|cy_pci_addr1
...
c_func
(paren
l_string|&quot;Cyclom-Y/PCI: relocate winaddr=0x%x ioaddr=0x%x&bslash;n&quot;
comma
id|cy_pci_addr2
comma
id|cy_pci_addr1
...
c_func
(paren
l_string|&quot;no Serial-Modules at 0x%x.&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Cyclom-Y/PCI found at 0x%x &quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Cyclom-Y/PCI #%d: 0x%x-0x%x, IRQ%d, &quot;
comma
id|j
op_plus
l_int|1
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI (bus=0x0%x, pci_id=0x%x, &quot;
comma
id|cyy_bus
comma
id|cyy_dev_fn
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI: found winaddr=0x%x ctladdr=0x%x&bslash;n&quot;
comma
id|cy_pci_addr2
comma
id|cy_pci_addr0
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI not supported for low addresses&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI: relocate winaddr=0x%x ctladdr=0x%x&bslash;n&quot;
comma
id|cy_pci_addr2
comma
id|cy_pci_addr0
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI: FPGA id %lx, ver %lx&bslash;n&quot;
comma
l_int|0xff
op_amp
(paren
...
l_int|0L
suffix:semicolon
multiline_comment|/* This must be a Cyclom-8Zo/PCI.  The extendable&n;                   version will have a different device_id and will&n;                   be allocated its maximum number of ports. */
id|cy_pci_nchan
op_assign
l_int|8
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI found at 0x%x &quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;Could not allocate IRQ%d &quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;for Cyclom-Z/PCI at 0x%x.&bslash;n&quot;
comma
id|cy_pci_irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI #%d: 0x%x-0x%x, IRQ%d, &quot;
comma
id|j
op_plus
l_int|1
...
c_func
(paren
l_string|&quot;Cyclom-Z/PCI #%d: 0x%x-0x%x, &quot;
comma
id|j
op_plus
l_int|1
...
c_func
(paren
l_string|&quot;Cyclom driver %s %s&bslash;n&quot;
comma
id|rcsvers
comma
id|rcsdate
...
c_func
(paren
l_string|&quot;&bslash;tbuilt %s %s&bslash;n&quot;
comma
id|__DATE__
comma
id|__TIME__
...
(brace
multiline_comment|/* Cyclom-8Zo/PCI */
id|number_z_boards
op_increment
suffix:semicolon
r_for
...
c_func
(paren
l_string|&quot;cyc:cy_init(1) setting Z count to 0&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|info-&gt;blocked_open
...
c_func
(paren
l_string|&quot;cyc:cy_init(2) setting Y count to 0&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|info-&gt;blocked_open
...
c_func
(paren
l_string|&quot;Cyclom-Z polling initialized&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
)brace
...
multiline_comment|/* See linux/drivers/char/riscom.c for ideas on how to&n;   pass additional base addresses to the driver!!! */
r_int
...
id|printk
(paren
l_string|&quot;  *tty read_status_mask timeout xmit_fifo_size &quot;
comma
id|printk
c_func
(paren
l_string|&quot;= %lx %x %x %x&bslash;n&quot;
comma
(paren
r_int
)paren
