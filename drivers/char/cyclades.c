...
macro_line|#if 0
multiline_comment|/******** &n; * For the next two macros, it is assumed that the buffer size is a &n; * power of 2 &n; ********/
mdefine_line|#define CHARS_IN_BUF(buf_ctrl) &bslash;&n;    ((cy_readl(&amp;buf_ctrl-&gt;rx_put) - &bslash;&n;      cy_readl(&amp;buf_ctrl-&gt;rx_get) + &bslash;&n;      cy_readl(&amp;buf_ctrl-&gt;rx_bufsize)) &amp; &bslash;&n;&t;&t;  (cy_readl(&amp;buf_ctrl-&gt;rx_bufsize) - 1))
mdefine_line|#define SPACE_IN_BUF(buf_ctrl) &bslash;&n;    ((cy_readl(&amp;buf_ctrl-&gt;tx_get) - &bslash;&n;      cy_readl(&amp;buf_ctrl-&gt;tx_put) + &bslash;&n;      cy_readl(&amp;buf_ctrl-&gt;tx_bufsize) - 1) &amp; &bslash;&n;&t;&t;  (cy_readl(&amp;buf_ctrl-&gt;tx_bufsize) - 1))
macro_line|#endif
...
suffix:semicolon
multiline_comment|/**************************************************&n;error = verify_area(VERIFY_WRITE, (void *) arg, sizeof(unsigned long));&n;copy_to_user  (to, from, count);&n;***************************************************************&n;error = verify_area(VERIFY_READ,  (void *) arg, sizeof(unsigned long *));&n;copy_from_user(to, from, count);&n;**************************************************/
r_static
r_inline
r_int
...
c_func
(paren
l_string|&quot;cy_interrupt: spurious interrupt %d&bslash;n&bslash;r&quot;
comma
id|irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cy_interrupt: rcvd intr, chip %d&bslash;n&bslash;r&quot;
comma
id|chip
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;cy_interrupt: xmit intr, chip %d&bslash;n&bslash;r&quot;
comma
id|chip
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Enables the firmware inactivity control */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Removed due to compilation problems in Alpha systems */
singleline_comment|//&t;    if ((char_count = CHARS_IN_BUF(buf_ctrl))){
id|rx_get
op_assign
id|cy_readl
c_func
...
multiline_comment|/* Removed due to compilation problems in Alpha systems */
singleline_comment|//&t;    if ((char_count = SPACE_IN_BUF(buf_ctrl))){
id|tx_get
op_assign
id|cy_readl
c_func
...
id|cyz_polling_cycle
suffix:semicolon
multiline_comment|/* refresh inactivity counter */
r_if
c_cond
(paren
id|cinfo-&gt;inact_ctrl
...
(brace
multiline_comment|/*&n;        case B0: cy_writel(&amp;ch_ctrl-&gt;comm_baud , 0); break;&n;&t;*/
r_case
id|B50
suffix:colon
id|cy_writel
...
macro_line|#if !defined(__alpha__) &amp;&amp; (LINUX_VERSION_CODE &gt;= 0x020100)
id|cy_isa_address
op_assign
id|ioremap
c_func
...
c_func
(paren
l_string|&quot;Cyclom-Y/PCI:found  winaddr=0x%lx ioaddr=0x%lx&bslash;n&quot;
comma
(paren
id|ulong
)paren
...
c_func
(paren
l_string|&quot;Cyclom-Y/PCI: relocate winaddr=0x%lx ioaddr=0x%lx&bslash;n&quot;
comma
(paren
id|u_long
)paren
...
c_func
(paren
l_string|&quot;for Cyclades-8Zo/PCI at 0x%lx.&bslash;n&quot;
comma
(paren
id|ulong
)paren
...
c_func
(paren
l_string|&quot;for Cyclades-Ze/PCI at 0x%lx.&bslash;n&quot;
comma
(paren
id|ulong
)paren
...
suffix:semicolon
macro_line|#ifdef SERIAL_DEBUG_COUNT
singleline_comment|//        printk(&quot;cyc:cy_init(1) setting Z count to 0&bslash;n&quot;);
macro_line|#endif
id|info-&gt;blocked_open
op_assign
l_int|0
...
suffix:semicolon
macro_line|#ifdef SERIAL_DEBUG_COUNT
singleline_comment|//        printk(&quot;cyc:cy_init(2) setting Y count to 0&bslash;n&quot;);
macro_line|#endif
id|info-&gt;blocked_open
op_assign
l_int|0
