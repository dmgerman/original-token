...
singleline_comment|//    if ((char_count = CHARS_IN_BUF(buf_ctrl))){
id|rx_get
op_assign
id|cy_readl
c_func
...
suffix:semicolon
multiline_comment|/* Removed due to compilation problems in Alpha systems */
singleline_comment|//    if ((char_count = SPACE_IN_BUF(buf_ctrl))){
id|tx_get
op_assign
id|cy_readl
c_func
...
c_func
(paren
l_string|&quot;cyc:cy_close retval (1) was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
...
(brace
multiline_comment|/* If it is a Z card, flush the&n;&t;&t;&t;&t;&t;    on-board RX buffers as well */
r_int
id|retval
suffix:semicolon
r_int
...
c_func
(paren
l_string|&quot;cyc: cy_close retval (2) was %x&bslash;n&quot;
comma
id|retval
)paren
suffix:semicolon
