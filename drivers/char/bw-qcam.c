multiline_comment|/*&n; *    QuickCam Driver For Video4Linux.&n; *&n; *&t;Video4Linux conversion work by Alan Cox.&n; */
...
(paren
id|KERN_ERR
l_string|&quot;qcam: I/O port 0x%03X in use.&bslash;n&quot;
comma
id|port
)paren
suffix:semicolon
...
id|port
suffix:semicolon
multiline_comment|/* Port 0 == Autoprobe */
id|q-&gt;port_mode
op_assign
(paren
id|QC_ANY
...
(paren
id|KERN_ERR
l_string|&quot;bw_qcam: No quickcam detected at 0x%03X&bslash;n&quot;
comma
id|io
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;Connectix Quickcam at 0x%03X&bslash;n&quot;
comma
id|qcam-&gt;port
)paren
suffix:semicolon
