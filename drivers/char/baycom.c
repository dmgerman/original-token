...
mdefine_line|#define BUFLEN_RX 16384
DECL|macro|BUFLEN_TX
mdefine_line|#define BUFLEN_TX 16384
DECL|macro|NR_PORTS
mdefine_line|#define NR_PORTS 4
DECL|macro|KISS_VERBOSE
mdefine_line|#define KISS_VERBOSE
DECL|macro|HDLC_LOOPBACK
macro_line|#undef HDLC_LOOPBACK
...
multiline_comment|/* ---------------------------------------------------------------------- */
multiline_comment|/*&n; * The HDLC routines could be more efficient; they could take more than&n; * one bit per call&n; */
DECL|function|hdlc_rx_bit
r_static
r_void
id|hdlc_rx_bit
c_func
...
(brace
multiline_comment|/* not a stuffed bit */
r_if
c_cond
(paren
id|bc-&gt;hdlc_rx.bitstream
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * return bit &n;&t;&t;&t;&t; */
id|bit
op_assign
id|bc-&gt;hdlc_tx.current_byte
op_amp
...
multiline_comment|/*&n;&t;&t;&t; * get new bit &n;&t;&t;&t; */
r_if
c_cond
(paren
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * bit stuffing&n;&t;&t;&t;&t; */
id|bc-&gt;hdlc_tx.bitstream
op_lshift_assign
l_int|1
suffix:semicolon
...
c_func
(paren
l_string|&quot;KERN_INFO baycom: p-persistence = %u&bslash;n&quot;
comma
id|bc-&gt;ch_params.ppersist
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;baycom: device busy, remove delayed&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|printk
