...
macro_line|#endif
DECL|macro|LIMIT
mdefine_line|#define LIMIT (PAGE_SIZE - 80)
id|len
op_assign
l_int|0
suffix:semicolon
...
DECL|variable|typhoon_proc_entry
r_static
r_struct
id|proc_dir_entry
id|typhoon_proc_entry
op_assign
(brace
l_int|0
comma
multiline_comment|/* low_ino: inode is dynamic */
l_int|13
comma
l_string|&quot;radio-typhoon&quot;
comma
multiline_comment|/* length of name and name */
id|S_IFREG
op_or
id|S_IRUGO
comma
...
l_int|NULL
comma
multiline_comment|/* operations -- use default */
op_amp
id|typhoon_read_proc
comma
...
(paren
id|KERN_ERR
l_string|&quot;radio-typhoon: registering /proc/radio-typhoon failed&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
(paren
id|KERN_ERR
l_string|&quot;radio-typhoon: unregistering /proc/radio-typhoon failed&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
