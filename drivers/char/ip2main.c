...
(paren
id|KERN_ERR
l_string|&quot;IP2: failed to unregister read_procmem (%d)&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;IP2: failed to register read_procmem (%d)&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
