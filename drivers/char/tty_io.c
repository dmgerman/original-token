...
multiline_comment|/*&n;&t; * Make sure that the tty&squot;s task queue isn&squot;t activated.  If it&n;&t; * is, take it out of the linked list.  The tqueue isn&squot;t used by&n;&t; * pty&squot;s, so skip the test for them.&n;&t; */
r_if
c_cond
(paren
id|tty-&gt;driver.type
...
multiline_comment|/*&n; * Routine which returns the baud rate of the tty&n; */
