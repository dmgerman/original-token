...
(brace
multiline_comment|/* Job control check -- must be done at start and after&n;&t;&t;   every sleep (POSIX.1 7.1.1.4). */
...
suffix:semicolon
multiline_comment|/* XXX packet mode&squot;s status byte is mistakenly counted */
r_if
c_cond
(paren
id|b
