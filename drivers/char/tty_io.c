...
r_continue
suffix:semicolon
multiline_comment|/* A break is handled by the lower levels. */
r_if
c_cond
(paren
id|I_BRKINT
...
(brace
multiline_comment|/* Don&squot;t echo the EOF char in canonical mode.  Sun&n;&t;&t;&t;   handles this differently by echoing the char and&n;&t;&t;&t;   then backspacing, but that&squot;s a hack. */
r_if
c_cond
(paren
id|c
...
(brace
multiline_comment|/* Avoid calling TTY_READ_FLUSH unnecessarily. */
r_if
c_cond
(paren
id|L_ICANON
...
l_int|1
suffix:semicolon
multiline_comment|/* Shuffle any pending data down the queues. */
id|TTY_READ_FLUSH
c_func
(paren
id|tty
...
(brace
multiline_comment|/* Gobble up an immediately following EOF if&n;&t;&t;&t;&t;   there is no more room in buf (this can&n;&t;&t;&t;&t;   happen if the user &quot;pushes&quot; some characters&n;&t;&t;&t;&t;   using ^D).  This prevents the next read()&n;&t;&t;&t;&t;   from falsely returning EOF. */
r_if
c_cond
(paren
id|eol
...
c_func
(paren
l_string|&quot;read_chan: canon_data &lt; 0!&bslash;n&quot;
)paren
suffix:semicolon
id|tty-&gt;canon_data
op_assign
...
multiline_comment|/* If there is enough space in the secondary queue now, let the&n;&t;&t;   low-level driver know. */
r_if
c_cond
(paren
id|tty-&gt;throttle
...
suffix:semicolon
multiline_comment|/* Care is needed here: opost() can abort even&n;&t;&t;&t;   if the write_q is not full. */
r_if
c_cond
(paren
id|opost
