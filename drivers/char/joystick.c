...
DECL|macro|JS_BUTTON_PERIOD
mdefine_line|#define JS_BUTTON_PERIOD&t;HZ/50&t;&t;/* button valid time (20 ms) */
DECL|macro|JS_AXIS_MIN_PERIOD
mdefine_line|#define JS_AXIS_MIN_PERIOD&t;HZ/25&t;&t;/* axis min valid time (40 ms) */
DECL|macro|JS_AXIS_MAX_PERIOD
mdefine_line|#define JS_AXIS_MAX_PERIOD&t;HZ/25*2&t;&t;/* axis max valid time (80 ms) */
...
multiline_comment|/*&n; * Sync ahead with bhead and cut too long tails.&n; */
r_for
c_loop
(paren
id|i
