...
multiline_comment|/* $Id: ac.c,v 1.16 1999/08/28 15:11:50 dwmw2 Exp $&t;&t;&t;     */
...
DECL|macro|DEVPRIO
mdefine_line|#define DEVPRIO PZERO+8
DECL|macro|FALSE
...
(paren
id|KERN_INFO
l_string|&quot;Applicom driver: $Id: ac.c,v 1.16 1999/08/28 15:11:50 dwmw2 Exp $&bslash;n&quot;
)paren
suffix:semicolon
...
(brace
multiline_comment|/* User board number not OK      */
singleline_comment|// printk(&quot;Write to invalid Applicom board %d&bslash;n&quot;, NumCard);
r_return
op_minus
id|EINVAL
suffix:semicolon
multiline_comment|/* Return error code user buffer */
)brace
...
suffix:semicolon
singleline_comment|//  memcpy_toio ((void *)apbs[IndexCard].PtrRamFromPc, (void *)&amp;tmpmailbox, sizeof(struct mailbox));
(brace
r_int
r_char
op_star
...
suffix:semicolon
singleline_comment|//  memcpy_fromio(&amp;tmpmailbox, apbs[IndexCard].PtrRamToPc, sizeof(struct mailbox));
(brace
r_int
r_int
id|from
...
id|LoopCount
suffix:semicolon
singleline_comment|//  volatile unsigned char ResetIntBoard;
singleline_comment|//    printk(&quot;Applicom interrupt on IRQ %d occurred&bslash;n&quot;, vec);
id|LoopCount
op_assign
l_int|0
suffix:semicolon
singleline_comment|// for(i=boardno;i&lt;MAX_BOARD;i++)         /* loop for not configured board   */
singleline_comment|//  if (apbs[i].RamIO)
singleline_comment|//    ResetIntBoard = *apbs[i].PtrRamItToPc;    /* reset interrupt of unused boards */
r_do
(brace
id|FlagInt
op_assign
...
c_func
(paren
l_string|&quot;apbs[%d].RamIO = %lx&bslash;n&quot;
comma
id|IndexCard
comma
id|apbs
