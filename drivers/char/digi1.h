...
multiline_comment|/* flow control chars&t; */
DECL|macro|DIGI_GETINFO
mdefine_line|#define&t;DIGI_GETINFO&t;(&squot;e&squot;&lt;&lt;8) | 103&t;&t;/* Fill in digi_info */
DECL|macro|DIGI_POLLER
mdefine_line|#define&t;DIGI_POLLER&t;(&squot;e&squot;&lt;&lt;8) | 104&t;&t;/* Turn on/off poller */
DECL|macro|DIGI_INIT
mdefine_line|#define&t;DIGI_INIT&t;(&squot;e&squot;&lt;&lt;8) | 105&t;&t;/* Allow things to run. */
...
multiline_comment|/************************************************************************&n; * Values for digiDload&n; ************************************************************************/
DECL|macro|NORMAL
mdefine_line|#define NORMAL  0
DECL|macro|PCI_CTL
mdefine_line|#define PCI_CTL 1
DECL|macro|SIZE8
mdefine_line|#define SIZE8  0
DECL|macro|SIZE16
mdefine_line|#define SIZE16 1
DECL|macro|SIZE32
mdefine_line|#define SIZE32 2
...
id|board
suffix:semicolon
multiline_comment|/* Which board is this ? */
DECL|member|status
r_int
r_char
id|status
suffix:semicolon
multiline_comment|/* Alive or dead */
DECL|member|type
r_int
r_char
id|type
suffix:semicolon
multiline_comment|/* see epca.h */
DECL|member|subtype
r_int
r_char
id|subtype
suffix:semicolon
multiline_comment|/* For future XEM, XR, etc ... */
DECL|member|numports
r_int
r_int
id|numports
suffix:semicolon
multiline_comment|/* Number of ports configured */
DECL|member|port
r_int
r_char
op_star
...
id|version
suffix:semicolon
multiline_comment|/* For future ... */
DECL|member|windowData
r_int
r_int
id|windowData
suffix:semicolon
