...
multiline_comment|/*&n;&t; * At this point the variable `scancode&squot; contains the keysym.&n;&t; * We keep track of the up/down status of the key, and&n;&t; * return the keysym if in MEDIUMRAW mode.&n;&t; * Note that the present code requires the application to keep&n;&t; * track of the up/down status as well - it would probably be&n;&t; * better to   put_queue(scancode + (up_flag ? 0200 : 0))  .&n;&t; */
r_if
c_cond
(paren
id|up_flag
...
multiline_comment|/* done stupidly to avoid coding in any dependencies of&n;lock values, shift values and kbd flags bit positions */
