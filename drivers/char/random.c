...
DECL|macro|F
mdefine_line|#define F(x, y, z) (((x) &amp; (y)) | ((~x) &amp; (z)))
DECL|macro|G
mdefine_line|#define G(x, y, z) (((x) &amp; (y)) | ((x) &amp; (z)) | ((y) &amp; (z)))
DECL|macro|H
...
multiline_comment|/*&n; * Basic cut-down MD4 transform&n; */
