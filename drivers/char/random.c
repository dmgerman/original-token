...
multiline_comment|/*&n; * Added a check for signal pending in the extract_entropy() loop to allow&n; * the read(2) syscall to be interrupted. Copyright (C) 1998  Andrea Arcangeli&n; */
