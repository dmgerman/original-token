...
multiline_comment|/*&n; * SHA transform algorith, taken from code written by Peter Gutman,&n; * and apparently in the public domain.&n; */
...
suffix:semicolon
multiline_comment|/* Heavy mangling, in 4 sub-rounds of 20 interations each. */
id|subRound
c_func
(paren
id|A
