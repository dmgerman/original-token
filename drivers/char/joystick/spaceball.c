multiline_comment|/*&n; * $Id: spaceball.c,v 1.6 2000/05/29 11:19:51 vojtech Exp $&n; *&n; *  Copyright (c) 1999-2000 Vojtech Pavlik&n; *&n; *  Based on the work of:&n; *  &t;David Thompson&n; *  &t;Joseph Krahn&n; *&n; *  Sponsored by SuSE&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;spaceball.c: Unknown escaped character: %#x&bslash;n&quot;
comma
id|data
)paren
suffix:semicolon
