...
DECL|macro|VERSION
mdefine_line|#define VERSION &t;&quot;1.5.4&quot;
...
macro_line|#include &quot;pcxxconfig.h&quot;
DECL|macro|DIGIMAJOR
mdefine_line|#define DIGIMAJOR   30
DECL|macro|DIGICUMAJOR
mdefine_line|#define DIGICUMAJOR 31 
DECL|macro|MAXPORTS
mdefine_line|#define MAXPORTS 16     /* Max ports per PC/Xx type board */
DECL|macro|NBDEVS
mdefine_line|#define NBDEVS   (NUMCARDS * MAXPORTS)
DECL|macro|PORTNUM
mdefine_line|#define PORTNUM(x)  ((x)-&gt;dev % MAXPORTS)
DECL|macro|LINENUM
mdefine_line|#define LINENUM(x)  (MINOR((x)-&gt;device) - (x)-&gt;driver.minor_start)
...
c_func
(paren
l_string|&quot;Board not found at port 0x%x! Check switch settings.&bslash;n&quot;
comma
id|bd-&gt;port
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;PC/Xm at 0x%x not supported!!&bslash;n&quot;
comma
id|bd-&gt;port
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;%s not resetting at port 0x%x! Check switch settings.&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
...
c_func
(paren
l_string|&quot;Failed memory test at %lx for %s at port %x, check switch settings.&bslash;n&quot;
comma
id|bd-&gt;membase
comma
id|board_desc
...
c_func
(paren
l_string|&quot;BIOS download failed on the %s at 0x%x!&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
...
c_func
(paren
l_string|&quot;Command failed for the %s at 0x%x!&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
...
c_func
(paren
l_string|&quot;FEP/OS download failed on the %s at 0x%x!&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
...
c_func
(paren
l_string|&quot;DigiBoard PC/Xx Driver V%s:  %s I/O=0x%x Mem=0x%lx Ports=%d&bslash;n&quot;
comma
id|VERSION
comma
id|board_desc
...
c_func
(paren
l_string|&quot;Couldn&squot;t register PC/Xe driver&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;Couldn&squot;t register PC/Xe callout&quot;
)paren
suffix:semicolon
)brace
id|loops_per_sec
...
id|FEP_HUPCL
suffix:semicolon
multiline_comment|/* This gets strange but if we dont do this we will get 78600&n;&t;&t; * instead of 115200. 57600 is mapped to 50 baud yielding 57600 in&n;&t;&t; * FAST mode. 115200 is mapped to 75. We need to map it to 110 to&n;&t;&t; * do 115K&n;&t;&t; */
r_if
c_cond
(paren
id|cflag
