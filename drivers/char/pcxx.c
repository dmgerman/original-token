...
multiline_comment|/* Define one default setting if no digi= config line is used.&n; * Default is ALTPIN = ON, PC/16E, 16 ports, I/O 200h Memory 0D0000h&n; */
...
multiline_comment|/* Flag if lilo configuration option is used. If so the&n; * default settings are removed&n; */
...
suffix:semicolon
multiline_comment|/* keep track of my inital minor number */
r_if
c_cond
(paren
id|numcards
...
c_func
(paren
l_string|&quot;PC/Xx: No cards configured, exiting.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;PC/Xx: No devices activated, exiting.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;PC/Xx: %s not resetting at port 0x%x! Check switch settings.&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
...
c_func
(paren
l_string|&quot;PC/Xx: BIOS download failed on the %s at 0x%x!&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
...
c_func
(paren
l_string|&quot;PC/Xx: FEP/OS download failed on the %s at 0x%x!&bslash;n&quot;
comma
id|board_desc
(braket
id|bd-&gt;type
