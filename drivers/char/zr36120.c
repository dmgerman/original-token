...
multiline_comment|/* ----------------------------------------------------------------------- */
multiline_comment|/* ZORAN chipset detector&t;&t;&t;&t;&t;&t;   */
multiline_comment|/* shamelessly stolen from bttv.c&t;&t;&t;&t;&t;   */
...
multiline_comment|/*&n;&t; * GRABBING?&n;&t; */
r_if
c_cond
(paren
id|test_bit
...
id|i
suffix:semicolon
multiline_comment|/* are we already grabbing? */
r_if
c_cond
(paren
id|test_bit
...
(brace
multiline_comment|/* did we get a complete grab? */
r_if
c_cond
(paren
id|zrread
...
multiline_comment|/* locate a new frame to grab */
r_for
c_loop
(paren
id|i
...
(brace
multiline_comment|/* there is a buffer more to be grabbed... */
id|ztv-&gt;lastframe
op_assign
id|i
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;irq(%ld): starting grab(%d)&bslash;n&quot;
comma
id|irq1
comma
id|i
...
(paren
id|KERN_DEBUG
l_string|&quot;irq(%ld): nothing more to grab&bslash;n&quot;
comma
id|irq1
)paren
)paren
suffix:semicolon
multiline_comment|/* turn grabbing off the next time around */
id|clear_bit
c_func
(paren
id|STATE_GRAB
...
suffix:semicolon
multiline_comment|/* force re-init of Read or Overlay settings */
id|clear_bit
c_func
(paren
id|STATE_READ
...
multiline_comment|/*&n;&t; * READING?&n;&t; */
r_if
c_cond
(paren
id|test_bit
...
(brace
multiline_comment|/* are we already reading? */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_DEBUG
l_string|&quot;irq(%ld): starting read&bslash;n&quot;
comma
id|irq1
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;irq(%ld): nothing more to read&bslash;n&quot;
comma
id|irq1
)paren
)paren
suffix:semicolon
multiline_comment|/* turn reading off the next time around */
id|clear_bit
c_func
(paren
id|STATE_READ
...
suffix:semicolon
multiline_comment|/* force re-init of Overlay settings */
id|clear_bit
c_func
(paren
id|STATE_OVERLAY
...
suffix:semicolon
multiline_comment|/* we are done, tell everyone */
id|wake_up_interruptible
c_func
(paren
op_amp
...
multiline_comment|/*&n;&t; * OVERLAYING?&n;&t; */
r_if
c_cond
(paren
id|test_bit
...
(paren
id|KERN_DEBUG
l_string|&quot;irq(%ld): starting overlay&bslash;n&quot;
comma
id|irq1
)paren
)paren
...
multiline_comment|/*&n;&t; * THEN WE MUST BE IDLING&n;&t; */
id|DEBUG
c_func
(paren
id|printk
...
(paren
id|KERN_DEBUG
l_string|&quot;irq(%ld): turning off&bslash;n&quot;
comma
id|irq1
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: CodReplIRQ&bslash;n&quot;
comma
id|CARD
)paren
)paren
...
(paren
id|KERN_ERR
l_string|&quot;%s: irq loop %d (%x)&bslash;n&quot;
comma
id|CARD
comma
id|count
...
(paren
id|KERN_DEBUG
l_string|&quot;zoran: PCI-BIOS not present or not accessible!&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
r_continue
suffix:semicolon
multiline_comment|/* Ok, ZR36120 found! */
id|ztv
op_assign
op_amp
id|zorans
...
(paren
id|KERN_ERR
l_string|&quot;zoran: PCI bus-mastering could not be enabled&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(paren
id|KERN_INFO
l_string|&quot;zoran: latency set to %d&bslash;n&quot;
comma
id|latency
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;       zoran_cap(%d) at %ld, state=%x&bslash;n&quot;
comma
id|on
comma
id|irq1
...
l_int|1
suffix:semicolon
multiline_comment|/* &n;&t;&t; * Clear the previous state flag. This way the irq&n;&t;&t; * handler will be forced to re-examine its current&n;&t;&t; * state from scratch, setting up the registers along&n;&t;&t; * the way.&n;&t;&t; */
id|clear_bit
c_func
(paren
id|STATE_OVERLAY
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t;&t; * turn interrupts and DMA both off&n;&t;&t; */
id|zrand
c_func
(paren
op_complement
...
id|ztv-&gt;interlace
suffix:semicolon
multiline_comment|/* double height? */
r_int
id|i
suffix:semicolon
id|DEBUG
...
multiline_comment|/* clear entire blob */
multiline_comment|/*&t;memset(ztv-&gt;overinfo.overlay, 0, 1024*1024/8); */
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: illegal clipzone (%d,%d,%d,%d) not in (0,0,%d,%d), adapting&bslash;n&quot;
comma
id|CARD
comma
id|vcp-&gt;x
...
(paren
id|KERN_DEBUG
l_string|&quot;       set_geo(rect=(%d,%d,%d,%d), norm=%d, format=%d, bpp=%d, bpl=%d, vidadr=%lx, overlay=%p)&bslash;n&quot;
comma
id|i-&gt;x
comma
id|i-&gt;y
...
(brace
multiline_comment|/* single frame suffices for this height */
id|zror
c_func
(paren
...
multiline_comment|/* can happen for read&squot;s! */
id|winHeight
op_assign
op_minus
id|winHeight
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: WARNING stride = %d&bslash;n&quot;
comma
id|CARD
comma
id|stride
...
(paren
id|KERN_DEBUG
l_string|&quot;       top=%08lx, bottom=%08lx, winWidth=%d, winHeight=%d, maxWidth=%d, maxHeight=%d, stride=%d&bslash;n&quot;
comma
id|top
comma
id|bot
...
suffix:semicolon
multiline_comment|/* determine scales and crops */
r_if
c_cond
(paren
l_int|1
...
(paren
id|KERN_DEBUG
l_string|&quot;       correcting horizontal start/end by one&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|winWidth
...
comma
op_complement
id|ZORAN_VFEC_HFILTER
comma
id|ZORAN_VFEC
)paren
suffix:semicolon
)brace
multiline_comment|/* when height is negative, we want to read from line 0 */
r_if
c_cond
(paren
id|i-&gt;h
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: open(dev,%d)&bslash;n&quot;
comma
id|CARD
comma
id|flags
...
multiline_comment|/******************************************&n; We really should be doing lazy allocing...&n; ******************************************/
...
multiline_comment|/* clear buffer status */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
multiline_comment|/* default to the compisite input since my camera is there */
id|zoran_muxsel
c_func
(paren
id|ztv
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: close(dev)&bslash;n&quot;
comma
id|CARD
)paren
)paren
suffix:semicolon
multiline_comment|/* we are no longer active, goodbye */
id|ztv-&gt;user
op_decrement
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* tell the state machine we want in too */
id|write_lock_irq
c_func
(paren
op_amp
...
id|ERESTARTSYS
suffix:semicolon
multiline_comment|/* give the user what he requested */
id|max
op_assign
id|ztv-&gt;readinfo.w
op_star
...
suffix:colon
(brace
multiline_comment|/* get video capabilities */
r_struct
id|video_capability
id|c
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: GetCapabilities&bslash;n&quot;
comma
id|CARD
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: capabilities %d %d %d&bslash;n&quot;
comma
id|CARD
comma
id|dc.flags
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: GetChannel(%d)&bslash;n&quot;
comma
id|CARD
comma
id|v.channel
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* too many inputs? */
r_if
c_cond
(paren
id|v.channel
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: SetChannel(%d,%d)&bslash;n&quot;
comma
id|CARD
comma
id|v.channel
...
id|EFAULT
suffix:semicolon
multiline_comment|/* Only one tuner for now */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: GetPicture&bslash;n&quot;
comma
id|CARD
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: SetPicture&bslash;n&quot;
comma
id|CARD
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: SetWindow(%d,%d,%d,%d,%x,%d)&bslash;n&quot;
comma
id|CARD
comma
id|vw.x
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: GetFramebuffer&bslash;n&quot;
comma
id|CARD
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: SetFrameBuffer(%p,%dx%d, bpp %d, bpl %d)&bslash;n&quot;
comma
id|CARD
comma
id|v.base
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: VIDEOCSYNC(%d)&bslash;n&quot;
comma
id|CARD
comma
id|i
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: Mcapture(%d,(%d,%d),%d=%s)&bslash;n&quot;
comma
id|CARD
comma
id|vm.frame
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: GetMemoryBuffer&bslash;n&quot;
comma
id|CARD
)paren
)paren
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: unhandled video ioctl(%x)&bslash;n&quot;
comma
id|CARD
comma
id|cmd
...
(paren
id|KERN_DEBUG
l_string|&quot;%s: bad ioctl(%x)&bslash;n&quot;
comma
id|CARD
comma
id|cmd
...
multiline_comment|/* framegrabber details */
id|ztv-&gt;swidth
op_assign
l_int|800
suffix:semicolon
...
id|ztv-&gt;readinfo.bpp
suffix:semicolon
multiline_comment|/* grabbing details */
r_for
c_loop
(paren
id|i
...
l_int|1
suffix:semicolon
multiline_comment|/* picture details */
