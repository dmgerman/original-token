...
multiline_comment|/*&n; * ---------------------------------------------------------------------&n; * esp_init() and friends&n; *&n; * esp_init() is called at boot-time to initialize the serial driver.&n; * ---------------------------------------------------------------------&n; */
...
c_func
(paren
l_string|&quot; Old ESP found at %x&bslash;n&quot;
comma
id|info-&gt;port
)paren
suffix:semicolon
...
id|offset
suffix:semicolon
multiline_comment|/* check if i/o region is already in use */
r_if
c_cond
(paren
id|check_region
...
(brace
multiline_comment|/* if it is a primary port, skip secondary ports */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* free the port information */
id|current_async
op_assign
id|IRQ_ports
(braket
