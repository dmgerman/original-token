...
multiline_comment|/*&n; * This is used to figure out the divisor speeds&n; */
DECL|variable|quot_table
r_static
r_int
id|quot_table
(braket
...
op_assign
(brace
multiline_comment|/*      0,    50,    75,  110,  134,  150,  200,  300, 600, 1200, */
l_int|0
comma
l_int|18432
comma
...
l_int|768
comma
multiline_comment|/*     1800,2400,4800,9600,19200,38400,57600,115200,230400,460800 */
l_int|512
comma
l_int|384
comma
...
suffix:semicolon
multiline_comment|/* default to 9600 bps */
r_if
c_cond
(paren
op_logical_neg
