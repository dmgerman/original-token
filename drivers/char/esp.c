...
id|rx_trigger
op_assign
id|CONFIG_ESPSERIAL_RX_TRIGGER
suffix:semicolon
...
id|tx_trigger
op_assign
id|CONFIG_ESPSERIAL_TX_TRIGGER
suffix:semicolon
...
id|x_bytes
suffix:semicolon
id|info-&gt;tty_buf-&gt;char_buf_ptr
op_sub_assign
id|x_bytes
suffix:semicolon
id|info-&gt;tty_buf-&gt;flag_buf_ptr
op_sub_assign
id|x_bytes
suffix:semicolon
r_if
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* This routine will currently check ALL ports when an interrupt */
multiline_comment|/* is received from ANY port */
id|info
op_assign
id|IRQ_ports
(braket
...
(brace
multiline_comment|/* error - check for rx timeout */
id|serial_out
c_func
(paren
id|info
...
multiline_comment|/* released DMA */
id|stop_port
op_assign
id|info
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Set clock scaling */
id|serial_out
c_func
(paren
id|info
...
suffix:semicolon
id|info-&gt;tty_buf-&gt;tqueue.routine
op_assign
id|do_ttybuf
suffix:semicolon
id|info-&gt;tty_buf-&gt;tqueue.data
op_assign
id|info
suffix:semicolon
)brace
...
l_int|0
suffix:semicolon
multiline_comment|/* Remove port from &quot;closed&quot; chain */
r_if
c_cond
(paren
id|info-&gt;next_port
...
id|info-&gt;prev_port
op_assign
id|next_info-&gt;prev_port
suffix:semicolon
id|next_info-&gt;prev_port-&gt;next_port
op_assign
id|info
suffix:semicolon
id|next_info-&gt;prev_port
...
suffix:semicolon
multiline_comment|/* stop a DMA transfer on the port being closed, and start the next&n;&t;   one */
r_if
c_cond
(paren
id|info-&gt;stat_flags
...
multiline_comment|/* Stick it on the &quot;closed&quot; chain */
id|info-&gt;next_port
op_assign
id|IRQ_ports
(braket
...
(brace
multiline_comment|/* code borrowed from tty_io.c */
r_if
c_cond
(paren
id|info-&gt;tty_buf-&gt;tqueue.sync
)paren
(brace
r_struct
id|tq_struct
...
id|ENODEV
suffix:semicolon
multiline_comment|/* check whether or not the port is on the closed chain */
id|info
op_assign
id|IRQ_ports
(braket
...
id|info-&gt;next_port
suffix:semicolon
multiline_comment|/* if the port is not on the closed chain, look for it on the */
multiline_comment|/* open chain */
r_if
c_cond
(paren
op_logical_neg
