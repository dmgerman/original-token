multiline_comment|/*&n; *      Copyright (C) 1993 Ning and David Mosberger.&n; *      Original:&n; *      Copyright (C) 1993 Bas Laarhoven.&n; *      Copyright (C) 1992 David L. Brown, Jr.&n; *&n; * This program is free software; you can redistribute it and/or&n; * modify it under the terms of the GNU General Public License as&n; * published by the Free Software Foundation; either version 2, or (at&n; * your option) any later version.&n; *&n; * This program is distributed in the hope that it will be useful, but&n; * WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU&n; * General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; see the file COPYING.  If not, write to&n; * the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139,&n; * USA.&n; *&n; *&n; * $Source: /home/bas/distr/ftape-2.03b/RCS/ecc.h,v $&n; * $Author: bas $&n; *&n; * $Revision: 1.20 $&n; * $Date: 1995/01/08 14:16:21 $&n; * $State: Beta $&n; *&n; *      This file contains the definitions for the&n; *      Reed-Solomon error correction code &n; *      for the QIC-40/80 tape streamer device driver.&n; */
macro_line|#ifndef _ecc_h_
DECL|macro|_ecc_h_
mdefine_line|#define _ecc_h_
DECL|typedef|BAD_SECTOR
r_typedef
r_int
r_int
id|BAD_SECTOR
