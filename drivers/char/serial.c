...
multiline_comment|/*&n; * this defines the index into rs_table for the port to use&n; */
...
suffix:semicolon
multiline_comment|/* Restore the interrupts */
id|outb
c_func
(paren
id|ier
...
id|CONFIG_SERIAL_CONSOLE_PORT
suffix:semicolon
multiline_comment|/* Disable all interrupts, it works in polled mode */
id|outb
c_func
(paren
l_int|0x00
