...
l_int|1
suffix:semicolon
multiline_comment|/* disabled for now */
)brace
r_else
r_if
c_cond
...
(brace
multiline_comment|/*&n;&t;&t; * On the 16650, we disable the FIFOs altogether&n;&t;&t; * because of a design bug in how the implement&n;&t;&t; * things.  We could support it by completely changing&n;&t;&t; * how we handle the interrupt driver, but not today....&n;&t;&t; *&n;&t;&t; * N.B.  Because there&squot;s no way to set a FIFO trigger&n;&t;&t; * at 1 char, we&squot;d probably disable at speed below&n;&t;&t; * 2400 baud anyway...&n;&t;&t; */
id|fcr
op_assign
l_int|0
suffix:semicolon
...
id|tty_std_termios
suffix:semicolon
id|serial_driver.init_termios.c_lflag
op_and_assign
op_complement
(paren
id|ISIG
