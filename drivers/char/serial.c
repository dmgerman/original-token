...
c_func
(paren
l_string|&quot;serial: ttyS%d: simple autoconfig failed&bslash;n&quot;
comma
id|state-&gt;line
)paren
suffix:semicolon
...
comma
multiline_comment|/* US Robotics Sporster 33600 Modem */
(brace
id|ISAPNP_VENDOR
c_func
(paren
...
suffix:semicolon
macro_line|#endif
macro_line|#if (LINUX_VERSION_CODE &gt; 0x2032D &amp;&amp; defined(CONFIG_DEVFS))
...
suffix:semicolon
macro_line|#if defined(CONFIG_KDB)
multiline_comment|/*&n;&t; * Remember I/O port for kdb&n;&t; */
r_if
c_cond
(paren
id|kdb_port
