...
DECL|macro|IRQ_T
mdefine_line|#define IRQ_T(state) &bslash;&n;&t;((state-&gt;flags &amp; ASYNC_SHARE_IRQ) ? SA_SHIRQ : SA_INTERRUPT)
...
suffix:semicolon
macro_line|#endif
multiline_comment|/*&n; * Provide backwards compatibility for kernels prior to 2.1.XX.&n; */
...
suffix:semicolon
macro_line|#endif
macro_line|#if (LINUX_VERSION_CODE &lt; 0x02017E)
...
macro_line|#else
DECL|macro|serial_isroot
mdefine_line|#define serial_isroot() (suser())
macro_line|#endif
macro_line|#if (LINUX_VERSION_CODE &lt; 131394) /* 2.1.66 */
DECL|macro|test_and_clear_bit
mdefine_line|#define test_and_clear_bit(x,y)&t;&t;clear_bit(x,y)
...
l_int|100
suffix:semicolon
macro_line|#if (LINUX_VERSION_CODE &gt; 0x200100)
...
multiline_comment|/*&n; * This is a helper routine to autodetect StarTech/Exar UART&squot;s.  When&n; * this function is called we know it is at least a StarTech 16650 V2,&n; * but it might be one of several StarTech UARTs, or one of its&n; * clones.  (We treat the broken original StarTech 16650 V1 as a&n; * 16550A, and why not?  Startech doesn&squot;t seem to even acknowledge its&n; * existence.)&n; * &n; * What evil have men&squot;s minds wrought...&n; */
...
id|old_emsr
suffix:semicolon
multiline_comment|/*&n;&t; * Here we check for the XR16C85x family.  We do this by&n;&t; * checking for to see if we can replace the scratch register&n;&t; * with the receive FIFO count register.&n;&t; *&n;&t; * XXX  I don&squot;t have one of these chips, but it should also be&n;&t; * possible to check for them by setting DLL and DLM to 0, and&n;&t; * then reading back DLL and DLM.  If the DLM reads back as&n;&t; * 0x10, then the UART is a XR16C850 and the DLL contains the&n;&t; * chip revision.&n;&t; */
id|old_fctr
op_assign
id|serial_inp
c_func
...
op_assign
(brace
multiline_comment|/*&n;&t; * Vendor ID, &t;Device ID,&n;&t; * Subvendor ID,&t;Subdevice ID,&n;&t; * Number of Ports, Base (Maximum) Baud Rate,&n;&t; * Offset of register holding Uart register offset&n;&t; * Mask to apply to above register&squot;s value&n;&t; */
(brace
id|PCI_VENDOR_ID_V3
comma
