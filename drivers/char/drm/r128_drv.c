multiline_comment|/* r128_drv.c -- ATI Rage 128 driver -*- linux-c -*-&n; * Created: Mon Dec 13 09:47:27 1999 by faith@precisioninsight.com&n; *&n; * Copyright 1999, 2000 Precision Insight, Inc., Cedar Park, Texas.&n; * Copyright 2000 VA Linux Systems, Inc., Sunnyvale, California.&n; * All Rights Reserved.&n; *&n; * Permission is hereby granted, free of charge, to any person obtaining a&n; * copy of this software and associated documentation files (the &quot;Software&quot;),&n; * to deal in the Software without restriction, including without limitation&n; * the rights to use, copy, modify, merge, publish, distribute, sublicense,&n; * and/or sell copies of the Software, and to permit persons to whom the&n; * Software is furnished to do so, subject to the following conditions:&n; *&n; * The above copyright notice and this permission notice (including the next&n; * paragraph) shall be included in all copies or substantial portions of the&n; * Software.&n; *&n; * THE SOFTWARE IS PROVIDED &quot;AS IS&quot;, WITHOUT WARRANTY OF ANY KIND, EXPRESS OR&n; * IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY,&n; * FITNESS FOR A PARTICULAR PURPOSE AND NONINFRINGEMENT.  IN NO EVENT SHALL&n; * PRECISION INSIGHT AND/OR ITS SUPPLIERS BE LIABLE FOR ANY CLAIM, DAMAGES OR&n; * OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE,&n; * ARISING FROM, OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER&n; * DEALINGS IN THE SOFTWARE.&n; *&n; * Authors:&n; *    Rickard E. (Rik) Faith &lt;faith@valinux.com&gt;&n; *    Kevin E. Martin &lt;martin@valinux.com&gt;&n; *    Gareth Hughes &lt;gareth@valinux.com&gt;&n; *&n; */
macro_line|#include &lt;linux/config.h&gt;
macro_line|#include &quot;drmP.h&quot;
macro_line|#include &quot;r128_drv.h&quot;
DECL|macro|R128_NAME
mdefine_line|#define R128_NAME&t;&t;&quot;r128&quot;
DECL|macro|R128_DESC
mdefine_line|#define R128_DESC&t;&t;&quot;ATI Rage 128&quot;
DECL|macro|R128_DATE
mdefine_line|#define R128_DATE&t;&t;&quot;20001215&quot;
DECL|macro|R128_MAJOR
mdefine_line|#define R128_MAJOR&t;&t;2
DECL|macro|R128_MINOR
mdefine_line|#define R128_MINOR&t;&t;1
DECL|macro|R128_PATCHLEVEL
mdefine_line|#define R128_PATCHLEVEL&t;&t;2
DECL|variable|r128_device
r_static
id|drm_device_t
id|r128_device
suffix:semicolon
DECL|variable|r128_res_ctx
id|drm_ctx_t
id|r128_res_ctx
suffix:semicolon
DECL|variable|r128_fops
r_static
r_struct
id|file_operations
id|r128_fops
...
suffix:semicolon
DECL|macro|R128_IOCTL_COUNT
mdefine_line|#define R128_IOCTL_COUNT DRM_ARRAY_SIZE(r128_ioctls)
...
multiline_comment|/* r128_options is called by the kernel to parse command-line options&n; * passed via the boot-loader (e.g., LILO).  It calls the insmod option&n; * routine, drm_parse_drm.&n; */
...
suffix:semicolon
DECL|macro|DRM_COPY
mdefine_line|#define DRM_COPY(name,value)&t;&t;&t;&t;&t;&bslash;&n;&t;len = strlen(value);&t;&t;&t;&t;&t;&bslash;&n;&t;if (len &gt; name##_len) len = name##_len;&t;&t;&t;&bslash;&n;&t;name##_len = strlen(value);&t;&t;&t;&t;&bslash;&n;&t;if (len &amp;&amp; name) {&t;&t;&t;&t;&t;&bslash;&n;&t;&t;if (copy_to_user(name, value, len))&t;&t;&bslash;&n;&t;&t;&t;return -EFAULT;&t;&t;&t;&t;&bslash;&n;&t;}
...
multiline_comment|/* r128_ioctl is called whenever a process performs an ioctl on /dev/drm. */
DECL|function|r128_ioctl
r_int
id|r128_ioctl
c_func
(paren
...
c_func
(paren
l_string|&quot;%s 0x%x ret = %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
id|nr
