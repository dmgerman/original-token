...
mdefine_line|#define R128_MINOR&t; 0
DECL|macro|R128_PATCHLEVEL
mdefine_line|#define R128_PATCHLEVEL  0
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* dev-&gt;queue_count == 0 right now for&n;                                   r128.  FIXME? */
r_if
c_cond
(paren
id|lock.context
