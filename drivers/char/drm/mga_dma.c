...
c_func
(paren
l_string|&quot;%s : tail-&gt;age : %d last_prim_age : %d&bslash;n&quot;
comma
id|__FUNCTION__
comma
...
c_func
(paren
l_string|&quot;I&squot;m waiting on the freelist!!! %d&bslash;n&quot;
comma
id|dev_priv-&gt;last_prim_age
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Dma top flush&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
c_func
(paren
l_string|&quot;lockup in fire primary &quot;
l_string|&quot;(Dma Top Flush)&bslash;n&quot;
)paren
suffix:semicolon
r_goto
...
c_func
(paren
l_string|&quot;I&squot;m locked&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
c_func
(paren
l_string|&quot;idx :%d&bslash;n&quot;
comma
id|dev_priv-&gt;next_prim-&gt;idx
)paren
suffix:semicolon
id|clear_bit
c_func
...
c_func
(paren
l_string|&quot;I can&squot;t get the dispatch lock&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;Waking up buf queue&bslash;n&quot;
)paren
suffix:semicolon
id|wake_up_interruptible
c_func
...
c_func
(paren
l_string|&quot;Not waking buf_queue on %d %d&bslash;n&quot;
comma
id|atomic_read
c_func
(paren
...
c_func
(paren
l_string|&quot;reserved_map or buffer_map are invalid&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;warp pipe %d: installed: %d phys: %lx size: %x&bslash;n&quot;
comma
id|i
comma
id|dev_priv-&gt;WarpIndex
...
c_func
(paren
l_string|&quot;mga_flush_ioctl called without lock held&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
