...
suffix:semicolon
multiline_comment|/* Force reset of dwgctl (eliminates clip disable) */
macro_line|#if 0
id|PRIMOUTREG
c_func
(paren
...
suffix:semicolon
multiline_comment|/* This takes a max of 30 dwords */
id|PRIMOUTREG
c_func
(paren
id|MGAREG_TEXCTL2
...
DECL|macro|EMIT_PIPE
mdefine_line|#define EMIT_PIPE 50
...
c_func
(paren
l_string|&quot;dispatch vertex %d addr 0x%lx, &quot;
l_string|&quot;length 0x%x nbox %d dirty %x&bslash;n&quot;
comma
id|buf-&gt;idx
comma
id|address
...
c_func
(paren
l_string|&quot;used : %d, total : %d&bslash;n&quot;
comma
id|buf-&gt;used
comma
id|buf-&gt;total
...
c_func
(paren
l_string|&quot;dispatch indices %d addr 0x%x, &quot;
l_string|&quot;start 0x%x end 0x%x nbox %d dirty %x&bslash;n&quot;
comma
id|buf-&gt;idx
comma
id|address
...
c_func
(paren
l_string|&quot;dispatch clear %d,%d-%d,%d flags %x!&bslash;n&quot;
comma
id|pbox
(braket
id|i
...
c_func
(paren
l_string|&quot;Starting Iload&bslash;n&quot;
)paren
suffix:semicolon
id|copy_from_user_ret
c_func
...
c_func
(paren
l_string|&quot;bus_address %lx, length %d, destorg : %x&bslash;n&quot;
comma
id|bus_address
comma
id|iload.length
