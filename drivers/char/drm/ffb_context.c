multiline_comment|/* $Id: ffb_context.c,v 1.3 2000/06/09 03:46:53 davem Exp $&n; * ffb_context.c: Creator/Creator3D DRI/DRM context switching.&n; *&n; * Copyright (C) 2000 David S. Miller (davem@redhat.com)&n; *&n; * Almost entirely stolen from tdfx_context.c, see there&n; * for authors.&n; */
