...
c_func
(paren
l_string|&quot;agpgart: timed out waiting for the other CPUs!&bslash;n&quot;
)paren
suffix:semicolon
id|flush_cache
c_func
...
c_func
(paren
l_string|&quot;agpgart: i810 is disabled&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;agpgart: no supported devices found.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;agpgart: unable to detrimine aperture size.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;agpgart: error allocating memory for key lists.&bslash;n&quot;
)paren
suffix:semicolon
id|agp_bridge
dot
...
c_func
(paren
l_string|&quot;agpgart: error configuring host chipset.&bslash;n&quot;
)paren
suffix:semicolon
id|agp_bridge
dot
