...
macro_line|#if LINUX_VERSION_CODE &lt; VERSION(2,3,43) 
macro_line|#include &quot;../net/syncppp.h&quot;
DECL|macro|net_device
mdefine_line|#define net_device device
DECL|macro|netif_stop_queue
mdefine_line|#define netif_stop_queue(a) (a)-&gt;tbusy = 1
DECL|macro|netif_start_queue
mdefine_line|#define netif_start_queue(a) (a)-&gt;tbusy = 0
DECL|macro|netif_wake_queue
mdefine_line|#define netif_wake_queue(a) (a)-&gt;tbusy = 0; mark_bh(NET_BH)
DECL|macro|netif_queue_stopped
mdefine_line|#define netif_queue_stopped(a) ((a)-&gt;tbusy)
macro_line|#else
...
id|netstats
suffix:semicolon
macro_line|#if LINUX_VERSION_CODE &gt;= VERSION(2,2,16) 
...
id|EBUSY
suffix:semicolon
multiline_comment|/* 10 seconds timeout */
id|mgsl_sppp_tx_timeout
c_func
(paren
id|dev
