...
DECL|macro|MSE_UPDATE_ON
mdefine_line|#define MSE_UPDATE_ON() mouse_update_allowed=1
DECL|macro|MSE_UPDATE_OFF
mdefine_line|#define MSE_UPDATE_OFF() mouse_update_allowed=0
...
suffix:semicolon
DECL|variable|mouse_dx
DECL|variable|mouse_dy
DECL|variable|mouse_buttons
r_static
r_int
id|mouse_dx
comma
...
id|mouse_buttons
suffix:semicolon
DECL|variable|mouse_ready
DECL|variable|mouse_update_allowed
DECL|variable|mouse_active
r_static
r_int
id|mouse_ready
op_assign
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;         *  use VBL to poll mouse deltas&n;         */
id|mouse_dx
op_assign
l_int|0
suffix:semicolon
...
DECL|variable|apollo_mouse_fops
r_struct
id|file_operations
