...
multiline_comment|/*&n; * Called to gobble up an immediately following EOF when there is no&n; * more room in buf (this can happen if the user &quot;pushes&quot; some&n; * characters using ^D).  This prevents the next read() from falsely&n; * returning EOF.&n; */
DECL|function|gobble_eof
r_static
r_inline
r_void
id|gobble_eof
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * Hack for PTY&squot;s; we need to wake up the other tty if there&squot;s&n;&t; * enough space.&n;&t; */
r_if
c_cond
(paren
id|tty-&gt;link
