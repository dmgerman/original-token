...
multiline_comment|/* ******************************** *&n; * functions for talking to TDA8425 *&n; * ******************************** */
DECL|function|tda8425_write
r_static
r_int
id|tda8425_write
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;tda8425: I/O error, trying (write %d 0x%x)&bslash;n&quot;
comma
id|addr
comma
id|val
...
(paren
id|KERN_DEBUG
l_string|&quot;tda8425_set(%04x,%04x,%04x,%04x)&bslash;n&quot;
comma
id|tda-&gt;left
op_rshift
l_int|10
...
(paren
id|KERN_DEBUG
l_string|&quot;tda8425_audio:%d (T,R,E,I,O)&bslash;n&quot;
comma
id|mode
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* this is the function we&squot;ll need to change if it turns out the&n;&t; * input-selecting capabilities should be used. */
)brace
multiline_comment|/* *********************** *&n; * i2c interface functions *&n; * *********************** */
DECL|function|tda8425_attach
r_static
r_int
id|tda8425_attach
c_func
...
(paren
id|KERN_INFO
l_string|&quot;tda8425: init&bslash;n&quot;
)paren
suffix:semicolon
