...
c_func
(paren
l_string|&quot;STALLION: Warning, unit %d I/O address %x &quot;
...
c_func
(paren
l_string|&quot;STALLION: %s found, unit=%d io=%x irq=%d &quot;
...
id|brdtype
suffix:semicolon
multiline_comment|/*&n; *&t;Read in all the BAR registers from this board. Different Stallion&n; *&t;boards use these in different ways, so we just read in the whole&n; *&t;lot and then figure out what is what later.&n; */
r_for
c_loop
(paren
id|i
...
c_func
(paren
l_string|&quot;STALLION: failed to read BAR register %d &quot;
l_string|&quot;from PCI board, errno=%x&bslash;n&quot;
comma
id|i
comma
id|rc
...
c_func
(paren
l_string|&quot;STALLION: failed to read INTERRUPT register &quot;
l_string|&quot;from PCI board, errno=%x&bslash;n&quot;
comma
id|rc
)paren
...
r_break
suffix:semicolon
multiline_comment|/*&n; *&t;&t;&t;Check that we can handle more boards...&n; */
r_if
c_cond
(paren
id|stl_nrbrds
...
c_func
(paren
l_string|&quot;STALLION: failed to read class type &quot;
l_string|&quot;from PCI board, errno=%x&bslash;n&quot;
comma
id|rc
)paren
