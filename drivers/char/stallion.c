...
id|stlconf_t
suffix:semicolon
multiline_comment|/*static stlconf_t&t;stl_brdconf[] = {&n;&t;{ BRD_EASYIO, 0x2a0, 0, 0, 10, 0 },&n;};*/
macro_line|#ifdef MODULE
DECL|variable|brdtype
r_static
r_char
op_star
id|brdtype
...
multiline_comment|/*&n; *&t;Define real Stallion PCI vemdor and device ID.&n; */
DECL|macro|PCI_VENDOR_ID_STALLION
mdefine_line|#define&t;PCI_VENDOR_ID_STALLION&t;0x124d
DECL|macro|PCI_DEVICE_ID_ECHPCI832
mdefine_line|#define&t;PCI_DEVICE_ID_ECHPCI832&t;0x0000
...
c_func
(paren
l_string|&quot;STALLION: sc26198 not responding, brd=%d panel=%d chip=%d&bslash;n&quot;
comma
id|panelp-&gt;brdnr
comma
id|panelp-&gt;panelnr
...
r_default
suffix:colon
multiline_comment|/*printk(&quot;%s(%d): unknown other intr cir=%x, iack=%x!&bslash;n&quot;, __FILE__, __LINE__, cir, iack);*/
r_break
suffix:semicolon
)brace
)brace
