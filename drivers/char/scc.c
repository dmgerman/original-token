...
DECL|macro|RCS_ID
mdefine_line|#define RCS_ID &quot;$Id: scc.c,v 1.17 1995/03/15 23:28:12 JReuter Exp JReuter $&quot;
DECL|macro|BANNER
mdefine_line|#define BANNER &quot;Z8530 SCC driver v1.8.dl1bke (beta) by dl1bke&bslash;n&quot;
multiline_comment|/* ******************************************************************** */
multiline_comment|/* *   SCC.C - Linux driver for Z8530 based HDLC cards for AX.25      *&t;*/
multiline_comment|/* ******************************************************************** */
multiline_comment|/* ********************************************************************&n;&n;&t;(c) 1995 by Joerg Reuter DL1BKE&n;&n;&t;portions (c) 1994 Hans Alblas PE1AYX &n;&t;and      (c) 1993 Guido ten Dolle PE1NNZ&n;&n;&t;for the complete copyright notice see &gt;&gt; Copying.Z8530DRV &lt;&lt;&n;&n;   ********************************************************************&t;*/
multiline_comment|/*&n;&n;   940913&t;- started to rewrite the drive&n;   950131&t;- changed copyright notice to GPL without limitations.&n;   950228&t;- (hopefully) fixed the reason for kernel panics in&n;                  chk_rcv_queue() [stupid error]&n;   950304       - fixed underrun/zcount handling&n;   950305&t;- the driver registers port addresses now&n;   950314&t;- fixed underrun interrupt handling again&n;   &n;   Thanks to:&n;   &n;   PE1CHL Rob&t;- for a lot of good ideas from his SCC driver for DOS&n;   PE1NNZ Guido - for his port of the original driver to Linux&n;   KA9Q   Phil  - from whom we stole the mbuf-structure&n;   PA3AYX Hans  - who rewrote the memory management and some minor,&n;                  but nevertheless useful changes&n;   DL8MBT Flori - for support&n;   DG0FT  Rene  - for the BayCom USCC support&n;   PA3AOU Harry - for ESCC testing, information supply and support&n;   &n;   PE1KOX Rob, DG1RTF Thomas, ON5QK Roland, &n;   &n;   and all who sent me bug reports and ideas... &n;   &n;   &n;   NB -- if you find errors, change something, please let me know&n;      &t; first before you distribute it... And please don&squot;t touch&n;   &t; the version number. Just replace my callsign in&n;   &t; &quot;v1.8.dl1bke&quot; with your own. Just to avoid confusion...&n;   &t;  &n;   J&#xfffd;rg Reuter DL1BKE&n;   &n;*/
...
suffix:semicolon
multiline_comment|/* No of chip is vector */
id|wr
c_func
(paren
id|scc
