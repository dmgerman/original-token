...
multiline_comment|/* ******************************************************************** */
multiline_comment|/* mbuf concept lent from KA9Q. Tnx PE1AYX for the buffer pool concept&t;*/
multiline_comment|/* (sorry, do you have any better ideas?) */
...
id|bp
suffix:semicolon
multiline_comment|/* Don&squot;t throw this one away */
id|bp-&gt;cnt
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* Simply rewind it */
id|bp-&gt;in_use
op_assign
l_int|0
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* throw away buffer */
)brace
)brace
...
(brace
multiline_comment|/* no buffer available or buffer full */
r_if
c_cond
(paren
id|scc-&gt;rbp
...
suffix:semicolon
multiline_comment|/* throw away buffers */
id|scc-&gt;stat.nospace
op_increment
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* rewind the buffer and toss */
)brace
r_if
c_cond
(paren
...
op_decrement
suffix:semicolon
multiline_comment|/* last byte is first CRC byte */
id|scc_enqueue
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;z8530drv: Warning - scc-&gt;stat.rx_queued shows overflow&quot;
...
multiline_comment|/* receive raw frame from SCC. used for AX.25 */
r_static
r_void
...
l_int|9
suffix:semicolon
multiline_comment|/* this f... IBM AT-design! */
id|request_irq
c_func
(paren
id|Ivec
