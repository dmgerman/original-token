...
DECL|macro|wdtpci_init
mdefine_line|#define wdtpci_init init_module
...
(brace
multiline_comment|/* See if we can do this device */
id|irq
op_assign
id|dev-&gt;irq
suffix:semicolon
