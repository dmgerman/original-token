...
multiline_comment|/*&n; * Look like a PS/2 mouse, please..&n; * In XFree86 (3.3.5 tested) you must select Protocol &quot;NetMousePS/2&quot;,&n; * then use your wheel as Button 4 and 5 via ZAxisMapping 4 5.&n; * The PS/2 protocol is fairly strange, but&n; * oh, well, it&squot;s at least common..&n; */
