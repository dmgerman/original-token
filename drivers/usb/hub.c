...
suffix:semicolon
multiline_comment|/* &lt;buffer&gt; is large enough for a hub with 127 ports;&n;&t;&t; * the hub can/will return fewer bytes here. */
r_if
c_cond
(paren
id|ret
...
c_func
(paren
l_string|&quot;Unable to kmalloc %d bytes for bitmap&quot;
comma
id|header-&gt;bLength
)paren
suffix:semicolon
...
(brace
multiline_comment|/* Try resetting the device. Windows does this and it */
multiline_comment|/*  gets some devices working correctly */
id|usb_set_port_feature
c_func
(paren
id|hub
