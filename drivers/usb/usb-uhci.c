multiline_comment|/* &n; * Universal Host Controller Interface driver for USB (take II).&n; *&n; * (c) 1999 Georg Acher, acher@in.tum.de (executive slave) (base guitar)&n; *          Deti Fliegl, deti@fliegl.de (executive slave) (lead voice)&n; *          Thomas Sailer, sailer@ife.ee.ethz.ch (chief consultant) (cheer leader)&n; *          Roman Weissgaerber, weissg@vienna.at (virt root hub) (studio porter)&n; *          &n; * HW-initalization based on material of&n; *&n; * (C) Copyright 1999 Linus Torvalds&n; * (C) Copyright 1999 Johannes Erdfelt&n; * (C) Copyright 1999 Randy Dunlap&n; *&n; * $Id: usb-uhci.c,v 1.197 2000/02/15 17:44:22 acher Exp $&n; */
...
DECL|macro|USE_RECLAMATION_LOOP
mdefine_line|#define USE_RECLAMATION_LOOP
macro_line|#else
singleline_comment|//#define USE_RECLAMATION_LOOP
macro_line|#endif
singleline_comment|// stop bandwidth reclamation after (roughly) 50ms (depends also on
singleline_comment|// hub polling interval)
...
c_func
(paren
l_string|&quot;enable_desc_loop: enter&quot;
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;enable_desc_loop: finished&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/*-------------------------------------------------------------------*/
...
c_func
(paren
l_string|&quot;disable_desc_loop: enter&bslash;n&quot;
)paren
suffix:semicolon
id|spin_lock_irqsave
(paren
...
c_func
(paren
l_string|&quot;disable_desc_loop: finished&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
...
macro_line|#ifdef USE_RECLAMATION_LOOP
singleline_comment|// Removes bandwidth reclamation if URB idles too long
DECL|function|check_idling_urbs
r_void
id|check_idling_urbs
c_func
(paren
id|uhci_t
op_star
...
id|type
suffix:semicolon
singleline_comment|//dbg(&quot;check_idling_urbs: enter i:%d&quot;,in_interrupt());
id|spin_lock
(paren
op_amp
id|s-&gt;urb_list_lock
...
c_func
(paren
l_string|&quot;URB timers: %li now: %li %i&bslash;n&quot;
comma
(paren
(paren
id|urb_priv_t
...
suffix:semicolon
singleline_comment|//dbg(&quot;check_idling_urbs: finished&quot;);
)brace
macro_line|#endif
...
id|status
suffix:semicolon
macro_line|#ifdef USE_RECLAMATION_LOOP&t;
id|disable_desc_loop
c_func
(paren
id|s
