...
c_func
(paren
l_string|&quot;uhci_submit_bulk: qh=%p, nqh=%p&bslash;n&quot;
comma
id|bqh
comma
id|nqh
...
c_func
(paren
l_string|&quot;uhci_submit_bulk: new bqh %p&bslash;n&quot;
comma
id|bqh
)paren
suffix:semicolon
...
multiline_comment|/*-------------------------------------------------------------------*/
singleline_comment|// mode: 0: unlink + no deletion mark, 1: regular (unlink/delete-mark), 2: don&squot;t unlink
...
c_func
(paren
l_string|&quot;clean transfer urb %p, qh %p, mode %i&quot;
comma
id|urb
comma
id|qh
...
id|queue_dbg
(paren
l_string|&quot;TOP relink of %p to %p-%p&quot;
comma
id|qh
comma
id|prevqh
...
r_else
(brace
singleline_comment|//intermediate
id|urb_priv_t
op_star
id|ppriv
op_assign
...
id|queue_dbg
(paren
l_string|&quot;IM relink of %p to %p-%p&quot;
comma
id|qh
comma
id|prevqh
...
l_int|0
suffix:semicolon
singleline_comment|//dbg(&quot;process_transfer: urb contains bulk/control request&quot;);
...
multiline_comment|/*&n;&t; * traverse the list in *reverse* direction, because new entries&n;&t; * may be added at the end.&n;&t; * also, because process_urb may unlink the current urb,&n;&t; * we need to advance the list before&n;&t; */
id|spin_lock
(paren
op_amp
id|s-&gt;urb_list_lock
