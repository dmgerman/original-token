...
r_else
(brace
multiline_comment|/* get from where? */
)brace
r_return
id|DID_ERROR
op_lshift
...
c_func
(paren
l_string|&quot;Bulk soft reset&bslash;n&quot;
)paren
suffix:semicolon
id|result
op_assign
...
r_do
(brace
singleline_comment|//usb_settoggle(us-&gt;pusb_dev, us-&gt;ep_in, 0);&t;/* AAARgh!! */
id|US_DEBUGP
c_func
(paren
l_string|&quot;Toggle is %d&bslash;n&quot;
comma
id|usb_gettoggle
c_func
(paren
