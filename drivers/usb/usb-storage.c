...
id|us_list
suffix:semicolon
DECL|variable|us_list_spinlock
id|spinlock_t
id|us_list_spinlock
op_assign
...
multiline_comment|/* FIXME: we need to enable and test multiple LUNs */
r_if
c_cond
(paren
id|us-&gt;srb-&gt;target
...
multiline_comment|/* FIXME: all we should need to do here is determine the protocol */
r_if
c_cond
(paren
id|dev-&gt;descriptor.idVendor
...
multiline_comment|/* FIXME: This needs to get period from the device */
id|US_DEBUGP
c_func
(paren
...
op_increment
suffix:semicolon
multiline_comment|/* FIXME: this is bad.  We abuse this pointer so we&n;&t;&t; * can pass the ss pointer to the host controler thread&n;&t;&t; * in us_detect&n;&t;&t; */
(paren
r_struct
id|us_data
op_star
