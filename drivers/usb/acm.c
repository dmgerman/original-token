multiline_comment|/*&n; * acm.c  Version 0.11&n; *&n; * Copyright (c) 1999 Armin Fuerst&t;&lt;fuerst@in.tum.de&gt;&n; * Copyright (c) 1999 Pavel Machek&t;&lt;pavel@suse.cz&gt;&n; * Copyright (c) 1999 Johannes Erdfelt&t;&lt;jerdfelt@valinux.com&gt;&n; * Copyright (c) 1999 Vojtech Pavlik&t;&lt;vojtech@suse.cz&gt;&n; *&n; * USB Abstract Control Model driver for USB modems and ISDN adapters&n; *&n; * Sponsored by SuSE&n; *&n; * ChangeLog:&n; *&t;v0.9  - thorough cleaning, URBification, almost a rewrite&n; *&t;v0.10 - some more cleanups&n; *&t;v0.11 - fixed flow control, read error doesn&squot;t stop reads&n; *&t;v0.12 - added TIOCM ioctls, added break handling, made struct acm kmalloced&n; */
...
id|ctrlif
suffix:semicolon
multiline_comment|/* interface number for acm control messages */
DECL|member|ctrlin
r_int
r_int
id|ctrlin
...
mdefine_line|#define&t;acm_set_control(acm, control)&t;acm_ctrl_msg(acm, ACM_REQ_SET_CONTROL, control, NULL, 0)
DECL|macro|acm_set_coding
mdefine_line|#define acm_set_coding(acm, coding) &t;acm_ctrl_msg(acm, ACM_REQ_SET_LINE, 0, coding, sizeof(struct acm_coding))
