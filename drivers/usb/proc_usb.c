...
multiline_comment|/*&n; * proc entry for every device&n; * sailer@ife.ee.ethz.ch&n; */
...
suffix:semicolon
DECL|macro|PROCUSB_MAXBUSSES
mdefine_line|#define PROCUSB_MAXBUSSES 64
DECL|variable|busnumbermap
r_static
r_int
r_int
id|busnumbermap
