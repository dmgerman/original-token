multiline_comment|/*&n; *  hid.c  Version 0.8&n; *&n; *  Copyright (c) 1999 Andreas Gal&n; *  Copyright (c) 2000 Vojtech Pavlik&n; *&n; *  USB HID support for the Linux input drivers&n; *&n; *  Sponsored by SuSE&n; */
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* skip the ID if we have a single report */
r_if
c_cond
(paren
id|report-&gt;device-&gt;report_enum
(braket
id|report-&gt;type
)braket
dot
...
c_func
(paren
l_string|&quot;had to kill output urb&quot;
)paren
suffix:semicolon
id|usb_unlink_urb
c_func
