...
(brace
multiline_comment|/* scan device ids for a match */
r_for
c_loop
(paren
suffix:semicolon
...
multiline_comment|/* Vendor match, possibly product-specific? */
r_if
c_cond
(paren
id|id-&gt;idVendor
...
multiline_comment|/* Device class match? */
r_if
c_cond
(paren
id|id-&gt;bDeviceClass
...
multiline_comment|/* Interface class match? */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/* is this driver interested in this interface? */
r_if
c_cond
(paren
id|id
...
r_else
(brace
multiline_comment|/* &quot;old style&quot; driver, but using new interface */
r_private
op_assign
id|driver
op_member_access_from_pointer
