...
id|usb_bus_list.next
suffix:semicolon
multiline_comment|/*first we remove the driver, to be sure it doesn&squot;t get used by&n;       *another thread while we are stepping through removing entries&n;       */
id|list_del
c_func
(paren
op_amp
...
c_func
(paren
l_string|&quot;usbcore: deregistering driver&bslash;n&quot;
)paren
suffix:semicolon
r_while
c_loop
...
c_func
(paren
l_string|&quot;null device being passed in!!!&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
(brace
multiline_comment|/*&n;                * Note: this is not the correct way to do this, this&n;                * uninitializes and reinitializes EVERY driver&n;                */
id|printk
c_func
(paren
l_string|&quot;disconnecting driverless device&bslash;n&quot;
)paren
suffix:semicolon
id|dev-&gt;driver
...
l_int|NULL
suffix:semicolon
multiline_comment|/* This will go back through the list looking for a driver&n;                * that can handle the device&n;&t;&t;*/
...
c_func
(paren
l_string|&quot;New bus registered&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
(brace
multiline_comment|/* NOTE: make sure that all the devices are removed by the&n;         * controller code, as well as having it call this when cleaning&n;&t; * itself up&n;         */
id|list_del
c_func
(paren
op_amp
...
id|status
suffix:semicolon
singleline_comment|//if (!usb_endpoint_halted(dev, endp))
...
suffix:semicolon
multiline_comment|/* dont clear if failed */
r_if
c_cond
(paren
id|result
...
macro_line|#if 1&t;/* lets be really tough */
id|dr.requesttype
op_assign
l_int|0x80
op_or
...
multiline_comment|/* usb_get_stringtable(dev); */
id|dev-&gt;actconfig
op_assign
id|dev-&gt;config
suffix:semicolon
