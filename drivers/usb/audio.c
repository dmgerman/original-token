...
(paren
id|KERN_DEBUG
l_string|&quot;usbin_start: device %d ufmt %d dfmt %d srate %d&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|u-&gt;format
...
(paren
id|KERN_DEBUG
l_string|&quot;usbout_start: device %d ufmt %d dfmt %d srate %d&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|u-&gt;format
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: failure to set sampling frequency device %d endpoint %d&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|usb_pipeendpoint
...
(paren
id|KERN_ERR
l_string|&quot;usbaudio: failure to get sampling frequency device %d endpoint %d&bslash;n&quot;
comma
id|dev-&gt;devnum
comma
id|usb_pipeendpoint
