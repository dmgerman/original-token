...
id|i
suffix:semicolon
multiline_comment|/* first find an exact match, taking both format and sample rate into account,&n;&t;   but ignore stereo bit */
r_for
c_loop
(paren
id|i
