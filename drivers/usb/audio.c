...
(brace
singleline_comment|//&t;struct usb_device *dev = state-&gt;s-&gt;usbdev;
r_struct
id|mixerchannel
op_star
id|ch
...
id|mchftr
suffix:semicolon
singleline_comment|//&t;unsigned char data[1];
id|usb_audio_recurseunit
c_func
(paren
id|state
