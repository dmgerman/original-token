...
suffix:semicolon
multiline_comment|/*&n; * my own sync control and bulk methods. Here to experiment&n; * and because the kernel ones set the process to TASK_UNINTERRUPTIBLE.&n; */
DECL|struct|sync
r_struct
id|sync
(brace
...
DECL|function|my_usb_control_msg
r_static
r_int
id|my_usb_control_msg
c_func
(paren
r_struct
id|usb_device
