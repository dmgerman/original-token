...
DECL|macro|MTS_DO_DEBUG
mdefine_line|#define MTS_DO_DEBUG
...
multiline_comment|/* we need no fops. let gcc fill it */
)brace
suffix:semicolon
multiline_comment|/* Internal driver stuff */
DECL|macro|MTS_VERSION
mdefine_line|#define MTS_VERSION&t;&quot;0.2.1&quot;
DECL|macro|MTS_NAME
...
suffix:semicolon
DECL|variable|mts_last_product
r_const
r_static
r_struct
id|vendor_product
...
suffix:semicolon
multiline_comment|/* Must never be derefed, points to one after last entry */
...
suffix:semicolon
multiline_comment|/* checking IDs */
r_for
c_loop
(paren
id|p
...
c_func
(paren
l_string|&quot;doesn&squot;t appear to be model %s&bslash;n&quot;
comma
id|p-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;returning NULL: unsupported&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
