...
id|rc
suffix:semicolon
multiline_comment|/* used by tty stuff to wait for output to drain. Go ask the&n;&t;   device how much is still queued in the tx ring */
id|rc
op_assign
id|usb_control_msg
c_func
...
l_int|1
comma
multiline_comment|/* value: 1 means chars_in_buffer */
l_int|0
comma
multiline_comment|/* index */
op_amp
