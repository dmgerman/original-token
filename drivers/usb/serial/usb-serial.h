...
multiline_comment|/* function prototypes for a Keyspan PDA serial converter */
r_static
r_int
...
suffix:semicolon
multiline_comment|/* All of the device info needed for the Keyspan PDA serial converter */
