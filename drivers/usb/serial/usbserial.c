...
multiline_comment|/* set up our port structure */
id|portNumber
op_assign
id|MINOR
c_func
...
suffix:semicolon
multiline_comment|/* make the tty driver remember our port object, and us it */
id|tty-&gt;driver_data
op_assign
id|port
suffix:semicolon
