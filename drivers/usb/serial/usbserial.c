...
suffix:semicolon
macro_line|#endif
multiline_comment|/* To add support for another serial converter, create a usb_serial_device_type&n;   structure for that device, and add it to this list, making sure that the&n;   last  entry is NULL. */
...
suffix:semicolon
multiline_comment|/* variables needed for the tty_driver structure */
...
DECL|function|usb_serial_tty_driver_init
r_static
r_struct
id|tty_driver
op_star
id|usb_serial_tty_driver_init
(paren
r_struct
id|usb_serial
op_star
...
suffix:semicolon
multiline_comment|/* initialize the entries that we don&squot;t want to be NULL */
...
id|max_endpoints
suffix:semicolon
multiline_comment|/* loop through our list of known serial converters, and see if this&n;           device matches. */
r_for
c_loop
(paren
id|device_num
...
id|num_interrupt_in
suffix:semicolon
multiline_comment|/* initialize a tty_driver for this device */
id|serial-&gt;tty_driver
op_assign
id|usb_serial_tty_driver_init
(paren
id|serial
...
c_func
(paren
l_string|&quot;Can&squot;t create a tty_serial_driver&quot;
)paren
suffix:semicolon
r_goto
id|probe_error
...
suffix:semicolon
multiline_comment|/* if this device has a tty_driver, then unregister it and free it */
r_if
c_cond
(paren
id|serial-&gt;tty_driver
...
multiline_comment|/* tell the world what devices this driver currently supports */
id|something
op_assign
l_int|0
suffix:semicolon
...
id|info
(paren
l_string|&quot;USB Serial driver is not configured for any devices!&quot;
)paren
suffix:semicolon
