...
c_func
(paren
l_string|&quot;omninet_open: kmalloc(%d) failed.&quot;
comma
r_sizeof
(paren
r_struct
...
c_func
(paren
l_string|&quot;usb_submit_urb(read bulk, %p) failed&quot;
comma
id|port-&gt;read_urb
)paren
suffix:semicolon
...
id|port
comma
l_string|&quot;omninet_read_bulk_callback&quot;
)paren
)paren
(brace
r_return
...
id|port
comma
l_string|&quot;omninet_write_bulk_callback&quot;
)paren
)paren
(brace
r_return
