...
multiline_comment|/* guarantee the write will send all data (or none), */
multiline_comment|/* so commands are not split */
id|len
op_assign
id|MIN
c_func
