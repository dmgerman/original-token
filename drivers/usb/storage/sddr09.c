...
c_func
(paren
l_string|&quot;Read %01X pages, from PBA %04X&quot;
l_string|&quot; (LBA %04X) page %01X&bslash;n&quot;
comma
id|pages
comma
id|pba
...
l_int|1
suffix:semicolon
multiline_comment|/* read 64 (2^6) bytes for every block (8192 (2^13) bytes)&n;&t;&t; of capacity:&n;&t;   64*(capacity/8192) = capacity*(2^6)*(2^-13) =&n;&t;   capacity*2^(6-13) = capacity*(2^-7)&n;&t; */
id|control
op_assign
id|kmalloc
c_func
