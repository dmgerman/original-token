...
multiline_comment|/* This is a sanity check that we should never hit */
r_if
c_cond
(paren
id|in_interrupt
...
(paren
id|KERN_ERR
l_string|&quot;usb-storage: command_abort() called from an interrupt!!! BAD!!! BAD!! BAD!!&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|FAILED
...
(brace
multiline_comment|/* cancel the URB */
id|usb_unlink_urb
c_func
(paren
id|us-&gt;current_urb
...
suffix:semicolon
multiline_comment|/* wake the control thread up */
r_if
c_cond
(paren
id|waitqueue_active
