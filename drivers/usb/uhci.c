...
c_func
(paren
l_string|&quot;uhci_td_result() failed with status %d&bslash;n&quot;
comma
id|status
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;qh %p leaving dangling entries? (%X)&bslash;n&quot;
comma
id|qh
comma
id|qh-&gt;element
...
DECL|macro|uhci_init
mdefine_line|#define uhci_init init_module
macro_line|#endif
