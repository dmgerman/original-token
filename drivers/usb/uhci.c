...
multiline_comment|/*&n; * This function removes and disallcoates all structures set up for an transfer.&n; * It takes the qh out of the skeleton, removes the tq and the td&squot;s.&n; * It only removes the associated interrupt handler if removeirq ist set.&n; * The *td argument is any td in the list of td&squot;s.&n; */
...
multiline_comment|/*&n; * Remove running irq td from queues&n; *&n; * This function is not used anymore.&n; */
macro_line|#if 0
r_static
r_int
id|uhci_remove_irq
...
c_func
(paren
l_string|&quot;usb-uhci: Releasing irq handle %p&bslash;n&quot;
comma
id|handle
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Warning, too much data for a bulk packet, crashing&bslash;n&quot;
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Status:    slow/fast,       Active,    Short Packet Detect     Infinite Errors */
id|status
op_assign
(paren
id|pipe
...
suffix:semicolon
singleline_comment|//Return last td for removal
r_return
id|td
suffix:semicolon
)brace
...
(brace
singleline_comment|//none found? there is nothing to remove!
r_if
c_cond
(paren
op_logical_neg
