...
multiline_comment|/*&n; * Isochronous operations&n; */
...
(paren
id|KERN_ERR
l_string|&quot;illegal frame number %d&bslash;n&quot;
comma
id|isodesc-&gt;frame
)paren
suffix:semicolon
...
multiline_comment|/* FIXME: Use uhci_remove_td */
...
id|tmp-&gt;next
suffix:semicolon
multiline_comment|/* We check the TD which had the IOC bit as well as the */
multiline_comment|/*  first TD */
multiline_comment|/* XXX: Shouldn&squot;t we check all of the TD&squot;s in the chain? */
r_if
c_cond
(paren
(paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/* If any of the error bits are set OR the active is NOT set */
multiline_comment|/*  then we&squot;re interested in this TD */
id|status
op_assign
id|td-&gt;status
op_amp
...
suffix:semicolon
multiline_comment|/* Isochronous TD&squot;s don&squot;t need this */
r_if
c_cond
(paren
op_logical_neg
...
id|name
suffix:semicolon
multiline_comment|/* FIXME: This is lame, but I guess it&squot;s better to leak memory than */
