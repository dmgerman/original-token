...
(brace
singleline_comment|//&t;&t;printk(&quot;uhci_td_result() - NAK&bslash;n&quot;);
multiline_comment|/* find total length xferred and reset toggle on failed packets */
id|tmp
op_assign
id|td-&gt;first
suffix:semicolon
r_do
(brace
multiline_comment|/* sum up packets that did not fail */
r_if
c_cond
(paren
id|rval
...
multiline_comment|/* &n;&t;&t;&t; * Note - only the first to fail will be marked NAK&n;&t;&t;&t; */
r_if
c_cond
(paren
id|tmp-&gt;status
...
(brace
multiline_comment|/* must reset the toggle on any error */
id|usb_settoggle
c_func
(paren
id|dev-&gt;usb
...
c_func
(paren
l_string|&quot;uhci_td_result returning partial count %d&bslash;n&quot;
comma
op_star
id|rval
)paren
