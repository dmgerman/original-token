multiline_comment|/*&n; * Universal Host Controller Interface driver for USB.&n; *&n; * (C) Copyright 1999 Linus Torvalds&n; * (C) Copyright 1999-2000 Johannes Erdfelt, jerdfelt@sventech.com&n; * (C) Copyright 1999 Randy Dunlap&n; * (C) Copyright 1999 Georg Acher, acher@in.tum.de&n; * (C) Copyright 1999 Deti Fliegl, deti@fliegl.de&n; * (C) Copyright 1999 Thomas Sailer, sailer@ife.ee.ethz.ch&n; * (C) Copyright 1999 Roman Weissgaerber, weissg@vienna.at&n; *&n; * Intel documents this fairly well, and as far as I know there&n; * are no royalties or anything like that, but even so there are&n; * people who decided that they want to do the same thing in a&n; * completely different way.&n; *&n; * WARNING! The USB documentation is downright evil. Most of it&n; * is just crap, written by a committee. You&squot;re better off ignoring&n; * most of it, the important stuff is:&n; *  - the low-level protocol (fairly simple but lots of small details)&n; *  - working around the horridness of the rest&n; */
...
r_return
suffix:semicolon
multiline_comment|/* Grab the first TD and add it to the QH */
id|td
op_assign
id|begin
suffix:semicolon
...
id|UHCI_PTR_DEPTH
suffix:semicolon
multiline_comment|/* Go through the rest of the TD&squot;s, link them together */
id|prevtd
op_assign
id|td
suffix:semicolon
...
DECL|function|uhci_schedule_delete_td
r_static
r_void
id|uhci_schedule_delete_td
c_func
(paren
r_struct
id|uhci
...
DECL|function|uhci_schedule_delete_qh
r_static
r_void
id|uhci_schedule_delete_qh
c_func
(paren
r_struct
id|uhci
...
(brace
multiline_comment|/* FIXME: Free the TD&squot;s */
r_return
op_minus
id|ENOMEM
suffix:semicolon
...
multiline_comment|/* FIXME: Free all of the previously allocated td&squot;s */
r_return
op_minus
id|ENOMEM
suffix:semicolon
...
(brace
multiline_comment|/* FIXME: Free all of the TD&squot;s */
r_return
op_minus
id|ENOMEM
suffix:semicolon
...
DECL|function|uhci_unlink_control
r_static
r_int
id|uhci_unlink_control
c_func
(paren
id|urb_t
op_star
...
suffix:semicolon
multiline_comment|/* Go through the rest of the TD&squot;s, deleting them, then scheduling */
multiline_comment|/*  their deletion */
id|td
op_assign
id|urbp-&gt;begin
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* If SPD is set then we received a short packet */
multiline_comment|/*  There will be no status phase at the end */
r_if
c_cond
(paren
id|td-&gt;status
...
DECL|function|uhci_unlink_interrupt
r_static
r_int
id|uhci_unlink_interrupt
c_func
(paren
id|urb_t
op_star
...
multiline_comment|/* We can use the control unlink since they&squot;re identical */
DECL|macro|uhci_unlink_bulk
mdefine_line|#define uhci_unlink_bulk uhci_unlink_control
DECL|function|uhci_result_bulk
r_static
r_int
id|uhci_result_bulk
c_func
...
c_func
(paren
l_string|&quot;uhci_result_bulk() failed with status %x&quot;
comma
id|status
)paren
suffix:semicolon
...
DECL|function|uhci_unlink_isochronous
r_static
r_int
id|uhci_unlink_isochronous
c_func
(paren
id|urb_t
op_star
...
id|EINPROGRESS
suffix:semicolon
multiline_comment|/* Assume no errors, we&squot;ll overwrite this if not */
id|urb-&gt;status
op_assign
l_int|0
suffix:semicolon
...
DECL|function|uhci_free_pending
r_void
id|uhci_free_pending
c_func
(paren
r_struct
id|uhci
...
id|head
suffix:semicolon
multiline_comment|/* Free all of the pending QH&squot;s and TD&squot;s */
id|head
op_assign
op_amp
id|uhci-&gt;td_free_list
...
r_break
suffix:semicolon
multiline_comment|/* Is it the UHCI programming interface? */
...
multiline_comment|/* We only want to return an error code if ther was an error */
multiline_comment|/*  and we didn&squot;t find a UHCI controller */
r_if
c_cond
(paren
id|retval
...
suffix:semicolon
multiline_comment|/* Free any outstanding TD&squot;s and QH&squot;s */
id|spin_lock_irqsave
c_func
(paren
op_amp
