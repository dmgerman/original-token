...
multiline_comment|/* FIXME: Re-setup the queue to run the STATUS phase? */
r_if
c_cond
(paren
id|td-&gt;status
...
suffix:semicolon
macro_line|#ifndef CONFIG_USB_UHCI_ALT_UNLINK_OPTIMIZE
r_if
c_cond
(paren
id|in_interrupt
...
DECL|function|uhci_stop_hc_schedule
r_static
r_void
id|uhci_stop_hc_schedule
c_func
...
(brace
macro_line|#ifdef CONFIG_USB_UHCI_ALT_UNLINK_OPTIMIZE
r_int
r_int
id|cmdreg
comma
...
(paren
id|KERN_ERR
l_string|&quot;uhci: stop_hc_schedule failed, HC still running&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
DECL|function|uhci_start_hc_schedule
r_static
r_void
id|uhci_start_hc_schedule
c_func
...
(paren
id|KERN_ERR
l_string|&quot;uhci: start_hc_schedule failed, HC still halted&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
