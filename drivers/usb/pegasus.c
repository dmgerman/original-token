...
op_assign
id|__FILE__
l_string|&quot;: v0.4.3 2000/08/22 (C) 1999-2000 Petko Manolov (petkan@dce.bg)&bslash;n&quot;
suffix:semicolon
DECL|macro|PEGASUS_USE_WAITQ
mdefine_line|#define&t;PEGASUS_USE_WAITQ
...
suffix:semicolon
DECL|function|pegasus_unlink_ctrl_urbs
r_static
r_void
id|pegasus_unlink_ctrl_urbs
c_func
(paren
r_struct
id|pegasus
...
DECL|function|pegasus_find_ctrl_urb
r_static
r_int
id|pegasus_find_ctrl_urb
c_func
(paren
r_struct
id|pegasus
...
l_int|0
suffix:semicolon
macro_line|#ifdef&t;PEGASUS_USE_WAITQ
...
id|ctrl-&gt;dr.length
op_assign
id|ctrl-&gt;urb.transfer_buffer_length
op_assign
id|cpu_to_le16p
c_func
(paren
...
DECL|function|pegasus_read_bulk_callback
r_static
r_void
id|pegasus_read_bulk_callback
c_func
(paren
r_struct
id|urb
...
id|rx_status
suffix:semicolon
multiline_comment|/*= *(int *)(pegasus-&gt;rx_buff + count - 4);*/
r_struct
id|sk_buff
op_star
id|skb
...
DECL|function|pegasus_irq_callback
r_static
r_void
id|pegasus_irq_callback
c_func
(paren
id|urb_t
op_star
...
DECL|function|pegasus_write_bulk_callback
r_static
r_void
id|pegasus_write_bulk_callback
c_func
(paren
r_struct
id|urb
...
(brace
macro_line|#ifndef&t;PEGASUS_USE_WAITQ
r_struct
id|pegasus
op_star
id|pegasus
