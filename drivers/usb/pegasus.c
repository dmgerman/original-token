...
op_assign
id|__FILE__
l_string|&quot;: v0.3.3 2000/03/13 Written by Petko Manolov (petkan@spct.net)&bslash;n&quot;
suffix:semicolon
DECL|macro|ADMTEK_VENDOR_ID
mdefine_line|#define&t;ADMTEK_VENDOR_ID&t;&t;0x07a6
DECL|macro|ADMTEK_DEVICE_ID_PEGASUS
mdefine_line|#define&t;ADMTEK_DEVICE_ID_PEGASUS&t;0x0986
...
suffix:semicolon
multiline_comment|/*&t;usb_submit_urb(&amp;pegasus-&gt;intr_urb);*/
id|netif_start_queue
c_func
(paren
id|net
...
suffix:semicolon
multiline_comment|/*&t;usb_unlink_urb(&amp;pegasus-&gt;intr_urb); */
