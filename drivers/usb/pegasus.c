...
op_assign
id|__FILE__
l_string|&quot;: v0.4.0 2000/06/15 (C) 1999-2000 Petko Manolov (petkan@spct.net)&bslash;n&quot;
suffix:semicolon
...
mdefine_line|#define&t;PEGASUS_CTRL_TIMEOUT&t;1000
...
suffix:semicolon
macro_line|#if 1&t;/* Should be fixed */
r_if
c_cond
(paren
id|urb-&gt;status
