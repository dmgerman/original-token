...
op_assign
id|__FILE__
l_string|&quot;: v0.4.9 2000/09/14 (C) 1999-2000 Petko Manolov (petkan@dce.bg)&quot;
suffix:semicolon
...
mdefine_line|#define&t;PEGASUS_PRESENT&t;&t;1
DECL|macro|PEGASUS_RUNNING
mdefine_line|#define&t;PEGASUS_RUNNING&t;&t;2
DECL|macro|CTRL_URB_RUNNING
mdefine_line|#define&t;CTRL_URB_RUNNING&t;4
DECL|macro|CTRL_URB_SLEEP
mdefine_line|#define&t;CTRL_URB_SLEEP&t;&t;8
...
DECL|macro|INTR_IVAL
mdefine_line|#define&t;INTR_IVAL&t;0x80
macro_line|#else
DECL|macro|INTR_IVAL
mdefine_line|#define&t;INTR_IVAL&t;0
macro_line|#endif
...
DECL|function|set_intr_interval
r_static
r_void
id|set_intr_interval
c_func
(paren
id|pegasus_t
op_star
...
suffix:semicolon
macro_line|#ifdef&t;PEGASUS_DUMP_EEPROM  
(brace
r_int
id|i
suffix:semicolon
