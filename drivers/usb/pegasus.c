...
mdefine_line|#define PEGASUS_DEV(product_name, vendor_id, product_id, flags) &bslash;&n;&t;{name: product_name, private: flags},
...
(brace
DECL|macro|PEGASUS_DEV
macro_line|#&t;define PEGASUS_DEV(product_name, vendor_id, product_id, flags) &bslash;&n;&t;&t;{name: product_name, private: flags},
macro_line|#&t;include &quot;pegasus_devs.h&quot;
DECL|macro|PEGASUS_DEV
macro_line|#&t;undef PEGASUS_DEV
(brace
l_int|NULL
comma
l_int|0
...
suffix:semicolon
multiline_comment|/* The entries in this table MUST CORRESPOND LINE-BY-LINE to the&n;   entries of usb_dev_id[]. */
...
(brace
DECL|macro|PEGASUS_DEV
macro_line|#&t;define PEGASUS_DEV(product_name, vendor_id, product_id, flags) &bslash;&n;&t;&t;{idVendor: vendor_id, idProduct: product_id },
macro_line|#&t;include &quot;pegasus_devs.h&quot;
DECL|macro|PEGASUS_DEV
macro_line|#&t;undef PEGASUS_DEV
(brace
