...
id|noinput
suffix:semicolon
multiline_comment|/* nz if no input stream */
DECL|member|minor
id|__u8
id|minor
suffix:semicolon
...
id|interface
op_assign
id|p-&gt;pusb_dev-&gt;config-&gt;interface-&gt;altsetting
suffix:semicolon
id|endpoint_num
op_assign
(paren
...
id|dr
suffix:semicolon
multiline_comment|/* Lets get the device id if possible */
id|dr.requesttype
op_assign
id|USB_TYPE_CLASS
op_or
...
(paren
id|KERN_INFO
l_string|&quot;  Printer ID is %s&bslash;n&quot;
comma
op_amp
id|ieee_id
(braket
