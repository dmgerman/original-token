...
id|header
suffix:semicolon
multiline_comment|/* We need at least 2 bytes for the magic value */
r_if
c_cond
(paren
id|scratch_left
...
id|STATE_HEADER
suffix:colon
multiline_comment|/* We need at least 64 bytes for the header */
r_if
c_cond
(paren
id|scratch_left
...
multiline_comment|/* end case STATE_LINES */
)brace
multiline_comment|/* end switch (scanstate) */
)brace
...
id|FRAME_ERROR
suffix:semicolon
multiline_comment|/* Get a fresh frame since this frame may have been important */
id|cpia-&gt;compress
op_assign
l_int|0
suffix:semicolon
...
c_func
(paren
l_string|&quot;cpia_isoc_irq: %p status %d, errcount = %d, length = %d&bslash;n&quot;
comma
id|urb
comma
id|urb-&gt;status
...
suffix:semicolon
singleline_comment|// usb_kill_isoc(sbuf-&gt;isodesc);
...
singleline_comment|// usb_run_isoc(sbuf-&gt;isodesc, cpia-&gt;sbuf[cpia-&gt;cursbuf].isodesc);
r_return
suffix:semicolon
)brace
...
singleline_comment|//&t;err = usb_init_isoc(dev, usb_rcvisocpipe(dev, 1), FRAMES_PER_DESC, cpia, &amp;cpia-&gt;sbuf[0].isodesc);
id|urb
op_assign
id|usb_alloc_urb
c_func
...
(paren
id|KERN_ERR
l_string|&quot;cpia_init_isoc: usb_run_isoc(0) ret %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cpia_init_isoc: usb_run_isoc(1) ret %d&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* accumulated in cpia_parse_data() */
id|cpia-&gt;curframe
op_assign
id|framenum
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;cpia_read: %ld bytes, noblock=%d&bslash;n&quot;
comma
id|count
comma
id|noblock
...
c_func
(paren
l_string|&quot;cpia_read: errored frame %d&bslash;n&quot;
comma
id|cpia-&gt;curframe
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;cpia_read: cpia_new_frame error&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|restart
...
(paren
id|KERN_DEBUG
l_string|&quot;cpia_read: frmx=%d, bytes_read=%ld, scanlength=%ld&bslash;n&quot;
comma
id|frmx
comma
id|frame-&gt;bytes_read
...
(paren
id|KERN_DEBUG
l_string|&quot;cpia_read: {copy} count used=%ld, new bytes_read=%ld&bslash;n&quot;
comma
id|count
comma
id|frame-&gt;bytes_read
...
(paren
id|KERN_ERR
l_string|&quot;cpia_read: cpia_new_frame returned error&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return
...
comma
op_amp
id|cpia-&gt;dev-&gt;actconfig-&gt;interface
(braket
l_int|0
)braket
)paren
