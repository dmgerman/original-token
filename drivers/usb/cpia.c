...
multiline_comment|/* 0x1968 is magic */
id|printk
c_func
(paren
...
multiline_comment|/*&n; * For the moment there is no actual data compression (making blocks&n; * of data contiguous).  This just checks the &quot;frames&quot; array for errors.&n; */
...
multiline_comment|/*&n;&t;usb_run_isoc(sbuf-&gt;isodesc, NULL);&n;&t;*/
multiline_comment|/*&n;&t;usb_schedule_isochronous(dev, sbuf-&gt;isodesc, cpia-&gt;sbuf[(cpia-&gt;receivesbuf + 2) % 3].isodesc);&n;*/
...
id|STATE_SCANNING
suffix:semicolon
multiline_comment|/* ALT_ISOC is only doing double-buffering, not triple. */
id|err
op_assign
id|usb_init_isoc
(paren
