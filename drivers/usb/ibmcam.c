...
suffix:semicolon
multiline_comment|/* Still mysterious i2o commands */
...
multiline_comment|/*&n; * usb_ibmcam_adjust_contrast()&n; *&n; * The contrast value changes from 0 (high contrast) to 15 (low contrast).&n; * This is in reverse to usual order of things (such as TV controls), so&n; * we reverse it again here.&n; *&n; * TODO: we probably don&squot;t need to send the setup 5 times...&n; *&n; * History:&n; * 1/2/99   Created.&n; */
...
multiline_comment|/*&n; * usb_ibmcam_change_lighting_conditions()&n; *&n; * We have 3 levels of lighting conditions: 0=Bright, 1=Medium, 2=Low.&n; * Low lighting forces slower FPS. Lighting is set as a module parameter.&n; *&n; * History:&n; * 1/5/99   Created.&n; */
...
DECL|function|usb_ibmcam_setup_before_if1
r_static
r_void
id|usb_ibmcam_setup_before_if1
c_func
(paren
r_struct
id|usb_device
...
DECL|function|usb_ibmcam_setup_before_if2
r_static
r_void
id|usb_ibmcam_setup_before_if2
c_func
(paren
r_struct
id|usb_device
...
suffix:semicolon
singleline_comment|// printk(KERN_DEBUG &quot;streaming=0&bslash;n&quot;);
id|ibmcam-&gt;streaming
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;couldn&squot;t kmalloc ibmcam-&gt;scratch&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
l_int|1014
suffix:semicolon
multiline_comment|/* Camera setup */
id|usb_ibmcam_veio
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* sleep_on(&amp;s-&gt;remove_ok); */
multiline_comment|/* Now it should be safe to remove */
