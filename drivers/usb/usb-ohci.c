...
mdefine_line|#define&t;OHCI_CONTROL_INIT &bslash;&n;&t;(OHCI_CTRL_CBSR &amp; 0x3) &bslash;&n;&t;| OHCI_CTRL_BLE | OHCI_CTRL_CLE | OHCI_CTRL_IE | OHCI_CTRL_PLE
r_static
...
id|URB_DEL
suffix:semicolon
multiline_comment|/* we want to delete the TDs of an URB from an ed &n;&t;&t;&t; * request the deletion, it will be handled at the&n;&t;&t;&t; * next USB-frame */
id|spin_lock_irqsave
(paren
op_amp
id|usb_ed_lock
...
(brace
multiline_comment|/* enable CTRL and BULK lists */
id|ohci-&gt;hc_control
op_or_assign
id|OHCI_CTRL_CLE
op_or
...
multiline_comment|/*-------------------------------------------------------------------------*/
multiline_comment|/* reinitialize after controller reset */
DECL|function|hc_reinit_ohci
r_static
r_void
id|hc_reinit_ohci
(paren
...
id|i
suffix:semicolon
multiline_comment|/* for load balancing of the interrupt branches */
r_for
c_loop
(paren
id|i
