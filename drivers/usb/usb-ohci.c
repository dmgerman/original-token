...
id|i
suffix:semicolon
multiline_comment|/* Release int/iso bandwidth for Interrupt or Isoc. transfers */
r_if
c_cond
(paren
id|urb-&gt;bandwidth
...
multiline_comment|/* maybe reenable CTRL and BULK lists */
r_if
c_cond
(paren
op_logical_neg
