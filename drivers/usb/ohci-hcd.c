...
DECL|function|sohci_bulk_handler
r_static
r_int
id|sohci_bulk_handler
c_func
(paren
r_void
op_star
...
l_int|NULL
comma
multiline_comment|/* FIXME: should be release_irq/remove_irq */
id|sohci_alloc_isochronous
comma
id|sohci_delete_isochronous
comma
...
(brace
multiline_comment|/* global power on */
id|writel
c_func
(paren
l_int|0x10000
...
r_else
(brace
multiline_comment|/* port power on */
r_for
c_loop
(paren
id|port_nr
