...
c_func
(paren
l_string|&quot;: end KILL_ISOC***: %p&bslash;n&quot;
comma
id|ed
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;++++ USB HC add 60 ed1 %x: %x :state: %x&bslash;n&quot;
comma
id|ed1-&gt;hwINFO
comma
(paren
