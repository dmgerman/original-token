...
c_func
(paren
l_string|&quot;******* hcd_ed: endpoint: %4x, function: %4x, out: %4x, type: %4x, slow: %4x, maxpack: %4x&bslash;n&quot;
comma
id|hcd_ed-&gt;endpoint
comma
id|hcd_ed-&gt;function
...
DECL|function|sohci_alloc_isochronous
r_static
r_void
op_star
id|sohci_alloc_isochronous
(paren
r_struct
id|usb_device
op_star
...
DECL|function|sohci_delete_isochronous
r_static
r_void
id|sohci_delete_isochronous
(paren
r_struct
id|usb_device
op_star
...
c_func
(paren
l_string|&quot;USB HC RM_ISO&gt;&gt;&gt;:%4x&bslash;n&quot;
comma
(paren
r_int
r_int
...
DECL|function|sohci_sched_isochronous
r_static
r_int
id|sohci_sched_isochronous
(paren
r_struct
id|usb_device
op_star
...
DECL|function|sohci_unsched_isochronous
r_static
r_int
id|sohci_unsched_isochronous
(paren
r_struct
id|usb_device
op_star
...
DECL|function|sohci_compress_isochronous
r_static
r_int
id|sohci_compress_isochronous
(paren
r_struct
id|usb_device
op_star
...
c_func
(paren
l_string|&quot;unlnk_branch int %2d(%2x): &quot;
comma
id|i
comma
id|i
...
multiline_comment|/* the int tree is a binary tree &n; * in order to process it sequentielly the indexes of the branches have to be mapped &n; * the mapping reverses the bits of a word of num_bits length&n; * */
DECL|function|rev
r_static
r_int
id|rev
...
multiline_comment|/*****&n; * Request the removal of an endpoint&n; * &n; * put the ep on the rm_list and request a stop of the bulk or ctrl list &n; * real removal is done at the next start of frame (SOF) hardware interrupt &n; * the dummy td carries the essential information (handler, proc queue, ...)&n; */
...
mdefine_line|#define FILL_ISO_TD(INFO, DATA, LEN, LW0, LW1, TYPE, HANDLER)  &bslash;&n;&t;OHCI_ALLOC(td_pt, sizeof(*td_pt)); &bslash;&n;    td_ret = (struct usb_ohci_td *) bus_to_virt(usb_ed-&gt;hwTailP); &bslash;&n;    td_pt1 = td_ret; &bslash;&n;    td_pt1-&gt;ed = ed; &bslash;&n;    td_pt1-&gt;buffer_start = (DATA); &bslash;&n;    td_pt1-&gt;type = (TYPE); &bslash;&n;    td_pt1-&gt;handler = (HANDLER); &bslash;&n;    td_pt1-&gt;lw0 = (LW0); &bslash;&n;    td_pt1-&gt;lw1 = (LW1); &bslash;&n;    td_pt1-&gt;hwINFO = (INFO); &bslash;&n;    td_pt1-&gt;hwCBP = (virt_to_bus(DATA) &amp; 0xfffff000); &bslash;&n;    td_pt1-&gt;hwBE = virt_to_bus((DATA) + (LEN) - 1); &bslash;&n;    td_pt1-&gt;hwNextTD = virt_to_bus(td_pt); &bslash;&n;    td_pt1-&gt;hwPSW[0] = virt_to_bus(DATA) &amp; 0xfff; &bslash;&n;    usb_ed-&gt;hwTailP = virt_to_bus(td_pt); &bslash;&n;    td_pt-&gt;hwNextTD = 0
...
multiline_comment|/* there are some pending requests to remove some of the eds &n; * we process every td including the dummy td of these eds &n; * and link them to a list&n; * */
