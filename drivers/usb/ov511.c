multiline_comment|/*&n; * OmniVision OV511 Camera-to-USB Bridge Driver&n; *&n; * Copyright (c) 1999-2000 Mark W. McClelland&n; * Many improvements by Bret Wallach&n; * Color fixes by by Orion Sky Lawlor, olawlor@acm.org, 2/26/2000&n; * Snapshot code by Kevin Moore&n; * OV7620 fixes by Charl P. Botha &lt;cpbotha@ieee.org&gt;&n; * Changes by Claudio Matsuoka, claudio@conectiva.com, 3/26/2000&n; * &n; * Based on the Linux CPiA driver written by Peter Pregler,&n; * Scott J. Bertin and Johannes Erdfelt.&n; * &n; * Please see the file: linux/Documentation/usb/ov511.txt &n; * and the website at:  http://alpha.dyndns.org/ov511&n; * for more info.&n; *&n; * This program is free software; you can redistribute it and/or modify it&n; * under the terms of the GNU General Public License as published by the&n; * Free Software Foundation; either version 2 of the License, or (at your&n; * option) any later version.&n; *&n; * This program is distributed in the hope that it will be useful, but&n; * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY&n; * or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License&n; * for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software Foundation,&n; * Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; */
...
id|out
comma
l_string|&quot;  hdr_size      : %d %d&bslash;n&quot;
comma
id|ov511-&gt;frame
(braket
id|i
...
id|out
comma
l_string|&quot;  scanlength    : %ld&bslash;n&quot;
comma
id|ov511-&gt;frame
(braket
id|i
...
id|out
comma
l_string|&quot;  bytesread     : %ld&bslash;n&quot;
comma
id|ov511-&gt;frame
(braket
id|i
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* struct cam_data *cam = data; */
r_struct
id|usb_ov511
id|new_params
suffix:semicolon
...
c_func
(paren
l_string|&quot;Unable to initialise /proc/ov511&bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/***********/
)brace
...
c_func
(paren
l_string|&quot;Failed to read sensor ID. You might not have an OV76xx,&quot;
)paren
suffix:semicolon
id|err
c_func
...
l_int|3
comma
l_string|&quot;destroying /proc/ov511/video%d&quot;
comma
id|ov511-&gt;vdev.minor
)paren
suffix:semicolon
...
l_int|3
comma
l_string|&quot;destroying /proc/ov511&quot;
)paren
suffix:semicolon
id|proc_ov511_destroy
c_func
