multiline_comment|/*&n; * OmniVision OV511 Camera-to-USB Bridge Driver&n; * Copyright 1999/2000 Mark W. McClelland&n; *&n; * Based on the Linux CPiA driver.&n; * &n; * Released under GPL v.2 license.&n; *&n; * Important keywords in comments:&n; *    CAMERA SPECIFIC - Camera specific code; may not work with other cameras.&n; *    DEBUG - Debugging code.&n; *    FIXME - Something that is broken or needs improvement.&n; *&n; * Version: 1.06&n; *&n; * Please see the file: linux/Documentation/usb/ov511.txt &n; * and the website at:  http://people.delphi.com/mmcclelland/linux/ &n; * for more info.&n; */
...
suffix:semicolon
multiline_comment|/* Set mode consistent registers */
id|ov511_i2c_write
c_func
(paren
id|dev
...
multiline_comment|/* Reset the camera chip */
r_if
c_cond
(paren
id|ov511_i2c_reset
...
id|dev
comma
id|OV511_REG_I2C_CLOCK_PRESCALER
comma
id|OV511_I2C_CLOCK_PRESCALER
)paren
)paren
(brace
r_return
