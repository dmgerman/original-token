multiline_comment|/*&n; * OmniVision OV511 Camera-to-USB Bridge Driver&n; * Copyright (c) 1999/2000 Mark W. McClelland&n; * Many improvements by Bret Wallach&n; * Color fixes by by Orion Sky Lawlor, olawlor@acm.org, 2/26/2000&n; * Snapshot code by Kevin Moore&n; * OV7620 fixes by Charl P. Botha &lt;cpbotha@ieee.org&gt;&n; * &n; * Based on the Linux CPiA driver.&n; * &n; * Released under GPL v.2 license.&n; *&n; * Version: 1.11&n; *&n; * Please see the file: linux/Documentation/usb/ov511.txt &n; * and the website at:  http://alpha.dyndns.org/ov511 &n; * for more info.&n; */
...
suffix:semicolon
singleline_comment|//&t;&t;else if (size == 512) alt = OV511_ALT_SIZE_512;
r_else
r_if
c_cond
(paren
...
suffix:semicolon
singleline_comment|//&t;&t;else if (size == 768) alt = OV511_ALT_SIZE_768;
r_else
r_if
c_cond
(paren
...
suffix:semicolon
singleline_comment|//&t;&t;else if (size == 992) alt = OV511_ALT_SIZE_992;
r_else
r_if
c_cond
(paren
...
(brace
singleline_comment|//&t;&t;cur_con = ov511_i2c_read(dev, OV7610_REG_CNT);
singleline_comment|//&t;&t;cur_brt = ov511_i2c_read(dev, OV7610_REG_BRT);
singleline_comment|//&t;        // DEBUG_CODE
singleline_comment|//&t;        PDEBUG(1, &quot;con=%d brt=%d&quot;, ov511_i2c_read(dev, OV7610_REG_CNT),
singleline_comment|//&t;                                   ov511_i2c_read(dev, OV7610_REG_BRT)); 
singleline_comment|//
singleline_comment|//&t;&t;if(ov511_i2c_write(dev, OV7610_REG_CNT, p-&gt;contrast &gt;&gt; 8) &lt; 0)
singleline_comment|//&t;&t;&t;return -EIO;
)brace
r_if
c_cond
(paren
...
(brace
multiline_comment|/* these aren&squot;t valid on the OV7620 */
id|ov511_i2c_write
c_func
(paren
id|dev
...
(brace
multiline_comment|/* not valid on the OV7620 */
id|ov511_i2c_write
c_func
(paren
id|dev
...
(brace
multiline_comment|/* horizontal window start */
id|ov511_i2c_write
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* horizontal window end */
id|ov511_i2c_write
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* vertical window start */
id|ov511_i2c_write
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* vertical window end */
id|ov511_i2c_write
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* clock rate control */
id|ov511_i2c_write
c_func
(paren
id|dev
...
suffix:semicolon
multiline_comment|/* 7620 doesn&squot;t have register 0x35, so play it safe */
r_if
c_cond
(paren
id|ov511-&gt;sensor
