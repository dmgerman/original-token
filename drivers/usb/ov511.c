...
mdefine_line|#define GET_SEGSIZE(p) ((p) == VIDEO_PALETTE_RGB24 ? 384 : 256)
DECL|macro|GET_DEPTH
mdefine_line|#define GET_DEPTH(p) ((p) == VIDEO_PALETTE_RGB24 ? 24 : 8)
...
c_func
(paren
l_string|&quot;Mark McClelland &lt;mmcclelland@delphi.com&gt; &amp; Bret Wallach &amp; Orion Sky Lawlor &lt;olawlor@acm.org&gt; &amp; Kevin Moore &amp; Charl P. Botha &lt;cpbotha@ieee.org&gt; &amp; Claudio Matsuoka &lt;claudio@conectiva.com&gt;&quot;
)paren
suffix:semicolon
...
macro_line|#if 0
multiline_comment|/* FIXME: subwindow support is currently broken! &n;&t; */
r_if
c_cond
(paren
id|width
...
suffix:semicolon
multiline_comment|/* YUV420/422, YFIR */
id|ov511_i2c_write
c_func
(paren
id|dev
...
l_float|1.0
suffix:semicolon
multiline_comment|/* 0-&gt;black; 1-&gt;full scale */
r_const
r_float
id|saturation
op_assign
l_float|1.0
suffix:semicolon
multiline_comment|/* 0-&gt;greyscale; 1-&gt;full color */
r_const
r_float
id|fixScale
op_assign
