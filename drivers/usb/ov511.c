...
DECL|macro|OV511_GBR422
macro_line|#undef OV511_GBR422&t;&t;/* Experimental -- sets the 7610 to GBR422 */
...
mdefine_line|#define GET_DEPTH(p) ((p) == VIDEO_PALETTE_GREY ? 8 : ((p) == VIDEO_PALETTE_YUV422 ? 8 : 24))
...
multiline_comment|/* FIXME: 176x144, 160x140 */
...
op_assign
(brace
multiline_comment|/* W    H   C  PXCNT LNCNT PXDIV LNDIV M420  COMA  COMC  COML */
(brace
l_int|640
comma
l_int|480
