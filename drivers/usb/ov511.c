...
multiline_comment|/***************************************************************&n;&n;For a 640x480 images, data shows up in 1200 384 byte segments.  The&n;first 128 bytes of each segment are probably some combo of UV but I&n;haven&squot;t figured it out yet.  The next 256 bytes are apparently Y&n;data and represent 4 squares of 8x8 pixels as follows:&n;&n;  0  1 ...  7    64  65 ...  71   ...  192 193 ... 199&n;  8  9 ... 15    72  73 ...  79        200 201 ... 207&n;       ...              ...                    ...&n; 56 57 ... 63   120 121     127        248 249 ... 255&n;&n;Right now I&squot;m only moving the Y data and haven&squot;t figured out&n;the UV data.&n;&n;If OV511_DUMPPIX is defined, _parse_data just dumps the&n;incoming segments, verbatim, in order, into the frame.&n;When used with vidcat -f ppm -s 640x480 this puts the data&n;on the standard output and can be analyzed with the parseppm.c&n;utility I wrote.  That&squot;s a much faster way for figuring out how&n;this data is scrambled.&n;&n;****************************************************************/
