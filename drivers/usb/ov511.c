...
mdefine_line|#define GET_DEPTH(p) ((p) == VIDEO_PALETTE_GREY ? 8 : &bslash;&n;&t;&t;     ((p) == VIDEO_PALETTE_YUV422 ? 16 : 24))
...
multiline_comment|/* #define this and OV511_DUMPPIX to disable parsing of UV data */
DECL|macro|OV511_FORCE_MONO
macro_line|#undef OV511_FORCE_MONO
macro_line|#ifdef OV511_GBR422
r_static
r_void
...
macro_line|#else
macro_line|#ifndef OV511_FORCE_MONO
...
macro_line|#else
multiline_comment|/* This will dump the Y channel data stream as-is */
r_int
id|count
suffix:semicolon
r_int
...
suffix:semicolon
multiline_comment|/* Checking vendor/product should be enough, but what the hell.&n;&t;   USB ID matching cannot check for a bInterfaceSubclass value&n;&t;   of 0, so we check it here. */
r_if
c_cond
(paren
