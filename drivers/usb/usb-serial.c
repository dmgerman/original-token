...
c_func
(paren
l_string|&quot;visor_startup: First vendor specific message successful&quot;
)paren
suffix:semicolon
)brace
id|response
...
c_func
(paren
l_string|&quot;visor_startup: Second vendor specific message successful&quot;
)paren
suffix:semicolon
)brace
id|kfree
