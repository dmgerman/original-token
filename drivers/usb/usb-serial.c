...
mdefine_line|#define MAX_ENDPOINTS&t;8
...
c_func
(paren
id|serial-&gt;write_urb.transfer_buffer
comma
id|buf
comma
id|count
...
id|serial-&gt;write_urb.transfer_buffer_length
op_assign
id|count
suffix:semicolon
r_if
