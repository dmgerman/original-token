...
c_func
(paren
l_string|&quot;whiteheat_startup&bslash;n&quot;
)paren
suffix:semicolon
id|response
op_assign
...
c_func
(paren
l_string|&quot;whiteheat_writememory failed for first firmware step (%d %04X %p %d)&bslash;n&quot;
comma
id|response
comma
id|record-&gt;address
