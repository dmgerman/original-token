multiline_comment|/* $Id: hycapi.c,v 1.6 2000/07/25 08:07:42 ualbrecht Exp $&n; *&n; * Linux driver for HYSDN cards, CAPI2.0-Interface.&n; * written by Ulrich Albrecht (u.albrecht@hypercope.de) for Hypercope GmbH&n; *&n; * Copyright 2000 by Hypercope GmbH&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: hycapi.c,v $&n; * Revision 1.6  2000/07/25 08:07:42  ualbrecht&n; * Fixed stupid re-registering bug resulting in system-freeze&n; *&n; * Revision 1.5  2000/06/18 16:08:18  keil&n; * 2.4 PCI changes and some cosmetics&n; *&n; * Revision 1.4  2000/06/13 09:13:06  ualbrecht&n; * Changed internal application handling: Registration is now deferred&n; * until a CAPI-message is actually sent to the controller (no good&n; * wasting memory on the card if it&squot;s never used anyways).&n; * Module will now unload more gracefully.&n; *&n; * Revision 1.2  2000/05/22 10:31:22  ualbrecht&n; * Parameter-checking for app-registration fixed&n; *&n; * Revision 1.1  2000/05/17 11:34:30  ualbrecht&n; * Initial release&n; *&n; *&n; */
