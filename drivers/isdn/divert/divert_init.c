multiline_comment|/* &n; * $Id: divert_init.c,v 1.3 1999/07/05 20:21:39 werner Exp $&n; *&n; * Module init for DSS1 diversion services for i4l.&n; *&n; * Copyright 1999       by Werner Cornelius (werner@isdn4linux.de)&n; * &n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA. &n; *&n; * $Log: divert_init.c,v $&n; * Revision 1.3  1999/07/05 20:21:39  werner&n; * changes to use diversion sources for all kernel versions.&n; * removed static device, only proc filesystem used&n; *&n; * Revision 1.2  1999/07/04 21:37:30  werner&n; * Ported from kernel version 2.0&n; *&n; *&n; *&n; */
