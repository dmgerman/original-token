...
macro_line|#endif
multiline_comment|/*&n;     * normal or bundle compression&n;     */
id|skb
op_assign
id|isdn_ppp_compress
c_func
...
macro_line|#endif
multiline_comment|/*&n;&t; * &squot;link&squot; compression &n;&t; */
id|skb
op_assign
id|isdn_ppp_compress
c_func
...
(paren
id|KERN_ERR
l_string|&quot;compression not included!&bslash;n&quot;
)paren
suffix:semicolon
id|dev_kfree_skb
c_func
...
(brace
multiline_comment|/* &n;&t;&t; * single link compression &n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
(paren
id|KERN_ERR
l_string|&quot;ippp: no (link) compressor defined!&bslash;n&quot;
)paren
suffix:semicolon
id|dev_kfree_skb
c_func
...
(paren
id|KERN_DEBUG
l_string|&quot;ippp: initialize link compressor&bslash;n&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/*&n;&t;&t;-&gt; decompress link&n;*/
)brace
r_else
(brace
...
op_assign
(paren
id|master-&gt;compressor-&gt;decomp_alloc
)paren
(paren
dot
dot
...
(paren
id|KERN_DEBUG
l_string|&quot;ippp: initialize compressor&bslash;n&quot;
)paren
suffix:semicolon
)brace
)brace
...
(paren
id|KERN_ERR
l_string|&quot;No compressor set!&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|skb_in
...
multiline_comment|/*&n; * we received a CCP frame .. &n; * not a clean solution, but we SHOULD handle a few cased in the kernel&n; */
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_ppp_receive_cpp: %02x %02x %02x %02x %02x %02x %02x %02x&bslash;n&quot;
comma
id|skb-&gt;data
(braket
l_int|0
