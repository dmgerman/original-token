...
suffix:semicolon
multiline_comment|/* Just ripped from isdn_ppp_write. Dunno whether it makes sense,&n;&t;   especially dunno what the sav_skb stuff is good for. */
id|count
op_assign
id|skb-&gt;len
suffix:semicolon
...
(brace
macro_line|#ifndef CONFIG_ISDN_CCP
r_if
c_cond
(paren
id|proto
...
(paren
id|KERN_ERR
l_string|&quot;isdn_ppp: Ouch! Compression not included!&bslash;n&quot;
)paren
suffix:semicolon
id|dev_kfree_skb
c_func
...
id|skb_out
suffix:semicolon
macro_line|#ifdef CONFIG_ISDN_CCP
