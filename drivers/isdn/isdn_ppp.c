...
multiline_comment|/*&n;&t;&t; * search a free device &n;&t;&t; */
r_for
c_loop
(paren
id|i
...
id|ISDN_MAX_CHANNELS
suffix:semicolon
multiline_comment|/* trigger error */
)brace
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/*&n;         * kick the ipppd on the new device &n;         */
r_if
c_cond
(paren
id|ippp_table
...
(paren
id|KERN_DEBUG
l_string|&quot;ippp, open, minor: %d state: %04x&bslash;n&quot;
comma
id|minor
comma
id|ippp_table
...
multiline_comment|/*&n;         * VJ header compression init&n;         */
id|ippp_table
(braket
id|minor
)braket
...
suffix:semicolon
multiline_comment|/* lp-&gt;ppp_minor==-1 =&gt; no calling of isdn_ppp_closewait() */
id|ippp_table
(braket
id|minor
)braket
...
id|PPPIOCSINPSIG
suffix:colon
multiline_comment|/* obsolete: set input ready signal */
multiline_comment|/* usual: sig = SIGIO */
multiline_comment|/* we always deliver a SIGIO */
r_break
suffix:semicolon
macro_line|#endif
r_case
...
id|PPPIOCGTIME
suffix:colon
multiline_comment|/* read time delta information */
r_break
suffix:semicolon
macro_line|#endif
r_case
...
id|first
suffix:semicolon
multiline_comment|/* &n;&t;&t; * if IPPP_NOBLOCK is set we return even if we have nothing to read &n;&t;&t; */
r_if
c_cond
(paren
id|bf-&gt;next
...
(paren
id|KERN_WARNING
l_string|&quot;ippp: illegal minor.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_DEBUG
l_string|&quot;recv skb, len: %ld&bslash;n&quot;
comma
id|skb-&gt;len
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;isdn_ppp_receive, MP, detected overflow with sqno: %d, last: %d !!!&bslash;n&quot;
comma
id|sqno
comma
id|tseq
...
suffix:semicolon
multiline_comment|/*&n;                                 * check queue, whether we have still buffered the next packet(s)&n;                                 */
r_while
c_loop
(paren
(paren
...
(paren
id|KERN_DEBUG
l_string|&quot;push, skb %ld %04x&bslash;n&quot;
comma
id|skb-&gt;len
comma
id|proto
...
suffix:semicolon
id|net_dev-&gt;local.stats.rx_packets
op_increment
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;isdn, xmit: Packet blocked: %d %d&bslash;n&quot;
comma
id|lp-&gt;isdn_device
comma
id|lp-&gt;isdn_channel
...
suffix:semicolon
multiline_comment|/* ... else packet needs processing. */
multiline_comment|/* future: step to next &squot;lp&squot; when this lp is &squot;tbusy&squot; */
r_if
c_cond
(paren
id|ippp_table
...
(paren
id|KERN_DEBUG
l_string|&quot;xmit skb, len %ld&bslash;n&quot;
comma
id|skb-&gt;len
)paren
suffix:semicolon
...
(brace
multiline_comment|/* ipt or ipts ? -&gt; check this again! */
id|u_char
op_star
id|buf
op_assign
...
(paren
id|KERN_DEBUG
l_string|&quot;xmit2 skb, len %ld, proto %04x&bslash;n&quot;
comma
id|skb-&gt;len
comma
id|proto
...
(brace
multiline_comment|/* skb_push(skb, 3); Done in isdn_net_header() */
id|mp_seqno
op_and_assign
l_int|0xfff
suffix:semicolon
...
r_else
(brace
multiline_comment|/* skb_push(skb, 5); Done in isdn_net_header () */
id|skb-&gt;data
(braket
l_int|4
)braket
...
DECL|function|isdn_ppp_cleanup_queue
r_static
r_void
id|isdn_ppp_cleanup_queue
c_func
...
(brace
multiline_comment|/* interface locked? */
id|net_dev
op_assign
id|net_dev-&gt;next
suffix:semicolon
