...
suffix:semicolon
multiline_comment|/* lp-&gt;ppp_slot==-1 =&gt; no calling of isdn_ppp_closewait() */
id|is-&gt;lp
op_assign
l_int|NULL
suffix:semicolon
...
macro_line|#if 0 /* get_user() / put_user() in 2.1 replace them 1:1 */
...
DECL|function|isdn_ppp_skb_destructor
r_static
r_void
id|isdn_ppp_skb_destructor
c_func
(paren
r_struct
id|sk_buff
...
(paren
id|KERN_DEBUG
l_string|&quot;ippp_dstrct: %s&bslash;n&quot;
comma
id|outstr
)paren
suffix:semicolon
