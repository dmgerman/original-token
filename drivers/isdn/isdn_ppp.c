...
l_int|0
suffix:semicolon
multiline_comment|/* last link: free mpqueue, free sqqueue ? */
)brace
macro_line|#endif
id|isdn_ppp_hangup
c_func
...
suffix:semicolon
multiline_comment|/* &n;         * search a free device &n;         */
r_for
c_loop
(paren
id|i
...
(paren
id|KERN_DEBUG
l_string|&quot;find_minor, %d lp: %08lx&bslash;n&quot;
comma
id|i
comma
(paren
...
(brace
multiline_comment|/* find interface for our lp; */
r_if
c_cond
(paren
op_amp
...
(paren
id|KERN_ERR
l_string|&quot;isdn_ppp_release: Can&squot;t find device for net_local&bslash;n&quot;
)paren
suffix:semicolon
id|p
op_assign
...
suffix:semicolon
multiline_comment|/* lp-&gt;ppp_minor==-1 =&gt; no calling of isdn_ppp_hangup() */
id|ippp_table
(braket
id|minor
)braket
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_ppp_ioctl: minor: %d cmd: %x&quot;
comma
id|minor
comma
id|cmd
...
suffix:semicolon
multiline_comment|/* OK .. we are ready to send the first buffer */
)brace
id|ippp_table
(braket
id|minor
...
(paren
id|KERN_WARNING
l_string|&quot;ippp: err, no memory !!&bslash;n&quot;
)paren
suffix:semicolon
id|net_dev-&gt;ib.modify
op_assign
...
multiline_comment|/*&n; * send ppp frame .. we expect a PIDCOMPable proto -- &n; *  (here: currently always PPP_IP,PPP_VJC_COMP,PPP_VJC_UNCOMP)&n; */
...
(paren
id|KERN_DEBUG
l_string|&quot;xmit, skb %d %04x&bslash;n&quot;
comma
id|skb-&gt;len
comma
id|proto
