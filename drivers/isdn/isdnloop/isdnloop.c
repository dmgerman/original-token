multiline_comment|/* $Id: isdnloop.c,v 1.4 1998/02/24 21:39:05 he Exp $&n;&n; * ISDN low-level module implementing a dummy loop driver.&n; *&n; * Copyright 1997 by Fritz Elfert (fritz@wuemaus.franken.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: isdnloop.c,v $&n; * Revision 1.4  1998/02/24 21:39:05  he&n; * L2_PROT_X25DTE / DCE&n; * additional state 17 and new internal signal messages &quot;BCON_I&quot;&n; * (for reliable connect confirmation primitive as needed by x.25 upper layer)&n; * Changes for new LL-HL interface&n; *&n; * Revision 1.3  1998/02/20 17:33:30  fritz&n; * Changes for recent kernels.&n; *&n; * Revision 1.2  1997/10/01 09:22:03  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.1  1997/03/24 23:02:04  fritz&n; * Added isdnloop driver.&n; *&n; */
