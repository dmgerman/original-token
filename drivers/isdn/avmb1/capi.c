...
l_int|1
suffix:semicolon
multiline_comment|/* fall througth */
r_case
id|SEL_EX
suffix:colon
multiline_comment|/* error conditions ? */
id|select_wait
c_func
(paren
op_amp
...
id|SEL_OUT
suffix:colon
multiline_comment|/* &n;&t;&t;   if (!queue_full())&n;&t;&t;   return 1;&n;&t;&t;   select_wait(&amp;cdev-&gt;send_wait, wait);&n;&t;&t;   return 0;&n;&t;&t; */
r_return
l_int|1
suffix:semicolon
)brace
