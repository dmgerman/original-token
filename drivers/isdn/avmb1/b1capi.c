multiline_comment|/*&n; * $Id: b1capi.c,v 1.14 1999/04/15 19:49:29 calle Exp $&n; * &n; * CAPI 2.0 Module for AVM B1-card.&n; * &n; * (c) Copyright 1997 by Carsten Paeth (calle@calle.in-berlin.de)&n; * &n; * $Log: b1capi.c,v $&n; * Revision 1.14  1999/04/15 19:49:29  calle&n; * fix fuer die B1-PCI. Jetzt geht z.B. auch IRQ 17 ...&n; *&n; * Revision 1.13  1999/01/05 18:29:31  he&n; * merged remaining schedule_timeout() changes from 2.1.127&n; *&n; * Revision 1.12  1998/10/25 14:38:58  fritz&n; * Backported from MIPS (Cobalt).&n; *&n; * Revision 1.11  1998/03/29 16:05:58  calle&n; * changes from 2.0 tree merged.&n; *&n; * Revision 1.4.2.18  1998/03/20 20:34:37  calle&n; * port valid check now only for T1, because of the PCI and PCMCIA cards.&n; *&n; * Revision 1.4.2.17  1998/03/20 14:38:17  calle&n; * capidrv: prepared state machines for suspend/resume/hold&n; * capidrv: fix bug in state machine if B1/T1 is out of nccis&n; * b1capi: changed some errno returns.&n; * b1capi: detect if you try to add same T1 to different io address.&n; * b1capi: change number of nccis depending on number of channels.&n; * b1lli: cosmetics&n; *&n; * Revision 1.4.2.16  1998/03/20 09:01:08  calle&n; * Changes capi_register handling to get full support for 30 bchannels.&n; *&n; * Revision 1.4.2.15  1998/03/18 17:43:26  calle&n; * T1 with fastlink, bugfix for multicontroller support in capidrv.c&n; *&n; * Revision 1.4.2.14  1998/03/04 17:33:47  calle&n; * Changes for T1.&n; *&n; * Revision 1.4.2.13  1998/02/27 15:40:41  calle&n; * T1 running with slow link. bugfix in capi_release.&n; *&n; * Revision 1.4.2.12  1998/02/24 17:58:25  calle&n; * changes for T1.&n; *&n; * Revision 1.10  1998/02/13 07:09:10  calle&n; * change for 2.1.86 (removing FREE_READ/FREE_WRITE from [dev]_kfree_skb()&n; *&n; * Revision 1.9  1998/01/31 11:14:39  calle&n; * merged changes to 2.0 tree, prepare 2.1.82 to work.&n; *&n; * Revision 1.8  1997/12/10 20:00:46  calle&n; * get changes from 2.0 version&n; *&n; * Revision 1.4.2.5  1997/12/07 19:59:54  calle&n; * more changes for M1/T1/B1 + config&n; *&n; * Revision 1.4.2.4  1997/11/26 16:57:20  calle&n; * more changes for B1/M1/T1.&n; *&n; * Revision 1.7  1997/10/19 14:45:40  calle&n; * fixed capi_get_version.&n; *&n; * Revision 1.6  1997/10/01 09:21:09  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.5  1997/07/12 08:22:26  calle&n; * Correct bug in CARD_NR macro, so now more than one card will work.&n; * Allow card reset, even if card is in running state.&n; *&n; *&n; * Revision 1.4  1997/05/27 15:17:45  fritz&n; * Added changes for recent 2.1.x kernels:&n; *   changed return type of isdn_close&n; *   queue_task_* -&gt; queue_task&n; *   clear/set_bit -&gt; test_and_... where apropriate.&n; *   changed type of hard_header_cache parameter.&n; *&n; * Revision 1.3  1997/05/18 09:24:09  calle&n; * added verbose disconnect reason reporting to avmb1.&n; * some fixes in capi20 interface.&n; * changed info messages for B1-PCI&n; *&n; * Revision 1.2  1997/03/05 21:20:41  fritz&n; * Removed include of config.h (mkdep stated this is unneded).&n; *&n; * Revision 1.1  1997/03/04 21:50:27  calle&n; * Frirst version in isdn4linux&n; *&n; * Revision 2.2  1997/02/12 09:31:39  calle&n; * new version&n; *&n; * Revision 1.1  1997/01/31 10:32:20  calle&n; * Initial revision&n; *&n; * &n; */
...
(paren
id|KERN_WARNING
l_string|&quot;b1capi: port 0x%x not valid for %s-card.&bslash;n&quot;
comma
id|port
comma
id|cardtype2str
...
(paren
id|KERN_ERR
l_string|&quot;b1capi: T1-HEMA-card-%d already at 0x%x&bslash;n&quot;
comma
id|cdef.cardnr
comma
id|cards
...
(paren
id|KERN_NOTICE
l_string|&quot;b1capi: NO T1-HEMA-card-%d at 0x%x (%d)&bslash;n&quot;
comma
id|cdef.cardnr
comma
id|cdef.port
...
(paren
id|KERN_NOTICE
l_string|&quot;b1capi: T1-HEMA-card-%d at 0x%x&bslash;n&quot;
comma
id|cdef.cardnr
comma
id|cdef.port
...
id|rc
suffix:semicolon
multiline_comment|/* don&squot;t want to change interface t&n;&t;&t;   addcard/probecard/registercard */
r_if
c_cond
(paren
id|cdef.cardtype
...
(paren
id|KERN_DEBUG
l_string|&quot;b1capi: loading contr %d&bslash;n&quot;
comma
id|ldef.contr
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;b1capi: %s attached&bslash;n&quot;
comma
id|userp-&gt;name
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;b1capi: %s detached&bslash;n&quot;
comma
id|userp-&gt;name
)paren
suffix:semicolon
