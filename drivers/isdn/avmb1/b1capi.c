multiline_comment|/*&n; * $Id: b1capi.c,v 1.4 1997/05/27 15:17:45 fritz Exp $&n; * &n; * CAPI 2.0 Module for AVM B1-card.&n; * &n; * (c) Copyright 1997 by Carsten Paeth (calle@calle.in-berlin.de)&n; * &n; * $Log: b1capi.c,v $&n; * Revision 1.4  1997/05/27 15:17:45  fritz&n; * Added changes for recent 2.1.x kernels:&n; *   changed return type of isdn_close&n; *   queue_task_* -&gt; queue_task&n; *   clear/set_bit -&gt; test_and_... where apropriate.&n; *   changed type of hard_header_cache parameter.&n; *&n; * Revision 1.3  1997/05/18 09:24:09  calle&n; * added verbose disconnect reason reporting to avmb1.&n; * some fixes in capi20 interface.&n; * changed info messages for B1-PCI&n; *&n; * Revision 1.2  1997/03/05 21:20:41  fritz&n; * Removed include of config.h (mkdep stated this is unneded).&n; *&n; * Revision 1.1  1997/03/04 21:50:27  calle&n; * Frirst version in isdn4linux&n; *&n; * Revision 2.2  1997/02/12 09:31:39  calle&n; * new version&n; *&n; * Revision 1.1  1997/01/31 10:32:20  calle&n; * Initial revision&n; *&n; * &n; */
...
mdefine_line|#define VALID_CARD(c)&t;   ((c) &gt; 0 &amp;&amp; (c) &lt;= ncards)
DECL|macro|CARD
mdefine_line|#define CARD(c)&t;&t;   (&amp;cards[(c)-1])
DECL|macro|CARDNR
mdefine_line|#define CARDNR(cp)&t;   ((cards-(cp))+1)
...
(paren
id|KERN_WARNING
l_string|&quot;b1capi: irq %d not valid.&bslash;n&quot;
comma
id|irq
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;b1capi: NO card at 0x%x (%d)&bslash;n&quot;
comma
id|port
comma
id|rc
...
(paren
id|KERN_NOTICE
l_string|&quot;b1capi: AVM-B1-Controller detected at 0x%x&bslash;n&quot;
comma
id|port
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;b1capi: load: invalid parameter contr=%d len=%d&bslash;n&quot;
comma
id|ldef.contr
comma
id|ldef.t4file.len
...
(brace
multiline_comment|/*&n;&t;&t; * disable card&n;&t;&t; */
id|B1_disable_irq
c_func
(paren
id|cards
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * free kernel resources&n;&t;&t; */
id|free_irq
c_func
(paren
id|cards
