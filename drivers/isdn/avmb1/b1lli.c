multiline_comment|/*&n; * $Id: b1lli.c,v 1.1 1997/03/04 21:50:28 calle Exp $&n; * &n; * ISDN lowlevel-module for AVM B1-card.&n; * &n; * (c) Copyright 1997 by Carsten Paeth (calle@calle.in-berlin.de)&n; * &n; * $Log: b1lli.c,v $&n; * Revision 1.1  1997/03/04 21:50:28  calle&n; * Frirst version in isdn4linux&n; *&n; * Revision 2.2  1997/02/12 09:31:39  calle&n; * new version&n; *&n; * Revision 1.1  1997/01/31 10:32:20  calle&n; * Initial revision&n; *&n; * &n; */
...
(paren
id|KERN_INFO
l_string|&quot;b1lli: %s-card (%s) with %s now active&bslash;n&quot;
comma
id|card-&gt;version
(braket
id|VER_CARDTYPE
