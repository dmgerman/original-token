...
id|dlev
comma
l_string|&quot;idi_hdl: Ch%d: Ind=%d Id=%x Ch=%d MInd=%d MLen=%d Len=%d&bslash;n&quot;
comma
id|chan-&gt;No
comma
id|ind-&gt;Ind
...
(brace
multiline_comment|/* I dont know why this happens, just ignoring this RC */
id|eicon_log
c_func
(paren
id|ccard
