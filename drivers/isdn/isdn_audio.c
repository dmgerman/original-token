multiline_comment|/* $Id: isdn_audio.c,v 1.17 1999/08/17 11:10:52 paul Exp $&n;&n; * Linux ISDN subsystem, audio conversion and compression (linklevel).&n; *&n; * Copyright 1994-1999 by Fritz Elfert (fritz@isdn4linux.de)&n; * DTMF code (c) 1996 by Christian Mock (cm@kukuruz.ping.at)&n; * Silence detection (c) 1998 by Armin Schindler (mac@gismo.telekom.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: isdn_audio.c,v $&n; * Revision 1.17  1999/08/17 11:10:52  paul&n; * don&squot;t try to use x86 assembler on non-x86!&n; *&n; * Revision 1.16  1999/08/06 12:47:35  calle&n; * Using __GNUC__ == 2 &amp;&amp; __GNUC_MINOR__ &lt; 95 how to define&n; *   ISDN_AUDIO_OPTIMIZE_ON_X386_WITH_ASM_IF_GCC_ALLOW_IT&n; *&n; * Revision 1.15  1999/08/06 12:02:52  calle&n; * egcs 2.95 complain about invalid asm statement:&n; *    &quot;fixed or forbidden register 2 (cx) was spilled for class CREG.&quot;&n; * Using ISDN_AUDIO_OPTIMIZE_ON_X386_WITH_ASM_IF_GCC_ALLOW_IT and not&n; * define it at the moment.&n; *&n; * Revision 1.14  1999/07/11 17:14:06  armin&n; * Added new layer 2 and 3 protocols for Fax and DSP functions.&n; * Moved &quot;Add CPN to RING message&quot; to new register S23,&n; * &quot;Display message&quot; is now correct on register S13 bit 7.&n; * New audio command AT+VDD implemented (deactivate DTMF decoder and&n; * activate possible existing hardware/DSP decoder).&n; * Moved some tty defines to .h file.&n; * Made whitespace possible in AT command line.&n; * Some AT-emulator output bugfixes.&n; * First Fax G3 implementations.&n; *&n; * Revision 1.13  1999/04/12 12:33:09  fritz&n; * Changes from 2.0 tree.&n; *&n; * Revision 1.12  1998/07/26 18:48:43  armin&n; * Added silence detection in voice receive mode.&n; *&n; * Revision 1.11  1998/04/10 10:35:10  paul&n; * fixed (silly?) warnings from egcs on Alpha.&n; *&n; * Revision 1.10  1998/02/20 17:09:40  fritz&n; * Changes for recent kernels.&n; *&n; * Revision 1.9  1997/10/01 09:20:25  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.8  1997/03/02 14:29:16  fritz&n; * More ttyI related cleanup.&n; *&n; * Revision 1.7  1997/02/03 22:44:11  fritz&n; * Reformatted according CodingStyle&n; *&n; * Revision 1.6  1996/06/06 14:43:31  fritz&n; * Changed to support DTMF decoding on audio playback also.&n; *&n; * Revision 1.5  1996/06/05 02:24:08  fritz&n; * Added DTMF decoder for audio mode.&n; *&n; * Revision 1.4  1996/05/17 03:48:01  fritz&n; * Removed some test statements.&n; * Added revision string.&n; *&n; * Revision 1.3  1996/05/10 08:48:11  fritz&n; * Corrected adpcm bugs.&n; *&n; * Revision 1.2  1996/04/30 09:31:17  fritz&n; * General rewrite.&n; *&n; * Revision 1.1.1.1  1996/04/28 12:25:40  fritz&n; * Taken under CVS control&n; *&n; */
...
mdefine_line|#define DTMF_TRESH    50000     /* above this is dtmf                         */
DECL|macro|SILENCE_TRESH
mdefine_line|#define SILENCE_TRESH   100     /* below this is silence                      */
DECL|macro|H2_TRESH
mdefine_line|#define H2_TRESH      10000     /* 2nd harmonic                               */
DECL|macro|AMP_BITS
