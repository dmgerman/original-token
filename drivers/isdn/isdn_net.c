multiline_comment|/* $Id: isdn_net.c,v 1.4 1996/02/19 15:23:38 fritz Exp fritz $&n; *&n; * Linux ISDN subsystem, network interfaces and related functions (linklevel).&n; *&n; * Copyright 1994,95,96 by Fritz Elfert (fritz@wuemaus.franken.de)&n; * Copyright 1995,96    by Thinking Objects Software GmbH Wuerzburg&n; * Copyright 1995,96    by Michael Hipp (Michael.Hipp@student.uni-tuebingen.de)&n; * &n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA. &n; *&n; * $Log: isdn_net.c,v $&n; * Revision 1.4  1996/02/19 15:23:38  fritz&n; * Bugfix: Sync-PPP packets got compressed twice, when resent due to&n; *         send-queue-full reject.&n; *&n; * Revision 1.3  1996/02/11 02:22:28  fritz&n; * Changed status- receive-callbacks to use pointer-arrays for finding&n; * a corresponding interface instead of looping over all interfaces.&n; * Activate Auto-hangup-timer only when interface is online.&n; * Some bugfixes in the dialing-statemachine.&n; * Lot of bugfixes in sk_buff&squot;ized encapsulation handling.&n; * For speedup connection-setup after dialing, remember sk_buf that triggered&n; * dialing.&n; * Fixed isdn_net_log_packet according to different encapsulations.&n; * Correct ARP-handling for ETHERNET-encapsulation.&n; *&n; * Revision 1.2  1996/01/22 05:05:12  fritz&n; * Changed returncode-logic for isdn_net_start_xmit() and it&squot;s&n; * helper-functions.&n; * Changed handling of buildheader for RAWIP and ETHERNET-encapsulation.&n; *&n; * Revision 1.1  1996/01/09 04:12:34  fritz&n; * Initial revision&n; *&n; */
...
multiline_comment|/*&n; * Handle status-messages from ISDN-interfacecard.&n; * This function is called from within the main-status-dispatcher&n; * isdn_status_callback, which itself is called from the lowlevel-driver.&n; * Return: 1 = Event handled, 0 = not for us or unknown Event.&n; */
r_int
...
suffix:semicolon
multiline_comment|/* If first Chargeinfo comes before B-Channel connect,&n;&t;&t;&t;&t;&t; * we correct the timestamp here.&n;&t;&t;&t;&t;&t; */
id|lp-&gt;chargetime
op_assign
id|jiffies
suffix:semicolon
...
l_int|4
suffix:colon
multiline_comment|/* Wait for D-Channel-connect or incoming call, if passive&n;&t;&t;&t; * callback configured. If timeout and max retries not&n;&t;&t;&t; * reached, switch back to state 3.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|p-&gt;local.dtimer
...
multiline_comment|/*&n; * Send-data-helpfunction for net-interfaces&n; */
r_int
DECL|function|isdn_net_send
id|isdn_net_send
c_func
(paren
id|u_char
...
l_int|1
suffix:semicolon
multiline_comment|/* Device driver queue full (or packet &gt; 4000 bytes, should never&n;&t; * happen)&n;&t; */
r_if
c_cond
(paren
id|l
...
(paren
id|KERN_ERR
l_string|&quot;isdn_net: Huh, sending pkt too big!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(paren
id|KERN_WARNING
l_string|&quot;isdn_net: No phone number for %s, packet dropped&bslash;n&quot;
comma
id|ndev-&gt;name
)paren
suffix:semicolon
...
id|ISDN_NET_ENCAP_SYNCPPP
suffix:colon
multiline_comment|/* reserve space to be filled in isdn_ppp_xmit */
id|len
op_assign
l_int|4
suffix:semicolon
...
macro_line|#endif
multiline_comment|/* Initialize first 4 bytes to a value, which is&n;                         * guaranteed to be invalid. Need that to check&n;                         * for already compressed packets in isdn_ppp_xmit().&n;                         */
op_star
(paren
(paren
r_int
...
(paren
id|KERN_WARNING
l_string|&quot;isdn_net_rebuild_header: Don&squot;t know how to resolve type %d addresses?&bslash;n&quot;
comma
(paren
r_int
)paren
...
multiline_comment|/*&n;                 *      Try and get ARP to resolve the header.&n;                 */
...
macro_line|#endif
multiline_comment|/* Initiate dialing by returning 2 */
id|restore_flags
c_func
(paren
id|flags
...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* why is this a CONFIG_ISDN_PPP feature ??? */
macro_line|#ifdef CONFIG_ISDN_PPP
r_if
c_cond
(paren
...
multiline_comment|/*&n; * Allocate a new network-interface and initialize it&squot;s data structures.&n; */
r_char
op_star
...
multiline_comment|/* The following should be configurable via ioctl */
