...
suffix:semicolon
macro_line|#if (defined CONFIG_ISDN_PPP ) &amp;&amp; (defined ISDN_CONFIG_MPP)
r_if
c_cond
(paren
id|tf
...
(brace
multiline_comment|/* if midx is invalid, drop packet */
id|isdn_trash_skb
c_func
(paren
id|skb
...
multiline_comment|/* The users field of an sk_buff is used in a special way&n;                 * with tty&squot;s incoming data:&n;                 *   users is set to the number of DLE codes when in audio mode.&n;                 */
id|skb-&gt;users
op_assign
l_int|0
suffix:semicolon
...
l_int|4
suffix:colon
multiline_comment|/* adpcm&n;                                         * Since compressed data takes less&n;                                         * space, we can overwrite the buffer.&n;                                         */
id|skb_trim
c_func
(paren
id|skb
...
multiline_comment|/* Direct deliver failed or queue wasn&squot;t empty.&n;                 * Queue up for later dequeueing via timer-irq.&n;                 */
id|__skb_queue_tail
c_func
(paren
op_amp
...
l_int|0
suffix:colon
multiline_comment|/* No network-device replies. Schedule RING-message to&n;                                         * tty and set RI-bit of modem-status.&n;                                         */
r_if
c_cond
(paren
(paren
...
(paren
id|KERN_INFO
l_string|&quot;isdn: cause: %s&bslash;n&quot;
comma
id|c-&gt;num
)paren
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* Find any network-device, waiting for D-channel setup */
r_if
c_cond
(paren
id|isdn_net_stat_callback
...
(brace
multiline_comment|/* If any tty has just dialed-out, setup B-Channel */
id|info
op_assign
op_amp
id|dev-&gt;mdm.info
...
(brace
multiline_comment|/* Signal hangup to tty-device */
id|info
op_assign
op_amp
id|dev-&gt;mdm.info
...
(brace
multiline_comment|/* Signal hangup to tty-device, schedule NO CARRIER-message */
id|info
op_assign
op_amp
id|dev-&gt;mdm.info
...
(brace
multiline_comment|/* users is the count of DLE&squot;s in&n;                         * this buff when in voice mode.&n;                         */
r_char
op_star
id|p
op_assign
...
(brace
multiline_comment|/* We got all the data in this buff.&n;                         * Now we can dequeue it.&n;                         */
r_if
c_cond
(paren
id|fp
...
r_else
(brace
multiline_comment|/* Not yet emptied this buff, so it&n;                         * must stay in the queue, for further calls&n;                         * but we pull off the data we got until now.&n;                         */
id|skb_pull
c_func
(paren
id|skb
...
r_break
suffix:semicolon
macro_line|#endif&t;&t;&t;&t;/* CONFIG_NETDEVICES */
r_case
id|IIOCSETVER
suffix:colon
id|dev-&gt;net_verbose
...
id|IIOCGETSET
suffix:colon
multiline_comment|/* Get complete setup (all network-interfaces and profile-&n;                                   settings of all tty-devices */
r_if
c_cond
(paren
id|arg
...
id|IIOCSETSET
suffix:colon
multiline_comment|/* Set complete setup (all network-interfaces and profile-&n;                                   settings of all tty-devices */
r_if
c_cond
(paren
id|arg
...
macro_line|#endif&t;&t;&t;&t;/* CONFIG_ISDN_PPP */
r_if
c_cond
(paren
op_logical_neg
