...
multiline_comment|/* &n; * This accesses user space with interrupts off, but is not needed by&n; * any of the isdn4k-util programs anyway. Thus, in contrast to your&n; * first impression after looking at the code, fixing is trival!*/
macro_line|#if 0 
r_static
r_int
id|isdn_set_allcfg
