...
multiline_comment|/*&n; * isdn_readbchan() tries to get data from the read-queue.&n; * It MUST be called with interrupts off.&n; *  &n; * I hope I got the EFAULT error path right -AK.&n; */
