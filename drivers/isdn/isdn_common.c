multiline_comment|/* $Id: isdn_common.c,v 1.101 2000/04/07 14:50:34 calle Exp $&n;&n; * Linux ISDN subsystem, common used functions (linklevel).&n; *&n; * Copyright 1994-1999  by Fritz Elfert (fritz@isdn4linux.de)&n; * Copyright 1995,96    Thinking Objects Software GmbH Wuerzburg&n; * Copyright 1995,96    by Michael Hipp (Michael.Hipp@student.uni-tuebingen.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: isdn_common.c,v $&n; * Revision 1.101  2000/04/07 14:50:34  calle&n; * Bugfix: on my system 2.3.99-pre3 Dual PII 350, unload of module isdn.o&n; *         hangs if vfree is called with interrupt disabled. After moving&n; * &t;restore_flags in front of vfree it doesn&squot;t hang.&n; *&n; * Revision 1.100  2000/03/03 16:37:11  kai&n; * incorporated some cosmetic changes from the official kernel tree back&n; * into CVS&n; *&n; * Revision 1.99  2000/02/26 01:00:52  keil&n; * changes from 2.3.47&n; *&n; * Revision 1.98  2000/02/16 14:56:27  paul&n; * translated ISDN_MODEM_ANZREG to ISDN_MODEM_NUMREG for english speakers&n; *&n; * Revision 1.97  2000/01/23 18:45:37  keil&n; * Change EAZ mapping to forbit the use of cards (insert a &quot;-&quot; for the MSN)&n; *&n; * Revision 1.96  2000/01/20 19:55:33  keil&n; * Add FAX Class 1 support&n; *&n; * Revision 1.95  2000/01/09 20:43:13  detabc&n; * exand logical bind-group&squot;s for both call&squot;s (in and out).&n; * add first part of kernel-config-help for abc-extension.&n; *&n; * Revision 1.94  1999/11/20 22:14:13  detabc&n; * added channel dial-skip in case of external use&n; * (isdn phone or another isdn device) on the same NTBA.&n; * usefull with two or more card&squot;s connected the different NTBA&squot;s.&n; * global switchable in kernel-config and also per netinterface.&n; *&n; * add auto disable of netinterface&squot;s in case of:&n; * &t;to many connection&squot;s in short time.&n; * &t;config mistakes (wrong encapsulation, B2-protokoll or so on) on local&n; * &t;or remote side.&n; * &t;wrong password&squot;s or something else to a ISP (syncppp).&n; *&n; * possible encapsulations for this future are:&n; * ISDN_NET_ENCAP_SYNCPPP, ISDN_NET_ENCAP_UIHDLC, ISDN_NET_ENCAP_RAWIP,&n; * and ISDN_NET_ENCAP_CISCOHDLCK.&n; *&n; * Revision 1.93  1999/11/04 13:11:36  keil&n; * Reinit of v110 structs&n; *&n; * Revision 1.92  1999/10/31 15:59:50  he&n; * more skb headroom checks&n; *&n; * Revision 1.91  1999/10/28 22:48:45  armin&n; * Bugfix: isdn_free_channel() now frees the channel,&n; * even when the usage of the ttyI has changed.&n; *&n; * Revision 1.90  1999/10/27 21:21:17  detabc&n; * Added support for building logically-bind-group&squot;s per interface.&n; * usefull for outgoing call&squot;s with more then one isdn-card.&n; *&n; * Switchable support to dont reset the hangup-timeout for&n; * receive frames. Most part&squot;s of the timru-rules for receiving frames&n; * are now obsolete. If the input- or forwarding-firewall deny&n; * the frame, the line will be not hold open.&n; *&n; * Revision 1.89  1999/10/16 14:46:47  keil&n; * replace kmalloc with vmalloc for the big dev struct&n; *&n; * Revision 1.88  1999/10/02 00:39:26  he&n; * Fixed a 2.3.x wait queue initialization (was causing panics)&n; *&n; * Revision 1.87  1999/09/12 16:19:39  detabc&n; * added abc features&n; * low cost routing for net-interfaces (only the HL side).&n; * need more implementation in the isdnlog-utility&n; * udp info support (first part).&n; * different EAZ on outgoing call&squot;s.&n; * more checks on D-Channel callbacks (double use of channels).&n; * tested and running with kernel 2.3.17&n; *&n; * Revision 1.86  1999/07/31 12:59:42  armin&n; * Added tty fax capabilities.&n; *&n; * Revision 1.85  1999/07/29 16:58:35  armin&n; * Bugfix: DLE handling in isdn_readbchan()&n; *&n; * Revision 1.84  1999/07/25 16:21:10  keil&n; * fix number matching&n; *&n; * Revision 1.83  1999/07/13 21:02:05  werner&n; * Added limit possibilty of driver b_channel resources (ISDN_STAT_DISCH)&n; *&n; * Revision 1.82  1999/07/12 21:06:50  werner&n; * Fixed problem when loading more than one driver temporary&n; *&n; * Revision 1.81  1999/07/11 17:14:09  armin&n; * Added new layer 2 and 3 protocols for Fax and DSP functions.&n; * Moved &quot;Add CPN to RING message&quot; to new register S23,&n; * &quot;Display message&quot; is now correct on register S13 bit 7.&n; * New audio command AT+VDD implemented (deactivate DTMF decoder and&n; * activate possible existing hardware/DSP decoder).&n; * Moved some tty defines to .h file.&n; * Made whitespace possible in AT command line.&n; * Some AT-emulator output bugfixes.&n; * First Fax G3 implementations.&n; *&n; * Revision 1.80  1999/07/07 10:14:00  detabc&n; * remove unused messages&n; *&n; * Revision 1.79  1999/07/05 23:51:30  werner&n; * Allow limiting of available HiSax B-chans per card. Controlled by hisaxctrl&n; * hisaxctrl id 10 &lt;nr. of chans 0-2&gt;&n; *&n; * Revision 1.78  1999/07/05 20:21:15  werner&n; * changes to use diversion sources for all kernel versions.&n; * removed static device, only proc filesystem used&n; *&n; * Revision 1.77  1999/07/01 08:29:50  keil&n; * compatibility to 2.3 kernel&n; *&n; * Revision 1.76  1999/06/29 16:16:44  calle&n; * Let ISDN_CMD_UNLOAD work with open isdn devices without crash again.&n; * Also right unlocking (ISDN_CMD_UNLOCK) is done now.&n; * isdnlog should check returncode of read(2) calls.&n; *&n; * Revision 1.75  1999/04/18 14:06:47  fritz&n; * Removed TIMRU stuff.&n; *&n; * Revision 1.74  1999/04/12 13:16:45  fritz&n; * Changes from 2.0 tree.&n; *&n; * Revision 1.73  1999/04/12 12:33:15  fritz&n; * Changes from 2.0 tree.&n; *&n; * Revision 1.72  1999/03/02 12:04:44  armin&n; * -added ISDN_STAT_ADDCH to increase supported channels after&n; *  register_isdn().&n; * -ttyI now goes on-hook on ATZ when B-Ch is connected.&n; * -added timer-function for register S7 (Wait for Carrier).&n; * -analog modem (ISDN_PROTO_L2_MODEM) implementations.&n; * -on L2_MODEM a string will be appended to the CONNECT-Message,&n; *  which is provided by the HL-Driver in parm.num in ISDN_STAT_BCONN.&n; * -variable &quot;dialing&quot; used for ATA also, for interrupting call&n; *  establishment and register S7.&n; *&n; * Revision 1.71  1999/01/28 09:10:43  armin&n; * Fixed bad while-loop in isdn_readbch().&n; *&n; * Revision 1.70  1999/01/15 19:58:54  he&n; * removed compatibiltity macro&n; *&n; * Revision 1.69  1998/09/07 21:59:58  he&n; * flush method for 2.1.118 and above&n; * updated IIOCTLNETGPN&n; *&n; * Revision 1.68  1998/08/31 21:09:45  he&n; * new ioctl IIOCNETGPN for /dev/isdninfo (get network interface&squot;&n; *     peer phone number)&n; *&n; * Revision 1.67  1998/06/26 15:12:21  fritz&n; * Added handling of STAT_ICALL with incomplete CPN.&n; * Added AT&amp;L for ttyI emulator.&n; * Added more locking stuff in tty_write.&n; *&n; * Revision 1.66  1998/06/17 19:50:41  he&n; * merged with 2.1.10[34] (cosmetics and udelay() -&gt; mdelay())&n; * brute force fix to avoid Ugh&squot;s in isdn_tty_write()&n; * cleaned up some dead code&n; *&n; *&n; * Revision 1.62  1998/04/14 16:28:43  he&n; * Fixed user space access with interrupts off and remaining&n; * copy_{to,from}_user() -&gt; -EFAULT return codes&n; *&n; * Revision 1.61  1998/03/22 18:50:46  hipp&n; * Added BSD Compression for syncPPP .. UNTESTED at the moment&n; *&n; * Revision 1.60  1998/03/19 13:18:18  keil&n; * Start of a CAPI like interface for supplementary Service&n; * first service: SUSPEND&n; *&n; * Revision 1.59  1998/03/09 17:46:23  he&n; * merged in 2.1.89 changes&n; *&n; * Revision 1.58  1998/03/07 22:35:24  fritz&n; * Starting generic module support (Nothing usable yet).&n; *&n; * Revision 1.57  1998/03/07 18:21:01  cal&n; * Dynamic Timeout-Rule-Handling vs. 971110 included&n; *&n; * Revision 1.56  1998/02/25 17:49:38  he&n; * Changed return codes caused be failing copy_{to,from}_user to -EFAULT&n; *&n; * Revision 1.55  1998/02/23 23:35:32  fritz&n; * Eliminated some compiler warnings.&n; *&n; * Revision 1.54  1998/02/22 19:44:19  fritz&n; * Bugfixes and improvements regarding V.110, V.110 now running.&n; *&n; * Revision 1.53  1998/02/20 17:18:05  fritz&n; * Changes for recent kernels.&n; * Added common stub for sending commands to lowlevel.&n; * Added V.110.&n; *&n; * Revision 1.52  1998/01/31 22:05:57  keil&n; * Lots of changes for X.25 support:&n; * Added generic support for connection-controlling encapsulation protocols&n; * Added support of BHUP status message&n; * Added support for additional p_encap X25IFACE&n; * Added support for kernels &gt;= 2.1.72&n; *&n; * Revision 1.51  1998/01/31 19:17:29  calle&n; * merged changes from and for 2.1.82&n; *&n; * Revision 1.50  1997/12/12 06:12:11  calle&n; * moved EXPORT_SYMBOL(register_isdn) from isdn_syms.c to isdn_common.c&n; *&n; * Revision 1.49  1997/11/06 17:16:52  keil&n; * Sync to 2.1.62 changes&n; *&n; * Revision 1.48  1997/11/02 23:55:50  keil&n; * Andi Kleen&squot;s changes for 2.1.60&n; * without it the isdninfo and isdnctrl devices won&squot;t work&n; *&n; * Revision 1.47  1997/10/09 21:28:46  fritz&n; * New HL&lt;-&gt;LL interface:&n; *   New BSENT callback with nr. of bytes included.&n; *   Sending without ACK.&n; *   New L1 error status (not yet in use).&n; *   Cleaned up obsolete structures.&n; * Implemented Cisco-SLARP.&n; * Changed local net-interface data to be dynamically allocated.&n; * Removed old 2.0 compatibility stuff.&n; *&n; * Revision 1.46  1997/10/01 09:20:27  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.45  1997/08/21 23:11:41  fritz&n; * Added changes for kernels &gt;= 2.1.45&n; *&n; * Revision 1.44  1997/05/27 15:17:23  fritz&n; * Added changes for recent 2.1.x kernels:&n; *   changed return type of isdn_close&n; *   queue_task_* -&gt; queue_task&n; *   clear/set_bit -&gt; test_and_... where apropriate.&n; *   changed type of hard_header_cache parameter.&n; *&n; * Revision 1.43  1997/03/31 14:09:43  fritz&n; * Fixed memory leak in isdn_close().&n; *&n; * Revision 1.42  1997/03/30 16:51:08  calle&n; * changed calls to copy_from_user/copy_to_user and removed verify_area&n; * were possible.&n; *&n; * Revision 1.41  1997/03/24 22:54:41  fritz&n; * Some small fixes in debug code.&n; *&n; * Revision 1.40  1997/03/08 08:13:51  fritz&n; * Bugfix: IIOCSETMAP (Set mapping) was broken.&n; *&n; * Revision 1.39  1997/03/07 01:32:54  fritz&n; * Added proper ifdef&squot;s for CONFIG_ISDN_AUDIO&n; *&n; * Revision 1.38  1997/03/05 21:15:02  fritz&n; * Fix: reduced stack usage of isdn_ioctl() and isdn_set_allcfg()&n; *&n; * Revision 1.37  1997/03/02 14:29:18  fritz&n; * More ttyI related cleanup.&n; *&n; * Revision 1.36  1997/02/28 02:32:40  fritz&n; * Cleanup: Moved some tty related stuff from isdn_common.c&n; *          to isdn_tty.c&n; * Bugfix:  Bisync protocol did not behave like documented.&n; *&n; * Revision 1.35  1997/02/21 13:01:19  fritz&n; * Changes CAUSE message output in kernel log.&n; *&n; * Revision 1.34  1997/02/10 20:12:43  fritz&n; * Changed interface for reporting incoming calls.&n; *&n; * Revision 1.33  1997/02/10 10:05:42  fritz&n; * More changes for Kernel 2.1.X&n; * Symbol information moved to isdn_syms.c&n; *&n; * Revision 1.32  1997/02/03 22:55:26  fritz&n; * Reformatted according CodingStyle.&n; * Changed isdn_writebuf_stub static.&n; * Slow down tty-RING counter.&n; * skb-&gt;free stuff replaced by macro.&n; * Bugfix in audio-skb locking.&n; * Bugfix in HL-driver locking.&n; *&n; * Revision 1.31  1997/01/17 01:19:18  fritz&n; * Applied chargeint patch.&n; *&n; * Revision 1.30  1997/01/14 01:27:47  fritz&n; * Changed audio receive not to rely on skb-&gt;users and skb-&gt;lock.&n; * Added ATI2 and related variables.&n; * Started adding full-duplex audio capability.&n; *&n; * Revision 1.29  1997/01/12 23:33:03  fritz&n; * Made isdn_all_eaz foolproof.&n; *&n; * Revision 1.28  1996/11/13 02:33:19  fritz&n; * Fixed a race condition.&n; *&n; * Revision 1.27  1996/10/27 22:02:41  keil&n; * return codes for ISDN_STAT_ICALL&n; *&n; * Revision 1.26  1996/10/23 11:59:40  fritz&n; * More compatibility changes.&n; *&n; * Revision 1.25  1996/10/22 23:13:54  fritz&n; * Changes for compatibility to 2.0.X and 2.1.X kernels.&n; *&n; * Revision 1.24  1996/10/11 14:02:03  fritz&n; * Bugfix: call to isdn_ppp_timer_timeout() never compiled, because of&n; *         typo in #ifdef.&n; *&n; * Revision 1.23  1996/06/25 18:35:38  fritz&n; * Fixed bogus memory access in isdn_set_allcfg().&n; *&n; * Revision 1.22  1996/06/24 17:37:37  fritz&n; * Bugfix: isdn_timer_ctrl() did restart timer, even if it&n; *         was already running.&n; *         lowlevel driver locking did use wrong parameters.&n; *&n; * Revision 1.21  1996/06/15 14:58:20  fritz&n; * Added version signatures for data structures used&n; * by userlevel programs.&n; *&n; * Revision 1.20  1996/06/12 16:01:49  fritz&n; * Bugfix: Remote B-channel hangup sometimes did not result&n; *         in a NO CARRIER on tty.&n; *&n; * Revision 1.19  1996/06/11 14:52:04  hipp&n; * minor bugfix in isdn_writebuf_skb_stub()&n; *&n; * Revision 1.18  1996/06/06 14:51:51  fritz&n; * Changed to support DTMF decoding on audio playback also.&n; *&n; * Revision 1.17  1996/06/05 02:24:10  fritz&n; * Added DTMF decoder for audio mode.&n; *&n; * Revision 1.16  1996/06/03 20:09:05  fritz&n; * Bugfix: called wrong function pointer for locking in&n; *         isdn_get_free_channel().&n; *&n; * Revision 1.15  1996/05/31 01:10:54  fritz&n; * Bugfixes:&n; *   Lowlevel modules did not get locked correctly.&n; *   Did show wrong revision when initializing.&n; *   Minor fixes in ioctl code.&n; *   sk_buff did not get freed, if error in writebuf_stub.&n; *&n; * Revision 1.14  1996/05/18 01:36:55  fritz&n; * Added spelling corrections and some minor changes&n; * to stay in sync with kernel.&n; *&n; * Revision 1.13  1996/05/17 15:43:30  fritz&n; * Bugfix: decrement of rcvcount in readbchan() corrected.&n; *&n; * Revision 1.12  1996/05/17 03:55:43  fritz&n; * Changed DLE handling for audio receive.&n; * Some cleanup.&n; * Added display of isdn_audio_revision.&n; *&n; * Revision 1.11  1996/05/11 21:51:32  fritz&n; * Changed queue management to use sk_buffs.&n; *&n; * Revision 1.10  1996/05/10 08:49:16  fritz&n; * Checkin before major changes of tty-code.&n; *&n; * Revision 1.9  1996/05/07 09:19:41  fritz&n; * Adapted to changes in isdn_tty.c&n; *&n; * Revision 1.8  1996/05/06 11:34:51  hipp&n; * fixed a few bugs&n; *&n; * Revision 1.7  1996/05/02 03:55:17  fritz&n; * Bugfixes:&n; *  - B-channel connect message for modem devices&n; *    sometimes did not result in a CONNECT-message.&n; *  - register_isdn did not check for driverId-conflicts.&n; *&n; * Revision 1.6  1996/04/30 20:57:21  fritz&n; * Commit test&n; *&n; * Revision 1.5  1996/04/20 16:19:07  fritz&n; * Changed slow timer handlers to increase accuracy.&n; * Added statistic information for usage by xisdnload.&n; * Fixed behaviour of isdnctrl-device on non-blocked io.&n; * Fixed all io to go through generic writebuf-function without&n; * bypassing. Same for incoming data.&n; * Fixed bug: Last channel had been unusable.&n; * Fixed kfree of tty xmit_buf on ppp initialization failure.&n; *&n; * Revision 1.4  1996/02/11 02:33:26  fritz&n; * Fixed bug in main timer-dispatcher.&n; * Bugfix: Lot of tty-callbacks got called regardless of the events already&n; * been handled by network-devices.&n; * Changed ioctl-names.&n; *&n; * Revision 1.3  1996/01/22 05:16:11  fritz&n; * Changed ioctl-names.&n; * Fixed bugs in isdn_open and isdn_close regarding PPP_MINOR.&n; *&n; * Revision 1.2  1996/01/21 16:52:40  fritz&n; * Support for sk_buffs added, changed header-stuffing.&n; *&n; * Revision 1.1  1996/01/09 04:12:52  fritz&n; * Initial revision&n; *&n; */
