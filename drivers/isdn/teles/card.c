...
DECL|macro|FRITZ_EXPERIMENTAL
mdefine_line|#define FRITZ_EXPERIMENTAL
r_extern
r_void
id|tei_handler
c_func
...
(brace
macro_line|#ifdef FRITZ_EXPERIMENTAL
r_int
id|to
op_assign
l_int|20
