...
(paren
id|KERN_WARNING
l_string|&quot;Teles: HSCX RDO mode=%d&bslash;n&quot;
comma
id|hsp-&gt;mode
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;HSCX RPF out of buffers at %ld&bslash;n&quot;
comma
id|jiffies
)paren
suffix:semicolon
...
r_else
(brace
multiline_comment|/* Here we lost an TX interrupt, so&n;                                 * restart transmitting the whole frame.&n;                                 */
id|hsp-&gt;sendptr
op_assign
l_int|0
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;HSCX B EXIR %x&bslash;n&quot;
comma
id|exval
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;teles: 16.3 ports %x-%x already in use&bslash;n&quot;
comma
id|card-&gt;iobase
comma
id|card-&gt;iobase
...
suffix:semicolon
multiline_comment|/* 0x1e=without AB&n;                                                 * 0x1f=with AB&n;                                                 * 0x1c 16.3 ???&n;                                                 */
r_if
c_cond
(paren
id|val
...
(brace
multiline_comment|/* What&squot;s that ??? KKeil */
r_if
c_cond
(paren
id|hscx
