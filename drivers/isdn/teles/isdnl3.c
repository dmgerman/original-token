multiline_comment|/* $Id: isdnl3.c,v 1.2 1996/04/20 16:45:05 fritz Exp $&n; *&n; * $Log: isdnl3.c,v $&n; * Revision 1.2  1996/04/20 16:45:05  fritz&n; * Changed to report all incoming calls to Linklevel, not just those&n; * with Service 7.&n; * Misc. typos&n; *&n; * Revision 1.1  1996/04/13 10:24:45  fritz&n; * Initial revision&n; *&n; *&n; */
...
multiline_comment|/*&n; * What about info2? Mapping to High-Layer-Compatibility?&n; */
macro_line|#if 0&t;&t;&t;&t;/* user-user not allowed in The Netherlands! */
op_star
id|p
op_increment
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;isdnl3/l3up DL_DATA size=%d&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;isdnl3up unhandled 1tr6 state %d MT %s&bslash;n&quot;
comma
id|st-&gt;l3.state
comma
id|mt_trans
...
(paren
id|KERN_INFO
l_string|&quot;isdnl3/l3up DL_UNIT_DATA size=%d&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
