...
suffix:semicolon
mdefine_line|#define PH_STATE_COUNT (ST_PH_ACTIVE+1)
r_static
r_char
op_star
id|strPhState
...
l_string|&quot;ST_PH_NULL&quot;
comma
l_string|&quot;ST_PH_ACTIVATED&quot;
comma
l_string|&quot;ST_PH_ACTIVE&quot;
comma
)brace
suffix:semicolon
r_enum
...
suffix:semicolon
mdefine_line|#define PH_EVENT_COUNT (EV_PH_DEACTIVATE+1)
r_static
r_char
op_star
id|strPhEvent
...
suffix:semicolon
mdefine_line|#define PH_FN_COUNT (sizeof(PhFnList)/sizeof(struct FsmNode))
macro_line|#endif
...
id|tmp
comma
l_string|&quot;enqueue_ui: %d bytes&bslash;n&quot;
comma
id|ibh-&gt;datasize
)paren
suffix:semicolon
...
id|tmp
comma
l_string|&quot;enqueue_super: %d bytes&bslash;n&quot;
comma
id|ibh-&gt;datasize
)paren
suffix:semicolon
