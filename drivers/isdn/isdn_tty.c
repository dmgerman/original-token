...
l_int|0
suffix:semicolon
multiline_comment|/* NO CARRIER message */
id|isdn_tty_modem_result
c_func
(paren
l_int|3
...
multiline_comment|/* Print CID only once, _after_ 1.st RING */
r_if
c_cond
(paren
(paren
...
mdefine_line|#define PARSE_ERROR { isdn_tty_modem_result(4, info); return; }
DECL|macro|PARSE_ERROR1
mdefine_line|#define PARSE_ERROR1 { isdn_tty_modem_result(4, info); return 1; }
r_static
r_void
