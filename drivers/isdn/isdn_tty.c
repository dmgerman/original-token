...
l_int|4
suffix:colon
multiline_comment|/* adpcm, compatible to ZyXel 1496 modem&n;                                 * with ROM revision 6.01&n;                                 */
id|buflen
op_assign
...
(brace
multiline_comment|/* If DLE decoding results in zero-transmit, but&n;                                         * c originally was non-zero, do a wakeup.&n;                                         */
r_if
c_cond
(paren
(paren
