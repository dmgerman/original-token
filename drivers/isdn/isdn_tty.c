...
mdefine_line|#define REG_RINGCNT   1
DECL|macro|REG_ESC
...
DECL|macro|REG_RESP
mdefine_line|#define REG_RESP     12
DECL|macro|BIT_RESP
mdefine_line|#define BIT_RESP      1
DECL|macro|REG_RESPNUM
mdefine_line|#define REG_RESPNUM  12
DECL|macro|BIT_RESPNUM
mdefine_line|#define BIT_RESPNUM   2
DECL|macro|REG_ECHO
...
DECL|macro|REG_RUNG
mdefine_line|#define REG_RUNG     13
DECL|macro|BIT_RUNG
mdefine_line|#define BIT_RUNG     64
DECL|macro|REG_RESRXT
mdefine_line|#define REG_RESRXT   13
DECL|macro|BIT_RESRXT
mdefine_line|#define BIT_RESRXT  128
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: FCLASS=2&bslash;n&quot;
)paren
suffix:semicolon
id|p
(braket
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: Fax FBOR=%c&bslash;n&quot;
comma
op_star
id|p
(braket
...
(brace
multiline_comment|/* SETUP irgendwie !! */
r_int
id|i
comma
id|val
...
c_func
(paren
l_string|&quot;&bslash;r&bslash;n(0,1),(0-5),(0-2),(0-2),(0,1),(0),(0),(0-7)&quot;
comma
id|info
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: Fax Setup values=%d,%d,%d,%d,%d,%d,%d,%d&bslash;n&quot;
comma
id|val
(braket
l_int|0
...
(brace
multiline_comment|/* set sender ID !! */
r_char
id|senderID
(braket
l_int|80
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: Fax sender=&gt;%s&lt;&bslash;n&quot;
comma
id|senderID
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;r&bslash;nISDNfax&quot;
comma
id|info
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;r&bslash;nAVM-B1&quot;
comma
id|info
)paren
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: FAP=?&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(brace
multiline_comment|/* beim trace mit dem zyxel folgt der wert 30 ;*/
id|p
(braket
l_int|0
)braket
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: FPHCTO=%s&bslash;n&quot;
comma
id|p
(braket
l_int|0
...
(paren
id|KERN_DEBUG
l_string|&quot;isdn_tty: FCR=%s&bslash;n&quot;
comma
id|p
(braket
l_int|0
