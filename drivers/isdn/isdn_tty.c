...
DECL|macro|VBUF
mdefine_line|#define VBUF 0x300
DECL|macro|VBUFX
...
(brace
multiline_comment|/* Post processing only once, if skb-&gt;free &gt; 1 */
macro_line|#ifdef CONFIG_ISDN_AUDIO
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* Mark skb post-processed */
id|skb-&gt;free
op_assign
l_int|1
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;isdn_tty: Cannot alloc skb in tty_write&bslash;n&quot;
)paren
suffix:semicolon
id|restore_flags
c_func
...
suffix:semicolon
multiline_comment|/* For T.70 header */
r_if
c_cond
(paren
id|from_user
