...
(paren
id|KERN_ERR
l_string|&quot;isdn_tty: (end_vrx) BUFFER OVERFLOW!!!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|1
...
(brace
multiline_comment|/* If DLE decoding results in zero-transmit, but&n;&t;&t;&t;&t;&t; * c originally was non-zero, do a wakeup.&n;&t;&t;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Do NOT handle Ctrl-Q or Ctrl-S&n;&t;&t;&t;&t; * when in full-duplex audio mode.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|isdn_tty_end_vrx
...
multiline_comment|/*&n; * A packet has been output successfully.&n; * Search the tty-devices for an appropriate device, decrement its&n; * counter for outstanding packets, and set CTS.&n; */
r_void
