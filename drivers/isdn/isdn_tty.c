multiline_comment|/* $Id: isdn_tty.c,v 1.84 2000/02/16 15:10:14 paul Exp $&n;&n; * Linux ISDN subsystem, tty functions and AT-command emulator (linklevel).&n; *&n; * Copyright 1994-1999  by Fritz Elfert (fritz@isdn4linux.de)&n; * Copyright 1995,96    by Thinking Objects Software GmbH Wuerzburg&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: isdn_tty.c,v $&n; * Revision 1.84  2000/02/16 15:10:14  paul&n; * If a ttyI has no open FDs, don&squot;t connect incoming calls to it.&n; * (Hangup on close of last FD is still to be done.)&n; *&n; * Revision 1.83  2000/02/16 14:59:33  paul&n; * translated ISDN_MODEM_ANZREG to ISDN_MODEM_NUMREG for english speakers;&n; * used defines for result codes;&n; * fixed RING ... RUNG problem (no empty lines in between).&n; *&n; * Revision 1.82  2000/01/23 18:45:37  keil&n; * Change EAZ mapping to forbit the use of cards (insert a &quot;-&quot; for the MSN)&n; *&n; * Revision 1.81  2000/01/20 19:55:33  keil&n; * Add FAX Class 1 support&n; *&n; * Revision 1.80  1999/11/07 13:34:30  armin&n; * Fixed AT command line editor&n; *&n; * Revision 1.79  1999/10/29 18:35:08  armin&n; * Check number len in isdn_get_msnstr() to avoid buffer overflow.&n; *&n; * Revision 1.78  1999/10/28 23:03:51  armin&n; * Bugfix: now freeing channel on modem_hup() even when&n; * usage on ttyI has changed and error-report for&n; * AT-commands on wrong channel-state.&n; *&n; * Revision 1.77  1999/10/26 21:13:14  armin&n; * using define for checking phone number len in isdn_tty_getdial()&n; *&n; * Revision 1.76  1999/10/11 22:16:26  keil&n; * Suspend/Resume is possible without explicit ID too&n; *&n; * Revision 1.75  1999/10/08 18:59:32  armin&n; * Bugfix of too small MSN buffer and checking phone number&n; * in isdn_tty_getdial()&n; *&n; * Revision 1.74  1999/09/04 06:20:04  keil&n; * Changes from kernel set_current_state()&n; *&n; * Revision 1.73  1999/08/28 21:56:27  keil&n; * misplaced #endif caused ttyI crash in 2.3.X&n; *&n; * Revision 1.72  1999/07/31 12:59:45  armin&n; * Added tty fax capabilities.&n; *&n; * Revision 1.71  1999/07/27 10:34:34  armin&n; * Fixed last change. Did not compile with AUDIO support off.&n; *&n; * Revision 1.70  1999/07/25 16:17:58  keil&n; * Fix Suspend/Resume&n; *&n; * Revision 1.69  1999/07/25 12:56:15  armin&n; * isdn_tty_at_cout() now queues the message if online and&n; * data is in queue or flip buffer is full.&n; * needed for fax connections.&n; *&n; * Revision 1.68  1999/07/11 17:51:51  armin&n; * Bugfix, &quot;-&quot; was missing for AT&amp;L settings.&n; *&n; * Revision 1.67  1999/07/11 17:14:12  armin&n; * Added new layer 2 and 3 protocols for Fax and DSP functions.&n; * Moved &quot;Add CPN to RING message&quot; to new register S23,&n; * &quot;Display message&quot; is now correct on register S13 bit 7.&n; * New audio command AT+VDD implemented (deactivate DTMF decoder and&n; * activate possible existing hardware/DSP decoder).&n; * Moved some tty defines to .h file.&n; * Made whitespace possible in AT command line.&n; * Some AT-emulator output bugfixes.&n; * First Fax G3 implementations.&n; *&n; * Revision 1.66  1999/07/07 10:13:46  detabc&n; * remove unused messages&n; *&n; * Revision 1.65  1999/07/04 21:01:59  werner&n; * Added support for keypad and display (ported from 2.0)&n; *&n; * Revision 1.64  1999/07/01 08:30:00  keil&n; * compatibility to 2.3 kernel&n; *&n; * Revision 1.63  1999/04/12 12:33:39  fritz&n; * Changes from 2.0 tree.&n; *&n; * Revision 1.62  1999/03/02 12:04:48  armin&n; * -added ISDN_STAT_ADDCH to increase supported channels after&n; *  register_isdn().&n; * -ttyI now goes on-hook on ATZ when B-Ch is connected.&n; * -added timer-function for register S7 (Wait for Carrier).&n; * -analog modem (ISDN_PROTO_L2_MODEM) implementations.&n; * -on L2_MODEM a string will be appended to the CONNECT-Message,&n; *  which is provided by the HL-Driver in parm.num in ISDN_STAT_BCONN.&n; * -variable &quot;dialing&quot; used for ATA also, for interrupting call&n; *  establishment and register S7.&n; *&n; * Revision 1.61  1999/01/27 22:53:11  he&n; * minor updates (spellings, jiffies wrap around in isdn_tty)&n; *&n; * Revision 1.60  1998/11/15 23:57:32  keil&n; * changes for 2.1.127&n; *&n; * Revision 1.59  1998/08/20 13:50:15  keil&n; * More support for hybrid modem (not working yet)&n; *&n; * Revision 1.58  1998/07/26 18:48:45  armin&n; * Added silence detection in voice receive mode.&n; *&n; * Revision 1.57  1998/06/26 15:12:36  fritz&n; * Added handling of STAT_ICALL with incomplete CPN.&n; * Added AT&amp;L for ttyI emulator.&n; * Added more locking stuff in tty_write.&n; *&n; * Revision 1.56  1998/06/18 23:31:51  fritz&n; * Replaced cli()/restore_flags() in isdn_tty_write() by locking.&n; * Removed direct-senddown feature in isdn_tty_write because it will&n; * never succeed with locking and is useless anyway.&n; *&n; * Revision 1.55  1998/06/17 19:50:55  he&n; * merged with 2.1.10[34] (cosmetics and udelay() -&gt; mdelay())&n; * brute force fix to avoid Ugh&squot;s in isdn_tty_write()&n; * cleaned up some dead code&n; *&n; *&n; *&n; * Revision 1.52  1998/03/19 13:18:21  keil&n; * Start of a CAPI like interface for supplementary Service&n; * first service: SUSPEND&n; *&n; *&n; * Revision 1.49  1998/03/08 00:01:59  fritz&n; * Bugfix: Lowlevel module usage and channel usage were not&n; *         reset on NO DCHANNEL.&n; *&n; * Revision 1.48  1998/03/07 12:28:15  tsbogend&n; * fixed kernel unaligned traps on Linux/Alpha&n; *&n; * Revision 1.47  1998/02/22 19:44:14  fritz&n; * Bugfixes and improvements regarding V.110, V.110 now running.&n; *&n; * Revision 1.46  1998/02/20 17:23:08  fritz&n; * Changes for recent kernels.&n; * Merged in contributions by Thomas Pfeiffer (V.110 T.70+ Extended FAX stuff)&n; * Added symbolic constants for Modem-Registers.&n; *&n; * Revision 1.45  1998/01/31 22:07:49  keil&n; * changes for newer kernels&n; *&n; * Revision 1.44  1998/01/31 19:30:02  calle&n; * Merged changes from and for 2.1.82, not tested only compiled ...&n; *&n; * Revision 1.43  1997/10/09 21:29:04  fritz&n; * New HL&lt;-&gt;LL interface:&n; *   New BSENT callback with nr. of bytes included.&n; *   Sending without ACK.&n; *   New L1 error status (not yet in use).&n; *   Cleaned up obsolete structures.&n; * Implemented Cisco-SLARP.&n; * Changed local net-interface data to be dynamically allocated.&n; * Removed old 2.0 compatibility stuff.&n; *&n; * Revision 1.42  1997/10/01 09:20:49  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.41  1997/05/27 15:17:31  fritz&n; * Added changes for recent 2.1.x kernels:&n; *   changed return type of isdn_close&n; *   queue_task_* -&gt; queue_task&n; *   clear/set_bit -&gt; test_and_... where apropriate.&n; *   changed type of hard_header_cache parameter.&n; *&n; * Revision 1.40  1997/03/24 22:55:27  fritz&n; * Added debug code for status callbacks.&n; *&n; * Revision 1.39  1997/03/21 18:25:56  fritz&n; * Corrected CTS handling.&n; *&n; * Revision 1.38  1997/03/07 12:13:35  fritz&n; * Bugfix: Send audio in adpcm format was broken.&n; * Bugfix: CTS handling was wrong.&n; *&n; * Revision 1.37  1997/03/07 01:37:34  fritz&n; * Bugfix: Did not compile with CONFIG_ISDN_AUDIO disabled.&n; * Bugfix: isdn_tty_tint() did not handle lowlevel errors correctly.&n; * Bugfix: conversion was wrong when sending ulaw audio.&n; * Added proper ifdef&squot;s for CONFIG_ISDN_AUDIO&n; *&n; * Revision 1.36  1997/03/04 21:41:55  fritz&n; * Fix: Excessive stack usage of isdn_tty_senddown()&n; *      and isdn_tty_end_vrx() could lead to problems.&n; *&n; * Revision 1.35  1997/03/02 19:05:52  fritz&n; * Bugfix: Avoid recursion.&n; *&n; * Revision 1.34  1997/03/02 14:29:22  fritz&n; * More ttyI related cleanup.&n; *&n; * Revision 1.33  1997/02/28 02:32:45  fritz&n; * Cleanup: Moved some tty related stuff from isdn_common.c&n; *          to isdn_tty.c&n; * Bugfix:  Bisync protocol did not behave like documented.&n; *&n; * Revision 1.32  1997/02/23 15:43:03  fritz&n; * Small change in handling of incoming calls&n; * documented in newest version of ttyI.4&n; *&n; * Revision 1.31  1997/02/21 13:05:57  fritz&n; * Bugfix: Remote hangup did not set location-info on ttyI&squot;s&n; *&n; * Revision 1.30  1997/02/18 09:41:05  fritz&n; * Added support for bitwise access to modem registers (ATSx.y=n, ATSx.y?).&n; * Beautified output of AT&amp;V.&n; *&n; * Revision 1.29  1997/02/16 12:11:51  fritz&n; * Added S13,Bit4 option.&n; *&n; * Revision 1.28  1997/02/10 22:07:08  fritz&n; * Added 2 modem registers for numbering plan and screening info.&n; *&n; * Revision 1.27  1997/02/10 21:31:14  fritz&n; * Changed setup-interface (incoming and outgoing).&n; *&n; * Revision 1.26  1997/02/10 20:12:48  fritz&n; * Changed interface for reporting incoming calls.&n; *&n; * Revision 1.25  1997/02/03 23:04:30  fritz&n; * Reformatted according CodingStyle.&n; * skb-&gt;free stuff replaced by macro.&n; * Finished full-duplex audio.&n; *&n; * Revision 1.24  1997/01/14 01:32:42  fritz&n; * Changed audio receive not to rely on skb-&gt;users and skb-&gt;lock.&n; * Added ATI2 and related variables.&n; * Started adding full-duplex audio capability.&n; *&n; * Revision 1.23  1996/10/22 23:14:02  fritz&n; * Changes for compatibility to 2.0.X and 2.1.X kernels.&n; *&n; * Revision 1.22  1996/10/19 18:56:43  fritz&n; * ATZ did not change the xmitbuf size.&n; *&n; * Revision 1.21  1996/06/24 17:40:28  fritz&n; * Bugfix: Did not compile without CONFIG_ISDN_AUDIO&n; *&n; * Revision 1.20  1996/06/15 14:59:39  fritz&n; * Fixed isdn_tty_tint() to handle partially sent&n; * sk_buffs.&n; *&n; * Revision 1.19  1996/06/12 15:53:56  fritz&n; * Bugfix: AT+VTX and AT+VRX could be executed without&n; *         having a connection.&n; *         Missing check for NULL tty in isdn_tty_flush_buffer().&n; *&n; * Revision 1.18  1996/06/07 11:17:33  tsbogend&n; * added missing #ifdef CONFIG_ISDN_AUDIO to make compiling without&n; * audio support possible&n; *&n; * Revision 1.17  1996/06/06 14:55:47  fritz&n; * Changed to support DTMF decoding on audio playback also.&n; * Bugfix: Added check for invalid info-&gt;isdn_driver in&n; *         isdn_tty_senddown().&n; * Clear ncarrier flag on last close() of a tty.&n; *&n; * Revision 1.16  1996/06/05 02:24:12  fritz&n; * Added DTMF decoder for audio mode.&n; *&n; * Revision 1.15  1996/06/03 20:35:01  fritz&n; * Fixed typos.&n; *&n; * Revision 1.14  1996/06/03 20:12:19  fritz&n; * Fixed typos.&n; * Added call to write_wakeup via isdn_tty_flush_buffer()&n; * in isdn_tty_modem_hup().&n; *&n; * Revision 1.13  1996/05/31 01:33:29  fritz&n; * Changed buffering due to bad performance with mgetty.&n; * Now sk_buff is delayed allocated in isdn_tty_senddown&n; * using xmit_buff like in standard serial driver.&n; * Fixed module locking.&n; * Added DLE-DC4 handling in voice mode.&n; *&n; * Revision 1.12  1996/05/19 01:34:40  fritz&n; * Bugfix: ATS returned error.&n; *         Register 20 made readonly.&n; *&n; * Revision 1.11  1996/05/18 01:37:03  fritz&n; * Added spelling corrections and some minor changes&n; * to stay in sync with kernel.&n; *&n; * Revision 1.10  1996/05/17 03:51:49  fritz&n; * Changed DLE handling for audio receive.&n; *&n; * Revision 1.9  1996/05/11 21:52:07  fritz&n; * Changed queue management to use sk_buffs.&n; *&n; * Revision 1.8  1996/05/10 08:49:43  fritz&n; * Checkin before major changes of tty-code.&n; *&n; * Revision 1.7  1996/05/07 09:15:09  fritz&n; * Reorganized and general cleanup.&n; * Bugfixes:&n; *  - Audio-transmit working now.&n; *  - &quot;NO CARRIER&quot; now reported, when hanging up with DTR low.&n; *  - Corrected CTS handling.&n; *&n; * Revision 1.6  1996/05/02 03:59:25  fritz&n; * Bugfixes:&n; *  - On dialout, layer-2 setup had been incomplete&n; *    when using new auto-layer2 feature.&n; *  - On hangup, &quot;NO CARRIER&quot; message sometimes missing.&n; *&n; * Revision 1.5  1996/04/30 21:05:25  fritz&n; * Test commit&n; *&n; * Revision 1.4  1996/04/20 16:39:54  fritz&n; * Changed all io to go through generic routines in isdn_common.c&n; * Fixed a real ugly bug in modem-emulator: &squot;ATA&squot; had been accepted&n; * even when a call has been cancelled from the remote machine.&n; *&n; * Revision 1.3  1996/02/11 02:12:32  fritz&n; * Bugfixes according to similar fixes in standard serial.c of kernel.&n; *&n; * Revision 1.2  1996/01/22 05:12:25  fritz&n; * replaced my_atoi by simple_strtoul&n; *&n; * Revision 1.1  1996/01/09 04:13:18  fritz&n; * Initial revision&n; *&n; */
