...
suffix:semicolon
multiline_comment|/* get frame from queue */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Bottom Half&n;&t; *&t;Runs with ints enabled&n;&t; */
r_if
c_cond
(paren
id|read_seq
...
DECL|function|pcbit_frame_read
r_static
r_void
id|pcbit_frame_read
c_func
