multiline_comment|/* $Id: q931.c,v 1.6 1997/07/27 21:09:44 keil Exp $&n;&n; * q931.c       code to decode ITU Q.931 call control messages&n; *&n; * Author       Jan den Ouden&n; *&n; * Changelog&n; *&n; * Pauline Middelink    general improvements&n; *&n; * Beat Doebeli         cause texts, display information element&n; *&n; * Karsten Keil         cause texts, display information element for 1TR6&n; *&n; *&n; * $Log: q931.c,v $&n; * Revision 1.6  1997/07/27 21:09:44  keil&n; * move functions to isdnl3.c&n; *&n; * Revision 1.5  1997/04/06 22:56:43  keil&n; * Some cosmetic changes&n; *&n; * Revision 1.4  1997/02/09 00:29:11  keil&n; * new interface handling, one interface per card&n; *&n; * Revision 1.3  1997/01/21 22:24:59  keil&n; * cleanups&n; *&n; * Revision 1.2  1996/10/27 22:12:45  keil&n; * reporting unknown level 3 protocol ids&n; *&n; * Revision 1.1  1996/10/13 20:04:56  keil&n; * Initial revision&n; *&n; *&n; */
...
id|dp
comma
l_string|&quot;LogFrame: warning Frame too big (%d)&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
