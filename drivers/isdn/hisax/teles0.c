multiline_comment|/* $Id: teles0.c,v 1.8 1997/04/13 19:54:04 keil Exp $&n;&n; * teles0.c     low level stuff for Teles Memory IO isdn cards&n; *              based on the teles driver from Jan den Ouden&n; *&n; * Author       Karsten Keil (keil@temic-ech.spacenet.de)&n; *&n; * Thanks to    Jan den Ouden&n; *              Fritz Elfert&n; *              Beat Doebeli&n; *&n; * $Log: teles0.c,v $&n; * Revision 1.8  1997/04/13 19:54:04  keil&n; * Change in IRQ check delay for SMP&n; *&n; * Revision 1.7  1997/04/06 22:54:04  keil&n; * Using SKB&squot;s&n; *&n; * Revision 1.6  1997/01/27 15:52:18  keil&n; * SMP proof,cosmetics&n; *&n; * Revision 1.5  1997/01/21 22:25:59  keil&n; * cleanups&n; *&n; * Revision 1.4  1996/11/05 19:41:27  keil&n; * more changes for 2.1&n; *&n; * Revision 1.3  1996/10/30 10:22:58  keil&n; * Changes for 2.1 kernels&n; *&n; * Revision 1.2  1996/10/27 22:08:34  keil&n; * cosmetic changes&n; *&n; * Revision 1.1  1996/10/13 20:04:58  keil&n; * Initial revision&n; *&n; *&n; *&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;Teles0: waitforCEC timeout&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_static
...
(paren
id|KERN_WARNING
l_string|&quot;Teles0: waitforXFW timeout&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_static
...
r_static
r_void
DECL|function|telesS0_interrupt
id|telesS0_interrupt
c_func
(paren
r_int
id|intno
...
id|sp-&gt;membase
suffix:semicolon
multiline_comment|/* 16.0 IOM 1 Mode */
id|writeisac
c_func
(paren
id|adr
...
(paren
id|KERN_WARNING
l_string|&quot;Teles0: IRQ(%d) getting no interrupts during init&bslash;n&quot;
comma
id|sp-&gt;irq
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;HiSax: %s config irq:%d mem:%x cfg:%x&bslash;n&quot;
comma
id|CardType
(braket
id|sp-&gt;typ
...
(paren
id|KERN_INFO
l_string|&quot;Teles0: HSCX version A: %s  B: %s&bslash;n&quot;
comma
id|HscxVersion
c_func
(paren
...
(paren
id|KERN_INFO
l_string|&quot;Teles0: ISAC %s&bslash;n&quot;
comma
id|ISACVersion
c_func
(paren
