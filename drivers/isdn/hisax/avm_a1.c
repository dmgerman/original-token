...
(paren
id|KERN_WARNING
l_string|&quot;AVM A1: waitforCEC timeout&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_static
...
(paren
id|KERN_WARNING
l_string|&quot;AVM A1: waitforXFW timeout&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_static
...
r_void
DECL|function|release_io_avm_a1
...
(paren
id|KERN_WARNING
l_string|&quot;AVM A1: IRQ(%d) getting no interrupts during init&bslash;n&quot;
comma
id|sp-&gt;irq
)paren
suffix:semicolon
...
(paren
id|KERN_NOTICE
l_string|&quot;HiSax: %s config irq:%d cfg:%x&bslash;n&quot;
comma
id|CardType
(braket
id|sp-&gt;typ
...
(paren
id|KERN_NOTICE
l_string|&quot;HiSax: isac:%x/%x&bslash;n&quot;
comma
id|sp-&gt;isac
comma
id|sp-&gt;isac
...
(paren
id|KERN_NOTICE
l_string|&quot;HiSax: hscx A:%x/%x  hscx B:%x/%x&bslash;n&quot;
comma
id|sp-&gt;hscx
(braket
l_int|0
...
(paren
id|KERN_INFO
l_string|&quot;AVM A1: HSCX version A: %s  B: %s&bslash;n&quot;
comma
id|HscxVersion
c_func
(paren
...
(paren
id|KERN_INFO
l_string|&quot;AVM A1: ISAC %s&bslash;n&quot;
comma
id|ISACVersion
c_func
(paren
