multiline_comment|/* $Id: hfc_pci.h,v 1.6 1999/08/28 21:04:29 werner Exp $&n;&n; *  specific defines for CCD&squot;s HFC 2BDS0 PCI chips&n; *&n; * Author     Werner Cornelius (werner@isdn4linux.de)      &n; *&n; * Copyright 1999  by Werner Cornelius (werner@isdn4linux.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: hfc_pci.h,v $&n; * Revision 1.6  1999/08/28 21:04:29  werner&n; * Implemented full audio support (transparent mode)&n; *&n; * Revision 1.5  1999/08/09 19:13:34  werner&n; * moved constant pci ids to pci id table&n; *&n; * Revision 1.4  1999/08/08 10:17:33  werner&n; * added new PCI vendor and card ids for Manufacturer 0x1043&n; *&n; * Revision 1.3  1999/07/14 12:39:34  werner&n; * Added changes for echo handling.&n; *&n; * Revision 1.2  1999/07/01 08:07:52  keil&n; * Initial version&n; *&n; *&n; *&n; */
multiline_comment|/*********************************************/
...
mdefine_line|#define HFCPCI_TIM3_125   0x00
