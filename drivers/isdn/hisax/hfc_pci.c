...
multiline_comment|/*****************************/
multiline_comment|/* release D- and B-channels */
multiline_comment|/*****************************/
r_void
DECL|function|releasehfcpci
id|releasehfcpci
c_func
(paren
r_struct
...
(paren
id|KERN_WARNING
l_string|&quot;HiSax: No memory for hfcpci.send&bslash;n&quot;
)paren
suffix:semicolon
r_return
(paren
...
(paren
id|KERN_ERR
l_string|&quot;HFC-PCI: no PCI bus present&bslash;n&quot;
)paren
suffix:semicolon
r_return
(paren
...
(paren
id|KERN_WARNING
l_string|&quot;HFC-PCI shared mem address will be corrected&bslash;n&quot;
)paren
suffix:semicolon
id|pcibios_write_config_word
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;HFC-PCI unable to align address %x&bslash;n&quot;
comma
(paren
r_int
)paren
