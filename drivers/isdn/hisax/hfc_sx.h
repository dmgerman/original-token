multiline_comment|/* $Id: hfc_sx.h,v 1.1 1999/11/18 00:09:18 werner Exp $&n;&n; *  specific defines for CCD&squot;s HFC 2BDS0 S+,SP chips&n; *&n; * Author     Werner Cornelius (werner@isdn4linux.de)      &n; *&n; * Copyright 1999  by Werner Cornelius (werner@isdn4linux.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: hfc_sx.h,v $&n; * Revision 1.1  1999/11/18 00:09:18  werner&n; *&n; * Initial release of files for HFC-S+ and HFC-SP cards with 32K-RAM.&n; * Audio and Echo are supported.&n; *&n; *&n; *&n; */
multiline_comment|/*********************************************/
