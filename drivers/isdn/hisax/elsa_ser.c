...
op_increment
suffix:semicolon
singleline_comment|//&t;&t;wake_up_interruptible(&amp;info-&gt;delta_msr_wait);
)brace
r_if
c_cond
(paren
...
singleline_comment|//&t;&t;&t;wake_up_interruptible(&amp;info-&gt;open_wait);
suffix:semicolon
r_else
r_if
c_cond
...
suffix:semicolon
singleline_comment|//&t;&t;&t;&t;rs_sched_event(info, RS_EVENT_WRITE_WAKEUP);
r_return
suffix:semicolon
)brace
)brace
