...
(paren
id|KERN_WARNING
l_string|&quot;ISAR: HDLC frame too short(%d)&bslash;n&quot;
comma
id|bcs-&gt;hw.isar.rcvidx
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar bin data send dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar hdlc data send dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
r_static
r_void
DECL|function|isar_pump_status_ev
id|isar_pump_status_ev
c_func
(paren
r_struct
id|BCState
...
(paren
id|KERN_WARNING
l_string|&quot;isar spurious IIS_RDATA %x/%x/%x&bslash;n&quot;
comma
id|ireg-&gt;iis
comma
id|ireg-&gt;cmsb
...
(paren
id|KERN_WARNING
l_string|&quot;isar spurious IIS_PSTEV %x/%x/%x&bslash;n&quot;
comma
id|ireg-&gt;iis
comma
id|ireg-&gt;cmsb
...
(paren
id|KERN_WARNING
l_string|&quot;isar spurious IIS_PSTRSP %x/%x/%x&bslash;n&quot;
comma
id|ireg-&gt;iis
comma
id|ireg-&gt;cmsb
...
id|cs
comma
l_string|&quot;isar pump bypass cfg dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar pump datamodem cfg dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar pump faxmodem cfg dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar pump status req dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar sart disable dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar sart binary dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar sart hdlc dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar sart v14 dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar buf stat req dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar iom2 dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
...
id|cs
comma
l_string|&quot;isar IOM2 cfg req dp%d failed&quot;
comma
id|bcs-&gt;hw.isar.dpath
)paren
suffix:semicolon
