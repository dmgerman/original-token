multiline_comment|/* $Id: isar.c,v 1.2 1998/11/15 23:54:53 keil Exp $&n;&n; * isar.c   ISAR (Siemens PSB 7110) specific routines&n; *&n; * Author       Karsten Keil (keil@isdn4linux.de)&n; *&n; *&n; * $Log: isar.c,v $&n; * Revision 1.2  1998/11/15 23:54:53  keil&n; * changes from 2.0&n; *&n; * Revision 1.1  1998/08/13 23:33:47  keil&n; * First version, only init&n; *&n; *&n; */
