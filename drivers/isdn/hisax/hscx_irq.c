multiline_comment|/* $Id: hscx_irq.c,v 1.7 1998/02/12 23:07:37 keil Exp $&n;&n; * hscx_irq.c     low level b-channel stuff for Siemens HSCX&n; *&n; * Author     Karsten Keil (keil@temic-ech.spacenet.de)&n; *&n; * This is an include file for fast inline IRQ stuff&n; *&n; * $Log: hscx_irq.c,v $&n; * Revision 1.7  1998/02/12 23:07:37  keil&n; * change for 2.1.86 (removing FREE_READ/FREE_WRITE from [dev]_kfree_skb()&n; *&n; * Revision 1.6  1997/10/29 19:01:07  keil&n; * changes for 2.1&n; *&n; * Revision 1.5  1997/10/01 09:21:35  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.4  1997/08/15 17:48:02  keil&n; * cosmetic&n; *&n; * Revision 1.3  1997/07/27 21:38:36  keil&n; * new B-channel interface&n; *&n; * Revision 1.2  1997/06/26 11:16:19  keil&n; * first version&n; *&n; *&n; */
r_static
r_inline
r_void
...
id|PACKET_NOACK
op_ne
id|bcs-&gt;hw.hscx.tx_skb-&gt;pkt_type
)paren
)paren
id|bcs-&gt;st-&gt;lli
dot
