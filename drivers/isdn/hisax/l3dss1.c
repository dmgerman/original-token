...
l_int|0
suffix:semicolon
multiline_comment|/* shift codeset procedure not implemented in the moment */
r_while
c_loop
(paren
(paren
...
id|pc-&gt;st
comma
l_string|&quot;check_infoelements mt %x %d/%d/%d/%d&quot;
comma
id|mt
comma
id|err_compr
...
l_int|0x4
suffix:semicolon
multiline_comment|/* assumptions for bearer services with keypad  */
op_star
id|p
op_increment
op_assign
...
l_int|0x18
suffix:semicolon
multiline_comment|/* no specific channel */
op_star
id|p
op_increment
op_assign
...
(brace
multiline_comment|/* special handling independant of si2 */
op_star
id|p
op_increment
op_assign
...
multiline_comment|/* Now we are on none mandatory IEs */
macro_line|#if 1
multiline_comment|/* !!!!!! this check seems to be a problem ? info bugfix to Karsten */
id|err
op_assign
id|check_infoelements
c_func
...
l_int|88
suffix:semicolon
multiline_comment|/* incompatible destination */
id|l3dss1_msg_without_setup
c_func
(paren
id|pc
...
suffix:semicolon
singleline_comment|// KKe 19.7.99 test eicon
singleline_comment|//        idev_kfree_skb(skb, FREE_READ);
id|pc-&gt;para.cause
op_assign
l_int|30
suffix:semicolon
...
comma
singleline_comment|//&t;{SBIT(11),
singleline_comment|//&t; MT_DISCONNECT, l3dss1_release_req},
(brace
id|SBIT
c_func
(paren
