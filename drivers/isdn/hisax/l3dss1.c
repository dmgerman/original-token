...
l_int|88
suffix:colon
multiline_comment|/* 0x58 incomp destination */
r_case
l_int|96
suffix:colon
...
(brace
multiline_comment|/* ETS 300-104 7.4.1, 8.4.1, 10.3.1, 11.4.1, 12.4.1, 13.4.1, 14.4.1...&n;&t;   if setup has been made and a non expected message type is received, we must send MT_STATUS cause 0x62  */
id|u_char
id|tmp
(braket
l_int|16
...
id|pc-&gt;st
comma
l_string|&quot;SUS wrong CALLID len %d&quot;
comma
id|l
)paren
suffix:semicolon
...
id|pc-&gt;st
comma
l_string|&quot;RES wrong CALLID len %d&quot;
comma
id|l
)paren
suffix:semicolon
...
id|pc-&gt;st
comma
l_string|&quot;resume ack without bchannel&quot;
)paren
suffix:semicolon
)brace
r_else
...
multiline_comment|/* | SBIT(17) | SBIT(19)*/
comma
id|MT_RELEASE
comma
id|l3dss1_release
