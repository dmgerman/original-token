multiline_comment|/* $Id: buffers.c,v 1.1 1996/10/13 20:04:49 keil Exp $&n; *&n; * Author       Karsten Keil (keil@temic-ech.spacenet.de)&n; *              based on the teles driver from Jan den Ouden&n; *&n; * Thanks to    Jan den Ouden&n; *              Fritz Elfert&n; *&n; * $Log: buffers.c,v $&n; * Revision 1.1  1996/10/13 20:04:49  keil&n; * Initial revision&n; *&n; *&n; */
DECL|macro|__NO_VERSION__
mdefine_line|#define __NO_VERSION__
macro_line|#include &quot;hisax.h&quot;
macro_line|#include &lt;linux/mm.h&gt;
macro_line|#include &lt;linux/malloc.h&gt;
DECL|macro|SMALLOC_DEBUG
macro_line|#undef SMALLOC_DEBUG
r_void
...
(brace
macro_line|#ifdef SMALLOC_DEBUG
id|printk
c_func
(paren
id|KERN_DEBUG
