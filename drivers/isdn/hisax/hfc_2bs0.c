multiline_comment|/* $Id: hfc_2bs0.c,v 1.4 1998/02/12 23:07:29 keil Exp $&n;&n; *  specific routines for CCD&squot;s HFC 2BS0&n; *&n; * Author       Karsten Keil (keil@temic-ech.spacenet.de)&n; *&n; *&n; * $Log: hfc_2bs0.c,v $&n; * Revision 1.4  1998/02/12 23:07:29  keil&n; * change for 2.1.86 (removing FREE_READ/FREE_WRITE from [dev]_kfree_skb()&n; *&n; * Revision 1.3  1997/11/06 17:13:35  keil&n; * New 2.1 init code&n; *&n; * Revision 1.2  1997/10/29 19:04:47  keil&n; * changes for 2.1&n; *&n; * Revision 1.1  1997/09/11 17:31:33  keil&n; * Common part for HFC 2BS0 based cards&n; *&n; *&n; */
...
id|tmp
comma
l_string|&quot;hfc_fill_fifo %d count(%d/%d)&quot;
comma
id|bcs-&gt;channel
comma
id|bcs-&gt;hw.hfc.tx_skb-&gt;len
