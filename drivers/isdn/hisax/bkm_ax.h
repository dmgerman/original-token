multiline_comment|/* $Id: bkm_ax.h,v 1.2 1999/07/01 08:07:55 keil Exp $&n; * bkm_ax.h   low level decls for T-Berkom cards A4T and Scitel Quadro (4*S0, passive)&n; *&n; * Author     Roland Klabunde (R.Klabunde@Berkom.de)&n; *&n; * $Log: bkm_ax.h,v $&n; * Revision 1.2  1999/07/01 08:07:55  keil&n; * Initial version&n; *&n; *&n; *&n; */
