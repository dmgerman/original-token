multiline_comment|/* $Id: act2000_isa.h,v 1.1 1997/09/23 18:00:07 fritz Exp $&n; *&n; * ISDN lowlevel-module for the IBM ISDN-S0 Active 2000 (ISA-Version).&n; *&n; * Copyright 1997 by Fritz Elfert (fritz@wuemaus.franken.de)&n; * Thanks to Friedemann Baitinger and IBM Germany&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA. &n; *&n; * $Log: act2000_isa.h,v $&n; * Revision 1.1  1997/09/23 18:00:07  fritz&n; * New driver for IBM Active 2000.&n; *&n; */
