multiline_comment|/* $Id: act2000.h,v 1.7 1999/04/12 13:13:54 fritz Exp $&n; *&n; * ISDN lowlevel-module for the IBM ISDN-S0 Active 2000.&n; *&n; * Copyright 1998 by Fritz Elfert (fritz@isdn4linux.de)&n; * Thanks to Friedemann Baitinger and IBM Germany&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA. &n; *&n; * $Log: act2000.h,v $&n; * Revision 1.7  1999/04/12 13:13:54  fritz&n; * Made cards pointer static to avoid name-clash.&n; *&n; * Revision 1.6  1998/11/05 22:12:38  fritz&n; * Changed mail-address.&n; *&n; * Revision 1.5  1997/10/09 22:22:59  fritz&n; * New HL&lt;-&gt;LL interface:&n; *   New BSENT callback with nr. of bytes included.&n; *   Sending without ACK.&n; *&n; * Revision 1.4  1997/09/25 17:25:37  fritz&n; * Support for adding cards at runtime.&n; * Support for new Firmware.&n; *&n; * Revision 1.3  1997/09/24 23:11:43  fritz&n; * Optimized IRQ load and polling-mode.&n; *&n; * Revision 1.2  1997/09/24 19:44:12  fritz&n; * Added MSN mapping support, some cleanup.&n; *&n; * Revision 1.1  1997/09/23 18:00:05  fritz&n; * New driver for IBM Active 2000.&n; *&n; */
