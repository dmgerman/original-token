multiline_comment|/* $Id: isdn_x25iface.c,v 1.7 1999/08/22 20:26:13 calle Exp $&n; * stuff needed to support the Linux X.25 PLP code on top of devices that&n; * can provide a lab_b service using the concap_proto mechanism.&n; * This module supports a network interface wich provides lapb_sematics&n; * -- as defined in ../../Documentation/networking/x25-iface.txt -- to&n; * the upper layer and assumes that the lower layer provides a reliable&n; * data link service by means of the concap_device_ops callbacks.&n; *&n; * Only protocol specific stuff goes here. Device specific stuff&n; * goes to another -- device related -- concap_proto support source file.&n; *&n; * $Log: isdn_x25iface.c,v $&n; * Revision 1.7  1999/08/22 20:26:13  calle&n; * backported changes from kernel 2.3.14:&n; * - several #include &quot;config.h&quot; gone, others come.&n; * - &quot;struct device&quot; changed to &quot;struct net_device&quot; in 2.3.14, added a&n; *   define in isdn_compat.h for older kernel versions.&n; *&n; * Revision 1.6  1999/01/27 22:53:19  he&n; * minor updates (spellings, jiffies wrap around in isdn_tty)&n; *&n; * Revision 1.5  1998/10/30 17:55:39  he&n; * dialmode for x25iface and multulink ppp&n; *&n; * Revision 1.4  1998/06/17 19:51:00  he&n; * merged with 2.1.10[34] (cosmetics and udelay() -&gt; mdelay())&n; * brute force fix to avoid Ugh&squot;s in isdn_tty_write()&n; * cleaned up some dead code&n; *&n; * Revision 1.3  1998/02/20 17:25:20  fritz&n; * Changes for recent kernels.&n; *&n; * Revision 1.2  1998/01/31 22:49:22  keil&n; * correct comments&n; *&n; * Revision 1.1  1998/01/31 22:27:58  keil&n; * New files from Henner Eisen for X.25 support&n; *&n; */
