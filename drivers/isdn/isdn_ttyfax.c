multiline_comment|/* $Id: isdn_ttyfax.c,v 1.4 1999/09/21 19:00:35 armin Exp $&n; * Linux ISDN subsystem, tty_fax AT-command emulator (linklevel).&n; *&n; * Copyright 1999    by Armin Schindler (mac@melware.de)&n; * Copyright 1999    by Ralf Spachmann (mel@melware.de)&n; * Copyright 1999    by Cytronics &amp; Melware &n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: isdn_ttyfax.c,v $&n; * Revision 1.4  1999/09/21 19:00:35  armin&n; * Extended FCON message with added CPN&n; * can now be activated with Bit 1 of Reg 23.&n; *&n; * Revision 1.3  1999/08/22 20:26:12  calle&n; * backported changes from kernel 2.3.14:&n; * - several #include &quot;config.h&quot; gone, others come.&n; * - &quot;struct device&quot; changed to &quot;struct net_device&quot; in 2.3.14, added a&n; *   define in isdn_compat.h for older kernel versions.&n; *&n; * Revision 1.2  1999/08/05 10:36:10  armin&n; * Bugfix: kernel oops on getting revision.&n; *&n; * Revision 1.1  1999/07/31 12:59:50  armin&n; * Added tty fax capabilities.&n; *&n; *&n; */
