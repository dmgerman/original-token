multiline_comment|/* $Id icn.c,v 1.15 1996/01/10 20:57:39 fritz Exp fritz $&n; *&n; * ISDN low-level module for the ICN active ISDN-Card.&n; *&n; * Copyright 1994,95,96 by Fritz Elfert (fritz@wuemaus.franken.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA. &n; *&n; * $Log: icn.c,v $&n; * Revision 1.17  1996/02/11 02:39:04  fritz&n; * Increased Buffer for status-messages.&n; * Removed conditionals for HDLC-firmware.&n; *&n; * Revision 1.16  1996/01/22 05:01:55  fritz&n; * Revert to GPL.&n; *&n; * Revision 1.15  1996/01/10 20:57:39  fritz&n; * Bugfix: Loading firmware twice caused the device stop working.&n; *&n; * Revision 1.14  1995/12/18  18:23:37  fritz&n; * Support for ICN-2B Cards.&n; * Change for supporting user-setable service-octet.&n; *&n; * Revision 1.13  1995/10/29  21:41:07  fritz&n; * Added support for DriverId&squot;s, added Jan&squot;s patches for Kernelversions.&n; *&n; * Revision 1.12  1995/04/29  13:07:35  fritz&n; * Added support for new Euro-ISDN-firmware&n; *&n; * Revision 1.11  1995/04/23  13:40:45  fritz&n; * Added support for SPV&squot;s.&n; * Changed Dial-Command to support MSN&squot;s on DSS1-Lines.&n; *&n; * Revision 1.10  1995/03/25  23:23:24  fritz&n; * Changed configurable Ports, to allow settings for DIP-Switch Cardversions.&n; *&n; * Revision 1.9  1995/03/25  23:17:30  fritz&n; * Fixed race-condition in pollbchan_send&n; *&n; * Revision 1.8  1995/03/15  12:49:44  fritz&n; * Added support for SPV&squot;s&n; * Splitted pollbchan_work ifor calling send-routine directly&n; *&n; * Revision 1.7  1995/02/20  03:48:03  fritz&n; * Added support of new request_region-function.&n; * Minor bugfixes.&n; *&n; * Revision 1.6  1995/01/31  15:48:45  fritz&n; * Added Cause-Messages to be signaled to upper layers.&n; * Added Revision-Info on load.&n; *&n; * Revision 1.5  1995/01/29  23:34:59  fritz&n; * Added stopdriver() and appropriate calls.&n; * Changed printk-statements to support loglevels.&n; *&n; * Revision 1.4  1995/01/09  07:40:46  fritz&n; * Added GPL-Notice&n; *&n; * Revision 1.3  1995/01/04  05:15:18  fritz&n; * Added undocumented &quot;bootload-finished&quot;-command in download-code&n; * to satisfy some brain-damaged icn card-versions.&n; *&n; * Revision 1.2  1995/01/02  02:14:45  fritz&n; * Misc Bugfixes&n; *&n; * Revision 1.1  1994/12/14  17:56:06  fritz&n; * Initial revision&n; *&n; */
...
multiline_comment|/* If defined, no bootcode- and protocol-downloading is supported and&n; * you must use an external loader&n; */
DECL|macro|LOADEXTERN
macro_line|#undef LOADEXTERN
r_static
r_char
...
suffix:semicolon
multiline_comment|/* Try to allocate a new buffer, link it into queue. */
r_static
id|u_char
op_star
DECL|function|icn_new_buf
id|icn_new_buf
c_func
(paren
id|pqueue
...
multiline_comment|/*&n; * Map Cannel0 (Bank0/Bank8) or Channel1 (Bank4/Bank12)&n; */
...
multiline_comment|/* Get Data from the B-Channel, assemble fragmented packets and put them&n; * into receive-queue. Wake up any B-Channel-reading processes.&n; * This routine is called via timer-callback from pollbchan().&n; * It schedules itself while any B-Channel is open.&n; */
macro_line|#ifdef DEBUG_RCVCALLBACK
DECL|variable|max_pending
r_static
r_int
id|max_pending
(braket
...
(paren
id|KERN_WARNING
l_string|&quot;icn: bogus packet on ch%d, dropping.&bslash;n&quot;
comma
id|channel
op_plus
l_int|1
...
op_assign
(paren
id|dev-&gt;shmem-&gt;data_control.ecnr
OG
id|dev-&gt;shmem-&gt;data_control.ecns
)paren
ques
c_cond
l_int|0xf
...
(paren
id|KERN_DEBUG
l_string|&quot;ICN_DEBUG: pend: %d %d&bslash;n&quot;
comma
id|max_pending
(braket
l_int|0
...
multiline_comment|/* Send data-packet to B-Channel, split it up into fragments of&n; * ICN_FRAGSIZE length. If last fragment is sent out, signal&n; * success to upper layers via statcallb with ISDN_STAT_BSENT argument.&n; * This routine is called via timer-callback from pollbchan() or&n; * directly from sendbuf().&n; */
...
suffix:semicolon
id|dev-&gt;rb_timer.function
op_assign
id|icn_pollbchan
suffix:semicolon
id|dev-&gt;rb_timer.expires
op_assign
id|jiffies
op_plus
id|ICN_TIMER_BCREAD
...
suffix:semicolon
id|dev2-&gt;rb_timer.function
op_assign
id|icn_pollbchan
suffix:semicolon
id|dev2-&gt;rb_timer.expires
op_assign
id|jiffies
op_plus
id|ICN_TIMER_BCREAD
...
id|c
suffix:semicolon
multiline_comment|/* No checks for buffer overflow for raw-status-device */
r_if
c_cond
(paren
id|dev-&gt;msg_buf_write
...
(paren
id|KERN_INFO
l_string|&quot;icn: 1TR6-Protocol loaded and running&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
(paren
id|KERN_INFO
l_string|&quot;icn: Euro-Protocol loaded and running&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_continue
...
multiline_comment|/*&n; * Check Statusqueue-Pointer from isdn-card.&n; * If there are new status-replies from the interface, check&n; * them against B-Channel-connects/disconnects and set flags arrcordingly.&n; * Wake-Up any processes, who are reading the status-device.&n; * If there are B-Channels open, initiate a timer-callback to&n; * icn_pollbchan().&n; * This routine is called periodically via timer.&n; */
DECL|function|icn_pollcard
r_static
r_void
id|icn_pollcard
c_func
...
suffix:semicolon
id|dev-&gt;st_timer.function
op_assign
id|icn_pollcard
suffix:semicolon
id|dev-&gt;st_timer.expires
op_assign
id|jiffies
op_plus
id|ICN_TIMER_DCREAD
...
multiline_comment|/* Send a packet to the transmit-buffers, handle fragmentation if necessary.&n; * Parameters:&n; *            channel = Number of B-channel&n; *            buffer  = pointer to packet&n; *            len     = size of packet (max 4000)&n; *            dev     = pointer to device-struct&n; *            user    = 1 = call from userproc, 0 = call from kernel&n; * Return:&n; *        Number of bytes transferred, -E??? on error&n; */
...
(paren
id|KERN_WARNING
l_string|&quot;icn: ports 0x%03x-0x%03x in use.&bslash;n&quot;
comma
id|dev-&gt;port
comma
id|dev-&gt;port
...
(paren
id|KERN_WARNING
l_string|&quot;icn: Protocol timed out.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#ifdef BOOT_DEBUG
id|printk
...
macro_line|#endif&t;&t;&t;&t;/* !LOADEXTERN */
...
multiline_comment|/* No checks for buffer overflow of raw-status-device */
r_if
c_cond
(paren
id|dev-&gt;msg_buf_write
...
(paren
id|KERN_INFO
l_string|&quot;icn: mmio set to 0x%08lx&bslash;n&quot;
comma
(paren
r_int
r_int
...
(paren
id|KERN_INFO
l_string|&quot;icn: port set to 0x%03x&bslash;n&quot;
comma
id|dev-&gt;port
)paren
suffix:semicolon
...
id|cbuf
comma
l_string|&quot;00;FV2ON&bslash;n01;EAZ1&bslash;n&quot;
)paren
suffix:semicolon
id|i
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;icn: Leased-line mode enabled&bslash;n&quot;
)paren
suffix:semicolon
id|cmd.command
op_assign
...
(paren
id|KERN_INFO
l_string|&quot;icn: Leased-line mode disabled&bslash;n&quot;
)paren
suffix:semicolon
id|cmd.command
op_assign
...
multiline_comment|/*&n; * For second half of doubleS0-Card add channel-offset.&n; */
DECL|function|if_command1
r_static
r_int
id|if_command1
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;icn: Could not allocate device-struct.&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
l_int|1
suffix:semicolon
id|dev-&gt;interface.channels
op_assign
id|ICN_BCH
suffix:semicolon
id|dev-&gt;interface.maxbufsize
op_assign
l_int|4000
suffix:semicolon
id|dev-&gt;interface.command
op_assign
id|if_command1
suffix:semicolon
id|dev-&gt;interface.writebuf
op_assign
id|if_sendbuf1
suffix:semicolon
id|dev-&gt;interface.writecmd
op_assign
id|if_writecmd1
suffix:semicolon
id|dev-&gt;interface.readstat
op_assign
id|if_readstatus1
suffix:semicolon
id|dev-&gt;interface.features
...
suffix:semicolon
id|dev2-&gt;interface.command
op_assign
id|if_command2
suffix:semicolon
id|dev2-&gt;interface.writebuf
op_assign
id|if_sendbuf2
suffix:semicolon
id|dev2-&gt;interface.writecmd
op_assign
id|if_writecmd2
suffix:semicolon
id|dev2-&gt;interface.readstat
op_assign
id|if_readstatus2
suffix:semicolon
id|strncpy
...
suffix:semicolon
id|dev2-&gt;msg_buf_write
op_assign
id|dev2-&gt;msg_buf
suffix:semicolon
id|dev2-&gt;msg_buf_read
op_assign
id|dev2-&gt;msg_buf
suffix:semicolon
id|dev2-&gt;msg_buf_end
...
(paren
id|KERN_WARNING
l_string|&quot;icn: Unable to register&bslash;n&quot;
)paren
suffix:semicolon
id|kfree
c_func
...
(paren
id|KERN_NOTICE
l_string|&quot;ICN-ISDN-driver Rev%sport=0x%03x mmio=0x%08x id=&squot;%s&squot;&bslash;n&quot;
comma
id|rev
comma
id|dev-&gt;port
