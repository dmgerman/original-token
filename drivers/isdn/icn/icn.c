...
multiline_comment|/*&n; * Release currend card/channel lock,&n; * then map same or other channel without locking.&n; */
...
(paren
id|KERN_ERR
l_string|&quot;icn: if_command called with invalid driverId!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|if_command
suffix:semicolon
multiline_comment|/*&n;        card-&gt;interface.writebuf = if_sendbuf;&n;&t;*/
...
(paren
id|KERN_NOTICE
l_string|&quot;ICN-ISDN-driver Rev%smem=0x%08x&bslash;n&quot;
comma
id|rev
comma
(paren
