...
multiline_comment|/* Append a packet to the transmit buffer-queue.&n; * Parameters:&n; *   channel = Number of B-channel&n; *   buffer  = pointer to packet&n; *   len     = size of packet (max 4000)&n; *   user    = 1 = call from userproc, 0 = call from kernel&n; *   card    = pointer to card-struct&n; * Return:&n; *   Number of bytes transferred, -E??? on error&n; */
