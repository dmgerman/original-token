multiline_comment|/* $Id: icn.c,v 1.64 2000/10/02 17:33:43 keil Exp $&n;&n; * ISDN low-level module for the ICN active ISDN-Card.&n; *&n; * Copyright 1994,95,96 by Fritz Elfert (fritz@isdn4linux.de)&n; *&n; * This program is free software; you can redistribute it and/or modify&n; * it under the terms of the GNU General Public License as published by&n; * the Free Software Foundation; either version 2, or (at your option)&n; * any later version.&n; *&n; * This program is distributed in the hope that it will be useful,&n; * but WITHOUT ANY WARRANTY; without even the implied warranty of&n; * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the&n; * GNU General Public License for more details.&n; *&n; * You should have received a copy of the GNU General Public License&n; * along with this program; if not, write to the Free Software&n; * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.&n; *&n; * $Log: icn.c,v $&n; * Revision 1.64  2000/10/02 17:33:43  keil&n; * Fix NULL pointer error  (thanks Luca Montecchia)&n; *&n; * Revision 1.63  2000/05/06 00:52:39  kai&n; * merged changes from kernel tree&n; * fixed timer and net_device-&gt;name breakage&n; *&n; * Revision 1.62  1999/09/06 07:29:35  fritz&n; * Changed my mail-address.&n; *&n; * Revision 1.61  1999/09/03 14:06:58  fritz&n; * Fixed a memory leak.&n; *&n; * Revision 1.60  1999/08/31 11:20:32  paul&n; * various spelling corrections (new checksums may be needed, Karsten!)&n; *&n; * Revision 1.59  1999/08/28 22:10:55  keil&n; * __setup function should be static&n; *&n; * Revision 1.58  1999/08/25 16:44:17  keil&n; * Support for new __setup function&n; *&n; * Revision 1.57  1999/07/06 16:15:30  detabc&n; * remove unused messages&n; *&n; * Revision 1.56  1999/04/12 13:15:07  fritz&n; * Fixed a cast.&n; *&n; * Revision 1.55  1999/04/12 12:34:02  fritz&n; * Changes from 2.0 tree.&n; *&n; * Revision 1.54  1999/01/05 18:29:39  he&n; * merged remaining schedule_timeout() changes from 2.1.127&n; *&n; * Revision 1.53  1998/06/17 19:51:28  he&n; * merged with 2.1.10[34] (cosmetics and udelay() -&gt; mdelay())&n; * brute force fix to avoid Ugh&squot;s in isdn_tty_write()&n; * cleaned up some dead code&n; *&n; * Revision 1.52  1998/05/20 19:29:58  tsbogend&n; * fixed bug introduced by changes for new BSENT callback&n; *&n; * Revision 1.51  1998/03/07 22:29:55  fritz&n; * Adapted Detlef&squot;s chenges for 2.1.&n; *&n; * Revision 1.49  1998/02/13 11:14:15  keil&n; * change for 2.1.86 (removing FREE_READ/FREE_WRITE from [dev]_kfree_skb()&n; *&n; * Revision 1.48  1997/10/10 15:56:14  fritz&n; * New HL&lt;-&gt;LL interface:&n; *   New BSENT callback with nr. of bytes included.&n; *   Sending without ACK.&n; *&n; * Revision 1.47  1997/10/01 09:21:51  fritz&n; * Removed old compatibility stuff for 2.0.X kernels.&n; * From now on, this code is for 2.1.X ONLY!&n; * Old stuff is still in the separate branch.&n; *&n; * Revision 1.46  1997/08/21 22:38:33  fritz&n; * Fixed a typo.&n; *&n; * Revision 1.45  1997/06/21 10:42:06  fritz&n; * Added availability to select leased mode on only one channel.&n; *&n; * Revision 1.44  1997/03/30 16:51:26  calle&n; * changed calls to copy_from_user/copy_to_user and removed verify_area&n; * were possible.&n; *&n; * Revision 1.43  1997/03/21 18:27:04  fritz&n; * Corrected parsing of incoming setup.&n; *&n; * Revision 1.42  1997/03/05 21:13:18  fritz&n; * Bugfix: sndcount was not reset on hangup.&n; *&n; * Revision 1.41  1997/02/24 23:34:29  fritz&n; * Bugfix in Layer1 error-recovery.&n; *&n; * Revision 1.40  1997/02/23 23:34:45  fritz&n; * Minor bugfixes in debugging code.&n; *&n; * Revision 1.39  1997/02/23 16:21:56  fritz&n; * Bugfix: Check for NULL pointer in icn_parse_status().&n; *&n; * Revision 1.38  1997/02/11 18:29:31  fritz&n; * Bugfix in D64S initialization.&n; *&n; * Revision 1.37  1997/02/10 22:43:20  fritz&n; * Added plan and screen elements on ISDN_STAT_ICALL&n; *&n; * Revision 1.36  1997/02/10 21:31:20  fritz&n; * Changed setup-interface (incoming and outgoing).&n; *&n; * Revision 1.35  1997/02/10 10:10:28  fritz&n; * Changes for Kernel 2.1.X compatibility.&n; * Enhanced initialization, can recover from&n; * misconfiguration by other autoprobing drivers.&n; *&n; * Revision 1.34  1997/01/29 22:34:44  fritz&n; * Cleanup, Corrected D64S setup of 2nd channel.&n; *&n; * Revision 1.33  1996/12/05 20:31:48  tsbogend&n; * added handling of L2: DATA LINK LOST messages&n; *&n; * Revision 1.32  1996/11/14 23:49:18  fritz&n; * Bugfix: copy_to_user/copy_from_user mismatch in debugging-ioctl.&n; *&n; * Revision 1.31  1996/11/13 02:36:25  fritz&n; * Fixed a race condition in writecmd.&n; * Some optimizations and cleanup.&n; *&n; * Revision 1.30  1996/10/22 23:14:09  fritz&n; * Changes for compatibility to 2.0.X and 2.1.X kernels.&n; *&n; * Revision 1.29  1996/08/29 20:34:54  fritz&n; * Bugfix in send queue management:&n; * sndcount was not updated correctly.&n; * Minor Bugfixes.&n; *&n; * Revision 1.28  1996/06/28 17:02:53  fritz&n; * replaced memcpy_fromfs_toio.&n; *&n; * Revision 1.27  1996/06/25 18:38:59  fritz&n; * Fixed function name in error message.&n; *&n; * Revision 1.26  1996/06/24 17:20:35  fritz&n; * Bugfixes in pollbchan_send():&n; *   - Using lock field of skbuff breaks networking.&n; *   - Added channel locking&n; *   - changed dequeuing scheme.&n; * Eliminated misc. compiler warnings.&n; *&n; * Revision 1.25  1996/06/11 22:53:35  tsbogend&n; * fixed problem with large array on stack&n; * made the driver working on Linux/alpha&n; *&n; * Revision 1.24  1996/06/06 13:58:33  fritz&n; * Changed code to be architecture independent&n; *&n; * Revision 1.23  1996/06/03 19:59:00  fritz&n; * Fixed typos.&n; *&n; * Revision 1.22  1996/05/17 15:46:41  fritz&n; * Removed own queue management.&n; * Changed queue management to use sk_buffs.&n; *&n; * Revision 1.21  1996/05/02 04:01:20  fritz&n; * Bugfix:&n; *  - icn_addcard() evaluated wrong driverId.&n; *&n; * Revision 1.20  1996/05/02 00:40:27  fritz&n; * Major rewrite to support more than one card&n; * with a single module.&n; * Support for new firmware.&n; *&n; * Revision 1.19  1996/04/21 17:43:32  fritz&n; * Changes for Support of new Firmware BRV3.02&n; *&n; * Revision 1.18  1996/04/20 16:50:26  fritz&n; * Fixed status-buffer overrun.&n; * Misc. typos&n; *&n; * Revision 1.17  1996/02/11 02:39:04  fritz&n; * Increased Buffer for status-messages.&n; * Removed conditionals for HDLC-firmware.&n; *&n; * Revision 1.16  1996/01/22 05:01:55  fritz&n; * Revert to GPL.&n; *&n; * Revision 1.15  1996/01/10 20:57:39  fritz&n; * Bugfix: Loading firmware twice caused the device stop working.&n; *&n; * Revision 1.14  1995/12/18  18:23:37  fritz&n; * Support for ICN-2B Cards.&n; * Change for supporting user-settable service-octet.&n; *&n; * Revision 1.13  1995/10/29  21:41:07  fritz&n; * Added support for DriverId&squot;s, added Jan&squot;s patches for Kernel versions.&n; *&n; * Revision 1.12  1995/04/29  13:07:35  fritz&n; * Added support for new Euro-ISDN-firmware&n; *&n; * Revision 1.11  1995/04/23  13:40:45  fritz&n; * Added support for SPV&squot;s.&n; * Changed Dial-Command to support MSN&squot;s on DSS1-Lines.&n; *&n; * Revision 1.10  1995/03/25  23:23:24  fritz&n; * Changed configurable Ports, to allow settings for DIP-Switch Cardversions.&n; *&n; * Revision 1.9  1995/03/25  23:17:30  fritz&n; * Fixed race-condition in pollbchan_send&n; *&n; * Revision 1.8  1995/03/15  12:49:44  fritz&n; * Added support for SPV&squot;s&n; * Split pollbchan_work for calling send-routine directly&n; *&n; * Revision 1.7  1995/02/20  03:48:03  fritz&n; * Added support of new request_region-function.&n; * Minor bugfixes.&n; *&n; * Revision 1.6  1995/01/31  15:48:45  fritz&n; * Added Cause-Messages to be signaled to upper layers.&n; * Added Revision-Info on load.&n; *&n; * Revision 1.5  1995/01/29  23:34:59  fritz&n; * Added stopdriver() and appropriate calls.&n; * Changed printk-statements to support loglevels.&n; *&n; * Revision 1.4  1995/01/09  07:40:46  fritz&n; * Added GPL-Notice&n; *&n; * Revision 1.3  1995/01/04  05:15:18  fritz&n; * Added undocumented &quot;bootload-finished&quot;-command in download-code&n; * to satisfy some brain-damaged icn card-versions.&n; *&n; * Revision 1.2  1995/01/02  02:14:45  fritz&n; * Misc Bugfixes&n; *&n; * Revision 1.1  1994/12/14  17:56:06  fritz&n; * Initial revision&n; *&n; */
