...
l_int|NULL
suffix:semicolon
multiline_comment|/* ISA PnP devices */
DECL|variable|isapnp_last_device
r_static
r_struct
id|pci_dev
op_star
id|isapnp_last_device
op_assign
l_int|NULL
suffix:semicolon
...
op_assign
id|DEVICE_DMA_SPEED_COMPATIBLE
suffix:semicolon
)brace
r_for
c_loop
...
(brace
multiline_comment|/* IRQ priority: table is good for i386 */
r_static
r_int
r_int
id|xtab
...
DECL|function|isapnp_free_device
r_static
r_void
id|isapnp_free_device
c_func
(paren
r_struct
id|pci_dev
