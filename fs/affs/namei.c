...
multiline_comment|/* Simple toupper()/tolower() for DOS&bslash;1 */
r_static
r_inline
r_int
r_int
...
multiline_comment|/* International toupper()/tolower() for DOS&bslash;3 (&quot;international&quot;) */
r_static
r_inline
r_int
r_int
...
r_int
r_int
DECL|function|affs_intl_tolower
id|affs_intl_tolower
c_func
(paren
r_int
r_int
...
multiline_comment|/* We need 2 sets of dentry operations, since we cannot&n; * determine the fs flavour in the callback routines.&n; */
r_static
r_int
id|affs_hash_dentry
c_func
...
suffix:semicolon
DECL|variable|affs_dentry_operations_intl
r_struct
id|dentry_operations
...
r_static
r_int
DECL|function|affs_hash_dentry_intl
id|affs_hash_dentry_intl
c_func
(paren
r_struct
...
r_static
r_int
DECL|function|affs_compare_dentry_intl
id|affs_compare_dentry_intl
c_func
(paren
r_struct
...
multiline_comment|/* This is copied from the ext2 fs. No need to reinvent the wheel. */
r_static
r_int
