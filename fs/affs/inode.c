...
c_func
(paren
l_string|&quot;Trying bs=%d bytes, root at %d, size=%d blocks (%d reserved)&bslash;n&quot;
comma
id|blocksize
comma
id|s-&gt;u.affs_sb.s_root_block
...
c_func
(paren
l_string|&quot;AFFS: Unsupported filesystem on device %s: %08X&bslash;n&quot;
comma
id|kdevname
c_func
(paren
...
multiline_comment|/* Allocate space for bitmap pointers and read the bitmap */
id|size
op_assign
id|s-&gt;u.affs_sb.s_partition_size
op_minus
...
c_func
(paren
l_string|&quot;AFFS: Can&squot;t get memory for bitmap info.&bslash;n&quot;
)paren
suffix:semicolon
r_goto
id|out
...
c_func
(paren
l_string|&quot;AFFS: %d bitmap blocks&bslash;n&quot;
comma
id|num_bm
)paren
suffix:semicolon
...
multiline_comment|/*&amp;&amp;&n;&t;&t;&t;&t;    !(s-&gt;s_flags &amp; MS_RDONLY)*/
)paren
(brace
id|printk
c_func
...
suffix:semicolon
multiline_comment|/* no need to mark buffer as dirty */
)brace
id|ptype
op_assign
(paren
...
multiline_comment|/* If the fs is mounted r/w, create data zones, else free bitmaps. */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;AFFS: add_entry(dir=%lu,inode=%lu,&bslash;&quot;%*s&bslash;&quot;,type=%ld&bslash;n&quot;
comma
id|dir-&gt;i_ino
comma
id|inode-&gt;i_ino
