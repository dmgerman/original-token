...
(brace
multiline_comment|/* #Specification: pseudo root / DOS/linux&n;&t;&t;&t; * Even in the real root directory (c:&bslash;), the directory&n;&t;&t;&t; * /linux won&squot;t show&n;&t;&t;&t; */
id|printk
c_func
(paren
id|KERN_WARNING
...
suffix:semicolon
multiline_comment|/* make the dentry negative */
id|d_delete
c_func
(paren
id|dentry
...
id|out_check
suffix:semicolon
macro_line|#if 0&t;/* why do this? we have the dentry ... */
id|ret
op_assign
id|UMSDOS_rlookup
(paren
...
id|out_check
suffix:colon
multiline_comment|/* Check whether we succeeded ... */
r_if
c_cond
(paren
op_logical_neg
