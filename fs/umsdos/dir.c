...
id|printk
(paren
l_string|&quot;umsdos_dentry_to_entry: ino=%ld, err=%d&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|err
...
c_func
(paren
l_string|&quot;umsdos_solve_hlink: following %s/%s&bslash;n&quot;
comma
...
id|printk
(paren
l_string|&quot;umsdos_solve_hlink: %s/%s is path %s&bslash;n&quot;
comma
id|hlink-&gt;d_parent-&gt;d_name.name
comma
id|hlink-&gt;d_name.name
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Hack alert! inode-&gt;u.umsdos_i.i_emd_dir isn&squot;t reliable,&n;&t;&t; * so just check whether there&squot;s an EMD file ...&n;&t;&t; */
id|real
op_assign
l_int|1
suffix:semicolon
...
id|printk
(paren
l_string|&quot;umsdos_solve_hlink: dir %s/%s, name=%s, emd_dir=%ld, real=%d&bslash;n&quot;
comma
