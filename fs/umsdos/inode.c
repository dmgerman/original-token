...
multiline_comment|/*&n; * Add some info into an inode so it can find its owner quickly&n; * Note: Deprecated; use above function if possible.&n; */
...
op_logical_neg
id|pseudo_ok
multiline_comment|/* &amp;&amp; msdos_lookup (pseudo, &quot;sbin&quot;, 4, sbin)==0 */
op_logical_and
id|msdos_lookup
(paren
id|pseudo
