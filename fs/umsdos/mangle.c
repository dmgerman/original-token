multiline_comment|/*&n; *  linux/fs/umsdos/mangle.c&n; *&n; *      Written 1993 by Jacques Gelinas &n; *&n; * Control the mangling of file name to fit msdos name space.&n; * Many optimisation by GLU == dglaude@is1.vub.ac.be (GLAUDE DAVID)&n; */
...
multiline_comment|/* #Specification: file name / non MSDOS conforming / base length 0&n;&t;&t; * file name beginning with a period &squot;.&squot; are invalid for MsDOS.&n;&t;&t; * It needs absolutely a base name. So the file name is mangled&n;&t;&t; */
r_int
id|ivldchar
op_assign
id|fname
...
id|base_len
suffix:semicolon
multiline_comment|/*&n;&t;&t; * cardinal_per_size tells if there exist at least one&n;&t;&t; * DOS pseudo devices on length n. See the test below.&n;&t;&t; */
r_static
r_const
r_char
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * lkp translate all character to acceptable character (for DOS).&n;&t;&t; * When lkp[n] == n, it means also it is an acceptable one.&n;&t;&t; * So it serve both as a flag and as a translator.&n;&t;&t; */
r_static
r_char
id|lkp
(braket
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Initialisation of the array is easier and less error prone&n;&t;&t;&t; * like this.&n;&t;&t;&t; */
r_int
id|i
suffix:semicolon
r_static
...
multiline_comment|/*  GLU&n;&t;&t; * file name which are longer than 8+&squot;.&squot;+3 are invalid for MsDOS.&n;&t;&t; * So the file name is to be mangled no more test needed.&n;&t;&t; * This Speed Up for long and very long name.&n;&t;&t; * The position of the last point is no more necessary anyway.&n;&t;&t; */
r_if
c_cond
(paren
id|len
...
(brace
multiline_comment|/* #Specification: file name / non MSDOS conforming / last char == .&n;&t;&t;&t;&t;&t;&t;&t; * If the last character of a file name is&n;&t;&t;&t;&t;&t;&t;&t; * a period, mangling is applied. MsDOS do&n;&t;&t;&t;&t;&t;&t;&t; * not support those file name.&n;&t;&t;&t;&t;&t;&t;&t; */
id|ivldchar
op_assign
l_int|1
suffix:semicolon
...
l_char|&squot;&bslash;0&squot;
suffix:semicolon
multiline_comment|/* GLU  C&squot;est sur on a un 0 a la fin */
id|info-&gt;msdos_reject
op_assign
l_int|1
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* GLU  C&squot;est sur on a un 0 a la fin */
multiline_comment|/*&n;&t;&t;&t;&t;&t; * GLU        On ne fait cela que si necessaire, on essaye d&squot;etre le&n;&t;&t;&t;&t;&t; * GLU        simple dans le cas general (le plus frequent).&n;&t;&t;&t;&t;&t; */
id|info-&gt;fake.fname
(braket
l_int|0
)braket
...
suffix:semicolon
multiline_comment|/* Help doing printk */
multiline_comment|/* GLU      Ce zero devrais deja y etre ! (invariant ?) */
id|info-&gt;fake.len
op_assign
id|msdos_len
suffix:semicolon
...
multiline_comment|/*&n;&t; * Evaluate how many record are needed to store this entry.&n;&t; */
id|info-&gt;recsize
op_assign
id|umsdos_evalrecsize
(paren
...
comma
macro_line|#elseif
multiline_comment|/*&n; * Je trouve les trois exemples ci-dessous tres &quot;malheureux&quot;.&n; * Je propose de mettre en minuscule dans un passe preliminaire,&n; * et de tester apres si il y a d&squot;autres caracters &quot;mechants&quot;.&n; * Bon, je ne l&squot;ai pas fait, parceque ce n&squot;est pas si facilement&n; * modifiable que ca. Mais c&squot;est pour le principe.&n; * Evidemment cela augmente les chances de &quot;Collision&quot;,&n; * par exemple: entre &quot;HELLO&quot; et &quot;Hello&quot;, mais ces problemes&n; * peuvent etre traiter ailleur avec les autres collisions.&n; */
l_string|&quot;HELLO&quot;
comma
l_int|1
comma
...
l_string|&quot;-prn&quot;
comma
multiline_comment|/* &n;   * GLU        ATTENTION : Le resultat de ceux-ci sont differents avec ma version&n;   * GLU        du mangle par rapport au mangle originale.&n;   * GLU        CAUSE: La maniere de calculer la variable baselen. &n;   * GLU                Pour toi c&squot;est toujours 3&n;   * GLU                Pour moi c&squot;est respectivement 7, 8 et 8&n;   */
l_string|&quot;PRN.abc&quot;
comma
l_int|1
comma
