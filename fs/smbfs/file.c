...
suffix:semicolon
multiline_comment|/* Pick the first dentry for this inode. */
id|head
op_assign
op_amp
id|inode-&gt;i_dentry
...
suffix:semicolon
multiline_comment|/* We need one, are we guaranteed to have one?  */
id|dentry
op_assign
id|list_entry
c_func
...
id|smb_readpage
comma
multiline_comment|/* writepage: smb_writepage, */
id|prepare_write
suffix:colon
id|smb_prepare_write
comma
