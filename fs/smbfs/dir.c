...
multiline_comment|/*&n; * Note: in order to allow the smbclient process to open the&n; * mount point, we don&squot;t revalidate for the connection pid.&n; */
r_static
r_int
...
c_func
(paren
l_string|&quot;smb_dir_open: smbclient process&bslash;n&quot;
)paren
suffix:semicolon
r_return
id|error
