...
c_func
(paren
l_string|&quot;smb_proc_open: %s/%s failed, error=%d, access=%d&bslash;n&quot;
comma
id|dentry-&gt;d_parent-&gt;d_name.name
comma
id|dentry-&gt;d_name.name
...
multiline_comment|/*&n; * Called with the server locked.&n; *&n; * Win NT 4.0 has an apparent bug in that it fails to update the&n; * modify time when writing to a file. As a workaround, we update&n; * the attributes if the file has been modified locally (we want to&n; * keep modify and access times in sync ...)&n; */
r_static
r_int
...
(brace
multiline_comment|/*&n;&t;&t; * Check whether to update locally-modified attributes at&n;&t;&t; * closing time. This is necessary to keep the modify and&n;&t;&t; * access times in sync.&n;&t;&t; *&n;&t;&t; * Kludge alert: If we&squot;re using trans2 getattr messages,&n;&t;&t; * the timestamps are accurate only to two seconds ...&n;&t;&t; * we must round the time to avoid cache invalidations!&n;&t;&t; */
r_if
c_cond
(paren
id|ino-&gt;u.smbfs_i.access
...
(brace
multiline_comment|/* N.B. check for read-only directories */
id|fattr-&gt;f_mode
op_assign
...
multiline_comment|/*&n; * In the core protocol there is only one time to be set,&n; * so we use fattr-&gt;f_mtime to make `touch&squot; work.&n; * Note: called with the server locked.&n; */
r_static
r_int
...
c_func
(paren
l_string|&quot;setattr_core: %s/%s, mtime=%ld&bslash;n&quot;
comma
id|dir-&gt;d_parent-&gt;d_name.name
comma
id|dir-&gt;d_name.name
...
multiline_comment|/*&n; * Set the attributes for an open file.&n; */
r_static
r_int
DECL|function|smb_proc_setfile_trans2
id|smb_proc_setfile_trans2
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;smb_proc_setfile_trans2: date=%x, time=%x, atime=%ld&bslash;n&quot;
comma
id|date
comma
id|time
