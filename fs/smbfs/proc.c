...
id|byte
op_star
DECL|function|smb_decode_dword
id|smb_decode_dword
c_func
(paren
id|byte
...
multiline_comment|/* smb_proc_do_create: We expect entry-&gt;attry &amp; entry-&gt;ctime to be set. */
r_static
r_int
DECL|function|smb_proc_do_create
id|smb_proc_do_create
c_func
(paren
r_struct
id|smb_server
