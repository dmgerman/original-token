multiline_comment|/*&n; *  proc.c&n; *&n; *  Copyright (C) 1995, 1996 by Paal-Kr. Engstad and Volker Lendecke&n; *&n; *  28/06/96 - Fixed long file name support (smb_proc_readdir_long) by Yuri Per&n; */
...
DECL|macro|SMB_CMD
mdefine_line|#define SMB_CMD(packet)  (BVAL(packet,8))
DECL|macro|SMB_WCT
mdefine_line|#define SMB_WCT(packet)  (BVAL(packet, SMB_HEADER_LEN - 1))
DECL|macro|SMB_BCC
...
id|byte
op_star
DECL|function|smb_encode_this_name
id|smb_encode_this_name
c_func
(paren
id|byte
op_star
...
multiline_comment|/* I put smb_encode_parents into a separate function so that the&n;   recursion only takes 16 bytes on the stack per path component on a&n;   386. */
r_static
id|byte
op_star
DECL|function|smb_encode_parents
id|smb_encode_parents
c_func
(paren
id|byte
op_star
...
c_func
(paren
l_string|&quot;len: %d, wct: %d, bcc: %d&bslash;n&quot;
comma
id|smb_len
c_func
(paren
...
c_func
(paren
l_string|&quot;smb_proc_open: name=%s&bslash;n&quot;
comma
id|name
)paren
suffix:semicolon
...
l_int|3
suffix:semicolon
multiline_comment|/* Skipping VBLOCK header&n;&t;&t;&t;&t;   (5, length lo, length hi). */
...
suffix:semicolon
multiline_comment|/* entry-&gt;name is null terminated from smb_init_dirent */
r_return
id|result
suffix:semicolon
)brace
...
(brace
multiline_comment|/* We do not distinguish between the client&n;&t;&t;&t;   requests and the server response. */
id|given_max_xmit
op_assign
id|server-&gt;max_xmit
suffix:semicolon
