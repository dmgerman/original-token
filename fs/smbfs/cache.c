...
(brace
multiline_comment|/* not in cache, alloc a new page if we didn&squot;t do it yet */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
multiline_comment|/* smb code assumes pages are zeroed */
id|clear_page
c_func
(paren
id|page_address
...
(paren
id|KERN_DEBUG
l_string|&quot;smbfs: get_cached_page&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
multiline_comment|/* Hmm, a page has materialized in the&n;                           cache. Fine. Go back and get that page&n;                          instead... */
r_goto
id|again
suffix:semicolon
id|cached_page
...
(paren
id|KERN_DEBUG
l_string|&quot;smbfs: get_cached_page done&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
