...
(brace
multiline_comment|/* not in cache, alloc a new page */
id|new_page
op_assign
id|page_cache_alloc
c_func
...
(brace
multiline_comment|/* Hmm, a page has materialized in the&n;                           cache. Fine. Go back and get that page&n;                           instead ... throwing away this one first. */
id|put_cached_page
c_func
(paren
(paren
...
(paren
id|KERN_ERR
l_string|&quot;smbfs/cache.c: page isn&squot;t locked! This could be fun ...&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return
