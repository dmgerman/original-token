...
c_func
(paren
l_string|&quot;smb_receive: recv error = %d&bslash;n&quot;
comma
op_minus
id|result
)paren
...
c_func
(paren
l_string|&quot;smb_receive: got 0 bytes&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;smb_receive: Got SESSION KEEP ALIVE&bslash;n&quot;
)paren
suffix:semicolon
id|sock-&gt;ops
op_member_access_from_pointer
...
c_func
(paren
l_string|&quot;smb_receive: Invalid packet&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/* Length not including first four bytes. */
id|len
op_assign
id|smb_len
c_func
...
c_func
(paren
l_string|&quot;smb_receive: Received length (%d) &gt; max_xmit (%d)!&bslash;n&quot;
comma
id|len
comma
id|server-&gt;max_xmit
...
c_func
(paren
l_string|&quot;SMB: notice message: error = %d&bslash;n&quot;
comma
op_minus
id|result
)paren
...
c_func
(paren
l_string|&quot;smb_response: rcls=%d, err=%d&bslash;n&quot;
comma
id|server-&gt;rcls
comma
id|server-&gt;err
