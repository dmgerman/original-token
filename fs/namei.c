...
c_func
(paren
id|nd-&gt;dentry-&gt;d_covers-&gt;d_parent
)paren
suffix:semicolon
id|dput
c_func
...
multiline_comment|/*&n; * Restricted form of lookup. Doesn&squot;t follow links, single-component only,&n; * needs parent already locked. Doesn&squot;t follow mounts.&n; */
...
id|error
suffix:semicolon
multiline_comment|/*&n;&t;&t; * It&squot;s not obvious that open(&quot;.&quot;, O_CREAT, foo) should&n;&t;&t; * fail, but it&squot;s even less obvious that it should succeed.&n;&t;&t; * Since O_CREAT means an intention to create the thing and&n;&t;&t; * open(2) had never created directories, count it as caller&squot;s&n;&t;&t; * luserdom and let him sod off - -EISDIR it is.&n;&t;&t; */
id|error
op_assign
op_minus
id|EISDIR
...
m_exit
suffix:semicolon
multiline_comment|/* same for foo/ */
r_if
c_cond
(paren
id|nd-&gt;last.name
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; * With O_EXCL it would be -EEXIST.&n;&t;&t;&t;&t; * If symlink is a dangling one it&squot;s -ENOENT.&n;&t;&t;&t;&t; * Otherwise we open the object it points to.&n;&t;&t;&t;&t; */
id|error
op_assign
id|do_follow_link
c_func
