...
multiline_comment|/*&n; * Whee.. Deadlock country. Happily there are only two VFS&n; * operations that do this..&n; */
...
id|EPERM
suffix:semicolon
multiline_comment|/*&n;&t; * Check the sticky bit.&n;&t; */
r_if
c_cond
(paren
id|check_sticky
...
id|EPERM
suffix:semicolon
multiline_comment|/*&n;&t; * I suspect that these two checks are atavisms copied from minixfs&n;&t; * and it looks like they can be dropped. Anyway, it will be simpler&n;&t; * to drop them from here and even if those checks are needed they&n;&t; * belong to VFS.&n;&t; */
r_if
c_cond
(paren
id|dir
...
id|EPERM
suffix:semicolon
multiline_comment|/*&n;&t; * Non-directories can&squot;t be rmdir&squot;d. It may confuse the heck of&n;&t; * NFS and CODA. Testing it in VFS is the Right Thing (tm), anyway.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/*&n;&t; * We try to drop the dentry early: we should have&n;&t; * a usage count of 2 if we&squot;re the only user of this&n;&t; * dentry, and if that is true (possibly after pruning&n;&t; * the dcache), then we drop the dentry now.&n;&t; *&n;&t; * A low-level filesystem can, if it choses, legally&n;&t; * do a&n;&t; *&n;&t; *&t;if (!list_empty(&amp;dentry-&gt;d_hash))&n;&t; *&t;&t;return -EBUSY;&n;&t; *&n;&t; * if it cannot handle the case of removing a directory&n;&t; * that is still in use by something else..&n;&t; */
r_switch
c_cond
(paren
id|dentry-&gt;d_count
...
id|exit_dput
suffix:semicolon
multiline_comment|/*&n;&t; * The dentry-&gt;d_count stuff confuses d_delete() enough to&n;&t; * not kill the inode from under us while it is locked. This&n;&t; * wouldn&squot;t be needed, except the dentry semaphore is really&n;&t; * in the inode, not in the dentry..&n;&t; */
id|dentry-&gt;d_count
op_increment
suffix:semicolon
id|dir
...
suffix:semicolon
multiline_comment|/*&n;&t; * Check that dentry still sits where it did and do the real stuff.&n;&t; */
r_if
c_cond
(paren
id|dentry-&gt;d_parent
...
id|exit_lock
suffix:semicolon
multiline_comment|/*&n;&t; * A directory can&squot;t be unlink&squot;ed.&n;&t; * A file cannot be removed from an append-only directory.&n;&t; */
id|error
op_assign
op_minus
id|EPERM
