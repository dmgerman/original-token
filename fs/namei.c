...
DECL|variable|getname_quicklist
r_char
op_star
...
l_int|NULL
suffix:semicolon
DECL|variable|getname_quickcount
r_int
id|getname_quickcount
op_assign
l_int|0
suffix:semicolon
DECL|variable|getname_quicklock
id|spinlock_t
...
multiline_comment|/* if a getname_quicklist limit is necessary to introduce, call&n;&t; * free_page((unsigned long) name);&n;&t; */
)brace
