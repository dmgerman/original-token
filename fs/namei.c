...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Ok, now we can&squot;t sleep any more. Double-check that&n;&t;&t; * nobody else added this in the meantime..&n;&t;&t; */
id|result
op_assign
id|d_lookup
c_func
...
multiline_comment|/* Internal lookup() using the new generic dcache. */
...
c_func
(paren
l_string|&quot;lookup of %s success in %s, but parent count is %d&bslash;n&quot;
comma
...
r_break
suffix:semicolon
multiline_comment|/* Last component? */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Don&squot;t check for write permission */
id|acc_mode
op_assign
l_int|0
suffix:semicolon
