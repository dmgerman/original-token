...
id|error
suffix:semicolon
macro_line|#if defined(DEBUG_SIZES) || defined(DEBUG_ALL)
id|hfs_warn
c_func
(paren
l_string|&quot;HFS inode: %d bytes available&bslash;n&quot;
comma
r_sizeof
(paren
r_struct
...
c_func
(paren
l_string|&quot;HFS super_block: %d bytes available&bslash;n&quot;
comma
r_sizeof
(paren
r_struct
...
(brace
multiline_comment|/* register_symtab(NULL); */
)brace
r_return
id|error
suffix:semicolon
