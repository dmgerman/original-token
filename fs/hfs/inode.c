...
(brace
multiline_comment|/* There is an existing inode for this file/dir.  Use it. */
op_increment
id|inode-&gt;i_count
suffix:semicolon
r_return
...
(brace
multiline_comment|/* The inode has been initialized by another process.&n;&t;&t;   Note that if hfs_put_inode() is sleeping in hfs_cat_put()&n;&t;&t;   then we still need to attach it to the entry. */
r_if
c_cond
(paren
op_logical_neg
