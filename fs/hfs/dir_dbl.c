...
multiline_comment|/*&n; * dbl_mknod()&n; *&n; * This is the mknod() entry in the inode_operations structure for&n; * regular HFS directories.  The purpose is to create a new entry&n; * in a directory, given the inode for the parent directory and the&n; * name (and its length) and the mode of the new entry (and the device&n; * number if the entry is to be a device special file).&n; */
DECL|function|dbl_mknod
r_static
r_int
id|dbl_mknod
c_func
