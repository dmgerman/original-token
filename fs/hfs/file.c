...
multiline_comment|/*&n; * hfs_bmap()&n; *&n; * This is the bmap() field in the inode_operations structure for&n; * &quot;regular&quot; (non-header) files.  The purpose is to translate an inode&n; * and a block number within the corresponding file into a physical&n; * block number.  This function just calls hfs_extent_map() to do the&n; * real work.&n; */
