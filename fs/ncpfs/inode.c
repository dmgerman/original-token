...
multiline_comment|/*&n; * This is called from iget() with the read semaphore held. &n; * The global ncp_entry_info structure has been set up by ncp_iget.&n; */
...
multiline_comment|/*&n; * Set up the ncp_entry_info pointer and get a new inode.&n; */
r_struct
id|inode
op_star
