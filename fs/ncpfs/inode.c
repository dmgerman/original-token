...
(brace
multiline_comment|/* Our task should be extremely simple here. We only have to&n;&t;   look up the information somebody else (ncp_iget) put into&n;&t;   the inode tree. The address of this information is the&n;&t;   inode-&gt;i_ino. Just to make sure everything went well, we&n;&t;   check it&squot;s there. */
r_struct
id|ncp_inode_info
op_star
id|inode_info
