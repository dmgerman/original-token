...
(brace
multiline_comment|/* Error, throw away the complete packet */
id|_recvfrom
c_func
(paren
id|sock
...
c_func
(paren
l_string|&quot;ncp_catch_watchdog: did not get SOCK_STREAM&bslash;n&quot;
)paren
suffix:semicolon
id|server-&gt;data_ready
op_assign
...
c_func
(paren
l_string|&quot;ncp_dont_catch_watchdog: did not get SOCK_STREAM&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
