...
op_assign
op_amp
id|out-&gt;coda_make_cinode.CodaFid
suffix:semicolon
r_struct
id|coda_vattr
op_star
...
op_assign
op_amp
id|out-&gt;coda_make_cinode.attr
suffix:semicolon
r_int
id|fd
op_assign
id|out-&gt;coda_make_cinode.fd
suffix:semicolon
r_struct
id|file
op_star
...
id|D_DOWNCALL
comma
l_string|&quot;make_cinode: fid = %s, ino = %ld&bslash;n&quot;
comma
id|coda_f2s
c_func
(paren
...
id|D_DOWNCALL
comma
l_string|&quot;make_cinode: no inode&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|D_DOWNCALL
comma
l_string|&quot;make_cinode: no file&bslash;n&quot;
)paren
suffix:semicolon
id|iput
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;   Unhash the dentry of the container file, as it is&n;&t;&t;&t;   still owned by the fs that stores the container&n;&t;&t;&t;   file. A more reliable solution would be to create&n;&t;&t;&t;   an new dentry owned by Coda, but that would require&n;&t;&t;&t;   knowledge of the internals of the dcache.&n;&t;&t;&t; */
id|d_drop
c_func
(paren
id|file-&gt;f_dentry
