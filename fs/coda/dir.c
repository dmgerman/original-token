...
id|EXDEV
suffix:semicolon
multiline_comment|/* if the volumeid are the same we can reuse the inode,&n;&t;   otherwise we need a new inode, since the new file &n;&t;   will have a new inode number. */
multiline_comment|/* if moving a directory, clean the dcache */
r_if
c_cond
(paren
id|S_ISDIR
