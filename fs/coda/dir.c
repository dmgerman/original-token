...
multiline_comment|/* creation routines: create, mkdir, link, symlink */
...
id|D_INODE
comma
l_string|&quot;old: %s, (%d length, %d strlen), new: %s (%d length, %d strlen).&bslash;n&quot;
comma
id|old_name
comma
id|old_length
...
suffix:semicolon
multiline_comment|/* We must prevent any new references to the&n;&t; * target while the rename is in progress, so&n;&t; * we unhash the dentry.  */
r_if
c_cond
(paren
op_logical_neg
...
id|D_SPECIAL
comma
l_string|&quot;OPEN inode number: %ld, flags %o.&bslash;n&quot;
comma
...
id|D_FILE
comma
l_string|&quot;GRAB: coda_inode_grab: ino %ld, ops at %x&bslash;n&quot;
comma
id|cont_inode-&gt;i_ino
comma
(paren
