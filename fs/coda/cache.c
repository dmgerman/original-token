...
multiline_comment|/* create a new acl cache entry and enlist it */
...
c_func
(paren
l_string|&quot;coda_cache_create: NULL sbi or cii!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
c_func
(paren
l_string|&quot;Out of memory in coda_cache_create!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
multiline_comment|/* destroy an acl cache entry */
DECL|function|coda_cache_destroy
r_static
r_void
id|coda_cache_destroy
c_func
(paren
r_struct
id|coda_cache
...
c_func
(paren
l_string|&quot;coda_cache_destroy: loose entry!&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
