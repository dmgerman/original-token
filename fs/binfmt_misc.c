...
multiline_comment|/*&n; * Find entry through id - caller has to do locking&n; */
...
suffix:semicolon
multiline_comment|/* we can use bit 3 and 5 of type for ext/magic and ext-strip&n;&t;   flag due to the nice encoding of E, M, e and m */
r_if
c_cond
(paren
(paren
...
id|dp
comma
l_string|&quot;extension stripped&bslash;n&quot;
)paren
suffix:semicolon
id|_out
suffix:colon
...
macro_line|#endif
DECL|macro|VERBOSE_STATUS
macro_line|#undef VERBOSE_STATUS
eof
