...
l_int|0x03
suffix:semicolon
multiline_comment|/* which floppy is it? */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n; * Ok, this is getblk, and it isn&squot;t very clear, again to hinder&n; * race-conditions. Most of the code is seldom used, (ie repeating),&n; * so it should be much more efficient than it looks.&n; *&n; * The algoritm is changed: better, and an elusive bug removed.&n; *&t;&t;LBT 11.11.91&n; */
DECL|macro|BADNESS
