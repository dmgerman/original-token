...
multiline_comment|/*&n; * Ok, breada can be used as bread, but additionally to mark other&n; * blocks for reading as well.&n; */
DECL|macro|NBUF
...
c_func
(paren
l_string|&quot;Buffer mem: %d buffers, %d used (last=%d), %d locked, %d dirty&bslash;n&quot;
comma
id|found
comma
id|used
