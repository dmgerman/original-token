...
suffix:semicolon
multiline_comment|/*&n;&t; * subtle. We release buffer-heads only if this is&n;&t; * the &squot;final&squot; flushpage. We have invalidated the bmap&n;&t; * cached value unconditionally, so real IO is not&n;&t; * possible anymore.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * block already exists, just mark it uptodate and&n;&t;&t;&t; * dirty:&n;&t;&t;&t; */
id|bh-&gt;b_end_io
op_assign
id|end_buffer_io_sync
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * if partially written block which has contents on&n;&t;&t;&t; * disk, then we have to read it first.&n;&t;&t;&t; * We also rely on the fact that filesystem holes&n;&t;&t;&t; * cannot be written.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|start_offset
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * block already exists, just mark it uptodate:&n;&t;&t;&t; */
id|bh-&gt;b_end_io
op_assign
id|end_buffer_io_sync
suffix:semicolon
...
mdefine_line|#define buffer_busy(bh)&t;((bh)-&gt;b_count || ((bh)-&gt;b_state &amp; BUFFER_BUSY_BITS))
