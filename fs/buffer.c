...
suffix:semicolon
multiline_comment|/* When we use bmap, we define block zero to represent&n;                   a hole.  ll_rw_page, however, may legitimately&n;                   access block zero, and we need to distinguish the&n;                   two cases. &n;&t;&t;   */
r_if
c_cond
(paren
id|bmap
...
l_string|&quot;async io complete on unlocked page&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
multiline_comment|/* OK, go ahead and complete the async IO on this page. */
id|save_flags
c_func
(paren
id|flags
...
multiline_comment|/*&n; * Generic &quot;readpage&quot; function for block devices that have the normal&n; * bmap functionality. This is most of the block device filesystems.&n; * Reads the page asynchronously --- the unlock_buffer() and&n; * mark_buffer_uptodate() functions propogate buffer state into the&n; * page struct once IO has completed.&n; */
