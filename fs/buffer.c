...
DECL|function|block_write_zero_range
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * First pass - map what needs to be mapped, initiate reads&n;&t; * on the boundaries if needed (i.e. if block is partially covered&n;&t; * _and_ is not up-to-date _and_ is not new).&n;&t; */
r_for
c_loop
(paren
id|bh
...
multiline_comment|/*&n;&t; * Now we can copy the data.&n;&t; */
r_if
c_cond
(paren
id|zerofrom
...
id|out
suffix:semicolon
multiline_comment|/*&n;&t; * Second pass: check if all out-of-range blocks are up-to-date&n;&t; * and mark the rest up-to-date and dirty.&n;&t; *&n;&t; * NOTE! This also does a direct dirty balace check,&n;&t; * rather than relying on bdflush just waking up every&n;&t; * once in a while. This is to catch (and slow down)&n;&t; * the processes that write tons of buffer..&n;&t; *&n;&t; * Note how we do NOT want to do this in the full block&n;&t; * case: full pages are flushed not by the people who&n;&t; * dirtied them, but by people who need memory. And we&n;&t; * should not penalize them for somebody else writing&n;&t; * lots of dirty pages.&n;&t; */
r_for
c_loop
(paren
id|bh
...
DECL|function|__block_read_full_page
r_static
r_inline
r_int
id|__block_read_full_page
c_func
(paren
r_struct
id|inode
