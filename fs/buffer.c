...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * If there are still a lot of dirty buffers around,&n;&t;&t; * skip the sleep and flush some more. Otherwise, we&n;&t;&t; * sleep for a while.&n;&t;&t; */
r_if
c_cond
(paren
id|balance_dirty_state
