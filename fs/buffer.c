...
multiline_comment|/*&n; * if a new dirty buffer is created we need to balance bdflush.&n; */
...
suffix:semicolon
multiline_comment|/* This buffer is dirty, maybe we need to start flushing.&n;&t; * If too high a percentage of the buffers are dirty...&n;&t; */
r_if
c_cond
(paren
id|nr_buffers_type
...
multiline_comment|/* If this is a loop device, and&n;&t; * more than half of the buffers are dirty...&n;&t; * (Prevents no-free-buffers deadlock with loop device.)&n;&t; */
r_if
c_cond
(paren
id|MAJOR
...
DECL|function|generic_block_flushpage
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * subtle. We release buffer-heads only if this is&n;&t; * the &squot;final&squot; flushpage. We invalidate the bmap&n;&t; * cached value in all cases.&n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * block already exists, just mark it dirty:&n;&t;&t;&t; */
id|bh-&gt;b_end_io
op_assign
id|end_buffer_io_sync
suffix:semicolon
...
DECL|function|block_write_one_page
r_int
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t; * Overwritten block.&n;&t;&t;&t; */
id|len
op_assign
id|blocksize
suffix:semicolon
...
id|len
suffix:semicolon
multiline_comment|/*&n;&t;&t; * we dirty buffers only after copying the data into&n;&t;&t; * the page - this way we can dirty the buffer even if&n;&t;&t; * the bh is still doing IO.&n;&t;&t; */
id|lock_kernel
c_func
(paren
)paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * if partially written block which has contents on&n;&t;&t;&t; * disk, then we have to read it first.&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n; * Start I/O on a page.&n; * This function expects the page to be locked and may return&n; * before I/O is complete. You then have to check page-&gt;locked,&n; * page-&gt;uptodate, and maybe wait on page-&gt;wait.&n; */
...
c_func
(paren
l_string|&quot;hm, no brw_page(%p) because IO already started.&bslash;n&quot;
comma
id|page
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;bh %p (%04x:%ld): count=%d, state=0x%04x&bslash;n&quot;
comma
id|p
comma
id|p-&gt;b_dev
