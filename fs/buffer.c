...
multiline_comment|/* The following two functions must operate atomically&n; * because they control the visibility of a buffer head&n; * to the rest of the kernel.&n; */
...
id|refill
suffix:semicolon
multiline_comment|/* OK, FINALLY we know that this buffer is the only one of its kind,&n;&t; * we hold a reference (b_count&gt;0), it is unlocked, and it is clean.&n;&t; */
id|init_buffer
c_func
(paren
id|bh
...
multiline_comment|/*&n; * For moronic filesystems that do not allow holes in file.&n; * we allow offset==PAGE_SIZE, bytes==0&n; */
DECL|function|block_write_cont_page
r_int
...
id|dprintk
(paren
l_string|&quot;do_kio start %d&bslash;n&quot;
comma
id|rw
)paren
suffix:semicolon
...
id|dprintk
(paren
l_string|&quot;do_kio end %d %d&bslash;n&quot;
comma
id|iosize
comma
id|err
...
c_func
(paren
l_string|&quot;brw_kiovec: iobuf not locked for I/O&quot;
)paren
suffix:semicolon
r_if
c_cond
...
id|dprintk
(paren
l_string|&quot;brw_kiovec: start&bslash;n&quot;
)paren
suffix:semicolon
...
id|dprintk
(paren
l_string|&quot;buffer %d (%d) at %p&bslash;n&quot;
comma
id|bhind
comma
id|tmp-&gt;b_blocknr
...
id|dprintk
(paren
l_string|&quot;brw_kiovec: end (%d, %d)&bslash;n&quot;
comma
id|transferred
comma
id|err
...
id|bh-&gt;b_next_free
suffix:semicolon
multiline_comment|/* If the buffer is not on the proper list,&n;&t;&t;&t;&t; * then refile it.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
id|next-&gt;b_next_free
suffix:semicolon
multiline_comment|/* If the buffer is not on the correct list,&n;&t;&t;&t;&t; * then refile it.&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* If we aren&squot;t in panic mode, don&squot;t write out too much&n;&t;&t;&t;&t; * at a time. Also, don&squot;t write out buffers we don&squot;t&n;&t;&t;&t;&t; * really have to write out yet..&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
