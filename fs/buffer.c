...
c_func
(paren
l_string|&quot;VFS: LRU block list corrupted&bslash;n&quot;
)paren
suffix:semicolon
op_star
(paren
...
DECL|function|insert_into_dirty_queue
r_static
r_void
id|insert_into_dirty_queue
c_func
(paren
r_struct
id|buffer_head
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * Tricky issue. It is legal to have an alias here,&n;&t;&t;&t; * because the buffer-cache layer can increase the&n;&t;&t;&t; * b_counter even if the buffer goes inactive&n;&t;&t;&t; * meanwhile.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|alias
...
c_func
(paren
l_string|&quot; buffer %p has nonzero alias %p which is locked!!! hoping that it will go away.&bslash;n&quot;
comma
id|bh
comma
id|alias
...
multiline_comment|/*&n; * We dont have to release all buffers here, but&n; * we have to be sure that no dirty buffer is left&n; * and no IO is going on (no buffer is locked), because&n; * we are going to free the underlying page.&n; */
