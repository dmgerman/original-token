...
multiline_comment|/*&n;&t; * If we achieved at least half of our goal, return now.&n;&t; */
r_if
c_cond
(paren
id|obtained
...
multiline_comment|/*&n;&t; * Make one more attempt to allocate some buffers.&n;&t; */
r_if
c_cond
(paren
id|grow_buffers
...
id|PAGE_SIZE
suffix:semicolon
multiline_comment|/*&n;&t; * If we got any buffers, or another task freed some, &n;&t; * return now to let this task proceed.&n;&t; */
r_if
c_cond
(paren
id|obtained
...
c_func
(paren
l_string|&quot;refill_freelist: obtained %d of %d, free list=%d&bslash;n&quot;
comma
id|obtained
comma
id|needed
...
multiline_comment|/*&n;&t; * System is _very_ low on memory ... wake up bdflush and wait.&n;&t; */
macro_line|#ifdef BUFFER_DEBUG
id|printk
c_func
(paren
l_string|&quot;refill_freelist: waking bdflush&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
id|wakeup_bdflush
...
suffix:semicolon
multiline_comment|/*&n;&t; * While we slept, other tasks may have needed buffers and entered&n;&t; * refill_freelist.  This could be a big problem ... reset the &n;&t; * needed amount to the absolute minimum.&n;&t; */
id|needed
op_assign
id|size
suffix:semicolon
