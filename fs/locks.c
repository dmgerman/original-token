...
l_int|NULL
suffix:semicolon
DECL|variable|unused_file_locks
r_static
r_struct
id|file_lock
op_star
id|unused_file_locks
op_assign
l_int|NULL
suffix:semicolon
multiline_comment|/*&n; * Free lock not inserted in any queue&n; *&n; * Careful! We can&squot;t just &quot;kfree()&quot; it: there may be other processes&n; * that have yet to remove themselves from the wait queues. Thus the&n; * internal memory management.&n; */
...
DECL|function|posix_remove_locks
r_static
r_void
id|posix_remove_locks
c_func
...
DECL|function|flock_remove_locks
r_static
r_void
id|flock_remove_locks
c_func
...
id|repeat
suffix:colon
multiline_comment|/* Check that there are locks, and that they&squot;re not F_FLOCK locks.&n;&t; */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Try to create a FLOCK lock on filp. We always insert new locks at&n; * the head of the list.&n; */
...
l_int|NULL
suffix:semicolon
id|retval-&gt;fl_nextlink
op_assign
l_int|NULL
suffix:semicolon
id|retval-&gt;fl_prevlink
op_assign
l_int|NULL
suffix:semicolon
id|retval-&gt;fl_block
