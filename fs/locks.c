...
suffix:semicolon
DECL|macro|acquire_fl_sem
mdefine_line|#define acquire_fl_sem()&t;down(&amp;file_lock_sem)
DECL|macro|release_fl_sem
mdefine_line|#define release_fl_sem()&t;up(&amp;file_lock_sem)
