...
id|sde
suffix:semicolon
multiline_comment|/* Copy the directory entry first, because the directory&n;&t;&t;&t;&t; * might be modified while we sleep in put_fs_byte...&n;&t;&t;&t;&t; */
id|memcpy
c_func
(paren
op_amp
