...
multiline_comment|/* We don&squot;t trust the value of&n;   sb-&gt;sv_sbd-&gt;s_tinode = *sb-&gt;sv_sb_total_free_inodes&n;   but we nevertheless keep it up to date. */
...
c_func
(paren
l_string|&quot;sysv_free_inode: inode has no device&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
c_func
(paren
l_string|&quot;sysv_free_inode: inode has nlink=%d&bslash;n&quot;
comma
id|inode-&gt;i_nlink
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;sysv_free_inode: inode on nonexistent device&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
