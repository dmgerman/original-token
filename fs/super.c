...
id|s
suffix:semicolon
multiline_comment|/* N.B. s_dev should be cleared in type-&gt;read_super */
id|fail
suffix:colon
id|s-&gt;s_dev
op_assign
...
id|dput_and_out
suffix:semicolon
multiline_comment|/*&n;&t; * Check whether to read the super block&n;&t; */
id|sb
op_assign
id|get_super
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; * Initialize the dirty inode list headers for the super blocks&n;&t; */
r_for
c_loop
(paren
id|i
