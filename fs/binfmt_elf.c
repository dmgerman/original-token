...
suffix:semicolon
multiline_comment|/*&n;&t; * First calculate the maximum range of VMA that we need to&n;&t; * use, and then allocate the entire thing.  Then unmap&n;&t; * and remap the individual portions of the file to the&n;&t; * correct address.&n;&t; */
r_if
c_cond
(paren
id|interp_elf_ex-&gt;e_type
...
r_else
(brace
multiline_comment|/*&n;&t;     * For normal executables, we do not use this offset,&n;&t;     * since the vaddr field contains an absolute address.&n;&t;     */
id|load_addr
op_assign
l_int|0
suffix:semicolon
