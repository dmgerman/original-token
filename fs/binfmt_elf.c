...
(paren
op_logical_neg
id|interpreter_dentry-&gt;d_inode-&gt;i_op
op_logical_or
op_logical_neg
id|interpreter_dentry-&gt;d_inode-&gt;i_op-&gt;default_file_ops-&gt;mmap
)paren
r_goto
id|out
suffix:semicolon
...
r_inline
r_int
DECL|function|do_load_elf_binary
id|do_load_elf_binary
c_func
(paren
r_struct
id|linux_binprm
...
suffix:semicolon
multiline_comment|/* all done with the file */
id|elf_entry
op_add_assign
id|load_bias
suffix:semicolon
...
r_inline
r_int
DECL|function|do_load_elf_library
id|do_load_elf_library
c_func
(paren
r_int
id|fd
...
id|ENOEXEC
suffix:semicolon
multiline_comment|/* N.B. save current DS?? */
id|set_fs
c_func
(paren
id|KERNEL_DS
