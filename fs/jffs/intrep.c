...
mdefine_line|#define set_current_state(x) do{current-&gt;state = x;} while (0)
macro_line|#endif
...
macro_line|#if 1
DECL|macro|_U
mdefine_line|#define _U      01
DECL|macro|_L
mdefine_line|#define _L      02
DECL|macro|_N
mdefine_line|#define _N      04
DECL|macro|_S
mdefine_line|#define _S      010
DECL|macro|_P
mdefine_line|#define _P      020
DECL|macro|_C
mdefine_line|#define _C      040
DECL|macro|_X
mdefine_line|#define _X      0100
DECL|macro|_B
mdefine_line|#define _B      0200
DECL|variable|jffs_ctype_
r_const
r_int
r_char
id|jffs_ctype_
...
suffix:semicolon
DECL|macro|jffs_isalpha
mdefine_line|#define jffs_isalpha(c)      ((jffs_ctype_+1)[(int)c]&amp;(_U|_L))
DECL|macro|jffs_isupper
mdefine_line|#define jffs_isupper(c)      ((jffs_ctype_+1)[(int)c]&amp;_U)
DECL|macro|jffs_islower
mdefine_line|#define jffs_islower(c)      ((jffs_ctype_+1)[(int)c]&amp;_L)
DECL|macro|jffs_isdigit
mdefine_line|#define jffs_isdigit(c)      ((jffs_ctype_+1)[(int)c]&amp;_N)
DECL|macro|jffs_isxdigit
mdefine_line|#define jffs_isxdigit(c)     ((jffs_ctype_+1)[(int)c]&amp;(_X|_N))
DECL|macro|jffs_isspace
mdefine_line|#define jffs_isspace(c)      ((jffs_ctype_+1)[(int)c]&amp;_S)
DECL|macro|jffs_ispunct
mdefine_line|#define jffs_ispunct(c)      ((jffs_ctype_+1)[(int)c]&amp;_P)
DECL|macro|jffs_isalnum
mdefine_line|#define jffs_isalnum(c)      ((jffs_ctype_+1)[(int)c]&amp;(_U|_L|_N))
DECL|macro|jffs_isprint
mdefine_line|#define jffs_isprint(c)      ((jffs_ctype_+1)[(int)c]&amp;(_P|_U|_L|_N|_B))
DECL|macro|jffs_isgraph
mdefine_line|#define jffs_isgraph(c)      ((jffs_ctype_+1)[(int)c]&amp;(_P|_U|_L|_N))
DECL|macro|jffs_iscntrl
mdefine_line|#define jffs_iscntrl(c)      ((jffs_ctype_+1)[(int)c]&amp;_C)
r_void
...
(paren
id|KERN_WARNING
l_string|&quot;flash: erase of region [0x%ld, 0x%ld] totally failed&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;jffs_scan_flash(): start pos = 0x%ld, end = 0x%ld&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:colon
multiline_comment|/* We have found 0xff on this block.  We have to&n;&t;&t;&t;   scan the rest of the block to be sure it is&n;&t;&t;&t;   filled with 0xff.  */
id|D1
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;jffs_scan_flash(): 0xff at pos 0x%ld.&bslash;n&quot;
comma
(paren
r_int
)paren
...
suffix:colon
multiline_comment|/* We have found 0x00 on this block.  We have to&n;&t;&t;&t;   scan as far as possible to find out how much&n;&t;&t;&t;   is dirty.  */
id|D1
c_func
(paren
id|printk
c_func
(paren
l_string|&quot;jffs_scan_flash(): 0x00 at pos 0x%ld.&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;*************** Dirty flash memory or bad inode: &quot;
l_string|&quot;hexdump(pos = 0x%ld, len = 128):&bslash;n&quot;
comma
(paren
r_int
)paren
...
multiline_comment|/* We have found the beginning of an inode.  Create a&n;&t;&t;   node for it.  */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;*** We have found this raw inode at pos 0x%ld &quot;
...
multiline_comment|/* Read the data in order to be sure it matches the&n;&t;&t;   checksum.  */
id|checksum
op_assign
id|jffs_checksum_flash
c_func
...
c_func
(paren
l_string|&quot;jffs_insert_node(): ino = %u, version = %u, name = &bslash;&quot;%s&bslash;&quot;&bslash;n&quot;
comma
id|raw_inode-&gt;ino
comma
...
(brace
multiline_comment|/* The jffs_fm struct that we got is not good enough.&n;&t;&t;   Make that space dirty.  */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;jffs_write_node(): Second &quot;
...
l_string|&quot;flash at pos 0x%ld:&bslash;n&quot;
comma
(paren
r_int
)paren
...
multiline_comment|/* Free all memory associated with a file.  */
r_int
...
(brace
multiline_comment|/* First try to remove all older versions.  */
r_for
c_loop
(paren
id|n
...
macro_line|#if 0
multiline_comment|/* Below is some example code for future use if we decide&n;&t;&t;   to implement it.  */
multiline_comment|/* This is code that isn&squot;t supported by VFS. So there aren&squot;t&n;&t;&t;   really any reasons to implement it yet.  */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;%s%s (ino: %u, highest_version: %u, size: %u)&bslash;n&quot;
comma
id|space
comma
(paren
...
c_func
(paren
l_string|&quot;JFFS: Erase failed! pos = 0x%ld&bslash;n&quot;
comma
(paren
r_int
)paren
...
r_int
DECL|function|jffs_garbage_collect
id|jffs_garbage_collect
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;***jffs_garbage_collect(): fmc-&gt;dirty_size = %u&bslash;n&quot;
comma
id|fmc-&gt;dirty_size
)paren
)paren
...
l_int|1
suffix:semicolon
multiline_comment|/* While there is too much dirt left and it is possible&n;&t;   to garbage collect, do so.  */
r_while
c_loop
(paren
id|fmc-&gt;dirty_size
...
c_func
(paren
l_string|&quot;***jffs_garbage_collect(): round #%u, &quot;
