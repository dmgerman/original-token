...
c_func
(paren
l_string|&quot;pgpos: %08x, bl: %d&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;pgpos2: %08x, bl: %d&bslash;n&quot;
comma
(paren
r_int
)paren
...
singleline_comment|//if ((status = block_write_cont_page(file, page, PAGE_SIZE, 0, NULL)) &lt; 0) goto out;
id|printk
c_func
(paren
l_string|&quot;C&bslash;n&quot;
...
id|ppos
comma
multiline_comment|/*hpfs_write_partial_page*/
