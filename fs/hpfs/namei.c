...
multiline_comment|/*shrink_dcache_parent(dentry);&n;&t;if (dentry-&gt;d_count &gt; 1) {*/
r_if
c_cond
(paren
op_logical_neg
...
DECL|function|hpfs_follow_link
r_struct
id|dentry
op_star
id|hpfs_follow_link
...
id|old_dir-&gt;i_sb
comma
l_string|&quot;hpfs_rename: grrr, could not get inode&quot;
)paren
suffix:semicolon
id|err
op_assign
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Do not allow to move mount points */
r_goto
id|end1_
suffix:semicolon
)brace
...
id|new_dir-&gt;i_sb
comma
l_string|&quot;hpfs_rename: could not find dirent #2&quot;
)paren
suffix:semicolon
r_goto
id|end1
