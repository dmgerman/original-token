...
DECL|macro|FAT_COPY_TO_USER
mdefine_line|#define FAT_COPY_TO_USER(uaddr, kaddr, len) copy_to_user(uaddr, kaddr, len)
macro_line|#else
macro_line|#include &lt;asm/segment.h&gt;
DECL|macro|FAT_COPY_TO_USER
mdefine_line|#define FAT_COPY_TO_USER(uaddr, kaddr, len) memcpy_tofs(uaddr, kaddr, len)
macro_line|#endif
...
id|printk
(paren
l_string|&quot;MSDOS FS: Using IO charset %s&bslash;n&quot;
comma
id|opts-&gt;iocharset
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;fat_read_super: Did not find valid FSINFO signature. Found 0x%x&bslash;n&quot;
comma
id|CF_LE_L
c_func
(paren
