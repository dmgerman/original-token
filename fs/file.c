...
multiline_comment|/*&n; * Allocate an fd array, using get_free_page() if possible.&n; * Note: the array isn&squot;t cleared at allocation time.&n; */
...
multiline_comment|/*&n; * Allocate an fdset array, using get_free_page() if possible.&n; * Note: the array isn&squot;t cleared at allocation time.&n; */
