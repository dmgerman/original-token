...
macro_line|#endif
DECL|macro|PREP_PAGE_RPC
mdefine_line|#define PREP_PAGE_RPC(code)&t;&bslash;&n;  if (!(p0 = (int*)__get_free_page(GFP_KERNEL)))&bslash;&n;&t;return NFSERR_IO;&bslash;&n;  p=nfs_rpc_header(p0,code)
r_static
r_int
op_star
id|nfs_rpc_header
