...
multiline_comment|/*&n; * Cancel all writeback requests, both pending and in process.&n; */
r_static
r_void
...
c_func
(paren
l_string|&quot;NFS: %4d nfs_wback_lock (status %d flags %x)&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|task-&gt;tk_status
...
c_func
(paren
l_string|&quot;NFS: %4d nfs_wback_result (status %d)&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|task-&gt;tk_status
...
id|task-&gt;tk_status
suffix:semicolon
multiline_comment|/* Remove request from writeback list and wake up tasks&n;&t; * sleeping on it. */
id|remove_write_request
c_func
(paren
op_amp
...
(brace
multiline_comment|/*&n;&t;&t; * An error occurred. Report the error back to the&n;&t;&t; * application by adding the failed request to the&n;&t;&t; * inode&squot;s error list.&n;&t;&t; */
r_if
c_cond
(paren
id|find_failed_request
