...
suffix:semicolon
id|rtreq.nlh.nlmsg_type
op_assign
id|RTMSG_NEWROUTE
suffix:semicolon
id|rtreq.nlh.nlmsg_len
op_assign
r_sizeof
(paren
id|rtreq
...
suffix:semicolon
id|rtreq.rtm.rtmsg_ifindex
op_assign
id|bootp_dev-&gt;ifindex
suffix:semicolon
id|rtreq.rtm.rtmsg_flags
op_assign
id|RTF_UP
suffix:semicolon
id|fs
