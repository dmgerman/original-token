...
mdefine_line|#define NFSDBG_FACILITY&t;&t;NFSDBG_ROOT
multiline_comment|/* Range of privileged ports */
DECL|macro|STARTPORT
mdefine_line|#define STARTPORT&t;&t;600
DECL|macro|ENDPORT
mdefine_line|#define ENDPORT&t;&t;&t;1023
DECL|macro|NPORTS
mdefine_line|#define NPORTS&t;&t;&t;(ENDPORT - STARTPORT + 1)
...
(paren
id|KERN_ERR
l_string|&quot;BOOTP: Failed to add route&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
id|bootp_xmit_sock-&gt;sk-&gt;broadcast
op_assign
l_int|1
suffix:semicolon
id|bootp_xmit_sock-&gt;sk-&gt;reuse
op_assign
l_int|1
suffix:semicolon
id|bootp_recv_sock-&gt;sk-&gt;reuse
op_assign
l_int|1
suffix:semicolon
r_if
...
(paren
l_string|&quot;Root-NFS: Portmapper on server returned %d &quot;
l_string|&quot;as mountd port&bslash;n&quot;
comma
id|port
)paren
suffix:semicolon
