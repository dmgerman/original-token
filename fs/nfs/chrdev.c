multiline_comment|/*&n; *  linux/fs/nfs/chrdev.c&n; *&n; *  Copyright (C) 1991, 1992  Linus Torvalds&n; */
...
multiline_comment|/*&n; * Called every time a nfs character special file is opened&n; */
...
suffix:semicolon
DECL|variable|nfs_chrdev_inode_operations
r_struct
id|inode_operations
