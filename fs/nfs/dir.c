...
op_increment
suffix:semicolon
multiline_comment|/* skip fileid */
multiline_comment|/* Skip len, name, and cookie. */
id|skip
op_assign
...
suffix:semicolon
multiline_comment|/* Recover from a revalidation flush.  The case here is that&n; * the inode for the directory got invalidated somehow, and&n; * all of our cached information is lost.  In order to get&n; * a correct cookie for the current readdir request from the&n; * user, we must (re-)fetch older readdir page cache entries.&n; */
DECL|function|refetch_to_readdir_off
r_static
r_int
id|refetch_to_readdir_off
c_func
(paren
r_struct
id|file
...
id|p
suffix:semicolon
multiline_comment|/* Skip the cookie. */
id|p
op_assign
(paren
(paren
...
multiline_comment|/* Invalidate directory cookie caches and EOF marker&n; * for an inode.&n; */
