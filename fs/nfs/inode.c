...
c_func
(paren
l_string|&quot;nfs_fhget: impossible&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_if
...
c_func
(paren
l_string|&quot;nfs_fhget: inode %ld busy, i_count=%d, i_nlink=%d&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|inode-&gt;i_count
...
c_func
(paren
l_string|&quot;nfs_fhget: inode %ld still busy, i_count=%d&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|inode-&gt;i_count
...
c_func
(paren
l_string|&quot;nfs_fhget: killing %s/%s filehandle&bslash;n&quot;
comma
id|dentry-&gt;d_parent-&gt;d_name.name
comma
id|dentry-&gt;d_name.name
