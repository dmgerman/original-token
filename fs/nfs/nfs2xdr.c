...
mdefine_line|#define NFS_writeres_sz&t;&t;NFS_attrstat_sz
...
suffix:semicolon
multiline_comment|/* Some servers (e.g. HP OS 9.5) seem to expect the buffer size&n;&t; * to be in longwords ... check whether to convert the size.&n;&t; */
r_if
c_cond
(paren
...
multiline_comment|/*&n; * Decode the result of a readdir call.&n; */
DECL|macro|NFS_DIRENT_MAXLEN
mdefine_line|#define NFS_DIRENT_MAXLEN&t;(5 * sizeof(u32) + (NFS_MAXNAMLEN + 1))
r_static
r_int
...
multiline_comment|/* Get start and end address of XDR readdir response. */
id|p
op_assign
(paren
id|u32
...
id|len
suffix:semicolon
multiline_comment|/* Convert fileid. */
op_star
id|p
op_assign
id|ntohl
...
op_increment
suffix:semicolon
multiline_comment|/* Convert and capture len */
id|len
op_assign
op_star
id|p
...
suffix:semicolon
multiline_comment|/* Convert and capture cookie. */
id|last_cookie
op_assign
op_star
id|p
...
multiline_comment|/*&n; * Encode arguments to readlink call&n; */
...
id|name
suffix:semicolon
multiline_comment|/* Verify OK status. */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Verify OK response length. */
r_if
c_cond
(paren
(paren
...
id|errno_NFSERR_IO
suffix:semicolon
multiline_comment|/* Convert and verify that string length is in range. */
id|p
op_assign
id|iov
(braket
