...
multiline_comment|/* Now we could merge it with msdos_rename_same. Later */
...
(paren
id|KERN_ERR
l_string|&quot;msdos_rename: %s/%s inode NULL, ino=%d&bslash;n&quot;
comma
...
multiline_comment|/*&n;&t; * Potential race here. It will go away when we&squot;ll switch to&n;&t; * sane inumbers (along with a frigging lot of other races).&n;&t; */
multiline_comment|/* set new entry */
id|memcpy
c_func
(paren
id|free_de
...
suffix:semicolon
multiline_comment|/*&n;&t; * Now the tricky part. We need to change i_ino. icache ignores&n;&t; * i_ino for unhashed inodes, so we&squot;ll remove inode from hash,&n;&t; * change what we want to change and reinsert it back. NB: we&n;&t; * don&squot;t have to invalidate FAT cache here - all we need is to&n;&t; * flip i_ino in relevant cache entries. Later.&n;&t; */
