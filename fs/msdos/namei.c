...
macro_line|#ifdef whatfor
multiline_comment|/*&n;&t; * He&squot;s dead, Jim. We don&squot;t d_instantiate anymore. Should do it&n;&t; * from the very beginning, actually.&n;&t; */
id|MSDOS_I
c_func
(paren
id|inode
