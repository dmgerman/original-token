...
l_string|&quot;0x%X&bslash;r&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
l_string|&quot;MSDOS bread failed&bslash;r&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
c_func
(paren
l_string|&quot;[MS-DOS FS Rel. alpha.6, FAT %d, check=%c, conv=%c]&bslash;r&bslash;n&quot;
comma
id|MSDOS_SB
c_func
(paren
...
c_func
(paren
l_string|&quot;[me=0x%x,cs=%d,#f=%d,fs=%d,fl=%d,ds=%d,de=%d,data=%d,se=%d,ts=%d]&bslash;r&bslash;n&quot;
comma
id|b-&gt;media
comma
id|MSDOS_SB
...
c_func
(paren
l_string|&quot;Unsupported FS parameters&bslash;r&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
c_func
(paren
l_string|&quot;No bmap support&bslash;r&bslash;n&quot;
)paren
suffix:semicolon
id|s-&gt;s_magic
op_assign
...
id|this
suffix:semicolon
multiline_comment|/* printk(&quot;read inode %d&bslash;r&bslash;n&quot;,inode-&gt;i_ino); */
id|inode-&gt;i_data
(braket
id|D_BUSY
)braket
