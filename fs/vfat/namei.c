...
multiline_comment|/*&n; * Compare two vfat names.&n; */
...
DECL|variable|vfat_dentry_operations
r_static
r_struct
id|dentry_operations
id|vfat_dentry_operations
op_assign
(brace
l_int|NULL
comma
...
(brace
multiline_comment|/* XXX: i is incorrectly computed. */
r_for
c_loop
(paren
id|i
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Filenames cannot end in &squot;.&squot; or we treat like it has none */
r_if
c_cond
(paren
id|vf-&gt;len
