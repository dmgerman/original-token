...
multiline_comment|/*&n;&t; * This convinces the VFS layer to drop the old inode,&n;&t; * but at the same time fools the VFAT layer to not&n;&t; * actually delete any of the blocks in the old file&n;&t; * (because they are very much used by the renamed file)&n;&t; */
id|MSDOS_I
c_func
(paren
id|old_inode
