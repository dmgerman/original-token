...
suffix:semicolon
multiline_comment|/* Here we either have is_long and slots&gt;=0 or slots==1 */
r_if
c_cond
(paren
id|res
...
multiline_comment|/* Drop all aliases */
DECL|function|drop_aliases
r_static
r_void
id|drop_aliases
c_func
...
id|EBUSY
suffix:semicolon
multiline_comment|/* Take care of aliases */
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* If that went OK all aliases are already dropped */
)brace
r_return
id|res
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * POSIX is braindead (surprise, surprise). It requires that rename()&n;&t; * should return 0 and do nothing if the target has the same inode as&n;&t; * the source. Somebody, get a time machine, return to &squot;89 and tell&n;&t; * RMS &amp; Co *not* to do that idiocy, FAST!&n;&t; */
r_if
c_cond
(paren
id|old_dentry-&gt;d_inode
...
suffix:semicolon
multiline_comment|/*&n;&t; * Race: we can be hit by another rename after this check.&n;&t; * For the time being use fat_lock_creation(), but it&squot;s&n;&t; * ugly. FIXME.&n;&t; */
id|fat_lock_creation
c_func
(paren
)paren
...
(brace
multiline_comment|/* We can&squot;t use d_subdir() here. Arrgh. */
r_for
c_loop
(paren
id|walk
...
(brace
multiline_comment|/*&n;&t;&t; * OK, we have to remove the target. We should do it so&n;&t;&t; * that nobody might go and find it negative. Actually we&n;&t;&t; * should give warranties wrt preserving target over the&n;&t;&t; * possible crash, but that&squot;s another story. We can&squot;t&n;&t;&t; * get here with the target unhashed, so the directory entry&n;&t;&t; * must exist.&n;&t;&t; */
id|new_inode
op_assign
id|new_dentry-&gt;d_inode
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t;&t; * Target is a directory. No other owners will&n;&t;&t;&t; * be tolerated.&n;&t;&t;&t; */
id|res
op_assign
op_minus
id|EBUSY
...
id|rename_done
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; * OK, let&squot;s try to get rid of other dentries.&n;&t;&t;&t; * No need to do it if i_count is 1.&n;&t;&t;&t; */
r_if
c_cond
(paren
...
id|sinfo.ino
suffix:semicolon
multiline_comment|/* XXX: take care of other owners */
