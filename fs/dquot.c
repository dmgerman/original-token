...
op_assign
op_amp
id|dquot-&gt;dq_mnt-&gt;mnt_dquot.dqio_sem
suffix:semicolon
id|lock_dquot
c_func
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/* We don&squot;t need to search for vfsmnt each time - umount has to wait for us */
id|vfsmnt
op_assign
id|lookup_vfsmnt
c_func
