...
r_return
suffix:semicolon
multiline_comment|/*&n;&t; * If the dq_mnt pointer isn&squot;t initialized this entry needs no&n;&t; * checking and doesn&squot;t need to be written. It just an empty&n;&t; * dquot that is put back on to the freelist.&n;&t; */
r_if
c_cond
(paren
id|dquot-&gt;dq_mnt
...
multiline_comment|/*&n; * Externally referenced functions through dquot_operations in inode.&n; */
