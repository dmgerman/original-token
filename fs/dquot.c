...
DECL|function|dev_has_quota_enabled
r_static
r_inline
r_char
id|dev_has_quota_enabled
c_func
(paren
id|kdev_t
id|dev
...
c_func
(paren
l_string|&quot;remove_free_dquot: dquot not on free list??&bslash;n&quot;
)paren
suffix:semicolon
)brace
id|list_del
...
id|filp
op_assign
id|dquot-&gt;dq_mnt-&gt;mnt_dquot.files
(braket
id|type
)braket
suffix:semicolon
...
(paren
op_amp
id|dquot-&gt;dq_mnt-&gt;mnt_dquot.semaphore
)paren
suffix:semicolon
id|offset
op_assign
...
multiline_comment|/*&n;&t; * If the dq_mnt pointer isn&squot;t initialized this entry needs no&n;&t; * checking and doesn&squot;t need to be written. It&squot;s just an empty&n;&t; * dquot that is put back on to the freelist.&n;&t; */
r_if
c_cond
(paren
id|dquot-&gt;dq_mnt
...
multiline_comment|/*&n;&t;&t; * The dquot may be back in use now, so we&n;&t;&t; * must recheck the free list.&n;&t;&t; */
r_goto
id|repeat
suffix:semicolon
)brace
...
(paren
id|KERN_DEBUG
l_string|&quot;get_empty_dquot: pruning %d&bslash;n&quot;
comma
id|count
)paren
suffix:semicolon
...
r_continue
suffix:semicolon
multiline_comment|/* N.B. race problem -- filp could become unused */
r_if
c_cond
(paren
id|filp-&gt;f_mode
...
id|restart
suffix:colon
multiline_comment|/* free any quota for unused dentries */
id|shrink_dcache_sb
c_func
(paren
id|sb
...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Note: we restart after each blocking operation,&n;&t;&t; * as the inuse_filps list may have changed.&n;&t;&t; */
r_if
c_cond
(paren
id|IS_QUOTAINIT
...
suffix:semicolon
multiline_comment|/* we may have blocked ... */
r_goto
id|restart
suffix:semicolon
)brace
...
l_int|0
op_logical_and
id|dquot-&gt;dq_mnt-&gt;mnt_dquot.rsquash
(braket
id|dquot-&gt;dq_type
)braket
op_eq
...
id|CURRENT_TIME
op_plus
id|dquot-&gt;dq_mnt-&gt;mnt_dquot.inode_expire
(braket
id|type
)braket
suffix:semicolon
...
id|CURRENT_TIME
op_plus
id|dquot-&gt;dq_mnt-&gt;mnt_dquot.block_expire
(braket
id|type
)braket
suffix:semicolon
...
c_func
(paren
l_string|&quot;Cannot create dquot SLAB cache&bslash;n&quot;
)paren
suffix:semicolon
id|memset
c_func
...
l_int|NULL
suffix:semicolon
id|vfsmnt-&gt;mnt_dquot.inode_expire
(braket
id|cnt
)braket
op_assign
l_int|0
suffix:semicolon
id|vfsmnt-&gt;mnt_dquot.block_expire
(braket
id|cnt
)braket
op_assign
...
id|cleanup
suffix:semicolon
multiline_comment|/* OK, there we go */
id|set_enable_flags
c_func
(paren
id|vfsmnt
