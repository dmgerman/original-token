...
suffix:semicolon
multiline_comment|/* This may be a waste, but we only&n;&t;     need this for a moment.  The layers&n;&t;     that call this function should&n;&t;     deallocate the mem fairly soon&n;&t;     after control is returned */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
multiline_comment|/* Zero length string */
id|retnamlen
op_assign
l_int|0
suffix:semicolon
...
l_int|0
suffix:semicolon
multiline_comment|/* This file did not have a NM field */
id|out
suffix:colon
r_if
c_cond
...
multiline_comment|/* Returns the name of the file that this inode is symlinked to.  This is&n;   in malloc&squot;d memory, so it needs to be freed, once we are through with it */
DECL|function|get_rock_ridge_symlink
r_char
op_star
...
(brace
multiline_comment|/*&n;&t;    * If there is another SL record, and this component record&n;&t;    * isn&squot;t continued, then add a slash.&n;&t;    */
r_if
c_cond
(paren
(paren
