...
id|CDROM_LBA
suffix:semicolon
multiline_comment|/* If a minor device was explicitly opened, set session to the&n;&t; * minor number. For instance, if /dev/hdc1 is mounted, session&n;&t; * 1 on the CD-ROM is selected. CD_PART_MAX gives access to&n;&t; * a max of 64 sessions on IDE. SCSI drives must still use&n;&t; * the session option to mount.&n;&t; */
r_if
c_cond
(paren
(paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Check whether to update our buffer */
r_if
c_cond
(paren
id|block
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Note: this is invariant even if the record&n;&t;&t; * spans buffers and must be copied ...&n;&t;&t; */
id|reclen
op_assign
op_star
id|pnt
suffix:semicolon
multiline_comment|/* N.B. this test doesn&squot;t trigger the i++ code ... */
r_if
c_cond
(paren
id|reclen
...
suffix:semicolon
multiline_comment|/* Check whether the raw inode spans the buffer ... */
r_if
c_cond
(paren
id|offset
...
(paren
id|KERN_INFO
l_string|&quot;ISOFS: NoMem ISO inode %lu&bslash;n&quot;
comma
id|inode-&gt;i_ino
)paren
suffix:semicolon
...
(paren
id|KERN_INFO
l_string|&quot;ISOFS: unable to read i-node block %d&bslash;n&quot;
comma
id|block
)paren
suffix:semicolon
...
(paren
id|KERN_WARNING
l_string|&quot;Warning: defective CD-ROM.  Enabling &bslash;&quot;cruft&bslash;&quot; mount option.&bslash;n&quot;
)paren
suffix:semicolon
id|inode-&gt;i_sb-&gt;u.isofs_sb.s_cruft
op_assign
...
c_func
(paren
l_string|&quot;Get inode %x: %d %d: %d&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|block
...
suffix:semicolon
multiline_comment|/*&n;&t; * All done with buffer ... no more references to buffer memory!&n;&t; */
id|brelse
c_func
(paren
id|bh
...
(paren
id|KERN_WARNING
l_string|&quot;Warning: defective CD-ROM (volume sequence number). Enabling &bslash;&quot;cruft&bslash;&quot; mount option.&bslash;n&quot;
)paren
suffix:semicolon
id|inode-&gt;i_sb-&gt;u.isofs_sb.s_cruft
op_assign
