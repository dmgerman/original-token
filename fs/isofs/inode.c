...
(brace
multiline_comment|/* Note: In theory, it is possible to have Rock Ridge&n;&t;     * extensions mixed with Joliet. All character strings&n;&t;     * would just be saved as Unicode. Until someone sees such&n;&t;     * a disc, do not allow the two to be mixed&n;&t;     */
id|pri
op_assign
(paren
r_struct
