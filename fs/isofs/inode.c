...
c_func
(paren
l_string|&quot;first inode: inode=%x nextino=%x firstext=%u size=%lu&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|nextino
...
id|firstext
op_assign
id|ino-&gt;u.isofs_i.i_first_extent
suffix:semicolon
id|size
op_assign
id|ino-&gt;u.isofs_i.i_section_size
suffix:semicolon
macro_line|#ifdef DEBUG
id|printk
c_func
(paren
l_string|&quot;read inode: inode=%lu ino=%lu nextino=%lu firstext=%u size=%lu&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|nextino
comma
id|ino-&gt;u.isofs_i.i_next_section_ino
comma
id|firstext
comma
id|size
...
c_func
(paren
l_string|&quot;isofs_bmap: ino=%lu block=%d firstext=%u size=%u nextino=%lu&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|block
...
c_func
(paren
l_string|&quot;isofs_bmap: mapped inode:block %x:%d to block %lu&bslash;n&quot;
comma
id|inode-&gt;i_ino
comma
id|block
