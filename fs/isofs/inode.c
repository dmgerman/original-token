...
id|CDROM_LBA
suffix:semicolon
multiline_comment|/* If a minor device was explicitly opened, set session to the&n;       * minor number. For instance, if /dev/hdc1 is mounted, session&n;       * 1 on the CD-ROM is selected. CD_PART_MAX gives access to&n;       * a max of 64 sessions on IDE. SCSI drives must still use&n;       * the session option to mount.&n;       */
r_if
c_cond
(paren
(paren
