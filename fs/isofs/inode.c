...
multiline_comment|/*&n;&t; * Disk changed? Free the root dentry and clean up ...&n;&t; */
id|dput
c_func
(paren
id|s-&gt;s_root
...
id|out_freechar
suffix:semicolon
multiline_comment|/*&n;&t; * Display error message&n;&t; */
id|out_no_root
suffix:colon
id|printk
c_func
...
id|out_unlock
suffix:semicolon
multiline_comment|/*&n;&t; * Cascaded error cleanup to ensure all resources are freed.&n;&t; */
id|out_iput
suffix:colon
id|iput
c_func
...
c_func
(paren
l_string|&quot;isofs_read_level3_size: More than 100 file sections ?!?, aborting...&bslash;n&quot;
