...
multiline_comment|/*&n;&t; * Force the blocksize to 512 for 512 byte sectors.  The file&n;&t; * read primitives really get it wrong in a bad way if we don&squot;t&n;&t; * do this.&n;&t; */
r_if
c_cond
(paren
id|orig_zonesize
...
c_func
(paren
l_string|&quot;Directory size &lt; 0&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
