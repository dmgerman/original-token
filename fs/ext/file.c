multiline_comment|/*&n; *  linux/fs/ext/file.c&n; *&n; *  Copyright (C) 1992 Remy Card (card@masi.ibp.fr)&n; *&n; *  from&n; *&n; *  linux/fs/minix/file.c&n; *&n; *  Copyright (C) 1991, 1992 Linus Torvalds&n; *&n; *  ext regular file handling primitives&n; */
...
suffix:semicolon
multiline_comment|/*&n; * We have mostly NULL&squot;s here: the current defaults are ok for&n; * the ext filesystem.&n; */
DECL|variable|ext_file_operations
r_static
r_struct
id|file_operations
id|ext_file_operations
op_assign
(brace
l_int|NULL
comma
...
c_func
(paren
l_string|&quot;ext_file_read: inode = NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;ext_file_read: mode = %07o&bslash;n&quot;
comma
id|inode-&gt;i_mode
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;ext_file_write: inode = NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;ext_file_write: mode = %07o&bslash;n&quot;
comma
id|inode-&gt;i_mode
)paren
suffix:semicolon
