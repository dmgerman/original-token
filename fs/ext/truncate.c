multiline_comment|/*&n; *  linux/fs/ext/truncate.c&n; *&n; *  (C) 1992  Remy Card (card@masi.ibp.fr)&n; *&n; *  from&n; *&n; *  linux/fs/minix/truncate.c&n; *&n; *  (C) 1991  Linus Torvalds&n; */
...
mdefine_line|#define DINDIRECT_BLOCK ((DIRECT_BLOCK-(256+9))&gt;&gt;8)
r_if
c_cond
(paren
id|inode-&gt;i_data
...
c_func
(paren
l_string|&quot;ext_release not implemented&bslash;n&quot;
)paren
suffix:semicolon
)brace
eof
