multiline_comment|/* $Id: openpromfs.c,v 1.20 1997/07/22 06:40:07 davem Exp $&n; * openpromfs.c: /proc/openprom handling routines&n; *&n; * Copyright (C) 1996,1997 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
