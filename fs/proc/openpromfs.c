multiline_comment|/* $Id: openpromfs.c,v 1.8 1996/12/02 16:04:42 ecd Exp $&n; * openpromfs.c: /proc/openprom handling routines&n; *&n; * Copyright (C) 1996 Jakub Jelinek (jj@sunsite.mff.cuni.cz)&n; */
