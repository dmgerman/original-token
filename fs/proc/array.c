...
comma
id|p-&gt;cap_inheritable.cap
comma
id|p-&gt;cap_permitted.cap
comma
id|p-&gt;cap_effective.cap
)paren
suffix:semicolon
)brace
...
id|buffer
comma
l_string|&quot;%d (%s) %c %d %d %d %d %d %lu %lu &bslash;&n;%lu %lu %lu %lu %lu %ld %ld %ld %ld %ld %ld %lu %lu %ld %lu %lu %lu %lu %lu &bslash;&n;%lu %s %s %s %s %lu %lu %lu&bslash;n&quot;
comma
id|pid
comma
id|tsk-&gt;comm
