...
(brace
multiline_comment|/* to conserve memory, we define the strins yes and no in&n;&t;   advance */
r_char
op_star
id|yes
op_assign
...
l_string|&quot;mask&bslash;t&bslash;t: %c&bslash;n&quot;
...
id|buffer
comma
l_string|&quot;%d (%s) %c %d %d %d %d %d %lu %lu &bslash;&n;%lu %lu %lu %ld %ld %ld %ld %ld %ld %lu %lu %ld %lu %lu %u %lu %lu %lu %lu %lu %lu &bslash;&n;%lu %lu %lu %lu&bslash;n&quot;
comma
id|pid
comma
(paren
