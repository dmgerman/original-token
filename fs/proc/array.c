...
multiline_comment|/* &n; * Caller must release_mm the mm_struct later.&n; * You don&squot;t get any access to init_mm. &n; */
DECL|function|get_mm_and_lock
r_static
r_struct
id|mm_struct
op_star
...
(paren
id|KERN_DEBUG
l_string|&quot;missing pgd for mm %p&bslash;n&quot;
comma
id|mm
)paren
suffix:semicolon
...
multiline_comment|/* FIXME: this does not do proper mm locking */
