...
suffix:semicolon
multiline_comment|/* MOUNT_REWRITE: make all files have non-NULL -&gt;f_vfsmnt (pipefs, sockfs) */
multiline_comment|/* Until then... */
DECL|macro|NULL_VFSMNT
mdefine_line|#define NULL_VFSMNT&t;/* remove as soon as pipefs and sockfs will be there */
...
id|ENOMEM
suffix:semicolon
multiline_comment|/* FIXME: check that all proc_read function&n;&t; *&t;handle a dying task gracefully.&n;&t; *&t;The memory for the task structure&n;&t; *&t;won&squot;t be freed, we&squot;ve called get_task_struct().&n;&t; */
macro_line|#if 0
r_if
c_cond
(paren
...
multiline_comment|/* can we ever get here if that&squot;s the case? */
r_goto
id|out_unlock
suffix:semicolon
id|read_lock
