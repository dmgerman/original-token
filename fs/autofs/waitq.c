...
macro_line|#ifndef i386
macro_line|#error Only i386 implemented
macro_line|#endif
DECL|function|sane_pointer
r_static
r_inline
r_int
id|sane_pointer
...
DECL|function|autofs_check_waitlist_integrity
r_void
...
c_func
(paren
l_string|&quot;autofs: CHECK_WAITLIST with bogus sbi pointer: %p&bslash;n&quot;
comma
id|sbi
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;autofs(%s): wait queue pointer corrupt: &quot;
comma
id|op
)paren
suffix:semicolon
