...
multiline_comment|/*&n; * XXX we should use the real ids for checking _all_ components of the&n; * path.  Now we only use them for the final component of the path.&n; */
...
l_int|6
suffix:semicolon
multiline_comment|/* needs cleaning? */
r_else
r_if
c_cond
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * XXX we are doing this test last because we really should be&n;&t; * swapping the effective with the real user id (temporarily),&n;&t; * and then calling suser() routine.  If we do call the&n;&t; * suser() routine, it needs to be called last. &n;&t; *&n;&t; * XXX nope.  suser() is inappropriate and swapping the ids while&n;&t; * decomposing the path would be racy.&n;&t; */
r_if
c_cond
(paren
(paren
