...
suffix:semicolon
multiline_comment|/*&n;&t; * We have to do this last, because we mustn&squot;t export&n;&t; * an incomplete fd to other processes which may share&n;&t; * the same file table with us.&n;&t; */
r_for
c_loop
(paren
id|fd
