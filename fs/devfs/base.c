...
mdefine_line|#define DEVFS_VERSION            &quot;0.96 (20000430)&quot;
...
r_continue
suffix:semicolon
multiline_comment|/*  Have to create the inode right now to get the inum  */
id|di
op_assign
id|create_devfs_inode
(paren
