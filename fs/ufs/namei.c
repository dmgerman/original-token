...
multiline_comment|/*&n; * NOTE! unlike strncmp, ufs_match returns 1 for success, 0 for failure.&n; */
...
l_string|&quot;ufs_rmdir&quot;
comma
l_string|&quot;d_count=%d, pruning&bslash;n&quot;
comma
id|dentry-&gt;d_count
)paren
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * Are we deleting the last instance of a busy directory?&n;&t;&t; * Better clean up if so.&n;&t;&t; *&n;&t;&t; * Make directory empty (it will be truncated when finally&n;&t;&t; * dereferenced).  This also inhibits ufs_add_entry.&n;&t;&t; */
id|inode-&gt;i_size
op_assign
l_int|0
suffix:semicolon
...
(paren
(paren
l_string|&quot;name %s, len %u&bslash;n&quot;
comma
