...
multiline_comment|/*&n; * Here are the whole-structure swabping routines...&n; * They were fun to design, but I don&squot;t understand why we&n; * need a copy of the superblock, anyway. -- Fare&squot;&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* SUN type superblock */
r_if
c_cond
(paren
...
l_int|0
suffix:semicolon
multiline_comment|/* 4.4BSD (FreeBSD) type superblock */
...
id|fs_u.fs_sun.fs_sparecon
comma
id|fs_u.fs_sun.fs_qbmask
)paren
suffix:semicolon
multiline_comment|/* Might fail on strictly aligning 64-bit big-endian&n;                 * architectures. Ouch!&n;                 */
id|be64_to_cpus
c_func
(paren
(paren
...
op_amp
id|usb-&gt;fs_u.fs_44.fs_maxfilesize
)paren
suffix:semicolon
id|be64_to_cpus
c_func
