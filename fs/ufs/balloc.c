...
DECL|macro|UFS_BALLOC_DEBUG_MORE
macro_line|#undef UFS_BALLOC_DEBUG_MORE
...
c_func
(paren
l_string|&quot;hlaska 3, fragment %u, tmp %u, oldcount %u&bslash;n&quot;
comma
id|fragment
comma
id|tmp
