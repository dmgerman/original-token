...
mdefine_line|#define ufs_get_fs_state(usb3) _ufs_get_fs_state_(usb3,flags,swab)
...
op_member_access_from_pointer
id|fs_u.fs_44.fs_state
)paren
suffix:semicolon
)brace
DECL|macro|ufs_set_fs_state
mdefine_line|#define ufs_set_fs_state(usb3,value) _ufs_set_fs_state_(usb3,value,flags,swab)
