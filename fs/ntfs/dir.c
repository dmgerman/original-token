...
suffix:semicolon
multiline_comment|/* header size. FIXME */
id|NTFS_PUTU16
c_func
(paren
id|record
...
id|walk-&gt;dir-&gt;u.index.recordsize
suffix:semicolon
multiline_comment|/* allocate contiguous index record */
id|error
op_assign
id|ntfs_extend_attr
c_func
...
(brace
multiline_comment|/* FIXME: try smaller allocations */
id|ntfs_free
c_func
(paren
id|record
...
multiline_comment|/* FIXME: adjust to maximum allowed index root value */
id|blocksize
op_assign
...
l_int|0
suffix:semicolon
multiline_comment|/*FIXME: split root */
r_if
c_cond
(paren
id|do_split
