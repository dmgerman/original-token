multiline_comment|/*&n; *  inode.c&n; *&n; *  Copyright (C) 1995-1997 Martin von L&#xfffd;wis&n; *  Copyright (C) 1996 Albert D. Cahalan&n; *  Copyright (C) 1996-1997 R&#xfffd;gis Duchesne&n; */
...
r_break
suffix:semicolon
multiline_comment|/* TODO: case 4-8 */
r_default
suffix:colon
id|ntfs_error
c_func
...
r_break
suffix:semicolon
multiline_comment|/* TODO: case 0x40-0x80 */
r_default
suffix:colon
id|ntfs_error
c_func
...
(brace
multiline_comment|/* should try:&n;&t;&t;   make attributes non-resident&n;&t;&t;   introduce extension records&n;&t;&t;   */
id|ntfs_error
c_func
(paren
...
suffix:semicolon
multiline_comment|/*should match standard attributes*/
id|NTFS_PUTU8
c_func
(paren
id|position
