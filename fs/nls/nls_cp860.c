multiline_comment|/*&n; * linux/fs/nls_cp860.c&n; *&n; * Charset cp860 translation tables.&n; * Generated automatically from the Unicode and charset&n; * tables from the Unicode Organization (www.unicode.org).&n; * The Unicode to charset table has only exact mappings.&n; */
