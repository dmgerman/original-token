...
id|out_nolock
suffix:semicolon
multiline_comment|/* Grab, or try to grab, the pipe&squot;s semaphore with data present.  */
r_if
c_cond
(paren
id|filp-&gt;f_flags
...
l_int|0
suffix:semicolon
multiline_comment|/* Signal writers there is more room.  */
...
r_do
(brace
multiline_comment|/* This should be a synchronous wake-up: don&squot;t do idle reschedules! */
id|wake_up_interruptible
c_func
(paren
id|PIPE_WAIT
...
multiline_comment|/* Signal readers there is more data.  */
id|wake_up_interruptible
c_func
(paren
id|PIPE_WAIT
