...
multiline_comment|/*&n; * Invalidate all inodes for a device, except for the root inode. &n; */
...
DECL|function|invalidate_inodes_except
r_static
r_int
id|invalidate_inodes_except
c_func
(paren
id|kdev_t
id|dev
...
multiline_comment|/*&n; * Check whether we can mount.&n; */
...
multiline_comment|/*&n; * Check whether we can unmount.&n; */
...
c_func
(paren
l_string|&quot;fs_may_umount: root inode not on device??&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
multiline_comment|/*&n;&t; * Invalidate the inodes for this device. Device has been synced&n;&t; * prior to call, so there should be no dirty inodes.&n;&t; */
id|busy
op_assign
id|invalidate_inodes_except
c_func
