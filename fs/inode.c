...
multiline_comment|/*&n; * This is called with the inode lock held. It searches&n; * the in-use for the specified number of freeable inodes.&n; * Freeable inodes are moved to a temporary list and then&n; * placed on the unused list by dispose_list.&n; * &n; * N.B. The spinlock is released to call dispose_list.&n; */
...
id|inode
suffix:semicolon
multiline_comment|/*&n;&t; * Check whether to shrink the dcache ... if we&squot;ve&n;&t; * allocated more than half of the nominal maximum,&n;&t; * try shrinking before allocating more. &n;&t; */
r_if
c_cond
(paren
