...
id|printk
(paren
l_string|&quot;EXT2-fs: fragsize %d != blocksize %d (not supported yet)&bslash;n&quot;
comma
id|s-&gt;u.ext2_sb.s_frag_size
comma
id|s-&gt;s_blocksize
...
id|printk
(paren
l_string|&quot;EXT2-fs: file system too big&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
id|printk
(paren
l_string|&quot;ext2_read_inode: bad inode number on dev %0x04: %d&bslash;n&quot;
comma
id|inode-&gt;i_dev
comma
id|inode-&gt;i_ino
