...
multiline_comment|/**&n; *&t;ext2_find_goal - find a prefered place for allocation.&n; *&t;@inode: owner&n; *&t;@block:  block we want&n; *&t;@chain:  chain of indirect blocks&n; *&t;@partial: pointer to the last triple within a chain.&n; *&n; *&t;This function returns the prefered place for block allocation.&n; */
