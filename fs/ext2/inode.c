multiline_comment|/*&n; *  linux/fs/ext2/inode.c&n; *&n; *  Copyright (C) 1992, 1993  Remy Card (card@masi.ibp.fr)&n; *&n; *  from&n; *&n; *  linux/fs/minix/inode.c&n; *&n; *  Copyright (C) 1991, 1992  Linus Torvalds&n; */
...
id|printk
(paren
l_string|&quot;EXT2-fs: magic match failed&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
id|printk
(paren
l_string|&quot;EXT2-fs warning: mounting non valid file system&bslash;n&quot;
)paren
suffix:semicolon
