multiline_comment|/*&n; * linux/fs/ext2/acl.c&n; *&n; * Copyright (C) 1993, 1994  Remy Card (card@masi.ibp.fr)&n; *                           Laboratoire MASI - Institut Blaise Pascal&n; *                           Universite Pierre et Marie Curie (Paris VI)&n; */
