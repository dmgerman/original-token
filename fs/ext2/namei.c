...
l_int|NULL
suffix:semicolon
multiline_comment|/* Is this a busy deleted directory?  Can&squot;t create new files &n;&t;   if so */
r_if
c_cond
(paren
id|dir-&gt;i_size
...
multiline_comment|/* Make directory empty (it will be truncated when finally&n;&t;&t;   dereferenced).  This also inhibits ext2_add_entry. */
id|inode-&gt;i_size
op_assign
l_int|0
suffix:semicolon
...
mdefine_line|#define PARENT_INO(buffer) &bslash;&n;&t;((struct ext2_dir_entry *) ((char *) buffer + &bslash;&n;&t;((struct ext2_dir_entry *) buffer)-&gt;rec_len))-&gt;inode
DECL|macro|PARENT_NAME
mdefine_line|#define PARENT_NAME(buffer) &bslash;&n;&t;((struct ext2_dir_entry *) ((char *) buffer + &bslash;&n;&t;((struct ext2_dir_entry *) buffer)-&gt;rec_len))-&gt;name
...
suffix:semicolon
multiline_comment|/* no mntp cross */
r_if
c_cond
(paren
op_logical_neg
