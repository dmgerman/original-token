...
mdefine_line|#define PARENT_INO(buffer) &bslash;&n;&t;((struct ext2_dir_entry *) ((char *) buffer + &bslash;&n;&t;le16_to_cpu(((struct ext2_dir_entry *) buffer)-&gt;rec_len)))-&gt;inode
DECL|macro|PARENT_NAME
mdefine_line|#define PARENT_NAME(buffer) &bslash;&n;&t;((struct ext2_dir_entry *) ((char *) buffer + &bslash;&n;&t;le16_to_cpu(((struct ext2_dir_entry *) buffer)-&gt;rec_len)))-&gt;name
