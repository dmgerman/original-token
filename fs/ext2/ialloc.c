...
r_else
(brace
multiline_comment|/* Try to place the inode in it&bslash;&squot;s parent directory */
id|i
op_assign
...
r_else
(brace
multiline_comment|/* Use a quadratic hash to find a group with a free inode */
r_for
c_loop
(paren
id|j
...
(brace
multiline_comment|/* That failed: try linear search for a free inode */
id|i
op_assign
id|dir-&gt;u.ext2_i.i_block_group
op_plus
