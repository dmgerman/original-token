multiline_comment|/*&n; *  linux/fs/ext2/ialloc.c&n; *&n; *  Copyright (C) 1992, 1993  Remy Card (card@masi.ibp.fr)&n; *&n; */
...
DECL|macro|set_bit
mdefine_line|#define set_bit(nr,addr) ( &bslash;&n;{ &bslash;&n;&t;char res; &bslash;&n;&t;__asm__ __volatile__(&quot;btsl %1,%2&bslash;n&bslash;tsetb %0&quot; &bslash;&n;&t;&t;&t;     :&quot;=q&quot; (res) &bslash;&n;&t;&t;&t;     :&quot;r&quot; (nr),&quot;m&quot; (*(addr))); &bslash;&n;&t;res; &bslash;&n;} &bslash;&n;)
DECL|macro|clear_bit
mdefine_line|#define clear_bit(nr,addr) ( &bslash;&n;{ &bslash;&n;&t;char res; &bslash;&n;&t;__asm__ __volatile__(&quot;btrl %1,%2&bslash;n&bslash;tsetnb %0&quot; &bslash;&n;&t;&t;&t;     :&quot;=q&quot; (res) &bslash;&n;&t;&t;&t;     :&quot;r&quot; (nr),&quot;m&quot; (*(addr))); &bslash;&n;&t;res; &bslash;&n;} &bslash;&n;)
DECL|macro|find_first_zero
mdefine_line|#define find_first_zero(addr,size) ( &bslash;&n;{ &bslash;&n;&t;int __res; &bslash;&n;&t;__asm__(&quot;cld&bslash;n&quot; &bslash;&n;&t;&t;&quot;1:&bslash;tlodsl&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;notl %%eax&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;bsfl %%eax,%%edx&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;jne 2f&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;addl $32,%%ecx&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;cmpl %%ebx,%%ecx&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;jl 1b&bslash;n&bslash;t&quot; &bslash;&n;&t;&t;&quot;xorl %%edx,%%edx&bslash;n&quot; &bslash;&n;&t;&t;&quot;2:&bslash;taddl %%edx,%%ecx&quot; &bslash;&n;&t;&t;:&quot;=c&quot; (__res):&quot;0&quot; (0), &quot;S&quot; (addr), &quot;b&quot; (size) &bslash;&n;&t;&t;:&quot;ax&quot;, &quot;bx&quot;, &quot;dx&quot;, &quot;si&quot;); &bslash;&n;&t;__res; &bslash;&n;} &bslash;&n;)
...
multiline_comment|/*&n; * ext2_new_inode does not use a very clever algorithm yet&n; *&n; * Currently, the group descriptors are scanned until a free block is found&n; */
...
id|panic
(paren
l_string|&quot;ext2_new_inode: Descriptor not loaded&quot;
)paren
suffix:semicolon
id|gdp
op_assign
...
id|printk
(paren
l_string|&quot;ext2_count_free_inodes: Descriptor not loaded&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
id|printk
(paren
l_string|&quot;Cannot load inode bitmap for group %d (bitmap = %d)&bslash;n&quot;
comma
id|i
comma
id|bitmap_nr
