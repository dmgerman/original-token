...
(brace
multiline_comment|/* Look for zero in first byte */
id|__asm__
c_func
(paren
"&quot;"
...
(brace
multiline_comment|/* The goal was occupied; search forward for a free &n;&t;&t;&t;   block within the next 32 blocks */
id|lmap
op_assign
(paren
(paren
...
id|printk
(paren
l_string|&quot;ext2_count_free_block: &quot;
l_string|&quot;Descriptor not loaded&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
