...
multiline_comment|/*&n; * These are  the prototypes for the  functions in the  dispatch table, as&n; * well as the  dispatch  table itself.&n; */
r_extern
r_int
id|load_aout_binary
c_func
...
c_func
(paren
l_string|&quot;N_TXTOFF &lt; BLOCK_SIZE. Please convert binary.&quot;
)paren
suffix:semicolon
r_return
op_minus
...
c_func
(paren
l_string|&quot;%s: executable not page aligned&bslash;n&quot;
comma
id|current-&gt;comm
)paren
suffix:semicolon
