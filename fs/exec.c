...
multiline_comment|/* get library inode */
r_return
op_minus
id|ENOENT
suffix:semicolon
...
l_int|NULL
suffix:semicolon
multiline_comment|/* we should check filetypes (headers etc), but we don&squot;t */
id|iput
c_func
(paren
id|current-&gt;library
...
multiline_comment|/* note that current-&gt;library stays unchanged by an exec */
r_if
c_cond
(paren
