...
id|pageaddr
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; * Cannot yet use highmem page because&n;&t;&t;&t;&t; * we cannot sleep with a kmap held.&n;&t;&t;&t;&t; */
id|pageaddr
op_assign
id|__get_free_page
c_func
...
suffix:semicolon
multiline_comment|/*  To support inheritance of root-permissions and suid-root&n;         *  executables under compatibility mode, we raise the&n;         *  effective and inherited bitmasks of the executable file&n;         *  (translation: we set the executable &quot;capability dumb&quot; and&n;         *  set the allowed set to maximum). We don&squot;t set any forced&n;         *  bits.&n;         *&n;         *  If only the real uid is 0, we only raise the inheritable&n;         *  bitmask of the executable file (translation: we set the&n;         *  allowed set to maximum and the application to &quot;capability&n;         *  smart&quot;). &n;         */
r_if
c_cond
(paren
op_logical_neg
