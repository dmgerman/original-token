...
multiline_comment|/*&n; * OSF/1 (and SunOS) readv/writev emulation.&n; *&n; * NOTE! This is not really the way it should be done,&n; * but it should be good enough for TCP connections,&n; * notably X11 ;-)&n; */
