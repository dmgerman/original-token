...
multiline_comment|/*&n; * Find the parent export entry for a given fs. This function is used&n; * only by the export syscall to keep the export tree consistent.&n; * nfsd_parentdev(dev) returns the device on which dev is mounted.&n; */
r_static
id|svc_export
op_star
...
multiline_comment|/* Look up the inode */
r_if
c_cond
(paren
op_logical_neg
...
id|finish
suffix:colon
multiline_comment|/* Release inode */
r_if
c_cond
(paren
id|err
...
(paren
id|KERN_WARNING
l_string|&quot;nfsd: bad inode in unexport!&bslash;n&quot;
)paren
suffix:semicolon
r_else
id|iput
...
macro_line|#if 0
multiline_comment|/*&n; * Get the inode associated with a pathname. Used by exp_export.&n; */
r_struct
id|inode
op_star
id|exp_lnamei
