...
id|rqstp-&gt;rq_client
comma
id|dchild-&gt;d_inode-&gt;i_dev
comma
id|dchild-&gt;d_inode-&gt;i_ino
)paren
suffix:semicolon
r_if
c_cond
...
c_cond
(paren
id|dchild-&gt;d_covers-&gt;d_sb
op_eq
id|dparent-&gt;d_sb
)paren
(brace
multiline_comment|/* stay in the original filesystem */
r_struct
id|dentry
op_star
id|tdentry
...
r_else
(brace
multiline_comment|/* This cannot possibly happen */
id|printk
c_func
(paren
l_string|&quot;nfsd_lookup: %s/%s impossible mount point!&bslash;n&quot;
comma
...
suffix:semicolon
multiline_comment|/*&n;&t; * We must lock the directory before we check for the inode.&n;&t; */
id|err
op_assign
id|fh_lock_parent
c_func
