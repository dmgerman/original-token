...
id|out_nfserr
suffix:semicolon
multiline_comment|/*&n;&t; * FIXME!!&n;&t; *&n;&t; * This should do a double-lock on both rdentry and the parent&n;&t; *&n;&t; * Moreover, it should do checks *both* for unlink and rmdir&n;&t; * cases. AV&n;&t; */
r_if
c_cond
(paren
id|type
