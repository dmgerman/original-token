...
macro_line|#endif
multiline_comment|/*&n; * Size of encoded NFS3 file handle, in words&n; */
DECL|macro|NFS3_FHANDLE_WORDS
mdefine_line|#define NFS3_FHANDLE_WORDS&t;(1 + XDR_QUADLEN(sizeof(struct knfs_fh)))
...
suffix:semicolon
multiline_comment|/* Disabled for now because of lock-up */
r_if
c_cond
(paren
l_int|0
...
r_else
(brace
multiline_comment|/* Didn&squot;t find this entry... weird.&n;&t;&t;&t; * Proceed without the attrs anf fh anyway.&n;&t;&t;&t; */
op_star
id|p
op_increment
op_assign
