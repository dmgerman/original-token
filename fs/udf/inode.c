...
DECL|function|udf_expand_adinicb
r_struct
id|buffer_head
op_star
...
id|inode-&gt;i_size
suffix:semicolon
id|newad.extLocation.logicalBlockNum
op_assign
op_star
id|block
suffix:semicolon
id|newad.extLocation.partitionReferenceNum
op_assign
id|UDF_I_LOCATION
c_func
(paren
...
multiline_comment|/* if the current extent is not recorded but allocated, get the&n;       block in the extent corresponding to the requested block */
r_if
c_cond
(paren
(paren
...
c_func
(paren
id|la-&gt;extLocation.logicalBlockNum
)paren
suffix:semicolon
id|UDF_I_EXT0LOC
c_func
...
c_func
(paren
id|la-&gt;extLocation.partitionReferenceNum
)paren
suffix:semicolon
)brace
r_break
...
id|ICB_FLAG_AD_IN_ICB
suffix:colon
multiline_comment|/* short directories */
(brace
id|UDF_I_EXT0LEN
c_func
(paren
...
multiline_comment|/* end switch ad_type */
r_switch
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* serialize access to UDF_SB_LOCATION() */
multiline_comment|/* This is really icky.. should fix -- blf */
multiline_comment|/* put the location where udf_read_inode can find it */
id|memcpy
c_func
(paren
op_amp
