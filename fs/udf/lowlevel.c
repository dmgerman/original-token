...
(brace
multiline_comment|/* Whoops.  We must save the old FS, since otherwise&n;&t;&t; * we would destroy the kernels idea about FS on root&n;&t;&t; * mount in read_super... [chexum]&n;&t;&t; */
id|mm_segment_t
id|old_fs
op_assign
id|get_fs
...
c_func
(paren
l_string|&quot;Device doesn&squot;t know how to ioctl?&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_return
