...
suffix:semicolon
multiline_comment|/* Zero padding */
id|memset
c_func
(paren
id|sfi-&gt;fileIdent
...
c_func
(paren
l_string|&quot;udf_tread failed: block=%d&bslash;n&quot;
comma
id|block
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;udf_add_entry failure!&bslash;n&quot;
)paren
suffix:semicolon
id|inode-&gt;i_nlink
op_decrement
...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t;DQUOT_INIT(new_inode);&n;*/
)brace
)brace
r_if
c_cond
