...
multiline_comment|/*&n; * udf_stamp_to_time&n; */
id|time_t
op_star
...
l_int|NULL
suffix:semicolon
multiline_comment|/* this is very rough. need to find source to mktime() */
id|tm.tm_year
op_assign
(paren
id|src.year
