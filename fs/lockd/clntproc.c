...
id|status
suffix:semicolon
multiline_comment|/* Always use NLM version 1 over UDP for now... */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* If the async call is proceeding, increment host refcount */
r_if
c_cond
(paren
id|status
...
id|status
suffix:semicolon
multiline_comment|/* No monitor, no lock: see nlmclnt_lock().&n;&t; * Since this is an UNLOCK, don&squot;t try to setup monitoring here. */
r_if
c_cond
(paren
op_logical_neg
