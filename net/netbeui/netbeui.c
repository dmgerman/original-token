...
DECL|function|netbeui_destroy_timer
r_static
r_void
id|netbeui_destroy_timer
c_func
(paren
r_int
r_int
...
(brace
multiline_comment|/*&t;netbeui_socket *sk=(netbeui_socket *)sock-&gt;data;*/
r_switch
c_cond
(paren
id|cmd
...
multiline_comment|/* FIXME - Netbios broadcast semantics ?? */
r_if
c_cond
(paren
