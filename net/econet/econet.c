...
id|dev
suffix:semicolon
multiline_comment|/* Real device structure */
DECL|member|station
DECL|member|net
r_int
r_char
...
l_int|NULL
suffix:semicolon
DECL|variable|edevlist_lock
r_static
id|spinlock_t
id|edevlist_lock
suffix:semicolon
multiline_comment|/*&n; *&t;Faster version of edev_get - call with IRQs off&n; */
DECL|function|__edev_get
r_static
id|__inline__
r_struct
id|ec_device
...
suffix:semicolon
multiline_comment|/* Bridge?  What&squot;s that? */
r_if
c_cond
(paren
id|edev
...
r_return
suffix:semicolon
multiline_comment|/* Device not configured for AUN */
r_if
c_cond
(paren
(paren
...
suffix:semicolon
multiline_comment|/* Stop warnings from happening on UP systems. */
(paren
r_void
)paren
id|edevlist_lock
