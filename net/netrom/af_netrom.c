...
(brace
multiline_comment|/* ??? size check --FIXME-- */
id|sk-&gt;nr-&gt;bpqext
op_assign
l_int|1
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Push down the NetROM header&n;&t; */
id|asmptr
op_assign
id|skb_push
c_func
...
suffix:semicolon
multiline_comment|/* Build a NET/ROM Network header */
op_star
id|asmptr
op_increment
op_assign
...
id|er
suffix:semicolon
multiline_comment|/* Allow for the 20 byte netrom header */
id|copied
op_assign
(paren
id|size
...
c_func
(paren
l_string|&quot;G4KLX NET/ROM for Linux. Version 0.3 ALPHA for AX25 029 Linux 1.3.0&bslash;n&quot;
)paren
suffix:semicolon
