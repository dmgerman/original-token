...
multiline_comment|/*&n; * dl1bke 960311: set parameters for existing NET/ROM connections,&n; *&t;&t;  includes a KILL command to abort any connection.&n; *&t;&t;  VERY useful for debugging ;-)&n; */
DECL|function|nr_ctl_ioctl
r_static
r_int
id|nr_ctl_ioctl
c_func
...
id|buffer
comma
l_string|&quot;user_addr dest_node src_node  dev    my  your  st  vs  vr  va    t1     t2    n2  wnd Snd-Q Rcv-Q&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|len
comma
l_string|&quot;%-9s %-3s  %02X/%02X %02X/%02X %2d %3d %3d %3d %3d/%03d %2d/%02d %2d/%02d %3d %5d %5d&bslash;n&quot;
comma
id|ax2asc
c_func
(paren
...
(paren
id|KERN_INFO
l_string|&quot;G4KLX NET/ROM for Linux. Version 0.6 for AX25.035 Linux 2.1&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_ERR
l_string|&quot;NET/ROM unable to register protocol with AX.25&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
(paren
id|KERN_ERR
l_string|&quot;NET/ROM unable to register linkfail handler with AX.25&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
