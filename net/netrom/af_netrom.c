...
id|NR_DEFAULT_IDLE
suffix:semicolon
DECL|variable|sysctl_netrom_transport_packet_length
r_int
...
(paren
id|KERN_INFO
l_string|&quot;G4KLX NET/ROM for Linux. Version 0.6 for AX25.034 Linux 2.1&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
