...
suffix:semicolon
multiline_comment|/* Just to be sure (2.3.11) -- Check this for 2.3.13 */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Some TCP/IP functions call waitqueue-operations without&n;&t;&t;&t;&t;   holding the sock-lock. I am not that brave.&n;&t;&t;&t;&t;*/
id|lock_sock
c_func
(paren
id|CurrentRequest-&gt;sock-&gt;sk
...
r_else
(brace
multiline_comment|/* Schedule socket-deletion 120 seconds from now */
id|delayed-&gt;Next
op_assign
id|delayed_release
(braket
...
(paren
id|KERN_CRIT
l_string|&quot;kHTTPd: Woops, the socket-buffer is NULL &bslash;n&quot;
)paren
suffix:semicolon
id|req
...
multiline_comment|/*&n;&n;This function checks in the delayed_release queue for candidate-sockets&n;to be released. If All != 0, all sockets are released. This is required for&n;unloading.&n;&n;*/
DECL|function|purge_delayed_release
r_static
r_void
id|purge_delayed_release
c_func
