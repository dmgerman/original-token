...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n; * FIXME: heard and routing table should be two lists. The routing table&n; *        should be updated by connects only. (WAMPES way of doing it)&n; *&n; *        routing table should accept a new route to the same destination&n; *        if the old one was added manually. Nevertheless we should still&n; *        be able to add permanent routes. (dl1bke)&n; */
...
id|len
suffix:semicolon
multiline_comment|/*&n;&t; * dl1bke 960301: use the default route if available&n;&t; *&n;&t; */
r_for
c_loop
(paren
id|ax25_rt
