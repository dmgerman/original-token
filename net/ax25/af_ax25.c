...
r_else
(brace
multiline_comment|/*&n;&t;&t;&t;&t;&t;&t; *&t;Remove kiss/headers&n;&t;&t;&t;&t;&t;&t; */
id|skb_pull
c_func
(paren
id|skb
...
id|data
suffix:semicolon
multiline_comment|/* Process the frame. If it is queued up internally it returns one otherwise we &n;&t;&t;   free it immediately. This routine itself wakes the user context layers so we&n;&t;&t;   do no further work */
r_if
c_cond
(paren
...
id|make-&gt;ax25
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Sort out any digipeated paths.&n;&t;&t; */
r_if
c_cond
(paren
id|dp.ndigi
...
suffix:semicolon
multiline_comment|/* 2 bytes for PID and (U)I frame byte: 15+ for KISS data &amp; calls */
r_if
c_cond
(paren
(paren
...
id|LAPB_UI
suffix:semicolon
multiline_comment|/* Datagram - will get replaced for I frames */
op_star
id|asmptr
op_increment
op_assign
id|sk-&gt;protocol
suffix:semicolon
multiline_comment|/* AX.25 TEXT by default */
r_if
c_cond
(paren
id|sk-&gt;debug
...
id|len
comma
l_string|&quot;%-9s %-3s %2d %2d %2d %2d %3d/%03d %2d/%02d %3d/%03d %2d/%02d %3d %3d&quot;
comma
id|ax2asc
c_func
(paren
...
c_func
(paren
l_string|&quot;GW4PTS/G4KLX AX.25 for Linux. Version 0.29 ALPHA for Linux NET3.029 (Linux 1.3.0)&bslash;n&quot;
)paren
suffix:semicolon
)brace
