...
c_cond
(paren
id|sk-&gt;protinfo.ax25-&gt;dama_slave
)paren
id|ax25_send_control
c_func
(paren
...
(brace
id|sk-&gt;protinfo.ax25-&gt;digipeat-&gt;repeated
(braket
id|ct
)braket
op_assign
...
id|sk-&gt;protinfo.ax25-&gt;digipeat-&gt;lastrepeat
op_assign
l_int|0
suffix:semicolon
)brace
...
comma
id|sk-&gt;protinfo.ax25-&gt;device-&gt;dev_addr
comma
id|AX25_ADDR_LEN
)paren
suffix:semicolon
...
comma
macro_line|#if defined(CONFIG_NETROM_MODULE) || defined(CONFIG_ROSE_MODULE)
id|X
c_func
(paren
id|ax25_findbyuid
...
(paren
id|KERN_INFO
l_string|&quot;G4KLX/GW4PTS AX.25 for Linux. Version 0.34 for Linux NET3.037 (Linux 2.1)&bslash;n&quot;
)paren
suffix:semicolon
)brace
multiline_comment|/*&n; *&t;A small shim to dev_queue_xmit to add the KISS control byte.&n; */
