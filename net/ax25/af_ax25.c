...
multiline_comment|/*&n; *&t;We support a funny extension here so you can (as root) give any callsign&n; *&t;digipeated via a local address as source. This is a hack until we add&n; *&t;BSD 4.4 ADDIFADDR type support. It is however small and trivially backward&n; *&t;compatible 8)&n; *&n; *&t;FIXME: Check family&n; */
...
multiline_comment|/*&n; *&t;FIXME: nonblock behaviour looks like it may have a bug. Also check&n; *&t;the family in the connect.&n; */
...
(paren
id|KERN_INFO
l_string|&quot;G4KLX/GW4PTS AX.25 for Linux. Version 0.35 for Linux NET3.038 (Linux 2.1)&bslash;n&quot;
)paren
suffix:semicolon
)brace
