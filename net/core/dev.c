...
l_int|0
suffix:semicolon
multiline_comment|/* Setup the lock before we open the faucet. */
id|spin_lock_init
c_func
(paren
op_amp
...
r_break
suffix:semicolon
multiline_comment|/* Code, following below is wrong.&n;&n;&t;&t;&t;   The only reason, why it does work is that&n;&t;&t;&t;   ONLY packet sockets receive outgoing&n;&t;&t;&t;   packets. If such a packet will be (occasionally)&n;&t;&t;&t;   received by normal packet handler, which expects&n;&t;&t;&t;   that mac header is pulled...&n;&t;&t;&t; */
multiline_comment|/* More sensible variant. skb-&gt;nh should be correctly&n;&t;&t;&t;   set by sender, so that the second statement is&n;&t;&t;&t;   just protection against buggy protocols.&n;&t;&t;&t; */
id|skb2-&gt;mac.raw
op_assign
id|skb2-&gt;data
suffix:semicolon
...
multiline_comment|/* The device has no queue. Common case for software devices:&n;&t;   loopback, all the sorts of tunnels...&n;&n;&t;   Really, it is unlikely that bh protection is necessary here:&n;&t;   virtual devices do not generate EOI events.&n;&t;   However, it is possible, that they rely on bh protection&n;&t;   made by us here.&n;&t; */
r_if
c_cond
(paren
id|dev-&gt;flags
...
DECL|variable|net_cpu_congestion
r_int
...
id|curr
suffix:semicolon
multiline_comment|/*&n;&t; *&n;&t; *  Let now clear backlog queue. -AS&n;&t; *&n;&t; *  We are competing here both with netif_rx() and net_bh().&n;&t; *  We don&squot;t want either of those to mess with skb ptrs&n;&t; *  while we work on them, thus cli()/sti().&n;&t; *&n;&t; *  It looks better to use net_bh trick, at least&n;&t; *  to be sure, that we keep interrupt latency really low. --ANK (980727)&n;&t; */
r_if
c_cond
(paren
id|backlog.qlen
...
(brace
macro_line|#ifndef CONFIG_CPU_IS_SLOW
r_if
c_cond
(paren
id|skb-&gt;stamp.tv_sec
...
(brace
multiline_comment|/* If device is running, close it.&n;&t;&t;   It is very bad idea, really we should&n;&t;&t;   complain loudly here, but random hackery&n;&t;&t;   in linux/drivers/net likes it.&n;&t;&t; */
r_if
c_cond
(paren
id|dev-&gt;flags
...
suffix:semicolon
multiline_comment|/* To avoid pointers looking to nowhere,&n;&t;&t;   we wait for end of critical section */
id|dev_lock_wait
c_func
(paren
)paren
