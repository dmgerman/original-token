...
suffix:semicolon
multiline_comment|/*&n; * called from init/main.c, -after- all the initcalls are complete.&n; * Registers a hook that calls /sbin/hotplug on every netdev&n; * addition and removal.&n; */
DECL|function|net_notifier_init
r_void
id|__init
...
(paren
id|KERN_WARNING
l_string|&quot;unable to register netdev notifier&bslash;n&quot;
id|KERN_WARNING
l_string|&quot;/sbin/hotplug will not be run.&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
