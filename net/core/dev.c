...
multiline_comment|/**&n; *&t;netdev_boot_setup_check&t;- check boot time settings&n; *&t;@dev: the netdevice&n; *&n; * &t;Check boot time settings for the device.  If device&squot;s name is a&n; *&t;mask (eg. eth%d) and settings are found then this will allocate &n; *&t;name for the device.  The found settings are set for the device&n; *&t;to be used later in the device probing.  Returns 0 if no settings&n; *&t;found, 1 if they are.&n; */
...
(brace
multiline_comment|/*&n;&t;&t;&t; * No settings found - allocate name. If the init()&n;&t;&t;&t; * fails the name will be reissued correctly.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|strchr
