...
(paren
id|KERN_DEBUG
l_string|&quot;%s: !skb-&gt;arp &amp; !rebuild_header -- BUG!&bslash;n&quot;
comma
id|skb-&gt;dev-&gt;name
)paren
suffix:semicolon
...
id|q
suffix:semicolon
multiline_comment|/*&n;&t; *&t;If the address has not been resolved. Call the device header rebuilder.&n;&t; *&t;This can cover all protocols and technically not just ARP either.&n;&t; *&n;&t; *&t;This call must be moved to protocol layer.&n;&t; *&t;Now it works only for IPv6 and for IPv4 in&n;&t; *&t;some unusual curcumstances (eql device). --ANK&n;&t; */
r_if
c_cond
(paren
op_logical_neg
