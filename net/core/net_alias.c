multiline_comment|/*&n; *&t;&t;NET_ALIAS device aliasing module.&n; *&n; * Version:&t;@(#)net_alias.c&t;0.42   12/11/95&n; *&n; * Authors:&t;Juan Jose Ciarlante, &lt;jjciarla@raiz.uncu.edu.ar&gt;&n; *&t;&t;Marcelo Fabian Roccasalva, &lt;mfroccas@raiz.uncu.edu.ar&gt;&n; *&n; * Features:&n; *&t;-&t;AF_ independent: net_alias_type objects&n; *&t;-&t;AF_INET optimized&n; *&t;-&t;ACTUAL alias devices inserted in dev chain&n; *&t;-&t;fast hashed alias address lookup&n; *&t;-&t;net_alias_type objs registration/unreg., module-ables.&n; *&t;-&t;/proc/net/aliases &amp; /proc/net/alias_types entries&n; *&n; * FIXME:&n; *&t;- User calls sleep/wake_up locking.&n; *&t;- Define a way to select the &quot;best&quot; alias device for an incoming&n; *&t;  packet to allow xxx_rcv() device switching based ALSO on pkt&squot;s&n; *&t;  src address (this would require a routing query).&n; *&t;  Related stuff:&n; *&t;&t;IP: Test routing between aliases (possible ICMP redirects).&n; *&t;&t;IP: ARP proxy entries attached to aliases are not visible.&n; *&n; *&n; *&t;This program is free software; you can redistribute it and/or&n; *&t;modify it under the terms of the GNU General Public License&n; *&t;as published by the Free Software Foundation; either version&n; *&t;2 of the License, or (at your option) any later version.&n; *&t;&n; */
...
suffix:semicolon
multiline_comment|/*&n; * net_alias_type base array, will hold net_alias_type objects.&n; */
...
multiline_comment|/*&n; * get hash key for supplied net alias type and address&n; * nat must be !NULL&n; * the purpose here is to map an net_alias_type and a generic&n; * address to a hash code.&n; */
r_static
id|__inline__
r_int
...
multiline_comment|/*&n; * unbind alias from type object and call &squot;done&squot; hook&n; */
r_static
id|__inline__
r_int
...
multiline_comment|/*&n; * compare device address with given. if NULL nat-&gt;addr_chk,&n; * compare dev-&gt;pa_addr with (sockaddr_in) 32 bits address (IP-ish)&n; */
...
multiline_comment|/*&n; * rehash alias with address supplied. &n; */
r_int
DECL|function|net_alias_rehash
id|net_alias_rehash
c_func
(paren
r_struct
...
DECL|macro|NAT_REC_SIZE
mdefine_line|#define NAT_REC_SIZE 64
...
suffix:semicolon
multiline_comment|/*&n;       * truncate to NAT_REC_SIZE&n;       */
id|len
op_add_assign
id|NAT_REC_SIZE
suffix:semicolon
...
multiline_comment|/*&n; * returns alias device with specified address AND flags_1 on AND flags_0 off.&n; *   intended for main devices.&n; *   typically called on xxx_rcv() to check if packet&squot;s dest address is one&n; *   of main_dev&squot;s alias address.&n; */
r_struct
id|device
op_star
DECL|function|net_alias_chk
id|net_alias_chk
c_func
(paren
r_struct
...
r_continue
suffix:semicolon
multiline_comment|/*&n;     * nat_addr_chk will call type specific address cmp function.&n;     */
r_if
c_cond
(paren
id|alias-&gt;dev.flags
...
multiline_comment|/*&n; * addr_chk enough for protocols whose addr is (fully) stored at pa_addr.&n; */
r_struct
id|device
op_star
DECL|function|net_alias_chk32
id|net_alias_chk32
c_func
(paren
r_struct
