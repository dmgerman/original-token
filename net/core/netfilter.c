...
multiline_comment|/* Do inclusive ranges overlap? */
...
c_func
(paren
l_string|&quot;nf_register_sockopt: bad val: min=%i max=%i.&bslash;n&quot;
comma
id|reg-&gt;optmin
comma
id|reg-&gt;optmax
...
c_func
(paren
l_string|&quot;nf_register_sockopt overlap: %u-%u v %u-%u&bslash;n&quot;
comma
id|ops-&gt;optmin
comma
id|ops-&gt;optmax
