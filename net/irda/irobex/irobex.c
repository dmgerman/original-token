multiline_comment|/*********************************************************************&n; *                &n; * Filename:      irobex.c&n; * Version:       0.4&n; * Description:   Kernel side of the IrOBEX layer&n; * Status:        Experimental.&n; * Author:        Dag Brattli &lt;dagb@cs.uit.no&gt;&n; * Created at:    Thu Jun 25 21:21:07 1998&n; * Modified at:   Mon Feb  8 09:05:01 1999&n; * Modified by:   Dag Brattli &lt;dagb@cs.uit.no&gt;&n; * &n; *     Copyright (c) 1998 Dag Brattli, All Rights Reserved.&n; *      &n; *     This program is free software; you can redistribute it and/or &n; *     modify it under the terms of the GNU General Public License as &n; *     published by the Free Software Foundation; either version 2 of &n; *     the License, or (at your option) any later version.&n; *  &n; *     Neither Dag Brattli nor University of Troms&#xfffd; admit liability nor&n; *     provide warranty for any of this software. This material is &n; *     provided &quot;AS-IS&quot; and at no charge.&n; *&n; ********************************************************************/
...
suffix:semicolon
multiline_comment|/* static struct irobex_cb *irobex_open(void); */
multiline_comment|/* static void   irobex_close( struct irobex_cb *self); */
r_static
r_void
...
suffix:semicolon
multiline_comment|/* &t;mgr_event.event = EVENT_IROBEX_INIT; */
multiline_comment|/* &t;sprintf( mgr_event.devname, &quot;%s&quot;, self-&gt;devname); */
multiline_comment|/* &t;irmanager_notify( &amp;mgr_event); */
r_return
l_int|0
suffix:semicolon
)brace
...
DECL|function|irobex_disconnect_request
r_static
r_void
id|irobex_disconnect_request
c_func
...
DECL|function|irobex_connect_request
r_int
id|irobex_connect_request
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t; * If we have discovered a remote device we&n;&t; * check if the discovery is still fresh. If not, we don&squot;t&n;&t; * trust the address.&n;&t; */
r_if
c_cond
(paren
id|self-&gt;daddr
...
comma
id|__FUNCTION__
l_string|&quot;(), daddr is old &lt;%d&gt;!&bslash;n&quot;
comma
id|jiffies
op_minus
id|self-&gt;time_discovered
...
multiline_comment|/* &n;&t; * Try to discover remote remote device if it has not been &n;&t; * discovered yet. &n;&t; */
r_if
c_cond
(paren
op_logical_neg
...
suffix:semicolon
multiline_comment|/* Give up after a few tries */
r_if
c_cond
(paren
(paren
