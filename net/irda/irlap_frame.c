...
(brace
multiline_comment|/* Make sure data is not larger than max data size plus LAP header */
r_if
c_cond
(paren
id|skb-&gt;len
...
(paren
id|__FUNCTION__
l_string|&quot;(), size=%d of sk_buff to big!&bslash;n&quot;
comma
(paren
r_int
)paren
