multiline_comment|/*********************************************************************&n; *                &n; * Filename:      irlap_frame.c&n; * Version:       0.9&n; * Description:   Build and transmit IrLAP frames&n; * Status:        Experimental.&n; * Author:        Dag Brattli &lt;dagb@cs.uit.no&gt;&n; * Created at:    Tue Aug 19 10:27:26 1997&n; * Modified at:   Mon May 31 09:29:13 1999&n; * Modified by:   Dag Brattli &lt;dagb@cs.uit.no&gt;&n; * &n; *     Copyright (c) 1998-1999 Dag Brattli &lt;dagb@cs.uit.no&gt;, All Rights Resrved.&n; *     &n; *     This program is free software; you can redistribute it and/or &n; *     modify it under the terms of the GNU General Public License as &n; *     published by the Free Software Foundation; either version 2 of &n; *     the License, or (at your option) any later version.&n; *&n; *     Neither Dag Brattli nor University of Troms&#xfffd; admit liability nor&n; *     provide warranty for any of this software. This material is &n; *     provided &quot;AS-IS&quot; and at no charge.&n; *&n; ********************************************************************/
...
multiline_comment|/*&n; * Function irlap_resend_rejected_frames (nr)&n; *&n; *    Resend frames which has not been acknowledged. TODO: check that the &n; *    traversal of the list is atomic, i.e that no-one tries to insert or&n; *    remove frames from the list while we travers it!&n; * &n; *    FIXME: It is not safe to traverse a this list without locking it!&n; */
...
l_int|NULL
suffix:semicolon
multiline_comment|/* &n;&t; *  Resend all unacknowledged frames &n;&t; */
id|count
op_assign
id|skb_queue_len
c_func
...
r_return
suffix:semicolon
multiline_comment|/* Skip this for now, DB */
r_while
c_loop
(paren
id|skb_queue_len
...
comma
id|__FUNCTION__
l_string|&quot;(), ns=%d, nr=%d, pf=%d, %ld&bslash;n&quot;
comma
id|info-&gt;ns
comma
id|info-&gt;nr
...
id|info.control
suffix:semicolon
multiline_comment|/* &n;&t; *  First check if this frame addressed to us &n;&t; */
r_if
c_cond
(paren
(paren
...
l_int|0
comma
l_string|&quot;*** REJ frame received! ***&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;*** SREJ frame received! ***&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
l_int|0
comma
l_string|&quot;DM rsp frame received!&bslash;n&quot;
)paren
suffix:semicolon
id|irlap_next_state
c_func
...
l_int|4
comma
l_string|&quot;UA rsp frame received!&bslash;n&quot;
)paren
suffix:semicolon
id|irlap_recv_ua_frame
c_func
