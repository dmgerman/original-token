...
multiline_comment|/*&n; * Function irlap_unit_data_indication (self, skb)&n; *&n; *    Received some data that was sent unreliable&n; *&n; */
DECL|function|irlap_unit_data_indication
r_void
...
comma
id|__FUNCTION__
l_string|&quot;(), queueing unreliable frame&bslash;n&quot;
)paren
suffix:semicolon
id|skb-&gt;data
(braket
...
multiline_comment|/* &n;&t; *  Make the intersection between IrLAP and drivers QoS&n;&t; *  capabilities &n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *  Calculate how many bytes it is possible to transmit before the&n;&t; *  link must be turned around wb = baud * mtt/1000 * 1/2&n;&t; */
...
l_int|4
comma
l_string|&quot;Setting window_bytes = %d&bslash;n&quot;
comma
id|self-&gt;window_bytes
)paren
suffix:semicolon
