...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef CONFIG_AIRPORT_DONGLE
id|airport_init
c_func
(paren
)paren
...
multiline_comment|/*&n; * Function irda_device_close (self)&n; *&n; *    Close the device&n; *&n; */
...
suffix:semicolon
multiline_comment|/* Change speed of IrDA port */
r_if
c_cond
(paren
...
DECL|function|irda_device_net_open
r_int
...
DECL|function|irda_device_net_close
r_int
...
multiline_comment|/* &t;&t;wrq-&gt;u.nwid.nwid = domain; */
multiline_comment|/* &t;&t;wrq-&gt;u.nwid.on = 1; */
r_break
suffix:semicolon
r_case
id|SIOCGIWENCODE
...
multiline_comment|/* &t;wrq-&gt;u.encoding.code = scramble_key; */
multiline_comment|/* &t;&t;wrq-&gt;u.encoding.method = 1; */
r_break
suffix:semicolon
r_case
id|SIOCSIWENCODE
...
multiline_comment|/* scramble_key = wrq-&gt;u.encoding.code; */
r_break
suffix:semicolon
r_case
id|SIOCGIWRANGE
...
multiline_comment|/*&n; * Function irda_device_txqueue_empty (irda_device)&n; *&n; *    Check if there is still some frames in the transmit queue for this&n; *    device. Maybe we should use: q-&gt;q.qlen == 0.&n; *&n; */
...
multiline_comment|/*&n; * Function irda_device_init_dongle (self, type)&n; *&n; *    Initialize attached dongle. Warning, must be called with a process&n; *    context!&n; */
DECL|function|irda_device_init_dongle
r_void
id|irda_device_init_dongle
c_func
(paren
...
c_func
(paren
l_string|&quot;IrDA: Initializing ESI dongle!&bslash;n&quot;
)paren
suffix:semicolon
id|request_module
c_func
...
c_func
(paren
l_string|&quot;IrDA: Initializing Tekram dongle!&bslash;n&quot;
)paren
suffix:semicolon
id|request_module
c_func
...
c_func
(paren
l_string|&quot;IrDA: Initializing ACTiSYS dongle!&bslash;n&quot;
)paren
suffix:semicolon
id|request_module
c_func
...
c_func
(paren
l_string|&quot;IrDA: Initializing GIrBIL dongle!&bslash;n&quot;
)paren
suffix:semicolon
id|request_module
c_func
...
c_func
(paren
l_string|&quot;IrDA: Initializing Litelink dongle!&bslash;n&quot;
)paren
suffix:semicolon
id|request_module
c_func
...
c_func
(paren
l_string|&quot;IrDA: Initializing Airport dongle!&bslash;n&quot;
)paren
suffix:semicolon
id|request_module
c_func
...
multiline_comment|/*&n; * Function irda_device_unregister_dongle (dongle)&n; *&n; *    &n; *&n; */
...
multiline_comment|/*&n; * Function irda_device_set_raw_mode (self, status)&n; *&n; *    &n; *&n; */
