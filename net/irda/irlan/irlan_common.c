...
multiline_comment|/*&n; * Function irlan_get_response_param (buf, param, value)&n; *&n; *    Extracts a single parameter name/value pair from buffer and updates&n; *    the buffer pointer to point to the next name/value pair. &n; */
DECL|function|irlan_get_param
r_int
id|irlan_get_param
c_func
(paren
