...
suffix:semicolon
multiline_comment|/* Make room for TTP header */
id|ASSERT
c_func
(paren
id|skb_headroom
...
op_increment
suffix:semicolon
multiline_comment|/* &n;&t; *  Data or dataless frame? Dataless frames only contain the &n;&t; *  TTP_HEADER&n;&t; */
r_if
c_cond
(paren
id|skb-&gt;len
...
multiline_comment|/* If peer has given us some credites and we didn&squot;t have anyone&n;         * from before, the we need to shedule the tx queue? &n;&t; */
r_if
c_cond
(paren
id|self-&gt;send_credit
...
id|KERN_ERR
id|__FUNCTION__
l_string|&quot;() illegal value length for max_sdu_size!&bslash;n&quot;
)paren
suffix:semicolon
id|self-&gt;tx_max_sdu_size
op_assign
...
comma
id|__FUNCTION__
l_string|&quot;(), RxMaxSduSize=%d&bslash;n&quot;
comma
id|self-&gt;tx_max_sdu_size
)paren
suffix:semicolon
