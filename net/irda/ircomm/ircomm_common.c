...
id|revision_date
op_assign
l_string|&quot;Tue Mar  2 02:03:58 1999&quot;
suffix:semicolon
r_static
r_void
...
id|KERN_ERR
id|__FUNCTION__
l_string|&quot;():why call me? something is wrong..&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
...
DECL|function|ircomm_query_ias_and_connect
r_int
...
suffix:semicolon
multiline_comment|/*&n;&t; * wait if another instance is discovering now&n;&t; */
r_if
c_cond
(paren
id|discovering_instance
...
id|EINTR
suffix:semicolon
multiline_comment|/* cought a signal */
)brace
r_if
c_cond
(paren
...
multiline_comment|/* got connected */
)brace
id|ASSERT
c_func
(paren
...
id|self
suffix:semicolon
multiline_comment|/*&n;&t; * start discovering&n;&t; */
id|hints
op_assign
...
multiline_comment|/*&n;&t; * waiting for discovery&n;&t; */
id|interruptible_sleep_on
c_func
(paren
op_amp
...
multiline_comment|/* got connected */
multiline_comment|/*&n;&t; * query Parameters field of IAS and waiting for answer&n;&t; */
id|self-&gt;servicetype
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* got connected */
multiline_comment|/* really got Parameters field? */
r_if
c_cond
(paren
id|self-&gt;ias_type
...
multiline_comment|/* &n;&t; * check if servicetype we want is available &n;&t; */
id|self-&gt;peer_cap
op_assign
id|self-&gt;servicetype
suffix:semicolon
...
multiline_comment|/*&n;&t; * then choose better one &n;&t; */
r_if
c_cond
(paren
id|self-&gt;servicetype
...
suffix:semicolon
macro_line|#if 1
multiline_comment|/*&n;&t; * waiting for discovery again &n;&t; */
id|interruptible_sleep_on
c_func
(paren
op_amp
...
multiline_comment|/* got connected */
macro_line|#endif
multiline_comment|/*&n;&t; * query lsapsel field and waiting for answer&n;&t; */
id|query_lsapsel
c_func
(paren
id|self
...
multiline_comment|/* got connected */
multiline_comment|/* really got Lsapsel field? */
r_if
c_cond
(paren
id|self-&gt;ias_type
...
multiline_comment|/* got connected */
macro_line|#endif
multiline_comment|/* succeed! ready to connect */
id|discovering_instance
op_assign
l_int|NULL
suffix:semicolon
...
id|bailout
suffix:colon
multiline_comment|/* failed.  not ready to connect */
id|discovering_instance
op_assign
l_int|NULL
suffix:semicolon
...
multiline_comment|/*&n; * query_lsapsel()&n; *    quering the remote IAS to ask which&n; *    dlsap we should use&n; */
