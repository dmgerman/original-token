...
suffix:semicolon
multiline_comment|/* Free frames queued for transmission */
r_while
c_loop
(paren
(paren
...
suffix:semicolon
multiline_comment|/*&t;save_flags(flags);&n;&t;cli();&n;*/
...
comma
id|__FUNCTION__
l_string|&quot;(), size %d to big, clipping to %d!&bslash;n&quot;
comma
id|size
comma
id|self-&gt;max_data_size
...
multiline_comment|/* Do we already have a buffer ready for transmit? */
r_if
c_cond
(paren
id|skb
...
r_else
(brace
multiline_comment|/* Current transmit frame is full */
id|DEBUG
c_func
(paren
l_int|1
...
multiline_comment|/* Check if we need to allocate a new frame */
r_if
c_cond
(paren
op_logical_neg
...
comma
id|__FUNCTION__
l_string|&quot;(), allocating new buffer of size %d!&bslash;n&quot;
comma
id|self-&gt;max_data_size
op_plus
id|self-&gt;max_header_size
...
l_int|0
suffix:semicolon
multiline_comment|/* We don&squot;t have any &quot;buffer&quot; */
)brace
...
multiline_comment|/*&n; * Function ircomm_tty_break (tty, break_state)&n; *&n; *    &n; *&n; */
DECL|function|ircomm_tty_break
r_static
r_void
id|ircomm_tty_break
c_func
...
comma
id|__FUNCTION__
l_string|&quot;(), ttys%d CD now %s...&bslash;n&quot;
comma
id|self-&gt;line
comma
(paren
