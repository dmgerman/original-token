...
id|revision_date
op_assign
l_string|&quot;Wed May 26 00:49:11 1999&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* &n;&t;&t; * next 2 lines must follow this order since irttp_flow_request()&n;&t;&t; * will run its rx queue&n;&t;&t; */
id|driver-&gt;ttp_stoprx
op_assign
l_int|0
suffix:semicolon
...
DECL|function|irvtd_start_tx_timer
r_static
r_void
id|irvtd_start_tx_timer
c_func
...
id|driver
suffix:semicolon
id|driver-&gt;tx_timer.function
op_assign
op_amp
id|irvtd_tx_timer_expired
suffix:semicolon
id|driver-&gt;tx_timer.expires
op_assign
id|jiffies
op_plus
id|timeout
...
DECL|function|irvtd_start_rx_timer
r_static
r_void
id|irvtd_start_rx_timer
c_func
...
id|driver
suffix:semicolon
id|driver-&gt;rx_timer.function
op_assign
op_amp
id|irvtd_rx_timer_expired
suffix:semicolon
id|driver-&gt;rx_timer.expires
op_assign
id|jiffies
op_plus
id|timeout
...
DECL|function|irvtd_tx_timer_expired
r_static
r_void
id|irvtd_tx_timer_expired
c_func
...
DECL|function|irvtd_rx_timer_expired
r_static
r_void
id|irvtd_rx_timer_expired
c_func
...
comma
id|__FUNCTION__
l_string|&quot;(): room in flip_buffer = %d&bslash;n&quot;
comma
id|TTY_FLIPBUF_SIZE
op_minus
id|driver-&gt;tty-&gt;flip.count
...
(brace
multiline_comment|/* handle it later */
id|irvtd_start_rx_timer
c_func
(paren
id|driver
...
comma
id|__FUNCTION__
l_string|&quot;():len = %d, room = %d&bslash;n&quot;
comma
(paren
r_int
)paren
...
c_func
(paren
id|driver-&gt;tx_max_sdu_size
op_plus
id|driver-&gt;max_header_size
)paren
suffix:semicolon
r_if
c_cond
...
multiline_comment|/* push tx queue so that client can send at least 1 octet */
id|irvtd_send_data_request
c_func
(paren
id|driver
...
suffix:semicolon
multiline_comment|/*&n;&t; * discover a peer device&n;&t; */
r_if
c_cond
(paren
id|driver-&gt;tty-&gt;termios-&gt;c_cflag
...
suffix:semicolon
multiline_comment|/* irvtd_start_timer( driver); */
id|driver-&gt;rx_disable
op_assign
l_int|0
suffix:semicolon
...
l_int|4
comma
l_string|&quot;irvtd_put_char(0x%02x) skb_len(%d) room(%d):&bslash;n&quot;
comma
(paren
r_int
)paren
