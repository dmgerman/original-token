...
(paren
id|KERN_WARNING
l_string|&quot;IrIAP: Can&squot;t allocate iriap hashbin!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
suffix:semicolon
multiline_comment|/* &n;&t;&t; *  Legal values restricted to 0x01-0x6f, page 15 irttp &n;&t;&t; */
id|DEBUG
c_func
(paren
l_int|4
...
suffix:semicolon
multiline_comment|/*&n;&t; * Finished, close connection!&n;&t; */
id|iriap_disconnect_request
c_func
(paren
id|self
