...
multiline_comment|/*&n; * Since unix domain sockets use filenames to communicate, two sockets are&n; * the same if their strings are the same, even if their lengths are different&n; * (due to possible null terminations). Verified under SunOS 4.1.2&n; */
r_static
r_int
DECL|function|same_path
id|same_path
c_func
(paren
r_char
...
(brace
multiline_comment|/*&n;&t; * Skip chars while they&squot;re equal&n;&t; */
r_for
c_loop
(paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * Both must be exhausted, or one must be null terminated and the&n;&t; * other either exhausted or null terminated, for the paths to be&n;&t; * equivalent&n;&t; */
r_return
(paren
(paren
id|l1
