...
multiline_comment|/*&n;&t; *&t;&t;W A R N I N G&n;&t; * this is a terrible hack. i want to create a socket in the&n;&t; * filesystem and get its inode. sys_mknod() can create one for&n;&t; * me, but it needs superuser privs and doesn&squot;t give me the inode.&n;&t; * we fake suser here and get the file created... ugh.&n;&t; */
id|memcpy
c_func
(paren
id|fname
