...
id|c
suffix:semicolon
macro_line|#ifdef DEBUG_IPX_PPROP_ROUTING
id|printk
c_func
(paren
id|KERN_INFO
l_string|&quot;IPX: PPROP packet received&bslash;n&quot;
l_string|&quot; Src: %8x:%02x:%02x:%02x:%02x:%02x:%02x:%d/%d&bslash;n&quot;
comma
id|htonl
c_func
(paren
...
c_func
(paren
l_string|&quot;IPX: Routing PPROP from net num %08x&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;IPX: Routing PPROP seen net num %08x&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;IPX: Forward PPROP onto net num %08x&bslash;n&quot;
comma
(paren
r_int
r_int
...
c_func
(paren
l_string|&quot;IPX: Ignoring PPROP for net num %08x&bslash;n&quot;
comma
(paren
r_int
r_int
...
suffix:semicolon
multiline_comment|/* Theory.. Keep printing in the same place until we pass offset */
macro_line|#ifdef CONFIG_IPX_INTERN&t;
id|len
op_add_assign
id|sprintf
(paren
