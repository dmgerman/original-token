...
suffix:colon
multiline_comment|/* Connection/WD/Data ACK */
id|pdata-&gt;rmt_seq
op_increment
suffix:semicolon
r_case
...
multiline_comment|/* need to leave skb on the queue! */
id|skb
op_assign
id|skb_peek
c_func
...
multiline_comment|/* insanity - rcv&squot;d ACK of unsent data ?? */
r_if
c_cond
(paren
id|ntohs
...
r_else
multiline_comment|/* Out of Seq - ERROR! */
id|skb_queue_head
c_func
(paren
op_amp
...
(paren
id|KERN_INFO
l_string|&quot;Sequenced Packet eXchange (SPX) 0.01 for Linux NET3.037&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
