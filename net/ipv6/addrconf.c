...
l_int|1
suffix:semicolon
multiline_comment|/* Wrong. It is user level function. */
...
(paren
id|KERN_DEBUG
l_string|&quot;IPv6: error %d adding prefix route&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t; * Pedro makes interesting thing here, he attached&n;&t; * fake nexthop to multicast route.&n;&t; * It is trick to avoid cloning, ugly, but efficient. --ANK&n;&t; */
r_if
c_cond
(paren
id|err
...
(paren
id|KERN_DEBUG
l_string|&quot;IPv6: error %d adding mroute&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* See comment in addrconf_add_mroute.&n;&t; * It is the same trick, but to avoid cloning for direct&n;&t; * sit routes i.e. IPv4 comaptible destinations.&n;&t; */
r_if
c_cond
(paren
id|err
...
l_int|1
suffix:semicolon
multiline_comment|/* It is wrong.&n;&t;&t;   It is routing daemon or radvd that must make it,&n;&t;&t;   rather than kernel.&n;&t;&t; */
id|ipv6_addr_all_routers
c_func
(paren
op_amp
