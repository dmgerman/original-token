...
suffix:semicolon
macro_line|#if 1
multiline_comment|/* BUGGGGG! Previous routine can return invalid pointer. */
id|rt
op_assign
id|rt6_get_dflt_router
c_func
...
macro_line|#if 0
multiline_comment|/* Bad idea. Sorry, this thing is not&n;&t;&t;&t;&t;   so easy to implement&t;&t;--ANK&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|dev-&gt;change_mtu
...
multiline_comment|/* passed validation tests&n;&n;&t;   NOTE We should not install redirect if sender did not supply&n;&t;   ll address on link, which requires it. It would break, if&n;&t;   we have non-transitive address resolution protocol.&n;&t;   Fix it later. --ANK&n;&t; */
id|rt
op_assign
id|rt6_redirect
c_func
...
r_else
(brace
multiline_comment|/* Hack. It will be freed upon exit from&n;&t;&t;&t;&t;&t;   ndisc_rcv&n;&t;&t;&t;&t;&t; */
id|atomic_inc
c_func
(paren
op_amp
...
multiline_comment|/* BUG! Target can be link-local on ANOTHER interface. Fixed. */
r_if
c_cond
(paren
(paren
