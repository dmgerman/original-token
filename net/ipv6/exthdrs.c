...
DECL|macro|swap
mdefine_line|#define swap(a,b) do { typeof (a) tmp; tmp = (a); (a) = (b); (b) = (tmp); } while(0)
...
macro_line|#endif
multiline_comment|/* &n; * find out if nexthdr is an extension header or a protocol&n; */
...
multiline_comment|/* be anal today */
r_return
l_int|NULL
suffix:semicolon
id|hdrlen
...
multiline_comment|/* Hack.. Do the same for AUTH headers? */
r_if
c_cond
(paren
id|nexthdr
