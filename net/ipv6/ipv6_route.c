...
multiline_comment|/*&n; *&t;Changes:&n; *&n; *&t;Masaki Hirabaru&t;&t;&t;:&t;Fix for /proc info &gt; pagesize&n; *&t;&lt;masaki@merit.edu&gt;&n; */
...
(paren
id|KERN_DEBUG
l_string|&quot;ip6_fib: zero length route not allowed&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
(brace
multiline_comment|/*&n;&t;&t;&t; *&t;This function is called from user&n;&t;&t;&t; *&t;context only (at the moment).&n;&t;&t;&t; *&t;As we don&squot;t sleep we should never see&n;&t;&t;&t; *&t;a lock count &gt; 1.&n;&t;&t;&t; *&n;&t;&t;&t; *&t;If this assumptions becomes invalid we&squot;ll&n;&t;&t;&t; *&t;just have to had a del request to the&n;&t;&t;&t; *&t;queue in this case.&n;&t;&t;&t; */
id|res
op_assign
op_minus
id|EBUSY
...
mdefine_line|#define RT6_INFO_LEN (32 + 2 + 32 + 2 + 2 + 2 + 4 + 8 + 7 + 1)
...
multiline_comment|/*&n; *&t;init/cleanup code&n; *&n; */
