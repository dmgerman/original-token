...
suffix:semicolon
multiline_comment|/* Huh! MOD_DEC_USE_COUNT was here :-(&n;&t;   It is impossible by two reasons: socket destroy&n;&t;   may be delayed and inet_release may sleep and&n;&t;   return to nowhere then. It should be moved to&n;&t;   inet6_destroy_sock(), but we have no explicit constructor :-(&n;&t;                                    --ANK (980802)&n;&t; */
