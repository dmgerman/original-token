...
l_int|1
suffix:semicolon
macro_line|#if 0 /* not yet, first fix routing COW */
...
(paren
id|KERN_DEBUG
l_string|&quot;icmpv6_send: no reply to icmp&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
