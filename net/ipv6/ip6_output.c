...
id|ipv6_statistics.Ip6OutMcastPkts
op_increment
suffix:semicolon
)brace
r_if
...
(brace
id|ipv6_statistics.Ip6FragFails
op_increment
suffix:semicolon
id|kfree_skb
c_func
...
id|ipv6_statistics.Ip6FragCreates
op_increment
suffix:semicolon
id|ipv6_statistics.Ip6OutRequests
op_increment
...
(brace
multiline_comment|/* Jumbo datagram.&n;&t;&t;&t;   It is assumed, that in the case of sk-&gt;ip_hdrincl&n;&t;&t;&t;   jumbo option is supplied by user.&n;&t;&t;&t; */
id|pktlength
op_add_assign
l_int|8
suffix:semicolon
...
suffix:semicolon
id|ipv6_statistics.Ip6InTooBigErrors
op_increment
suffix:semicolon
id|kfree_skb
c_func
...
op_decrement
suffix:semicolon
id|ipv6_statistics.Ip6OutForwDatagrams
op_increment
suffix:semicolon
r_return
id|dst
...
id|drop
suffix:colon
id|ipv6_statistics.Ip6InAddrErrors
op_increment
suffix:semicolon
id|kfree_skb
c_func
