...
id|hlimit
suffix:semicolon
multiline_comment|/* Do something with IPv6 options headers here. */
id|seg_len
op_assign
id|skb-&gt;len
suffix:semicolon
...
id|opt-&gt;opt_nflen
suffix:semicolon
multiline_comment|/* Due to conservative check made by caller,&n;&t;&t;   pktlength cannot overflow here.&n;&n;&t;&t;   When (and if) jumbo option will be implemented&n;&t;&t;   we could try soemething sort of:&n;&n;&t;&t;   if (pktlength &lt; length) return -EMSGSIZE;&n;&n;&t;&t;*/
)brace
r_if
c_cond
(paren
...
id|EMSGSIZE
suffix:semicolon
multiline_comment|/* pktlength includes IPv6 header, not included&n;&t;&t;   in IPv6 payload length.&n;&t;&t;   FIXME are non-fragmentable options included&n;&t;&t;   in packet after defragmentation? If not, we&n;&t;&t;   should subtract opt_nflen also. --ANK&n;&t;&t; */
r_if
c_cond
(paren
id|pktlength
