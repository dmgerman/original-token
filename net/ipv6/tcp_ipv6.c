...
(brace
multiline_comment|/* Well, I know that it is ugly...&n;&t;   All this -&gt;prot, -&gt;af_specific etc. need LARGE cleanup --ANK&n;&t; */
r_if
c_cond
(paren
...
mdefine_line|#define tcp_v6_lookup(sa, sp, da, dp, dif) &bslash;&n;({&t;struct sock *___sk; &bslash;&n;&t;SOCKHASH_LOCK_READ(); &bslash;&n;&t;___sk = __tcp_v6_lookup((sa),(sp),(da),(dp),(dif)); &bslash;&n;&t;SOCKHASH_UNLOCK_READ(); &bslash;&n;&t;___sk; &bslash;&n;})
