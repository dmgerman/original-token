...
suffix:semicolon
multiline_comment|/* Actually we should not attach dst to socket in state LISTEN,&n;&t;   it results in stale destination per listen socket and&n;&t;   overflow of routing cache.&n;&t;   (IPv4 has the same flaw with more unpleasant consequences.)&n;&t; */
id|ip6_dst_store
c_func
(paren
id|sk
