...
id|skp
suffix:semicolon
multiline_comment|/* Well, I know that it is ugly...&n;&t;&t; * All this -&gt;prot, -&gt;af_specific etc. need LARGE cleanup --ANK&n;&t;&t; */
r_if
c_cond
(paren
...
multiline_comment|/* Clean up a locked TCP bind bucket, this only happens if a&n;&t; * port is allocated for a socket, but it never fully connects.&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;prev
...
l_string|&quot;%02X %08X:%08X %02X:%08lX %08X %5d %8d %d&quot;
comma
id|i
comma
id|src-&gt;s6_addr32
