...
multiline_comment|/* XXX: this functions needs to be updated like tcp_v4_err. */
...
multiline_comment|/* FIXME: This is wrong. Need to check for open_requests here. */
id|opening
op_assign
(paren
id|sk-&gt;state
...
multiline_comment|/*&n;&t; *&t;Signal NDISC that the connection is making&n;&t; *&t;&quot;forward progress&quot;&n;&t; *&t;This is in the fast path and should be _really_ speed up! -Ak&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;state
...
suffix:semicolon
multiline_comment|/* I don&squot;t understand why lock_sock()/release_sock() is not  &n;&t; * called here. IPv4 does this. It looks like a bug to me. -AK&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;state
