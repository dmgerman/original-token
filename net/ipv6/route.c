...
multiline_comment|/*&n;&t; *&t;default... this should be chosen according to route flags&n;&t; */
macro_line|#if RT6_DEBUG &gt;= 3
(brace
r_struct
id|in6_addr
...
suffix:semicolon
multiline_comment|/* XXX Figure out what really is supposed to be happening here -DaveM */
id|ipv6_addr_copy
c_func
(paren
op_amp
...
(paren
(paren
l_string|&quot;RTF_GATEWAY, &quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;1. gateway route lookup&n;&t;&t; *&t;2. ndisc_get_neigh&n;&t;&t; */
id|gw_addr
op_assign
op_amp
...
(paren
(paren
l_string|&quot;RTF_GATEWAY &amp;&amp; !RTF_ADDRCONF, &quot;
)paren
)paren
suffix:semicolon
r_if
...
(paren
id|KERN_DEBUG
l_string|&quot;rt6_redirect: no route to destination&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
(brace
multiline_comment|/*&n;&t;&t; *&t;This can happen due to misconfiguration&n;&t;&t; *&t;if we are dealing with an &quot;on link&quot; redirect.&n;&t;&t; */
id|RDBG
c_func
(paren
(paren
l_string|&quot;RTF_GATEWAY&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|printk
...
(paren
id|KERN_DEBUG
l_string|&quot;rt6_redirect: destination not directly &quot;
...
(brace
multiline_comment|/*&n;&t;&t; *&t;duh?! no route to redirect target.&n;&t;&t; *&t;How where we talking to it in the first place ?&n;&t;&t; */
id|RDBG
c_func
(paren
(paren
l_string|&quot;!tgtr||dsterr&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|printk
...
(paren
id|KERN_DEBUG
l_string|&quot;rt6_redirect: no route to target&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|NULL
...
(paren
(paren
l_string|&quot;tgt RTF_GATEWAY &amp;&amp; dstmatch, dup&bslash;n&quot;
)paren
)paren
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Check if we already have the right route.&n;&t;&t; */
macro_line|#if RT6_DEBUG &gt;= 1
id|printk
c_func
(paren
id|KERN_DEBUG
l_string|&quot;rt6_redirect: duplicate&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
(paren
(paren
l_string|&quot;hhpurge, getnewneigh, ret(%p)&bslash;n&quot;
comma
id|tgtr
)paren
)paren
