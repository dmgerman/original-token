...
id|out
suffix:semicolon
multiline_comment|/* Sic! rt6_redirect is called by bh, so that it is allowed */
id|dst_release
c_func
(paren
op_amp
...
id|p_arg
suffix:semicolon
multiline_comment|/* In IPv6 pmtu discovery is not optional,&n;&t;   so that RTAX_MTU lock cannot dissable it.&n;&t;   We still use this lock to block changes&n;&t;   caused by addrconf/ndisc.&n;&t;   */
r_if
c_cond
(paren
id|rt-&gt;rt6i_dev
