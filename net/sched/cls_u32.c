multiline_comment|/*&n; * net/sched/cls_u32.c&t;Ugly (or Universal) 32bit key Packet Classifier.&n; *&n; *&t;&t;This program is free software; you can redistribute it and/or&n; *&t;&t;modify it under the terms of the GNU General Public License&n; *&t;&t;as published by the Free Software Foundation; either version&n; *&t;&t;2 of the License, or (at your option) any later version.&n; *&n; * Authors:&t;Alexey Kuznetsov, &lt;kuznet@ms2.inr.ac.ru&gt;&n; *&n; *&t;The filters are packed to hash tables of key nodes&n; *&t;with a set of 32bit key/mask pairs at every node.&n; *&t;Nodes reference next level hash tables etc.&n; *&n; *&t;This scheme is the best universal classifier&n; *&t;I managed to invent; it is not super-fast, but it is not slow&n; *&t;(provided you programmed it correctly), and enough general.&n; *&t;And its relative speed grows, when number of rules becomes larger.&n; *&n; *&t;Seems, it presents the best middle point between speed and&n; *&t;managability both by human and by machine.&n; *&n; *&t;It is especially useful for link sharing and link sharing, combined&n; *&t;with QoS; pure RSVP need not such general approach and can use&n; *&t;much simpler (and faster) schemes, sort of cls_rsvp.c.&n; */
