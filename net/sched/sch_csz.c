...
id|rate
suffix:semicolon
multiline_comment|/* Flow rate. Fixed point is at rate_log */
DECL|member|L_tab
r_int
r_int
op_star
...
suffix:semicolon
DECL|macro|L2R
mdefine_line|#define L2R(q,f,L) ((f)-&gt;L_tab[(L)&gt;&gt;(q)-&gt;cell_log])
...
multiline_comment|/* Calculate and return current round number.&n;   It is another time consuming part, but&n;   it is impossible to avoid it.&n;&n;   Fixed point arithmetic is not ... does not ... Well, it is just CRAP.&n; */
...
(brace
multiline_comment|/*&n;&t;struct csz_sched_data *q = (struct csz_sched_data *)sch-&gt;data;&n;&t;int&t;i;&n;&n;&t;for (i=0; i&lt;4; i++)&n;&t;&t;qdisc_destroy(q-&gt;other[i]);&n; */
)brace
...
(brace
multiline_comment|/*&n;&t;struct csz_sched_data *q = (struct csz_sched_data *)sch-&gt;data;&n;&t;struct cszctl *ctl = (struct cszctl*)gctl-&gt;arg;&n;&t;struct sk_buff *skb;&n;&t;int    i;&n;&n;&t;if (op == PSCHED_TC_ATTACH) {&n;&t;&t;&n;&t;}&n;*/
r_return
l_int|0
suffix:semicolon
)brace
DECL|variable|csz_ops
r_struct
id|Qdisc_ops
id|csz_ops
op_assign
