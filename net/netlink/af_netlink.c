...
suffix:semicolon
multiline_comment|/* Netlink table lock. It protects against sk list changes&n;   during uninterruptible sleeps in netlink_broadcast.&n;&n;   These lock MUST NOT be used from bh/irq on SMP kernels, because&n;   It would result in race in netlink_wait_on_table.&n; */
r_extern
id|__inline__
r_void
...
(paren
id|KERN_DEBUG
l_string|&quot;netlink_release: impossible event. Please, report.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
