...
multiline_comment|/* make sure there was a free socket. */
r_if
c_cond
(paren
id|sk-&gt;num
...
c_func
(paren
l_string|&quot;  check=%X, other = %X&bslash;n&quot;
comma
id|m-&gt;check
comma
id|m-&gt;other
...
id|MPRINTK
(paren
l_string|&quot;smalloc (size = %d)&bslash;n&quot;
comma
id|size
)paren
suffix:semicolon
...
id|MPRINTK
(paren
l_string|&quot;sfree(data=%X, len = %d)&bslash;n&quot;
comma
id|data
comma
id|len
...
id|MPRINTK
(paren
l_string|&quot;sfree: head-&gt;other != tail:&bslash;n&quot;
)paren
suffix:semicolon
id|bad
op_assign
...
id|MPRINTK
(paren
l_string|&quot;sfree: tail-&gt;other != head:&bslash;n&quot;
)paren
suffix:semicolon
id|bad
op_assign
...
id|MPRINTK
(paren
l_string|&quot;sfree: head failed checksum&bslash;n&quot;
)paren
suffix:semicolon
id|bad
op_assign
...
id|MPRINTK
(paren
l_string|&quot;sfree: tail failed checksum&bslash;n&quot;
)paren
suffix:semicolon
id|bad
op_assign
...
id|MPRINTK
(paren
l_string|&quot;sock_wmalloc(%X,%d,%d) returning NULL&bslash;n&quot;
comma
id|sk
comma
id|size
...
id|MPRINTK
(paren
l_string|&quot;sock_wmalloc(%X,%d,%d) returning %X&bslash;n&quot;
comma
id|sk
comma
id|size
...
id|MPRINTK
(paren
l_string|&quot;sock_rmalloc(%X,%d,%d) returning NULL&bslash;n&quot;
comma
id|sk
comma
id|size
...
id|MPRINTK
(paren
l_string|&quot;sock_rmalloc(%X,%d,%d) returning %X&bslash;n&quot;
comma
id|sk
comma
id|size
