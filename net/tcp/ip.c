...
id|printk
(paren
l_string|&quot;packet fragmented. &bslash;n&quot;
)paren
suffix:semicolon
id|skb-&gt;sk
op_assign
...
(brace
multiline_comment|/* this can never happen. */
id|printk
(paren
l_string|&quot;sock_ioctl: protocol not found. &bslash;n&quot;
)paren
suffix:semicolon
multiline_comment|/* what else can I do, I suppose I could send a sigkill. */
r_return
(paren
op_minus
id|EIO
...
l_int|1
suffix:semicolon
multiline_comment|/* now we have to remove the top sock buff.  If there are none, then&n;      we return. */
r_if
c_cond
(paren
id|sk-&gt;rqueue
