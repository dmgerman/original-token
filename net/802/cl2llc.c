...
c_cond
(paren
id|lp-&gt;ops-&gt;connect_indication_ep
op_ne
l_int|NULL
)paren
id|lp-&gt;ops
...
c_cond
(paren
id|lp-&gt;ops-&gt;disconnect_indication_ep
op_ne
l_int|NULL
)paren
id|lp-&gt;ops
