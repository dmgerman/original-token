...
(brace
multiline_comment|/* &n;&t;&t; *&t;Should not occur: &n;&t;&t; */
r_if
c_cond
(paren
...
multiline_comment|/*&n; *&t;Add_to_queue() adds an skb at back of an I-frame queue.&n; *&t;this function is used for both atq and rtq.&n; *&t;the front and back pointers identify the queue being edited.&n; *&t;this function is called with macros ADD_TO_RTQ() and ADD_TO_ATQ() .&n; */
DECL|function|llc_add_to_queue
r_void
id|llc_add_to_queue
c_func
(paren
...
l_int|NULL
suffix:semicolon
multiline_comment|/* there is no more recent skb */
id|t
op_assign
op_star
id|back
suffix:semicolon
multiline_comment|/* save current back ptr */
op_star
id|back
op_assign
id|skb
...
multiline_comment|/* if rtq empty now */
id|lp-&gt;rtq_back
op_assign
l_int|NULL
suffix:semicolon
multiline_comment|/* correct back pointer */
r_return
id|ack_count
suffix:semicolon
)brace
