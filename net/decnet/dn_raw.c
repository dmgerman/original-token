multiline_comment|/*&n; * DECnet       An implementation of the DECnet protocol suite for the LINUX&n; *              operating system.  DECnet is implemented using the  BSD Socket&n; *              interface as the means of communication with the user level.&n; *&n; *              DECnet Raw Sockets Interface&n; *&n; * Author:      Steve Whitehouse &lt;SteveW@ACM.org&gt;&n; *&n; *&n; * Changes:&n; *           Steve Whitehouse - connect() function.&n; */
...
DECL|variable|dn_raw_mop_sklist
r_static
r_struct
id|sock
op_star
id|dn_raw_mop_sklist
op_assign
l_int|NULL
suffix:semicolon
...
(paren
id|KERN_DEBUG
l_string|&quot;dn_raw_autobind: Unknown protocol&bslash;n&quot;
)paren
suffix:semicolon
r_return
suffix:semicolon
...
multiline_comment|/*&n; * Bind does odd things with raw sockets. Its basically used to filter&n; * the incomming packets, but this differs with the different layers&n; * at which you extract packets.&n; *&n; * For Routing layer sockets, the object name is a host ordered unsigned&n; * short which is a mask for the 16 different types of possible routing&n; * packet. I&squot;d like to also select by destination address of the packets&n; * but alas, this is rather too dificult to do at the moment.&n; */
