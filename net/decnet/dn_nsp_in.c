...
l_int|0
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;dn_ack: %hd 0x%04hx&bslash;n&quot;, type, ack); */
r_switch
c_cond
(paren
id|type
...
multiline_comment|/*&n; * This function uses a slightly different lookup method&n; * to find its sockets, since it searches on object name/number&n; * rather than port numbers&n; */
DECL|function|dn_conninit_rx
r_static
r_int
id|dn_conninit_rx
c_func
...
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;username2sockaddr 1&bslash;n&quot;); */
r_if
c_cond
(paren
...
id|free_out
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;looking for listener...&bslash;n&quot;); */
r_if
c_cond
(paren
(paren
...
l_int|1
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;checking backlog...&bslash;n&quot;); */
r_if
c_cond
(paren
id|sk-&gt;ack_backlog
...
id|free_out
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;waking up socket...&bslash;n&quot;); */
id|sk-&gt;ack_backlog
op_increment
suffix:semicolon
id|skb_queue_tail
...
id|reason
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;DECnet: discinit %d&bslash;n&quot;, skb-&gt;len); */
r_if
c_cond
(paren
id|skb-&gt;len
...
id|TCP_CLOSE
suffix:semicolon
multiline_comment|/* printk(KERN_DEBUG &quot;DECnet: discinit&bslash;n&quot;); */
r_switch
c_cond
(paren
id|scp-&gt;state
...
multiline_comment|/*&n; * Copy of sock_queue_rcv_skb (from net/core/datagram.c) to&n; * queue other data segments. Also we send SIGURG here instead&n; * of the normal SIGIO, &squot;cos its out of band data.&n; */
...
DECL|function|dn_returned_conninit
r_static
r_void
id|dn_returned_conninit
c_func
(paren
r_struct
id|sk_buff
...
id|free_out
suffix:semicolon
multiline_comment|/*&n;&t; * Returned packets...&n;&t; */
r_if
c_cond
(paren
id|cb-&gt;rt_flags
...
(brace
multiline_comment|/* printk(KERN_DEBUG &quot;control type&bslash;n&quot;); */
r_switch
c_cond
(paren
id|cb-&gt;nsp_flags
