...
suffix:semicolon
multiline_comment|/* No max specified, so made it the same as t3 */
DECL|variable|min_cost
r_static
r_int
id|min_cost
(braket
...
DECL|function|dn_dev_fill_ifinfo
r_static
r_int
id|dn_dev_fill_ifinfo
c_func
(paren
r_struct
id|sk_buff
...
DECL|function|dn_dev_dump_ifinfo
r_static
r_int
id|dn_dev_dump_ifinfo
c_func
(paren
r_struct
id|sk_buff
...
DECL|function|dn_dev_eth_setsrc
r_static
r_int
id|dn_dev_eth_setsrc
c_func
...
DECL|function|dn_dev_lo_setsrc
r_static
r_int
id|dn_dev_lo_setsrc
c_func
...
DECL|function|dn_dev_eth_neigh_setup
r_static
r_int
id|dn_dev_eth_neigh_setup
c_func
...
DECL|function|dn_dev_ptp_setsrc
r_static
r_int
id|dn_dev_ptp_setsrc
c_func
...
suffix:semicolon
id|dn_db-&gt;neigh_parms-&gt;neigh_setup
op_assign
id|dn_db-&gt;parms.neigh_setup
suffix:semicolon
id|dn_dev_sysctl_register
c_func
(paren
...
id|len
comma
l_string|&quot;%-8s %1s     %04lu %04lu   %04lu %04lu   %04hu    %03d %02x    %-10s %-7s %-7s&bslash;n&quot;
comma
id|dev-&gt;name
ques
c_cond
