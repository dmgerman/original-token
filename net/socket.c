...
multiline_comment|/*&n;&t;&t; * The socket maintains a reference to the inode, so we&n;&t;&t; * have to increment the count.&n;&t;&t; */
id|inode-&gt;i_count
op_increment
suffix:semicolon
id|fd_install
...
id|err
suffix:semicolon
multiline_comment|/*&n;&t; * Now grab another socket&n;&t; */
id|err
op_assign
op_minus
id|EINVAL
...
id|out_close1
suffix:semicolon
multiline_comment|/*&n;&t; * Get the sockets for the two fd&squot;s&n;&t; */
id|sock1
op_assign
id|sockfd_lookup
c_func
...
id|out_put1
suffix:semicolon
multiline_comment|/* try to connect the two sockets together */
id|err
op_assign
id|sock1-&gt;ops
op_member_access_from_pointer
...
(brace
multiline_comment|/* Handle the race where the accept works and we&n;&t;&t;   then getname after it has closed again */
r_if
c_cond
(paren
id|newsock-&gt;ops
...
multiline_comment|/* N.B. Should check for errors here */
id|move_addr_to_user
c_func
(paren
id|address
...
(brace
multiline_comment|/* Suggested by the Advanced Sockets API for IPv6 draft:&n;&t;&t;&t; * Limit the msg_controllen size by the SO_SNDBUF size.&n;&t;&t;&t; */
multiline_comment|/* Note - when this code becomes multithreaded on&n;&t;&t;&t; * SMP machines you have a race to fix here.&n;&t;&t;&t; */
id|err
op_assign
op_minus
id|ENOBUFS
