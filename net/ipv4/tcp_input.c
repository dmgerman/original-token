...
multiline_comment|/*&n; *&t;TODO&n; *&t;&t;- A better sock cache&n; *&n; */
...
multiline_comment|/*&n; *&t;Policy code extracted so it&squot;s now seperate&n; */
...
id|seg_nxt
suffix:semicolon
multiline_comment|/*&n;&t; *&t;When the window is open (most common case)&n;&t; *&t;we want to accept segments if they have yet unseen data&n;&t; *&t;or in the case of a dataless segment if seg.seq == rcv.nxt&n;&t; *&t;this means:&n;&t; *&n;&t; *&t;if (seq == end_seq)&n;&t; *&t;&t;end_seq &gt;= rcv.nxt&n;&t; *&t;else&n;&t; *&t;&t;end_seq &gt;  rcv.nxt&n;&t; */
r_if
c_cond
(paren
id|seq
...
(brace
id|sk-&gt;tp_pinfo.af_tcp.retrans_head
op_assign
l_int|NULL
suffix:semicolon
id|sk-&gt;cong_window
...
DECL|variable|sysctl_tcp_vegas_cong_avoidance
r_int
...
mdefine_line|#define SHIFT_FACTOR 12
...
id|tp-&gt;basertt
suffix:semicolon
multiline_comment|/*&t;&t;&n;&t;printk(KERN_DEBUG &quot;A:%x E:%x rtt:%x srtt:%x win: %d&bslash;n&quot;, &n;&t;       Actual, Expected, seq_rtt, tp-&gt;srtt, sk-&gt;cong_window);&n;      */
...
(paren
id|KERN_DEBUG
l_string|&quot;removing seg %x-%x from &quot;
l_string|&quot;retransmit queue&bslash;n&quot;
comma
id|skb-&gt;seq
comma
id|skb-&gt;end_seq
...
suffix:semicolon
multiline_comment|/* &n;&t; * if we where retransmiting don&squot;t count rtt estimate&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;retransmits
...
multiline_comment|/* Sanity check out packets_out counter */
r_if
c_cond
(paren
id|skb_queue_len
...
(paren
id|KERN_DEBUG
l_string|&quot;tcp_ack: packets_out %d&bslash;n&quot;
comma
id|sk-&gt;packets_out
)paren
suffix:semicolon
...
multiline_comment|/* &n;&t; * Ok. This is an out_of_order segment &n;&t; */
...
(paren
id|KERN_DEBUG
l_string|&quot;-&gt;seq:%d end:%d &quot;
l_string|&quot;wup:%d wnd:%d&bslash;n&quot;
comma
id|skb-&gt;seq
comma
id|skb-&gt;end_seq
...
id|rcv_mss
suffix:semicolon
multiline_comment|/*&n;&t; *&t;state == CLOSED&n;&t; *&t;tested in tcp_v{4,6}_rcv&n;&t; */
r_switch
c_cond
(paren
id|sk-&gt;state
...
multiline_comment|/*&n; * Local variables:&n; *  compile-command: &quot;gcc -D__KERNEL__ -I/usr/src/linux/include -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -fno-strength-reduce -pipe -m486 -DCPU=486 -c -o tcp_input.o tcp_input.c&quot;&n; * c-file-style: &quot;Linux&quot;&n; * End:&n; */
eof
