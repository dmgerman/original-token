...
(paren
id|KERN_DEBUG
l_string|&quot;TCP: peer shrinks window. Bad, what else can I say?&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
