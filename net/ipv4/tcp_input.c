...
multiline_comment|/*&n;&t; * put it after the packet we found (which&n;&t; * may be the list-head, but that&squot;s fine).&n;&t; */
id|__skb_append
c_func
(paren
id|next
...
DECL|function|tcp_forget_unacked
r_static
r_inline
r_void
id|tcp_forget_unacked
c_func
(paren
r_struct
id|sk_buff_head
...
multiline_comment|/*&n; * This should be a bit smarter and remove partially&n; * overlapping stuff too, but this should be good&n; * enough for any even remotely normal case (and the&n; * worst that can happen is that we have a few&n; * unnecessary packets in the receive queue).&n; */
...
(brace
multiline_comment|/*&n;&t; * Throw out things we haven&squot;t acked.&n;&t; */
id|tcp_forget_unacked
c_func
(paren
id|list
...
suffix:semicolon
multiline_comment|/*&n;&t; * Throw out duplicates&n;&t; */
id|tcp_remove_dups
c_func
(paren
id|list
