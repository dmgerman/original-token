multiline_comment|/*&n; *  $Id: ipconfig.c,v 1.11 1998/02/12 07:43:16 davem Exp $&n; *&n; *  Automatic Configuration of IP -- use BOOTP or RARP or user-supplied&n; *  information to configure own IP address and routes.&n; *&n; *  Copyright (C) 1996, 1997 Martin Mares &lt;mj@atrey.karlin.mff.cuni.cz&gt;&n; *&n; *  Derived from network configuration code in fs/nfs/nfsroot.c,&n; *  originally Copyright (C) 1995, 1996 Gero Kuhlmann and me.&n; */
...
l_int|0
suffix:semicolon
DECL|macro|IC_GOT_BOOTP
mdefine_line|#define IC_GOT_BOOTP 1
DECL|macro|IC_GOT_RARP
mdefine_line|#define IC_GOT_RARP 2
macro_line|#endif
...
l_int|0
suffix:semicolon
multiline_comment|/* BOOTP capable devices */
DECL|variable|__initdata
r_static
r_int
id|rarp_dev_count
...
l_int|0
suffix:semicolon
multiline_comment|/* RARP capable devices */
...
(paren
(paren
l_string|&quot;IP-Config: Opened %s&bslash;n&quot;
comma
id|dev-&gt;name
)paren
)paren
...
multiline_comment|/*&n; *  Dirty tricks for BOOTP packet routing.  We replace the standard lookup function&n; *  for the local fib by our version which does fake lookups and returns our private&n; *  fib entries. Ugly, but it seems to be the simplest way to do the job.&n; */
DECL|variable|__initdata
r_static
r_void
op_star
id|ic_old_local_lookup
id|__initdata
op_assign
l_int|NULL
suffix:semicolon
multiline_comment|/* Old local routing table lookup function */
DECL|variable|__initdata
r_static
r_struct
id|fib_info
...
l_int|NULL
suffix:semicolon
multiline_comment|/* Our fake fib entries */
DECL|variable|__initdata
r_static
r_struct
id|fib_info
...
(paren
(paren
l_string|&quot;BOOTP: Route lookup: %d:%08x -&gt; %d:%08x: &quot;
comma
id|key-&gt;iif
comma
id|key-&gt;src
...
(brace
multiline_comment|/* Packet output */
id|DBG
c_func
(paren
(paren
l_string|&quot;Output&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|res-&gt;type
...
(brace
multiline_comment|/* Packet input */
id|DBG
c_func
(paren
(paren
l_string|&quot;Input&bslash;n&quot;
)paren
)paren
suffix:semicolon
id|res-&gt;type
...
(brace
multiline_comment|/* Address check by inet_addr_type() */
id|DBG
c_func
(paren
(paren
...
id|nh-&gt;nh_oif
op_assign
id|nh-&gt;nh_dev-&gt;ifindex
suffix:semicolon
multiline_comment|/* Dirty trick: replace standard routing table lookup by our function */
id|ic_old_local_lookup
op_assign
id|local_table-&gt;tb_lookup
suffix:semicolon
id|local_table-&gt;tb_lookup
op_assign
id|ic_bootp_route_lookup
...
multiline_comment|/*&n; *  Allocation and freeing of BOOTP packet buffers.&n; */
DECL|function|__initfunc
id|__initfunc
c_func
(paren
...
multiline_comment|/*&n; *  Add / Remove fake interface addresses for BOOTP packet sending.&n; */
DECL|function|__initfunc
id|__initfunc
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;BOOTP: Unable to set interface address&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
multiline_comment|/*&n; *  UDP socket operations.&n; */
DECL|function|__initfunc
id|__initfunc
c_func
(paren
...
(paren
id|KERN_ERR
l_string|&quot;BOOTP: connect() failed (%d)&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
(paren
id|KERN_ERR
l_string|&quot;BOOTP: bind() failed (%d)&bslash;n&quot;
comma
id|err
)paren
suffix:semicolon
...
l_int|1
suffix:semicolon
multiline_comment|/* Add fake zero addresses to all interfaces */
r_if
c_cond
(paren
id|ic_bootp_addrs_add
...
l_int|1
suffix:semicolon
multiline_comment|/* Initialize BOOTP routing */
r_if
c_cond
(paren
id|ic_bootp_route_init
...
l_int|1
suffix:semicolon
multiline_comment|/* Initialize common portion of BOOTP request */
id|memset
c_func
(paren
id|ic_xmit_bootp
...
id|ic_bootp_xmit_sock-&gt;sk-&gt;broadcast
op_assign
l_int|1
suffix:semicolon
id|ic_bootp_xmit_sock-&gt;sk-&gt;reuse
op_assign
l_int|1
suffix:semicolon
id|ic_bootp_recv_sock-&gt;sk-&gt;reuse
op_assign
l_int|1
suffix:semicolon
id|ic_set_bootp_route
...
multiline_comment|/* Find interface this arrived from */
r_for
c_loop
(paren
id|d
...
multiline_comment|/* Record BOOTP packet arrival */
id|cli
c_func
(paren
)paren
