...
(brace
multiline_comment|/* If the report failed throw the cache entry &n;&t;&t;&t;   out - Brad Parker&n;&n;&t;&t;&t;   OK, OK, Brad. Only do not forget to free skb&n;&t;&t;&t;   and return :-) --ANK&n;&t;&t;&t; */
r_if
c_cond
(paren
id|ipmr_cache_report
...
id|VIFF_REGISTER
suffix:colon
multiline_comment|/*&n;&t;&t;&t;&t; * Special Purpose VIF in PIM&n;&t;&t;&t;&t; * All the packets will be sent to the daemon&n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|reg_vif_num
...
(paren
id|KERN_DEBUG
l_string|&quot;ipmr_add_vif: flags %02x&bslash;n&quot;
comma
id|vif.vifc_flags
)paren
suffix:semicolon
...
multiline_comment|/* Resolved cache entry is not changed by net bh,&n;&t;   so that we are allowed to enable it.&n;&t; */
id|end_bh_atomic
c_func
(paren
)paren
