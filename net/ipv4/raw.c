...
multiline_comment|/*&n; * This is the prot-&gt;rcv() function. It&squot;s called when we have&n; * backlogged packets from core/sock.c if we couldn&squot;t receive it&n; * when the packet arrived.&n; */
DECL|function|raw_rcv_redo
r_static
r_int
id|raw_rcv_redo
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;BSD raw sockets forget to check SO_BROADCAST ....&n;&t; */
r_if
c_cond
(paren
op_logical_neg
