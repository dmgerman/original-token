...
multiline_comment|/*&n;&t; *&t;See if the firewall wants to dispose of the packet. &n;&t; *&n;&t; *&t;Note: the current standard firewall code expects that the &n;&t; *&t;destination address was already checked against the interface &n;&t; *&t;address lists.&n;&t; *&n;&t; *&t;If this code is ever moved in front of ip_route_input() you need&n;&t; *&t;to fix the fw code [moving it might be a good idea anyways,&n;&t; *&t;so that we can firewall against potentially bugs in the options&n;&t; *&t;or routing code]&n;&t; */
...
suffix:semicolon
macro_line|#endif
macro_line|#ifdef&t;CONFIG_IP_ROUTE_TOS
multiline_comment|/* It is for 2.2 only. Firewalling should make smart&n;&t;&t;   rerouting itself, ideally, but now it is too late&n;&t;&t;   to teach it. &t;&t;&t;--ANK (980905)&n;&t;&t; */
r_if
c_cond
(paren
id|iph-&gt;tos
