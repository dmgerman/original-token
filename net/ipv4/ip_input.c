...
macro_line|#endif
macro_line|#ifdef CONFIG_IP_MASQUERADE
multiline_comment|/* Do we need to de-masquerade this packet? */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/* Some masq modules can re-inject packets if&n;&t;&t; * bad configured.&n;&t;&t; */
id|printk
c_func
(paren
id|KERN_DEBUG
l_string|&quot;ip_input(): demasq recursion detected. &quot;
l_string|&quot;Check masq modules configuration&bslash;n&quot;
)paren
suffix:semicolon
id|kfree_skb
c_func
