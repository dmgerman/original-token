...
op_star
comma
id|new_tuple.dst.protonum
comma
id|new_tuple.dst.u.all
)paren
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Mapping the inner packet is just like a normal&n;&t;&t;   packet in the other direction, except it was never&n;&t;&t;   src/dst reversed, so where we would normally apply&n;&t;&t;   a dst manip, we reply a src, and vice versa. */
r_if
c_cond
(paren
id|info-&gt;manips
