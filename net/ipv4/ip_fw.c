...
c_func
(paren
l_string|&quot;%s PROTO=%d %ld.%ld.%ld.%ld:%hu %ld.%ld.%ld.%ld:%hu&quot;
...
(brace
multiline_comment|/* Prepend mark &amp; interface */
id|skb_put
c_func
(paren
id|outskb
...
c_func
(paren
l_string|&quot;ip_fw_ctl (masq): length %d, expected %d&bslash;n&quot;
comma
id|len
comma
r_sizeof
...
DECL|variable|proc_net_ipfwchains_chain
r_static
r_struct
id|proc_dir_entry
id|proc_net_ipfwchains_chain
op_assign
(brace
...
suffix:semicolon
DECL|variable|proc_net_ipfwchains_chainnames
r_static
r_struct
id|proc_dir_entry
id|proc_net_ipfwchains_chainnames
op_assign
(brace
...
(brace
macro_line|#ifdef DEBUG_IP_FIRWALL_LOCKING
id|fwc_wlocks
op_assign
id|fwc_rlocks
op_assign
...
c_func
(paren
l_string|&quot;ip_fw_init: cannot initialize netlink&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
macro_line|#if defined(DEBUG_IP_FIREWALL) || defined(DEBUG_IP_FIREWALL_USER)
id|printk
c_func
(paren
l_string|&quot;Firewall graphs enabled! Untested kernel coming thru. &bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
)brace
