...
multiline_comment|/*&n;&t;&t; * VERY ugly piece of code which actually&n;&t;&t; * makes kernel printf for matching packets...&n;&t;&t; */
r_if
c_cond
(paren
id|f-&gt;fw_flg
...
id|skb2-&gt;h.iph
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Mend the IP header too&n;&t;&t; */
id|iph-&gt;tot_len
op_assign
id|htons
c_func
...
id|len
comma
l_string|&quot;%08lX/%08lX-&gt;%08lX/%08lX %.16s %08lX %X &quot;
comma
id|ntohl
c_func
(paren
...
id|len
comma
l_string|&quot;%s %08lX:%04X %08lX:%04X %04X %08X %6d %6d %lu&bslash;n&quot;
comma
id|strProt
(braket
id|ms-&gt;protocol
