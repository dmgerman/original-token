...
c_func
(paren
l_string|&quot;Got nh: via %08x dev %d w %d fl %02x&bslash;n&quot;
comma
id|nh-&gt;nh_gw
comma
id|nh-&gt;nh_oif
...
id|EINVAL
suffix:semicolon
multiline_comment|/* Ugly conversion from rtentry types to unsigned */
r_if
c_cond
(paren
id|r-&gt;rt_flags
