...
c_func
(paren
l_string|&quot;nh %d/%d gw=%08x/%08x dev=%s/%s&bslash;n&quot;
comma
id|fi-&gt;fib_nh
(braket
l_int|0
...
(paren
id|KERN_DEBUG
l_string|&quot;SIOCRT*: mtu/window/irtt are not implemnted.&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
