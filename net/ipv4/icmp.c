...
id|iph-&gt;tos
suffix:semicolon
multiline_comment|/* XXX: use a more aggressive expire for routes created by &n;&t; * this call (not longer than the rate limit timeout). &n;&t; * It could be also worthwhile to not put them into ipv4&n;&t; * fast routing cache at first.&n;&t; */
r_if
c_cond
(paren
id|ip_route_output
...
id|dummy
suffix:semicolon
multiline_comment|/* &n; * &t;Configurable rate limits.&n; *&t;Send at most one packets per time.&n; *&t;Someone should check if these default values are correct.&n; */
DECL|variable|sysctl_icmp_sourcequench_time
r_int
