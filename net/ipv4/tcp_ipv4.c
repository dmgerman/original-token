...
multiline_comment|/* Allocate and initialize a new TCP local port bind bucket.&n; * The sockhash lock must be held as a writer here.&n; */
...
id|new_saddr
suffix:semicolon
multiline_comment|/* XXX The only one ugly spot where we need to&n;&t;&t; * XXX really change the sockets identity after&n;&t;&t; * XXX it has entered the hashes. -DaveM&n;&t;&t; */
id|__tcp_v4_rehash
c_func
(paren
id|sk
...
comma
l_string|&quot;%4d: %08X:%04X %08X:%04X&quot;
l_string|&quot; %02X %08X:%08X %02X:%08X %08X %5d %8d %d&quot;
comma
id|i
comma
id|src
...
multiline_comment|/* Finally, walk time wait buckets. */
r_for
c_loop
(paren
id|i
