...
multiline_comment|/* FIXME: add a timeout here, to cope with broken devices that&n;&t;&t;  drop all DF=1 packets. Do some more sanity checking &n;&t;&t;  here to prevent DOS attacks?&n;&t;&t;  This code should kick the tcp_output routine to&n;&t;&t;  retransmit a packet immediately because we know that&n;&t;&t;  the last packet has been dropped. -AK */
r_if
c_cond
(paren
id|type
...
(brace
multiline_comment|/*&t;socket already created but not&n;&t;&t;&t;&t; *&t;yet accepted()...&n;&t;&t;&t;&t; */
id|sk
op_assign
id|req-&gt;sk
suffix:semicolon
...
multiline_comment|/*&n;&t; * We check packets with only the SYN bit set against the&n;&t; * open_request queue too: This increases connection latency a bit,&n;&t; * but is required to detect retransmitted SYNs.&n;&t; *&n;&t; * The ACK/SYN bit check is probably not needed here because&n;&t; * it is checked later again (we play save now).&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;state
