...
suffix:semicolon
macro_line|#if 0
multiline_comment|/* check wrong - icmp.c should pass in len */
r_if
c_cond
(paren
id|skb-&gt;len
...
multiline_comment|/* pointless, because we have no way to retry when sk is locked.&n;&t;   But the socket should be really locked here for better interaction&n;&t;   with the socket layer. This needs to be solved for SMP&n;&t;   (I would prefer an &quot;ICMP backlog&quot;). */
multiline_comment|/* lock_sock(sk); */
id|tp
op_assign
op_amp
id|sk-&gt;tp_pinfo.af_tcp
...
id|prev
suffix:semicolon
multiline_comment|/* Prevent race conditions with accept()&n;&t;&t;&t; * icmp is unreliable. &n;&t;&t;&t; * This is the easiest solution for now - for&n;&t;&t;&t; * very big servers it might prove inadequate.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|sk-&gt;sock_readers
...
(brace
multiline_comment|/* XXX: add a counter here to profile this. &n;&t;&t;&t;&t; * If too many ICMPs get dropped on busy&n;&t;&t;&t;&t; * servers this needs to be solved differently.&n;&t;&t;&t;&t; */
r_goto
id|out
suffix:semicolon
)brace
...
id|out
suffix:colon
multiline_comment|/* release_sock(sk); */
)brace
...
r_else
(brace
multiline_comment|/* Check for embryonic sockets (open_requests)&n;&t;&t; * We check packets with only the SYN bit set&n;&t;&t; * against the open_request queue too: This&n;&t;&t; * increases connection latency a bit, but is&n;&t;&t; * required to detect retransmitted SYNs.  &n;&t;&t; */
multiline_comment|/* FIXME: need to check for multicast syns&n;&t;&t; * here to satisfy RFC1122 4.2.3.10, p. 104:&n;&t;&t; * discard bcast/mcast SYN. I&squot;m not sure if&n;&t;&t; * they&squot;re filtered out at the IP layer (I&n;&t;&t; * think not) &n;&t;&t; */
r_if
c_cond
(paren
id|sk-&gt;state
...
(paren
id|KERN_DEBUG
l_string|&quot;TCPv4 bad checksum from %I:%04x to %I:%04x, len=%d/%d/%d&bslash;n&quot;
comma
op_amp
id|saddr
comma
...
id|tcp_v4_search_req
comma
macro_line|#ifdef CONFIG_SYNCOOKIES
id|cookie_v4_check
comma
macro_line|#else
l_int|NULL
