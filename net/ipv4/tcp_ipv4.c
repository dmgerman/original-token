...
multiline_comment|/* That should be really in a standard kernel include file. */
DECL|macro|offsetof
mdefine_line|#define offsetof(t,m) ((unsigned int) (&amp;((t *)0)-&gt;m))
r_extern
r_int
