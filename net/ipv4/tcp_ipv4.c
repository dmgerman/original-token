...
id|af_req
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;assumption: the socket is not in use.&n;&t;&t; *&t;as we checked the user count above and we&squot;re&n;&t;&t; *&t;running from a soft interrupt.&n;&t;&t; */
id|req
op_assign
...
(paren
id|KERN_DEBUG
l_string|&quot;bug: syn_recv socket &quot;
l_string|&quot;exists&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
...
c_func
(paren
l_string|&quot;tcp_do_rebuild_header: &quot;
l_string|&quot;hh miss %08x via %08x&bslash;n&quot;
comma
id|iph-&gt;daddr
comma
id|rt-&gt;rt_gateway
