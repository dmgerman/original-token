...
suffix:semicolon
multiline_comment|/* th-&gt;doff gets fixed up below if we tack on options. */
id|buff-&gt;seq
op_assign
id|tp-&gt;write_seq
op_increment
...
suffix:semicolon
multiline_comment|/* Do not place TCP options in a reset. */
id|ip_queue_xmit
c_func
(paren
id|skb1
...
id|TCPOLEN_TSTAMP_ALIGNED
suffix:semicolon
multiline_comment|/* tcp_syn_build_options will do an skb_put() to obtain the TCP&n;&t; * options bytes below.&n;&t; */
id|skb-&gt;h.th
op_assign
id|th
op_assign
...
multiline_comment|/* This is not only more efficient than what we used to do, it eliminates&n; * a lot of code duplication between IPv4/IPv6 SYN recv processing. -DaveM&n; */
