...
multiline_comment|/* The sockhash lock must be held as a writer here. */
...
id|tb-&gt;flags
op_amp
id|TCPB_FLAG_GOODSOCKNUM
)paren
)paren
(brace
multiline_comment|/* Someone is in between the bind&n;&t;&t;&t;&t;&t; * and the actual connect or listen.&n;&t;&t;&t;&t;&t; * See if it was a legitimate reuse&n;&t;&t;&t;&t;&t; * and we are as well, else punt.&n;&t;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|sk-&gt;reuse
...
multiline_comment|/* We must obtain the sockhash lock here, we are always&n;&t; * in BH context.&n;&t; */
...
id|sk-&gt;opt-&gt;optlen
suffix:semicolon
multiline_comment|/* Reset mss clamp */
id|tp-&gt;mss_clamp
op_assign
op_complement
l_int|0
...
(brace
multiline_comment|/* Clamp mss at maximum of 536 and user_mss.&n;&t;&t;   Probably, user ordered to override tiny segment size&n;&t;&t;   in gatewayed case.&n;&t;&t; */
id|tp-&gt;mss_clamp
op_assign
id|max
c_func
...
op_increment
suffix:semicolon
multiline_comment|/* If too many ICMPs get dropped on busy&n;&t;&t;&t;  * servers this needs to be solved differently.&n;&t;&t;&t;  */
r_goto
id|out_unlock
suffix:semicolon
)brace
...
multiline_comment|/* ANK (980927) ... which is harmless now,&n;&t;&t;   sk-&gt;err&squot;s may be safely lost.&n;&t;&t; */
id|sk-&gt;err
op_assign
id|err
suffix:semicolon
...
macro_line|#ifdef CONFIG_IP_TRANSPARENT_PROXY
multiline_comment|/*&n;   Seems, I never wrote nothing more stupid.&n;   I hope Gods will forgive me, but I cannot forgive myself 8)&n;                                                --ANK (981001)&n; */
DECL|function|tcp_v4_search_proxy_openreq
r_static
r_struct
id|sock
op_star
id|tcp_v4_search_proxy_openreq
c_func
(paren
r_struct
id|sk_buff
...
macro_line|#ifdef CONFIG_IP_TRANSPARENT_PROXY
multiline_comment|/* The new socket created for transparent proxy may fall&n;&t; * into a non-existed bind bucket because sk-&gt;num != newsk-&gt;num.&n;&t; * Ensure existance of the bucket now. The placement of the check&n;&t; * later will require to destroy just created newsk in the case of fail.&n;&t; * 1998/04/22 Andrey V. Savochkin &lt;saw@msu.ru&gt;&n;&t; */
r_if
c_cond
(paren
id|tcp_bucket_check
...
id|newtp-&gt;mss_clamp
suffix:semicolon
multiline_comment|/* It would be better to use newtp-&gt;mss_clamp here */
r_if
c_cond
(paren
id|newsk-&gt;rcvbuf
...
suffix:semicolon
multiline_comment|/* Deliver SIGIO */
r_return
id|newsk
suffix:semicolon
m_exit
