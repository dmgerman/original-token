...
suffix:semicolon
multiline_comment|/* We send a ACK if we can now advertise a non-zero window&n;&t; * which has been raised &quot;significantly&quot;.&n;  &t; */
r_if
c_cond
(paren
id|tcp_timer_is_set
