...
op_decrement
suffix:semicolon
multiline_comment|/*&n;&t; * This does not pass any already set errors on the new socket&n;&t; * to the user, but they will be returned on the first socket operation&n;&t; * after the accept.&n;&t; */
id|error
op_assign
l_int|0
suffix:semicolon
