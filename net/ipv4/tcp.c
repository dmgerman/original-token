...
id|rcv_wnd
suffix:semicolon
multiline_comment|/* FIXME: double check this rule, then check against&n;&t;&t; * other use of similar rules. Abtract if possible.&n;&t;&t; */
id|rcv_wnd
op_assign
id|tp-&gt;rcv_wnd
op_minus
