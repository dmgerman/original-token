...
(brace
macro_line|#if EXTRA_RELEASE
multiline_comment|/*&n; * we don&squot;t really need to release even if we sleep: our packets&n; * will be backlogged for us, and that&squot;s just fine.&n; */
...
multiline_comment|/*&n; *&t;Release a skb if it is no longer needed. This routine&n; *&t;must be called with interrupts disabled or &quot;sk-&gt;inuse = 1&quot;&n; *&t;so that the sk_buff queue operation is ok.&n; */
...
id|rspace
suffix:semicolon
multiline_comment|/*&n;&t; * NOTE! &squot;sk-&gt;inuse&squot; must be set, so that we don&squot;t get&n;&t; * a messed-up receive queue.&n;&t; */
r_while
c_loop
(paren
(paren
