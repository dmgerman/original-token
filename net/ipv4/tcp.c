...
suffix:semicolon
multiline_comment|/*&n; *&t;Find someone to &squot;accept&squot;. Must be called with&n; *&t;the listening socket locked.&n; */
...
multiline_comment|/*&n; *&t;Socket write_space callback.&n; *&t;This (or rather the sock_wake_async) should agree with poll. &n; */
...
multiline_comment|/*&n; *&t;Wait for a socket to get into the connected state&n; *&n; *&t;Note: Must be called with the socket locked, and it&n; *&t;      runs with the kernel fully unlocked.&n; */
...
multiline_comment|/*&n; *&t;Wait for more memory for a socket&n; *&n; * NOTE: This runs with the kernel fully unlocked.&n; */
...
id|SO_NOSPACE
suffix:semicolon
multiline_comment|/* clear SIGIO XXX */
id|mss_now
op_assign
id|tcp_current_mss
c_func
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t;&t;   These three lines and clause if (sk-&gt;state == TCP_CLOSE)&n;&t;&t;   are unlikely to be correct, if target &gt; 1.&n;&t;&t;   I DO NOT FIX IT, because I have no idea, what&n;&t;&t;   POSIX prescribes to make here. Probably, it really&n;&t;&t;   wants to lose data 8), if not all target is received.&n;&t;&t;                                                 --ANK&n;&t;&t; */
r_if
c_cond
(paren
id|sk-&gt;err
...
id|used
suffix:semicolon
multiline_comment|/*&t;We now will not sleep again until we are finished&n;&t;&t; *&t;with skb. Sorry if you are doing the SMP port&n;&t;&t; *&t;but you&squot;ll just have to fix it neatly ;)&n;&t;&t; *&n;&t;&t; *&t;Very funny Alan... -DaveM&n;&t;&t; */
id|atomic_dec
c_func
(paren
op_amp
...
multiline_comment|/*&n; *&t;Wait for an incoming connection, avoid race&n; *&t;conditions. This must be called with the socket locked,&n; *&t;and without the kernel lock held.&n; */
...
id|out
suffix:colon
multiline_comment|/* sk should be in LISTEN state, thus accept can use sk-&gt;err for&n;&t; * internal purposes without stomping on anyone&squot;s feed.&n;&t; */
id|sk-&gt;err
op_assign
id|error
suffix:semicolon
