...
id|tp-&gt;ack.pending
suffix:semicolon
macro_line|#ifdef CONFIG_TCP_MORE_COARSE_ACKS
r_if
c_cond
(paren
id|tp-&gt;ack.pending
...
suffix:semicolon
macro_line|#ifdef CONFIG_TCP_LESS_COARSE_ACKS
