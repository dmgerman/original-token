...
multiline_comment|/*&n; * Add more stuff to the end of skb-&gt;len&n; */
DECL|function|fill_in_partial_skb
r_static
r_int
id|fill_in_partial_skb
c_func
(paren
r_struct
id|sock
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Now we may find the frame is as big, or too&n;&t; *&t;big for our MSS. Thats all fine. It means the&n;&t; *&t;MSS shrank (from an ICMP) after we allocated &n;&t; *&t;this frame.&n;&t; */
id|copy
op_assign
id|sk-&gt;mss
op_minus
...
multiline_comment|/*&n;&t; *&t;Otherwise continue to fill the buffer.&n;&t; */
id|send
op_assign
id|tcp_send_skb
suffix:semicolon
...
id|used
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;This copy_to_user can sleep. If it sleeps and we&n;&t;&t; *&t;do a second read it relies on the skb-&gt;users to avoid&n;&t;&t; *&t;a crash when cleanup_rbuf() gets called.&n;&t;&t; */
id|memcpy_toiovec
c_func
(paren
id|msg-&gt;msg_iov
...
multiline_comment|/*&n; * Wait for an incoming connection, avoid race&n; * conditions. This must be called with the socket&n; * locked.&n; */
