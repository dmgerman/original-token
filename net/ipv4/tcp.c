...
suffix:semicolon
multiline_comment|/*&n; *&t;The less said about this the better, but it works and will do for 1.2  (and 1.4 ;))&n; */
...
multiline_comment|/*&n; *&t;This routine picks a TCP windows for a socket based on&n; *&t;the following constraints&n; *  &n; *&t;1. The window can never be shrunk once it is offered (RFC 793)&n; *&t;2. We limit memory per socket&n; */
...
l_int|0x3FF
suffix:semicolon
multiline_comment|/* make free space a multiple of 1024 */
r_if
c_cond
(paren
id|sk-&gt;window_clamp
...
multiline_comment|/*&n; *      This function returns the amount that we can raise the&n; *      usable window.&n; */
...
(paren
id|KERN_DEBUG
l_string|&quot;TRW: win &lt; 0 w=%d 1=%u 2=%u&bslash;n&quot;
comma
id|sk-&gt;window
comma
id|sk-&gt;acked_seq
...
macro_line|#ifndef CONFIG_NO_PATH_MTU_DISCOVERY&t; 
r_struct
id|iphdr
op_star
id|iph
...
multiline_comment|/*&n;&t;&t;&t; *&t;First thing we do is make sure that we are established. &n;&t;&t;&t; */
r_if
c_cond
(paren
id|sk-&gt;shutdown
...
multiline_comment|/* &n;&t;&t;&t; *&t;Wait for a connection to finish.&n;&t;&t;&t; */
r_while
c_loop
(paren
id|sk-&gt;state
...
macro_line|#ifndef CONFIG_NO_PATH_MTU_DISCOVERY
multiline_comment|/*&n;&t;&t; *&t;FIXME:  I&squot;m almost sure that this fragment is BUG,&n;&t;&t; *&t;&t;but it works... I do not know why 8) --ANK&n;&t;&t; *&n;&t;&t; *&t;Really, we should rebuild all the queues...&n;&t;&t; *&t;It&squot;s difficult. Temprorary hack is to send all&n;&t;&t; *&t;queued segments with allowed fragmentation.&n;&t;&t; */
(brace
r_int
id|new_mss
op_assign
...
(brace
multiline_comment|/*&n;&t;&t;&t;&t; *&t;We will release the socket in case we sleep here. &n;&t;&t;&t;&t; */
id|release_sock
c_func
(paren
id|sk
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; *&t;NB: following must be mtu, because mss can be increased.&n;&t;&t;&t;&t; *&t;mss is always &lt;= mtu &n;&t;&t;&t;&t; */
id|skb
op_assign
id|sock_wmalloc
c_func
...
multiline_comment|/*&n;&t;&t;&t;&t; *&t;FIXME: here is another race condition. &n;&t;&t;&t;&t; */
id|tmp
op_assign
id|sk-&gt;wmem_alloc
suffix:semicolon
...
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t;&t; *&t;Again we will try to avoid it. &n;&t;&t;&t;&t; */
r_if
c_cond
(paren
id|tmp
...
suffix:semicolon
multiline_comment|/*&n;&t; * See if we have anything to free up?&n;&t; */
id|skb
op_assign
id|skb_peek
c_func
...
multiline_comment|/*&n;&t;&t;&t; *&t;This also takes care of updating the window.&n;&t;&t;&t; *&t;This if statement needs to be simplified.&n;&t;&t;&t; *&n;&t;&t;&t; *      rules for delaying an ack:&n;&t;&t;&t; *      - delay time &lt;= 0.5 HZ&n;&t;&t;&t; *      - we don&squot;t have a window update to send&n;&t;&t;&t; *      - must send at least every 2 full sized packets&n;&t;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
l_int|0
suffix:semicolon
multiline_comment|/* Now works the right way instead of a hacked &n;&t;&t;&t;&t;&t;&t;&t;&t;&t;&t;&t;initial setting */
id|sk-&gt;prot
op_member_access_from_pointer
id|queue_xmit
c_func
...
(brace
multiline_comment|/* does the packet contain any unseen data AND */
multiline_comment|/* does the packet start before the window? */
r_return
id|after
c_func
(paren
...
id|no_tcp_socket
suffix:colon
multiline_comment|/*&n;&t; *&t;No such TCB. If th-&gt;rst is 0 send a reset (checked in tcp_reset)&n;&t; */
id|tcp_reset
c_func
(paren
id|daddr
