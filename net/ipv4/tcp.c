...
id|out
suffix:colon
multiline_comment|/* sk should be in LISTEN state, thus accept can use sk-&gt;err for&n;&t; * internal purposes without stomping one anyone&squot;s feed.&n;&t; */
id|sk-&gt;err
op_assign
id|error
suffix:semicolon
