...
suffix:semicolon
macro_line|#endif
multiline_comment|/* Always wake the user up when an error occured */
r_if
c_cond
(paren
id|sock_wspace
...
id|TCP_LAST_ACK
suffix:colon
multiline_comment|/* Could have shutdown() then close()&n;&t;&t;&t;&t;&t; * (but don&squot;t do send_fin again!) */
id|ns
op_assign
id|TCP_LAST_ACK
suffix:semicolon
