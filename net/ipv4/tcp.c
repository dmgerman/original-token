...
multiline_comment|/* &n; * &t;Add more stuff to the end of the skb.&n; */
DECL|function|tcp_append_tail
r_static
r_int
id|tcp_append_tail
c_func
...
suffix:semicolon
id|sk-&gt;tp_pinfo.af_tcp.write_seq
op_add_assign
id|copy
suffix:semicolon
id|skb-&gt;end_seq
...
(paren
id|KERN_DEBUG
l_string|&quot;sendmsg: copy &lt; 0&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
...
l_int|1
suffix:semicolon
multiline_comment|/* Read at least this may bytes */
r_if
c_cond
(paren
id|sk-&gt;state
