...
multiline_comment|/*&n; *&t;Socket write_space callback.&n; *&t;This (or rather the sock_wake_async) should agree with poll.&n; *&n; *&t;WARNING. This callback is called, when socket is not locked.&n; *&n; *&t;This wakeup is used by TCP only as dead-lock breaker, real&n; *&t;wakeup occurs when incoming ack frees some space in buffer.&n; */
