...
multiline_comment|/*&n; *&t;Walk down the receive queue counting readable data until we hit the &n; *&t;end or we find a gap in the received data queue (ie a frame missing &n; *&t;that needs sending to us). &n; */
...
op_decrement
suffix:semicolon
multiline_comment|/* FIXME: need to check here if socket has already&n;&t;&t; * an soft_err or err set.&n;&t;&t; * We have two options here then: reply (this behaviour matches&n;&t;&t; * Solaris) or return the error to the application (old Linux)&n;&t;&t; */
id|error
op_assign
l_int|0
suffix:semicolon
