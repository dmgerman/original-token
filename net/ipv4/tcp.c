...
multiline_comment|/* Listening TCP sockets never sleep to wait for memory, so&n; * it is completely silly to wake them up on queue space&n; * available events.  So we hook them up to this dummy callback.&n; */
DECL|function|tcp_listen_write_space
r_static
r_void
id|tcp_listen_write_space
c_func
(paren
r_struct
id|sock
...
multiline_comment|/* A chunk was here doing something strange&n;&t;&t;&t; * with psh etc. It is deleted, because it was&n;&t;&t;&t; * evident non-sense.&t;&t;&t; --ANK&n;&t;&t;&t; */
id|copy
op_assign
id|min
c_func
...
multiline_comment|/* Do not set sk-&gt;done, it is set only by normal data receive */
r_if
c_cond
(paren
id|sk-&gt;state
...
suffix:semicolon
multiline_comment|/* Well, if I missed something then punishment will be terrible oops. */
id|__kfree_skb
c_func
(paren
id|skb
...
id|tp-&gt;ack.rcv_mss
macro_line|#endif
multiline_comment|/*&n;&t;&t;     * If this read emptied read buffer, we send ACK when:&n;&t;&t;     *&n;&t;&t;     * -- ATO estimator diverged. In this case it is useless&n;&t;&t;     * to delay ACK, it will miss in any case.&n;&t;&t;     *&n;&t;&t;     * -- The second condition is triggered when we did not&n;&t;&t;     * ACK 8 segments not depending of their size.&n;&t;&t;     * Linux senders allocate full-sized frame even for one byte&n;&t;&t;     * packets, so that default queue for MTU=8K can hold&n;&t;&t;     * only 8 packets. Note, that no other workarounds&n;&t;&t;     * but counting packets are possible. If sender selected&n;&t;&t;     * a small sndbuf or have larger mtu lockup will still&n;&t;&t;     * occur. Well, not lockup, but 10-20msec gap.&n;&t;&t;     * It is essentially dead lockup for 1Gib ethernet&n;&t;&t;     * and loopback :-). The value 8 covers all reasonable&n;&t;&t;     * cases and we may receive packet of any size&n;&t;&t;     * with maximal possible rate now.&n;&t;&t;     */
op_logical_or
(paren
id|copied
OG
...
suffix:semicolon
multiline_comment|/* Send ACK now, if this read freed lots of space&n;&t;&t; * in our buffer. Certainly, new_window is new window.&n;&t;&t; * We can advertise it now, if it is not less than current one.&n;&t;&t; * &quot;Lots&quot; means &quot;at least twice&quot; here.&n;&t;&t; */
r_if
c_cond
(paren
id|new_window
...
suffix:semicolon
macro_line|#ifdef TCP_LESS_COARSE_ACKS
multiline_comment|/* Possible improvement. When sender is faster than receiver,&n;&t;&t; * traffic looks like: fill window ... wait for window open ...&n;&t;&t; * fill window. We lose at least one rtt, because call&n;&t;&t; * cleanup_rbuf only once. Probably, if &quot;len&quot; was large&n;&t;&t; * we should insert several intermediate cleanup_rbuf(s).&n;&t;&t; *&n;&t;&t; * F.e.:&n;&t;&t; */
r_do
(brace
id|u32
id|full_space
...
suffix:semicolon
multiline_comment|/* Try to ACK, if total buffer length is larger&n;&t;&t;&t;   than maximal window and if rcv_window has&n;&t;&t;&t;   chances to increase twice. It will result&n;&t;&t;&t;   to exponentially decreased ACKing during&n;&t;&t;&t;   read to huge (usually, mmapped) buffer.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|len
