...
multiline_comment|/*&n;&t; * This does not pass any already set errors on the new socket&n;&t; * to the user, but they will be returned on the first socket operation&n;&t; * after the accept.&n;&t; *&n;&t; * Once linux gets a multithreaded net_bh or equivalent there will be a race&n;&t; * here - you&squot;ll have to check for sk-&gt;zapped as set by the ICMP handler then.&n;&t; */
id|error
op_assign
l_int|0
suffix:semicolon
