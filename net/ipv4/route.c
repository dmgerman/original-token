...
multiline_comment|/*&n;&t;&t; *&t;If MTU was not specified, use default.&n;&t;&t; *&t;If you want to increase MTU for some net (local subnet)&n;&t;&t; *&t;use &quot;route add .... mss xxx&quot;.&n;&t;&t; *&n;&t;&t; * &t;The MTU isn&squot;t currently always used and computed as it&n;&t;&t; *&t;should be as far as I can tell. [Still verifying this is right]&n;&t;&t; */
r_if
c_cond
(paren
(paren
...
(brace
multiline_comment|/*&n; *&t;&quot;Magic&quot; device route is allowed to point to loopback,&n; *&t;discard it too.&n; */
r_if
c_cond
(paren
id|f-&gt;fib_info-&gt;fib_dev
...
multiline_comment|/*&n; * RT &quot;bottom half&quot; handlers. Called with masked interrupts.&n; */
...
id|rth-&gt;rt_dst
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Multicast or limited broadcast is never gatewayed.&n;&t; */
r_if
c_cond
(paren
id|MULTICAST
