...
(brace
multiline_comment|/* Not IP (i.e. ARP). Do not make route for invalid&n;&t;&t; * destination or if it is redirected.&n;&t;&t; */
r_if
c_cond
(paren
id|out_dev
