...
(brace
multiline_comment|/* Entrie is expired even if it is in use */
r_if
c_cond
(paren
(paren
...
c_func
(paren
l_string|&quot;Device %s is down.&bslash;n&quot;
comma
