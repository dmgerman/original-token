...
multiline_comment|/* Compile time configuretion flags */
DECL|macro|CONFIG_IP_LOCAL_RT_POLICY
mdefine_line|#define CONFIG_IP_LOCAL_RT_POLICY 1
r_static
r_void
id|rt_run_flush
c_func
...
(paren
id|KERN_WARNING
l_string|&quot;host %08x/%s ignores redirects for %08x to %08x.&bslash;n&quot;
comma
id|rt-&gt;rt_src
comma
