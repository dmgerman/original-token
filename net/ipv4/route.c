...
macro_line|#ifdef CONFIG_KERNELD
DECL|function|real_ip_rt_route
r_static
r_struct
id|rtable
op_star
...
suffix:semicolon
multiline_comment|/* Not good while forwarding a packet... see ipc/msg.c */
id|kerneld_route
c_func
(paren
id|wanted_route
...
suffix:semicolon
multiline_comment|/* perhaps a ppp-connection? */
