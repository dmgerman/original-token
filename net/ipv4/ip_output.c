...
multiline_comment|/*&n; *&t;If a sender wishes the packet to remain unfreed&n; *&t;we add it to his send queue. This arguably belongs&n; *&t;in the TCP level since nobody else uses it. BUT&n; *&t;remember IPng might change all the rules.&n; */
DECL|function|add_to_send_queue
r_static
r_inline
r_void
id|add_to_send_queue
c_func
(paren
r_struct
id|sock
...
(brace
multiline_comment|/* No reassigning numbers to fragments... */
r_default
suffix:colon
id|free
op_assign
