...
multiline_comment|/* To preserve the cute illusion that a locally-generated packet can&n;   be mangled before routing, we actually reroute if a hook altered&n;   the packet. -RR */
...
macro_line|#endif
multiline_comment|/* Do route recalc if netfilter changes skb. */
r_static
r_inline
r_int
...
suffix:semicolon
macro_line|#ifdef CONFIG_NETFILTER
multiline_comment|/* BLUE-PEN-FOR-ALEXEY.  I don&squot;t understand; you mean I can&squot;t&n;           hold the route as I pass the packet to userspace? -- RR&n;&n;&t;   You may hold it, if you really hold it. F.e. if netfilter&n;&t;   does not destroy handed skb with skb-&gt;dst attached, it&n;&t;   will be held. When it was stored in info-&gt;arg, then&n;&t;   it was not held apparently. Now (without second arg) it is evident,&n;&t;   that it is clean.&t;&t;&t;&t;   --ANK&n;&t; */
r_if
c_cond
(paren
id|rt
