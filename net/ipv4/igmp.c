...
macro_line|#endif
multiline_comment|/* Big mc list lock for all the devices */
DECL|variable|ip_mc_lock
r_static
id|rwlock_t
id|ip_mc_lock
op_assign
id|RW_LOCK_UNLOCKED
suffix:semicolon
multiline_comment|/* Big mc list semaphore for all the sockets.&n;   We do not refer to this list in IP data paths or from BH,&n;   so that semaphore is OK.&n; */
DECL|variable|ip_sk_mc_sem
id|DECLARE_MUTEX
c_func
(paren
id|ip_sk_mc_sem
