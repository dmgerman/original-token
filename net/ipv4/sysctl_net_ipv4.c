...
comma
l_string|&quot;igmp_max_host_report_delay&quot;
comma
op_amp
id|sysctl_igmp_max_host_report_delay
comma
...
comma
macro_line|#if 0
multiline_comment|/* This one shouldn&squot;t be exposed to the user (too implementation&n;&t;   specific): */
(brace
id|NET_IPV4_IGMP_AGE_THRESHOLD
comma
l_string|&quot;igmp_age_threshold&quot;
comma
op_amp
id|sysctl_igmp_age_threshold
comma
