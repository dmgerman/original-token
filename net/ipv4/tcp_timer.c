...
multiline_comment|/*&n; *&t;Reset the retransmission timer&n; *&n; *&t;We currently ignore the why/when parameters, and decide on&n; *&t;our own how long we should wait on our own..&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t; * Was an old timer event active?&n;&t; */
r_if
c_cond
(paren
id|del_timer
...
multiline_comment|/* &n;&t; * Keepopen processing?&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;keepopen
...
multiline_comment|/*&n;&t; * Retransmission?&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;send_head
...
(brace
multiline_comment|/*&n;&t;&t; * Zero window probe?&n;&t;&t; */
r_struct
id|sk_buff
op_star
id|skb
op_assign
id|sk-&gt;write_queue.next
suffix:semicolon
r_if
c_cond
(paren
...
suffix:semicolon
multiline_comment|/* get us going again */
r_break
suffix:semicolon
