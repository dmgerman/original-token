...
l_int|0
suffix:semicolon
multiline_comment|/* The death-row tw chains are only ever touched&n;&t; * in BH context so no locking is needed.&n;&t; */
id|tw
op_assign
id|tcp_tw_death_row
(braket
