...
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Hmm.  We got an UDP packet to a port to which we&n;&t;&t; * don&squot;t wanna listen.  Ignore it.&n;&t;&t; */
id|kfree_skb
c_func
(paren
id|skb
