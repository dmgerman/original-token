...
multiline_comment|/*&n; *&t;Moves tunnel to listen state&n; */
...
suffix:semicolon
multiline_comment|/*&n;EXPORT_SYMBOL(ip_masq_set_expire);&n;*/
DECL|variable|ip_masq_free_ports
id|EXPORT_SYMBOL
c_func
(paren
...
l_int|0
comma
l_string|&quot;masq_expire delayed: %s %08lX:%04X-&gt;%08lX:%04X nlocks-1=%d masq.refcnt-1=%d masq.n_control=%d&bslash;n&quot;
comma
id|masq_proto_name
c_func
(paren
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;Try the next available port number&n;&t;&t; */
id|mport
op_assign
id|ms-&gt;mport
op_assign
...
DECL|function|ip_masq_procinfo
r_static
r_int
id|ip_masq_procinfo
c_func
...
id|temp
comma
l_string|&quot;Prot SrcIP    SPrt DstIP    DPrt MAddr    MPrt State        Ref Ctl Expires (free=%d,%d,%d)&quot;
comma
id|atomic_read
c_func
(paren
...
id|temp
comma
l_string|&quot;%-4s %08lX:%04X %08lX:%04X %08lX:%04X %-12s %3d %3d %7lu&quot;
comma
id|masq_proto_name
c_func
(paren
...
macro_line|#endif
multiline_comment|/*&n; *&t;Control from ip_sockglue&n; *&t;From userspace&n; */
DECL|function|ip_masq_ctl
r_int
id|ip_masq_ctl
c_func
(paren
...
multiline_comment|/*  (mctl-&gt;mctl_action == IP_MASQ_MOD_CTL)  */
id|ret
op_assign
id|ip_masq_mod_ctl
c_func
