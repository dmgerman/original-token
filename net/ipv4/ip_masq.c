...
multiline_comment|/*&n; *&t;Handle ICMP messages.&n; *&t;Find any that might be relevant, check against existing connections,&n; *&t;forward to masqueraded host if relevant.&n; *&t;Currently handles error types - unreachable, quench, ttl exceeded&n; */
...
c_func
(paren
l_string|&quot;Incoming ICMP (%d) %lX -&gt; %lX&bslash;n&quot;
comma
id|icmph-&gt;type
comma
id|ntohl
...
c_func
(paren
l_string|&quot;Handling ICMP for %lX:%X -&gt; %lX:%X&bslash;n&quot;
comma
id|ntohl
c_func
(paren
...
c_func
(paren
l_string|&quot;Rewrote ICMP to %lX:%X -&gt; %lX:%X&bslash;n&quot;
comma
id|ntohl
c_func
(paren
