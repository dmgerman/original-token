...
id|ip_masq
op_star
DECL|function|ip_masq_in_get_2
id|ip_masq_in_get_2
c_func
(paren
r_int
...
c_func
(paren
l_string|&quot;Incoming forward ICMP (%d) %lX -&gt; %lX&bslash;n&quot;
comma
id|icmph-&gt;type
comma
id|ntohl
...
(paren
id|KERN_INFO
l_string|&quot;MASQ: forward ICMP: failed checksum from %s!&bslash;n&quot;
comma
id|in_ntoa
c_func
(paren
...
c_func
(paren
l_string|&quot;Handling forward ICMP for %lX:%X -&gt; %lX:%X&bslash;n&quot;
comma
id|ntohl
c_func
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* This is pretty much what ip_masq_in_get() does */
id|ms
op_assign
id|ip_masq_in_get_2
c_func
...
c_func
(paren
l_string|&quot;Rewrote forward ICMP to %lX:%X -&gt; %lX:%X&bslash;n&quot;
comma
id|ntohl
c_func
(paren
...
c_func
(paren
l_string|&quot;Incoming reverse ICMP (%d) %lX -&gt; %lX&bslash;n&quot;
comma
id|icmph-&gt;type
comma
id|ntohl
...
(paren
id|KERN_INFO
l_string|&quot;MASQ: reverse ICMP: failed checksum from %s!&bslash;n&quot;
comma
id|in_ntoa
c_func
(paren
...
c_func
(paren
l_string|&quot;Handling reverse ICMP for %lX:%X -&gt; %lX:%X&bslash;n&quot;
comma
id|ntohl
c_func
(paren
...
suffix:semicolon
macro_line|#endif
multiline_comment|/* This is pretty much what ip_masq_in_get() does, except params are wrong way round */
id|ms
op_assign
id|ip_masq_in_get_2
c_func
...
c_func
(paren
l_string|&quot;Rewrote reverse ICMP to %lX:%X -&gt; %lX:%X&bslash;n&quot;
comma
id|ntohl
c_func
(paren
