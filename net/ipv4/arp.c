...
suffix:semicolon
multiline_comment|/*&n; *&t;Old mapping: we cannot trust it, send ARP broadcast to confirm it.&n; *&t;If it will answer, the entry will be updated,&n; *&t;if not ... we are lost. We will use it for ARP_CONFIRM_INTERVAL.&n; */
r_if
c_cond
(paren
id|jiffies
...
suffix:semicolon
multiline_comment|/*&n; *&t;Handle gratuitous arp.&n; */
id|arp_fast_lock
c_func
(paren
)paren
