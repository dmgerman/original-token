...
multiline_comment|/*&n; *&t;Create a new unresolved entry.&n; *&n; *&t;NOTE: Always make sure no possibility of sleeping is introduced here,&n; *            since nearly all callers are inside of BH atomic.  Don&squot;t let&n; *            the arp_alloc() fool you, at neigh_alloc() it is using GFP_ATOMIC&n; *            always.&n; */
...
r_else
(brace
multiline_comment|/* If last_updated==0 host is dead, so&n;&t;&t;&t; * drop skb&squot;s and set socket error.&n;&t;&t;&t; */
id|icmp_send
c_func
(paren
id|skb
...
DECL|function|arp_check_published
r_static
id|__inline__
r_int
id|arp_check_published
c_func
(paren
id|u32
id|tip
...
macro_line|#if defined(CONFIG_FDDI)
r_if
c_cond
(paren
id|dev_type
