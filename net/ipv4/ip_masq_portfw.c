multiline_comment|/*&n; *&t;&t;IP_MASQ_PORTFW masquerading module&n; *&n; *&n; * Version:&t;@(#)ip_masq_portfw.c  0.02      97/10/30&n; *&n; * Author:&t;Steven Clarke &lt;steven.clarke@monmouth.demon.co.uk&gt;&n; *&n; * Fixes:&t;&n; *&t;Juan Jose Ciarlante&t;: created this new file from ip_masq.c and ip_fw.c&n; *&t;Juan Jose Ciarlante&t;: modularized &n; *&t;Juan Jose Ciarlante &t;: use GFP_KERNEL&n; *&n; *&t;FIXME&n; *&t;&t;- after creating /proc/net/ip_masq/ direct, put portfw underneath&n; */
...
macro_line|#include &lt;net/ip_portfw.h&gt;
...
multiline_comment|/*&n; *&t;Lookup routine for lport,laddr match&n; *&t;called from ip_masq module (via registered obj)&n; */
...
id|pf
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Lock for reading only, by now...&n;&t; */
id|ip_masq_lock
c_func
(paren
op_amp
