...
multiline_comment|/* rtnl_shlock(); -- it is pointless at the moment --ANK */
r_if
c_cond
(paren
id|main_table
...
multiline_comment|/* rtnl_shunlock(); */
id|len
op_assign
id|ptr
op_minus
...
id|EINVAL
suffix:semicolon
macro_line|#ifndef&t;CONFIG_RTNL_OLD_IFINFO
r_if
c_cond
(paren
id|i
