...
suffix:semicolon
multiline_comment|/* No dst. It is bad. Guess some reasonable value.&n;&t;&t; * Actually, this case should not be possible.&n;&t;&t; * SANITY.&n;&t;&t; */
id|BUG_TRAP
c_func
(paren
id|dst
...
suffix:semicolon
multiline_comment|/* Minimal MSS to include full set of of TCP/IP options&n;&t;&t;   plus 8 bytes of data. It corresponds to mtu 128.&n;&t;&t; */
r_if
c_cond
(paren
id|mss
