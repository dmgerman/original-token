...
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;We have to copy the bytes over as the new header wouldn&squot;t fit&n;&t;&t; *&t;the old buffer. This should be very rare.&n;&t;&t; */
r_if
c_cond
(paren
id|skb2
...
multiline_comment|/*&n;&t; *&t;Do any IP forwarding required.&n;&t; */
...
l_int|20
suffix:semicolon
multiline_comment|/* We do this twice so the subtract once is quicker */
id|skb-&gt;raddr
op_assign
(paren
id|rt
