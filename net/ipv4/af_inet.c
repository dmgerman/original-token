...
(brace
multiline_comment|/* Note: tcp_connected contains SYN_RECV, which may cause&n;&t;&t;   bogus results here. -AK */
r_if
c_cond
(paren
id|tcp_connected
...
suffix:semicolon
multiline_comment|/* Note: there is a theoretical race here when an wake up&n;&t;&t;   occurred before inet_wait_for_connect is entered. In 2.3&n;&t;&t;   the wait queue setup should be moved before the low level&n;&t;&t;   connect call. -AK*/
r_if
c_cond
(paren
id|err
...
id|sock_error
suffix:colon
multiline_comment|/* This is ugly but needed to fix a race in the ICMP error handler */
r_if
c_cond
(paren
id|sk-&gt;zapped
