...
suffix:semicolon
DECL|variable|proc_net_rtcache
r_static
r_struct
id|proc_dir_entry
id|proc_net_rtcache
...
macro_line|#if defined(CONFIG_IP_ACCT)||defined(CONFIG_IP_FIREWALL)|| &bslash;&n;    defined(CONFIG_IP_MASQUERADE)
id|ip_fw_init
c_func
(paren
)paren
