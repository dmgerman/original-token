...
suffix:semicolon
multiline_comment|/* RED-PEN. current-&gt;state is volatile. Is it enough to prevent&n;&t; * reordering it and sk-&gt;state check? I put barrier to be sure.&n;&t; */
id|barrier
c_func
(paren
)paren
