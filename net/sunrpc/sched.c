...
(paren
id|KERN_ERR
l_string|&quot;RPC: Bug! Overwriting active timer&bslash;n&quot;
)paren
suffix:semicolon
id|del_timer
c_func
...
multiline_comment|/*&n; * Delete any timer for the current task.&n; */
r_static
r_inline
r_void
DECL|function|__rpc_del_timer
id|__rpc_del_timer
c_func
(paren
r_struct
...
multiline_comment|/*&n; * Wake up a single task -- must be invoked with spin lock held.&n; *&n; * It would probably suffice to cli/sti the del_timer and remove_wait_queue&n; * operations individually.&n; */
r_static
r_void
...
multiline_comment|/*&n;&t;&t; * Check whether task is sleeping.&n;&t;&t; * Note that if the task goes to sleep in tk_action,&n;&t;&t; * and the RPC reply arrives before we get here, it will&n;&t;&t; * have state RUNNING, but will still be on schedq.&n;&t;&t; * 27/9/99: The above has been attempted fixed by&n;&t;&t; *          introduction of task-&gt;tk_sleeping.&n;&t;&t; */
id|spin_lock_bh
c_func
(paren
op_amp
...
multiline_comment|/*&n; * User-visible entry point to the scheduler.&n; *&n; * This may be called recursively if e.g. an async NFS task updates&n; * the attributes and finds that dirty pages must be flushed.&n; */
r_int
...
suffix:semicolon
multiline_comment|/* Delete any running timer */
id|__rpc_del_timer
c_func
(paren
id|task
