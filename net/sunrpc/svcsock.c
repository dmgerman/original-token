...
c_func
(paren
l_string|&quot;svc: socket %p sendto([%p %d... ], %d, %d) = %d&bslash;n&quot;
comma
id|rqstp-&gt;rq_sock
comma
id|iov
...
c_func
(paren
l_string|&quot;svc: socket %p recvfrom(%p, %d) = %d&bslash;n&quot;
comma
id|rqstp-&gt;rq_sock
comma
id|iov
...
id|svsk
suffix:semicolon
multiline_comment|/* Disconnect signalled through data_ready?!? */
r_if
c_cond
(paren
id|sk-&gt;state
...
(paren
id|KERN_WARNING
l_string|&quot;%s: socket dup failed (err %d)!&bslash;n&quot;
comma
id|serv-&gt;sv_name
comma
op_minus
