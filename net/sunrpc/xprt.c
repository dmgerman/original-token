...
multiline_comment|/*&n; * data_ready callback for TCP.&n; */
r_static
r_void
...
(brace
multiline_comment|/* printk(&quot;RPC: inconsistent free list!&bslash;n&quot;); */
id|rpc_debug
op_assign
op_complement
l_int|0
...
c_func
(paren
l_string|&quot;RPC: %4d inconsistent free list &quot;
l_string|&quot;(cong %ld cwnd %ld)&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|xprt-&gt;cong
