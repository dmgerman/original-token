...
id|rpc_queue_lock
suffix:semicolon
multiline_comment|/*&n; * Look up the RPC request corresponding to a reply.&n; *&n; * RED-PEN: Niiice... Guys, when will we learn finally that locking&n; * in this manner is NOOP? --ANK&n; */
r_static
r_inline
r_struct
id|rpc_rqst
...
r_static
r_void
DECL|function|do_rpciod_tcp_dispatcher
id|do_rpciod_tcp_dispatcher
c_func
(paren
r_void
)paren
...
(brace
multiline_comment|/* mama... start_bh_atomic was here...&n;&t;   Calls to sock-&gt;ops _are_ _impossible_ with disabled bh. Period. --ANK&n;&t; */
id|do_rpciod_tcp_dispatcher
c_func
(paren
)paren
...
id|status
suffix:semicolon
multiline_comment|/* We don&squot;t care if we got a reply, so don&squot;t protect&n;&t; * against bh. */
r_if
c_cond
(paren
id|task-&gt;tk_rpcwait
...
multiline_comment|/*&n; * RPC transmit timeout handler.&n; */
r_static
r_void
DECL|function|xprt_transmit_timeout
id|xprt_transmit_timeout
c_func
(paren
r_struct
...
c_func
(paren
l_string|&quot;RPC: %4d transmit_timeout %d&bslash;n&quot;
comma
id|task-&gt;tk_pid
comma
id|task-&gt;tk_status
...
suffix:semicolon
multiline_comment|/*&n;         * Wait until rq_gotit goes non-null, or timeout elapsed.&n;&t; */
id|task-&gt;tk_timeout
op_assign
id|req-&gt;rq_timeout.to_current
suffix:semicolon
