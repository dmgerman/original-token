...
multiline_comment|/* We have set things up such that we perform the checksum of the UDP&n; * packet in parallel with the copies into the RPC client iovec.  -DaveM&n; */
...
multiline_comment|/* Input handler for RPC replies. Called from a bottom half and hence&n; * atomic.&n; */
r_static
r_inline
r_void
...
DECL|function|tcp_output_record
r_static
id|__inline__
r_void
id|tcp_output_record
c_func
(paren
r_struct
id|rpc_xprt
...
DECL|variable|rpc_rx_xprt_pending
r_static
r_struct
id|rpc_xprt
op_star
id|rpc_rx_xprt_pending
op_assign
l_int|NULL
suffix:semicolon
multiline_comment|/* Chain by rx_pending of rpc_xprt&squot;s */
DECL|variable|rpc_tx_xprt_pending
r_static
r_struct
id|rpc_xprt
op_star
id|rpc_tx_xprt_pending
op_assign
l_int|NULL
suffix:semicolon
multiline_comment|/* Chain by tx_pending of rpc_xprt&squot;s */
