...
id|len
comma
l_string|&quot;%-16s&bslash;n     %-7d %-7d %-7d %-7d %-7d&bslash;n     %-7d %-7d %-7d %-7d %-7d&bslash;n&quot;
comma
id|ipaddr
comma
...
suffix:semicolon
macro_line|#if 0 /* compiler seems to barf on this */
id|mpc-&gt;ingress_lock
op_assign
id|RW_LOCK_UNLOCKED
suffix:semicolon
...
multiline_comment|/* FIXME: tarvitsee ty&#xfffd;t&#xfffd; */
...
multiline_comment|/*&n;         * See if ingress MPC is using shortcut we opened as a return channel.&n;         * This means we have a bi-directional vcc opened by us.&n;         */
r_if
c_cond
(paren
id|eg-&gt;shortcut
...
suffix:semicolon
multiline_comment|/* set address if mpcd e.g. gets killed and restarted.&n;                 * If we do not do it now we have to wait for the next LE_ARP&n;                 */
r_if
c_cond
(paren
id|memcmp
...
multiline_comment|/* clear the caches */
...
multiline_comment|/* this means dev-&gt;start == 0 and&n;                 * the flow of packets from the&n;                 * upper layer stops&n;                 */
id|mpc
op_assign
id|find_mpc_by_lec
c_func
...
c_func
(paren
l_string|&quot;mpoa: (%s) using egress SVC to reach %d.%d.%d.%d&bslash;n&quot;
comma
id|client-&gt;dev-&gt;name
comma
id|ip
...
c_func
(paren
l_string|&quot;mpoa: (%s) MPOA_res_reply_rcvd: ip %d.%d.%d.%d&bslash;n&quot;
comma
id|client-&gt;dev-&gt;name
comma
id|ip
...
c_func
(paren
l_string|&quot;mpoa: (%s) ingress_purge_rcvd: recieved a purge for an entry that doesn&squot;t exist, &quot;
comma
id|mpc-&gt;dev-&gt;name
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;mpoa: (%s) egress_purge_rcvd: received a purge reply for an entry that doesn&squot;t exist&bslash;n&quot;
comma
id|mpc-&gt;dev-&gt;name
)paren
suffix:semicolon
