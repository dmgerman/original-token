...
r_struct
id|inode_operations
id|proc_dev_atm_inode_operations
op_assign
(brace
op_amp
id|proc_dev_atm_operations
...
suffix:semicolon
DECL|variable|proc_spec_atm_inode_operations
r_static
r_struct
id|inode_operations
id|proc_spec_atm_inode_operations
op_assign
(brace
op_amp
id|proc_spec_atm_operations
...
mdefine_line|#define CREATE_ENTRY(name) &bslash;&n;    name = create_proc_entry(#name,0,atm_proc_root); &bslash;&n;    if (!name) goto cleanup; &bslash;&n;    name-&gt;data = atm_##name##_info; &bslash;&n;    name-&gt;ops = &amp;proc_spec_atm_inode_operations
