...
suffix:semicolon
DECL|variable|proc_atm_operations
r_static
r_struct
id|file_operations
id|proc_atm_operations
op_assign
(brace
l_int|NULL
comma
...
l_int|NULL
comma
multiline_comment|/* no special release */
l_int|NULL
multiline_comment|/* can&squot;t fsync */
)brace
suffix:semicolon
DECL|variable|proc_atm_inode_operations
r_struct
id|inode_operations
id|proc_atm_inode_operations
op_assign
(brace
op_amp
id|proc_atm_operations
comma
multiline_comment|/* default ATM directory file-ops */
l_int|NULL
comma
...
suffix:semicolon
DECL|macro|ENTRY
mdefine_line|#define ENTRY(name) static struct proc_dir_entry atm_proc_entry_##name = &bslash;&n;    { 0, sizeof(#name)-1, #name, S_IFREG | S_IRUGO, 1, 0, 0, 0, &bslash;&n;    &amp;proc_atm_inode_operations, NULL }
DECL|macro|REG
mdefine_line|#define REG(name) if (!error) error = proc_register(&amp;atm_proc_root, &bslash;&n;    &amp;atm_proc_entry_##name)
DECL|macro|INO
mdefine_line|#define INO(name) (atm_proc_entry_##name.low_ino)
...
id|buf
comma
l_string|&quot;Itf VPI VCI   State    Sock# Inode&bslash;n&quot;
)paren
suffix:semicolon
macro_line|#endif
r_return
...
id|dev-&gt;proc_entry
op_assign
id|atm_proc_entry_template
suffix:semicolon
id|dev-&gt;proc_entry-&gt;name
op_assign
id|dev-&gt;proc_name
suffix:semicolon
id|dev-&gt;proc_entry-&gt;namelen
op_assign
id|sprintf
c_func
(paren
