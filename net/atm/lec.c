...
suffix:semicolon
multiline_comment|/* will be lec0, lec1, lec2 etc. */
DECL|variable|myname
r_static
r_char
id|myname
(braket
...
macro_line|#if 0   /* these are disabled in &lt;linux/atmdev.h&gt; too */
l_int|NULL
comma
multiline_comment|/*poll */
l_int|NULL
comma
multiline_comment|/*send_iovec*/
macro_line|#endif 
l_int|NULL
comma
...
suffix:semicolon
multiline_comment|/* init_trdev globbers device name */
)brace
r_else
(brace
id|priv
...
c_func
(paren
l_string|&quot;lane:(%s) lane2_associate_ind: could not notify MPOA&bslash;n&quot;
comma
id|dev-&gt;name
)paren
suffix:semicolon
