...
multiline_comment|/*&n;&t; * Fixme: BSD difference: In BSD all sockets connected to use get&n;&t; *&t;  ECONNRESET and we die on the spot. In Linux we behave&n;&t; *&t;  like files and pipes do and wait for the last&n;&t; *&t;  dereference.&n;&t; *&n;&t; * Can&squot;t we simply set sock-&gt;err?&n;&t; */
id|unix_gc
c_func
(paren
)paren
...
id|sk
suffix:semicolon
multiline_comment|/* socket created, increment count */
...
multiline_comment|/*&n;&t; *&t;Now ready to connect&n;&t; */
id|sk-&gt;state
op_assign
id|TCP_CLOSE
suffix:semicolon
...
(brace
multiline_comment|/*&n;&t;&t; * if it gives EAGAIN we should give back&n;&t;&t; * EINPROGRESS. But this should not happen since the&n;&t;&t; * socket should have some writespace left (it did not&n;&t;&t; * allocate any memory until now)&n;&t;&t; */
r_goto
id|out_release
suffix:semicolon
)brace
...
suffix:semicolon
multiline_comment|/* No longer locked to master&t;   */
id|kfree_skb
c_func
(paren
id|skb
