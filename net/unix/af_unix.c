...
id|dentry
suffix:semicolon
multiline_comment|/* Do not believe to VFS, grab kernel lock */
id|lock_kernel
c_func
(paren
)paren
...
(brace
multiline_comment|/* Damn, even dget is not SMP safe. It becomes ridiculous... */
id|lock_kernel
c_func
(paren
)paren
...
id|out
suffix:semicolon
multiline_comment|/* If socket state is TCP_LISTEN it cannot change,&n;&t;   so that no locks are necessary.&n;&t; */
id|skb
op_assign
...
(paren
l_int|0
multiline_comment|/*other-&gt;user_callback &amp;&amp;&n;&t;    other-&gt;user_callback(other-&gt;user_data, skb) == 0*/
)paren
(brace
id|unix_state_runlock
c_func
