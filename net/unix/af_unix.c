...
DECL|macro|ulock
mdefine_line|#define ulock(sk)&t;(&amp;(sk-&gt;protinfo.af_unix.user_count))
...
suffix:semicolon
multiline_comment|/* socket destroyed, decrement count&t;&t;      */
...
id|addr_len
suffix:semicolon
multiline_comment|/* First of all allocate resources.&n;&t;   If we will make it after state checks,&n;&t;   we will have to recheck all again in any case.&n;&t; */
id|restart
suffix:colon
...
id|out
suffix:semicolon
multiline_comment|/* Check that listener is in valid state. */
id|err
op_assign
op_minus
id|ECONNREFUSED
...
id|MSG_SYN
suffix:semicolon
multiline_comment|/* set up connecting socket */
id|sock-&gt;state
op_assign
id|SS_CONNECTED
suffix:semicolon
...
id|other-&gt;peercred
suffix:semicolon
multiline_comment|/* set up newly created sock */
id|unix_peer
c_func
(paren
id|newsk
...
suffix:semicolon
multiline_comment|/* send info to listening sock */
id|other-&gt;ack_backlog
op_increment
suffix:semicolon
id|skb_queue_tail
...
id|newsock
suffix:semicolon
multiline_comment|/* destroy handed sock */
id|newsk-&gt;socket
op_assign
l_int|NULL
suffix:semicolon
...
DECL|function|do_unix_dgram_sendmsg
r_static
r_int
id|do_unix_dgram_sendmsg
c_func
(paren
r_struct
id|socket
...
DECL|function|do_unix_stream_sendmsg
r_static
r_int
id|do_unix_stream_sendmsg
c_func
(paren
r_struct
id|socket
...
DECL|function|do_unix_dgram_recvmsg
r_static
r_int
id|do_unix_dgram_recvmsg
c_func
(paren
r_struct
id|socket
...
id|out
suffix:semicolon
multiline_comment|/*&n;&t; * sysctl_unix_max_dgram_qlen may change over the time we blocked&n;&t; * in the waitqueue so we must wakeup every time we shrink the&n;&t; * receiver queue. -arca&n;&t; */
id|wake_up_interruptible
c_func
(paren
op_amp
...
DECL|function|do_unix_stream_recvmsg
r_static
r_int
id|do_unix_stream_recvmsg
c_func
(paren
r_struct
id|socket
...
DECL|function|unix_stream_write_space
r_static
r_void
id|unix_stream_write_space
c_func
...
(paren
id|KERN_INFO
l_string|&quot;NET4: Unix domain sockets 1.0 for Linux NET4.0.&bslash;n&quot;
)paren
suffix:semicolon
r_if
c_cond
