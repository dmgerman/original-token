...
id|sk
suffix:semicolon
multiline_comment|/*&t;printk(&quot;Unix create&bslash;n&quot;);*/
r_if
c_cond
(paren
id|protocol
...
suffix:semicolon
multiline_comment|/* Try and flush out this socket. Throw our buffers at least */
...
multiline_comment|/* if msg-&gt;accrights != NULL, we have fds to pass.&n; * Current implementation passes at most one fd.&n; */
...
l_int|0
suffix:semicolon
multiline_comment|/* for passing  fd, NULL indicates no fd */
r_struct
id|file
op_star
id|filp
...
multiline_comment|/* see if we want to access rights (fd) -- at the moment, &n;&t; * we can pass none or 1 fd&n;         */
id|filp
op_assign
l_int|NULL
suffix:semicolon
...
(brace
multiline_comment|/* then accrightslen is meaningful */
r_if
c_cond
(paren
...
(brace
multiline_comment|/* if we have accrights, we fail here */
r_return
op_minus
id|EINVAL
suffix:semicolon
...
multiline_comment|/* invariant -- flip points to a file to pass or NULL */
r_while
c_loop
(paren
id|sent
...
multiline_comment|/* at this point, we want to add an fd if we have one  */
id|skb-&gt;h.filp
op_assign
id|filp
suffix:semicolon
...
multiline_comment|/*&n; * return 0 if we can stick the fd, negative errno if we can&squot;t&n; */
DECL|function|stick_fd
r_static
r_int
id|stick_fd
c_func
