...
multiline_comment|/*&n;&t; *&t;Optimisation for the fact that under 0.01% of X messages typically&n;&t; *&t;need breaking up.&n;&t; */
r_if
c_cond
(paren
id|len
...
id|size
op_assign
multiline_comment|/*protocol_size(&amp;proto_unix)+*/
id|len
suffix:semicolon
id|skb
op_assign
...
multiline_comment|/*&t;protocol_adjust(skb,&amp;proto_unix);*/
id|skb-&gt;sk
op_assign
id|sk
suffix:semicolon
...
multiline_comment|/*&t;printk(&quot;got rcv sem&bslash;n&quot;);*/
r_while
c_loop
(paren
id|ct
...
multiline_comment|/*&n; *&t;For AF_UNIX we flip everything into an iovec. If this doesnt do any speed harm then it will&n; *&t;be easier for all the low levels to be totally iovec based.&n; */
DECL|function|unix_recvfrom
r_static
r_int
id|unix_recvfrom
c_func
