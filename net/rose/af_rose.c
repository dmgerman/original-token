...
suffix:semicolon
DECL|variable|proc_net_rose_neigh
r_static
r_struct
id|proc_dir_entry
id|proc_net_rose_neigh
op_assign
(brace
...
suffix:semicolon
DECL|variable|proc_net_rose_nodes
r_static
r_struct
id|proc_dir_entry
id|proc_net_rose_nodes
op_assign
(brace
...
suffix:semicolon
DECL|variable|proc_net_rose_routes
r_static
r_struct
id|proc_dir_entry
id|proc_net_rose_routes
op_assign
(brace
...
(paren
id|KERN_ERR
l_string|&quot;Rose: unable to register ROSE devices.&bslash;n&quot;
)paren
suffix:semicolon
r_break
suffix:semicolon
