...
multiline_comment|/*&n; * &t;A level 2 link has timed out, therefore it appears to be a poor link,&n; *&t;then don&squot;t use that neighbour until it is reset. XXX others.&n; */
...
multiline_comment|/*&n; * &t;A device has been &quot;downed&quot; remove its link status. XXX others.&n; */
...
multiline_comment|/*&n;&t; *&t;We should check for the random number in the facilities&n;&t; *&t;here. XXX.&n;&t; */
r_for
c_loop
(paren
id|rose_route
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Create a new route entry, if we can.&n;&t; */
r_for
c_loop
(paren
id|rose_node
...
r_break
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Its an unknown node, or is unreachable.&n;&t; */
r_if
c_cond
(paren
id|rose_node
...
id|buffer
comma
l_string|&quot;addr  callsign  dev  count  restart     t0&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|len
comma
l_string|&quot;%05d %-9s %-4s   %3d      %3s  %3d/%03d&bslash;n&quot;
comma
id|rose_neigh-&gt;number
comma
id|ax2asc
...
id|buffer
comma
l_string|&quot;lci  callsign  dev  &lt;-&gt; lci  callsign  dev&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(paren
op_amp
id|rose_route-&gt;neigh1-&gt;callsign
)paren
comma
id|rose_route-&gt;neigh1-&gt;dev
ques
c_cond
id|rose_route-&gt;neigh1-&gt;dev-&gt;name
suffix:colon
l_string|&quot;???&quot;
)paren
suffix:semicolon
...
(paren
op_amp
id|rose_route-&gt;neigh2-&gt;callsign
)paren
comma
id|rose_route-&gt;neigh2-&gt;dev
ques
c_cond
id|rose_route-&gt;neigh2-&gt;dev-&gt;name
suffix:colon
l_string|&quot;???&quot;
)paren
suffix:semicolon
