...
multiline_comment|/*&n; *&t;Clear all nodes and neighbours out, except for neighbours with&n; *&t;active connections going through them.&n; */
...
id|len
comma
l_string|&quot;%-10s %04d 1 loopback&bslash;n&quot;
comma
id|rose2asc
c_func
(paren
