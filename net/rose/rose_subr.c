...
multiline_comment|/*&n; * Requeue all the un-ack-ed frames on the output queue to be picked&n; * up by rose_kick called from the timer. This arrangement handles the&n; * possibility of an empty output queue.&n; */
...
suffix:colon
r_case
id|ROSE_INTERRUPT_CONFIRMATION
suffix:colon
r_case
...
suffix:colon
r_case
id|ROSE_REGISTRATION_REQUEST
suffix:colon
r_case
id|ROSE_REGISTRATION_CONFIRMATION
suffix:colon
r_case
id|ROSE_DIAGNOSTIC
suffix:colon
