...
suffix:semicolon
macro_line|#endif
multiline_comment|/* The less said about this the better, but it works and will do for 1.2 */
...
macro_line|#endif&t;
multiline_comment|/* This is a hack but it doesnt occur often and its going to&n;&t;   be a real        to fix nicely */
r_if
c_cond
(paren
id|state
...
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;This is not the right way to handle this. We have to&n;&t;&t; *&t;issue an up to date window and ack report with this &n;&t;&t; *&t;retransmit to keep the odd buggy tcp that relies on &n;&t;&t; *&t;the fact BSD does this happy. &n;&t;&t; *&t;We don&squot;t however need to recalculate the entire &n;&t;&t; *&t;checksum, so someone wanting a small problem to play&n;&t;&t; *&t;with might like to implement RFC1141/RFC1624 and speed&n;&t;&t; *&t;this up by avoiding a full checksum.&n;&t;&t; */
id|th-&gt;ack_seq
op_assign
id|ntohl
c_func
...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n;&t;&t; *&t;This is an artefact of a flawed concept. We want one&n;&t;&t; *&t;queue and a smarter send routine when we send all.&n;&t;&t; */
id|flag
op_or_assign
l_int|4
suffix:semicolon
...
multiline_comment|/* Check me --------------vvvvvvv */
id|reset_timer
c_func
(paren
id|sk
...
(brace
multiline_comment|/*&n;&t;&t; *&t;FIXME: BSD has some magic to avoid sending resets to&n;&t;&t; *&t;broken 4.2 BSD keepalives. Much to my suprise a few none&n;&t;&t; *&t;BSD stacks still have broken keepalives so we want to&n;&t;&t; *&t;cope with it.&n;&t;&t; */
r_if
c_cond
(paren
id|skb-&gt;len
)paren
multiline_comment|/* We don&squot;t care if its just an ack or&n;&t;&t;&t;&t;   a keepalive/window probe */
(brace
id|new_seq
op_assign
id|th-&gt;seq
...
multiline_comment|/* Do this the way 4.4BSD treats it. Not what I&squot;d&n;&t;&t;&t;   regard as the meaning of the spec but its what BSD&n;&t;&t;&t;   does and clearly they know everything 8) */
...
l_int|1
suffix:semicolon
multiline_comment|/*&n;&t;&t;&t; *&t;When we ack the fin, we turn on the RCV_SHUTDOWN flag. Also do the FIN &n;&t;&t;&t; *&t;processing.&n;&t;&t;&t; */
r_if
c_cond
(paren
id|skb-&gt;h.th-&gt;fin
...
multiline_comment|/*&n; *&t;A TCP packet has arrived.&n; */
...
c_func
(paren
l_string|&quot;IMPOSSIBLE 1&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IMPOSSIBLE 2&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
(brace
multiline_comment|/* We got an ack, but its not a good ack */
r_if
c_cond
(paren
op_logical_neg
...
multiline_comment|/*&n;&t;&t;&t;&t; *&t;Ok.. its good. Set up sequence numbers and&n;&t;&t;&t;&t; *&t;move to established.&n;&t;&t;&t;&t; */
id|syn_ok
op_assign
l_int|1
suffix:semicolon
...
multiline_comment|/* BSD has a funny hack with TIME_WAIT and fast reuse of a port. We&n;&t;   don&squot;t use it, we don&squot;t need it and its not in the spec. There is&n;&t;   a more complex suggestion for fixing these reuse issues in RFC1644&n;&t;   but not yet ready for general use. Also see RFC1379.*/
multiline_comment|/* We are now in normal data flow (see the step list in the RFC) */
multiline_comment|/* Note most of these are inline now. I&squot;ll inline the lot when&n;&t;   I have time to test it hard and look at what gcc outputs */
...
c_cond
(paren
multiline_comment|/*sk-&gt;state!=TCP_SYN_RECV &amp;&amp;*/
op_logical_neg
id|tcp_sequence
c_func
(paren
...
multiline_comment|/*&n;&t; *&t;Write data can still be transmitted/retransmitted in the&n;&t; *&t;following states.  If any other state is encountered, return.&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;state
...
multiline_comment|/*&n; *&t;A window probe timeout has occured.&n; */
