...
id|skb-&gt;next
suffix:semicolon
multiline_comment|/* if there is some real unread data, send a reset. */
r_if
c_cond
(paren
id|skb-&gt;len
...
(brace
macro_line|#ifdef OLD_WAY&t;&t;&t;
r_int
id|i
suffix:semicolon
r_if
...
multiline_comment|/* The comment above appears completely bogus --clh */
multiline_comment|/*&t;&t;&t;if (!th-&gt;fin) { */
id|sk-&gt;state
op_assign
id|TCP_CLOSE
suffix:semicolon
