...
id|TCP_LISTEN
suffix:colon
multiline_comment|/* we need to drop any sockets which have been connected,&n;&t;&t;&t;   but have not yet been accepted. */
id|tcp_set_state
c_func
(paren
id|sk
...
c_func
(paren
l_string|&quot;Socket %p reset by SYN while established.&bslash;n&quot;
comma
id|sk
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Reset on listening socket %d.&bslash;n&quot;
comma
id|sk-&gt;blog
)paren
suffix:semicolon
