...
multiline_comment|/*&n;&t; * are we at urgent data?&n;&t; */
r_if
c_cond
(paren
id|sk-&gt;urg_data
...
id|used
suffix:semicolon
multiline_comment|/*&n;&t;&t; * Mark this data used if we are really reading it, and we&n;&t;&t; * have used all the data.&n;&t;&t; */
r_if
c_cond
(paren
op_logical_neg
...
op_decrement
suffix:semicolon
multiline_comment|/* is the urgent data in this packet at all? */
r_if
c_cond
(paren
id|th-&gt;doff
...
l_int|0
suffix:semicolon
multiline_comment|/* have we already seen and read this? */
r_if
c_cond
(paren
id|after
...
l_int|0
suffix:semicolon
multiline_comment|/* is this a duplicate? */
r_if
c_cond
(paren
id|sk-&gt;urg_data
...
l_int|0
suffix:semicolon
multiline_comment|/*&n;&t; * We signal the user only for the first urgent data: if urgent&n;&t; * data already exists, no signal is sent&n;&t; */
r_if
c_cond
(paren
op_logical_neg
