...
multiline_comment|/*&n;&t;&t; * Fixed the recv(..., MSG_OOB) behaviour.  BSD docs and&n;&t;&t; * the available implementations agree in this case:&n;&t;&t; * this call should never block, independent of the&n;&t;&t; * blocking state of the socket.&n;&t;&t; * Mike &lt;pall@rz.uni-karlsruhe.de&gt;&n;&t;&t; */
r_return
op_minus
id|EAGAIN
suffix:semicolon
macro_line|#ifdef NOTDEF
multiline_comment|/* remove the loop, if this dead code gets removed! */
r_if
c_cond
(paren
id|nonblock
