...
multiline_comment|/*&n; * This routine is called by the ICMP module when it gets some&n; * sort of error condition.  If err &lt; 0 then the socket should&n; * be closed and the error returned to the user.  If err &gt; 0&n; * it&squot;s just the icmp type &lt;&lt; 8 | icmp code.  &n; * header points to the first 8 bytes of the tcp header.  We need&n; * to find the appropriate port.&n; */
r_void
...
id|DBG_TCP
comma
l_string|&quot;possible read_queue corruption.&bslash;n&quot;
)paren
)paren
suffix:semicolon
r_return
...
multiline_comment|/*&n;&t;&t; * FIXME:&n;&t;&t; * Now here is a race condition.&n;&t;&t; * release_sock could cause the connection to enter the&n;&t;&t; * `established&squot; mode, if that is the case, then we will&n;&t;&t; * block here for ever, because we will have gotten our&n;&t;&t; * wakeup call before we go to sleep.&n;&t;&t; */
id|release_sock
c_func
(paren
id|sk
...
multiline_comment|/*&n;   * We also need to worry about the window.&n;   * The smallest we will send is about 200 bytes.&n;   */
id|copy
op_assign
id|min
c_func
...
id|DBG_TCP
comma
l_string|&quot;tcp_read: returing %d&bslash;n&quot;
comma
id|copied
)paren
)paren
...
suffix:semicolon
multiline_comment|/* Wwap the send and the receive. */
id|t1-&gt;dest
op_assign
id|th-&gt;source
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;rtcp_rcv: back checksum&bslash;n&quot;
)paren
suffix:semicolon
id|kfree_skb
c_func
