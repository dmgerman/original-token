...
c_func
(paren
l_string|&quot;dev_rint: packet dropped (no memory) !&bslash;n&quot;
)paren
suffix:semicolon
id|dropping
op_assign
...
multiline_comment|/*&n; * This function gets called periodically, to see if we can&n; * process any data that came in from some interface.&n; */
r_void
...
l_int|0
suffix:semicolon
multiline_comment|/* Check &amp;&amp; mark our BUSY state. */
id|cli
c_func
(paren
)paren
...
c_func
(paren
l_string|&quot;INET: dev: skb with bad magic-%X:&quot;
comma
id|skb-&gt;magic
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;INET: dev: *** bug bad skb-&gt;next,&quot;
)paren
suffix:semicolon
id|printk
c_func
...
suffix:semicolon
multiline_comment|/* This will send it through the process again. */
id|dev
op_member_access_from_pointer
id|queue_xmit
c_func
...
c_func
(paren
l_string|&quot;INET: Warning: old-style ioctl(IP_SET_DEV) called!&bslash;n&quot;
)paren
suffix:semicolon
r_return
op_minus
