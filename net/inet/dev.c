...
suffix:colon
(brace
multiline_comment|/* Maintain backwards-compatibility, to be deleted for 1.00. */
r_struct
id|device
op_star
id|dev
suffix:semicolon
multiline_comment|/* The old &squot;struct ip_config&squot;. */
r_struct
id|ip_config
(brace
r_char
...
multiline_comment|/* To be proper we should delete the route here. */
r_if
c_cond
(paren
id|ipc.up
