...
r_else
(brace
multiline_comment|/* This routine is only ever called when &squot;entry&squot; is&n;&t;&t;&t;   complete. Thus this can&squot;t fail (but does) */
id|printk
c_func
(paren
...
(brace
multiline_comment|/* This packet is not for us. Remove it. */
id|kfree_skb
c_func
(paren
id|skb
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Process entry&n;&t; */
id|addr_hint
op_assign
id|ip_chk_addr
c_func
...
id|arp-&gt;ar_hln
suffix:semicolon
multiline_comment|/* This seems sensible but not everyone gets it right ! */
id|entry-&gt;htype
op_assign
id|ntohs
c_func
...
multiline_comment|/* Not good but we have no choice */
id|entry-&gt;last_used
op_assign
id|jiffies
suffix:semicolon
...
(brace
multiline_comment|/* Send out waiting packets. We might have problems,&n;&t;&t;&t;   if someone is manually removing entries right now.&n;&t;&t;&t;   I will fix this one. */
id|arp_send_q
c_func
(paren
id|entry
...
(brace
multiline_comment|/* We don&squot;t do &quot;smart arp&quot; and cache all possible&n;&t;&t;&t;   entries. That just makes us more work. */
id|sti
c_func
(paren
)paren
...
multiline_comment|/* From here on, interrupts are enabled. Never touch entry-&gt;..&n;&t;   any more. */
r_if
c_cond
(paren
id|arp-&gt;ar_op
...
(brace
multiline_comment|/* This wasn&squot;t a request, or some bad request for 127.0.0.1&n;&t;&t;   has made its way to the net, so delete it. */
id|kfree_skb
c_func
(paren
id|skb
...
multiline_comment|/* Either we respond with our own hw address, or we do proxy arp for&n;&t;   another machine. */
id|arp_send
c_func
(paren
id|ARPOP_REPLY
