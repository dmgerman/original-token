...
macro_line|#ifdef CONFIG_IP_FORWARDING
...
multiline_comment|/* this check may be unnecessary - retransmit only for TCP */
r_if
c_cond
(paren
id|sk-&gt;protocol
