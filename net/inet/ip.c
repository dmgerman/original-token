...
multiline_comment|/* &n;&t; *&t;See if we are allowed to forward this.&n;&t; */
...
macro_line|#ifdef CONFIG_IP_NO_ICMP_REDIRECT
r_if
c_cond
(paren
id|dev
...
(brace
multiline_comment|/*&n;&t;&t; *&t;Don&squot;t forward multicast or broadcast frames.&n;&t;&t; */
r_if
c_cond
(paren
id|skb-&gt;pkt_type
...
(brace
multiline_comment|/*&n;&t;&t; *&t;Check it is for one of our groups&n;&t;&t; */
r_struct
id|ip_mc_list
op_star
id|ip_mc
...
macro_line|#endif
multiline_comment|/*&n;&t; *&t;Account for the packet&n;&t; */
...
l_int|4
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Deliver to raw sockets. This is fun as to avoid copies we want to make no surplus copies.&n;&t; */
id|hash
op_assign
id|iph-&gt;protocol
op_amp
...
suffix:semicolon
multiline_comment|/* If there maybe a raw socket we must check - if not we don&squot;t care less */
r_if
c_cond
(paren
(paren
...
multiline_comment|/* Here either raw_sk is the last raw socket, or NULL if none */
multiline_comment|/* We deliver to the last raw socket AFTER the protocol checks as it avoids a surplus copy */
)brace
)brace
...
r_continue
suffix:semicolon
multiline_comment|/*&n;&t;* &t;See if we need to make a copy of it.  This will&n;&t;* &t;only be set if more than one protocol wants it.&n;&t;* &t;and then not for the last one. If there is a pending&n;&t;*&t;raw delivery wait for that&n;&t;*/
r_if
c_cond
(paren
id|ipprot-&gt;copy
...
suffix:colon
(brace
multiline_comment|/* Not fully tested */
r_struct
id|in_addr
id|addr
suffix:semicolon
