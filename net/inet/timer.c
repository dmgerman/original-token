...
id|TIME_DESTROY
suffix:colon
multiline_comment|/* We&squot;ve waited for a while for all the memory associated with&n;&t; &t;&t; * the socket to be freed.  We need to print an error message.&n;&t; &t;&t; */
r_if
c_cond
(paren
id|sk-&gt;wmem_alloc
...
op_increment
suffix:semicolon
multiline_comment|/* So it DOESNT go away */
id|destroy_sock
(paren
id|sk
)paren
...
multiline_comment|/* Socket gone, DONT update sk-&gt;inuse! */
r_break
suffix:semicolon
r_case
id|TIME_CLOSE
