...
id|DBG_UDP
comma
l_string|&quot;UDP: err(err=%d, header=%X, daddr=%X, saddr=%X, protocl=%X)&bslash;n&quot;
comma
id|err
comma
id|header
...
suffix:semicolon
multiline_comment|/* This was checked in the wrong place&n;  verify_area(VERIFY_WRITE, to, copied);&n;  */
id|memcpy_tofs
c_func
(paren
id|to
...
id|skb-&gt;daddr
suffix:semicolon
multiline_comment|/* Also in the wrong place, jumping out here will lose&n;&t;   a packet for good and leave the socket in use&n;&t;   now tested above&n;&t;verify_area(VERIFY_WRITE, sin, sizeof(*sin));*/
id|memcpy_tofs
c_func
(paren
id|sin
