...
multiline_comment|/*&n; * Used by &squot;rt_add()&squot; when we can&squot;t get the netmask from the device..&n; */
...
suffix:semicolon
multiline_comment|/*&n;&t; * Gateway to our own interface is really direct&n;&t; */
r_if
c_cond
(paren
id|gw
...
id|pos
comma
l_string|&quot;Iface&bslash;tDestination&bslash;tGateway &bslash;tFlags&bslash;tRefCnt&bslash;tUse&bslash;tMetric&bslash;n&quot;
)paren
suffix:semicolon
