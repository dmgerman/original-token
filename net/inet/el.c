multiline_comment|/* el.c: A shared-memory NS8390 ethernet driver for linux. */
multiline_comment|/*&n;    Written 1992,1993 by Donald Becker. This is alpha test code.&n;    Copyright 1993 United States Government as represented by the&n;    Director, National Security Agency.  This software may be used and&n;    distributed according to the terms of the GNU Public License,&n;    incorporated herein by reference.&n;&n;    This driver should work with the 3c503 and 3c503/16.  It must be used&n;    in shared memory mode.&n;&n;    The Author may be reached as becker@super.org or&n;    C/O Supercomputing Research Ctr., 17100 Science Dr., Bowie MD 20715&n;*/
...
id|version
op_assign
l_string|&quot;el.c:v0.99-10 5/28/93 Donald Becker (becker@super.org)&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* We check for a memory-mapped 3c503 board by looking at the&n;       port location bitmap at the end of the jumpered boot PROM space.&n;       This works even if a PROM isn&squot;t there. */
r_for
c_loop
(paren
id|addr
...
macro_line|#ifndef ignore_nonshared_memory
multiline_comment|/* It&squot;s not memory mapped, bummer.  Try all of the locations&n;       that aren&squot;t obviously empty. */
(brace
r_int
id|i
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* Reset any lurking NE2000 */
r_if
c_cond
(paren
id|inb
...
macro_line|#endif  /* probe_nonshared_memory */
r_return
l_int|0
suffix:semicolon
)brace
...
id|el2_block_output
suffix:semicolon
multiline_comment|/* This should be probed for (or set via an ioctl()) at run-time someday. */
...
c_func
(paren
l_string|&quot;&bslash;n3c503: configured interrupt number %d out of range.&bslash;n&quot;
comma
id|dev-&gt;irq
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;&bslash;n%s: %s using IRQ %d with shared memory at %#6x-%#6x,&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ei_status.name
...
c_func
(paren
l_string|&quot;&bslash;n%s: %s using IRQ %d with programmed I/O.&bslash;n&quot;
comma
id|dev-&gt;name
comma
id|ei_status.name
