...
c_func
(paren
l_string|&quot;INET: *** bug unlocking non-locked sk_buff. &bslash;n&quot;
)paren
suffix:semicolon
)brace
id|skb-&gt;lock
...
id|skb2
suffix:semicolon
multiline_comment|/*&n;&t; * We need to remove skb from the transmit queue,&n;&t; * or maybe the arp queue.&n;&t; */
id|cli
c_func
(paren
)paren
...
(brace
multiline_comment|/*&n;&t; * This is really a bug in BSD which we need&n;&t; * to emulate because ftp expects it.&n;&t; */
r_return
op_minus
id|EINVAL
suffix:semicolon
...
(brace
multiline_comment|/*&t;if (sk-&gt;num &gt; PROT_SOCK) return(0); */
id|snum
op_assign
id|get_new_socknum
c_func
...
r_continue
suffix:semicolon
macro_line|#if 1&t;/* C.E. Hawkins  ceh@eng.cam.ac.uk */
r_if
c_cond
(paren
id|s-&gt;prot
