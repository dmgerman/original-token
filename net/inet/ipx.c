...
DECL|function|ipxrtr_device_event
r_int
id|ipxrtr_device_event
c_func
(paren
r_int
r_int
...
id|buffer
comma
l_string|&quot;Net      Router                Flags Dev   Frame&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
id|len
comma
l_string|&quot;%08lX %08lX:%02X%02X%02X%02X%02X%02X %02X    %s  %d&bslash;n&quot;
comma
id|ntohl
c_func
(paren
...
multiline_comment|/*&n;&t;&t; *&t;Ok, before we forward, make sure this is not a local packet on the &n;&t;&t; *&t;other network &n;&t;&t; */
r_if
c_cond
(paren
id|rt-&gt;router_net
...
id|outgoing_size
suffix:semicolon
multiline_comment|/*&n;        &t;&t; *&t;NOTE: src arg for memcpy used to be (skb+1)+insize&n;&t;&t;&t; *&t;however, that doesn&squot;t work... (dunno why)&n;&t;&t;&t; *&t;it should though...&n; &t;&t;&t; */
id|memcpy
c_func
(paren
(paren
...
c_func
(paren
l_string|&quot;Swansea University Computer Society IPX 0.29 BETA for NET3.019&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
