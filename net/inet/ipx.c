...
op_increment
suffix:semicolon
multiline_comment|/* If the route is a gateway then forward to it */
id|dev
op_member_access_from_pointer
id|hard_header
c_func
...
suffix:semicolon
multiline_comment|/* No suitable route - no gateways when not routing */
r_if
c_cond
(paren
id|rt
...
c_func
(paren
l_string|&quot;Swansea University Computer Society IPX 0.24 BETA for NET3 ALPHA.008&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
