...
id|buffer
comma
l_string|&quot;   local_address              rem_address                tx_queue rx_queue st uid&bslash;n&quot;
)paren
suffix:semicolon
r_for
c_loop
...
(brace
id|sk-&gt;ncp.watchdog-&gt;ipx_source_addr.net
op_assign
id|rt-&gt;net
suffix:semicolon
id|sk-&gt;ncp.watchdog-&gt;ipx_source_addr.sock
op_assign
id|htons
c_func
(paren
...
c_func
(paren
id|sk-&gt;ncp.watchdog-&gt;ipx_source_addr.node
comma
l_char|&squot;&bslash;0&squot;
comma
l_int|6
...
suffix:semicolon
id|sk-&gt;ncp.watchdog-&gt;zapped
op_assign
l_int|0
suffix:semicolon
id|sk-&gt;ncp.mail-&gt;ipx_source_addr.net
op_assign
id|rt-&gt;net
suffix:semicolon
id|sk-&gt;ncp.mail-&gt;ipx_source_addr.sock
op_assign
id|htons
c_func
(paren
...
c_func
(paren
id|sk-&gt;ncp.mail-&gt;ipx_source_addr.node
comma
l_char|&squot;&bslash;0&squot;
comma
l_int|6
...
DECL|function|ipx_build_header
r_static
r_int
id|ipx_build_header
c_func
...
c_func
(paren
l_string|&quot;IPX: build_header: Addresses built.&bslash;n&quot;
)paren
suffix:semicolon
)brace
r_if
...
c_func
(paren
l_string|&quot;IPX: build_header: building packet.&bslash;n&quot;
)paren
suffix:semicolon
)brace
...
id|skb-&gt;h.raw
suffix:semicolon
id|ipx_pack-&gt;ipx_checksum
op_assign
l_int|0xFFFF
suffix:semicolon
id|ipx_pack-&gt;ipx_pktsize
op_assign
id|htons
c_func
(paren
...
suffix:semicolon
id|ipx_pack-&gt;ipx_tctrl
op_assign
l_int|0
suffix:semicolon
id|ipx_pack-&gt;ipx_type
op_assign
id|type
suffix:semicolon
id|memcpy
...
DECL|function|ipx_delete_timer
r_static
r_void
id|ipx_delete_timer
(paren
...
c_func
(paren
l_string|&quot;&bslash;007%s&bslash;n&quot;
comma
id|data
)paren
suffix:semicolon
...
id|ret
suffix:semicolon
id|local_sipx.sipx_type
op_assign
l_int|0
suffix:semicolon
id|local_sipx.sipx_port
op_assign
l_int|0
suffix:semicolon
id|local_sipx.sipx_network
op_assign
l_int|0L
suffix:semicolon
id|ret
