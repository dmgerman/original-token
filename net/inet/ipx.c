...
c_func
(paren
l_string|&quot;IPX:fcntl:passed sock-&gt;data=NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IPX:setsockopt:passed sock-&gt;data=NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IPX:getsockopt:passed NULL sock-&gt;data.&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IPX:bind:sock-&gt;data=NULL&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IPX:connect:sock-&gt;data=NULL!&bslash;n&quot;
)paren
suffix:semicolon
r_return
l_int|0
...
c_func
(paren
l_string|&quot;IPX: Registering local net %lx&bslash;n&quot;
comma
id|ipx-&gt;ipx_dest.net
)paren
suffix:semicolon
...
c_func
(paren
l_string|&quot;Swansea University Computer Society IPX 0.25 BETA for NET3 014&bslash;n&quot;
)paren
suffix:semicolon
)brace
macro_line|#endif
