...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;We need to check if there is a primary net and if&n;&t; *&t;this is addressed to one of the *SPECIAL* sockets because&n;&t; *&t;these need to be propogated to the primary net.&n;&t; *&t;The *SPECIAL* socket list contains: 0x452(SAP), 0x453(RIP) and&n;&t; *&t;0x456(Diagnostic).&n;&t; */
r_if
c_cond
(paren
id|ipx_primary_net
...
multiline_comment|/* if the orginating net is not equal to our net; this is routed */
r_if
c_cond
(paren
...
multiline_comment|/* In some case, ipxitf_adjust_skbuff can overwrite node */
id|memcpy
c_func
(paren
id|dest_node
...
id|f.ipx_primary
op_assign
id|sipx-&gt;sipx_primary
suffix:semicolon
id|f.ipx_internal
op_assign
id|sipx-&gt;sipx_internal
suffix:semicolon
r_if
c_cond
(paren
