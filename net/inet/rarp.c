...
l_int|NULL
suffix:semicolon
multiline_comment|/*&n; * This structure defines an ethernet arp header, which is the same header&n; * that is used for rarp.&n; */
DECL|struct|arphdr
r_struct
id|arphdr
(brace
...
id|ar_hrd
suffix:semicolon
multiline_comment|/* format of hardware address  */
DECL|member|ar_pro
r_int
r_int
id|ar_pro
suffix:semicolon
multiline_comment|/* format of protocol address  */
DECL|member|ar_hln
r_int
r_char
id|ar_hln
...
id|ar_pln
suffix:semicolon
multiline_comment|/* length of protocol address  */
DECL|member|ar_op
r_int
r_int
id|ar_op
suffix:semicolon
multiline_comment|/* ARP opcode (command)        */
macro_line|#if 0
multiline_comment|/*&n;   *&t;Ethernet looks like this : This bit is variable sized however...&n;   */
r_int
r_char
id|ar_sha
(braket
