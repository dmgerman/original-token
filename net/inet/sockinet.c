...
c_func
(paren
l_string|&quot;Socket Error: Socket destroyed with data backlog.&bslash;n&quot;
)paren
suffix:semicolon
id|cli
c_func
...
multiline_comment|/* No listen() on a busy socket. */
r_if
c_cond
(paren
id|sk-&gt;state
...
multiline_comment|/* Some sanity checks here are a good idea */
r_if
c_cond
(paren
id|backlog
...
multiline_comment|/*&n; *&t;Create an inet socket. Note that sock=NULL is now legal, and means a kernel&n; *&t;created socket.&n; */
...
l_int|1
suffix:semicolon
multiline_comment|/* if set cong_window grow exponentially every time&n;&t;&t;&t;&t;  we get an ack. */
id|sk-&gt;urginline
op_assign
l_int|0
suffix:semicolon
...
multiline_comment|/* how many packets we should send before forcing an ack. &n;    &t; * if this is set to zero it is the same as sk-&gt;delay_acks = 0 &n;    &t; */
id|sk-&gt;max_ack_backlog
op_assign
l_int|0
suffix:semicolon
...
l_int|576
suffix:semicolon
multiline_comment|/* This is a reasonable typical choice. RFC791 guarantees this is acceptable */
id|sk-&gt;prot
op_assign
id|prot
suffix:semicolon
...
multiline_comment|/* Added in use check AC 24/12/93 */
(brace
id|destroy_sock
c_func
(paren
...
id|sk
suffix:semicolon
multiline_comment|/*&n;  &t; * This should really check to make sure&n;  &t; * the socket is a TCP socket.&n;  &t; */
id|how
op_increment
suffix:semicolon
...
multiline_comment|/* This one _IS_ legal */
r_if
c_cond
(paren
op_logical_neg
...
c_func
(paren
l_string|&quot;Swansea University Computer Society Net2Debugged [1.28]&bslash;n&quot;
)paren
suffix:semicolon
