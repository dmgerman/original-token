...
suffix:semicolon
multiline_comment|/* Nor send them */
id|del_timer
c_func
(paren
op_amp
...
multiline_comment|/*&n; * Return 1 if we still have things to send in our buffers.&n; */
...
(brace
multiline_comment|/* BSD explicitly states these are the same - so we do it this way to be sure */
r_return
id|inet_recvfrom
c_func
(paren
...
macro_line|#ifdef CONFIG_IP_MULTICAST
multiline_comment|/*&n; *&t;Deliver a datagram to broadcast/multicast sockets.&n; */
DECL|function|get_sock_mcast
r_struct
id|sock
op_star
id|get_sock_mcast
...
c_func
(paren
l_string|&quot;Swansea University Computer Society TCP/IP for NET3.019&bslash;n&quot;
)paren
suffix:semicolon
