...
id|version
op_assign
l_string|&quot;lance.c:v0.12 9/3/93 becker@super.org&bslash;n&quot;
suffix:semicolon
...
suffix:semicolon
multiline_comment|/* We need a ethercard low-memory allocation scheme for for bus-master or&n;   DMA ethercards if they are to work &gt;16M memory systems. This is a&n;   temporary solution to the lack of one, but it limits us to a single&n;   AT1500 and &lt;16M. Bummer. */
...
suffix:semicolon
multiline_comment|/* First probe for the ethercard ID, 0x57, and then look for a LANCE&n;       chip. */
r_for
c_loop
(paren
id|port
...
r_continue
suffix:semicolon
multiline_comment|/* Reset the LANCE. Un-Reset needed only for the real NE2100. */
id|temp
op_assign
id|inw
c_func
...
suffix:semicolon
macro_line|#ifndef NE2100
multiline_comment|/* This is really 79C960-specific, NE2100 might not understand */
