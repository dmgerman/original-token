...
(paren
op_amp
id|sk-&gt;protinfo.x25-&gt;interrupt_queue
)paren
)paren
op_ne
l_int|NULL
...
multiline_comment|/*&n; * Requeue all the un-ack-ed frames on the output queue to be picked&n; * up by x25_kick called from the timer. This arrangement handles the&n; * possibility of an empty output queue.&n; */
...
id|skb-&gt;data
suffix:semicolon
id|facilities-&gt;window_size
op_assign
op_minus
l_int|1
suffix:semicolon
id|facilities-&gt;packet_size
op_assign
op_minus
l_int|1
suffix:semicolon
