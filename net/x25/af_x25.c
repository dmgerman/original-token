...
multiline_comment|/*&n; *&t;Find a connected X.25 socket given my LCI.&n; */
...
id|EINVAL
suffix:semicolon
id|sk-&gt;protinfo.x25-&gt;facilities.packet_size
op_assign
id|opt
suffix:semicolon
r_return
...
id|EINVAL
suffix:semicolon
id|sk-&gt;protinfo.x25-&gt;facilities.throughput
op_assign
id|opt
suffix:semicolon
r_return
...
id|EINVAL
suffix:semicolon
id|sk-&gt;protinfo.x25-&gt;facilities.reverse
op_assign
id|opt
suffix:semicolon
r_return
...
id|X25_STATE_0
suffix:semicolon
id|x25-&gt;facilities.window_size
op_assign
id|X25_DEFAULT_WINDOW_SIZE
suffix:semicolon
id|x25-&gt;facilities.packet_size
op_assign
id|X25_DEFAULT_PACKET_SIZE
suffix:semicolon
...
id|len
suffix:semicolon
multiline_comment|/*&n;&t; *&t;skb-&gt;data points to the x25 frame start&n;&t; */
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Extract the X.25 addresses and convert them to ASCII strings.&n;&t; */
id|len
op_assign
id|x25_addr_ntoa
c_func
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Remove address lengths and addresses.&n;&t; */
id|skb_pull
c_func
(paren
id|skb
...
multiline_comment|/*&n;&t; *&t;Parse the facilities.&n;&t; */
id|len
op_assign
...
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Then remove them, leaving any Call User Data.&n;&t; */
id|skb_pull
c_func
(paren
id|skb
...
id|neigh
suffix:semicolon
multiline_comment|/*&n;&t; *&t;This implies that we accept all the incoming facilities&n;&t; *&t;values (if any). This needs fixing. XXX&n;&t; */
id|make-&gt;protinfo.x25-&gt;facilities
op_assign
id|facilities
suffix:semicolon
multiline_comment|/*&n;&t; *&t;Incoming Call User Data. XXX&n;&t; */
id|x25_write_internal
c_func
(paren
id|make
...
id|len
comma
l_string|&quot;%-10s %-10s %-5s %3.3X  %d  %d  %d  %d %3d %3d %3d %3d %3d %5d %5d&bslash;n&quot;
comma
(paren
